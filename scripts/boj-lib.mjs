...
// This module is library-only — no CLI entrypoint.
// Use scripts/import-tier.mjs (manual bulk import) or
// scripts/archive-per-problem.mjs (workflow-driven archival).
