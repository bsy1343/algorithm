...
public class 하이퍼튜브 {
    ...
    static void input() throws IOException
    {
        ...
        for(int tube = 1; tube <= M; tube ++)tube_to_node[tube] = new ArrayList<>();
        for(int node = 1; node <= N; node ++)node_to_tube[node] = new ArrayList<>();
    ...
    public static void main(String args[]) throws IOException
    {
        ...
        while(!qu.isEmpty())
        {
            ...
            {
                if(visited_tube[tube] == 1) continue;
                visited_tube[tube] = 1;
