...
제출: 315, 정답: 223, 맞힌 사람: 210, 정답 비율: 73.944%
...
<p>For each problem set if the square is a magic square print &ldquo;Magic square of size &lt;m&gt;&rdquo;, where &lt;m&gt; is replaced with the size (number of rows) of the magic square. If the square is not a magic square print &ldquo;Not a magic square&rdquo;</p>
