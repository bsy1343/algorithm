...
제출: 325, 정답: 126, 맞힌 사람: 109, 정답 비율: 40.221%
...
<ul>
	<li>You might think this is not particularly interesting game, since one can always guess words like &ldquo;aal&rdquo;, &ldquo;abut&rdquo;, etc. (depending on length), and easily earn coins. However, there is a twist: if it turns out you would earn too many coins, you don&rsquo;t earn anything (its a carnival game after all). We will ignore this twist.</li>
</ul>
