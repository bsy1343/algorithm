...
제출: 1099, 정답: 814, 맞힌 사람: 733, 정답 비율: 76.116%
...
<p>주사위는 각 면에 a<sub>i</sub>, a<sub>i</sub>+1, ... , b<sub>i </sub> 의 숫자들을 갖고 있고, 1 &le; a<sub>i</sub> &le; b<sub>i</sub> &le; 100 이다.</p>

<p>주사위는 최소 4개의 면을 가질 것이므로 a<sub>i</sub> + 3 &le; b<sub>i</sub> 임을 유추할 수 있다.</p>
