...
제출: 236, 정답: 131, 맞힌 사람: 107, 정답 비율: 56.316%
...
<p>The first line contains two integers C and n (2 &le; n &le; 100), the total capacity and the number of stations the train stops in. The next n lines contain three integers each, the number of people that left the train, entered the train, and had to stay at a station. Lines are given in the same order as the train visits each station. All integers including C are between 0 and 10<sup>9</sup> inclusive.</p>
