...
제출: 892, 정답: 787, 맞힌 사람: 758, 정답 비율: 89.072%
...
<p>The first line contains three integers W, N and P, representing respectively the height of the waist of the opponent, the height of his neck, and the number of thrown punches (1 &le; W &lt; N &le; 200 and 1 &le; P &le; 100). The second line contains P integers H<sub>1</sub>, H<sub>2</sub>, . . . , H<sub>P</sub> (1 &le; H<sub>i</sub> &le; 200 for i = 1, 2, . . . , P) indicating the heights of the punches. All heights are given in centimeters.</p>
