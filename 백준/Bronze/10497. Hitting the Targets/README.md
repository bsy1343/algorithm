...
제출: 151, 정답: 131, 맞힌 사람: 124, 정답 비율: 86.111%
...
<p style="text-align: center;"><img alt="" src="/upload/images2/hitting.png" style="height:217px; width:264px" /></p>
...
<p>Input starts with an integer 1 &le; m &le; 30 indicating the number of targets. Each of the next m lines begins with the word rectangle or circle and then a description of the target boundary. A rectangular target&rsquo;s boundary is given as four integers x1 y1 x2 y2, where x1 &lt; x2 and y1 &lt; y2. The points (x1, y1) and (x2, y2) are the bottom-left and top-right corners of the rectangle, respectively. A circular target&rsquo;s boundary is given as three integers x y r. The center of the circle is at (x, y) and the 0 &lt; r &le; 1000 is the radius of the circle.</p>

<p>After the target descriptions is an integer 1 &le; n &le; 100 indicating the number of shots that follow. The next n lines each contain two integers x y, indicating the coordinates of a shot. All x and y coordinates for targets and shots are in the range [&minus;1000, 1000].</p>
