...
제출: 2993, 정답: 2338, 맞힌 사람: 2219, 정답 비율: 80.750%
...
<p>테스트 케이스는 여러줄에 걸쳐 입력된다. 각 테스트 케이스는 4개의 정수 a, b, c, d (-5000 &le; a &le; b &le; c &le; d &le; 2000)로 이뤄진다. [a, b]는 출생일의 범위, [c, d]는 사망일의 범위이다. a, b, c, d의 입력이 모두 0일 경우 프로그램을 종료한다.</p>
