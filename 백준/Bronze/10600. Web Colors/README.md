...
제출: 272, 정답: 199, 맞힌 사람: 184, 정답 비율: 73.307%
...
<p>For a given color, the &ldquo;closest&rdquo; color in the HTML color names is a color with the smallest Euclidean distance from the given color. That is, if rgb is the color to be mapped, and {\(R_1G_1B_1\), . . . , \(R_{16}G_{16}B_{16}\)} is the set of the HTML colors, the closest color is the one which minimizes the distance expression</p>
