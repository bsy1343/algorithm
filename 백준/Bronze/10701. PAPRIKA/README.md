...
제출: 99, 정답: 67, 맞힌 사람: 63, 정답 비율: 69.231%
...
<p>Because the peppers aren&rsquo;t aware of Marin&rsquo;s number X, they have decided to rectify the injustice using the following strategy. The first pepper tries to switch its ID card with second pepper, then the second pepper tries to switch its ID card with the third pepper and so on until the end of the line. Two peppers will switch their ID cards if the pepper that has a larger number on the ID card it&rsquo;s currently holding wants to become a filled pepper, and the one with the smaller number doesn&rsquo;t. The peppers will not switch ID cards if they have equal numbers on them.</p>

<p>Your task is to determine the number of peppers that will have their life purpose completed.</p>

### 입력

<p>The first line of input contains two integers N and X (1 &le; N, X &le; 1 000) from the task.</p>

<p>Each of the following N lines contains two integers a (1 &le; a &le; 1 000) and b (0 &le; b &le; 1) that describe the peppers in the order which they&rsquo;re waiting in line to be filled.</p>

<p>The number a is printed on the ID card of a pepper and represents its age in days, and number b represents it&rsquo;s life purpose (0 if pepper wants to be served fresh or 1 if it wants to be served as a filled pepper).</p>
...
<p><strong>Clarification of the first example:</strong> All peppers are young enough, but not a single one of them wants to be stuffed.</p>

<p><strong>Clarification of the second example:</strong> Every two adjacent peppers switched their ID cards.</p>