...
제출: 125503, 정답: 60368, 맞힌 사람: 50992, 정답 비율: 48.140%
...
<p>이 장난감에 있는 글자들은 영어 대문자 &lsquo;A&rsquo;부터 &lsquo;Z&rsquo;, 영어 소문자 &lsquo;a&rsquo;부터 &lsquo;z&rsquo;, 숫자 &lsquo;0&rsquo;부터 &lsquo;9&rsquo;이다. 영석이는 칠판에 글자들을 수평으로 일렬로 붙여서 단어를 만든다. 다시 그 아래쪽에 글자들을 붙여서 또 다른 단어를 만든다. 이런 식으로 다섯 개의 단어를 만든다. 아래 그림 1은 영석이가 칠판에 붙여 만든 단어들의 예이다.&nbsp;</p>
...
<p>총 다섯줄의 입력이 주어진다. 각 줄에는 최소 1개, 최대 15개의 글자들이 빈칸 없이 연속으로 주어진다. 주어지는 글자는 영어 대문자 &lsquo;A&rsquo;부터 &lsquo;Z&rsquo;, 영어 소문자 &lsquo;a&rsquo;부터 &lsquo;z&rsquo;, 숫자 &lsquo;0&rsquo;부터 &lsquo;9&rsquo; 중 하나이다. 각 줄의 시작과 마지막에 빈칸은 없다.</p>
