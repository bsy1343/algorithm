...
제출: 16443, 정답: 10768, 맞힌 사람: 9054, 정답 비율: 66.208%
...
<p>이제 여러분은 다음과 같은 규칙으로 카드의 위치를 바꾼다: 구간 [a, b] (단, 1 &le; a &le; b &le; 20)가 주어지면 위치 a부터 위치 b까지의 카드를 현재의 역순으로 놓는다.</p>
...
<p>총 10개의 줄에 걸쳐 한 줄에 하나씩 10개의 구간이 주어진다. i번째 줄에는 i번째 구간의 시작 위치 a<sub>i</sub>와 끝 위치 b<sub>i</sub>가 차례대로 주어진다. 이때 두 값의 범위는 1 &le; a<sub>i</sub> &le; b<sub>i</sub> &le; 20이다.</p>
