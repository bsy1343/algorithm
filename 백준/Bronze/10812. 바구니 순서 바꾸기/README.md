...
제출: 11993, 정답: 7396, 맞힌 사람: 6632, 정답 비율: 63.397%
...
<p>둘째 줄부터 M개의 줄에는 바구니의 순서를 바꾸는&nbsp;만드는 방법이 주어진다. 방법은 i, j, k로 나타내고, 왼쪽으로부터 i번째 바구니부터 j번째 바구니의 순서를 회전시키는데, 그 때 기준 바구니는 k번째 바구니라는 뜻이다. (1 &le; i &le; k &le; j &le; N)</p>
