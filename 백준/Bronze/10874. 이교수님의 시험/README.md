...
제출: 2916, 정답: 2183, 맞힌 사람: 2016, 정답 비율: 78.049%
...
<p>첫 번째 줄은 시험을 본 학생수를 나타내는 정수 N이 주어진다.(1 &le; N &le; 100)</p>

<p>N번째 줄까지는 1에서 5사이에 해당하는 정수 열개가 주어진다. i번째 줄의 j번째 수는 i번째 학생이 고른 j번째 문제의 답을 의미한다. (1 &le; i &le; N, 1 &le; j &le; 10)</p>
