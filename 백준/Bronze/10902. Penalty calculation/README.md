...
제출: 918, 정답: 549, 맞힌 사람: 494, 정답 비율: 63.990%
...
<p>당신이 어느 한 문제에 답안을 n개 제출했다고 하자. 이 중 i번째 (1 &le; i &le; n) 답안은 대회가 시작한 지 t<sub>i</sub>분 뒤에 제출하였고, 채점 결과 s<sub>i</sub>점을 받았다고 가정하자.</p>
...
<ul>
	...
	<li>s<sub>f</sub> = 1 또는 s<sub>f</sub> = 4 : P = t<sub>f</sub> + (f - 1) &times; 20</li>
</ul>
...
<p>첫 번째 줄에 이 문제에 제출한 답안의 수 n (1 &le; n &le; 100)이 주어진다.</p>

<p>이후 n개의 줄이 주어지는데, 이 중 i번째 (1 &le; i &le; n)번째 줄에는 두 개의 정수 t<sub>i</sub>와 s<sub>i</sub>가 공백을 사이로 두고 주어진다. 1 &le; t<sub>1</sub> &lt; t<sub>2</sub> &lt; ... &lt; t<sub>n</sub> &le; 300, 임이 보장된다.</p>
