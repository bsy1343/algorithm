...
제출: 141, 정답: 100, 맞힌 사람: 93, 정답 비율: 72.656%
...
<p>The first line of input will contain an n-digit PIN, 6 &le; n &le; 256. The second line will contain an m-digit pattern word containing only upper and lower case letters, 1 &le; m &le; 256.</p>
