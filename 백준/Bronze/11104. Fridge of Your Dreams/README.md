...
제출: 2701, 정답: 2217, 맞힌 사람: 2046, 정답 비율: 83.887%
...
<p>The first line of input gives n &le; 1000, the number of test cases. Then follow n lines with positive numbers represented as 24-bit binary strings (0s and 1s).</p>
