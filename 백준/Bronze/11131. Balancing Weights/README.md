...
제출: 1062, 정답: 888, 맞힌 사람: 838, 정답 비율: 85.773%
...
<p>Ever since you started studying, your whole family have been expecting you to know the answers to a whole lot of difficult questions. What is wrong with my computer? What is the name of Prince Harry&rsquo;s new girlfriend? Have you seen my new pants? Your grandfather has just found a new problem for you, and you are yet again under the pressure of finding the answers to one of life&rsquo;s most fundamental questions.</p>
...
<p>where \(\tau\) is the total torque applied, \(m\) is the mass of the weight and \(d\) is its distance from the center. The lever&rsquo;s angular acceleration can then be found by the equation</p>

<p>\[\alpha = \tau / I\]</p>

<p>where \(\alpha\) is the angular acceleration and \(I\) is the lever&rsquo;s moment of inertia. The moment of inertia is given by the function</p>
...
<ul>
	<li>0 &lt; T &le; 100</li>
	<li>0 &lt; N &le; 100</li>
	<li>&minus;1000 &le; W<sub>i</sub> &le; 1000</li>
