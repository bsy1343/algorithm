...
제출: 1135, 정답: 404, 맞힌 사람: 346, 정답 비율: 38.487%
...
<p>This is it! You&rsquo;ve finally graduated and started working. Looking forward to some really cool tasks now. While you&rsquo;re skipping around in the eagerness of getting started, you&rsquo;re told what your first task is - Input Validation! You should check whether the typed input is an integer number.</p>
