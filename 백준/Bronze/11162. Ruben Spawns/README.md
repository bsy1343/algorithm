...
제출: 34, 정답: 30, 맞힌 사람: 28, 정답 비율: 90.323%
...
<p>There is one caveat with minions. If you have too many of them, they might get lost. So, simply put, fewer is better. After all, someone has to keep track of those minions. Each minion spawned from the machine can work a set amount of units, and then they are &ldquo;spent&rdquo; (there exists a recycling machine, but it is hidden in a deep, dark forest somewhere).</p>

<p>The machine itself creates a given number of minions whose work capacities are normally distributed with both &micro; and &sigma; unknown. The number of minions the machine can spawn in a given time interval is Poisson distributed with intensity &lambda;, also unknown.</p>
...
<ul>
	...
	<li>0 &lt; W &le; 10000</li>
	<li>0 &lt; M &le; 100</li>
	<li>0 &lt; C<sub>i</sub> &le; 100</li>
</ul>

### 출력

<p>Output the minimum number of minions needed to complete the workload W, or output &ldquo;no rest for Ruben&rdquo; (without the quotes). Please note that you need a capital r in Ruben&rsquo;s name.</p>