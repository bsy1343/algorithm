...
제출: 444, 정답: 320, 맞힌 사람: 295, 정답 비율: 72.482%
...
<p>The first line of the input contains one integer n, 1 &le; n &le; 100, the group size. The second line contains n integers a<sub>1</sub>, a<sub>2</sub>, . . . , a<sub>n</sub> (1 &le; a<sub>i</sub> &le; 6 for all 1 &le; i &le; n): the outcome of each participant&rsquo;s die roll.</p>

### 출력

<p>Output the index of the participant that has the highest unique outcome, or &ldquo;none&rdquo; (without the quotes) if nobody has a unique outcome.</p>