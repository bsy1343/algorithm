...
제출: 223, 정답: 101, 맞힌 사람: 86, 정답 비율: 43.655%
...
<ul>
	<li>One line with an integer M, satisfying 1 &le; M &le; 800: the number of tiles the player has in his hand.</li>
	<li>One line with M space-separated strings, representing the tiles in the hand. Each tile string consists of an integer V satisfying 1 &le; V &le; 100 (the value), and a character which is either b, g, r or y (representing the suit).</li>
</ul>
