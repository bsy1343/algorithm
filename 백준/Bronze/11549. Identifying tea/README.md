...
제출: 5249, 정답: 4651, 맞힌 사람: 4417, 정답 비율: 89.377%
...
<p>The first line contains an integer T representing the tea type (1 &le; T &le; 4). The second line contains five integers A, B, C, D and E, indicating the answer given by each contestant (1 &le; A, B, C, D, E &le; 4).</p>
