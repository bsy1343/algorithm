...
제출: 14369, 정답: 10322, 맞힌 사람: 9435, 정답 비율: 73.202%
...
<p>매 입력의 첫 줄에는 학교의 숫자 정수 N(1 &le; N &le; 100)이 주어진다.</p>

<p>이어서 N줄에 걸쳐 학교 이름 S(1 &le; |S| &le; 20, S는 공백없는 대소문자 알파벳 문자열)와 해당 학교가 지난 한 해동안 소비한 술의 양 L(0 &le; L &le; 10,000,000)이 공백으로 구분되어 정수로 주어진다.</p>
