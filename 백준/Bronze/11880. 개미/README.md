...
제출: 3755, 정답: 1384, 맞힌 사람: 1197, 정답 비율: 37.013%
...
<p>첫 줄에 테스트 케이스의 수 T가 주어집니다. (1 &le; T &le; 100,000)</p>

<p>각 테스트 케이스마다 한 줄에 하나씩 음이 아닌 정수 a, b, c가 공백을 사이로 두고 주어집니다. 여기서 a는 지우개의 가로의 길이, b는 지우개의 세로의 길이, c는 지우개의 높이를 나타냅니다. (1 &le; a, b, c &le; 10<sup>5</sup>)</p>
