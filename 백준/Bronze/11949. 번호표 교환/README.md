...
제출: 875, 정답: 736, 맞힌 사람: 682, 정답 비율: 86.220%
...
<p>그리고 M개의 카드가 있다. 이 카드는 1부터 M까지의 값을 가진다. 각 카드는 반드시 1부터 사용하며, k (2 &le; k &le; M) 번 카드는 k-1번 카드를 쓴 다음에 쓴다.</p>

<p>게임의 규칙은 다음과 같다.</p>

<ul>
	<li>선생님이 1번 학생에게 i번 카드를 준다. (1 &le; i &le;&nbsp;M)</li>
...
<p>첫 번째 줄에 학생의 수와 카드의 수를 나타내는 정수&nbsp;N, M (1 &le;&nbsp;N &le;&nbsp;100, 1 &le; M &le; 100) 이 공백으로 구분되어 입력된다.</p>

<p>두 번째 줄부터 N줄에 걸쳐서 각 학생이 가지는 번호표의 값 A<sub>i</sub> (1 &le; A<sub>i</sub> &le; 1000) 가 주어진다.</p>
