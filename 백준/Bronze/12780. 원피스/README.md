...
제출: 3046, 정답: 1898, 맞힌 사람: 1675, 정답 비율: 63.423%
...
<p>입력의 첫 줄에는 해적단이 획득한 단서의 문자열 <em>H</em>가 주어진다.(0 &lt; |<em>H</em>| &le; 100,000)</p>

<p>입력의 두 번째 줄에는 진아가 <em>H</em>에서 등장 횟수를 알고 싶은 문자열 <em>N</em>이 주어진다.(0 &lt; |<em>N</em>| &le; 10)</p>
