...
제출: 180, 정답: 83, 맞힌 사람: 78, 정답 비율: 48.148%
...
<p>The first line of input contains three integers: n, t and t<sub>0</sub> (1 &le; n &le; 100, 1 &le; t &le; 10 000, 1 &le; t<sub>0</sub> &le; 100) &mdash; the number of variants, the length of the test, and the time needed to secretly copy the solution from the notes.</p>

<p>The following n lines describe variants. The first integer m<sub>i</sub> (1 &le; m<sub>i</sub> &le; 100) is the number of tasks in the i-th variant. It is followed by mi integers t<sub>ij</sub> (1 &le; t<sub>ij</sub> &le; 100) &mdash; time needed for tasks.</p>
