...
제출: 245, 정답: 214, 맞힌 사람: 191, 정답 비율: 86.818%
...
<pre>
n
a<sub>1</sub> a<sub>2</sub> &hellip; a<sub>n</sub></pre>

<p>A dataset consists of two lines. The number of students n is given in the first line. n is an integer satisfying 2 &le; n &le; 1000. The second line gives scores of n students. a<sub>i</sub> (1 &le; i &le; n) is the score of the i-th student, which is a non-negative integer not greater than 1,000,000.</p>
