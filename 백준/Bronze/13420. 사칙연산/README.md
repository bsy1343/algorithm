...
제출: 4474, 정답: 2495, 맞힌 사람: 2236, 정답 비율: 57.525%
...
<p>출력은 표준 출력을 사용한다. 입력받은 데이터에 대해, 각 테스트 케이스의 답을 순서대로 1줄에 1개씩 출력한다. 주어진 수식이 정답일 경우 &ldquo;correct&rdquo;를, 오답일 경우 &ldquo;wrong answer&rdquo;를 출력한다. 문제의 정답이 32비트 정수가 넘어갈 수 있다.&nbsp;모든 범위가 부호가 있는 64비트 정수 이내이다.</p>