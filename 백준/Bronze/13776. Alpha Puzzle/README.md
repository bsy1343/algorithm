...
제출: 175, 정답: 146, 맞힌 사람: 122, 정답 비율: 84.138%
...
<p>You will be presented with a single puzzle solution which starts with a single integer, S, on a line by itself (10 &lt;= S &lt;=20). S is the size of the puzzle &ndash; the number of rows and columns of squares that it contains.</p>
