...
제출: 1054, 정답: 663, 맞힌 사람: 564, 정답 비율: 62.667%
...
<p>He put 50 envelopes at the front of the room, numbered sequentially from 1 to 50. Inside one he hid a rabbit &ndash; not a real one, of course, just a card with a rabbit picture on it! He then put cards in all the other envelopes so that if an envelope was chosen with a number lower than the one holding the rabbit, the card would read &ldquo;Try a higher number&rdquo;, otherwise the card would read &ldquo;Try a lower number&rdquo;.</p>
