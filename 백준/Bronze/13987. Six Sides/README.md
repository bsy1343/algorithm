...
제출: 408, 정답: 263, 맞힌 사람: 229, 정답 비율: 69.605%
...
<p>The first line of input contains six space-separated integers, representing the values written on the first player&rsquo;s die.</p>

<p>The second line of input contains the values on the second player&rsquo;s die in the same format.</p>
