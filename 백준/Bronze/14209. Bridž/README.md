...
제출: 566, 정답: 483, 맞힌 사람: 442, 정답 비율: 90.389%
...
<p>He wants to know if he&rsquo;s done a good job. Help Mirko and check!&nbsp;</p>

### 입력

<p>The first line of input contains the integer N (1 &le; N &le; 10 000) from the task.</p>

<p>Each of the following N lines contains Ki , a string consisting of characters &lsquo;A&rsquo;, &lsquo;K&rsquo;, &lsquo;Q&rsquo;, &lsquo;J&rsquo;, &lsquo;X&rsquo;, of length 13, representing the cards Mirko had in his hand after dealing them for the ith time.&nbsp;</p>
...
<p>Clarification of the example : Mirko has a total of 4 aces, 2 kings, 1 queen and 1 jack in his hand. This totals to 4 * 4 + 2 * 3 + 1 * 2 + 1 * 1 = 25 honor points.&nbsp;</p>