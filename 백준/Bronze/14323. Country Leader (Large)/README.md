...
제출: 230, 정답: 138, 맞힌 사람: 124, 정답 비율: 59.903%
...
<ul>
	<li>1 &le;&nbsp;T&nbsp;&le; 100.</li>
	<li>1 &le;&nbsp;N&nbsp;&le; 100.</li>
	<li>Each name consists of at most 20 characters and only consists of the uppercase English letters&nbsp;<code>A</code>&nbsp;through&nbsp;<code>Z</code>&nbsp;and &#39; &#39;(space).</li>
	<li>All names start and end with alphabet letters.</li>
</ul>
