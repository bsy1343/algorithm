...
제출: 2272, 정답: 1444, 맞힌 사람: 1291, 정답 비율: 66.273%
...
<p>첫 번째 줄에는 참가자의 수를 나타내는 자연수 N (1 &le; N &le; 3) 이 주어진다.</p>

<p>두 번째 줄부터 N 개의 줄에 걸쳐 세 개의 정수 S<sub>i</sub>, C<sub>i</sub>, L<sub>i</sub> (0 &le; S<sub>i</sub>&nbsp;&le; 620, 0 &le; C<sub>i</sub> &le; 50, 0 &le; L<sub>i</sub> &le; 179)가 주어진다.</p>
