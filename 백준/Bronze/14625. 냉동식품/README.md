...
제출: 2733, 정답: 805, 맞힌 사람: 719, 정답 비율: 30.635%
...
<p>첫째 줄과 두 번째 줄에 시작시간과 종료시간이 시 H(0 &le; H &le; 23)와 분 M(0 &le; M &le; 59)이 정수로 빈칸을 사이에 두고 주어진다. 세 번째 줄에는 몇 분이 나오는지 알고 싶은 숫자 N(0 &le; N &le; 9)이 주어진다.</p>
