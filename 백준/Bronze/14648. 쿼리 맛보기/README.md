...
제출: 3070, 정답: 1332, 맞힌 사람: 1105, 정답 비율: 45.139%
...
<p>첫째 줄에 수열의 길이를 뜻하는 n(1 &le; n &le; 1,000)과 쿼리의 개수를 뜻하는 q(1 &le; q &le; 10,000)가 주어진다. 둘째 줄에 길이 n의 수열이 하나의 공백을 사이에 두고 주어진다. 수열의 각 수는 -2,147,483,648보다 크거나 같고, 2,147,483,647보다 작거나 같은 정수이다.&nbsp;이후 셋째 줄 부터 q개의 줄에 걸쳐 쿼리가 주어진다. 쿼리의 형식은 &ldquo;1 a b&rdquo; 또는 &ldquo;2 a b c d&rdquo;이다. a, b, c, d는 n보다 작거나 같은 자연수이며, a &le; b, c &le; d임이 보장된다.</p>
