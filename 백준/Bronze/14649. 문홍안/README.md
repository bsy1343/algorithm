...
제출: 1098, 정답: 674, 맞힌 사람: 568, 정답 비율: 62.418%
...
<p>첫째 줄에는 김그네 씨의 재산을 나타내는 정수 P(0 &le; P &le; 290,000)가 주어진다. 둘째 줄에는 비서의 수 N(0 &le; N &le; 100)이 주어진다. 그 다음 줄부터 N개의 줄에 걸쳐 각 비서의 위치와 방향이 공백을 사이에 두고 주어진다. 위치는 돌의 번호로 주어지며, 방향은 &lsquo;L&rsquo;이면 왼쪽, &lsquo;R&rsquo;이면 오른쪽을 의미한다. 처음의 비서들이 같은 돌 위에서 출발하는 입력은 없다. 두 명 이상이 동시에 같은 돌에 올라올 수 있으며, 여러 명이 동시에 올라오면 여러 번 밟은 것으로 간주한다.</p>
...
<p style="text-align:center"><img alt="" src="https://onlinejudgeimages.s3-ap-northeast-1.amazonaws.com/problem/14649/2.png" style="height:254px; width:579px" /></p>
