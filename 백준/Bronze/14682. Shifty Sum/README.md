...
제출: 1304, 정답: 1090, 맞힌 사람: 1030, 정답 비율: 85.124%
...
<p>Suppose we have a number like 12. Let&rsquo;s define shifting a number to mean adding a zero at the end. For example, if we shift that number once, we get the number 120. If we shift the number again we get the number 1200. We can shift the number as many times as we want.</p>
...
<p>The first line of input contains the number N (1 &le; N &le; 10000). The second line of input contains k, the number of times to shift N (0 &le; k &le; 5).</p>
