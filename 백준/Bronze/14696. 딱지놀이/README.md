...
제출: 11018, 정답: 6948, 맞힌 사람: 5706, 정답 비율: 65.040%
...
<p>표준 출력으로 총 N 줄을 출력한다. 출력의 i번째 (1&nbsp;&le; i &le; N) 줄에 정확히 한 글자를 출력하는데, 출력하는 글자는 A, B, D 중 하나로 라운드 i의 결과를 나타낸다. 각 라운드의 결과는 A가 승자라면 A, B가 승자라면 B, 무승부라면 D이다.</p>