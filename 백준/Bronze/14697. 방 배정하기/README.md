...
제출: 17074, 정답: 7550, 맞힌 사람: 5638, 정답 비율: 44.293%
...
<p>표준 입력으로 방의 정원을 나타내는 서로 다른 세 자연수 A, B, C (1 &le; A &lt; B &lt; C &le; 50)와 전체 학생 수를 나타내는 자연수 N (1 &le; N &le; 300)이 공백으로 분리되어 한 줄에 주어진다.</p>
