...
제출: 1898, 정답: 1004, 맞힌 사람: 880, 정답 비율: 54.021%
...
<p>첫 번째 줄에 시침의 각도 &theta;<sub>1</sub>, 분침의 각도 &theta;<sub>2</sub> (0 &le; &theta;<sub>1</sub>, &theta;<sub>2</sub> &le; 359)가 정수로 주어진다. 시침, 분침의 각도는 12시 방향을 기준으로 시계방향으로 잰다. 예를 들어 3시 방향은 90, 9시 방향은 270 이다.</p>
