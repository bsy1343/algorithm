...
제출: 3132, 정답: 2080, 맞힌 사람: 1698, 정답 비율: 68.248%
...
<ol>
	...
	<li>그 합이 10으로 나뉘면 &ldquo;정당한 번호&rdquo;(유효)이고 그렇지 않으면 &ldquo;부당한 번호&rdquo;(유효하지 않음)로 판정된다.</li>
</ol>
...
<p>신용카드의 번호가 유효하면 &ldquo;T&rdquo;, 유효하지 않으면 &ldquo;F&rdquo;를 한 줄 씩 출력한다.</p>