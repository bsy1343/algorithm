...
제출: 4817, 정답: 3471, 맞힌 사람: 3230, 정답 비율: 74.596%
...
<p>이 경우, 수열의 뒷부분은 4, 2, 1 이 끝없이 반복된다.&nbsp;실제로 C(1)이 5&times;2<sup>60</sup>보다 작은 자연수인 모든 수열은 언젠가는 4, 2, 1로 끝나게 된다는 것이 알려져 있다.</p>

<p>주어진 입력 C(1)에 대하여 C(n)이 처음으로 1이 되는 n을 출력하시오.</p>

### 입력

<p>C(1); 1 &le; C(1) &le; 100000</p>
