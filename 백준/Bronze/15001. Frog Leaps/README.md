...
제출: 756, 정답: 482, 맞힌 사람: 427, 정답 비율: 62.887%
...
<ul>
	<li>On the first line one integer 2 &le; n &le; 10<sup>6</sup>, the total number of stops.</li>
	<li>Then follow n lines with one integer x<sub>i</sub>, the position of the ith stop in meters, with x<sub>i</sub> &lt; x<sub>i+1</sub>. Here 0 &le; x<sub>i</sub> &le; 10<sup>6</sup>. The frog&rsquo;s start location is at the first stop x<sub>0</sub>. Amsterdam is located at the last stop x<sub>n&minus;1</sub>.</li>
</ul>
