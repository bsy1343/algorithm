...
제출: 355, 정답: 260, 맞힌 사람: 242, 정답 비율: 75.155%
...
<ul>
	<li>A single integer 1 &le; n &le; 15, the number of pieces.</li>
	<li>The values of the pieces a<sub>0</sub>, a<sub>1</sub>, . . . , a<sub>n&minus;1</sub>, space-separated. It is given that 1 &le; a<sub>i</sub> &le; 100.</li>
</ul>

### 출력

<p>Output a single line containing two integers, the combined value of Alice&rsquo;s pieces, and the combined value of Bob&rsquo;s pieces.</p>