...
제출: 251, 정답: 216, 맞힌 사람: 194, 정답 비율: 86.607%
...
<ul>
	<li>One line containing the integer N (2 &le; N &le; 10), the number of settings;</li>
	<li>One line containing N distinct integers H<sub>i</sub> (1 &le; H &le; 500), the possible settings;</li>
	<li>One line containing the integer T (1 &le; T &le; 3000), the height of the tree.</li>
</ul>
