...
제출: 234, 정답: 159, 맞힌 사람: 141, 정답 비율: 69.118%
...
<p>In the game of chess, knights are unique due to their &ldquo;L-shaped&rdquo; movement. A knight can move, as shown in Figure A.1, by either moving two squares sideways and one square up or down, or moving one square sideways and two squares either up or down.</p>
...
<p>The input will consist of 5 lines, each having 5 characters. All characters will be either &rsquo;k&rsquo;, indicating the placement of a knight, or &rsquo;.&rsquo;, indicating an empty space on the board.</p>
