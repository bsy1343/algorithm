...
제출: 270, 정답: 214, 맞힌 사람: 191, 정답 비율: 80.591%
...
<p>The input consists of a single line containing the integer S (3 &le; S &le; 32,767).</p>
...
<p>The compact representations must be printed in the form &ldquo;x,y&rdquo;, with exactly one comma between x and y and no other characters.</p>