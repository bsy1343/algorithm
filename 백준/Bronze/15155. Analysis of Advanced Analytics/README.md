...
제출: 194, 정답: 157, 맞힌 사람: 141, 정답 비율: 83.432%
...
<p>The input consists of two lines. The first line contains two integers n (1 &le; n &le; 1 000), which is the number of days in the semester, and k (1 &le; k &le; 1 000), which is the number of pages in each notebook.</p>

<p>The second line contains n integers a<sub>1</sub>, a<sub>2</sub>, . . . , a<sub>n</sub> (1 &le; a<sub>i</sub> &le; k), where a<sub>i</sub> is the number of pages needed for the i th day in the semester.</p>
