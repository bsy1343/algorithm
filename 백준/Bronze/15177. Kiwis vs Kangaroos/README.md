...
제출: 225, 정답: 170, 맞힌 사람: 141, 정답 비율: 76.630%
...
<ol>
	...
	<li>For each letter in the secret phrase, count the number of times that letter appears in the animal&rsquo;s key. Uppercase and lowercase should be treated as the same.</li>
...
<p>If there is a winner of the feud, display the winner&rsquo;s name: either Kangaroos or Kiwis. If there is a tie, display Feud continues instead.</p>