...
제출: 948, 정답: 722, 맞힌 사람: 657, 정답 비율: 77.936%
...
<p>For example: In the word &ldquo;arrrrrghh&rdquo;, the letter &ldquo;r&rdquo; appears 5 times while &ldquo;h&rdquo; appears twice.</p>

<p>Write a program that reads a pirate word from the terminal and writes the letter that occurs most frequently.</p>

<p>It is guaranteed that only one letter is the most repeated. That is, words like &ldquo;aipo&rdquo; won&rsquo;t appear because no single letter wins.</p>
