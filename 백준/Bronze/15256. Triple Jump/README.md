...
제출: 117, 정답: 70, 맞힌 사람: 66, 정답 비율: 64.078%
...
<p>The first line of the data set contains an integer 1 &le; n &le; 1000, the number of steps you took. This is followed by a line with n doubles 0.0 &le; x<sub>i</sub> &le; 100.0; x<sub>i</sub> is the place where you touched the track/sandbox on the i th step.</p>

### 출력

<p>For each data set, output &ldquo;Data Set x:&rdquo; on a line by itself, where x is its number. Then output the distance of the triple jump, rounded to two decimals.</p>
