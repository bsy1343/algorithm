...
제출: 794, 정답: 717, 맞힌 사람: 675, 정답 비율: 90.848%
...
<p>Each line of the input contains the information of one student. For each student, there are two positive integers c and d (1 &le; c, d &le; 1000) that show the amount of call (in minutes) and data usage (in megabytes) for the student, respectively. The input terminates with &ldquo;0 0&rdquo; that should not be processed.</p>
