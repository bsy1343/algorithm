...
제출: 171, 정답: 116, 맞힌 사람: 107, 정답 비율: 70.395%
...
<p>There are multiple test cases in the input. Each test is given in one line consisting of four space-separated 4-digit strings. The leftmost digit of the given card number is guaranteed to be non-zero. The input terminates with a line containing &ldquo;0000 0000 0000 0000&rdquo; that should not be processed.</p>

### 출력

<p>For each test case, output a line containing &ldquo;Yes&rdquo; or &ldquo;No&rdquo; depending on whether the card number is valid or not, respectively</p>