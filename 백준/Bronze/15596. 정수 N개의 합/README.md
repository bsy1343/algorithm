...
제출: 146714, 정답: 73128, 맞힌 사람: 63076, 정답 비율: 50.593%
...
<ul>
	...
	<ul>
		<li><code>a</code>: 합을 구해야 하는 정수 <code>n</code>개가 저장되어 있는 배열 (0 &le; a[i] &le; 1,000,000, 1 &le; n &le; 3,000,000)</li>
	...
	<ul>
		<li><code>a</code>: 합을 구해야 하는 정수 <code>n</code>개가 저장되어 있는 리스트 (0 &le; a[i] &le; 1,000,000, 1 &le; n &le; 3,000,000)</li>
