...
제출: 401, 정답: 206, 맞힌 사람: 146, 정답 비율: 45.912%
...
<p>Write a program to convert a stream of decimal numbers into ternary format, so they fit the new system&rsquo;s input bus.</p>
...
<ul>
	<li>One line with an integer n (1 &le; n &le; 10<sup>6</sup>), the size of the data stream.</li>
	<li>n lines with one decimal integer v<sub>i</sub> (0 &le; v &lt; 3<sup>20</sup>), the decimal representation of the i-th integer in the data stream.</li>
</ul>
