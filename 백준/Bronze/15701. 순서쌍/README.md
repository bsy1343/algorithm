...
제출: 1251, 정답: 714, 맞힌 사람: 663, 정답 비율: 60.603%
...
<p>자연수 N이 주어졌을 때, a&nbsp;&times; b가 N과 같은 서로 다른 순서쌍 (a, b)의 개수를 구하는 프로그램을 작성하시오. a와 b는 자연수이어야 한다.</p>

### 입력

<p>첫째 줄에 자연수 N (1 &le; N &le; 1,000,000,000)이 주어진다.</p>
