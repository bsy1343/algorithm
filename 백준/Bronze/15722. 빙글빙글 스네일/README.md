...
제출: 872, 정답: 539, 맞힌 사람: 484, 정답 비율: 68.750%
...
<p>달팽이가 움직인 시간이 n초로 주어진다. (0 &le; n &le; 1000, n은 0이상의 정수)</p>
...
<ul>
	<li>방향에 따라 x와y좌표의 증감의 규칙이 있다.</li>
	<li>달팽이의 자취에서 한 변을 1회로 보자. 이때 변의 길이는 2회 동안 유지되며 변의 길이가 변할 때는 1씩 규칙적으로 증가한다.</li>
</ul>