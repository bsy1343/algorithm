...
제출: 2850, 정답: 1739, 맞힌 사람: 1537, 정답 비율: 62.684%
...
<p>N행 N열의 의자 모두 사람들이 앉아있고 사람들의 매력지수 X[i][j] 가 주어진다. (1 &le; i, j &le; N) i행 j열의 매력지수는 X[i][j]이고, A 가 B 보다 매력지수가 더 높으면 A 가 더 잘생겼다고 할 수 있다.</p>
...
<p>입력의 첫째 줄에 의자가 놓인 행과 열의 수 N(1 &le; N &le; 1000)이 주어지고 , 진서가 앉은 의자가 위치한 행 a, 열 b가 주어진다. 이후 두 번째 줄부터 N+1 줄까지 강의실에 앉아있는 학생들의 매력지수 X[i][j](1 &le; X &le; 50000)가 주어진다. X[i][j] 는 i행 j열에 앉은 학생의 매력지수이다.&nbsp;</p>
