...
제출: 1819, 정답: 880, 맞힌 사람: 757, 정답 비율: 50.232%
...
<p>이 방법을 통해 &rdquo;I AM JOHN&rdquo; 이라는 평문을 4글자 밀어 암호문을 작성하면 &rdquo;M EQ NSLR&rdquo;이 된다. 우리는 이를 바탕으로 카이사르 암호 프로그램을 작성하고자 한다. 단, 추가된 점이 조금 있다.</p>
...
<p>첫&nbsp;번째 줄에는 다음 알파벳으로 밀 횟수 k(1 &le; k &le; 10,000,000), 그리고 문자열 s의 길이 |s|(1 &le; |s| &le; 100,000)가 입력으로 들어온다.</p>
