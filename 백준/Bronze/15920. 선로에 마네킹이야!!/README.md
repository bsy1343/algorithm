...
제출: 949, 정답: 565, 맞힌 사람: 502, 정답 비율: 59.338%
...
<ol>
	...
	<li>레버를 당긴다. 레버의 상태가 &ldquo;당긴 상태&rdquo;일 경우 &ldquo;당기지 않은 상태&rdquo;로 바뀌고, 반대로 &ldquo;당기지 않은 상태&rdquo;일 경우 &ldquo;당긴 상태&rdquo;로 바뀐다.</li>
</ol>
...
<ol>
	...
	<li>광차가 A구역에서 B구역으로 이동하는 순간, 레버의 상태에 따라 광차가 타는 선로가 결정된다. 레버가 &ldquo;당기지 않은 상태&rdquo;이면 광차는 5개의 마네킹이 묶여 있는 아래쪽 선로를 타고, &ldquo;당긴 상태&rdquo;이면 1개의 마네킹이 묶여 있는 위쪽 선로를 탄다.</li>
...
<p>첫째 줄에 문자열의 길이 N (1 &le; N &le; 10) 이 주어진다.</p>

<p>둘째 줄에 문자열 S가 주어진다. S는 글자 &ldquo;W&rdquo;와 &ldquo;P&rdquo;로만 이루어져 있다. 이는 당신의 행동을 순서대로 나타내며, &ldquo;W&rdquo;는 1초 기다리는 행동, &ldquo;P&rdquo;는 레버를 당기는 행동을 의미한다.</p>
