...
제출: 307, 정답: 282, 맞힌 사람: 246, 정답 비율: 92.481%
...
<p>Let us observe the above-mentioned phenomenon in some concrete data. Incomes of <i>n</i> people, <i>a</i><sub>1</sub>, &hellip; , <i>a<sub>n</sub></i>, are given. You are asked to write a program that reports the number of people whose incomes are less than or equal to the average (<i>a</i><sub>1</sub> + &hellip; + <i>a<sub>n</sub></i>) / <i>n</i>.</p>
...
<pre>
<i>n</i>
<i>a</i><sub>1</sub> <i>a</i><sub>2</sub> &hellip; <i>a<sub>n</sub></i></pre>

<p>A dataset consists of two lines. In the first line, the number of people <i>n</i> is given. <i>n</i> is an integer satisfying 2 &le; <i>n</i> &le; 10 000. In the second line, incomes of <i>n</i> people are given. <i>a<sub>i</sub></i> (1 &le; <i>i</i> &le; <i>n</i>) is the income of the <i>i</i>-th person. This value is an integer greater than or equal to 1 and less than or equal to 100 000.</p>
