...
제출: 290, 정답: 128, 맞힌 사람: 118, 정답 비율: 44.195%
...
<ul>
	<li>one line with an integer n (1 &le; n &le; 1 000), giving the number of rival pairs.</li>
	<li>one line with n integers h<sub>1</sub>, . . . , h<sub>n</sub> (1 &le; h<sub>i</sub> &le; 1 000 for each i), the i-th value giving the Power Level of the i-th most important hero.</li>
	<li>one line with n integers v<sub>1</sub>, . . . , v<sub>n</sub> (1 &le; v<sub>i</sub> &le; 1 000 for each i), the i-th value giving the Power Level of the i-th most important villain.</li>
</ul>
