...
제출: 264, 정답: 161, 맞힌 사람: 141, 정답 비율: 59.244%
...
<p>The input starts with a line containing two integers N (4 &le; N &le; 100 000), which is the length of the string, and K (1 &le; K &le; 10<sup>18</sup>), which is the number of times you should perform a switcheroo to S. It is guaranteed that N is a multiple of 4.</p>
