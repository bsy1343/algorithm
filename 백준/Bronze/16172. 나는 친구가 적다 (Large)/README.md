...
제출: 5767, 정답: 2052, 맞힌 사람: 1635, 정답 비율: 40.162%
...
<p>첫 번째 줄에는 알파벳 소문자, 대문자, 숫자로 이루어진 문자열 S가 주어진다. (1 &le; |S| &le; 200,000) 두 번째 줄에는 성민이가 찾고자 하는 알파벳 소문자, 대문자로만 이루어진 키워드 문자열 K가 주어진다. (1 &le; |K|&nbsp;&le; 200,000)</p>
