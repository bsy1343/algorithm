...
제출: 5092, 정답: 2077, 맞힌 사람: 1655, 정답 비율: 40.534%
...
<p>입력은 표준입력을 사용한다. 첫 번째 줄에 네 정수 <em>a</em>, <em>b</em>, <em>n</em>, <em>w</em>가 한 줄에 주어진다. 1 &le; <em>a</em> &le; 1,000, 1 &le; <em>b</em> &le; 1,000, 2 &le; <em>n</em> &le; 1,000, 2 &le; <em>w</em> &le; 1,000,000이다.</p>
