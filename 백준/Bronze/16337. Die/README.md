...
제출: 384, 정답: 203, 맞힌 사람: 160, 정답 비율: 53.691%
...
<p>The input specifies the top side of a captured die. It consists of three lines, each with three characters &ldquo;<code>o</code>&rdquo; or &ldquo;<code>:</code>&rdquo; representing a dent or a smooth surface, respectively</p>

### 출력

<p>Output a single line with either the number represented by the captured top side of the die or &ldquo;<code>unknown</code>&rdquo; if the image is incorrect.</p>