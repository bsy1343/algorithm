...
제출: 2042, 정답: 977, 맞힌 사람: 880, 정답 비율: 48.325%
...
<p>If a word is not ended as it stated in the table, put &lsquo;-us&rsquo; at the end of the word. For example, a word &ldquo;cup&rdquo; is translated into &ldquo;cupus&rdquo; and a word &ldquo;water&rdquo; is translated into &ldquo;wateres&rdquo;.</p>

<p>Write a program that translates English words into pseudo-Latin words.</p>

### 입력

<p>Your program is to read from standard input. The input starts with a line containing an integer, <em>n</em> (1 &le; <em>n</em> &le; 20), where <em>n</em> is the number of English words. In the following <em>n</em> lines, each line contains an English word. Words use only lowercase alphabet letters and each word contains at least 3 and at most 30 letters.</p>
