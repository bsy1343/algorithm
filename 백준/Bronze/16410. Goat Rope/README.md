...
제출: 191, 정답: 159, 맞힌 사람: 148, 정답 비율: 83.146%
...
<p>The input consists of a single line containing six space-separated integers x, y, x<sub>1</sub>, y<sub>1</sub>, x<sub>2</sub>, and y<sub>2</sub>, each in the range [&minus;999, 999].</p>
...
<p>Print the minimum distance from the goat&rsquo;s post to the house, with a relative or absolute error no more than 0.001.</p>