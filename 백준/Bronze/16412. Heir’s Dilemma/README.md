...
제출: 218, 정답: 191, 맞힌 사람: 163, 정답 비율: 90.556%
...
<p>Your favorite uncle has passed away, leaving you a large estate. Bank account numbers, locations of safe deposit boxes, and GPS coordinates to buried treasures are all locked in an electronic safe in your uncle&rsquo;s office behind a picture of dogs playing poker. One day he showed you the safe with its 9 digit keypad (digits 1 through 9). He told you he wasn&rsquo;t worried about anyone breaking into his safe because it&rsquo;s equipped with a self-destruct mechanism that will destroy the contents if anyone attempts a forced entry.</p>
...
<p>Here&rsquo;s what you know:</p>
...
<p>The input is a line with two space-separated integers L and H, where 123 456 &le; L &lt; H &le; 987 654</p>

### 출력

<p>Print one integer, the total number of possible combinations to the safe, where each combination c must satisfy the three constraints above, and lie in the range L &le; c &le; H.</p>