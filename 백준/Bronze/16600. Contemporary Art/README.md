...
제출: 2685, 정답: 2232, 맞힌 사람: 2106, 정답 비율: 84.005%
...
<ul>
	<li>One line with an integer a (1 &le; a &le; 10<sup>18</sup>), the area of the image in square centimetres.</li>
</ul>

### 출력

<p>Output the total length of filament needed for the frame, in centimetres. Your answer should have an absolute or relative error of at most 10<sup>&minus;6</sup>.</p>