...
제출: 319, 정답: 94, 맞힌 사람: 87, 정답 비율: 29.693%
...
<p>The first line contains two integers n (1 &le; n &le; 10<sup>6</sup>), which is the number of words, and L (0 &le; L &le; 10<sup>6</sup>), which is the desired length of typesetting.</p>
