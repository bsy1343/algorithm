...
제출: 214, 정답: 144, 맞힌 사람: 127, 정답 비율: 67.914%
...
<p>The first line of input contains two integers n (1 &le; n &le; 10<sup>9</sup>) and m (1 &le; m &le; 10<sup>5</sup>), the length of the track and the number of locations Bethany recorded in her list. The next line contains m integers each of which is at least 0 and at most n &minus; 1. These are the list of locations Bethany recorded. The list is in increasing order of time.</p>
