...
제출: 4318, 정답: 2630, 맞힌 사람: 2307, 정답 비율: 63.571%
...
<p>민승이는 N(1 &le; N &le; 1,000,000)명의 학생들에게 양의 정수로 된 라벨을 붙이려고 한다. 하지만 모든 학생들은 숫자 L(0 &le; L &le; 9)이 자신의 라벨 숫자에 포함되길 원치 않는다.&nbsp;</p>
