...
제출: 3857, 정답: 3032, 맞힌 사람: 2828, 정답 비율: 80.593%
...
<p>각 줄은 나무의 나이 a(1 &le; a &le; 20)로 시작하며, 그 뒤로 2a 개의 정수가 공백을 두고 주어집니다. 2a 개의 정수는&nbsp;splitting factor와 가지치기 한 가지의 수가 level 별로 나열된 것입니다.</p>
