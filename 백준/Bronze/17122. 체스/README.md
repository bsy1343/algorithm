...
제출: 1313, 정답: 573, 맞힌 사람: 473, 정답 비율: 44.962%
...
<ul>
	<li>표기법 1: 해당 칸의 열 번호를 대문자로 적고 행 번호를 적는 방법 (예를 들어 &ldquo;A1&rdquo;, &ldquo;D4&rdquo;, &ldquo;H8&rdquo;)</li>
...
<p>위의 표기법을 이용하면 하나의 칸을 두 가지 다른 방법으로 표현할 수 있다. 가령 &ldquo;A3&rdquo; 와 &ldquo;17&rdquo;은 같은 칸을 가리킨다 (검은 색). 다른 예로, &ldquo;38&rdquo;과 &ldquo;F5&rdquo;은 같은 칸을 가리킨다 (흰 색).&nbsp;</p>
...
<p>각 테스트 케이스에 대해, 주어진 두 칸이 같은 색이면 &ldquo;YES&rdquo;를, 아니면 &ldquo;NO&rdquo;를 출력하시오 (따옴표는 제외).&nbsp;</p>

### 힌트

<ul>
	<li>&ldquo;A1&rdquo; 과 &ldquo;17&rdquo;은 둘 다 검은 색 칸이다.</li>
	<li>&ldquo;A1&rdquo; 과 &ldquo;1&rdquo;은 같은 칸이며 당연히 같은 색이다.</li>
	<li>&ldquo;B3&rdquo; 은 흰 칸을 나타내고 &nbsp;&ldquo;21&rdquo; 은 검은 칸을 나타낸다.</li>
	<li>&ldquo;G5&rdquo; 은 검은 칸을 나타내고 &ldquo;40&rdquo; 은 흰색 칸을 나타낸다.</li>
</ul>