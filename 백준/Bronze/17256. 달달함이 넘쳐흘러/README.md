...
제출: 10428, 정답: 8195, 맞힌 사람: 7825, 정답 비율: 79.458%
...
<p>첫째 줄에&nbsp;케이크 수 a를 구성하는 자연수 a.x, a.y, a.z 가 차례대로 주어진다. (1 &le; a.x, a.y, a.z &le; 100)</p>

<p>둘째 줄에&nbsp;케이크 수 c를 구성하는 자연수 c.x, c.y, c.z 가 차례대로 주어진다. (1 &le; c.x, c.y, c.z &le; 100)</p>

### 출력

<p>문제의 조건을 만족하는&nbsp;b.x, b.y, b.z를 하나의 공백을 사이에 두고 차례대로 출력한다.</p>

<p>b는 1 &le; b.x, b.y, b.z &le; 100 이고 반드시 유일하게 존재한다.</p>