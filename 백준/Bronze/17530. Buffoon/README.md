...
제출: 1497, 정답: 1107, 맞힌 사람: 1018, 정답 비율: 75.913%
...
<p>The first line of input contains an integer N, (2 &le; N &le; 10<sup>4</sup>). The next N lines will contain N positive integers v<sub>1</sub>, . . . , v<sub>N</sub> , one on each line, corresponding to the number of votes each candidate received, in order of registration. Since the Kingdom of matchings population is 100,000 people, the total number of votes will not exceed this value, i.e &Sigma;v<sub>i</sub> &le; 100,000.</p>

### 출력

<p>Your program must output a single line containing the character &lsquo;S&rsquo; if young Carlos is elected as buffoon, or the character &lsquo;N&rsquo; otherwise.</p>