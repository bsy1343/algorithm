...
제출: 281, 정답: 163, 맞힌 사람: 136, 정답 비율: 59.130%
...
<p>Let&rsquo;s help Vinicius by calculating for him the number of signs he needs to count to have completed at least 10%, 20%, . . . , 90% of his training, given the number of laps he wants to run and the total number of signs along the track.</p>
...
<p>The input consists of a single line, which contains two integers, V and N (1 &le; V, N &le; 10<sup>4</sup>), where V is the desired number of laps and N is the number of signs along the track.</p>
