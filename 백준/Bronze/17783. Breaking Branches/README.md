...
제출: 491, 정답: 420, 맞힌 사람: 374, 정답 비율: 86.374%
...
<p>Your parents decided that it would be &ldquo;fun&rdquo; to spend the entire Sunday walking near the Mookerheide close to Nijmegen.</p>
...
<ul>
	<li>A line containing a single integer 2 &le; n &le; 10<sup>9</sup>, the length of the branch.</li>
</ul>
...
<ul>
	...
	<li>If Alice can win, print the length of a piece of branch Alice can break off as a winning move. This should be an integer between 1 and n &minus; 1, inclusive.</li>
</ul>
