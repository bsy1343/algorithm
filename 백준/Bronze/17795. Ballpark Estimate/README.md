...
제출: 247, 정답: 187, 맞힌 사람: 156, 정답 비율: 75.000%
...
<p>The closeness of the representation r of a number n is defined by abs(r &minus; n).</p>
...
<ul>
	<li>one line with the positive integer n (1 &le; n &le; 10<sup>18</sup>).</li>
</ul>
