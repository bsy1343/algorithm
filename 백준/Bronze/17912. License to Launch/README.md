...
제출: 1213, 정답: 958, 맞힌 사람: 879, 정답 비율: 78.905%
...
<p>On the first line there is a single integer n (1 &le; n &le; 100 000) the number of days for which the launch license is valid. On the second line follows n integers between 0 and 10<sup>9</sup> where the i&rsquo;th integer is the amount of space junk on the i&rsquo;th day. The first day is day i = 0.</p>
