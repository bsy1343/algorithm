...
제출: 581, 정답: 396, 맞힌 사람: 360, 정답 비율: 69.498%
...
<ul>
	<li>Two integers n and c (1 &le; n &le; 100, 1 &le; c &le; 10), giving the number of songs and the crossfade time in seconds.</li>
	<li>n lines of the form m:ss (0:30 &le; m:ss &le; 9:59), giving the song lengths (with one digit for the number of whole minutes and two digits for the remaining seconds).</li>
</ul>
