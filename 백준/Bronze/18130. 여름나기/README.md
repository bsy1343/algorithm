...
제출: 1347, 정답: 376, 맞힌 사람: 322, 정답 비율: 31.787%
...
<p style="text-align: center;"><img alt="" src="%EB%B0%B1%EC%A4%80/Bronze/18130.%E2%80%85%EC%97%AC%EB%A6%84%EB%82%98%EA%B8%B0/dc1ee18a.png" data-original-src="%EB%B0%B1%EC%A4%80/Bronze/18130.%E2%80%85%EC%97%AC%EB%A6%84%EB%82%98%EA%B8%B0/dc1ee18a.png" data-original-src="https://upload.acmicpc.net/2f10a8d8-46b6-49e2-9616-73eed9f58b03/" onerror="this.onerror=null;this.src=this.dataset.originalSrc" /></p>
...
<p>첫 줄에 두 정수 진열된 손 선풍기의 개수 <em>N</em>(1 &le; <em>N</em> &le; 10,000) 와&nbsp;현석이가 집까지 가는데 걸어가는 시간 <em>Q</em>(1 &le; <em>Q</em> &le; 1,000,000)가 주어진다.</p>

<p>두 번째 줄부터 <em>N+1</em>번째 줄까지 세 정수 <em>P, K, C</em>가 주어지는데 <em>P</em>(0 &le; <em>P</em> &le; 100,000)는 손 선풍기의 가격, <em>K</em>(1 &le; <em>K</em> &le; 1,000,000)는 추가비용을 내야 하는 시간 간격, <em>C</em>(1 &le; <em>C</em> &le; 1,000,000)는 추가비용의 초기값을 의미한다.</p>
