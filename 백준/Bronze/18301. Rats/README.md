...
제출: 9063, 정답: 7146, 맞힌 사람: 6899, 정답 비율: 79.081%
...
<p style="text-align: center;">N :=&nbsp;&lfloor;(n<sub>1</sub> + 1)(n<sub>2</sub> + 1)/(n<sub>12</sub> + 1) - 1&rfloor;</p>

<p>where &lfloor;x&rfloor; is the floor of a real number x, i.e., the closest integer less than or equal to x.</p>
...
<ul>
	<li>0 &le; n<sub>1</sub>, n<sub>2</sub> &le; 10 000;</li>
	<li>0 &le; n<sub>12</sub> &le; min(n<sub>1</sub>, n<sub>2</sub>).</li>
</ul>