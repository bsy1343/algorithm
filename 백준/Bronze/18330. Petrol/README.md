...
제출: 2606, 정답: 1902, 맞힌 사람: 1803, 정답 비율: 73.263%
...
<p>The input consists of two lines. The first line contains an integer n (0 ⩽ n ⩽ 200), specifying the amount of petrol that will be used in the next month. The second line contains an integer k (0 ⩽ k ⩽ 360), showing the quota left in Mahya&rsquo;s fuel card at the end of current month.</p>
