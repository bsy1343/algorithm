...
제출: 2746, 정답: 1291, 맞힌 사람: 1079, 정답 비율: 51.113%
...
<p><img width="212" height="135" alt="" src="%EB%B0%B1%EC%A4%80/Bronze/1942.%E2%80%85%EB%94%94%EC%A7%80%ED%84%B8%EC%8B%9C%EA%B3%84/6afdeb29.png" data-original-src="https://boja.mercury.kr/assets/problem/1942-1.png" onerror="this.onerror=null;this.src=this.dataset.originalSrc" /></p>
<p>디지털시계는 일반적으로 시각을 &ldquo;hh:mm:ss&rdquo;의 형태로 표현한다. hh는 00 이상 23 이하의 값을, mm과 ss는 00 이상 59 이하의 값을 가질 수 있다. 이러한 형태의 시각에서 콜론(&ldquo;:&rdquo;)을 제거하면 &ldquo;hhmmss&rdquo;라는 정수를 얻을 수 있는데, 이러한 정수를 시계 정수라고 한다. 예를 들어, 오후 5시 5분 13초, 즉 17:05:13의 시계 정수는 170513이고, 오전 0시 7분 37초, 즉 00:07:37의 시계 정수는 737이다.</p>
...
<p>세 개의 입력이 주어진다. 첫째 줄부터 세 줄에 걸쳐 시작하는 시각과 끝나는 시각이 &ldquo;hh:mm:ss&rdquo;의 형태로 주어진다. 시작하는 시각과 끝나는 시각 사이에는 빈 칸이 하나 있어서, 한 줄마다 (빈 칸을 포함하여) 총 17글자가 입력으로 주어진다. 시작하는 시각과 끝나는 시각은 항상 다르다.</p>
