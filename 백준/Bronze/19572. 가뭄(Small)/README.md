...
제출: 2230, 정답: 1347, 맞힌 사람: 1233, 정답 비율: 60.441%
...
<p>3개의 양의 정수가 입력으로 들어온다. 각각은 <em>d</em><sub>1</sub>, <em>d</em><sub>2</sub>, <em>d</em><sub>3</sub>을 의미한다.&nbsp;(1&nbsp;&le; <em>d</em><sub>1</sub>, <em>d</em><sub>2</sub>, <em>d</em><sub>3</sub>&nbsp;&le; 10<sup>6</sup>)</p>
