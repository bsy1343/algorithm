...
제출: 293, 정답: 140, 맞힌 사람: 128, 정답 비율: 48.302%
...
<p>There are three lines of input. Each line contains one positive integer. The first line contains the value of P. The second line contains N, the number of people who have the disease on Day 0. The third line contains the value of R. Assume that P &le; 10<sup>7</sup> and N &le; P and R &le; 10.</p>
