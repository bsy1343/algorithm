...
제출: 299, 정답: 244, 맞힌 사람: 231, 정답 비율: 81.625%
...
<p>The first line of input contains the number of drops of paint, N, where 2 &le; N &le; 100 and N is an integer. Each of the next N lines contain exactly two positive integers X and Y separated by one comma (no spaces). Each of these pairs of integers represents the coordinates of a drop of paint on the canvas. Assume that X &lt; 100 and Y &lt; 100, and that there will be at least two distinct points. The coordinates (0, 0) represent the bottom-left corner of the canvas.</p>
