...
제출: 248, 정답: 124, 맞힌 사람: 98, 정답 비율: 48.756%
...
<p>In the first sample, the first needle intersects a vertical line ($x = 1$), but the second doesn&#39;t. So the fraction of needles that intersect vertical lines is $1/2$ and the corresponding approximation of $\pi$ is $4$.</p>

<p>In the second sample, both the needles intersect vertical lines ($x = 1$ and $x = 0$), so the fraction of needles that intersect vertical lines is $1$ and the corresponding approximation of $\pi$ is $2$.</p>