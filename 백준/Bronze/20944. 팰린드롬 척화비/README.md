...
제출: 3789, 정답: 3063, 맞힌 사람: 2765, 정답 비율: 82.439%
...
<ul>
	<li>팰린드롬 : <span style="color:#999999;">(<em>앞뒤가 똑같은 팰린드롬~</em>)</span> &ldquo;u&rdquo;, &ldquo;xyx&rdquo;, &ldquo;krrk&rdquo;&nbsp;같이 뒤집어 읽어도 같은 문자열을 뜻한다.</li>
	<li>수미상관 : <span style="color:#999999;">(<em>앞뒤가 똑같은 수미상관~</em>)</span> &ldquo;z&rdquo;, &ldquo;pqpq&rdquo;, &ldquo;astoast&rdquo;&nbsp;같이 앞쪽&nbsp;절반이 뒤쪽 절반과 같은 문자열을 뜻한다. 정확히는, 길이가 $N$인 문자열이면 길이가 $\left\lfloor\frac{N}{2}\right\rfloor$인 접두사와 접미사가 동일한 문자열을 뜻한다.</li>
</ul>
