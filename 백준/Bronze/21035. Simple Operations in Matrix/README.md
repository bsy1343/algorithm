...
제출: 165, 정답: 139, 맞힌 사람: 128, 정답 비율: 84.768%
...
<p>The first line contains two integers: <em>N</em> <em>M</em>&nbsp;(1 &le; <em>N</em>, <em>M</em> &le; 50) denoting the size of the matrix (number of rows and columns, respectively). The next <em>N</em> lines, each contains <em>M</em> integers: <em>A<sub>i</sub></em><sub>,<em>j</em></sub> (-100 &le;&nbsp;<em>A<sub>i</sub></em><sub>,<em>j</em></sub> &le; 100) denoting the matrix element at the <em>i</em>-th row and <em>j</em>-th column for 1 &le; <em>i</em> &le; <em>N</em> and 1 &le; <em>j</em> &le; <em>M</em>, respectively. The next line contains an integer: <em>Q</em> (0 &le; <em>Q</em> &le; 100) denoting the number of queries. The next <em>Q</em> lines, each contains a query in one of the following format:</p>

<ul>
	<li><code>row</code> <em>k</em> <em>val</em> (1 &le; <em>k</em> &le; <em>N</em>; -100 &le; <em>val</em> &le; 100)</li>
	<li><code>col</code> <em>k</em> <em>val</em> (1 &le; <em>k</em> &le; <em>M</em>; -100 &le; <em>val</em> &le; 100)</li>
</ul>
