...
제출: 11103, 정답: 4303, 맞힌 사람: 3803, 정답 비율: 40.596%
...
<p>알파벳 대소문자로 이루어진 영어 단어가 하나 있을 때, a를 1로, b를 2로, &hellip;, z를 26으로, A를 27로, &hellip;, Z를 52로 하여 그 합을 구한다. 예를 들어 cyworld는 합을 구하면 100이 되고, abcd는 10이 된다.</p>
