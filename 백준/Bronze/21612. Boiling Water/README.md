...
제출: 3398, 정답: 2439, 맞힌 사람: 2324, 정답 비율: 71.618%
...
<p style="text-align: center;">P = 5 &times; B &minus; 400</p>
...
<p>Note that the science of this problem is generally correct but the values of 100<sup>◦</sup>C and 100 kPa are approximate and the formula is a simplification of the exact relationship between water&rsquo;s boiling point and atmospheric pressure.</p>

### 입력

<p>The input is one line containing an integer B where B &ge; 80 and B &le; 200. This represents the temperature in <sup>◦</sup>C at which water begins to boil.</p>
