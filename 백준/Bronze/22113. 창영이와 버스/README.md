...
제출: 992, 정답: 767, 맞힌 사람: 679, 정답 비율: 81.220%
...
<ul>
	...
	<li>1 &le; <em>M</em> &le; <em>N</em></li>
	<li>1 &le;&nbsp;<em>A</em><sub><em>S,E</em></sub> &le; 1,000 (1 &le; <em>S, E</em> &le; <em>N</em>)</li>
	<li>버스의 번호는&nbsp;1 이상 <em>N</em> 이하의 자연수</li>
	<li>창영이는 같은 버스를 여러 번 이용하지 않는다.</li>
</ul>