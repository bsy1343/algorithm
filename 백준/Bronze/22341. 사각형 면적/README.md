...
제출: 5318, 정답: 1992, 맞힌 사람: 1598, 정답 비율: 39.603%
...
<ul>
	<li>만약 점이 종이의 경계나 밖에 있다면, 즉 X &ge; A이거나, Y &ge; B라면 이 점은 무시된다.</li>
...
<ul>
	...
	<li>1 &le; C &le; 10 000</li>
	<li>처리할 점 (X, Y)는 모두 1 &le; X, Y &le; N를 만족</li>
</ul>