...
제출: 187, 정답: 172, 맞힌 사람: 133, 정답 비율: 95.000%
...
<ul>
	...
	<li>児童はマス&nbsp;<i>(i, j)</i>&nbsp;に対して&nbsp;<i>a<sub>i</sub>&nbsp;&times; b<sub>j</sub></i>&nbsp;の結果を 10 進法表記で書き込む．このとき，先頭に不必要な 0 をつけることはない．</li>
</ul>
...
<p>データセットの最初の行は，二つの整数&nbsp;<i>n</i>&nbsp;と&nbsp;<i>m</i>&nbsp;からなる．<i>n</i>&nbsp;は縦の行数，<i>m</i>&nbsp;は横の列数である．この値は&nbsp;<i>1 &le; n, m &le; 100</i>&nbsp;を満たす． 2 行目は整数列&nbsp;<i>a</i>&nbsp;の値が&nbsp;<i>n</i>&nbsp;個ある．<i>a<sub>i</sub></i>&nbsp;(<i>1 &le; i &le; n</i>) は&nbsp;<i>i</i>&nbsp;行目の値を表す． 3 行目は整数列&nbsp;<i>b</i>&nbsp;の値が&nbsp;<i>m</i>&nbsp;個ある．<i>b<sub>j</sub></i>&nbsp;(<i>1 &le; j &le; m</i>) は&nbsp;<i>j</i>&nbsp;列目の値を表す． これらの値は&nbsp;<i>1 &le; a<sub>i</sub>, b<sub>j</sub>&nbsp;&le; 1,000</i>&nbsp;を満たす．</p>

<p>入力の終わりはゼロふたつからなる行で表される．</p>

### 출력

<p>各データセットについて，与えられた&nbsp;<i>nm</i>&nbsp;マス計算に書き込まれる数字 0&ndash;9 の個数&nbsp;<i>c<sub>0</sub>&nbsp;c<sub>1</sub>&nbsp;... c<sub>9</sub></i>&nbsp;を 1 行に空白区切りで出力せよ．</p>