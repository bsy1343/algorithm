...
시간 제한: 2.222 초 (추가 시간 없음), 메모리 제한: 222 MB (추가 메모리 없음)

### 통계

제출: 3089, 정답: 2082, 맞힌 사람: 1868, 정답 비율: 71.135%
