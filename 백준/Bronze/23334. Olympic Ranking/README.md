...
제출: 361, 정답: 227, 맞힌 사람: 180, 정답 비율: 63.158%
...
<ul>
	<li>1 &le; n &lt; 300</li>
	<li>g, s, b &isin; {0, 1, ..., 999}</li>
	<li>There is only one country or NOC of the best rank.</li>
	<li>The names of countries and NOCs consist of only printable ASCII characters.</li>
	<li>The size of an input file does not exceed 3 megabytes.</li>
</ul>