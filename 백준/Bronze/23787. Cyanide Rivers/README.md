...
제출: 168, 정답: 122, 맞힌 사람: 112, 정답 비율: 73.203%
...
<p>The input consists of one line containing an odd binary number with up to 300 000 digits and with no leading zeros. Each digit represents one tower. Towers standing in a river are represented by 0&rsquo;s, remaining towers are represented by 1&rsquo;s. The order of the digits is the same as the order of towers in the row.</p>
