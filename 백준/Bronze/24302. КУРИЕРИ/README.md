...
제출: 711, 정답: 256, 맞힌 사람: 223, 정답 비율: 34.627%
...
<p>На единствения ред на стандартния изход програмата трябва да изведе общата сума за транспортирането на заявените сладкиши до клиентите във формат &bdquo;<code>lv.st</code>&ldquo;, където с <code>lv</code> са означени левовете, а със <code>st</code> &ndash; стотинките.</p>

### 제한

<ul>
	<li>100 &le; x &le; 100 000</li>
</ul>