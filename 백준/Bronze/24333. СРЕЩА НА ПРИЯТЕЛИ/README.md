...
제출: 370, 정답: 264, 맞힌 사람: 239, 정답 비율: 71.343%
...
<p>На първия ред на стандартния изход програмата трябва да изведе едно цяло число &ndash; времето на общуване на двамата приятели в минути. Ако двамата не могат да общуват, да се изведе 0.</p>

### 제한

<ul>
	<li>1 &le; l<sub>1</sub>, r<sub>1</sub>, l<sub>2</sub>, r<sub>2</sub>, k &le; 50000</li>
</ul>