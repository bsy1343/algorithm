...
시간 제한: 2.022 초 (추가 시간 없음), 메모리 제한: 319 MB (추가 메모리 없음)

### 통계

제출: 24012, 정답: 15966, 맞힌 사람: 14994, 정답 비율: 66.991%
...
<p>살면서&nbsp;<span style="color:#2ecc71;"><strong>녹색거탑</strong></span>을 만난다면, 탑을 정복하고 <strong>DEVIEW</strong>에 참여해 <strong>코<span style="color:#e74c3c;">딩괴물</span></strong>이 되어보자.</p>