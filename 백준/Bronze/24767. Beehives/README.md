...
제출: 208, 정답: 133, 맞힌 사람: 116, 정답 비율: 72.050%
...
<p>Input will be provided on multiple lines. Each case will begin with a floating point number d (0 &lt; d &lt; 1000.0), the distance within which hives will fight. On the next line will be N (1 &le; N &le; 100), the number of hives in that case. The next N lines will contain two floating point numbers separated by a single space, x and y (-1000.0 &le; x,y &le; 1000.0), which give the position of each hive. No two hives will be at the exact same location. Input will be terminated by a line containing the string <code>0.0 0</code>.</p>
