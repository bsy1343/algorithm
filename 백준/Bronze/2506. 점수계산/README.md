...
제출: 19236, 정답: 14448, 맞힌 사람: 13076, 정답 비율: 76.289%
...
<p>첫째 줄에 문제의 개수 N (1 &le; N &le; 100)이 주어진다. 둘째 줄에는 N개 문제의 채점 결과를 나타내는 0 혹은 1이 빈 칸을 사이에 두고 주어진다. 0은 문제의 답이 틀린 경우이고, 1은 문제의 답이 맞는 경우이다. </p>
