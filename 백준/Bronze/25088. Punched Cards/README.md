...
제출: 251, 정답: 219, 맞힌 사람: 197, 정답 비율: 88.341%
...
<p style="text-align: center;"><img alt="" src="https://upload.acmicpc.net/9b57c7f7-0f40-4e50-8990-d91254383437/-/preview/" style="width: 558px; height: 250px;" /></p>
...
<p>For each test case, output one line containing <code>Case #x:</code>, where $x$ is the test case number (starting from 1). Then, output $(2&sdot;R)+1$ additional lines with the ASCII art drawing of a punched card with $R$ rows and $C$ columns.</p>

### 힌트

<p>Sample Case #1 is the one described in the problem statement. Sample Cases #2 and #3 are additional examples. Notice that the output for each case contains exactly $R&sdot;C+3$ periods.</p>