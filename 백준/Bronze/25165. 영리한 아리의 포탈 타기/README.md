...
제출: 1101, 정답: 568, 맞힌 사람: 480, 정답 비율: 54.054%
...
<p>첫 번째 줄에 광야의 크기를 나타내는 두 정수 <em>N</em>과 <em>M</em>이 주어진다. (2 &le; <em>N</em>, <em>M</em> &le; 100)</p>

<p>두 번째 줄에 아리가 처음 위치한 칸의 열의 값을 나타내는 정수 <em>A<sub>c&nbsp;</sub></em>(1 &le; <em>A<sub>c</sub></em> &le; <em>M</em>)와 아리의 진행 방향 <em>D</em>가 주어진다. <em>D</em>는 0이나 1로 주어지고, 0이라면 진행 방향이 왼쪽임을, 1이라면 진행 방향이 오른쪽임을 의미한다.</p>

<p>세 번째 줄에 부하 몬스터의 위치를 나타내는 두 정수 <em>S<sub>r</sub></em> (2 &le; <em>S<sub>r</sub></em> &le; <em>N</em>), <em>S<sub>c</sub></em> (1 &le; <em>S<sub>c</sub></em> &le; <em>M</em>)가 주어진다.</p>
