...
제출: 413618, 정답: 161873, 맞힌 사람: 134626, 정답 비율: 38.602%
...
<p>첫째 줄에는 현재 시각이 나온다. 현재 시각은 시 A (0 &le; A &le; 23) 와 분 B (0 &le; B &le; 59)가 정수로 빈칸을 사이에 두고 순서대로 주어진다. 두 번째 줄에는 요리하는 데 필요한 시간 C (0 &le; C &le; 1,000)가 분 단위로 주어진다. </p>
