...
제출: 2369, 정답: 1230, 맞힌 사람: 1074, 정답 비율: 55.332%
...
<table border="1" cellpadding="1" cellspacing="1" class="table table-bordered" style="width: 1500px; margin-left: auto; margin-right: auto;">
	...
	<thead>
		<tr>
			<th scope="row" style="text-align: center;">&darr;신장(cm),&nbsp;등급 &rarr;</th>
...
<p>C, C++, Java에서&nbsp;정수를 정수로 나눈 결과는 정수이므로&nbsp;float와&nbsp;double 같은 실수 자료형을 이용해 BMI를 계산해야 한다.</p>