...
제출: 1506, 정답: 523, 맞힌 사람: 449, 정답 비율: 35.692%
...
<p>첫 번째 줄에 시청자가 구독한 스트리머의 수 $N$, 시청자 변화 추이의 길이 $M$이 주어진다. $(2 &le; N &le; 10\,000, 1 &le; M &le; 100)$</p>

<p>두 번째 줄에는 랄파의 시청자 변화 추이 $L_{j}$가 $M$개 주어진다. $(1 &le; L_{j} &le; 10\,000)$</p>

<p>세 번째 줄부터 $N+1$번째 줄까지 각 스트리머 $i$의 시청자 변화 추이 $K_{i, j}$가 $M$개 주어진다.$(1 &le; K_{i, j} &le; 10\,000)$</p>
...
<p>이 문제는 입력의 양이 방대하므로 각 언어의 빠른 입출력의 사용을 권장한다.</p>