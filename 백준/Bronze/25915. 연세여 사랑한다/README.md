...
시간 제한: 1.885 초, 메모리 제한: 1024 MB

### 통계

제출: 1798, 정답: 1525, 맞힌 사람: 1385, 정답 비율: 87.107%
...
<ul>
	<li>$c$는 대문자 알파벳 <span style="color:#e74c3c;"><code>A</code></span> - <span style="color:#e74c3c;"><code>Z</code></span>이다.</li>
</ul>