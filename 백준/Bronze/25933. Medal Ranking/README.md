...
제출: 352, 정답: 262, 맞힌 사람: 238, 정답 비율: 73.006%
...
<p>When different countries compete against each other (e.g., in the Olympics), they receive gold/silver/bronze medals. The countries can then be ranked in one of two ways: by &ldquo;count&rdquo; which is based on the total number of medals (regardless of the medal colors) or by &ldquo;color&rdquo; which is based on the number of gold medals (and silver medals if tied in gold medals, and bronze medals if tied in gold and silver).</p>
