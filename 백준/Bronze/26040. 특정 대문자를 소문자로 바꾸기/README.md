...
제출: 1690, 정답: 1199, 맞힌 사람: 1049, 정답 비율: 71.167%
...
<ul>
	<li>3 &le; 문자열 <em>A</em> 길이 &le; 100,000</li>
	<li>1 &le; 문자 목록 <em>B</em>에 있는 대문자의 개수 &le; 26</li>
	<li>문자 목록 <em>B</em>에는 중복된 대문자가 존재하지 않는다.</li>
</ul>