...
제출: 199, 정답: 135, 맞힌 사람: 126, 정답 비율: 69.613%
...
<p>The first line of input contains six space-separated integers, representing the values written on the first player&rsquo;s die. The second line of input contains the values on the second player&rsquo;s die in the same format.</p>
