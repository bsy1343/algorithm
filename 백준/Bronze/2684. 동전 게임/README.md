...
제출: 2714, 정답: 2206, 맞힌 사람: 2004, 정답 비율: 82.776%
...
<p>첫째 줄에 테스트 케이스의 개수 P(1 &le; P &le; 1000)가 주어진다. 각 테스트 케이스는 한 줄로 이루어져 있고, 동전을 40번 던진 결과가 주어진다. 이때, 앞면은 H로, 뒷면은 T로 표현한다.&nbsp;</p>
