...
제출: 127, 정답: 92, 맞힌 사람: 75, 정답 비율: 70.755%
...
<p>Ever the innovator, Farmer John is teaching cows to speak some phrases in human language. He writes each new phrase the cows learn in his phrase book, a total of M (1 &le; M &le; 1,000) so far.</p>

<p>When Farmer John is on a vacation, he can only communicate with his cows by telephone. Being an active vacationer, FJ visits beaches and fine restaurants when away from the farm. When he returns, his answering machine is full of N (1 &le; N &le; 10,000) messages, many potentially from the cows.</p>
