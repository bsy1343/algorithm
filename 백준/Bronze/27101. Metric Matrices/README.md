...
제출: 263, 정답: 135, 맞힌 사람: 124, 정답 비율: 50.612%
...
<ul>
	<li>Line 1: One integer, N, the rows and number of columns, 2 &le; N &le; 30</li>
	<li>Line 2..N+1: N lines, each with N space-separated integers (-32000 &le; each integer &le; 32000).  The first of these lines represents the first row; the first number in each line is the first column.</li>
</ul>
