...
제출: 428, 정답: 237, 맞힌 사람: 213, 정답 비율: 55.759%
...
<p>Reading a long table is a tedious job, so you would like to create a program that takes N as an input, and produce X, Y, Z as the output. The value of X, Y, and Z must be an integer not less than &minus;10<sup>18</sup> and not more than 10<sup>18</sup>.</p>

### 입력

<p>Input begins with a line containing an integer: N (0 &le; N &lt; 50).</p>
