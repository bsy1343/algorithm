...
제출: 291, 정답: 137, 맞힌 사람: 119, 정답 비율: 52.423%
...
<p>Given is a sequence S of distinct integers. Rearrange the sequence in any way. The only condition is that the resulting sequence must not be sorted &ndash; neither in ascending nor in descending order.</p>
