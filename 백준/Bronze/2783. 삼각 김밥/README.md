...
제출: 6513, 정답: 4372, 맞힌 사람: 4092, 정답 비율: 69.005%
...
<p>첫째 줄에 세븐25의 삼각 김밥 가격 정보 X와 Y가 주어진다. (Y그램 당 X원) (1 &le; X &le; 100, 1 &le; Y &le; 1,000)</p>

<p>둘째 줄에는 세븐25를 제외한 편의점의 개수 N이 주어진다. (1 &le; N &le; 100)</p>

<p>다음 N개의 줄에는 i번째 편의점의 삼각 김밥 가격 정보 X<sub>i</sub>와 Y<sub>i</sub>가 주어진다. (Y<sub>i</sub>그램 당 X<sub>i</sub>원) (1 &le; X<sub>i</sub> &le; 100, 1 &le; Y<sub>i</sub> &le; 1,000)</p>
