...
제출: 1359, 정답: 1100, 맞힌 사람: 1033, 정답 비율: 82.508%
...
<ul>
	<li>The height of <code>1</code> escalator step is <code>21cm</code>, and the height of <code>1</code> stair is <code>17cm</code>.</li>
	<li>The answer &le; <code>6425</code></li>
	<li>All exits are at the <strong>same elevation.</strong></li>
	<li>All platforms are at<strong> </strong>the<strong> same elevation.</strong></li>
	<li>There is <strong>no change in elevation</strong> at the same platform.</li>
	<li><code>x</code> is integer.</li>
</ul>