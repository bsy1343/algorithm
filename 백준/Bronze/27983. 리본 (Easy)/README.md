...
제출: 924, 정답: 521, 맞힌 사람: 445, 정답 비율: 56.116%
...
<ul>
	<li>$\color{red}{2 \le N \le 10^3}$</li>
	<li>$-10^9 \le X_1 &lt; X_2 &lt; \cdots &lt; X_{N} \le 10^9$</li>
	<li>$1 \le L_i \le 10^9$</li>
	<li>$C_i \in \{$<code>R</code>, <code>Y</code>, <code>B</code>$\}$</li>
</ul>