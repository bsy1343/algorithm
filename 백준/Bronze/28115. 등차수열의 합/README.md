...
제출: 1217, 정답: 665, 맞힌 사람: 574, 정답 비율: 53.645%
...
<ul>
	...
	<li>$-10^9\leq A_i\leq 10^9$ $(1\le i\le N)$</li>
	<li>$-10^{18}\leq B_i,C_i\leq 10^{18}$ $(1\le i\le N)$</li>
	<li>$A_i$, $B_i$, $C_i$는 모두 정수 $(1\le i\le N)$</li>
</ul>