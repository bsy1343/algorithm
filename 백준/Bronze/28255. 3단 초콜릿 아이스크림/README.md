...
제출: 840, 정답: 645, 맞힌 사람: 595, 정답 비율: 79.228%
...
<p>코코는 &ldquo;2단 아이스크림&rdquo;의 정의를 다음과 같이 내리기로 했다.</p>
...
<p>하지만 이 정의가 평범한 팰린드롬의 정의와 같다는 것에 실망한 코코는 한 단계 더 나아간 &ldquo;3단 아이스크림&rdquo;을 정의하였다.</p>
