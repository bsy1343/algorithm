...
제출: 18387, 정답: 9151, 맞힌 사람: 7588, 정답 비율: 50.159%
...
<p>첫째 줄에 상근이가 측정한 높이의 수이자 수열의 크기인 N(1 &le; N &le; 1000)이 주어진다. 둘째&nbsp;줄에는 N개의 양의 정수 Pi(1 &le; Pi &le; 1000)가 주어진다. 각 숫자는 상근이가 측정한 높이이다.</p>
