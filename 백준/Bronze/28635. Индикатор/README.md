...
제출: 735, 정답: 522, 맞힌 사람: 493, 정답 비율: 71.657%
...
<p>В первом примере секундомер уже показывает любимое число Совуньи, ничего делать не нужно.</p>

<p>Во втором примере требуется три нажатия: $2 \to 3 \to 4 \to 5$.</p>

<p>В третьем примере требуется четыре нажатия: $8 \to 9 \to 1 \to 2 \to 3$.</p>