...
제출: 8016, 정답: 5834, 맞힌 사람: 5496, 정답 비율: 73.163%
...
<p>$a$의 제곱은 $a$를 두 번 곱한 수로, $a^2$으로 표현합니다. $a^2 = a \times a$입니다. 또한, $a$의 세제곱은 $a$를 세 번 곱한 수로, $a^3$으로 표현합니다. $a^3 = a \times a \times a$ 입니다.</p>