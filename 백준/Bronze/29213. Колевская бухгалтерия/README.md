...
제출: 88, 정답: 64, 맞힌 사람: 52, 정답 비율: 70.270%
...
<p>Ответом на первый тест из примера является единственная тройка чисел $(1, 0, 0)$.</p>

<p>Ответами на второй тест из примера являются следующие тройки чисел:</p>
