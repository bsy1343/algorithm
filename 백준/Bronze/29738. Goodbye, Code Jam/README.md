...
제출: 2926, 정답: 1857, 맞힌 사람: 1768, 정답 비율: 64.478%
...
<p><strong>Round 1</strong>은 <strong>Round 1A</strong>, <strong>Round 1B</strong>, <strong>Round 1C</strong>로 이루어진 $3$개의 라운드 중 $1$개의 라운드에서 상위 $1\,500$등 안에 들면 다음 라운드로 진출하는 방식이나 문제에서는 서술 편의상 $4\,500$등으로 표현했다.</p>