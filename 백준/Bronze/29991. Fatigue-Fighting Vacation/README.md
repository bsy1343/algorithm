...
제출: 377, 정답: 187, 맞힌 사람: 167, 정답 비율: 48.688%
...
<p>The first line of input contains three integer numbers, D, C, and, R, representing, respectively, the initial amount of disposition, the number of tiring activities, and the number of invigorating activities (1 &le; D &le; 10<sup>5</sup>, 1 &le; C &le; 10<sup>4</sup>, and 1 &le; R &le; 10<sup>4</sup>). Each of the next C lines contains an integer number C<sub>i</sub> (1 &le; C<sub>i</sub> &le; 10<sup>5</sup> for 1 &le; i &le; C), representing the required amount of disposition for a tiring activity, in order of preference. Finally, each of the next R lines contains an integer number R<sub>i</sub> (1 &le; R<sub>i</sub> &le; 10<sup>5</sup> for 1 &le; i &le; R), representing the provided amount of disposition for an invigorating activity, in order of preference.</p>
