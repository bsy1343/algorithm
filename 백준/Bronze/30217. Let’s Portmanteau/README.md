...
제출: 147, 정답: 91, 맞힌 사람: 81, 정답 비율: 61.832%
...
<p>From &ldquo;yourdictionary.com&rdquo;: Portmanteau, pronounced &ldquo;port-man-tow,&rdquo; refers to a new word made from two words and their meanings. For example, the portmanteau brunch refers to a combined meal of breakfast and lunch, and spork is a mix between a spoon and a fork.</p>
...
<ol>
	...
	<ol>
		...
		<li>If v<sub>1</sub> and v<sub>2</sub> don&rsquo;t exist (i.e., neither word has a vowel while moving right/left), use the letter &ldquo;o&rdquo; as the merging vowel.</li>
	</ol>
	</li>
</ol>

<p>Assume the vowels are &ldquo;aeiou&rdquo;.</p>
