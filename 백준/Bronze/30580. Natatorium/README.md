...
제출: 171, 정답: 113, 맞힌 사람: 91, 정답 비율: 63.636%
...
<p>The first input line contains integer C (1 &le; C &le; 10<sup>18</sup>), the area of the pool surface. The second line contains integer M (1 &le; M &le; 2 &middot; 10<sup>5</sup>), the number of pool side lengths offered by the company. The third line contains a list of space-separated unique primes P<sub>1</sub>, . . . , P<sub>M</sub> (1 &lt; P<sub>i</sub> &lt; 10<sup>9</sup>), representing the offered pool side lengths.</p>
