...
제출: 8910, 정답: 5391, 맞힌 사람: 4933, 정답 비율: 60.954%
...
<p>
	문자열 S가 &ldquo;ABCDEFGHIJKLMNOPQRSTUVW&rdquo; 일 때, S에 등장하지 않는 알파벳 대문자는 X, Y, Z이다. X의 아스키 코드 값은 88, Y는 89, Z는 90이므로 이 아스키 코드 값의 합은 267이다.</p>
