...
제출: 1105, 정답: 862, 맞힌 사람: 818, 정답 비율: 78.203%
...
<ul>
	<li>There are equal to or more than $1\,000$ votes difference between the ranked <code>16th</code> and <code>20th</code> character votes.</li>
	<li>No two characters received the same number of votes.</li>
	<li>$30\,000 \lt \text{Number of votes from ranked }16\text{th character to ranked }20\text{th character} \le 45\,000$.</li>
</ul>