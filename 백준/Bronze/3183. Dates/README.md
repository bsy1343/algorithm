...
제출: 516, 정답: 310, 맞힌 사람: 285, 정답 비율: 59.129%
...
<p>Output will be one line for each line of input, the line containing just one word. If the numbers represent a valid date, the word &lsquo;Valid&rsquo; will be output, otherwise the word &lsquo;Invalid&rsquo; will be output.</p>