...
제출: 1147, 정답: 778, 맞힌 사람: 723, 정답 비율: 70.813%
...
<p>각 문자는 &lsquo;<span style="color:#e74c3c;"><code>.</code></span>&rsquo;, &lsquo;<span style="color:#e74c3c;"><code>@</code></span>&rsquo;, &lsquo;<span style="color:#e74c3c;"><code>#</code></span>&rsquo;, &lsquo;<span style="color:#e74c3c;"><code>!</code></span>&rsquo; 중 하나로, 각각 빈칸, 로봇이 있는 칸, 박스가 있는 칸, 박스를 놓아야 하는 칸을 뜻한다. </p>

<p>&lsquo;<span style="color:#e74c3c;"><code>@</code></span>&rsquo;, &lsquo;<span style="color:#e74c3c;"><code>#</code></span>&rsquo;, &lsquo;<span style="color:#e74c3c;"><code>!</code></span>&rsquo;는 정확히 하나씩 주어진다. 즉, 박스가 처음부터 목표 지점에 있는 경우는 주어지지 않는다.</p>

### 출력

<p>적어도 몇 번의 명령을 해야 박스를 원하는 칸에 둘 수 있는지 출력한다.</p>

<p>몇 번의 명령을 내려도 박스를 원하는 칸으로 옮길 수 없다면 대신 &lsquo;<span style="color:#e74c3c;"><code>-1</code></span>&rsquo;을 출력한다.</p>