...
제출: 402, 정답: 359, 맞힌 사람: 325, 정답 비율: 90.529%
...
<p><i>n</i> (1 &le; <i>n</i> &le; 100) is the number of snacks sold in the candy store. <i>a<sub>k</sub></i> (<i>k</i> = 1, &hellip;, <i>n</i>) is a positive integer less than or equal to 1000, meaning that the price of the <i>k</i>-th snack from the left is <i>a<sub>k</sub></i> yen.</p>
