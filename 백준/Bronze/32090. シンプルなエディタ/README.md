...
제출: 137, 정답: 115, 맞힌 사람: 98, 정답 비율: 81.667%
...
<ul>
	...
	<ul>
		...
		<li>&ldquo;<code>_</code>&rdquo; は入力形式を合わせるためのダミーである．</li>
	</ul>
	</li>
...
<p>1 行目にはキーボードからの入力の数を表す整数 <i>N</i> が与えられる．<i>N</i> は <i>1 &le; N &le; 1000</i> を満たす．</p>
