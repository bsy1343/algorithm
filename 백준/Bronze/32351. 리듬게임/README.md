...
제출: 327, 정답: 218, 맞힌 사람: 186, 정답 비율: 68.382%
...
<p>언어별로 정답인 <span style="color:#e74c3c;"><code>ans</code></span>를 소숫점 아래 $12$자리까지 출력하는 방법은 다음과 같다. 이외의 언어는 각 언어의 레퍼런스 페이지를 참고하여라.</p>

<ul>
	<li>C: <code>printf("%.12f\n", ans);</code></li>
	<li>C++: <code>std::cout &lt;&lt; std::fixed &lt;&lt; std::setprecision(12) &lt;&lt; ans &lt;&lt; std::endl;</code></li>
	<li>C#: <code>Console.WriteLine(String.Format("{0:F12}", ans));</code></li>
	<li>Java: <code>System.out.printf("%.12f\n", ans);</code></li>
	<li>Python: <code>print(f'{ans:.12f}')</code></li>
</ul>