...
제출: 266, 정답: 197, 맞힌 사람: 156, 정답 비율: 75.000%
...
<p>The first line of input file contains two integers N, 1 &le; N &le; 100, and G separated by a space character. Number N is number of rooms in a hotel and G is number of groups of guests.</p>

<p>The next G lines contain numbers of guests in each group &ndash; (i+1)th line contains number of guests in ith group (groups are numbered by order of arrival to a hotel).</p>
