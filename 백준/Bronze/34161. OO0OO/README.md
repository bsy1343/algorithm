...
시간 제한: 0.124 초 (추가 시간 없음), 메모리 제한: 1024 MB (추가 메모리 없음)

### 통계

제출: 1254, 정답: 662, 맞힌 사람: 547, 정답 비율: 55.646%
...
<p style="text-align: center;"><img alt="" src="%EB%B0%B1%EC%A4%80/Bronze/34161.%E2%80%85OO0OO/7e512b9f.jpg" data-original-src="https://boja.mercury.kr/assets/problem/34161-1.jpg" onerror="this.onerror=null;this.src=this.dataset.originalSrc" style="width:600px;max-width:100%;"></p>
...
<p style="text-align: center;"><img alt="" src="%EB%B0%B1%EC%A4%80/Bronze/34161.%E2%80%85OO0OO/ab8aedf7.png" data-original-src="https://boja.mercury.kr/assets/problem/34161-2.png" onerror="this.onerror=null;this.src=this.dataset.originalSrc" style="width:600px;max-width:100%;"></p>
...
<p style="text-align: center;"><img alt="" src="%EB%B0%B1%EC%A4%80/Bronze/34161.%E2%80%85OO0OO/3a136806.png" data-original-src="https://boja.mercury.kr/assets/problem/34161-3.png" onerror="this.onerror=null;this.src=this.dataset.originalSrc" style="width:600px;max-width:100%;"></p>
...
<p>$10\, 000$개 중 정답이 맞은 개수 당 $0.01$점을 부여한다.</p>

<p>단, 출력이 $10\, 000$개의 정수가 아닌 경우나 $-1$ 이상 $998\, 244\, 353$ 미만의 범위를 벗어나는 경우 <strong class="result-wa">틀렸습니다</strong>를 받을 수 있으므로, 답을 구하지 못한 경우도 정수를 출력하자.</p>

### 힌트

<p>이 문제의 시간 제한이 $0.124$초인 이유는 동우의 생일이 $1$월 $24$일이기 때문이다.</p>