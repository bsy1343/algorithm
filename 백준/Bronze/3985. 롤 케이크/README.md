...
제출: 8892, 정답: 4943, 맞힌 사람: 4358, 정답 비율: 55.987%
...
<p>첫째 줄에 롤 케이크의 길이 L (1 &le; L &le; 1000)이 주어진다. 둘째 줄에는 방청객의 수 N (1 &le; N &le; 1000)이 주어진다. 다음 N개 줄에는 각 방청객 i가 종이에 적어낸 수 P<sub>i</sub>와 K<sub>i</sub>가 주어진다. (1 &le; P<sub>i</sub> &le; K<sub>i</sub> &le; L, i = 1..N)</p>
