...
제출: 321, 정답: 244, 맞힌 사람: 184, 정답 비율: 78.970%
...
<p>Input consists of several test cases. For each case, the first line of input contains 1 &le; k &le; 100, the number of courses Freddie has chosen, and 0 &le; m &le; 100, the number of categories. One or more lines follow containing k 4-digit integers follow; each is the number of a course selected by Freddie. Each category is represented by a line containing 1 &le; c &le; 100, the number of courses in the category, 0 &le; r &le; c, the minimum number of courses from the category that must be taken, and the c course numbers in the category. Each course number is a 4-digit integer. The same course may fulfil several category requirements. Freddie&#39;s selections, and the course numbers in any particular category, are distinct. A line containing 0 follows the last test case.</p>
