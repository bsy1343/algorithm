...
제출: 236, 정답: 205, 맞힌 사람: 180, 정답 비율: 88.235%
...
<p>WALL&bull;E<sup>TM</sup>&copy;, as he cleans up and organizes the depopulated Earth, has come upon some Civil War memorials. He is consolidating the cannonballs into one location, and decides to use pyramids with triangular bases rather than ones with square bases.</p>
