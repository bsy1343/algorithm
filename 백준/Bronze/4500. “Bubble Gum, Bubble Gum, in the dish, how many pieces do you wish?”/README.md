...
제출: 263, 정답: 212, 맞힌 사람: 184, 정답 비율: 83.636%
...
value is chosen, the people are iterated through, one at a time, starting at 1, from &ldquo;left&rdquo; to &ldquo;right&rdquo;, starting with the person who chose the number. Iterating is done in a circular fashion, meaning that once the person on the far right is reached, the next person in the iteration will be the person on the far left. Upon reaching n, the person at that location is the winner.</p>
