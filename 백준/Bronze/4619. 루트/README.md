...
제출: 3508, 정답: 2105, 맞힌 사람: 1881, 정답 비율: 61.430%
...
<p>
	입력은 여러 테스트 케이스로 이루어져 있다. 각 테스트 케이스는 한 줄로 이루어져 있고, B와 N이 주어진다. (1 &le; B &le; 1,000,000, 1 &le; N &le; 9) 입력의 마지막 줄에는 0이 2개 주어진다.</p>
