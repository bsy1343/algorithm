...
제출: 1367, 정답: 1150, 맞힌 사람: 1088, 정답 비율: 84.407%
...
<p>The input consists of one or more data sets. Each set starts with a line containing an integer <em>n</em>, 1 &le; <em>n</em> &le; 10,&nbsp; followed by <em>n</em> pairs of values, one pair per line. The first value in a pair, <em>s,</em> is the speed in miles per hour and the second value, <em>t</em>, is the total elapsed time. Both <em>s</em> and <em>t</em> are integers, 1 &le;<em> s</em> &le; 90 and 1 &le;<em> t</em> &le; 12.&nbsp; The values for <em>t </em>are always in strictly increasing order. A value of -1 for <em>n</em> signals the end of the input.</p>
