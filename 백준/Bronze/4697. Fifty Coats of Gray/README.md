...
제출: 192, 정답: 169, 맞힌 사람: 151, 정답 비율: 89.349%
...
<p>where n (1 &le; n &le; 100) is the number of apartments, width (8 &le; width &le; 100) is the width of each room, length (8 &le; length &le; 100) is the length of each room, height (8 &le; height &le; 30) is the height of each room, area (100 &le; area &le; 1, 000) is the area in square feet that can be covered by each can of paint, and m (0 &le; m &le; 10) is the number of windows and doors.</p>

<p>On each of the next m lines will be two positive integers, width and height, describing a door or window. No window or door will be larger than the largest wall. All linear measures will be expressed in feet. The input will end with a line with six 0&rsquo;s.</p>
