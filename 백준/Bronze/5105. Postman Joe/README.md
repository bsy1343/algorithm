...
제출: 314, 정답: 96, 맞힌 사람: 83, 정답 비율: 30.741%
...
<p>Input will consist of a number of tasks that Joe has set, each on a single line. The last line will contain just a # character &ndash; that line should not be processed.</p>
...
<p>Joe makes 16 deliveries, missing these 4 houses.</p>

<p>The 7th delivery (D4) is to house 1 which received the 2nd delivery.</p>