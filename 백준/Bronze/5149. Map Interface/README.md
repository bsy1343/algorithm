...
제출: 278, 정답: 145, 맞힌 사람: 105, 정답 비율: 56.452%
...
<p>The first line contains two integers n,m. 2 &le; n &le; 500 is the total number of stations in the system, and 2 &le; m &le; n the number of stations you travel through.</p>
...
<p>For each data set, first output &ldquo;Data Set x:&rdquo; on a line by itself, where x is its number. Then, output the total number of stations visible in the smallest rectangle containing all of your trip. Each data set should be followed by a blank line.</p>