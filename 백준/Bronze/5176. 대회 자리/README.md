...
제출: 5107, 정답: 3460, 맞힌 사람: 3171, 정답 비율: 69.494%
...
<p>
	첫째 줄에 참가자의 수 P와 자리의 수 M이 주어진다. (1 &le; P, M &le; 500) 다음 P개 줄에는 각 참가자가 원하는 자리가 주어진다. 자리는 1번부터 M번까지 있다. 입력으로 주어지는 참가자가 도착하는 순서이다.</p>
