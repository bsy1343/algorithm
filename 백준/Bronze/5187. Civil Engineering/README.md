...
제출: 196, 정답: 139, 맞힌 사람: 120, 정답 비율: 69.364%
...
<p>For each data set, first output &ldquo;Data Set x:&rdquo; on a line by itself, where x is its number. Then, output the total weight of the oblongs in grams.</p>