...
제출: 235, 정답: 202, 맞힌 사람: 175, 정답 비율: 86.207%
...
<p style="text-align: center;">x<sub>i</sub> = x<sub>i&minus;1</sub> + x<sub>i&minus;2</sub></p>
...
<p>The first line in the test data file contains the number of test cases, n. After that, each line contains one test case. The test case begins with the number of elements in the sequence, k, and then we have k numbers which form the sequence. Assume all numbers are &ge; 0, and that the numbers are all &lt; 2<sup>30</sup>.</p>

### 출력

<p>For each test case, you are to output &ldquo;YES&rdquo; (if the sequence is a generalized Fibbonacci sequence) or &ldquo;NO&rdquo; (if it is not).</p>