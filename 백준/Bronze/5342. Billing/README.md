...
제출: 829, 정답: 663, 맞힌 사람: 609, 정답 비율: 80.343%
...
<p>The input is a list of office supplies with one item per line. End-of- input is denoted by the string &ldquo;EOI&rdquo;.</p>

### 출력

<p>Print the total cost of all the items in the list. The output must start with a dollar sign, &ldquo;$&rdquo; and the total printed with exactly two decimal digits.</p>