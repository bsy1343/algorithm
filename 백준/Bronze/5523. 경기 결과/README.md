...
제출: 6961, 정답: 4680, 맞힌 사람: 4288, 정답 비율: 69.917%
...
<p>첫째 줄에는 정수 N(1 &le; N &le; 1,000,000)이 주어진다.</p>

<p>둘째 줄부터는 정수 A<sub>i</sub>, B<sub>i</sub>&nbsp;(0 &le; A<sub>i</sub>, B<sub>i</sub>&nbsp;&le; 100)가 공백을 사이에 두고 차례대로 주어진다.</p>
