...
제출: 505, 정답: 337, 맞힌 사람: 291, 정답 비율: 68.150%
...
<ul>
	...
	<li>h<sub>n</sub> = 3 &times; h<sub>n-1</sub> + 1 (if h<sub>n-1</sub> is odd)</li>
</ul>
...
<p>Each test case is described using a single line. The line contains an integer H representing the starting value to build the sequence (1 &le; H &le; 500).</p>
