...
제출: 134, 정답: 107, 맞힌 사람: 94, 정답 비율: 79.661%
...
<p>The input contains several test cases. The first line of a test case contains three integers N, C and K which indicate respectively the number of draws that have already happened (1 &le; N &le; 10000), how many numbers comprises a bet (1 &le; C &le; 10) and the maximum value of the numbers to be chosen in a bet (C &lt; K &le; 100). Each of the next N lines contains C distinct integers X<sub>i</sub> indicating the numbers drawn in each previous contest (1 &le; X<sub>i</sub> &le; K, for 1 &le; i &le; C). The end of input is indicated by N = C = K = 0.</p>
