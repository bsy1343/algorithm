...
제출: 263, 정답: 220, 맞힌 사람: 187, 정답 비율: 90.338%
...
<p>Given two integers M and N, with 1 &le; M &le; N &le; 5000, you must determine the integer numbers X and Y such that</p>

<ul>
	<li>A. M &le; X &le; N; and</li>
...
<p>Your program should process several test cases. Each test case is composed by a single line contain- ing the two integers M and N (1 &le; M &le; N &le; 5000). The end of input is indicated by M = N = 0.</p>
