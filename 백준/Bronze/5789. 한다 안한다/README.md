...
제출: 6043, 정답: 3483, 맞힌 사람: 3237, 정답 비율: 58.983%
...
<p>첫째 줄에는 테스트 케이스의 개수 N이 주어진다. (1 &le; N &le; 1000) 각 테스트 케이스는 한 줄로 이루어져 있으며, 0과 1로 이루어진 문자열이 주어진다. 문자열의 길이는 항상 짝수이고, 1000보다 작다.</p>
