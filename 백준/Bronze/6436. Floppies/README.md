...
제출: 780, 정답: 362, 맞힌 사람: 305, 정답 비율: 46.423%
...
<p>The input file contains several test cases. Each test case consists of a single line containing one integer <i>s</i> (0 &le; <i>s </i>&le; 1,000,000,000), specifying the size of the SHAR file in bytes.</p>
