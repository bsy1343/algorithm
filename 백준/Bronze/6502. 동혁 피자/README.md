...
제출: 4741, 정답: 2453, 맞힌 사람: 2248, 정답 비율: 52.720%
...
<p>입력은 여러 개의 테스트 케이스로 이루어져 있다. 각 테스트 케이스는&nbsp;숫자 세 개로 이루어져 있고, 순서대로 r, w, l이다. r은 식탁의 반지름이고, w와 l은 피자의 너비와 높이이다. (1 &le; r &le; 1000, 1 &le; w &le; l &le; 1000) r이 0이 들어오는 경우에는 프로그램을 종료한다.</p>
