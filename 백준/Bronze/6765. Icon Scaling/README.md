...
제출: 310, 정답: 246, 맞힌 사람: 217, 정답 비율: 80.074%
...
<p>The icon will be encoded as characters (x and *) in a 3 &times; 3 grid as follows:</p>
...
<p>Write a program that accepts a positive integer scaling factor and outputs the scaled icon. A scaling factor of k means that each character is replaced by a k &times; k grid consisting only of that character.</p>
