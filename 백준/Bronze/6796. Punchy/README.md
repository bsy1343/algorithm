...
제출: 260, 정답: 150, 맞힌 사람: 131, 정답 비율: 62.085%
...
<p>Write a program to read and execute the commands in Bill&rsquo;s &ldquo;new&rdquo; program.</p>
...
<ul>
	...
	<li>4 X Y means calculate X &lowast; Y and store the value in variable X;</li>
	<li>5 X Y means calculate X &minus; Y and store the value in variable X;</li>
...
<p>(To clarify division of negative numbers, &minus;3/2 and 3/ &minus; 2 both have quotient &minus;1 and &minus;3/ &minus; 2 has quotient 1.)</p>

### 출력

<p>Your program should output the value of the indicated variables, one integer per line, until the &ldquo;stop&rdquo; instruction has been read in, at which time your program should stop execution.</p>