...
제출: 4392, 정답: 1834, 맞힌 사람: 1692, 정답 비율: 42.121%
...
<p>For example, &ldquo;LOL&rdquo; means &ldquo;laughing out loud&rdquo; and &ldquo;:-)&rdquo; is called an emoticon which looks like a happy face (on its side) and it indicates chuckling. This is all quite a mystery to some adults.</p>
...
<table class="table table-bordered">
	...
	<tbody>
		...
		<tr>
			<td>:-)</td>
			<td>I&rsquo;m happy</td>
		</tr>
		<tr>
			<td>:-(</td>
			<td>I&rsquo;m unhappy</td>
		</tr>
		<tr>
			<td>;-)</td>
			<td>wink</td>
...
<p>The user will be prompted to enter text to be translated one line at a time. When the short form &ldquo;TTYL&rdquo; is entered, the program ends. Users may enter text that is found in the translation table, or they may enter other words. All entered text will be symbols or upper case letters. There will be no spaces and no quotation marks.</p>

### 출력

<p>The program will output text immediately after each line of input. If the input is one of the phrases in the translation table, the output will be the translation; if the input does not appear in the table, the output will be the original word. The translation of the last short form entered &ldquo;TTYL&rdquo; should be output.</p>