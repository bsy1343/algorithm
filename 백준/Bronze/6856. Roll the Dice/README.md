...
제출: 1099, 정답: 447, 맞힌 사람: 403, 정답 비율: 39.355%
...
<p>The input is given as two integers. First, the user is prompted for and must enter in the number m (1 &le; m &le; 1000). Second, the user is prompted for and must enter the number n (1 &le; n &le; 1000).</p>

### 출력

<p>The program prints out the number of ways 10 may be rolled on these two dice. Note that in the output, the word &ldquo;way&rdquo; should be used if there is only one way to achieve the sum of 10; otherwise, the word &ldquo;ways&rdquo; should be used in the output. That is, if there is only one way to get the sum 10, the output should</p>

<pre>
There is 1 way to get the sum 10.</pre>