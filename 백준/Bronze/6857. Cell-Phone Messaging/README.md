...
제출: 89, 정답: 70, 맞힌 사람: 67, 정답 비율: 81.707%
...
<p>For example, to write &ldquo;a&rdquo; we press the key &lsquo;2&rsquo; once and we are done; to write &ldquo;dada&rdquo; we press 3232&mdash;four key presses; and to write &ldquo;bob&rdquo; we press 2266622. An obvious issue is how to write two consecutive letters on the same key, for example in &lsquo;abba&rsquo; or &lsquo;cell&rsquo;. The problem is solved by introducing a time-out feature: a letter currently displayed is chosen when another key is pressed, but also after a pause, i.e., a time out. Hence for example, to write &lsquo;abba&rsquo; we press 2-pause22-pause-22-pause-2; to write &lsquo;cell&rsquo; we press 22233555-pause-555; or to write &lsquo;www&rsquo; we press &lsquo;9-pause-9-pause-9&rsquo;.</p>
