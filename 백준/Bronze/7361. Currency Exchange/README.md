...
제출: 111, 정답: 69, 맞힌 사람: 61, 정답 비율: 59.804%
...
<p>N c<sub>1</sub> c<sub>2</sub> &hellip; c<sub>n</sub> m</p>

<p>Where 1 &lt;= n &lt;= 10 and c<sub>1</sub>, &hellip;, c<sub>n</sub> are integers from 2 through 5 indicating the order in which Issac visits the countries. (A value of n = 0 indicates end of input, in which case there will be no more numbers on the line.) So, his trip will be 1 -&gt; c<sub>1</sub> -&gt; c<sub>2</sub> -&gt; &hellip; -&gt; c<sub>n</sub> -&gt; 1. the real number m will be the amount of US dollars at the start of the trip.</p>
