...
제출: 159, 정답: 57, 맞힌 사람: 49, 정답 비율: 35.766%
...
<p>The first line of the input file contains <em>N</em> (2 &le; <em>N</em> &le; 50 000). Next line contains <em>N</em> &minus; 1 integer numbers: X<sub>2</sub>, X<sub>3</sub>, ... , X<sub>N</sub> (1 &le; X<sub>2</sub> &lt; X<sub>3</sub> &lt; . . . &lt; X<sub>N</sub> &le; 10<sup>9</sup> ).</p>
