...
제출: 815, 정답: 557, 맞힌 사람: 503, 정답 비율: 68.716%
...
<p>각 테스트 케이스의 첫째 줄에는 단어의 개수 1 &le; m &le; 50이 주어진다. 다음 m개 줄에는 단어가 한 줄에 하나씩 주어진다. 각 단어의 길이는 최대 5글자이고, 공백을 포함하지 않는다. 다음 줄에는 참가자의 수 1 &le; n &le; 200이 주어지며, 다음 n개 줄에는 각 참가자의 비밀번호 정보가 주어진다.&nbsp;</p>

<p>비밀번호 정보는 정수 1 &le; k &le; 10 로 시작하며, 비밀번호를 이루고 있는 단어의 개수이다. 다음 k개 숫자는 단어의 인덱스를 나타내며, 순서대로 해당하는 단어를 연결한 문자열이 비밀번호이다.</p>
