...
제출: 3083, 정답: 1565, 맞힌 사람: 1435, 정답 비율: 51.861%
...
<p>가우스가 초등학교에 다닐 때, 선생님 J.G. B&uuml;ttner는 1부터 100까지 수의 합을 계산하게 시켰다. 가우스는 몇 초만에 정확한 답 5050을 계산했다.</p>
...
<p>첫째 줄에 테스트 케이스의 개수가 주어진다. 각 테스트 케이스는 한 줄로 이루어져 있으며, n과 m이 주어진다. (-10<sup>9</sup> &le; n &le; m &le; 10<sup>9</sup>)</p>
