...
제출: 8222, 정답: 6212, 맞힌 사람: 5698, 정답 비율: 77.704%
...
<p>입력의 첫 줄에는 테스트 케이스의 개수 T(1 &le; T &le; 10)가 주어진다. 각 테스트 케이스는 한 줄에 다섯 심판이 준 점수 다섯 개의 정수 N<sub>i</sub>(1 &le; N<sub>i</sub> &le; 10, i = 1, 2, ..., 5)가 하나의 공백을 사이에 두고 주어진다.</p>
