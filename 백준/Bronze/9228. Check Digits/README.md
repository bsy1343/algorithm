...
제출: 381, 정답: 195, 맞힌 사람: 168, 정답 비율: 49.267%
...
<p>Output will be a series of lines, one for each number in the input, except for the terminating #. Each line will consist of the original number followed by the characters &lsquo; -&gt; &rsquo; followed by either the check digit or the word &lsquo;Rejected&rsquo;.</p>