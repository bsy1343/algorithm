...
제출: 4280, 정답: 2544, 맞힌 사람: 2317, 정답 비율: 61.968%
...
<p>첫째 줄에 N이 주어진다. (1 &le; N &le; 20) 둘째 줄에는 파일을 삭제하기 전에 파일이 있었던 곳의 비트가 주어지고, 셋째 줄에는 삭제한 후에 비트가 주어진다. 비트는 0과 1로만 이루어져 있고, 두 문자열의 길이는 같다. 비트는 최대 1000개의 문자로 이루어져 있다.&nbsp;</p>
