...
제출: 823, 정답: 656, 맞힌 사람: 568, 정답 비율: 79.887%
...
<p>For each case, output the line &ldquo;Case x:&rdquo; where x is the case number, on a single line, followed by a list of integers, each on a new line, between 1 and 6. If the student has graduated from the school, do not print them.</p>