...
제출: 386, 정답: 257, 맞힌 사람: 233, 정답 비율: 73.502%
...
<p>For each case, output the line &ldquo;Case x:&rdquo; where x is the case number, on a single line. Then output a single space followed by an all-caps alphanumeric representation of the message, exactly five characters in length.</p>