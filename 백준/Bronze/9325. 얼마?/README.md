...
제출: 10573, 정답: 8595, 맞힌 사람: 7915, 정답 비율: 81.961%
...
<p>각 테스트 케이스의 첫 줄엔 자동차의 가격 s가&nbsp;주어진다.&nbsp;(1 &le; s &le; 100 000)</p>

<p>둘째 줄엔 해빈이가 구매하려고 하는&nbsp;서로 다른 옵션의 개수 n이&nbsp;주어진다.&nbsp;(0 &le; n &le; 1 000)</p>

<p>뒤이어 n개의 줄이 입력으로 들어온다. 각 줄은&nbsp;q 와 p로 이루어져 있는데&nbsp;q는 해빈이가 사려고 하는 특정 옵션의 개수이고 p는 해당 옵션의 가격이다. (1 &le; q &le; 100, 1 &le; p&nbsp;&le; 10 000)</p>
