...
제출: 4750, 정답: 2351, 맞힌 사람: 2167, 정답 비율: 50.833%
...
<p>각 테스트 케이스에 대해 삼각형이&nbsp;&ldquo;equilateral&rdquo;, &ldquo;isosceles&rdquo;, &ldquo;scalene&rdquo; 타입 중 어느 타입에 속하는지 출력한다. 만약 주어진 세 변의 길이로 삼각형이 만들어지지 않을경우,&nbsp;&ldquo;invalid!&rdquo;를 출력한다.</p>