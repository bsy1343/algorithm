...
제출: 201, 정답: 151, 맞힌 사람: 134, 정답 비율: 73.626%
...
<p>Stringld (left delete) is a function that gets a string and deletes its leftmost character (for instance Stringld(&ldquo;acm&rdquo;) returns &ldquo;cm&rdquo;).</p>
