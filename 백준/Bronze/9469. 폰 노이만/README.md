...
제출: 2677, 정답: 2147, 맞힌 사람: 1823, 정답 비율: 82.377%
...
<p>각 테스트 케이스는 다섯 숫자 N, D, A, B, F이루어져 있다. N은 테스트 케이스의 번호이고, D는 철로의 길이 (10 &le; D &le; 1000), A와 B는 두 기차의 속도 (1 &le; A, B &le; 40), F는 파리의 속도 (A &le; B &lt; F &le; 50)이다. D, A, B, F는 실수이다. 실수는 최대 소수점 둘째자리까지 주어진다.</p>
