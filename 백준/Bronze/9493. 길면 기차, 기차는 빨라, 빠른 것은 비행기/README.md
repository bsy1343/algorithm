...
제출: 2480, 정답: 1081, 맞힌 사람: 941, 정답 비율: 44.555%
...
<p>한 줄에 테스트 케이스가 하나씩 주어진다. 각 테스트 케이스는 세 개의 정수 M(1 &le; M &le; 10,000), A 그리고 B(1 &le; A &lt; B &le; 1000)로 이루어져 있다. 정수는 공백으로 구분되어 있다.</p>
