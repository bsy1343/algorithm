...
제출: 6309, 정답: 3127, 맞힌 사람: 2716, 정답 비율: 50.371%
...
<p>첫째 줄에 게임이 시작했을 때 폭탄을 들고 있는 사람의 번호 K (1 &le; K &le; 8)가 주어진다.</p>

<p>둘째 줄에는 질문의 개수 N (1 &le; N &le; 100)이 주어진다.</p>

<p>다음 N개 줄에는 i번째 질문을 대답하기까지 걸린 시간(단위: 초) T (1 &le; T &le; 100), 그 플레이어의 대답 Z (T, N, P중 하나) 가 주어진다.</p>
