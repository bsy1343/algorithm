...
제출: 471, 정답: 419, 맞힌 사람: 386, 정답 비율: 90.398%
...
<ul>
	<li>&ldquo;BOTH&rdquo;: If both the easiest and hardest problems got colors which they should not get.</li>
	<li>&ldquo;EASY&rdquo;: If only the easiest problem got a color which it should not get.</li>
	<li>&ldquo;HARD&rdquo;: If only the hardest problem got a color which it should not get.</li>
	<li>&ldquo;OKAY&rdquo;: If both the easiest and hardest problems got colors which they can get.</li>
</ul>