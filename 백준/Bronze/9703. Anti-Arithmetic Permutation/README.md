...
제출: 153, 정답: 115, 맞힌 사람: 101, 정답 비율: 75.373%
...
<p>For each test case, the output contains a line in the format Case #x: M, where x is the case number (starting from 1) and M is &ldquo;YES&rdquo; when the given permutation is anti-arithmetic or &ldquo;NO&rdquo; otherwise. Quotes are for clarity only.&nbsp;</p>