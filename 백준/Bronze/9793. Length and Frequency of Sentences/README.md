...
제출: 216, 정답: 146, 맞힌 사람: 122, 정답 비율: 66.304%
...
<p>The first line of the input contains an integer N (1 &le; N &le; 4,000) indicating the number of sentences. The following N lines are sentences, one sentence in each line. A sentence has between 2 to 75 words inclusive.</p>
