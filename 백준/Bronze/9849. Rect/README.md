...
제출: 278, 정답: 199, 맞힌 사람: 180, 정답 비율: 71.429%
...
<p>Given a set of rectangles {R<sub>1</sub>, R<sub>2</sub>, &middot; &middot; &middot; , R<sub>n</sub>}, compute the area of their common intersection. i.e.,</p>

<p style="text-align: center;">Area (R<sub>1</sub> &cap; R<sub>2</sub> &cap; &middot; &middot; &middot; &cap; R<sub>n</sub>)</p>

<p>The edges of the rectangles R<sub>1</sub>, R<sub>2</sub>, &middot; &middot; &middot; , R<sub>n</sub>, are either vertical or horizontal lines.</p>
...
<pre>
x<sub>1</sub> x<sub>2</sub> y<sub>1</sub> y<sub>2</sub></pre>

<p>such that 0 &le; x<sub>1</sub> &lt; x<sub>2</sub> &le; 10,000 and 0 &le; y<sub>1</sub> &lt; y<sub>2</sub> &le; 10,000, and x<sub>1</sub>, x<sub>2</sub>, y<sub>1</sub> and y<sub>2</sub> are int</p>
