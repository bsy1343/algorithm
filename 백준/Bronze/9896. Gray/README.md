...
제출: 203, 정답: 152, 맞힌 사람: 124, 정답 비율: 77.019%
...
<p>(1 &times; 2<sup>4</sup>) + (0 &times; 2<sup>3</sup>) + (1 &times; 2<sup>2</sup>) + (1 &times; 2<sup>1</sup>) + (1 &times; 2<sup>0</sup>) = (1 &times; 16) + (1 &times; 4) + (1 &times; 2) + (1 &times; 1) = 23.</p>
...
<pre style="text-align: center;">
<strong>0</strong> + <strong>1</strong> 1
    v  
0   1  
</pre>
...
<p>You are to write a program to convert an&nbsp;<i>n</i>-bit binary value into its equivalent&nbsp;<i>n</i>-bit standard Gray code value, where 1 &le;&nbsp;<i>n</i>&nbsp;&le; 20</p>
...
<ol>
	<li>The first line contains the integer&nbsp;<i>n</i>, the number of bits, where 1 &le;&nbsp;<i>n</i>&nbsp;&le; 20.</li>
