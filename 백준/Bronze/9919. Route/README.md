...
제출: 108, 정답: 81, 맞힌 사람: 73, 정답 비율: 76.042%
...
<p>More examples are given below, with the &ldquo;poles&rdquo; drawn on a straight line instead of a loop for easy viewing (but remember that after the last pole, the joggers must go further to finish at the first pole).</p>
...
<ol>
	<li>Read the input to obtain the length N of the route in metres (3 &le; N &le; 30,000) and the heights H<sub>i</sub>, 1 &le; i &le; N, of the poles in centimetres above sea-level (1 &le; H<sub>i</sub> &le; 30,000). &nbsp;All values are positive integers.</li>
