...
제출: 13260, 정답: 4221, 맞힌 사람: 2709, 정답 비율: 29.401%
...
<p>각각의 테스트 케이스에 대해서 적군 진영의 숫자 N (1 &le; N &le; 3,000)이 주어진다.&nbsp;이어서 N줄에 걸쳐 적군 진영의 좌표 x, y (0 &le; x, y &le; 5,000), 그리고 해당 진영의 R (0 &le; R &le; 5,000)이 주어진다. 주어지는 수는 모두 정수이다.</p>
