...
제출: 20732, 정답: 9264, 맞힌 사람: 6863, 정답 비율: 43.202%
...
<ul>
	<li>첫째 줄에 컴퓨터 개수 n, 의존성 개수 d, 해킹당한 컴퓨터의 번호 c가 주어진다(1 &le; n &le; 10,000, 1 &le; d &le; 100,000, 1 &le; c &le; n).</li>
	<li>이어서 d개의 줄에 각 의존성을 나타내는 정수 a, b, s가 주어진다(1 &le; a, b &le; n, a &ne; b, 0 &le; s &le; 1,000). 이는 컴퓨터 a가 컴퓨터 b를 의존하며, 컴퓨터 b가 감염되면 s초 후 컴퓨터 a도 감염됨을 뜻한다.</li>
</ul>
