...
제출: 31, 정답: 19, 맞힌 사람: 19, 정답 비율: 61.290%
...
<p>The input consists of one case. The first line contains two integers, N and W, the number of seats left and the number of weeks left before the flight (0 &lt; N &le; 300, 0 &le; W &le; 52). The next W + 1 lines give the estimates for W weeks, W &minus; 1 weeks, . . . , and down to 0 weeks (i.e. last week) before the flight. Each of these lines starts with an integer K (0 &lt; K &le; 100), the number of different prices to consider that week. This is followed by K integers 0 &lt; p<sub>1</sub> &lt; &middot; &middot; &middot; &lt; p<sub>K</sub> &lt; 1000 giving the prices in dollars. Finally, this is followed by K additional integers s<sub>1</sub>, . . . , s<sub>K</sub> (0 &le; s<sub>i</sub> &le; N) indicating the number of tickets that will be sold for the corresponding prices.</p>
