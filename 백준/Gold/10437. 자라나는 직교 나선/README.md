...
제출: 141, 정답: 87, 맞힌 사람: 56, 정답 비율: 61.538%
...
<p>각 테스트 케이스는 테스트 케이스의 번호 T와 문제에서 설명한 점 X,Y로 이루어져 있다. (1 &le; x &le; 10000, 1 &le; y &le; 10000)</p>
