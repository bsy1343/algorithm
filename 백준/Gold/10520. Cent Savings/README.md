...
제출: 215, 정답: 101, 맞힌 사람: 93, 정답 비율: 48.947%
...
<ul>
	<li>one line with two integers n (1 &le; n &le; 2 000) and d (1 &le; d &le; 20), the number of items and the number of available dividers;</li>
	<li>one line with n integers p<sub>1</sub>, . . . p<sub>n</sub> (1 &le; p<sub>i</sub> &le; 10 000 for 1 &le; i &le; n), the prices of the items in cents. The prices are given in the same order as the items appear on the belt.</li>
</ul>
