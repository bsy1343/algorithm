...
제출: 186, 정답: 122, 맞힌 사람: 89, 정답 비율: 73.554%
...
<p style="text-align: center;"><img alt="" src="/upload/images2/greatswerc.png" style="height:187px; width:245px" /></p>
...
<ul>
	<li>3 &le; n &le; 10</li>
	<li>Each word has at most 10 symbols (capital letters).</li>
	<li>A word problem has at most 10 distinct letters.</li>
</ul>