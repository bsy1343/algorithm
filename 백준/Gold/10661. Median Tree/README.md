...
제출: 106, 정답: 86, 맞힌 사람: 77, 정답 비율: 81.915%
...
<p>The first line contains an even number n (2 &le; n &le; 1,000) and an integer m (n-1 &le;&nbsp;m &le;&nbsp;10,000). n is the nubmer of nodes and m is the number of edges in the graph.</p>

<p>Then m lines follow, each of which contains s<sub>i</sub>&nbsp;(1 &le; s<sub>i</sub>&nbsp;&le; n), t<sub>i</sub>&nbsp;(1 &le; s<sub>i</sub>&nbsp;&le; n, t<sub>i</sub>&nbsp;&le; s<sub>i</sub>) and c<sub>i</sub>&nbsp;(1 &le; c<sub>i</sub>&nbsp;&le; 1,000). This means there is an edge between the nodes s<sub>i</sub>&nbsp;and t<sub>i</sub>&nbsp;and its cost is c<sub>i</sub>. There is no more than one edge which connects s<sub>i</sub>&nbsp;and t<sub>i</sub>.</p>
