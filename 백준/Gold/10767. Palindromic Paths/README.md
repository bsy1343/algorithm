# [Gold III] Palindromic Paths - 10767
...
제출: 650, 정답: 165, 맞힌 사람: 134, 정답 비율: 25.573%

### 분류

자료 구조, 그래프 이론, 해시를 사용한 집합과 맵, 중간에서 만나기, 문자열, 집합과 맵

### 문제 설명

<p>Farmer John&#39;s farm is in the shape of an N&times;N grid of fields (2&le;N&le;18), each labeled with a letter in the alphabet. For example:</p>
