...
제출: 882, 정답: 352, 맞힌 사람: 253, 정답 비율: 41.272%
...
<p>지용이는 이제 A 항구에서 출발해서 무인도 B에 자신의 제국을 건설하기 위해 멀고 먼 여행을 떠날 계획이다. (1 &le; A, B &le; N, A &ne; B)</p>
...
<p>첫 번째 줄에는 정수 K, N, M (1 &le; K &le; 200; 2 &le; N &le; 2000; 1 &le; M &le; 10000)이 주어진다.</p>

<p>이 후 M개의 줄에 각 바닷길의 정보가 A, B, t<sub>i</sub>, h<sub>i</sub> (1 &le; A, B &le; N; 1 &le; t<sub>i</sub> &le; 10<sup>5</sup>; 0 &le; h<sub>i</sub> &le; 200) 형태로 주어진다. 이는 A와 B를 잇는 바닷길이 존재하며, 이 바닷길은 t<sub>i</sub>의 시간이 걸리며 h<sub>i</sub> 만큼 뗏목을 깎아내린다는 것을 의미한다. A &ne; B임이 보장된다.</p>

<p>마지막 줄에는 시작점과 도착점인 A, B가 주어진다. (1 &le; A, B &le; N; A &ne; B)</p>
