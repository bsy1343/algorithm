...
제출: 21108, 정답: 4677, 맞힌 사람: 3363, 정답 비율: 24.322%
...
<p>첫 줄에는 공의 개수를 나타내는 자연수 N이 주어진다(1 &le; N &le; 200,000). 다음 N개의 줄 중 i번째 줄에는 i번째 공의 색을 나타내는 자연수 C<sub>i</sub>와 그 크기를 나타내는 자연수 S<sub>i</sub>가 주어진다(1 &le; C<sub>i</sub> &le; N, 1 &le; S<sub>i</sub> &le; 2,000). 서로 같은 크기 혹은 같은 색의 공들이 있을 수 있다.</p>
