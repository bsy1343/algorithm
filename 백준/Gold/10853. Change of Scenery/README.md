...
제출: 300, 정답: 89, 맞힌 사람: 67, 정답 비율: 33.333%
...
<p>The first line of the input starts with three integers N M and K, where N is the number of junctions and M is the number of streets in your city, and K is the number of junctions you pass every day (1 &le; K &le; N &le; 10 000, 0 &le; M &le; 1 000 000).</p>
...
<p>M lines follow. The i-th of those lines contains three integers a<sub>i</sub> b<sub>i</sub> c<sub>i</sub> and describes a street from junction a<sub>i</sub> to junction b<sub>i</sub> of length c<sub>i</sub> (1 &le; a<sub>i</sub>, b<sub>i</sub> &le; N, 1 &le; c<sub>i</sub> &le; 10 000). Streets are always undirected.</p>
...
<p>Print one line of output containing &ldquo;yes&rdquo; if there is another way you can take without losing time, &ldquo;no&rdquo; otherwise.</p>