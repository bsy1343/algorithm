...
제출: 329, 정답: 140, 맞힌 사람: 107, 정답 비율: 37.943%
...
<p>In SPL, numbers are expressed using nouns and adjectives. The positive noun has the value of 1, while the negative noun has the value of &minus;1. Adjectives are used to double the value. Articles such as &lsquo;a&rsquo;, &lsquo;an&rsquo;, and &lsquo;the&rsquo; may or may not be used.</p>
...
<p>To construct arbitrary integers other than the power of two, you can use basic arithmetic to make those integers. The expression &ldquo;the sum of (A) and (B)&rdquo; is used to get the value of A + B and &ldquo;the difference between (A) and (B)&rdquo; is used to get the value of A&minus;B, where &ldquo;(A)&rdquo; and &ldquo;(B)&rdquo; represents numbers written in &lsquo;Shakespearean&rsquo; form. No adjectives are allowed in these form (e.g. &lsquo;the mighty sum of hero and king&rsquo; is invalid.) The other operations such as multiplication and division are also present in original SPL, but for the simplicity, we assume that only addition and subtraction are to be used in this problem.</p>
...
<p>The first line of the input contains one integer T (1 &le; T &le; 10, 000), the number of test cases. Each test case consists of one line, which contains one integer N (|N| &le; 50, 000), which is the number to be expressed in the Shakespearean form.</p>
