...
제출: 352, 정답: 130, 맞힌 사람: 101, 정답 비율: 39.921%
...
<p>첫 번째 줄에 조사하고자 하는 정민의 세대 D(1 &le; D &le; 100)가 주어진다.</p>

<p>두 번째 줄에는 D개의 정수가 주어지는데, 차례대로 d<sub>i</sub> (1 &le; i &le; D,1 &le; d<sub>i</sub> &le; i)가 공백으로 구분되어 주어지며, d<sub>i</sub>는 i&minus;1 세대의 정민이 d<sub>i</sub>번째로 낳은 자식을 보겠다는 의미이다.</p>
