...
제출: 146, 정답: 65, 맞힌 사람: 53, 정답 비율: 56.989%
...
<p>이 문제는&nbsp;<a href="https://onlinejudgeimages.s3-ap-northeast-1.amazonaws.com/problem/10960/data.tar.gz" style="line-height: 20.8px;">압축 파일</a>에서 calvin3.in으로 채점을 한다. (예제는 채점하지 않는다)</p>