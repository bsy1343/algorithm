# [Gold I] Calvinball championship, again 8 - 10968

[문제 링크](https://www.acmicpc.net/problem/10968)
...
제출: 43, 정답: 17, 맞힌 사람: 13, 정답 비율: 46.429%

### 분류

그래프 이론, 그래프 탐색, 깊이 우선 탐색, 무작위화
...
<p>이 문제는&nbsp;<a href="https://onlinejudgeimages.s3-ap-northeast-1.amazonaws.com/problem/10960/data.tar.gz" style="line-height: 20.8px;">압축 파일</a>에서 calvin8.in으로 채점을 한다. (예제는 채점하지 않는다)</p>