...
제출: 73, 정답: 42, 맞힌 사람: 32, 정답 비율: 55.172%

### 분류

그래프 이론, 그래프 탐색, 너비 우선 탐색, 백트래킹, 이분 그래프
...
<p>이 문제는&nbsp;<a href="https://onlinejudgeimages.s3-ap-northeast-1.amazonaws.com/problem/10960/data.tar.gz" style="line-height: 20.8px;">압축 파일</a>에서 calvin10.in으로 채점을 한다. (예제는 채점하지 않는다)</p>