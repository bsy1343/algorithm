...
제출: 137, 정답: 56, 맞힌 사람: 48, 정답 비율: 41.379%
...
<p>The first line contains a positive integer T (T &le; 20) indicating the number of test cases. The first line of each test case contains two integer n and m (n &le; 1000, 0 &le; m &le; min(n(n-1)/2 , 105432)) where n is the number of kinds of materials and m is the number of pairs on the list. Each of the following m lines contains two integer a and b indicating that material a and material b will cause an explosion if they are put in the same package.</p>
