...
제출: 82, 정답: 44, 맞힌 사람: 42, 정답 비율: 60.870%
...
<p>In mathematics, we usually specify the order of operations by using parentheses. For example, 7 &times; (3 + 2) always means multiplying 7 by the result of 3 + 2 and never means adding 2 to the result of 7 &times; 3. However, there are people who do not like parentheses. International Counter of Parentheses Council (ICPC) is attempting to make a notation without parentheses the world standard. They are always making studies of such no-parentheses notations.</p>
...
<p>Figure 4: (2 + 3) &times; 4 &times; 5</p>
