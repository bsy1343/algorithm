...
제출: 127256, 정답: 32613, 맞힌 사람: 23063, 정답 비율: 24.010%
...
<p>첫째 줄에 수빈이가 이동하려고 하는 채널 N (0 &le; N &le; 500,000)이 주어진다.  둘째 줄에는 고장난 버튼의 개수 M (0 &le; M &le; 10)이 주어진다. 고장난 버튼이 있는 경우에는 셋째 줄에는 고장난 버튼이 주어지며, 같은 버튼이 여러 번 주어지는 경우는 없다.</p>
