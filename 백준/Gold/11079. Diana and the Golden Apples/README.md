...
<p>The first line of input contains 5 space-separated integers: 1 &le; L &le; 1 000, the length of the race in units of 100 m; 10 &le; Td, Th &le; 30 the time in seconds that it takes Diana and Humperdonkey respectively to run 100 m; 0 &le; N &le; 1000 the number of golden apples Humperdonkey has placed on the race track; and 0 &lt; d &le; 10, the extra time in seconds that Diana takes to cover 100 m for each additional kilogram of gold that she is carrying.</p>

<p>This is followed by N lines, each with 2 space-separated integers 0 &lt; wi &le; 50, the weight of the ith apple in kg and 0 &le; xi &lt; L, the distance of the ith apple from the start of the track in units of 100 m.</p>

### 출력

<p>A single integer W &ge; 0, being the maximum weight in gold apples that Diana can be carrying when she crosses the finish line if she is to finish ahead of Prince Humperdonkey. If Diana is unable to beat Humperdonkey the output line should instead be</p>

<pre>
Diana marries Humperdonkey</pre>