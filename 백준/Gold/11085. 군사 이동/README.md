...
제출: 1951, 정답: 1259, 맞힌 사람: 1046, 정답 비율: 64.290%
...
<p>첫 줄에 p와 w가 공백을 사이에 두고 주어집니다. (2 &le; p &le; 1 000; 1 &le; w &le; 50 000)</p>

<p>다음 줄에 Baekjoon World의 수도 c와 Cube World의 수도 v가 공백을 사이에 두고 주어집니다. (0 &le; c, v &lt; p; c &ne; v)</p>

<p>다음 w줄에 길이 연결하는 두 지점 w<sub>start</sub>, w<sub>end</sub>,와 길의 너비 w<sub>width</sub>가 공백을 사이에 두고 주어집니다. (0 &le; w<sub>start</sub>, w<sub>end</sub> &lt; p; w<sub>start</sub> &ne; w<sub>end</sub>; 1 &le; w<sub>width</sub> &le; 1 000)</p>
