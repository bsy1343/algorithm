...
제출: 98, 정답: 46, 맞힌 사람: 39, 정답 비율: 45.882%
...
<p>Each input will consist of a single test case. Note that your program may be run multiple times on different inputs. Each test case will begin with a single integer n (1 &le; n &le; 1,000,000) indicating the number of cards in the deck. On the next line will be n unique integers c (1 &le; c &le; n), with a single space between them, indicating an ordering of the n cards. The values c are guaranteed to be a permutation of the numbers 1..n.</p>
