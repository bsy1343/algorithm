...
제출: 30031, 정답: 11574, 맞힌 사람: 7542, 정답 비율: 41.449%
...
<p>N(2 &le; N &le; 50,000)개의 정점으로 이루어진 트리가 주어진다. 트리의 각 정점은 1번부터 N번까지 번호가 매겨져 있으며, 루트는 1번이다.</p>

<p>두 노드의 쌍 M(1 &le; M &le; 10,000)개가 주어졌을 때, 두 노드의 가장 가까운 공통 조상이 몇 번인지 출력한다.</p>
