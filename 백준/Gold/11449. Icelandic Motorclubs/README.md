...
제출: 53, 정답: 36, 맞힌 사람: 31, 정답 비율: 67.391%
...
<ul>
	<li>One line containing an integer 3 &le; N &le; 1, 000 000 denoting the number of gas stations on the circular road (assume stations are numbered from 1 to N).</li>
	<li>N lines, each describing a gas station using two space-separated integers G and D (with 0 &le; G &le; 512 and 1 &le; D &le; 512), representing the amount of gas available at this gas station and the distance to the next gas station in miles. Because it is a circular road, the final gas station N lists the distance to gas station 1.</li>
</ul>
