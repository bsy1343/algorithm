...
제출: 41, 정답: 20, 맞힌 사람: 15, 정답 비율: 44.118%
...
<ul>
	<li>One line consisting of two positive integers r c (1 &lt; r, c &le; 60), the size of the school in rows and columns.</li>
	...
	<li>One line consisting of a single integer p (1 &le; p &le; 200) representing the number of patrolling masters.</li>
...
<p>All &lsquo;special&rsquo; coordinates (locations of the bed, fridge, and masters) will be marked as walkable on the map.</p>
