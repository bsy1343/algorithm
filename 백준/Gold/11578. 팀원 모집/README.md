...
제출: 2100, 정답: 880, 맞힌 사람: 710, 정답 비율: 42.187%
...
<p>두 번째 줄부터 M개의 줄에 차례대로 i(1 &le; i &le; M)번 학생들이 풀 수 있는 문제의 개수 O<sub>i</sub>와 i번 학생이 풀 수 있는 문제의 번호 P<sub>ij</sub>(1 &le; j &le; O<sub>i</sub>, 1 &le; P<sub>ij</sub> &le; N)가 O<sub>i</sub>개 주어진다.</p>
