...
제출: 32, 정답: 28, 맞힌 사람: 24, 정답 비율: 88.889%
...
<p>Congratulations! You were selected to take part in the TV game show Who Wants to Be a Millionaire! Like most people, you are somewhat risk-averse, so you might rather take \$250,000 than a 50% chance of winning \$1,000,000. On the other hand, if you happen to already be rich, then you might as well take a chance on the latter. Before appearing on the show, you want to devise a strategy to maximize the expected happiness derived from your winnings.</p>

<p>More precisely, if your present net worth is W dollars, then winning v dollars gives you ln(1 + v/W) units of happiness. Thus, the game&rsquo;s expected happiness is &Sigma;<sub>v</sub>P(v) ln(1+v/W), where P(v) is the probability that you&rsquo;ll win v dollars, and the summation is taken over all possible values of v. Since happiness units are too abstract, you will be asked to measure the value of the game in dollars. That is, compute D such that a guaranteed payout of D dollars makes you as happy as a chance on the show, assuming optimal play.</p>
...
<p>For example, the game in the first sample input is worth 0.5 ln(1 + 5000/4000) &asymp; 0.405 units of happiness. Getting \$2,000 would likewise grant ln(1 + 2000/4000) &asymp; 0.405 happiness.</p>

### 입력

<p>The first line of input contains two space-separated integers n and W (1 &le; n &le; 10<sup>5</sup> , 1 &le; W &le; 10<sup>6</sup>). Line i + 1 describes the ith question. It starts with a string, which is one of safe or unsafe, indicating whether the ith question is safe or not. The string is followed by a real number p<sub>i</sub> and an integer v<sub>i</sub> (0 &le; p<sub>i</sub> &le; 1, 1 &le; v<sub>i</sub> &lt; v<sub>i+1</sub> &le; 10<sup>6</sup>).</p>
