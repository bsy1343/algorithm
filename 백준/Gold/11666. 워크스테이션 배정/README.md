...
제출: 714, 정답: 307, 맞힌 사람: 245, 정답 비율: 44.224%
...
<ul>
	<li>첫 번째 줄에 연구원의 수 n (1 &le; n &le; 300 000), 워크스테이션이 자동으로 잠기는 기준 시간 m (1 &le; m &le; 10<sup>8</sup>) 이 주어진다.&nbsp;</li>
	<li>n개의 줄에 a와 s가 주어진다. (1 &le; a, s &le; 10<sup>8</sup>) 연구원들은 a분에 도착해서, 정확히 s분동안 머무른다.</li>
</ul>
