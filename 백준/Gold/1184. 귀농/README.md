...
제출: 1488, 정답: 709, 맞힌 사람: 510, 정답 비율: 49.467%
...
<p>상근이와 선영이는 도심 속의 삶에 싫증을 느꼈고, 친구 현수가 있는 시골로 농사를 지으려 내려왔다. 현수의 땅은 크기가 N&times;N 인 정사각형이고, 땅은 단위 정사각형 1&times;1로 나누어져 있다. 각 단위 정사각형 (i,j)의 수익은 A<sub>ij</sub>이다. A<sub>ij</sub>는 음수가 될 수도 있다. (땅을 경작하지 않아 관리가 필요한 경우)</p>
...
<p>첫째 줄에 땅의 크기 N (1 &le; N &le; 50)이 주어진다.</p>
