...
제출: 72, 정답: 39, 맞힌 사람: 38, 정답 비율: 57.576%
...
<p>Each line contains two integer number N (1 &le; N &le; 300000) and M (1 &le; M &le; 300000) - number of villages and traders accordingly.</p>

<p>Next M lines contains 3 numbers each: L<sub>i</sub>, R<sub>i</sub> (1 &le; L<sub>i</sub> &le; R<sub>i</sub> &le; N) and X<sub>i</sub> (1 &le; X<sub>i</sub> &le; 10<sup>9</sup>) - numbers of first and last village and starting price for i-th trader.</p>
