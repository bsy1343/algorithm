...
제출: 652, 정답: 156, 맞힌 사람: 128, 정답 비율: 34.595%
...
<ul>
	<li>1 &le; K &le; N &le; 50</li>
	<li>-10,000 &le;&nbsp;x<sub>i,1</sub>, y<sub>i,1</sub>,&nbsp;x<sub>i,2</sub>, y<sub>i,2</sub> &le; 10,000</li>
	<li>x<sub>i,1</sub>&nbsp;&lt;&nbsp;x<sub>i,2</sub></li>
	<li>y<sub>i,1</sub>&nbsp;&lt;&nbsp;y<sub>i,2</sub></li>
</ul>