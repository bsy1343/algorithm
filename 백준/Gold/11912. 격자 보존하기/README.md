...
제출: 340, 정답: 93, 맞힌 사람: 81, 정답 비율: 28.322%
...
<p>두 번째 줄에는 k개의 정수 p<sub>1</sub>, p<sub>2</sub>, ..., p<sub>k</sub>가 공백을 사이로 두고 주어집니다. 이 중 i (1 &le; i &le; k)번째 정수 p<sub>i</sub>는 i번 말이 위치한 칸의 번호를 나타냅니다.</p>

<ul>
	<li>2 &le; n &le; 10<sup>9</sup></li>
	<li>1 &le; k &le; min(10<sup>5</sup>, n)</li>
	<li>1 &le; d &le; n - 1</li>
	<li>1 &le; p<sub>1</sub> &lt; p<sub>2</sub> &lt; ... &lt; p<sub>k - 1</sub> &lt; p<sub>k</sub> &le; n</li>
</ul>
