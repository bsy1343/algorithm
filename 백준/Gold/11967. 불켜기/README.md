...
제출: 15109, 정답: 4723, 맞힌 사람: 3268, 정답 비율: 28.931%
...
<p>농부 존은 최근에 N &times; N개의 방이 있는 거대한 헛간을 새로 지었다. 각 방은 (1, 1)부터 (N,N)까지 번호가 매겨져있다(2 &le; N &le; 100). 어둠을 무서워하는 암소 베시는 최대한 많은 방에 불을 밝히고 싶어한다.</p>
...
<p>첫 번째 줄에는 N(2 &le; N &le; 100)과, M(1 &le; M &le; 20,000)이 정수로 주어진다.</p>
