...
제출: 122659, 정답: 45718, 맞힌 사람: 26986, 정답 비율: 38.560%
...
<p>첫째 줄에 정점의 개수 V(1 &le; V &le; 10,000)와 간선의 개수 E(1 &le; E &le; 100,000)가 주어진다. 다음 E개의 줄에는 각 간선에 대한 정보를 나타내는 세 정수 A, B, C가 주어진다. 이는 A번 정점과 B번 정점이 가중치 C인 간선으로 연결되어 있다는 의미이다. C는 음수일 수도 있으며, 절댓값이 1,000,000을 넘지 않는다.</p>
