# [Gold I] Travel (Large) - 12067

[문제 링크](https://www.acmicpc.net/problem/12067)
...
제출: 20, 정답: 16, 맞힌 사람: 16, 정답 비율: 88.889%

### 분류

그래프 이론, 최단 경로, 데이크스트라, 오프라인 쿼리
...
<ul>
	...
	<li>1 &le;&nbsp;<strong>T</strong>&nbsp;&le; 5.</li>
	<li>2 &le;&nbsp;<strong>N</strong>&nbsp;&le; 500.</li>
	<li>1 &le;&nbsp;<strong>M</strong>&nbsp;&le; 2000.</li>
	<li>1 &le;&nbsp;<strong>K</strong>&nbsp;&le; 5000.</li>
</ul>
