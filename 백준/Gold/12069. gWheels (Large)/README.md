# [Gold IV] gWheels (Large) - 12069

[문제 링크](https://www.acmicpc.net/problem/12069)
...
제출: 167, 정답: 67, 맞힌 사람: 22, 정답 비율: 20.370%

### 분류

수학, 자료 구조, 브루트포스 알고리즘, 정수론, 해시를 사용한 집합과 맵, 유클리드 호제법
...
<ul>
	...
	<li>1 &le;&nbsp;<strong>N<sub>p</sub>, N<sub>t</sub></strong>&nbsp;&le; 2000.</li>
	<li>2 &le;&nbsp;<strong>N<sub>e</sub></strong>&nbsp;&le; 2000.</li>
</ul>
