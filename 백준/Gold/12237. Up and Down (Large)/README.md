...
제출: 151, 정답: 70, 맞힌 사람: 61, 정답 비율: 55.455%
...
<ul>
	...
	<li>1 &le; <strong>A</strong><strong><sub>i</sub></strong> &le; 10<sup>9</sup></li>
...
<p>In the first case, the sequence is already in the desired form (with <strong>m</strong>=<strong>N</strong>=3) so no swaps are required.</p>

<p>In the second case, swapping 3 and 7 produces an <em>up and down</em> sequence (with <strong>m</strong>=3).</p>