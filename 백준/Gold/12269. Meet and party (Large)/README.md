...
제출: 60, 정답: 29, 맞힌 사람: 26, 정답 비율: 56.522%

### 분류

수학, 정렬, 기하학, 이분 탐색, 누적 합, 삼분 탐색
...
<ul>
	...
	<li><span style="line-height:1.6em">1 &le; </span><strong style="line-height:1.6em">B</strong><span style="line-height:1.6em"> &le; 1000.</span></li>
	<li>1 &le; <strong>Total number of people in each test case</strong> &le; 1000000.</li>
</ul>