...
제출: 44, 정답: 28, 맞힌 사람: 25, 정답 비율: 69.444%

### 분류

구현, 자료 구조, 그래프 이론, 집합과 맵, 최단 경로, 해시를 사용한 집합과 맵, 데이크스트라, 분리 집합
...
<ul>
	<li>1 &le; <strong>S</strong> &le; 100.</li>
	<li>1 &le; <strong>a</strong><strong><sub>i</sub></strong><strong>, b</strong><strong><sub>i</sub></strong> &le; <strong>N</strong>.</li>
	<li>0 &le; <strong>t</strong><strong><sub>i</sub></strong> &le; 1000.</li>
	<li>1 &le; <strong>p</strong><strong><sub>j</sub></strong><strong>, q</strong><strong><sub>j</sub></strong> &le; <strong>N</strong>.</li>
	<li><strong style="line-height:1.6em">T</strong><span style="line-height:1.6em"> = 1.</span></li>
	<li>1 &le; <strong>N</strong> &le; 80000.</li>
	<li>0 &le; <strong>M</strong> &le; 3000.</li>
</ul>
