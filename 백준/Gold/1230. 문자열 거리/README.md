...
제출: 1122, 정답: 264, 맞힌 사람: 199, 정답 비율: 30.060%
...
<p>문자열 O에서 문자열 N까지 문자열 거리는 O를 N과 같게 만들기 위해 필요한 문자열 삽입의 최솟값이다. 문자열 삽입은 O의 어느 위치에서건 가능하다. 예를 들어, O가 &ldquo;gosrl&quot;일 때, &rdquo;sip gi&quot;을 r이전에 삽입한다면 &quot;gossip girl&ldquo;이 된다.</p>
