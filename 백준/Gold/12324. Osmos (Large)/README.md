...
제출: 74, 정답: 40, 맞힌 사람: 33, 정답 비율: 50.769%

### 분류

브루트포스 알고리즘, 그리디 알고리즘, 구현, 시뮬레이션, 정렬
...
<ul>
	...
	<li>1 &le; <strong>A</strong> &le; 10<sup>6</sup>.</li>
	<li>1 &le; all mote sizes &le; 10<sup>6</sup>.</li>
