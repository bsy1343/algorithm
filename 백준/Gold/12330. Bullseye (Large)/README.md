...
제출: 115, 정답: 52, 맞힌 사람: 47, 정답 비율: 58.750%

### 분류

수학, 기하학, 이분 탐색, 매개 변수 탐색, 임의 정밀도 / 큰 수 연산
...
<ul>
	<li>1 &le; <strong>T</strong> &le; 6000.</li>
	<li>1 &le; <strong>r</strong> &le; 10<sup>18</sup>.</li>
	<li>1 &le; <strong>t</strong> &le; 2 &times; 10<sup>18</sup>.</li>
</ul>
