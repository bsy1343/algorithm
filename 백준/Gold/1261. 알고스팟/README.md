...
제출: 50693, 정답: 23149, 맞힌 사람: 16124, 정답 비율: 44.688%
...
<p>첫째 줄에 미로의 크기를 나타내는 가로 크기 M, 세로 크기 N (1 &le; N, M &le; 100)이 주어진다. 다음 N개의 줄에는 미로의 상태를 나타내는 숫자 0과 1이 주어진다. 0은 빈 방을 의미하고, 1은 벽을 의미한다.</p>
