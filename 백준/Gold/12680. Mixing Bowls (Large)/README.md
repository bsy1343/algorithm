# [Gold I] Mixing Bowls (Large) - 12680

[문제 링크](https://www.acmicpc.net/problem/12680)
...
제출: 48, 정답: 21, 맞힌 사람: 18, 정답 비율: 48.649%

### 분류

다이나믹 프로그래밍, 자료 구조, 그리디 알고리즘, 문자열, 정렬, 트리, 집합과 맵, 해시를 사용한 집합과 맵, 트리에서의 다이나믹 프로그래밍
