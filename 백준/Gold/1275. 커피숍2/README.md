...
제출: 24235, 정답: 8000, 맞힌 사람: 6255, 정답 비율: 32.257%
...
<p>N개의 정수가 있으면, 동호는 다음과 같이 말한다. &ldquo;3~7번째 수의 합은 무엇이죠?&rdquo; 그러면 상대방은 &ldquo;그 답은 000입니다. 그리고 8번째 수를 2로 고치도록 하죠&rdquo; 그러면 동호는 &ldquo;네 알겠습니다.&rdquo;라고 한 뒤에 다시 상대방이 동호가 했던 것처럼 &ldquo;8~9번째 수의 합은 무엇이죠?&rdquo;라고 묻게된다. 이 것을 번갈아 가면서 반복하는 게임이다.</p>
...
<p>첫째 줄에 수의 개수 N과 턴의 개수 Q가 주어진다.(1 &le;&nbsp;N, Q &le; 100,000) 둘째 줄에는 처음 배열에 들어가 있는 정수 N개가 주어진다. 세 번째 줄에서 Q+2번째 줄까지는 x y a b의 형식으로 x~y까지의 합을 구하여라, a번째 수를 b로 바꾸어라 라는 뜻의 데이터가 주어진다.</p>
