...
제출: 4901, 정답: 1739, 맞힌 사람: 1410, 정답 비율: 36.604%
...
<p>입력의 첫 줄에는 도윤이와 친구들이 선택한 점의 좌표 <em>x</em>, <em>y</em>(-10,000 &le; <em>x</em>, <em>y</em> &le; 10,000)가 순서대로 4개 주어진다. <em>x</em>, <em>y</em>값은 항상 정수이다.</p>
