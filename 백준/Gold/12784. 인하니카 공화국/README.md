...
제출: 3337, 정답: 1322, 맞힌 사람: 990, 정답 비율: 38.283%
...
<p>입력의 첫 줄에는 테스트 케이스의 개수 <em>T</em>(1 &le; <em>T</em> &le; 100)가 주어진다.</p>

<p>각 테스트 케이스의 첫 번째 줄에는 섬의 수 <em>N</em>(1 &le; <em>N</em> &le; 1,000)과 다리의 수 <em>M</em>이 주어진다.</p>

<p>다음으로 <em>M</em>개의 줄에는 각 다리를 통해 이어진 두 섬의 번호와 다리를 파괴하기 위한 다이너마이트의 수 <em>D</em>(1 &le; <em>D</em> &le; 20)가 주어진다.</p>
