...
제출: 317, 정답: 180, 맞힌 사람: 120, 정답 비율: 55.046%
...
<p>첫 번째 줄에는 도시의 버스 정류장의 수, 정수 N이 주어진다. 버스 정류장은 1번부터 N번까지 있다. 이후의 N - 1개의 줄은 도시의 도로를 나타낸다. 각각의 줄은 도로에 의해 연결된 두개의 다른 버스 정류장 번호 x, y(&nbsp;1 &le; x, y &le; N)를 포함한다.</p>

<p>단 1 &le; N &le; 10<sup>6</sup>이다.</p>
