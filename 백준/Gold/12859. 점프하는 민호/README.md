...
제출: 132, 정답: 74, 맞힌 사람: 58, 정답 비율: 56.311%
...
<p>첫 번째 줄에는 카드의 개수 n (1 &le;&nbsp;n &le; 300) 이 주어진다.</p>

<p>두 번째 줄에는 n개의 카드가 가지고 있는 l<sub>i</sub> (1 &le;&nbsp;l<sub>i</sub> &le; 10<sup>9</sup>)이 주어진다.</p>

<p>세 번째 줄에는 n개의 카드가 가지고 있는 c<sub>i</sub> (1 &le; c<sub>i</sub> &le; 10<sup>5</sup>)이 주어진다.</p>
