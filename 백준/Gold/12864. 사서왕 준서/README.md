...
제출: 191, 정답: 116, 맞힌 사람: 92, 정답 비율: 58.974%
...
<p>첫 줄에 준서가 정리해야하는 책의 수 N(1 &le; N &le; 5,000)이 들어온다. 두 번째 줄에는 준서가 정리해야하는 책의 번호 N개가 현재 꽂혀있는 순서대로 주어진다. 세 번째 줄에는 각 책의 무게 N개가 현재 꽂혀있는 순서대로 주어진다. 책의 번호는 모두 0보다 크고 1000보다 작은 실수이며, 책의 무게는 1보다 크거나 같고 10,000보다 작거나 같은 정수이다.</p>
