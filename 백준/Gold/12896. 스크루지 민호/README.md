...
제출: 899, 정답: 367, 맞힌 사람: 293, 정답 비율: 40.137%
...
<p>첫째 줄에는 천나라에 있는 도시의 수 N (2 &le; N &le; 100,000) 이 주어진다.&nbsp; 다음 N - 1 줄에 걸쳐 도시들의 연결 상태가 주어진다.</p>

<p>각각의 줄에는 공백을 기준으로 세개의 숫자가 u, v (1 &le; u, v &le; N) 가 주어지는데 이는 도시 u와 v가 양방향 도로로 연결이 되어 있다는 것을 의미한다.</p>
