...
제출: 523, 정답: 217, 맞힌 사람: 166, 정답 비율: 39.618%
...
<p>같은 개수의 자릿수를 갖는 두 자연수 A와 B가 주어질 때, A &le; x &lt;&nbsp;y &le; B 인 멋진 쌍 (x, y)의 개수를 출력하세요.</p>

### 입력

<p>첫 번째 줄에 두 자연수 A, B가 주어진다. A &le; B &le; 2,000,000, A와 B의 자릿수 개수는 같다.</p>
