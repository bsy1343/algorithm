...
제출: 366, 정답: 111, 맞힌 사람: 91, 정답 비율: 35.271%
...
<p>첫째 줄에 도시의 개수 N (1 &le; N &le; 100)과 도로의 개수 M (1 &le; M &le; 2,000)이 주어진다.</p>

<p>둘째 줄부터 M개의 줄에는 도로의 정보가 0번 도로부터 순서대로 주어진다.</p>

<p>도로의 정보는 from, to, time으로 이루어져 있으며, from과 to를 오가는데 걸리는 시간이 time이라는 뜻이다. (0 &le; from, to &le; N-1, 1 &le; time &le; 1,000, from &ne; to)</p>
