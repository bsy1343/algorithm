...
제출: 11847, 정답: 6778, 맞힌 사람: 5499, 정답 비율: 57.067%
...
<p>입력의 첫 줄에는 유치원에 있는 원생의 수를 나타내는 자연수 N(1 &le; N &le; 300,000)과 나누려고 하는 조의 개수를 나타내는 자연수 K(1 &le; K &le; N)가 공백으로 구분되어 주어진다. 다음 줄에는 원생들의 키를 나타내는 N개의 자연수가 공백으로 구분되어 줄 서 있는 순서대로 주어진다. 태양이는 원생들을 키 순서대로 줄 세웠으므로, 왼쪽에 있는 원생이 오른쪽에 있는 원생보다 크지 않다. 원생의 키는 10<sup>9</sup>를 넘지 않는 자연수이다.</p>
