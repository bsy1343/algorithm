...
제출: 2684, 정답: 1423, 맞힌 사람: 994, 정답 비율: 50.177%
...
<p>For each graph, a single line with &ldquo;tree&rdquo; if the graph represents a tree or &ldquo;graph&ldquo; otherwise.</p>