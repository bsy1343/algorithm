...
제출: 196, 정답: 73, 맞힌 사람: 53, 정답 비율: 36.806%
...
<p>An integer m (2 &le; m &le; 100) represents the lifetime (in years) of the bamboos with the shortest lifetime that Dr. ACM can use for gardening. An integer n (1 &le; n &le; 500,000) represents the number of blocks.</p>
