...
제출: 880, 정답: 320, 맞힌 사람: 238, 정답 비율: 37.658%
...
<p>&ldquo;정수 N(N &le; 100000)개가 있을 때, N개의 합을 100으로 나눈 값을 X라고 하자. 이때 acos(X)를 계산하여라. 단, 숫자의 합은 &ndash;100 이상 100 이하인 것이 보장된다.&rdquo;</p>
...
<p>첫 번째 줄에 점의 개수 N (1 &le; N &le; 100000)을 출력한다.</p>
