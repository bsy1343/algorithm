...
제출: 1208, 정답: 307, 맞힌 사람: 242, 정답 비율: 27.500%
...
<p>케이크를 재미있게 먹기 위해서 여러 가지 패턴을 만들기로 했다. 그렇게 되면 영식이가 먹게되는 케이크는 달라지게 된다. 만약 &ldquo;영식,민식,영식&rdquo;과 같이 먹게되면 다음과 같이 먹는다.</p>
...
<ul>
	<li>0 &le; a &le; b &le; 2<sup>63</sup>-1</li>
	<li>a와 b는 서로소</li>
</ul>