...
제출: 5593, 정답: 1834, 맞힌 사람: 1475, 정답 비율: 31.131%
...
<p style="text-align:center"><img alt="" src="%EB%B0%B1%EC%A4%80/Gold/13422.%E2%80%85%EB%8F%84%EB%91%91/710d473a.png" data-original-src="%EB%B0%B1%EC%A4%80/Gold/13422.%E2%80%85%EB%8F%84%EB%91%91/710d473a.png" data-original-src="https://onlinejudgeimages.s3-ap-northeast-1.amazonaws.com/problem/13422/1.png" onerror="this.onerror=null;this.src=this.dataset.originalSrc" style="height:300px; width:302px" /></p>
...
<p>입력 데이터는 표준 입력을 사용한다. 입력은 T개의 테스트 데이터로 구성된다. 입력의 첫째 줄에 테스트 케이스의 개수를 나타내는 자연수 T가 주어진다. 각각의 테스트 케이스의 첫째 줄에 마을에 있는 집의 개수 N(1 &le; N &le; 100,000), 도둑이 돈을 훔칠 연속된 집의 개수 M(1 &le; M &le; N), 자동 방범 장치가 작동하는 최소 돈의 양 K(1 &le; K &le; 1,000,000,000, K는 정수)가 공백으로 구분되어 주어진다. 테스트 케이스의 둘째 줄에는 N개의 집에서 각각 보관중인 돈의 양이 시계방향 순서대로 공백으로 구분되어 주어진다. 돈의 양은 각 집이 이웃해 있는 순서대로 주어진다. 첫 번째 집과 마지막 집 또한 이웃하기 위해 입력의 첫 번째와 마지막이 서로 연결되어 있다고 가정하며, 각 집에서 보관 중인 돈의 양은 1이상 10,000이하의 정수이다.</p>
