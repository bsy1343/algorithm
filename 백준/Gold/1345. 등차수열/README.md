...
제출: 1192, 정답: 216, 맞힌 사람: 166, 정답 비율: 20.393%
...
<p>수열 S가 주어진다. 수열 S<sub>i</sub>&nbsp;= &lfloor;A<sub>i+1</sub>&rfloor;이다. 그리고, 감소하지 않는 수열이다. &lfloor;x&rfloor;는 x보다 작거나 같은 정수 중 가장 큰 값이다. 예를 들어 &lfloor;3.4&rfloor; = 3, &lfloor;0.6&rfloor; = 0, &lfloor;-1.2&rfloor; = -2, &lfloor;-0.6&rfloor; = 1이다.</p>
