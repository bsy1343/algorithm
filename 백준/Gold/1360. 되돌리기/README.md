...
제출: 2507, 정답: 801, 맞힌 사람: 665, 정답 비율: 35.354%
...
<ul>
	<li>&ldquo;type c&quot; : 현재 글의 가장 뒤에 문자 c를 추가한다.</li>
	<li>&ldquo;undo t&quot; : 이전 t초동안 수행된 작업을 역순으로 되돌린다.</li>
</ul>
...
<p>2초일 때, 텍스트는 &ldquo;ab&quot;이다. 3초때 모든 것이 되돌리기 되므로 텍스트는 빈 텍스트가 되고, 4초때 3초때 되돌리기 한 것이 되돌리기 되고, 2초때 type b한 것이 지워진다. 따라서 텍스트는 &rdquo;a&quot;가 된다.</p>
