...
제출: 7915, 정답: 3796, 맞힌 사람: 2799, 정답 비율: 46.013%
...
<p>첫 줄에는 논의 수 N(1 &le; N &le; 300)이 주어진다. 다음 N개의 줄에는 i번째 논에 우물을 팔 때 드는 비용 Wi(1 &le;&nbsp;Wi &le; 100,000)가 순서대로 들어온다. 다음 N개의 줄에 대해서는 각 줄에 N개의 수가 들어오는데 이는 i번째 논과 j번째 논을 연결하는데 드는 비용 Pi,j(1 &le;&nbsp;Pi,j &le; 100,000, Pi,j = Pj,i, Pi,i = 0)를 의미한다. </p>
