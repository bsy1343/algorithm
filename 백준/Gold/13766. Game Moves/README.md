...
제출: 23, 정답: 10, 맞힌 사람: 10, 정답 비율: 45.455%
...
<ol>
	<li>Choice of direction: the player chooses one of the directions up, down, left or right. The chosen direction will be called &ldquo;downstream&rdquo;.</li>
	<li>Movement: the player moves all pieces downstream as far as they will go, closing any gaps. The edge of the board towards which all pieces move is called the &ldquo;blocking edge&rdquo;.</li>
