...
제출: 39, 정답: 22, 맞힌 사람: 20, 정답 비율: 58.824%
...
<p>They are competing in production of missiles in particular. Nevertheless, no countries have started wars for years. Actually they have a reason they can&rsquo;t get into wars &mdash; they have missiles much more than enough to destroy the entire world. Once a war would begin among countries, none of them could remain.</p>
...
<p>The first line contains two positive integers n and d, the number of countries and the tolerated difference of potential (n &le; 100, d &le; 1000). Then n lines follow. The i-th line begins with a non-negative integer mi , the number of the missiles possessed by the i-th country. It is followed by a sequence of mi positive integers. The j-th integer ci,j represents the capability of the j-th newest missile of the i-th country (c<sub>i,j</sub> &le; 1000). These integers are separated by a single space. Note that the country disposes their missiles in the reverse order of the given sequence.</p>
...
<p>For each dataset, print a single line. If they can dispose all their missiles according to the treaty, print &ldquo;Yes&rdquo; (without quotes). Otherwise, print &ldquo;No&rdquo;.</p>
