...
제출: 211, 정답: 137, 맞힌 사람: 122, 정답 비율: 66.304%
...
<p>The first line contains an integer N representing the number of activities (3 &le; N &le; 10<sup>5</sup> ). The second line contains N integers S<sub>1</sub>, S<sub>2</sub>, . . . , S<sub>N</sub> representing the scores given by Alex to each activity (0 &le; S<sub>i</sub> &le; 100 for i = 1, 2, . . . , N)</p>
