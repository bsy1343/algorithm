...
제출: 5956, 정답: 1800, 맞힌 사람: 1228, 정답 비율: 27.720%
...
<p style="text-align:center"><img alt="" src="%EB%B0%B1%EC%A4%80/Gold/13911.%E2%80%85%EC%A7%91%E2%80%85%EA%B5%AC%ED%95%98%EA%B8%B0/fedf34ba.png" data-original-src="%EB%B0%B1%EC%A4%80/Gold/13911.%E2%80%85%EC%A7%91%E2%80%85%EA%B5%AC%ED%95%98%EA%B8%B0/fedf34ba.png" data-original-src="https://onlinejudgeimages.s3-ap-northeast-1.amazonaws.com/problem/13911/1.png" onerror="this.onerror=null;this.src=this.dataset.originalSrc" style="height:213px; width:336px" /></p>
...
<p>첫줄에는 정점의 개수 V(3 &le; V &le; 10,000)와 도로의 개수 E(0 &le; E &le; 300,000)가 주어진다. 그 다음 E줄에 걸쳐 각 도로를 나타내는 세 개의 정수 (u,v,w)가 순서대로 주어진다. 이는 u와 v(1 &le; u,v &le; V)사이에 가중치가 w(1 &le; w &lt; 10,000)인 도로가 존재한다는 뜻이다. u와 v는 서로 다르며 다른 두 정점 사이에는 여러 개의 간선이 존재할 수도 있음에 유의한다. E+2번째 줄에는 맥도날드의 수 M(1 &le; M &le; V-2) 맥세권일 조건 x(1 &le; x &le; 100,000,000)가 주어지고 그 다음 줄에 M개의 맥도날드 정점 번호가 주어진다. E+4번째 줄에는 스타벅스의 수 S(1 &le; S &le; V-2)와 스세권일 조건 y(1 &le; y &le; 100,000,000)가 주어지고 그 다음 줄에 S개의 스타벅스 정점 번호가 주어진다.&nbsp;</p>
