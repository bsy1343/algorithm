...
제출: 455, 정답: 79, 맞힌 사람: 58, 정답 비율: 23.967%
...
<p>첫째 줄에 원 위에 찍혀있는 점의 개수 N (1 &le; N &le; 360)이 주어진다. 다음 줄부터 N개의 줄에 점이 찍혀있는 각도가 한 줄에 하나씩 주어진다. 각도는 0보다 크거나 같고, 359보다 작거나 같다. 각도는 중복되어 들어오지 않는다.</p>
