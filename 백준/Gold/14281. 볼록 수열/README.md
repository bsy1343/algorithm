...
제출: 553, 정답: 202, 맞힌 사람: 162, 정답 비율: 37.241%
...
<p>정수 수열 x[0], x[1], ..., x[N-1]이 볼록이 되려면 모든 1 &le; i &le; N-2에 대해서, x[i-1]+x[i+1] &ge; 2*x[i]를 만족해야 한다. 또, 길이가 1, 2인 수열은 항상 볼록하다.</p>
...
<p>첫째 줄에 수열의 크기 N (1 &le; N &le; 50)이, 둘째 줄에 수열 A가 입력으로 주어진다. (0 &le; a[i] &le; 10<sup>9</sup>)</p>
