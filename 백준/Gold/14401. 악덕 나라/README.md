...
제출: 224, 정답: 79, 맞힌 사람: 65, 정답 비율: 36.932%
...
<p>첫째 줄에는 도시의 개수 n,이미 존재하는 고속도로의 개수 m이 주어진다.(1&le;n&le;500, 0&le;m&le;2000)</p>

<p>다음 n줄에는 도시의 좌표 x,y가 주어진다.(-1,000,000&le;x,y&le;1,000,000) 두 도시가 같은 위치에 존재하지 않는다.</p>

<p>다음 m줄에는 고속도로가 잇는 두 정점 a,b가 주어진다. (1&le;a,b&le;n)</p>
