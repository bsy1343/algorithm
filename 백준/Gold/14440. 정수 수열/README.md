...
제출: 1921, 정답: 464, 맞힌 사람: 403, 정답 비율: 30.392%
...
<p>모든 n &ge; 2에 대해서, A<sub>n</sub> = x&times;A<sub>n-1</sub> + y&times;A<sub>n-2</sub>를 만족한다.</p>
...
<p>첫째 줄에 x, y, a<sub>0</sub>, a<sub>1</sub>, n이 주어진다. (1 &le; x, y &le; 99, 0 &le; n &lt; 10<sup>8</sup>) a<sub>0</sub>과 a<sub>1</sub>은 A<sub>0</sub>, A<sub>1</sub>의 마지막 두 자리이다.</p>
