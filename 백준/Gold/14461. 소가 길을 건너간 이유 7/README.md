...
제출: 1522, 정답: 726, 맞힌 사람: 597, 정답 비율: 46.971%
...
<p>존의 농장에는 작은 정사각형 목초지가 N&times;N (3 &le; N &le; 100) 격자로 이루어져 있다. <a href="https://www.acmicpc.net/problem/14469">농장의 바깥에는 높은 울타리</a>가 있어서 소가 농장 밖으로 나갈 일은 없다. 이 농장에 사는 소 베시는 한 목초지에서 상하좌우로 인접한 다른 목초지로 이동할 수 있지만, 교통사고를 피하기 위해 차가 안 오는지 확인하고 길을 건너야 한다. 길을 건너는데는 T초 (0 &le; T &le; 1,000,000)가 걸린다.</p>
...
<p>첫 줄에 N과 T가 주어진다. 다음 N줄에는 목초지마다 풀을 먹는데 걸리는 시간이 N&times;N의 형태로 주어진다. 각각의 수는 모두 100,000 이하이다.</p>
