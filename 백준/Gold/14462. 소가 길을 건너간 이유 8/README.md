...
제출: 930, 정답: 530, 맞힌 사람: 420, 정답 비율: 55.925%
...
<p>존 (우리가 지금까지 도와 주었던 존과는 다른 인물이다)의 농장에는 N 종류의 소가 있다. 각각 1번 종, 2번 종, ..., N번 종 (1 &le; N &le; 1000)이다. 만약 |a&minus;b| &le; 4라면 a번 종과 b번 종의 소는 친하지만, 그렇지 않으면 사이가 나쁘다.</p>
