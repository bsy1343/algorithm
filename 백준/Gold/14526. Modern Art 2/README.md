...
제출: 428, 정답: 135, 맞힌 사람: 105, 정답 비율: 33.654%
...
<p>Although, her paintings can now be described by a 1-dimensional array of colors of length \(N\) (\(1 \leq N \leq 100,000\)), her painting style remains unchanged: she starts with a blank canvas and layers upon it a sequence of &quot;rectangles&quot; of paint, which in this 1-dimensional case are simply intervals. She uses each of the colors \(1 \ldots N\) exactly once, although just as before, some colors might end up being completely covered up by the end.</p>
...
<p>The first line of input contains \(N\), and the next \(N\) lines contain an integer in the range \(0 \ldots N\) indicating the color of each cell in the 1-dimensional painting (0 for a blank cell).</p>
...
<p>In this example, the interval of color 1 must be painted in an earlier round than the intervals of colors 4 and 5, so at least two rounds are needed.</p>