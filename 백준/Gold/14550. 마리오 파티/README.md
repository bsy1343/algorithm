...
제출: 411, 정답: 227, 맞힌 사람: 192, 정답 비율: 58.896%
...
<p>입력은 20개 이하의 테스트케이스로 구성되어 있고, 맨 끝에 0이 온다. 각 테스트케이스의 첫 줄에는 N (출발점과 별 사이의 칸 수), S, T가 주어진다. 2 &le; N &le; 200, 2 &le; S &le; 10, N + 1 &le; ST, T &le; N + 1이다. 따라서 T턴 이내에 별을 먹는 방법이 꼭 존재한다.</p>
