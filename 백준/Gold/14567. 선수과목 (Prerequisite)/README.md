...
제출: 10098, 정답: 6778, 맞힌 사람: 5114, 정답 비율: 66.963%
...
<p>첫 번째 줄에 과목의 수 N(1 &le; N &le; 1000)과 선수 조건의 수 M(0 &le; M &le; 500000)이 주어진다. 선수과목 조건은 M개의 줄에 걸쳐 한 줄에 정수 A B 형태로 주어진다. A번 과목이 B번 과목의 선수과목이다. A &lt; B인 입력만 주어진다. (1 &le; A &lt; B &le; N)</p>
