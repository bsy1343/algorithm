...
제출: 388, 정답: 127, 맞힌 사람: 99, 정답 비율: 33.559%
...
<p>$$ N_n =\left\{ 1, 2, 3, 4, &hellip;, n \right\} 일 때, a_{n+1} = \sum_{S \subset N_n} \sum_{i \in S} a_i $$</p>
...
<p>첫 줄에 택희의 질문의 개수 Q가 주어진다. (1 &le; Q &le; 200000)</p>

<p>이어 Q줄에 걸쳐, 다음의 네 가지 타입 중 하나의 쿼리가 주어진다.</p>

<ul>
	<li>1 a<sub>1</sub> i j (1 &le; a<sub>1</sub> &le; 10<sup>5</sup>, 1 &le; i, j &le; 10<sup>6</sup>): 첫 항이 a<sub>1</sub>인 엄청난 수열에서, a<sub>i</sub>와 a<sub>j</sub>의 최대공약수는?</li>
	<li>2 a<sub>1</sub> i j (1 &le; a<sub>1</sub> &le; 10<sup>5</sup>, 1 &le; i, j &le; 10<sup>6</sup>): 첫 항이 <!--[if gte msEquation 12]><m:oMath><m:sSub><m:sSubPr><span
   ...
   mso-fareast-font-family:"맑은 고딕";mso-fareast-theme-font:minor-latin'><m:r>1</m:r></span></i></m:sub></m:sSub></m:oMath><![endif]-->a<sub>1</sub>인 엄청난 수열에서, a<sub>i</sub>와 a<sub>j</sub>의 최소공배수는?
	...
	<li>3 a<sub>1</sub> i j (1 &le; a<sub>1</sub> &le; 10<sup>5</sup>, 1 &le; i, j &le; 10<sup>6</sup>): 첫 항이 a<sub>1</sub>인 엄청난 수열에서, $ \sum_{k=i}^j a_k $는?</li>
	<li>4 a<sub>1</sub> k (1 &le; a<sub>1</sub> &le; 10<sup>5</sup>, 1 &le; k &le; 10<sup>6</sup>): 첫 항이 a<sub>1</sub>인 엄청난 수열에서, a<sub>k</sub>는?</li>
</ul>

<p>3번 쿼리의 경우, 항상 i &le; j를 만족하도록 입력이 주어진다.</p>
