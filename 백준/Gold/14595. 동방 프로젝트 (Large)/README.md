...
제출: 3495, 정답: 1288, 맞힌 사람: 932, 정답 비율: 35.654%
...
<p>물론 병찬이 외에도 많은 사람이 동아리방을 원한다. 다행히 방은 충분했기에 병찬이는 안심하고 있었지만&hellip;</p>
...
<p>첫 번째 줄에는 동아리방의 개수를 나타내는 양의 정수 N(2 &le; N &le; 1,000,000) 이 주어진다. 두 번째 줄에는 빅-종빈빌런의 행동 횟수를 나타내는 음이 아닌 정수 M(0 &le; M &le; 5,000) 이 주어진다. 세 번째 줄부터 M개의 줄에 걸쳐 빅-종빈빌런의 행동이 양의 정수 x, y(1 &le; x &lt; y &le; N) 로 주어진다. 여기서 행동이란 x번 방부터 y번 방 사이의 벽을 무너뜨리는 것을 의미한다.</p>
