...
제출: 121, 정답: 43, 맞힌 사람: 26, 정답 비율: 40.625%
...
<p>가장 첫 줄에 응답 데이터 수를 나타내는 자연수 N(6 &le; N &le; 100)이 주어진다. 이후 N줄에 걸쳐서 x1 x2 NAME 형식으로 데이터가 주어진다(-1,000 &le; x1, x2 &le; 1,000, 1&nbsp;&le; Length of NAME &le; 15). x1과 x2는 각각 그 사람의 특징을 나타내는 두 정수값이다. 그룹의 이름은 공백없이 알파벳 대문자로 주어진다.</p>
