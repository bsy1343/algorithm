...
제출: 468, 정답: 159, 맞힌 사람: 136, 정답 비율: 36.658%
...
<p>첫 줄에 이번 대회의 참가자의 수 N(1 &le; N &le; 100)과 문제의 수 M(1 &le; M &le; 10)이 주어진다. 다음 N 개의 줄에는 1등부터 N 등까지, i 등 참가자의 맞춘 문제 수 K<sub>i</sub> (0 &le; K<sub>i</sub> &le; M)와 해당 참가자의 1 ~ M번 문제에 대한 결과가 M 개가 주어진다. 결과는 맞았다면 1, 틀렸다면 0, 찢어져 결과를 알 수 없다면 -1로 주어진다.</p>

### 출력

<p>좋은대회가 될 수 있다면 &ldquo;YES&rdquo;, 아니라면 &nbsp;&ldquo;NO&rdquo;를 출력한다.</p>
