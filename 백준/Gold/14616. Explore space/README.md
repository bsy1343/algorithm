...
제출: 439, 정답: 158, 맞힌 사람: 110, 정답 비율: 38.732%
...
<p>첫 번째 줄에 웜홀 안에 존재하는 방사능 층의 개수 N(1 &le; N &le; 100,000)이 주어진다. 다음 N개의 줄에 걸쳐 i(1 &le; i &le; N)번째 방사능 층을 나타내는 선분의 양끝점 좌표가 주어진다. 다음 줄에는 레이저의 발사 횟수 M(1 &le; M &le; 100,000)이 주어진다. 다음 M개의 줄에 걸쳐 j(1 &le; j &le; M)번째 레이저의 발사 위치가 주어진다. 입력으로 주어지는 모든 좌표의 크기는 1보다 크거나 같고 100,000보다 작거나 같다. 방사능 층을 나타내는 선분의 시작과 끝은 동일할 수 있다.</p>
