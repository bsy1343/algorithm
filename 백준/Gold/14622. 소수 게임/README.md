...
제출: 2595, 정답: 501, 맞힌 사람: 368, 정답 비율: 18.852%
...
<p dir="ltr">입력의 첫째 줄에 두 사람이 대결을 하는 라운드 수 N이 주어진다. (5&le;N&le;100,000)</p>

<p>이 후 N개의 줄에 대웅이와 규성이가 말하는 정수가 공백으로 구분되어 주어진다. 두 사람이 말하는 정수는&nbsp;5,000,000보다 작은 자연수 또는 0이다.</p>

### 출력

<p>대웅이가 이길 경우 &ldquo;소수의 신 갓대웅&rdquo; 규성이가 이길 경우 &ldquo;소수 마스터 갓규성&rdquo;을 출력한다. 만약 비길 경우 &ldquo;우열을 가릴 수 없음&rdquo; 을 출력한다.</p>