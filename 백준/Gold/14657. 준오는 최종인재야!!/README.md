...
제출: 1126, 정답: 320, 맞힌 사람: 224, 정답 비율: 26.794%
...
<p>&ldquo;네가 만약 제한 시간 안에 기준치 이상의 문제를 풀어온다면 너를 최종인재로 추천해주겠다. 하지만 그렇지 못한다면! 너는 영원히 BOB 센터에서 히어로즈 오브 더 스톰을 플레이해야 할 거야... 후후&rdquo;</p>
...
<p>첫째 줄에 문제의 수 N, 하루 풀이 시간 T가 주어진다. (2 &le; N &le;&nbsp;50,000, 1 &le;&nbsp;T &le; 100,000) 이후 둘째 줄 부터 N-1개의 줄에 걸쳐 각 줄마다 A, B, C가 주어진다. (1 &le;&nbsp;A, B &le; N, 1 &le;&nbsp;C &le;&nbsp;1,000) A와 B는 서로 연결된 문제의 번호를 뜻하며, C는 A를 풀고 B를 풀거나 B를 풀고 A를 푸는데 걸리는 시간을 뜻한다.</p>
