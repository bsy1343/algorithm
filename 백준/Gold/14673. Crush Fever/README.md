...
제출: 309, 정답: 122, 맞힌 사람: 95, 정답 비율: 40.426%
...
<p>프로그램의 입력은 표준 입력으로 받는다. 입력의 첫 줄에는 퍼즐의 너비 M, 높이 N이 주어진다. (1 &le; M, N &le; 8) 두 번째 줄부터 N+1번째 줄까지 퍼즐의 각 행을 나타내는 M개의 숫자 c가 주어진다. c는 퍼즐 조각의 종류이다. (1 &le; c &le; 5)&nbsp;</p>
