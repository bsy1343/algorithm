...
제출: 723, 정답: 197, 맞힌 사람: 147, 정답 비율: 28.324%
...
<p>첫 번째 줄에 &ldquo;질서 있는 홍삼 게임&rdquo;의 참가자의 수 N(2 &le; N &le; 500), 은하가 먼저 지목한 사람의 번호 A와 두 번째로 지목한 사람의 번호 B(1 &le; A, B &le; N, A &ne;&nbsp;B), 각 지목권의 지목 간격을 나타내는 정수 D<sub>A</sub>, D<sub>B</sub>(1 &le; D<sub>A</sub>, D<sub>B</sub> &le; N &minus; 1)이 공백을 사이에 두고 순서대로 주어진다.</p>
