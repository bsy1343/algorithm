...
제출: 8828, 정답: 4932, 맞힌 사람: 4070, 정답 비율: 55.685%
...
<p>첫째 줄에는 이번 시험의 단원 개수 N(1 &le; N &le; 100)과 시험까지 공부 할 수 있는 총 시간 T(1 &le; T &le; 10000)가 공백을 사이에 두고 주어진다.</p>

<p>둘째 줄부터 N 줄에 걸쳐서 각 단원 별 예상 공부 시간 K(1 &le; K &le; 1000)와 그 단원 문제의 배점 S(1 &le; S &le; 1000)가 공백을 사이에 두고 주어진다.</p>
