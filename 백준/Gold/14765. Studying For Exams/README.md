...
제출: 38, 정답: 22, 맞힌 사람: 21, 정답 비율: 63.636%
...
<ul>
	<li>f<sub>i</sub>(0) &ge; 0;</li>
	<li>f<sub>i</sub>(T) &le; 100;</li>
	<li>a<sub>i</sub> &lt; 0;</li>
...
<p>The first line of each input contains the integers N (1 &le; N &le; 10) and T (1 &le; T &le;&nbsp;240) separated by a space. This is followed by N lines, each containing the three parameters a<sub>i</sub>, b<sub>i</sub>, and c<sub>i</sub> describing the function f<sub>i</sub>(t). The three parameters are separated by a space, and are given as real numbers with 4 decimal places. Their absolute values are no more than 100.</p>
