...
제출: 1220, 정답: 488, 맞힌 사람: 369, 정답 비율: 38.478%
...
<p>입력은 1줄에서 26줄까지 입력될 수 있으며, 각각은 다른 작업 (위 예제에서 말하자면 A, B, C, &hellip;) 을 포함한다. 각 줄에는 다음과 같은 내용이 포함된다.</p>
