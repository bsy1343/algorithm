...
제출: 8294, 정답: 3748, 맞힌 사람: 3151, 정답 비율: 47.199%
...
<p>용액들의 특성값 A<sub>1</sub>, &hellip; ,A<sub>N</sub>이 오름차순으로 주어졌을 때, 이 중 두 개의 용액을 혼합하여 만들 수 있는 0에 가장 가까운 특성값 B를 출력하시오.</p>
...
<ul>
	...
	<li>-100,000,000 &le; A<sub>i</sub> &le; 100,000,000</li>
	<li>A<sub>i-1</sub> &le; A<sub>i</sub></li>
</ul>