...
제출: 1977, 정답: 522, 맞힌 사람: 362, 정답 비율: 25.121%
...
<p>첫 줄에 각 병영의 세로 길이 n, 가로 길이 m 이 주어진다. (1 &le; n, m &le; 100)</p>

<p>다음 줄부터 차례대로 병영의 블록별 레벨 제한 k가 주어진다. (0 &le; k &le; 10<sup>9</sup>).</p>
