...
제출: 180, 정답: 95, 맞힌 사람: 79, 정답 비율: 51.634%

### 분류

다이나믹 프로그래밍, 그리디 알고리즘, 많은 조건 분기, 게임 이론
...
<p>Output the largest possible difference (in your favour) between your net happiness and your&nbsp;sister&rsquo;s net happiness.</p>