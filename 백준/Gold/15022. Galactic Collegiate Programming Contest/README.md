...
제출: 207, 정답: 89, 맞힌 사람: 80, 정답 비율: 50.955%
...
<p>The first line of input contains two integers n and m, where 1 &le; n &le; 10<sup>5</sup> is the number of teams, and 1 &le; m &le; 10<sup>5</sup> is the number of events.</p>

<p>Then follow m lines that describe the events. Each line contains two integers t and p (1 &le; t &le; n and 1 &le; p &le; 1000), meaning that team t has solved a problem with penalty p. The events are ordered by the time when they happen.</p>

### 출력

<p>Output m lines. On the i&rsquo;th line, output the rank of your favorite team after the first i events have happened.</p>