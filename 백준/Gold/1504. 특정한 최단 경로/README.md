...
제출: 117326, 정답: 33912, 맞힌 사람: 23219, 정답 비율: 26.770%
...
<p>첫째 줄에 정점의 개수 N과 간선의 개수 E가 주어진다. (2 &le; N &le; 800, 0 &le; E &le; 200,000) 둘째 줄부터 E개의 줄에 걸쳐서 세 개의 정수 a, b, c가 주어지는데, a번 정점에서 b번 정점까지 양방향 길이 존재하며, 그 거리가 c라는 뜻이다. (1 &le; c &le; 1,000) 다음 줄에는 반드시 거쳐야 하는 두 개의 서로 다른 정점 번호 v<sub>1</sub>과 v<sub>2</sub>가 주어진다. (v<sub>1</sub> &ne; v<sub>2</sub>, v<sub>1</sub> &ne; N,&nbsp;v<sub>2</sub> &ne; 1) 임의의 두 정점 u와 v사이에는 간선이 최대 1개 존재한다.</p>
