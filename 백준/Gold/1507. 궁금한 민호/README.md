...
제출: 7163, 정답: 4127, 맞힌 사람: 3275, 정답 비율: 56.592%
...
<p>첫째 줄에 도시의 개수 N(1 &le; N &le; 20)이 주어진다. 둘째 줄부터 N개의 줄에 각각의 도시 사이에 이동하는데 필요한 시간이&nbsp;주어진다. A에서 B로 가는 시간과 B에서 A로 가는 시간은 같다. 또, A와 B가 같은 경우에는&nbsp;0이 주어지고, 그 외의 경우에 필요한 시간은 2500보다 작거나 같은 자연수이다.</p>
