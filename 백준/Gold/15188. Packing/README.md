...
제출: 100, 정답: 69, 맞힌 사람: 38, 정답 비율: 73.077%
...
<p>For each problem your program should output one line with the text &ldquo;Problem &ldquo; and the number of the problem (counting from 1) followed by a colon, a space and the total value of presents shipped by the drone pair.&nbsp;</p>