...
제출: 365, 정답: 159, 맞힌 사람: 138, 정답 비율: 51.880%
...
<p>첫째 줄에 총 참가자의 수 N(2 &le; N &le; 500)이 주어진다. 그 후 N줄에 걸쳐 참가신청한 순서에 맞추어 코딩력 X<sub>i</sub> (1 &le; X<sub>i</sub> &le; 100,000)이 주어진다. 코딩력이 같은 참가자는 없다.</p>
