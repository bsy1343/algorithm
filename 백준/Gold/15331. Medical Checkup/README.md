...
제출: 172, 정답: 87, 맞힌 사람: 71, 정답 비율: 51.449%
...
<p>n and t are integers. n is the number of the students (1 &le; n &le; 10<sup>5</sup>). t specifies the time of our concern (0 &le; t &le; 10<sup>9</sup>). For each i, the integer h<sub>i</sub> is the health condition of student i (1 &le; h<sub>i</sub> &le; 10<sup>9</sup>).</p>
