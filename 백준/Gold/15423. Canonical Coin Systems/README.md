...
제출: 347, 정답: 115, 맞힌 사람: 93, 정답 비율: 34.317%
...
<p>Input consists of a single case. The first line contains an integer n (2 &le; n &le; 100), the number of denominations in the coin system. The next line contains the n denominations as space-separated integers c<sub>1</sub> c<sub>2</sub> . . . c<sub>n</sub>, where c<sub>1</sub> = 1 and c<sub>1</sub> &lt; c<sub>2</sub> &lt; . . . &lt; c<sub>n</sub> &le; 10<sup>6</sup>.</p>

### 출력

<p>Output &ldquo;canonical&rdquo; if the coin system is canonical, or &ldquo;non-canonical&rdquo; if the coin system is non-canonical.</p>