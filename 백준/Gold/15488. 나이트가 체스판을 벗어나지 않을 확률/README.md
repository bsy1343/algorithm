...
제출: 413, 정답: 282, 맞힌 사람: 250, 정답 비율: 73.529%
...
<p>크기가 N&times;N인 체스판 위에 나이트가 하나 있다. 나이트가 있는 곳의 좌표가 주어졌을 때, K번 이동한 후에 나이트가 체스판 위에 있을 확률을 구하는 프로그램을 작성하시오.</p>
...
<p>첫째 줄에 N, 나이트의 좌표 x, y, 이동 횟수 K가 주어진다. (1 &le; N &le; 50, 1 &le; x, y &le; N, 0 &le; K &le; 50)</p>
