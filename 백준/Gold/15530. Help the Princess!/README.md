...
제출: 117, 정답: 70, 맞힌 사람: 67, 정답 비율: 59.292%
...
<p>The first line of a dataset contains two positive integers H and W delimited by a space, where H is the height of the grid and W is the width of the grid. (2 &le; H, W &le; 200)</p>
...
<p>&lsquo;@&rsquo;, &lsquo;\$&rsquo;, &lsquo;%&rsquo;, &lsquo;.&rsquo;, and &lsquo;#&rsquo; represent the princess, a soldier, the escape hatch, an empty cell, and a wall, respectively. It is guaranteed that there exists only one &lsquo;@&rsquo;, only one &lsquo;%&rsquo;, and more than or equal to zero &lsquo;\$&rsquo; in the grid.</p>

### 출력

<p>Output a line containing a word &ldquo;Yes&rdquo;, if the princess can escape from the palace. Otherwise, output &ldquo;No&rdquo;.</p>