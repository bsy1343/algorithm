...
제출: 14399, 정답: 4275, 맞힌 사람: 2924, 정답 비율: 28.298%
...
<p>첫째 줄에 N(1 &le;&nbsp;N &le; 2,000,000,000)과 M(1 &le; M &le; 10,000)이 빈칸을 사이에 두고 주어진다. 둘째 줄에는 각 놀이기구의 운행 시간을 나타내는 M개의 자연수가 순서대로 주어진다. 운행 시간은 1 이상 30 이하의 자연수이며, 단위는 분이다.</p>
