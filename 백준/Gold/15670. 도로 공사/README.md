...
제출: 457, 정답: 186, 맞힌 사람: 161, 정답 비율: 46.264%
...
<p>첫째 줄에 도로의 길이 N, 재혁이가 관찰한 기간 M이 주어진다. (1 &le; N, M &le; 10<sup>5</sup>)</p>

<p>둘째 줄에 각 지점의 높이를 의미하는 N개의 숫자 a<sub>i</sub>가 주어진다. (1 &le; a<sub>i</sub> &le; 10<sup>9</sup>)</p>

<p>다음 M개의 줄에 i번째 날에 공사한 구간을 의미하는 l<sub>i</sub>, r<sub>i</sub>(1 &le; l<sub>i</sub> &le; r<sub>i</sub> &le; N)가 주어진다.</p>
