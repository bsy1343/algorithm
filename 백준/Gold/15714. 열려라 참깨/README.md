...
제출: 153, 정답: 80, 맞힌 사람: 61, 정답 비율: 47.656%
...
<p>첫째 줄에 N이 주어진다. (1 &le; N &le;&nbsp;1,000,000)</p>

<p>둘째 줄에 자갈의 위치(i, Y<sub>i</sub>)를 나타내는 정수 Y<sub>i</sub>가 공백으로 구분되어 주어진다. (i = 1, 2, ..., N, 0 &le; Y<sub>i</sub> &lt; 2<sup>31</sup>)</p>

<p>셋째 줄에 홈의 위치(i, Y<sub>i</sub>)를 나타내는 정수 Y<sub>i</sub>가 공백으로 구분되어 주어진다. (i = 1, 2, ..., N, 0 &le; Y<sub>i</sub> &lt; 2<sup>31</sup>)</p>
