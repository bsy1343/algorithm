...
제출: 5389, 정답: 1581, 맞힌 사람: 1197, 정답 비율: 27.625%
...
<p>첫째 줄에 상자의 개수 N(1 &le; N &le; 1,000,000)과 규칙의 개수 K(1 &le; K &le; 10,000), 도토리의 개수 D(1 &le; D &le; 1,000,000,000)가 주어진다. 그 후 K개 줄에는 A, B, C(1 &le; C &le; A &le; B &le; N)가 주어지며 A번 상자부터 B번 상자까지 C개 간격으로 도토리를 하나씩 넣는 규칙을 뜻한다. D는 모든 규칙으로 넣을 수 있는 도토리의 수보다 같거나 작다.</p>
