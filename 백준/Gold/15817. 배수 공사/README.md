...
제출: 1413, 정답: 574, 맞힌 사람: 462, 정답 비율: 42.077%
...
<p>영만이가 가지고 있는 파이프의 종류의 수 N과 만들고 싶은 합친 파이프의 길이 x가 주어진다. (1&nbsp;&le; N &le; 100 이며, 1 &le; x &le; 10 000 이다.)</p>

<p>다음 N개의 줄에 걸쳐서 파이프의 길이 L<sub>i</sub>&nbsp;와 수량 C<sub>i</sub> 이 공백을 사이에 두고 주어진다. 길이가 짧은 것부터 순서대로 입력되며, 0 &lt; L<sub>i</sub> &le; x, 0 &lt; C<sub>i</sub> &le; 100 이다. 또한, 입력되는 파이프의 길이는 서로 다르다.</p>
