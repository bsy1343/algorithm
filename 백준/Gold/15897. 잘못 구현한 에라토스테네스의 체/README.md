...
제출: 3341, 정답: 1227, 맞힌 사람: 993, 정답 비율: 42.691%
...
<p>첫 번째 줄에 위 프로그램의 입력 n의 값이 자연수로 주어진다. (1 &le; n &le; 10<sup>9</sup>)</p>
