...
제출: 1177, 정답: 257, 맞힌 사람: 182, 정답 비율: 20.848%
...
<p>첫 줄에 2차원 격자의 크기 N(1&le; N &le; 500), 일반 모드에서 변신 모드로 변신하는 데 소모되는 턴의 수 t(0 &le; t &le; 500), 목표 지점의 행과 열의 번호 r(1 &le; r &le; N), c(1 &le; c &le; N)가 주어진다.</p>
