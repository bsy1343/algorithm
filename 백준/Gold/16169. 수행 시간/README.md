...
제출: 566, 정답: 368, 맞힌 사람: 315, 정답 비율: 65.900%
...
<ol>
	...
	<li>각 n개의 컴퓨터의 계급은 c<sub>1</sub>, c<sub>2</sub>, &hellip; c<sub>n</sub>이다. (1 &le; c<sub>1</sub>&nbsp;&le; c<sub>2</sub>&nbsp;&le; &hellip; &le; c<sub>n</sub>&nbsp;&le; n). 주어진 컴퓨터의 계급을 오름차순으로 정렬했을 경우, | c<sub>j</sub>&nbsp;-c<sub>j-1</sub>&nbsp;|&le; 1이다.&nbsp;</li>
...
<p>첫 번째 줄에는 컴퓨터의 개수 n이 주어진다. (3 &le; n &le; 100) 두 번째 줄부터 n개의 줄에 걸쳐 1번부터 n번까지 각 컴퓨터의 계급과 동작 속도 t가 공백을 두고 주어진다. (1 &le; t &le; 100)</p>
