...
제출: 13737, 정답: 6097, 맞힌 사람: 4167, 정답 비율: 42.477%
...
<p>N&times;M 크기의 보드와 4개의 버튼으로 이루어진 게임이 있다. 보드는 1&times;1크기의 정사각형 칸으로 나누어져 있고,&nbsp;각각의 칸은 비어있거나, 벽이다. 두 개의 빈 칸에는 동전이 하나씩 놓여져 있고, 두 동전의 위치는 다르다.</p>
...
<p>첫째 줄에 보드의 세로 크기 N과 가로 크기 M이 주어진다. (1 &le; N, M &le; 20)</p>
