...
제출: 747, 정답: 386, 맞힌 사람: 286, 정답 비율: 52.574%
...
<p>첫째 줄에 막대의 개수 N(1 &le; N &le; 10,000)이 주어진다. 둘째 줄에는 막대의 길이 A<sub>1</sub>, A<sub>2</sub>, ..., A<sub>N</sub>이 주어진다. (2 &le; A<sub>i</sub> &le; 100,000)</p>
