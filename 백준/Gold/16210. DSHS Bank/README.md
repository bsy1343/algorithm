...
제출: 681, 정답: 172, 맞힌 사람: 135, 정답 비율: 29.476%
...
<p>첫째 줄에는 은행의 지점의 개수(본점이 될 하나의 지점을 포함한 개수이다.) N이 주어진다. (2 &le; N &le; 500,000)</p>
...
<p>두 점 (x<sub>1</sub>, y<sub>1</sub>)와 (x<sub>2</sub>, y<sub>2</sub>) 사이의 택시 거리는 <strong>|x<sub>1</sub>-x<sub>2</sub>|+|y<sub>1</sub>-y<sub>2</sub>|</strong> (| |는 절댓값 기호이다)로 정의된다.</p>