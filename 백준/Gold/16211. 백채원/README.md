...
제출: 438, 정답: 190, 맞힌 사람: 143, 정답 비율: 41.691%
...
<p>첫째 줄에는 우리나라에 있는 지점의 수 N과 도로의 수 M, <strong>백채원</strong>의 추종자의 수 K가 차례대로 주어진다. (1 &le; N &le; 200,000, 1 &le; M &le; 500,000, 1 &le; K &le; N-1)</p>

<p>둘째 줄부터 M개의 줄에 차례대로 M개의 각 도로가 잇는 지점의 번호 A, B와 이 도로를 통해 두 지점을 오가는 데에 걸리는 시간 T가 주어진다. (1 &le; A, B &le; N, 1 &le; T &le; 10,000, A &ne; B, 같은 도로가 두 번 주어지지 않는다.)</p>

<p>마지막 줄에는 <strong>백채원</strong>의 추종자들이 사는 지점의 번호를 나타내는 서로 다른 자연수 P<sub>1</sub>, &hellip;, P<sub>K</sub>가 공백을 사이에 두고 주어진다. (2 &le; P<sub>i</sub> &le; N)</p>
