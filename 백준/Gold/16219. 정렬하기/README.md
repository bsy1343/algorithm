...
제출: 349, 정답: 119, 맞힌 사람: 100, 정답 비율: 39.062%
...
<p>첫 줄에 N이 주어진다. (1&nbsp;&le; N &le; 2 &times; 10<sup>5</sup>)</p>

<p>둘째 줄에 수열 S가 N개의 수가 공백으로 구분되어 주어진다. (수열 S는 0부터 N-1까지의 정수가 한 번씩 등장하는 수열이다.)</p>

<p>세번째 줄에 M이 주어진다. (1&nbsp;&le; M &le; 6&nbsp;&times; 10<sup>5</sup>)</p>

<p>M개의 줄에 걸쳐, X[i]와 Y[i]가 공백으로 구분되어 주어진다. (0&nbsp;&le; X[i], Y[i] &lt; N)</p>
