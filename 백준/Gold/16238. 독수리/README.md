...
제출: 586, 정답: 356, 맞힌 사람: 258, 정답 비율: 62.621%
...
<p>독수리는 양을 먹으면서 살고 있다. 양이 사는 곳은 크기가 1&times;N인 직사각형으로 나타낼 수 있고, 1&times;1 크기의 칸으로 나누어져 있다. 칸은 왼쪽에서부터 1번, 2번, ..., N번으로 번호가 매겨져 있다. i번 칸에 사는&nbsp;양의 수는 A<sub>i</sub>마리이다.</p>
...
<p>첫째 줄에 칸의 개수 N이 주어진다. (1 &le; N &le; 1,000)</p>

<p>둘째 줄에 각 칸에 있는 양의 수 A<sub>1</sub>, A<sub>2</sub>, .., A<sub>N</sub>이 주어진다. (0 &le; A<sub>i</sub> &le; 100,000)</p>
