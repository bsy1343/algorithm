...
제출: 80, 정답: 69, 맞힌 사람: 65, 정답 비율: 86.667%
...
<ul>
	<li>The first line consists of two integers 1 &le; n &le; 1000 and 1 &le; k &le; 10, the number of samples and the length of each sample respectively.</li>
...
<ul>
	...
	<li>Then, print n &minus; 1 lines, each consisting of two integers 0 &le; u, v &lt; n, indicating that in the most likely evolutionary tree, there is an edge between DNA string u and v. If there are multiple answers possible, any of them will be accepted.</li>
</ul>