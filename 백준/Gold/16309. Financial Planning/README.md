...
제출: 269, 정답: 112, 맞힌 사람: 106, 정답 비율: 42.231%
...
<ul>
	<li>The first line contains the number of investment options 1 &le; n &le; 10<sup>5</sup> and the minimum amount of money you need to retire 1 &le; M &le; 10<sup>9</sup>.</li>
	<li>Then, n lines follow. Each line i has two integers: the daily profits of this investment 1 &le; p<sub>i</sub> &le; 10<sup>9</sup> and its initial cost 1 &le; c<sub>i</sub> &le; 10<sup>9</sup>.</li>
</ul>
