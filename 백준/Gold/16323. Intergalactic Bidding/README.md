...
제출: 118, 정답: 73, 맞힌 사람: 68, 정답 비율: 64.762%
...
<p>The first line of input contains two integers n and s, where 1 &le; n &le; 1 000 is the number of participants, and 1 &le; s &lt; 10<sup>1 000</sup> is the random number chosen by the ICPC.</p>

<p>Then follow n lines describing the participants. Each line contains a string t and an integer b, where t is the name of a participant, and 1 &le; b &lt; 10<sup>1 000</sup> is the amount of his bet. The name of each participant is unique and consists of between 1 and 20 letters from the English alphabet.</p>
