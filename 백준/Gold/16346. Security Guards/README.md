...
제출: 76, 정답: 25, 맞힌 사람: 21, 정답 비율: 34.426%

### 분류

그래프 이론, 그래프 탐색, 이분 탐색, 누적 합, 너비 우선 탐색
...
<p>The first line of input contains two integers N and Q (1 &le; N,Q &le; 3 &middot; 10<sup>5</sup>), the number of guards and the number of security incidents, respectively. After that, N lines follow. Each of these lines contains two integers X and Y (0 &le; X, Y &le; 5000) which describe coordinates of a guard in a 2D plane. Next, Q lines follow. Each of these lines contains two integers A and B (0 &le; A, B &le; 5000) which describe coordinates of a security incident.</p>
