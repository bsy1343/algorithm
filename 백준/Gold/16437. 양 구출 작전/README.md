...
제출: 9188, 정답: 2690, 맞힌 사람: 1962, 정답 비율: 28.246%
...
<p>첫 번째 줄에 섬의 개수 <em>N</em> (2 &le; <em>N</em> &le; 123,456) 이 주어집니다.</p>

<p>두 번째 줄부터 <em>N</em>-1개에 줄에&nbsp;2번 섬부터 <em>N</em>번 섬까지 섬의 정보를 나타내는 <em>t<sub>i</sub></em>, <em>a<sub>i</sub></em>, <em>p<sub>i</sub></em> (1 &le; <em>a<sub>i</sub></em> &le; 10<sup>9</sup>, 1 &le; <em>p<sub>i</sub></em>&nbsp;&le; <em>N</em>) 가 주어집니다.</p>
