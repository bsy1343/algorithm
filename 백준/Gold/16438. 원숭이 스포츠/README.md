...
제출: 1180, 정답: 528, 맞힌 사람: 428, 정답 비율: 45.580%
...
<p>첫 번째 줄에 원숭이의 수를 나타내는 정수 <em>N</em>&nbsp;(2 &le;&nbsp;<em>N</em> &le;&nbsp;99)&nbsp;가 주어집니다.</p>

### 출력

<p>일곱 개의 줄에&nbsp;팀의 구성을 출력합니다.</p>

<p><em>i</em>&nbsp;(1 &le; <em>i</em> &le; 7)&nbsp;번째 줄에는 길이가 <em>N</em>이고 문자 &#39;<code>A</code>&#39; 또는 문자 &#39;<code>B</code>&#39;로 만 구성된 문자열을 출력합니다. <em>i</em>번째 문자열의 <em>j</em>번째 문자는 <em>i</em>번째 날 <em>j</em>번 원숭이가 속한 팀을 나타냅니다.&nbsp;</p>
