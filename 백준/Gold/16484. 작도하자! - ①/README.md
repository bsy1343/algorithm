...
제출: 598, 정답: 463, 맞힌 사람: 422, 정답 비율: 79.323%
...
<p>첫째 줄에 자연수 <em>n</em>과 <em>d</em>의 값이 사이에 공백을 한 개 두고 차례대로 주어진다. <em>n</em>과 <em>d</em>의 값은&nbsp;1,000&nbsp;이하의 양의 정수이고, <em>d</em>&times;2의 값은 <em>n</em>의 값보다 작다.</p>
