...
제출: 1728, 정답: 618, 맞힌 사람: 443, 정답 비율: 35.987%
...
<p style="text-align: center;">| max(a,b,c) &ndash; min(a,b,c) |</p>
...
<p>첫째 줄에 첫 번째 플레이어가 받은 숫자 카드의 개수 A, 두 번째 플레이어가 받은 숫자 카드의 개수 B, 세 번째 플레이어가 받은 숫자 카드의 개수 C가 주어진다. (1 &le; A, B, C &le; 1,000)</p>
