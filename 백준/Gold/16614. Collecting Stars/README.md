...
제출: 117, 정답: 63, 맞힌 사람: 48, 정답 비율: 61.538%
...
<p>The input starts with a line containing two integers n (1 &le; n &le; 200 000), which is the number of stars, and k (1 &le; k &le; n), which is the number of stars you must collect.</p>

<p>The following n lines describe the stars. Each of these lines contains two integers t (1 &le; t &le; 10<sup>9</sup>), which is the amount of time it will take to collect the star, and d (0 &le; d &lt; n), which is the number of stars that must be collected before the star is available.</p>
