...
제출: 263, 정답: 73, 맞힌 사람: 56, 정답 비율: 27.053%
...
<p>Input consists of a single line with a string of b characters (1 &le; b &le; 40), each representing one corral and being either 0 (empty corral) or 1 (inhabited corral). The first character corresponds to the first corral in the row.</p>

### 출력

<p>Output the minimum number of relocations needed to populate all corrals. If it is not possible to populate all corrals by any number of relocations, print &minus;1.</p>