...
제출: 655, 정답: 469, 맞힌 사람: 437, 정답 비율: 72.591%
...
<p>나이트 게임은 크기가 N&times;N인 체스판 위에서 진행되는 게임이고, 나이트를 하나씩 턴을 번갈아가며 놓는 게임이다.</p>
...
<p>첫째 줄에 테스트 케이스의 개수 T(1 &le; T &le; 100)가 주어진다. 둘째 줄부터 T개의 줄에 테스트 케이스가 한 줄에 하나씩 주어지며, 체스판의 크기 N(1 &le; N &le; 10,000)으로 이루어져 있다.</p>
