...
제출: 3397, 정답: 859, 맞힌 사람: 646, 정답 비율: 25.655%
...
<p><a href="https://en.wikipedia.org/wiki/Bomberman">봄버맨</a>은 크기가 R&times;C인 직사각형 격자판 위에서 살고 있다. 격자의 각 칸은 비어있거나 폭탄이 들어있다.</p>
...
<p>첫째 줄에 R, C, N (1 &le; R, C&nbsp;&le; 200, 1 &le; N &le; 10<sup>9</sup>)이 주어진다. 둘째 줄부터 R개의 줄에 격자판의 초기 상태가 주어진다. 빈 칸은 &#39;<code>.</code>&#39;로, 폭탄은 &#39;<code>O</code>&#39;로 주어진다.</p>
