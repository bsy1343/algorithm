...
제출: 11598, 정답: 2971, 맞힌 사람: 2035, 정답 비율: 24.296%
...
<p>구사과와 친구들이 확장 게임을 하려고 한다. 이 게임은 크기가 N&times;M인 격자판 위에서 진행되며, 각 칸은 비어있거나 막혀있다. 각 플레이어는 하나 이상의 성을 가지고 있고, 이 성도 격자판 위에 있다. 한 칸 위에 성이 두 개 이상인 경우는 없다.</p>
...
<ul>
	...
	<li>1 &le; P &le; 9</li>
	<li>1 &le; S<sub>i</sub> &le; 10<sup>9</sup></li>
</ul>