...
제출: 63841, 정답: 24716, 맞힌 사람: 19028, 정답 비율: 35.987%
...
<p>게임은 정육면체 주사위를 사용하며, 주사위의 각 면에는 1부터 6까지 수가 하나씩 적혀있다. 게임은 크기가 10&times;10이고, 총 100개의 칸으로 나누어져 있는 보드판에서 진행된다. 보드판에는 1부터 100까지 수가 하나씩 순서대로 적혀져 있다.</p>
...
<p>첫째 줄에 게임판에 있는 사다리의 수 N(1 &le; N &le; 15)과 뱀의 수 M(1 &le; M &le; 15)이 주어진다.</p>
