...
제출: 2664, 정답: 1548, 맞힌 사람: 1127, 정답 비율: 56.862%
...
<p>첫째 줄에 가입한 유저의 수 N(1 &le; N &le; 100,000)이 주어진다. 둘째 줄부터 N개의 줄에는 유저의 닉네임이 가입한 순서대로 한 줄에 하나씩 주어진다. 닉네임은 알파벳 소문자로만 이루어져 있고, 길이는 10을 넘지 않는다.</p>
