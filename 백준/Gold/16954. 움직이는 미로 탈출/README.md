...
제출: 18120, 정답: 6191, 맞힌 사람: 3925, 정답 비율: 29.755%
...
<p>욱제는 학교 숙제로 크기가 8&times;8인 체스판에서 탈출하는 게임을 만들었다. 체스판의 모든 칸은&nbsp;빈 칸 또는 벽 중 하나이다. 욱제의 캐릭터는 가장 왼쪽 아랫 칸에 있고, 이 캐릭터는 가장 오른쪽 윗 칸으로 이동해야 한다.</p>
