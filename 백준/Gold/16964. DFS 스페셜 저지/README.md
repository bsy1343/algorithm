...
제출: 8160, 정답: 2864, 맞힌 사람: 2080, 정답 비율: 35.936%
...
<p>첫째 줄에 정점의 수 N(2&nbsp;&le; N &le; 100,000)이 주어진다. 둘째 줄부터 N-1개의 줄에는 트리의 간선 정보가 주어진다. 마지막 줄에는 DFS&nbsp;방문 순서가 주어진다. DFS 방문 순서는 항상 N개의 정수로 이루어져 있으며, 1부터 N까지 자연수가 한 번씩 등장한다.</p>
