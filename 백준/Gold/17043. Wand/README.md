...
제출: 129, 정답: 54, 맞힌 사람: 45, 정답 비율: 41.667%
...
<p>The first line contains two integers N and M (1 &le; N, M &le; 100 000).</p>

<p>In the following M lines there are two numbers X<sub>i</sub> and Y<sub>i</sub> (1 &le; X<sub>i</sub>, Y<sub>i</sub> &le; N, X<sub>i</sub> &ne; Y<sub>i</sub>). The wizard Xi will win the fight against wizard Y<sub>i</sub>.</p>
