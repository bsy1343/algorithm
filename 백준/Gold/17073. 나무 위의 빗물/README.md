...
제출: 5039, 정답: 2117, 맞힌 사람: 1523, 정답 비율: 39.263%
...
<p>첫째 줄에 트리의 노드의 수 <em>N</em>과 1번 노드에 고인 물의 양을 의미하는 정수&nbsp;<em>W</em>가 주어진다.&nbsp;(2 &le; <em>N </em>&le; 500,000, 1 &le; <em>W</em> &le; 10<sup>9</sup>)</p>

<p>다음 <em>N-1</em>줄에 걸쳐, 트리에 존재하는 간선의 정보가 <em>U V</em>의 형태로 주어진다. (1 &le; <em>U</em>,<em> V</em>&nbsp;&le;<em> N</em>​​​​,&nbsp;<em>U&nbsp;</em>&ne; <em>V</em>)</p>
