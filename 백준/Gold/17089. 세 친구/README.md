...
제출: 2651, 정답: 1333, 맞힌 사람: 934, 정답 비율: 46.078%
...
<p>첫째 줄에 사람의 수 N(3 &le; N &le; 4,000), 친구 관계의 수 M(0 &le; M &le; 4,000)이 주어진다. 둘째 줄부터 M개의 줄에는 친구 관계를 의미하는 두 정수 A, B가 주어진다. 친구 관계는 A와 B, 그리고 B와 A가 친구라는 것을 의미한다.</p>
