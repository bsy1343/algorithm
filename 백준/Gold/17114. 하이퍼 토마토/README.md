...
제출: 4819, 정답: 1421, 맞힌 사람: 756, 정답 비율: 24.593%
...
<p>시프트의 토마토&nbsp;농장은 아래 그림과 같이 토마토를 보관하는 큰 11차원 창고를 가지고 있다. 창고는 <em>m&nbsp;</em>&times;<em> n&nbsp;</em>&times;<em> o&nbsp;</em>&times;<em> p&nbsp;</em>&times;<em> q&nbsp;</em>&times;<em> r&nbsp;</em>&times;<em> s&nbsp;</em>&times;<em> t&nbsp;</em>&times;<em> u&nbsp;</em>&times;<em> v&nbsp;</em>&times;<em> w</em>&nbsp;의 격자 모양이고, 각 칸에 토마토를 하나씩 보관할 수 있다.</p>

<p>&nbsp;</p>

<p style="text-align: center;"><img alt="" src="%EB%B0%B1%EC%A4%80/Gold/17114.%E2%80%85%ED%95%98%EC%9D%B4%ED%8D%BC%E2%80%85%ED%86%A0%EB%A7%88%ED%86%A0/ca1622e4.png" data-original-src="%EB%B0%B1%EC%A4%80/Gold/17114.%E2%80%85%ED%95%98%EC%9D%B4%ED%8D%BC%E2%80%85%ED%86%A0%EB%A7%88%ED%86%A0/ca1622e4.png" data-original-src="https://upload.acmicpc.net/ca30bf59-2a40-4eff-909f-532bc9df8840/-/preview/" onerror="this.onerror=null;this.src=this.dataset.originalSrc" /></p>
...
<p>첫 줄에는 문제의 설명에서 창고의 크기를 나타내는 자연수&nbsp;<em>m</em>,<em> n</em>,<em> o</em>,<em> p</em>,<em> q</em>,<em> r</em>,<em> s</em>,<em> t</em>,<em> u</em>,<em> v</em>,<em> w</em>가 주어진다. 단, 1 &le;&nbsp;<em>mnopqrstuvw</em>&nbsp;&le; 10<sup>6</sup> 이다.</p>
