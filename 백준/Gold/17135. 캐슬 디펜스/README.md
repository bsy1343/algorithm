...
제출: 41414, 정답: 15964, 맞힌 사람: 9921, 정답 비율: 34.461%
...
<p>캐슬 디펜스는 성을 향해 몰려오는 적을 잡는 턴 방식의 게임이다. 게임이 진행되는 곳은 크기가 N&times;M인 격자판으로 나타낼 수 있다. 격자판은 1&times;1 크기의 칸으로 나누어져 있고, 각 칸에 포함된 적의 수는 최대 하나이다. 격자판의 N번행의 바로 아래(N+1번 행)의 모든 칸에는 성이 있다.</p>
