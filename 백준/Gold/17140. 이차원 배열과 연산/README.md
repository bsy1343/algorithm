...
제출: 26821, 정답: 13020, 맞힌 사람: 8813, 정답 비율: 45.798%
...
<p>크기가 3&times;3인 배열 A가 있다. 배열의 인덱스는 1부터 시작한다.&nbsp;1초가 지날때마다 배열에 연산이 적용된다.</p>

<ul>
	<li>R 연산: 배열 A의 모든 행에 대해서 정렬을 수행한다. 행의 개수 &ge; 열의 개수인 경우에 적용된다.</li>
...
<p>첫째 줄에 r, c, k가 주어진다. (1 &le; r, c, k &le; 100)</p>
...
<p>가장 처음에는 행의 개수 &ge; 열의 개수 이기 때문에, R 연산이 적용된다. 편의상 정렬 중간 단계는 (수, 수의 등장 횟수)로 표현한다.</p>

<pre>
1 2 1 &rarr; (2, 1), (1, 2)         &rarr; 2 1 1 2
2 1 3 &rarr; (1, 1), (2, 1), (3, 1) &rarr; 1 1 2 1 3 1
3 3 3 &rarr; (3, 3)                 &rarr; 3 3</pre>
