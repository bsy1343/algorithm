...
제출: 15231, 정답: 6324, 맞힌 사람: 4570, 정답 비율: 42.421%
...
<p>연구소는 크기가 N&times;N인 정사각형으로 나타낼 수 있으며, 정사각형은 1&times;1 크기의 정사각형으로 나누어져 있다. 연구소는 빈 칸, 벽으로 이루어져 있으며, 벽은 칸 하나를 가득 차지한다.</p>
...
<p>첫째 줄에 연구소의 크기 N(5 &le; N &le; 50), 놓을 수 있는 바이러스의 개수 M(1 &le; M &le; 10)이 주어진다.</p>
