...
제출: 2807, 정답: 1101, 맞힌 사람: 792, 정답 비율: 37.536%
...
<p>첫 번째 줄에 자르는 횟수가 담긴 목록의 길이 N과 자를 수 있는 지점의 개수 M, 그리고 롤 케이크의 길이인 정수 L이 주어진다. (1 &le; N &le; M &le; 1,000, 1 &lt; L &le; 4,000,000)</p>

<p>다음 M줄에 걸쳐 자를 수 있는 지점을 나타내는 정수 S<sub>i</sub>가 주어진다. (1 &le; S<sub>i</sub> &lt; L)</p>

<p>다음 N줄에 걸쳐 자르는 횟수를 나타내는 정수 Q<sub>i</sub>가 주어진다. (1 &le; Q<sub>i</sub>&nbsp;&le; M)</p>
