...
제출: 5649, 정답: 1162, 맞힌 사람: 983, 정답 비율: 20.902%
...
<p>문제에서 다루는 적분법은&nbsp;$&int;{x^ndx} = \frac{1}{(n+1)}x^{n+1} + W$&nbsp;을 사용한다. (W는 적분상수) 또한 적분 가능 함수에 대하여 합의 법칙, $&int;(f(x)+g(x))dx = &int;{f(x)dx} + &int;{g(x)dx}$&nbsp;가 성립한다.</p>