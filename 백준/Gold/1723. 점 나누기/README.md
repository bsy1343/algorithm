...
제출: 613, 정답: 124, 맞힌 사람: 81, 정답 비율: 28.322%
...
<p>첫째 줄에 N(3 &le; N &le; 10,000), K(3 &le; K &le; 1,000)가 주어진다. 다음 N개의 줄에는 실수로 나타나는 각도가 주어진다. 각도는 0이상 360미만이며, 실수 연산의 오차를 막기 위해 360/K의 정수배에 근접한 각도로 떨어져 있는 점은 없다.</p>
