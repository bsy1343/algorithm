...
제출: 187, 정답: 86, 맞힌 사람: 74, 정답 비율: 49.664%
...
<p>첫 줄에는 군사들의 수 <em>n&nbsp;</em>이 주어진다. (1 &le; <em>n</em> &le; 1,000)</p>

<p>두 번째 줄부터 <em>n</em> + 1 번째 줄에는 매 줄마다 정수 <em>d</em><sub>i</sub>, 즉 <em>i&nbsp;</em>번째 군사가 성으로부터 떨어진 거리가 미터 단위로 주어진다.(1 &le; <em>d</em><sub>i</sub> &le; 20)</p>

### 출력

<p>A와 B 모두 최적의 선택을 한다고 가정할 때, A가 게임에서 승리한다면 &ldquo;<code>A</code>&rdquo;를, B가 승리한다면 &ldquo;<code>B</code>&rdquo;를 출력하라.</p>