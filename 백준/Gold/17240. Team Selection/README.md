...
제출: 450, 정답: 215, 맞힌 사람: 159, 정답 비율: 45.170%
...
<p>첫 줄에는 후보자의 수 <em>n</em>이 주어진다.(5 &le; <em>n</em> &le; 20,000)</p>

<p>두 번째 줄부터 <em>n</em> + 1 번째 각 줄까지 <em>i&nbsp;</em>번째 후보자의 실력 <em>a</em><sub>i</sub>, <em>b</em><sub>i</sub>, <em>c</em><sub>i</sub>, <em>d</em><sub>i</sub>, <em>e</em><sub>i</sub>가 띄어쓰기를 사이에 두고 주어진다. (0 &le; <em>a</em><sub>i</sub>, <em>b</em><sub>i</sub>, <em>c</em><sub>i</sub>, <em>d</em><sub>i</sub>, <em>e</em><sub>i</sub> &le; 1,000)</p>
...
<p>첫 번째 예제의 경우 1번 선수에게 A, 2번 선수에게 B, 3번 선수에게 C, 4번 선수에 게 D, 5번 선수에게 E를 맡기는 것이 실력의 합을 극대화 할 수 있다. 6번 선수는 모든 역할군의 실력이 9이지만, 각 역할군에서 6번 선수보다 잘하는 후보자가 있기 때문에, 팀에는 선발되지 않는다.</p>

<p>두 번째 예제의 경우 첫 번째 예제에서, 5번 선수의 D 실력이 20으로 증가한 상황이 다. 이제는 D를 5번 선수에게 맡기고, E를 6번 선수에게 맡길 때 실력의 합을 극대화 할 수 있다.</p>