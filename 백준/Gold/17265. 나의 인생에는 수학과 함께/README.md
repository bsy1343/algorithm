...
제출: 3593, 정답: 1943, 맞힌 사람: 1579, 정답 비율: 53.489%
...
<ol>
	<li>&nbsp;5 &rarr; &times;&nbsp;&rarr; 4 = 20</li>
	<li>&nbsp;20 &rarr; +&nbsp;&rarr; 5 = 25</li>
	<li>&nbsp;25 &rarr; &times;&rarr; 5 = 125</li>
	<li>&nbsp;125 &rarr; +&nbsp;&rarr; 2 = 127</li>
</ol>
...
<p>첫 번째 줄에는 지도의 크기 <em>N</em>이 주어진다.&nbsp;(<em>3 &le;&nbsp;N &le;&nbsp;5</em>,&nbsp;<em>N</em>은 홀수)&nbsp;</p>

<p>그 다음 N&nbsp;줄에는 N개의 숫자 또는&nbsp;연산자가&nbsp;빈칸을 사이에 두고 주어지며, 세현이네 집 (1, 1)과 학교 (N, N)는 반드시 숫자로 주어진다.</p>

<p>그리고 숫자 다음에는 연산자, 연산자 다음에는 숫자가 나오도록 주어진다. 주어지는 숫자는 0이상 5이하의 정수, 연산자는 <em>(&lsquo;+&rsquo;, &lsquo;-&rsquo;, &lsquo;*&rsquo;) </em>만 주어진다.</p>
