...
제출: 4655, 정답: 872, 맞힌 사람: 581, 정답 비율: 16.841%
...
<p>연예인 김영광을 너무 닮아서 길거리에서 매번 사진이 찍히는 지헌이는 사람들에게 노출되는 것을 매우 꺼려한다. 하지만 친구인 성하와 약속을 하면 성하는 매번 늦기 때문에 길거리에 나온 지헌이는 매번 성하를 기다린다. 약속 장소에서 성하에게 전화를 하면 매번 &ldquo;가는 중&rdquo; 이라는 대답만 듣고 기다리는 동안 길거리에서 사람들에게 사진을 찍히는 지헌이는 스트레스를 심하게 받고 있다. 참지 못한 지헌이는 성하의 핸드폰을 해킹하여서 항상 어디 있는지 알 수 있게 되었다.</p>
...
<p>첫 번째 줄에는 약속 장소 후보의 수 <em>V</em>와&nbsp;약속 장소를 연결하는 총 길의 수 <em>M</em>이 주어진다. (2 &le; <em>V</em> &le; 100,&nbsp;1 &le; <em>M</em> &le; 1,000)</p>

<p>그리고 다음 <em>M</em>개의 각 줄에는 <em>a, b, c</em> 가 주어진다.&nbsp;<em>a, b</em>는 길의 시작과 끝이며 <em>c</em>는 그 길을 지나가는 데 걸리는 시간을 나타낸다.</p>

<p>(1 &le; a, b &le; V,&nbsp;<em>c</em>는 10,000이하의 자연수, 길은 양방향이다)</p>

<p>그리고 그 다음 줄에는 지헌이의 위치 <em>J&nbsp;</em>와 성하의 위치 <em>S&nbsp;</em>가 주어진다. (<em>1 &le;&nbsp;J, S &le;&nbsp;V</em>)</p>
