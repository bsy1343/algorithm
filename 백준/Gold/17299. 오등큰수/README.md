...
제출: 23879, 정답: 11483, 맞힌 사람: 8961, 정답 비율: 47.238%
...
<p>첫째 줄에 수열 A의 크기 N (1 &le; N &le; 1,000,000)이 주어진다. 둘째에 수열 A의 원소 A<sub>1</sub>, A<sub>2</sub>, ..., A<sub>N</sub>&nbsp;(1 &le; A<sub>i</sub> &le; 1,000,000)이&nbsp;주어진다.</p>
