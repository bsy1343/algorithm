...
제출: 1459, 정답: 583, 맞힌 사람: 407, 정답 비율: 41.111%
...
<ul>
	<li>P[n] = 1 (0 &le; n &le; &pi;)</li>
	<li>P[n] = P[n-1] + P[n-&pi;] (그 외)</li>
</ul>

<p>주의할 것은 n이 꼭 정수일 필요는 없다는 것이다. 즉, P[n-&pi;] = P[n-&pi;-1]+P[n-&pi;-&pi;]와 같은 식으로 계산을 해 주어야 한다.</p>

<p>자연수로 n이 주어졌을 때, P[n]을 구하는 프로그램을 작성하시오.</p>

### 입력

<p>첫째 줄에 자연수 n(1 &le; n &le; 1,000)이 주어진다.</p>
