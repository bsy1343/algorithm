...
제출: 2653, 정답: 1234, 맞힌 사람: 1038, 정답 비율: 47.053%
...
<p>다음 <em>N</em>개의 줄의 각 줄에는 두 정수 <em>x</em>와 <em>y</em>(-10<sup>4</sup> &le; <em>x</em>, <em>y</em> &le; 10<sup>4</sup>)가 공백 하나를 사이에 두고 주어진다. 이는 (<em>x</em>, <em>y</em>)에 편의시설이 하나 존재한다는 뜻이다.</p>
