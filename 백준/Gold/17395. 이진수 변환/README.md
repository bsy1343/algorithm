...
제출: 622, 정답: 270, 맞힌 사람: 239, 정답 비율: 44.424%
...
<p>첫 번째 줄에 변환할 자연수와 변환 횟수를 의미하는 두 자연수 <em>x</em><sub>0</sub>과 <em>N</em>이 공백으로 구분되어 주어진다. (1 &le; <em>x</em><sub>0</sub>&nbsp;&le; 10<sup>16</sup>, 1 &le; <em>N</em> &le; 50)</p>
