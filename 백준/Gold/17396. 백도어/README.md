...
제출: 13306, 정답: 3690, 맞힌 사람: 2719, 정답 비율: 25.078%
...
<p>첫 번째 줄에 분기점의 수와 분기점들을 잇는 길의 수를 의미하는 두 자연수 <em>N</em>과 M이 공백으로 구분되어 주어진다.(1 &le; <em>N</em> &le; 100,000, 1 &le; <em>M</em> &le; 300,000)</p>
...
<p>다음 <em>M</em>개의 줄에 걸쳐 세 정수 <em>a</em>, <em>b</em>, <em>t</em>가 공백으로 구분되어 주어진다. (0 &le; <em>a</em>, <em>b</em> <em>&lt; N</em>, <em>a</em> &ne; <em>b</em>, 1 &le; <em>t</em> &le; 100,000) 이는 <em>a</em>번째 분기점과&nbsp;<em>b</em>번째 분기점 사이를 지나는데 <em>t</em>만큼의 시간이 걸리는 것을 의미한다. 연결은 양방향이며, 한 분기점에서 다른 분기점으로 가는 간선은 최대 1개 존재한다.</p>
