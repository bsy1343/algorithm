...
제출: 26786, 정답: 11683, 맞힌 사람: 8066, 정답 비율: 40.610%
...
<p>크기가 N&times;M 크기인 배열 A가&nbsp;있을때, 배열 A의 값은 각 행에 있는 모든 수의 합 중 최솟값을 의미한다.&nbsp;배열 A가 아래와 같은 경우 1행의 합은 6, 2행의 합은 4, 3행의 합은 15이다. 따라서, 배열 A의 값은 4이다.</p>
...
<p>예를 들어, 배열 A의 크기가 6&times;6이고, 회전 연산이 (3, 4, 2)인 경우에는 아래 그림과 같이 회전하게 된다.</p>

<pre>
A[1][1]   <span style="color:#2980b9;">A[1][2] &rarr; A[1][3] &rarr; A[1][4] &rarr; A[1][5] &rarr; A[1][6]</span>
<span style="color:#2980b9;">             &uarr;                                       &darr;</span>
A[2][1]   <span style="color:#2980b9;">A[2][2]   A[2][3] &rarr; A[2][4] &rarr; A[2][5]   A[2][6]</span>
<span style="color:#2980b9;">             &uarr;         &uarr;                   &darr;         &darr;</span>
A[3][1]   <span style="color:#2980b9;">A[3][2]   A[3][3]   A[3][4]   A[3][5]   A[3][6]</span>
<span style="color:#2980b9;">             &uarr;         &uarr;                   &darr;         &darr;</span>
A[4][1]   <span style="color:#2980b9;">A[4][2]   A[4][3] &larr; A[4][4] &larr; A[4][5]   A[4][6]</span>
<span style="color:#2980b9;">             &uarr;                                       &darr;</span>
A[5][1]   <span style="color:#2980b9;">A[5][2] &larr; A[5][3] &larr; A[5][4] &larr; A[5][5] &larr; A[5][6]</span>
...
<p>다음은 배열 A의 크기가&nbsp;5&times;6이고, 회전 연산이 (3, 4, 2), (4, 2, 1)인 경우의 예시이다.</p>
