...
제출: 7388, 정답: 4058, 맞힌 사람: 2737, 정답 비율: 52.971%
...
<p>함수 f : {1, 2, ..., m}&rarr;{1, 2, ..., m}이 있다. 이때&nbsp;f<sub>n</sub> : {1, 2, ..., m}&rarr;{1, 2, ..., m}을 다음과 같이 정의하자.</p>
...
<p>첫 줄에 정수 m이 주어진다. (1&nbsp;&le; m&nbsp;&le; 200,000)</p>

<p>다음 줄에 f(1), f(2), ..., f(m)이 차례대로 주어진다.</p>

<p>다음 줄에 쿼리의 개수 Q가 주어진다. (1&nbsp;&le; Q&nbsp;&le; 200,000)</p>

<p>다음 Q개의 줄에 각각 정수 n과 x가 주어진다. (1&nbsp;&le; n&nbsp;&le; 500,000; 1&nbsp;&le; x&nbsp;&le; m)</p>
