...
제출: 1584, 정답: 864, 맞힌 사람: 728, 정답 비율: 61.331%
...
<p>첫째 줄에 N(1 &le; N &le; 10)과 M(1 &le; M &le; 10<sup>12</sup>)이 주어진다. 둘째 줄에는 N개의 소수가 주어진다. 입력으로 주어지는 소수는 100보다 작거나 같으며, 같은 소수가 두 번 이상 주어지지 않는다.</p>
