...
제출: 499, 정답: 219, 맞힌 사람: 161, 정답 비율: 48.060%
...
<p>첫 번째 줄에 정수 <em>N</em> (2 &le; <em>N</em> &le; 100,000) 이 주어집니다.</p>

<p>다음 <em>N</em>개의 줄에는 1번부터 <em>N</em>번 피연산자 노드가 가지는 정수 <em>a<sub>i</sub></em> (-10,000 &le; <em>a<sub>i</sub></em> &le; 10,000) 가 주어집니다.</p>

<p>그 다음 <em>N-1</em> 개의 줄에는 <em>N+1</em>번 연산자 노드부터 <em>2N-1</em>번 연산자 노드들의 정보가 주어집니다.</p>

<p>각 줄에는 연산자 노드가 가지는 연산자 <em>o<sub>i</sub></em> (<em>o<sub>i</sub></em> &isin; {&#39;<code>+</code>&#39;, &#39;<code>-</code>&#39;}) 와 왼쪽 자식 노드의 번호와 오른쪽 자식의 번호 <em>c<sub>i,1</sub></em>, <em>c<sub>i,2</sub></em> (1 &le; <em>c<sub>i,1</sub></em>, <em>c<sub>i,2</sub></em> &le; <em>2N-2</em>) 가 차례대로 주어집니다.</p>
