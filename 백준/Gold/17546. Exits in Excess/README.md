...
제출: 192, 정답: 91, 맞힌 사람: 71, 정답 비율: 44.375%
...
<ul>
	<li>One line containing the number of rooms 1 &le; n &le; 10<sup>5</sup> and the number of corridors 0 &le; m &le; 2 &middot; 10<sup>5</sup>.</li>
...
<ul>
	<li>On the first line, print a single integer 0 &le; r &le; m/2, the number of corridors to be removed.</li>
