...
제출: 2632, 정답: 939, 맞힌 사람: 722, 정답 비율: 35.202%
...
<p>그래서 N분동안 학생들은 달릴지 아님 쉴지 결정하여야 한다. 그러나 학생들도 인간이기 때문에 계속 달릴 수는 없다. &ldquo;지침 지수&rdquo;라는 것이 있어서 1분을 달린다면 &ldquo;지침 지수&rdquo;는 1이 올라간다. 반대로 1분을 쉰다면 &ldquo;지침 지수&rdquo;는 1이 내려간다. 또한 이 &ldquo;지침 지수&rdquo;가 M보다 커지면 학생들은 더 이상 달릴 수가 없다.</p>
...
<p>첫째 줄에 운동할 시간 N(1 &le; N &le; 10000)과 M(1 &le; M &le; 500)이 주어진다.&nbsp;이어서 N개의 줄에 i분에 달릴수 있는 거리 D<sub>i</sub>(0 &le; D<sub>i</sub> &le; 10,000)가 차례차례 주어진다.</p>
