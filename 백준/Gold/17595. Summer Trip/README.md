...
제출: 74, 정답: 60, 맞힌 사람: 55, 정답 비율: 87.302%
...
<p>The input consists of one line with a string describing the sequence of event types in the summer season. All characters are lowercase English letters (&rsquo;<code>a</code>&rsquo; &ndash; &rsquo;<code>z</code>&rsquo;), with different letters represent different types of events. Character <em>i</em> of the string encodes the <em>i</em>th event of the summer. There are no blanks or spaces in the string.</p>
