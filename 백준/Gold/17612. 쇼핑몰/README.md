...
제출: 5908, 정답: 2239, 맞힌 사람: 1564, 정답 비율: 38.494%
...
<p style="text-align: center;"><img alt="" src="%EB%B0%B1%EC%A4%80/Gold/17612.%E2%80%85%EC%87%BC%ED%95%91%EB%AA%B0/9ac939b8.png" data-original-src="%EB%B0%B1%EC%A4%80/Gold/17612.%E2%80%85%EC%87%BC%ED%95%91%EB%AA%B0/9ac939b8.png" data-original-src="https://upload.acmicpc.net/5b0b8a21-5bb6-44df-92f3-cbbb9f042339/-/preview/" onerror="this.onerror=null;this.src=this.dataset.originalSrc" style="height: 90px; width: 134px;" /></p>
...
<p>입력의 첫 줄에는 2개의 정수 N(1 &le; N &le; 100,000)과 k(1 &le; k &le; 100,000)가 주어진다. 다음 줄부터 N개의 줄에 걸쳐&nbsp;고객 N명의 정보가 줄 맨 앞의 고객부터 맨 뒤 고객까지 순서대로 주어진다. i번째 줄은 줄의 앞에서 i번째 고객의&nbsp;회원번호 id<sub>i</sub>(1 &le; id<sub>i</sub> &le; 1,000,000)와 그가 구입한 물건의 수 w<sub>i</sub>(1 &le; w<sub>i</sub> &le; 20)로 이루어져 있다. N명의 회원번호는 모두 다르다.</p>

### 출력

<p>고객 N명의 회원번호를 쇼핑몰을 빠져나가는 순서대로 r<sub>1</sub>, r<sub>2</sub>, ..., r<sub>N</sub>이라 할 때, 1&times;r<sub>1</sub> + 2&times;r<sub>2</sub> + ... + N&times;r<sub>N</sub>의 값을 출력한다. 출력값이 int 범위를 넘어갈 수 있음에 유의하라.</p>