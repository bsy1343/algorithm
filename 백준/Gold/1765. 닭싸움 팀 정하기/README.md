...
제출: 3334, 정답: 1638, 맞힌 사람: 1248, 정답 비율: 49.018%
...
<p>첫째 줄에 학생의 수 n이 주어진다. 각 학생들은 1부터 n까지 번호가 매겨져 있다. (2 &le; n &le; 1000)&nbsp;</p>

<p>둘째 줄에 학생 간의 인간관계 중 알려진 것의 개수 m이 주어진다. (1 &le; m &le; 5000)</p>

<p>다음 m개의 줄에는 한 줄에 한 개씩, 학생 간의 인간관계가 F p q 혹은 E p q의 형태로 공백으로 구분되어 주어진다. (1 &le; p &lt; q &le; n)</p>
