...
제출: 40466, 정답: 20804, 맞힌 사람: 16220, 정답 비율: 50.966%
...
<p>첫째 줄에 문제의 수 N(1 &le; N &le; 32,000)과 먼저 푸는 것이 좋은 문제에 대한 정보의 개수 M(1&nbsp;&le; M &le; 100,000)이 주어진다. 둘째 줄부터 M개의 줄에 걸쳐 두 정수의 순서쌍 A,B가 빈칸을 사이에 두고 주어진다. 이는 A번 문제는 B번 문제보다 먼저 푸는 것이 좋다는 의미이다.</p>
