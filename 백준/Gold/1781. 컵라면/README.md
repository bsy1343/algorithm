...
제출: 24550, 정답: 8811, 맞힌 사람: 6469, 정답 비율: 35.282%
...
<p>첫 줄에 숙제의 개수 N (1 &le; N &le; 200,000)이 들어온다. 다음 줄부터 N+1번째 줄까지 i+1번째 줄에 i번째 문제에 대한 데드라인과 풀면 받을 수 있는 컵라면 수가 공백으로 구분되어 입력된다.</p>
