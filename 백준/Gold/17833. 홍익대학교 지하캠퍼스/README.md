...
제출: 304, 정답: 125, 맞힌 사람: 98, 정답 비율: 38.281%
...
<p>첫 째 줄에는 건물을 배치할 수 있는 지하 층 수에 해당하는 자연수&nbsp;<em>N</em>이 주어진다. ( N은&nbsp;2&nbsp;&le; <em>N</em> &le; 2,000 이다.&nbsp;)</p>

<p>둘 째 줄에는 각각 정문과 후문에 출입구가 위치한 층 <em>R</em>과 <em>D</em>가 공백을 사이에 두고 주어진다.&nbsp;(&nbsp;R과 D는 각각 1&nbsp;&le; <i>R</i>&nbsp;&le; <em>N, 1</em>&nbsp;&le; <i>D</i>&nbsp;&le; <em>N</em>&nbsp;인 자연수다. )</p>

<p>셋 째 줄에는 샘플의 개수 <em>M</em>이 주어진다. ( M은 1&nbsp;&le; <em>M&nbsp;</em>&le; 2,000 인 자연수다. )</p>
...
<p>( 이 때 위의 입력은 각각&nbsp;2&nbsp;&le;&nbsp;<em>H<sub>i </sub></em>&le; <em>N<sub>, </sub></em>1 &le;<em>T<sub>i </sub></em>&le; 1,000,000<em><sub>,&nbsp;</sub></em>1 &le;&nbsp;<em>E<sub>i1 </sub></em>&le;&nbsp;<em>H<sub>i , </sub></em>1 &le;&nbsp;<em>E<sub>i2&nbsp;</sub></em>&le;&nbsp;<em>H<sub>i&nbsp;&nbsp;</sub></em>를 만족하는 자연수이다. 단,&nbsp;<em>E<sub>i1&nbsp;</sub></em>&ne; <em>E<sub>i2</sub></em> 이다. )</p>
