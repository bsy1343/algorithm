...
제출: 820, 정답: 445, 맞힌 사람: 352, 정답 비율: 55.346%
...
<p>첫 번째 줄에 수풀의 수 <em>N</em>(2 &le; <em>N</em> &le; 50,000)과 오솔길의 수 <em>M</em>(1 &le; <em>M</em> &le; 500,000)이 공백으로 구분되어 주어진다.</p>

<p>두 번째 줄부터 <em>M</em>개의 줄에 걸쳐, <em>u</em>, <em>v</em>(1 &le;&nbsp;<em>u</em>,<em>v</em> &le;&nbsp;<em>N</em>, <em>u&nbsp;</em>&ne;&nbsp;<em>v</em>)가 공백으로 구분되어 주어진다. 이는 <em>u</em>번 수풀과 <em>v</em>번 수풀이 오솔길로 연결되어 있음을 의미한다.</p>
