...
제출: 570, 정답: 270, 맞힌 사람: 209, 정답 비율: 49.881%
...
<ol>
	...
	<li>어떤 버스 노선이 K개의 정류장을 방문하고, 방문하는 정류장들을 순서대로 정류장 1, 정류장 2, &hellip; ,정류장 K라고 할 때, 정류장 i(1 &le; i &le; K-1)와 정류장 i+1 사이에는 도로가 존재해야 한다. 이때 정류장 i와 i+1을 잇는 도로는&nbsp;이 버스 노선이 <strong>지나가는</strong> 도로라고 부른다.</li>
...
<p>첫 번째 줄에 정류장의 수 N(2&nbsp;&le;&nbsp;N&nbsp;&le; 200,000)가&nbsp;주어지며 정류장은 0부터 N-1까지 고유한 번호를 가진다.</p>
