...
제출: 3550, 정답: 1757, 맞힌 사람: 1408, 정답 비율: 52.734%
...
<p>첫 번째 줄에 시험지의 개수 N과 시험지를 나눌 그룹의 수 K가 정수로 주어진다. (1 &le; K &le; N &le; 10<sup>5</sup>)</p>

<p>두 번째 줄에 각 시험지마다 맞은 문제의 개수 x가 정수로 주어진다 (0 &le; x &le; 20)</p>
