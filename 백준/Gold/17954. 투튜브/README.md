...
제출: 669, 정답: 234, 맞힌 사람: 203, 정답 비율: 34.820%
...
<p>하지만 성주가 선물해준 사과는 너무 신선하여 민서가 포장을 뜯는 즉시 조금씩 부패하기 시작한다. 양의 정수 T초의 시간이 지나게 되면, 튜브 안에 들어있는 사과들은 &ldquo;크기 x T&rdquo;만큼의 부패도를 가지게 되고, 부패도는 누적된다.</p>
...
<p>첫째 줄에 양의 정수 N이 주어진다. (1 &le; N &le; 10,000)</p>
