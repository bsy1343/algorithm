...
제출: 734, 정답: 391, 맞힌 사람: 312, 정답 비율: 52.792%
...
<p style="text-align: center;"><img alt="" src="%EB%B0%B1%EC%A4%80/Gold/17977.%E2%80%85Triangulation/f4eca618.png" data-original-src="%EB%B0%B1%EC%A4%80/Gold/17977.%E2%80%85Triangulation/f4eca618.png" data-original-src="https://upload.acmicpc.net/a5a9e43c-c513-4e8f-abd1-31b61346355f/-/preview/" onerror="this.onerror=null;this.src=this.dataset.originalSrc" style="width: 175px; height: 199px;" /></p>
...
<p>Your program is to read from standard input. The input starts with a line containing <em>n</em> (3 &le; <em>n</em> &le; 1,000,000), where <em>n</em> is the number of sides of the regular <em>n</em>-sided polygon.</p>
