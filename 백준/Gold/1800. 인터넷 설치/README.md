...
제출: 5896, 정답: 2167, 맞힌 사람: 1517, 정답 비율: 34.834%
...
<p>첫 번째 줄에 N(1 &le; N &le; 1,000), 케이블선의 개수 P(1 &le; P &le; 10,000), 공짜로 제공하는 케이블선의 개수 K(0 &le; K &lt; N)이 주어진다. 다음 P개의 줄에는 케이블이 연결하는 두 컴퓨터 번호와 그 가격이 차례로 들어온다. 가격은 1 이상 1,000,000 이하다.</p>
