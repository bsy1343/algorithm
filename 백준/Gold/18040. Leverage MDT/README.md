...
제출: 111, 정답: 60, 맞힌 사람: 59, 정답 비율: 59.000%
...
<p>The kingdom of Nlogonia is a very prosperous one. Its king, Constantourist, expanded the kingdom by conquering nearby towns. However, now that Constantourist&rsquo;s life is coming to an end, his two sons, Javasar and Golangsar, need to decide the fate of the kingdom.</p>

<p>Instead of fighting an unnecessary war to choose the next king, the two sons are trying to negotiate an agreement so as to divide the kingdom&rsquo;s jurisdiction into two. Nlogonia is a rectangle-shaped land having N kilometers in the North-South direction and M kilometers in the West-East direction. Thus, during the initial stage of negotiations the two sons were able to divide the land in N &times; M square parcels of one kilometer on each side, using divisory lines parallel to the kingdom&rsquo;s border. The next step is to distribute the parcels between the two sons.</p>
...
<p>The first line contains two integers N and M (1 &le; N, M &le; 1000), indicating the length (in kilometers) of Nlogonia in the North-South and West-East directions, respectively. Each of the next N lines contains a string of M characters, where each character is either the uppercase letter &ldquo;G&rdquo; or the uppercase letter &ldquo;B&rdquo;, representing that the soil quality of a parcel is good or bad, respectively. The description of the kingdom&rsquo;s parcels is made from North to South, and from West to East.</p>
