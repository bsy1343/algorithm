...
제출: 5396, 정답: 1355, 맞힌 사람: 993, 정답 비율: 24.446%
...
<p>첫 번째 줄에 물건의 개수 <em>N</em>과 제시하는 무게 <em>C</em>가 공백으로 구분되어 주어진다. (1 &le; <em>N</em> &le; 5,000, 1 &le; <em>C</em> &le; 10<sup>8</sup>, <em>N</em>과 <em>C</em>는 양의 정수)</p>

<p>다음 줄에는 <em>N</em>개의 물건 각각의 무게 <em>w</em>가 공백으로 구분되어 주어진다. (1 &le; <em>w</em> &le; 10<sup>8</sup>, <em>w</em>는 양의 정수)</p>
