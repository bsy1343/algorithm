...
제출: 464, 정답: 248, 맞힌 사람: 221, 정답 비율: 55.808%
...
<p>첫 번째 줄에 테스트케이스의 개수를 나타내는&nbsp;<em>T</em>(1 &le;&nbsp;<em>T</em>&nbsp;&le; 100)가 주어진다.</p>

<p>두 번째 줄부터 각 테스트케이스마다 간선의 개수를 나타내는&nbsp;<em>E</em>가 주어진다. (1 &le;&nbsp;<em>E</em>&nbsp;&le; 5,000)</p>
