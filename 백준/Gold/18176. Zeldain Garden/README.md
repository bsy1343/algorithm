...
제출: 90, 정답: 63, 맞힌 사람: 56, 정답 비율: 70.000%
...
<p>The input contains one text line with two integers N, M (1 &le; N &le; M &le; 10<sup>12</sup>), the minimum and the maximum number of loudspeakers in the collection.</p>
