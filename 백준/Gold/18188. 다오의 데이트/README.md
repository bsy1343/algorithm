...
제출: 818, 정답: 359, 맞힌 사람: 282, 정답 비율: 46.844%
...
<p>두번째 줄부터 <em>H</em>개의 줄에 걸쳐, 버블힐의 정보가 주어진다. (<em>i</em>+1)번째 줄에는 길이 <em>W</em>의 문자열이 주어진다(1 &le; <em>i</em> &le; <em>H</em>). 이의 <em>j</em>번째 문자를 <em>A</em><sub><em>i</em>, <em>j</em></sub>라고 하자(1 &le; <i>j</i>&nbsp;&le; <i>W</i>). 이는 다음을 의미한다.</p>
...
<p>(<em>H</em>+3)번째 줄부터 <em>N</em>개의 줄에 걸쳐, 마리드의 방해에 관한 정보가 주어진다. (<em>H</em>+<em>i</em>+2)번째 줄에는 두 문자 <em>B<sub>i</sub></em>와 <em>C<sub>i</sub></em>가 사이에 공백을 두고 주어진다(1 &le; <em>i</em> &le; <i>N</i>). 이는 다오가 <em>i</em>번째 움직임으로 <em>B<sub>i</sub></em> 방향이나 <em>C<sub>i</sub></em> 방향 중 하나를 택해야 함을 의미한다. 각 문자가 의미하는 방향은 다음과 같다(키보드에서 &quot;<code>WASD</code>&quot;의 배치를 생각하라).</p>
...
<ul>
	<li>2 &le;&nbsp;<em>H</em> &le;&nbsp;20</li>
	<li>2 &le;&nbsp;<em>W</em> &le;&nbsp;20</li>
	<li>1 &le;&nbsp;<em>N</em> &le; 20</li>
	<li><em>A<sub>i</sub></em><sub>, <em>j</em></sub>는 &#39;<code>.</code>&#39;, &#39;<code>D</code>&#39;, &#39;<code>Z</code>&#39;, &#39;<code>@</code>&#39; 중 하나다(1 &le;&nbsp;<em>i</em> &le;&nbsp;<em>H</em>, 1 &le;&nbsp;<em>j</em> &le;&nbsp;<em>W</em>).</li>
	<li><em>A<sub>i</sub></em><sub>, <em>j</em></sub>&nbsp;중 정확하게 하나는 &#39;<code>D</code>&#39;다(1 &le;&nbsp;<em>i</em> &le;&nbsp;<em>H</em>, 1 &le;&nbsp;<em>j</em> &le;&nbsp;<em>W</em>).</li>
	<li><em>A<sub>i</sub></em><sub>, <em>j</em></sub>&nbsp;중 정확하게 하나는 &#39;<code>Z</code>&#39;다(1 &le;&nbsp;<em>i</em> &le;&nbsp;<em>H</em>, 1 &le;&nbsp;<em>j</em> &le;&nbsp;<em>W</em>).</li>
	<li><em>B<sub>i</sub></em>과 <em>C<sub>i</sub></em>는 &#39;<code>W</code>&#39;, &#39;<code>A</code>&#39;, &#39;<code>S</code>&#39;, &#39;<code>D</code>&#39; 중 하나다(1 &le;&nbsp;<em>i</em> &le;&nbsp;<em>N</em>).</li>
	<li><em>B<sub>i</sub></em> &ne;&nbsp;<em>C<sub>i</sub></em>&nbsp;(1 &le;&nbsp;<em>i</em> &le;&nbsp;<em>N</em>).</li>
</ul>