...
제출: 4410, 정답: 2348, 맞힌 사람: 1870, 정답 비율: 52.454%
...
<p>입력의 첫 번째 줄에 정점의 개수 V와 간선의 개수 E<em>,</em> 그리고 건우가 위치한 정점 P가 주어진다. (2 &le;&nbsp;<em>V&nbsp;&nbsp;</em>&le; 5,000, 1 &le;&nbsp;<em>E&nbsp;</em>&le; 10,000, 1 &le;&nbsp;<em>P&nbsp;&nbsp;</em>&le;&nbsp;<em>V</em>)</p>

<p>두 번째 줄부터 E개의 줄에 걸쳐 각 간선의 정보 a,b,c가 공백으로 구분되어 주어진다. 이는 a번 정점과 b번 정점 사이의 거리가 c임을 의미한다. (1 &le;&nbsp;<em>a</em>,<em>b&nbsp;</em>&le;&nbsp;<em>V</em>, 1 &le;&nbsp;<em>c&nbsp;&nbsp;</em>&le; 10,000)</p>
