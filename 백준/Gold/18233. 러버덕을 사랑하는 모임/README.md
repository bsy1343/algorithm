...
제출: 1146, 정답: 409, 맞힌 사람: 323, 정답 비율: 35.495%
...
<p>첫 번째 줄에 정수 <em>N</em>,&nbsp;<em>P</em>, <em>E</em>가 공백으로 구분되어 주어진다. (1 &le; <em>N</em>, <em>P</em>&nbsp;&le; 20, 1 &le; <em>E</em> &le; 1,000,000)</p>

<p>그 다음 줄부터 <em>N</em>개의 줄에 걸쳐 회원 1부터 순서대로 <em>x<sub>i</sub></em>와 <em>y<sub>i</sub></em>가 공백으로 구분되어 주어진다. (1 &le; <em>x<sub>i</sub></em>&nbsp;&le; <em>y<sub>i</sub></em>&nbsp;&le; 1,000,000)</p>
