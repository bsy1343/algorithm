...
제출: 944, 정답: 231, 맞힌 사람: 214, 정답 비율: 26.066%
...
<ul>
	<li>swap L&nbsp;R&nbsp;: A<sub>L</sub>, A<sub>R</sub>의 값을 서로 바꾼다.&nbsp;(1 &le; L&nbsp;&lt; R&nbsp;&le; N)</li>
	<li>reverse L&nbsp;R&nbsp;: 부분 수열 [A<sub>L</sub>, A<sub>L+1</sub>, ..., A<sub>R</sub>] 을 뒤집는다.&nbsp;(1 &le; L&nbsp;&lt; R&nbsp;&le; N)</li>
</ul>
...
<p>첫째 줄에 수열의 길이&nbsp;N과&nbsp;K가 주어진다.&nbsp;(1&nbsp;&le; K &lt; N&nbsp;&le; 10,000,000)</p>
