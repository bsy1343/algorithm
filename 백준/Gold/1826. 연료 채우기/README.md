...
제출: 11168, 정답: 3627, 맞힌 사람: 2810, 정답 비율: 31.755%
...
<p>첫째 줄에 주유소의 개수 N(1 &le; N &le; 10,000)가 주어지고 두 번째 줄부터 N+1번째 줄 까지 주유소의 정보가 주어진다. 주유소의 정보는 두개의 정수 a,b로 이루어 져 있는데 a(1 &le; a &le; 1,000,000)는 성경이의 시작 위치에서 주유소 까지의 거리, 그리고 b(1 &le; b &le; 100)는 그 주유소에서 채울 수 있는 연료의 양을 의미한다. 그리고 N+2번째 줄에는 두 정수 L과 P가 주어지는데 L(1 &le; L &le; 1,000,000)은 성경이의 위치에서 마을까지의 거리, P(1 &le; P &le; 1,000,000)는 트럭에 원래 있던 연료의 양을 의미한다.</p>
