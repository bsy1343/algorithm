...
제출: 137, 정답: 56, 맞힌 사람: 42, 정답 비율: 37.838%
...
<p>첫째 줄에는 사람의 수 N(1&le;N&le;8)이 주어진다. 그리고 두 번째 줄에는 당신의 이동 속도가 소수로 주어진다. 그리고 세 번째 줄부터 N+2번째 줄 까지 네 개의 소수 xi,yi,vi,ai가 차례로 주어진다.&nbsp; (xi, y1) (-10^6 &lt;=xi,yi&lt;= 10^6)는 점심시간이 끝났을 때 i번째 사람의 좌표를 의미하고, vi(1&le;vi&le;100)는 i번째 사람의 이동 속도를 의미한다. 그리고 ai(1&le;ai&le;2파이) 는 그 사람의 이동 방향을 의미한다.</p>
