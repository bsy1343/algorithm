...
제출: 2953, 정답: 1036, 맞힌 사람: 827, 정답 비율: 34.273%
...
<ul>
	<li>1 &le;&nbsp;<em>X</em>&nbsp;&le; <em>N</em>&nbsp;인 임의의 정수 <em>X</em>에 대해, 현재 있는 징검다리의 번호를&nbsp;<em>i</em>번이라고 할 때 <em>i+X</em>번 징검다리로 뛸 수 있다.</li>
...
<p>첫 번째 줄에&nbsp;테스트 케이스의 수 <em>T</em>가 주어진다. (1&nbsp;&le; <em>T</em>&nbsp;&le; 1000)</p>

<p>각 테스트 케이스는 한 줄로 구성되며, 징검다리의 개수를 의미하는 <em>N</em>이 주어진다.&nbsp;(1 &le; <em>N</em>&nbsp;&le; 10<sup>9</sup>)</p>
