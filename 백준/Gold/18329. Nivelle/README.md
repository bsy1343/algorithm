...
<p>The first line contains an integer N (1 &le; N &le; 100 000), the length of array of toys from task description.</p>
...
<p>Output two indices L and R (1 &le; L &le; R &le; N), which denote that the sought contiguous subsequence of toys is located at positions L, L + 1, . . . , R.</p>
