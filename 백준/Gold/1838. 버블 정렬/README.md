...
제출: 3597, 정답: 862, 맞힌 사람: 688, 정답 비율: 34.695%
...
<p>첫째 줄에는 정수 N(1 &le; N &le; 500,000)이 주어진다. 다음 줄에 배열 A를 이루는 N개의 정수가 빈 칸을 사이에 두고 순서대로 주어진다. 주어지는 정수는 절댓값이 2,147,483,647을 넘지 않는다.</p>
