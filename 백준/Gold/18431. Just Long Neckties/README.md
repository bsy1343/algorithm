...
제출: 218, 정답: 137, 맞힌 사람: 127, 정답 비율: 63.184%
...
<p>Have you ever heard of Just Odd Inventions, Ltd.? This company is known for their &ldquo;just odd inventions.&rdquo; We call it JOI, Ltd. in this problem. JOI, Ltd. has invented its newest product &ldquo;Just Long Neckties&rdquo;. There are N + 1 types of neckties, numbered 1 to N + 1. The length of the i-th necktie (1 &le; i &le; N + 1) is A<sub>i</sub>.</p>

<p>The company gathered their employees to hold a try-on party. N employees participate in the party, and the j-th employee (1 &le; j &le; N) initially wears a necktie of length B<sub>j</sub>.</p>
...
<p>If an employee initially wearing a necktie of length b tries a necktie of length a, (s)he feels strangeness of max{a &minus; b, 0}. The oddity of the try-on party is defined as the maximum strangeness among the employees.</p>
...
<ul>
	...
	<li>1 &le; A<sub>i</sub> &le; 1 000 000 000 (1 &le; i &le; N + 1).</li>
	<li>1 &le; B<sub>j</sub> &le; 1 000 000 000 (1 &le; j &le; N).</li>
</ul>