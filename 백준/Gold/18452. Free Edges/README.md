...
제출: 93, 정답: 64, 맞힌 사람: 62, 정답 비율: 74.699%

### 분류

자료 구조, 그래프 이론, 그래프 탐색, 애드 혹, 분리 집합
...
<p>The first line of the input contains two integers n and m: the number of vertices and the number of edges in your graph (1 &le; n, m &le; 10<sup>5</sup>).</p>

<p>The next m lines contain description of the edges of the graph. Each of these lines contains two integers a<sub>i</sub> and b<sub>i</sub>, describing an edge between vertices a<sub>i</sub> and b<sub>i</sub> (1 &le; a<sub>i</sub>, b<sub>i</sub> &le; n, a<sub>i</sub> &ne; b<sub>i</sub>).</p>
