...
제출: 207, 정답: 51, 맞힌 사람: 39, 정답 비율: 28.467%

### 분류

다이나믹 프로그래밍, 그래프 이론, 그래프 탐색, 정렬, 가장 긴 증가하는 부분 수열 문제
...
<p>첫째 줄에 점들의 개수 N(1&le;N&le;500)이 주어진다. 그리고 두 번째 줄부터 N+1번째 줄까지 점들의 연결 상태가 주어진다. 각 정보는 두 개의 정수로 이루어 져 있는데 i번째 줄에 a와 b 두 정수가 주어져 있다면 i번 점과 a, b가 연결이 되어 있다는 것을 의미한다.</p>
