...
제출: 148, 정답: 87, 맞힌 사람: 80, 정답 비율: 57.143%
...
<p>The first line contains n (2 &le; n &le; 100), which is the length of one side of the square grid representing the maze.</p>

<p>Following this is an n &times; n grid of characters. If a cell is cleared out, its corresponding character is a dot (<code>.</code>). If a cell is blocked off with corn plants, its corresponding character is a hash (<code>#</code>).</p>
