...
제출: 1091, 정답: 253, 맞힌 사람: 170, 정답 비율: 23.035%
...
<p>첫 줄에 세 정수 Lx, Ly, N이&nbsp;주어진다. (1 &le; Lx, Ly &le; 1,000,&nbsp;1 &le; N &le; 20,000) Lx와 Ly는 창고의 가로, 세로 길이이며, N은 입고되는 상자의 개수이다. 이후 N개의 줄에 각 상자의 정보가 입고되는 순서로 주어진다. 이는 다섯 개의 정수 lx, ly, lz, px,&nbsp;py 로 이루어진다. (1 &le; lx, 0 &le; px, px+lx &le; Lx, 1 &le; ly, 0 &le; py, py+ly &le; Ly, 1 &le; lz &le; 100,000) lx, ly, lz는 각각 상자의 가로, 세로, 높이 길이를 나타낸다. px, py는 상자를 쌓아야 하는 위치를 나타낸다. 상자 바닥의 네 꼭짓점 중 가장 남서쪽에 있는 것의 x, y좌표를 px, py에 맞추어 쌓으면 된다.</p>
