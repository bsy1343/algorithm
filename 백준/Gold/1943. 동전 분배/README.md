...
제출: 9481, 정답: 2268, 맞힌 사람: 1406, 정답 비율: 22.031%
...
<p>세 개의 입력이 주어진다. 각 입력의 첫째 줄에 동전의 종류 N(1 &le; N &le; 100)이 주어진다. 각 입력의 둘째 줄부터 N+1째 줄까지 각각의 동전의 금액과 개수가 빈 칸을 사이에 두고 주어진다. 단, 원장선생님께서 주신 금액의 총 합은 100,000원을 넘지 않는다. 동전의 금액과 개수는 자연수이고, 같은 금액을 가진 동전이 두 번 이상 주어지는 경우는 없다.</p>
