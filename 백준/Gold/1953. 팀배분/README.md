...
제출: 2635, 정답: 1106, 맞힌 사람: 892, 정답 비율: 44.006%
...
<p>첫 줄에는 학생들의 수 n (1 &le; n &le; 100)이 주어진다. 그리고 둘째 줄부터 n+1번째 줄까지 서로가 싫어하는 사람들의 정보가 주어진다. i+1번째 줄에는 i번째 사람이 싫어하는 사람의 수와 싫어하는 사람들이 나온다.</p>
