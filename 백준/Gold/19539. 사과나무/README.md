...
제출: 6741, 정답: 2811, 맞힌 사람: 2341, 정답 비율: 43.160%
...
<p>첫 번째 줄에 모든 나무가 갊자가 바라는 높이가 되도록 물뿌리개를 통해 만들 수 있으면 &ldquo;<span style="color:#e74c3c;"><code>YES</code></span>&rdquo;를, 아니면 &ldquo;<span style="color:#e74c3c;"><code>NO</code></span>&rdquo;를 따옴표를 제외하고 출력한다.</p>