...
제출: 347, 정답: 160, 맞힌 사람: 131, 정답 비율: 51.575%
...
<p>첫 번째 줄에 시약의 종류 n(1 &le; n &le; 100)이 주어진다. 그리고 두 번째 줄부터 n+1번째 줄까지 공백을 사이에 두고 a<sub>i</sub>와 b<sub>i</sub>가(1 &le; a<sub>i</sub>&nbsp;&le; 100, 1 &le; b<sub>i</sub> &le; 1000) 주어진다. 그리고 n+2번째 줄에는 용액의 양 M(1 &le; M &le; 10000) 이 주어진다.</p>
