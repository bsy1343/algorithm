...
제출: 1718, 정답: 591, 맞힌 사람: 484, 정답 비율: 36.092%
...
<p>첫 번째 줄에는 비드맨이 가지고 있는 구슬의 종류 <em>N</em>이 주어진다. (1&nbsp;&le; <em>N</em>&nbsp;&le; 10<sup>5</sup>)</p>

<p>두 번째 줄부터 <em>N</em>개의 줄에는 <em>x</em><sub>1</sub>, <em>x</em><sub>2</sub>​, <em>x</em><sub>3,&nbsp;</sub>..., <em>x<sub>N</sub></em>이 주어진다. <em>x<sub>i</sub></em>는 비드맨이 가지고 있는 <em>i</em>번째 종류의 구슬의 개수이다. (1 &le; <em>x</em><sub><em>i</em>&nbsp;</sub>&le; 10<sup>9</sup>)</p>
