...
제출: 11604, 정답: 5385, 맞힌 사람: 4198, 정답 비율: 46.505%
...
<p>첫째 줄에 배열의 크기&nbsp;N(1 &le; N &le; 100,000)이 주어진다. 둘째 줄부터 N+1 줄까지&nbsp;공백을 사이에 두고 회의의 시작시간과 끝나는 시간이 주어진다. 시작 시간과 끝나는 시간은 2<sup>31</sup>&minus;1보다 작거나 같은 자연수 또는 0이다.</p>
