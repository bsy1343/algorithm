...
제출: 1351, 정답: 351, 맞힌 사람: 265, 정답 비율: 25.703%
...
<p>첫 번째 줄에 <em>X, Y, M&nbsp;</em>(0 &le;&nbsp;<em>X, Y</em> &le;&nbsp;100,000, 2 &le;&nbsp;<em>M</em> &le;&nbsp;100,000)이 주어진다. <em>M</em>은 짝수다.</p>
...
<ul>
	<li><em>i</em>번째 줄의 수&nbsp;<i>V<sub>i</sub></i>가 음수라면,&nbsp;<em>i</em>번째 행동에 &minus;<em>V</em><i><sub>i</sub></i>번째 적을 죽인다.</li>
