...
제출: 749, 정답: 367, 맞힌 사람: 283, 정답 비율: 46.091%
...
<p>첫 번째 줄에는 트리를 구성하는 정점의 개수 <em>N</em> (2&nbsp;&le; <em>N</em>&nbsp;&le; 10<sup>5</sup>)가 주어진다.</p>

<p>두 번째 줄부터 <em>N&nbsp;</em>+ 1번째 줄까지는 정점에 연결된 간선에 대한 정보가 주어진다. 각 줄의 처음에는 간선이 연결될 정점의 번호 <em>V<sub>i</sub></em> (1&nbsp;&le; <em>V<sub>i</sub></em>&nbsp;&le; <em>N</em>)가 주어지며, -1을 입력받기 전까지는 해당 노드에서 연결된 모든 노드에 대한 정보가 주어진다.</p>
...
<p>트리를 구성하는 양방향 간선의 정보를 입력받기 때문에, 간선의 개수의 총합은 <strong>2&nbsp;&times; (<em>N</em> - 1) </strong>개이며, 모든 정점들은&nbsp;간선을 통해 서로 직/간접적으로 연결되있다.</p>
...
<p>이 때, 출력되는 모든 <span style="color:#e74c3c;"><code>left</code></span> 필드와 <span style="color:#e74c3c;"><code>right</code></span> 필드는 <strong>1 이상</strong> <strong>2&nbsp;&times; <em>N</em>&nbsp;이하</strong>의 서로 다른 자연수이다.</p>