...
제출: 556, 정답: 116, 맞힌 사람: 75, 정답 비율: 21.307%
...
<p>첫째 줄에 이미지의 크기를 나타내는 두 정수 n(1 &le; n &le; 128), m(1 &le; m &le; 128)이 주어진다. 이는 이미지의 크기가 n&times;m이라는 의미이다. 다음 n개의 줄에는 m개의 숫자로 이미지가 주어진다. 흰색은 0으로, 검은색은 1로 표현된다.</p>
