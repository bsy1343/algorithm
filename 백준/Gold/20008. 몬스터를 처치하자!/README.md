...
제출: 593, 정답: 275, 맞힌 사람: 207, 정답 비율: 48.252%
...
<p>첫 번째 줄에는 스킬 개수 N(1 &le; N &le; 5)과 몬스터의 체력(HP)을 나타내는 정수(1 &le; HP &le; 100000)가 주어진다.</p>

<p>두 번째 줄부터는 줄마다 스킬의 대기 시간을 초 단위로 나타내는 정수 C(1 &le; C &le; 10)와 스킬의 대미지를 나타내는 정수 D(HP/10 &le; D &le; HP)가 공백을 두고 주어진다. 모든 스킬의 대기 시간은 다르며, 모든 D의 합은 HP보다 작다.</p>
