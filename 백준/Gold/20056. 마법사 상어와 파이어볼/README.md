...
제출: 28683, 정답: 12107, 맞힌 사람: 7596, 정답 비율: 38.463%
...
<p>마법사 상어가 크기가 N&times;N인 격자에 파이어볼 M개를 발사했다. 가장 처음에 파이어볼은 각자 위치에서 이동을 대기하고 있다. i번 파이어볼의 위치는 (r<sub>i</sub>, c<sub>i</sub>), 질량은 m<sub>i</sub>이고, 방향은 d<sub>i</sub>, 속력은 s<sub>i</sub>이다. 위치 (r, c)는 r행 c열을 의미한다.</p>
...
<ol>
	...
	<ol>
		...
		<ol>
			<li>질량은&nbsp;&lfloor;(합쳐진 파이어볼 질량의 합)/5&rfloor;이다.</li>
			<li>속력은&nbsp;&lfloor;(합쳐진 파이어볼 속력의 합)/(합쳐진 파이어볼의 개수)&rfloor;이다.</li>
...
<ul>
	<li>4 &le; N &le; 50</li>
	<li>0 &le; M &le; N<sup>2</sup></li>
	<li>1 &le; K &le; 1,000</li>
	<li>1 &le; r<sub>i</sub>, c<sub>i</sub> &le; N</li>
	<li>1 &le; m<sub>i</sub> &le; 1,000</li>
	<li>1 &le; s<sub>i</sub> &le; 1,000</li>
	<li>0 &le; d<sub>i</sub> &le; 7</li>
</ul>