...
제출: 1195, 정답: 335, 맞힌 사람: 281, 정답 비율: 31.188%
...
<p>증가수열은 모든 <em>i</em>(1 &le; <em>i</em> &lt; <em>N</em>)에 대해서 <em>a<sub>i</sub></em> &le; <em>a<sub>i+1</sub></em>을 만족하는 수열이고, 감소수열은 <em>a<sub>i</sub></em> &ge; <em>a<sub>i+1</sub></em>을 만족하는 수열이다.</p>
...
<ul>
	...
	<li>1&nbsp;&le; <em>a<sub>i</sub></em>&nbsp;&le; 1,000,000,000. (1&nbsp;&le; <em>i</em>&nbsp;&le; <em>N</em>)</li>
