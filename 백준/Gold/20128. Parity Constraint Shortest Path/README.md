...
제출: 357, 정답: 217, 맞힌 사람: 181, 정답 비율: 60.333%
...
<ul>
	...
	<li>1&nbsp;&le;&nbsp;<em>M</em>&nbsp;&le; 300,000.</li>
	<li>1&nbsp;&le;&nbsp;<em>u<sub>i</sub></em>,&nbsp;<em>v<sub>i</sub></em>&nbsp;&le;&nbsp;<em>N</em>.&nbsp;<em>u<sub>i</sub></em>&nbsp;&ne;&nbsp;<em>v<sub>i</sub></em>. <em>u<sub>i</sub></em>와 <em>v<sub>i</sub></em>는 <em>i</em>번째 간선의 양 끝점을 의미한다.</li>
	<li>1&nbsp;&le;&nbsp;<em>w<sub>i</sub></em>&nbsp;&le; 1,000,000,000.&nbsp;<em>w<sub>i</sub></em>는&nbsp;<em>i</em>번째 간선의 비용을 의미한다.</li>
