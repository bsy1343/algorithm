...
제출: 1632, 정답: 617, 맞힌 사람: 511, 정답 비율: 36.422%
...
<p>첫번째 줄에 풍선의 개수 정수&nbsp;<em>N</em>(1&nbsp;&le;&nbsp;<em>N</em>&nbsp; &le; 100,000)이 주어진다.</p>

<p>다음&nbsp;<em>N</em>개의 줄에는 풍선의 위치인 두 정수&nbsp;<em>x</em>,<em> y</em> (-1,000,000 &le; <em>x</em>, <em>y</em> &le; 1,000,000)가 주어진다.</p>
