...
제출: 755, 정답: 198, 맞힌 사람: 157, 정답 비율: 26.701%
...
<p>Your program is to read from standard input. The input consists of exactly two lines. The first line consists of two integers, <em>n</em> and <em>d</em> (2 &le; <em>n</em> &le; 1,000,000 and 1 &le; <em>d</em> &le; 10<sup>10</sup>), where <em>n</em> denotes the number of mobile robots you are controlling and <em>d</em> is the distance that the robots should keep for the robot-to-robot communication. Each mobile robot is identified by a label from 1 to <em>n</em>. The second line consists of <em>n</em> integers, each of which ranges from &minus;10<sup>16</sup> and 10<sup>16</sup>, representing the current locations of robot 1, robot 2, &hellip;, and robot <em>n</em> in this order.</p>
