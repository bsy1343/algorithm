...
제출: 300, 정답: 82, 맞힌 사람: 64, 정답 비율: 27.948%
...
<p>첫째 줄에는 선분의 개수 N(1 &le; N &le; 60)이 들어온다. 다음에는 각 선분의 좌표가 N줄에 걸쳐서 입력으로 들어온다. 선분의 좌표는 &quot;(한 쪽 끝점의 가로 좌표, 세로 좌표, 다른 쪽 끝점의 가로 좌표, 세로 좌표)&quot;의 순서로 들어오며, 한 줄에 하나의 선분에 관한 정보가 들어온다. 좌표의 범위는 10,000 이하의 음이 아닌 정수이다.</p>
