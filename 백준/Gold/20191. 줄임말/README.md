...
제출: 2897, 정답: 873, 맞힌 사람: 661, 정답 비율: 36.259%
...
<ul>
	<li>S와 T는 영문 알파벳 소문자(&lsquo;<code>a</code>&rsquo; - &lsquo;<code>z</code>&rsquo;)만으로 이루어진 문자열이다.</li>
	<li>S의 길이는 1 이상 1 000 000 이하이다.</li>
	<li>T의 길이는 1 이상 100 000 이하이다.</li>
</ul>