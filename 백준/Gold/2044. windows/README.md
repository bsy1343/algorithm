...
제출: 559, 정답: 188, 맞힌 사람: 160, 정답 비율: 34.557%
...
<p>text-mode windows의 개발자인 동혁이는 &quot;cascade mode (계단형 배치)&quot; 부분을 코딩하다가 고심에 빠졌다. text-mode windows에서 하나의 window는 다음과 같이 &lsquo;+&rsquo;, &lsquo;-&rsquo;, &lsquo;|&rsquo;, &lsquo;.&rsquo;, 그리고 알파벳 소문자로 이루어져 있다.</p>
...
<p>첫째 줄에 스크린의 세로 길이 M과 가로 길이 N이 주어진다. (10&le;M, N&le;100) 이어서 M개의 줄에는 각각 N개의 문자열이 주어지는데, 이는 screen-shot을 나타내 주는 정보이다. 배경 그림 같은 것은 없고 모두 &lsquo;.&rsquo;으로 표시되며, 모든 window의 title의 길이는 1 이상 10 이하이다. M과 N은 &quot;cascade mode&quot;로 window를 모두 정리할 수 있을 만큼 충분히 크다고 가정해도 좋다.</p>
