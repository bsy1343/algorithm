...
제출: 804, 정답: 336, 맞힌 사람: 299, 정답 비율: 43.906%

### 분류

그래프 이론, 그리디 알고리즘, 그래프 탐색, 트리
...
<p>The first line contains the single integer $N$. The next $N&minus;1$ lines each contain two space-separated integers $a$ and $b$ describing a road between farms $a$ and $b$. Both $a$ and $b$ are in the range $1\ldots N$.</p>
