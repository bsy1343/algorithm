...
제출: 1441, 정답: 295, 맞힌 사람: 203, 정답 비율: 20.020%
...
<p>첫 줄에는 <em>N, M, K</em> 값이 주어진다. (<em>N</em>&nbsp;&le; 100, <em>M</em> &le;&nbsp;1,000, <em>K</em> &le;&nbsp;100,000)</p>

<p><em>N&nbsp;</em>은 총 크롬 탭 수이다.&nbsp;<em>M </em>은 목표 CPU 사용량이다.&nbsp;<em>K&nbsp;</em>은 목표 메모리 할당량이다.</p>

<p>다음 <em>N</em> 줄에는 다음과 같이 크롬 탭의 정보가 주어진다.</p>

<p><em>cpu, memory, priority&nbsp;</em>(1 &le;&nbsp;<em>cpu</em> &le;&nbsp;<em>M,&nbsp;</em>1 &le;&nbsp;<em>memory</em> &le;&nbsp;<em>K,&nbsp;</em>1 &le;&nbsp;<em>priority</em> &le;&nbsp;5)</p>
