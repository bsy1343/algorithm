...
제출: 71328, 정답: 21091, 맞힌 사람: 12937, 정답 비율: 29.342%
...
<p>첫째 줄에 도시의 수 N이 주어진다. (2 &le; N &le; 16) 다음 N개의 줄에는 비용 행렬이 주어진다. 각 행렬의 성분은 1,000,000 이하의 양의 정수이며, 갈 수 없는 경우는 0이 주어진다. W[i][j]는 도시 i에서 j로 가기 위한 비용을 나타낸다.</p>
