...
제출: 4082, 정답: 1614, 맞힌 사람: 1187, 정답 비율: 42.591%
...
<p>첫째 줄에 지점의 개수 N(2 &le; N &le; 50,000)이 주어진다. 다음 N개의 줄에는 차례로 두 지점 사이의 거리가 양의 정수로 주어진다. 전체 거리의 총 합은 1,000,000,000을 넘지 않는다.</p>
