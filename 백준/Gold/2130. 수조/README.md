...
제출: 1078, 정답: 236, 맞힌 사람: 126, 정답 비율: 19.535%
...
<p>N(1 &le; N &le; 50,000)개의 수조가 있다. 각각의 수조는 3차원 공간상에 존재한다. 수조에 대한 정보는 수조가 위치한 높이 b(0 &le; b &le; 1,000,000), 수조 자체의 높이 h(1 &le; h &le; 40,000), 수조의 가로길이 w(1 &le; w &le; 40,000), 수조의 세로길이 d(1 &le; d &le; 40,000)로 표현된다. 모든 수조의 아래에는 파이프가 달려 있고, 모든 파이프들은 하나로 연결되어 있다.</p>
