...
제출: 14059, 정답: 3657, 맞힌 사람: 2867, 정답 비율: 26.933%
...
<p>첫째 줄에 N(1 &le; N &le; 100,000)이 주어진다. 다음 N개의 줄에는 X[1], A[1], X[2], A[2], &hellip;, X[N], A[N]이 주어진다. 범위는 |X[i]| &le; 1,000,000,000, 1 &le; A[i] &le; 1,000,000,000 이며 모든 입력은 정수이다.</p>
