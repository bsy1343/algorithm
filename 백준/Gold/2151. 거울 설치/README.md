...
제출: 13064, 정답: 3642, 맞힌 사람: 2482, 정답 비율: 27.164%
...
<p>첫째 줄에 집의 크기 N (2 &le; N &le; 50)이 주어진다. 다음 N개의 줄에는 N개의 문자로 집에 대한 정보가 주어진다. &lsquo;#&rsquo;는 문이 설치된 곳으로 항상 두 곳이며, &lsquo;.&rsquo;은 아무 것도 없는 것으로 빛은 이 곳을 통과한다. &lsquo;!&rsquo;은 거울을 설치할 수 있는 위치를 나타내고, &lsquo;*&rsquo;은 빛이 통과할 수 없는 벽을 나타낸다.</p>
