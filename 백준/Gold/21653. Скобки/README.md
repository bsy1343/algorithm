...
제출: 67, 정답: 45, 맞힌 사람: 38, 정답 비율: 76.000%
...
<p>Таким образом, если в полученной последовательности добавленная открывающая скобка стоит в позиции i, а добавленная закрывающая &mdash; в позиции j, то два способа, соответствующие парам (i<sub>1</sub>, j<sub>1</sub>) и (i<sub>2</sub>, j<sub>2</sub>), считаются различными, если i<sub>1</sub>&ne;i<sub>2</sub> или j<sub>1</sub>&ne;j<sub>2</sub>.</p>
...
<p>Величина n (количество скобок каждого типа) не превосходит 50 000.</p>