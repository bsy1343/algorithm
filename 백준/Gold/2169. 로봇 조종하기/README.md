...
제출: 21005, 정답: 7985, 맞힌 사람: 5723, 정답 비율: 37.097%
...
<p>NASA에서는 화성 탐사를 위해 화성에 무선 조종 로봇을 보냈다. 실제 화성의 모습은 굉장히 복잡하지만, 로봇의 메모리가 얼마 안 되기 때문에 지형을 N&times;M 배열로 단순화 하여 생각하기로 한다.</p>
...
<p>첫째 줄에 N, M(1&le;N, M&le;1,000)이 주어진다. 다음 N개의 줄에는 M개의 수로 배열이 주어진다. 배열의 각 수는 절댓값이 100을 넘지 않는 정수이다. 이 값은 그 지역의 가치를 나타낸다.</p>
