...
제출: 257, 정답: 73, 맞힌 사람: 56, 정답 비율: 30.601%
...
<p>과자판은 N&times;N크기의 정사각 배열로서 표현될 수 있으며, 각각의 요소는 그 부분에 뿌려진 소스의 양을 나타낸다. 양수는 원래 기준치 소스양보다&nbsp; 많이 뿌려졌음을, 음수는 그 반대를 나타낸다. 다음은 10&times;10크기의 과자판의 예이다.</p>
...
<p>N&times;N개의 과자판이 주어질 때, 상사의 요구를 만족시는 프로그램을 작성하시오.</p>

### 입력

<p>맨 첫줄에는 과자판의 크기 N과 잘라낼 양파깡의 개수 M이 빈 칸을 사이에 두고 주어진다. 다음 줄부터는 과자판이 N&times;N의 형태로 빈 칸을 사이에 두고 주어진다.</p>
...
<ul>
	<li>3 &le; N &le; 30</li>
	<li>1 &le; M &le; 30</li>
	<li>각&nbsp;소스의 수는 -100이상 100이하의 정수이다.</li>
</ul>