...
제출: 8327, 정답: 1549, 맞힌 사람: 1047, 정답 비율: 21.024%
...
<p>예를 들어 주어진 수열이 $4, &minus;1, 2, 1, &minus;3, 1, 2, 2, 1, 3$이라고 하자. 이 수열을 아래와 같이 나누면 각 부분의 합이 달라서 허용되는 형태가 아니다.</p>

<p>$[4, &minus;1, 2], [1, &minus;3, 1, 2], [2, 1], [3]$</p>
...
<p>$[4, &minus;1], [2, 1, &minus;3, 1, 2], [2, 1], [3]$ 혹은 $[4, &minus;1, 2, 1, &minus;3], [1, 2], [2, 1], [3]$</p>
...
<ul>
	...
	<li>모든 $1 \le i \le N$에 대해 $-1~000 \le A_i \le 1~000$</li>
</ul>