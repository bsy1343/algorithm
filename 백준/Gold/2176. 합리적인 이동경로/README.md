...
제출: 2767, 정답: 922, 맞힌 사람: 690, 정답 비율: 33.398%
...
<p>첫째 줄에 정점의 개수 N(1 &lt; N &le; 1,000), 간선의 개수 M(1 &le; M &le; 100,000이 주어진다. 다음 M개의 줄에는 각 간선에 대한 정보를 나타내는 세 정수 A, B, C가 주어진다. 이는 A번 정점과 B번 정점이 길이 C(0 &lt; C &le; 10,000)인 간선으로 연결되어 있다는 의미이다. 두 정점은 최대 한 개의 간선으로만 연결될 수 있다. 간선은 방향성이 없다.</p>
