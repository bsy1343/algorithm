...
제출: 1566, 정답: 675, 맞힌 사람: 535, 정답 비율: 42.192%
...
<ul>
	...
	<li>1 &le; <em>T </em>&le; min(프로세스들의 실행 시간 총 합, 10<sup>6</sup>)</li>
	<li>1 &le; <em>A<sub>i</sub>, B<sub>i</sub>, C<sub>i</sub></em>&nbsp;&le; 10<sup>6</sup></li>
	<li>문제에 주어지는 <strong>프로세스의 <em>id </em>값은 모두 다릅니다.</strong></li>
	<li>주어지는 값들은 모두 자연수입니다.</li>
</ul>