...
제출: 91, 정답: 53, 맞힌 사람: 50, 정답 비율: 72.464%
...
<p>The following $m$ lines will contain a pair $a_i$, $b_i$ ($1 \le a_i , b_i \le n$, $a_i \ne b_i$, for all $1 \le i \le&nbsp;m$) describing a dependency of kind: &ldquo;job $a_i$&nbsp;must be executed before job $b_i$&rdquo;.</p>
