...
제출: 103, 정답: 80, 맞힌 사람: 74, 정답 비율: 82.222%
...
.
.
x<sub>n&minus;1</sub> y<sub>n&minus;1</sub>
a<sub>1</sub>
.
.
.
...
<p>Here, n and m are the numbers of rooms and nuts. They satisfy 1 &le; n &le; 2&times;10<sup>5</sup> and 0 &le; m &lt; n. Rooms are numbered from 1 to n. The ant is initially in the room 1.</p>

<p>Each of the following n &minus; 1 lines has two integers x<sub>i</sub> and y<sub>i</sub> (1 &le; i &le; n &minus; 1) indicating that a tunnel connects rooms numbered x<sub>i</sub> and y<sub>i</sub>. 1 &le; x<sub>i</sub> &le; n, 1 &le; y<sub>i</sub> &le; n, and x<sub>i</sub>&nbsp;&ne;&nbsp;y<sub>i</sub> hold. No two tunnels connect the same pair of rooms.</p>

<p>Each of the remaining m lines has an integer a<sub>k</sub> (1 &le; k &le; m, 2 &le; a<sub>k</sub> &le; n) which indicates that the room numbered a<sub>k</sub> has a nut in it. The numbers a<sub>k</sub>&rsquo;s are all distinct.</p>
