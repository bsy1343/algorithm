...
제출: 2706, 정답: 774, 맞힌 사람: 551, 정답 비율: 26.126%
...
<pre>
yyyy-MM-dd hh:mm [부품 이름] [동아리 회원 닉네임]</pre>
...
<ul>
	<li>$2&nbsp;\le N \le 80,000$, $N$은 짝수</li>
	<li>$0 \le DDD \le 200$</li>
	<li>$1 \le MM \le 12$</li>
	<li>$0 \le hh \le 23$</li>
	<li>$0 \le mm \le 59$</li>
	<li>$1 \le F \le 4,000$</li>
	<li>$5 \le |P|, |M| \le 20$</li>
	<li>부품을 반납하지 않은 사람은 없다.</li>
</ul>