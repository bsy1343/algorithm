...
제출: 21910, 정답: 11499, 맞힌 사람: 9401, 정답 비율: 51.762%
...
<p>첫째 줄에 센서의 개수 N(1 &le; N &le; 10,000), 둘째 줄에 집중국의 개수 K(1 &le; K &le; 1000)가 주어진다. 셋째 줄에는 N개의 센서의 좌표가 한 개의 정수로 N개 주어진다. 각 좌표 사이에는 빈 칸이 하나&nbsp;있으며, 좌표의 절댓값은 1,000,000 이하이다.</p>
