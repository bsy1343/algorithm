...
제출: 2124, 정답: 800, 맞힌 사람: 620, 정답 비율: 37.508%
...
<p>첫째 줄에 세 정수 A, B, C (0 &lt; A &le; 10,000, -10,000 &le; B, C &lt; 0) 가 주어진다. 그리고 둘째 줄에 X가, 셋째 줄에 Y가 주어진다. 각 문자열의 길이는 3,000자를 넘지 않으며 빈 문자열은 입력으로 주어지지 않는다.</p>
