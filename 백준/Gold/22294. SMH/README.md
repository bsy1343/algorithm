...
제출: 190, 정답: 73, 맞힌 사람: 44, 정답 비율: 49.438%
...
<ul>
	...
	<li>input parameter: 각 학생들의 키(m)가 정수로 학번순으로 저장된 리스트 A가 주어진다. 이때 A[$i$]는 20-$(i+1)$ 학생을 나타낸다.(e.g.: A[0] &rarr; 20-001). 키의 범위는 1 m에서 100 m이다. 리스트 A의 크기는 11보다 작거나 같다.</li>
