...
제출: 2258, 정답: 799, 맞힌 사람: 605, 정답 비율: 34.611%
...
<p>첫째 줄에 정점의 개수 N(1 &le; N &le; 2,000)이 주어진다. 둘째 줄에는 벌레가 만드는 2&times;N자리의 이진수가 주어진다. 셋째 줄에는 썩은 사과의 위치를 나타내는 두 정수 X, Y가 주어진다. 이는 2&times;N자리의 이진수에서 X번째의 숫자에 대응되는 정점과, Y번째 숫자에 대응되는 정점에 있는 사과가 썩었다는 의미이다. 이때 두 정점이 서로 같을 수도 있다.</p>
