...
제출: 2644, 정답: 666, 맞힌 사람: 392, 정답 비율: 24.826%
...
<ul>
	<li>f[<code>()</code>] = 1</li>
	<li>X가 올바른 괄호열이면, f[(X)] = 2 &times; f[X]</li>
...
<ul>
	<li>f[<code>()</code>] = 1</li>
	<li>f[<code>(())</code>] = 2 &times; f[<code>()</code>] = 2 &times; 1 = 2</li>
	<li>f[<code>()()</code>] = f[<code>()</code>] + f[<code>()</code>] = 1 + 1 = 2</li>
	<li>f[<code>()()()</code>] = f[<code>()</code>] + f[<code>()()</code>] = 1 + 2 = 3</li>
	<li>f[<code>(()())</code>] = 2 &times; f[<code>()()</code>] = 2 &times; 2 = 4</li>
	<li>f[<code>((()))</code>] = 2 &times; f[<code>(())</code>] = 2 &times; 2 = 4</li>
	<li>f[<code>()(())</code>] = f[<code>()</code>] + f[<code>(())</code>] = 1 + 2 = 3</li>
...
<ul>
	<li>1 &le; T &le; 10</li>
	<li>A와 B는 올바른 괄호열이다.</li>
	<li>하나의 입력에서 주어지는 모든 테스트 케이스의 A의 길이의 합은 3 000 000 이하이다.</li>
	<li>하나의 입력에서 주어지는 모든 테스트 케이스의 B의 길이의 합은 3 000 000 이하이다.</li>
</ul>