...
제출: 25249, 정답: 10036, 맞힌 사람: 7121, 정답 비율: 40.161%
...
<p>자두는 T(1&le;T&le;1,000)초 동안 떨어지게 된다. 자두는 최대 W(1&le;W&le;30)번만 움직이고 싶어 한다. 매 초마다 어느 나무에서 자두가 떨어질지에 대한 정보가 주어졌을 때, 자두가 받을 수 있는 자두의 개수를 구해내는 프로그램을 작성하시오. 자두는 1번 자두나무 아래에 위치해 있다고 한다.</p>
