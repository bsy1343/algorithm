...
제출: 14, 정답: 8, 맞힌 사람: 7, 정답 비율: 70.000%
...
<ul>
	<li><var>1 &le; n &le; 5000</var></li>
	<li><var>1 &le; m &le; 5&times;10<sup>5</sup></var></li>
	<li><var>|x<sub>i</sub>|, |y<sub>i</sub>| &le; 10<sup>9</sup> (1 &le; i &le; n)</var></li>
	<li><var>|x<sub>i1</sub>|, |y<sub>i1</sub>|, |x<sub>i2</sub>|, |y<sub>i2</sub>| &le; 10<sup>9</sup> (1 &le; i &le; m)</var></li>
	<li><var>x<sub>i1</sub> &le; x<sub>i2</sub>, y<sub>i1</sub> &le; y<sub>i2</sub> (1 &le; i &le; m)</var></li>
	<li>すべての入力は整数で与えられる</li>
</ul>