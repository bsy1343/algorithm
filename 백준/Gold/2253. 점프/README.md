...
제출: 7768, 정답: 1994, 맞힌 사람: 1286, 정답 비율: 23.134%
...
<p>N(2 &le; N &le; 10,000)개의 돌들이 같은 간격으로 놓여 있다. 편의상 순서대로 1, 2, &hellip;, N번 돌이라고 부르자. 당신은 현재 1번 돌 위에 있는데, 이 돌들 사이에서 점프를 하면서 N번째 돌로 이동을 하려 한다. 이때 다음 조건들이 만족되어야 한다.</p>
...
<p>첫째 줄에 두 정수 N, M(0 &le; M &le; N-2)이 주어진다. M은 크기가 맞지 않는, 즉 크기가 작은 돌의 개수이다. 다음 M개의 줄에는 크기가 작은 돌들의 번호가 주어진다. 1번 돌과 N번 돌은 충분히 크기가 크다고 가정한다.</p>
