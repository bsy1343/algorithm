...
<p>The first line contains the number of sightseeing area N (1 &le; N &le; 100). Next N lines describe the integer matrix C, where the j-th element of the i-th row of the input describes C<sub>i,j</sub> (0 &le; C<sub>i,j</sub> &le; 1, 000, 000). For each i, you can assume C<sub>i,i</sub> is always zero.</p>
