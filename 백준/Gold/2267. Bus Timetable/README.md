...
제출: 25, 정답: 5, 맞힌 사람: 5, 정답 비율: 62.500%
...
<p>Input will consist of a number of scenarios. Each scenario will start with the title of the scenario, followed by a number of lines, one for each route in the scenario. The sequence of scenarios will be terminated by a line consisting of a single &lsquo;#&rsquo;.</p>
