...
제출: 555, 정답: 158, 맞힌 사람: 132, 정답 비율: 29.268%
...
<p>첫째 줄에 N(1 &le; N &le; 256), M(1 &le; M &le; 100,000)이 주어진다. M은 키를 비교한 회수이다. 다음 M개의 줄에는 키를 비교한 두 학생의 번호 A, B가 주어진다. 이는 학생 A가 학생 B의 앞에 서야 한다는 의미이다. 같은 학생들을 여러 번 비교했을 수도 있다. A와 B가 같은 경우는 없다.</p>
