...
제출: 4690, 정답: 1933, 맞힌 사람: 1378, 정답 비율: 44.026%
...
<p style="text-align: center;"><img alt="" height="434" src="%EB%B0%B1%EC%A4%80/Gold/2281.%E2%80%85%EB%8D%B0%EC%8A%A4%EB%85%B8%ED%8A%B8/b2dd3226.png" data-original-src="https://boja.mercury.kr/assets/problem/2281-1.png" onerror="this.onerror=null;this.src=this.dataset.originalSrc" width="658" /></p>
...
<p>첫째 줄에 n(1 &le; n &le; 1,000), m(1 &le; m &le; 1,000)이 주어진다. m은 노트의 가로 칸의 개수(폭, 너비)이다. 다음 n개의 줄에는 각 사람의 이름의 길이가 노트에 적어야 할 순서대로 주어진다. 각 길이는 m을 넘지 않는 자연수이다.</p>
