...
제출: 3066, 정답: 844, 맞힌 사람: 703, 정답 비율: 34.444%
...
<p>첫째 줄에 N(1 &le; N &le; 100,000)이 주어진다. 다음 N개의 줄에는 X[1], A[1], X[2], A[2], &hellip;, X[N], A[N]이 주어진다. 범위는 |X[i]| &le; 1,000,000,000, 0 &le; A[i] &le; 1,000,000,000 이며 모든 입력은 정수이다.</p>
