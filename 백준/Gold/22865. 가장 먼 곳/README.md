...
제출: 2958, 정답: 1274, 맞힌 사람: 939, 정답 비율: 40.387%
...
<ul>
	...
	<li>$N - 1 &le; M &le; 500,000$</li>
	<li>$1 &le; A, B, C, D, E &le; N$</li>
	<li>$1 &le; L &le; 10,000$</li>
	<li>$L$은 정수</li>
	<li>땅의 번호는 $1$부터 $L$까지 하나씩 붙어 있다.</li>
	<li>임의의 두 땅 사이를 도로를 통해서 이동할 수 있다.</li>
</ul>