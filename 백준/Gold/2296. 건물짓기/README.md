...
제출: 433, 정답: 192, 맞힌 사람: 147, 정답 비율: 47.883%
...
<p>첫째 줄에 건물의 개수를 나타내는 자연수 N(1 &le; N &le; 1,000)이 주어진다. 다음 N개의 줄에는 건물을 지을 x, y(1 &le; x, y &le; 1,000,000,000) 좌표와 그 건물을 지었을 때의 이익 c(1 &le; c &le; 50,000)가 주어진다. 서로 다른 두 건물이 같은 x좌표나 같은 y좌표를 가지는 경우는 없다.</p>
