...
제출: 400, 정답: 169, 맞힌 사람: 136, 정답 비율: 40.964%
...
<p>그 다음 줄에는 사용자의 요청&nbsp;개수 <em>K</em>(1 &le; <em>K</em> &le; 1,000)가 주어진다.</p>

<p>이어서 <em>K</em>개의 줄에 걸쳐 5개의 양의 정수 <em>T</em>(0 &le; <em>T</em> &le; 1,000), <em>U1</em>, <em>U2</em>, <em>V1</em>, <em>V2</em>가 주어지며, 환승에 걸리는 소요 시간이 <em>T</em>이며 출발지는 <em>U1</em>번 노선의 <em>U2</em>역이고 도착지는 <em>V1</em>번 노선의 <em>V2</em>역이라는 뜻이다.</p>
