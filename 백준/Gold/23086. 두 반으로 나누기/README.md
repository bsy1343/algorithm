...
제출: 619, 정답: 183, 맞힌 사람: 139, 정답 비율: 28.484%

### 분류

그래프 이론, 그래프 탐색, 깊이 우선 탐색, 매개 변수 탐색, 이분 그래프
...
<ul>
	...
	<li>\(N\) - 1 &le; \(M\) &le; min(\(\frac{N(N - 1)}{2}\), 2&nbsp;&times; 10<sup>5</sup>)</li>
	<li>0 &le; \(K\) &le; \(M\) - \(N\) +&nbsp;1</li>
	<li>1&nbsp;&le; \(u\), \(v\)&nbsp;&le; \(N\), \(u \ne v\)</li>
	<li>1 &le; \(R_i\) &le; \(M\)&nbsp;</li>
</ul>
