...
제출: 1502, 정답: 430, 맞힌 사람: 323, 정답 비율: 29.152%
...
<p>첫째 줄에 접속할 수 있는 웹페이지의 종류의 수 <em>N</em>, 사용자가 수행하는 작업의 개수 <em>Q&nbsp;</em>와 최대 캐시 용량 <em>C</em>&nbsp;이 순서대로 주어진다.(1 &le; <em>N, Q</em>&nbsp;&le; 2,000, 1 &le;&nbsp;<em>C&nbsp;</em>&le; 200,000)</p>

<p>둘째 줄에는 <i>N</i>개의 정수 <em>CAP<sub>i&nbsp;</sub></em>가 주어진다. <em>i&nbsp;</em>는 웹페이지의 번호이며,&nbsp;<em>i&nbsp;</em>번째 숫자는&nbsp;<em>i</em> 번째 웹페이지를 방문할 때 사용하는 캐시 공간의 크기를 의미한다. 각 캐시 공간의 크기는 1&nbsp;&le;&nbsp;<em>CAP<sub>i&nbsp;&nbsp;</sub></em>&le; <i>C&nbsp;&nbsp;</i>를 만족한다.</p>
...
<p>아래 그림은 에제 입력 1을 나타내고 있다.</p>

<p>파란색 도형 안에 괄호 밖 숫자는 페이지의 번호를, 괄호 안 숫자는 해당 페이지가 사용하는 캐시 공간의 크기이다.</p>

<p style="text-align: center;"><img alt="" src="https://upload.acmicpc.net/5cc043b7-d7bd-45a4-a53b-ddd65d0e5d00/-/preview/" /></p>