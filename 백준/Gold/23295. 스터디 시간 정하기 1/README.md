...
제출: 1586, 정답: 527, 맞힌 사람: 390, 정답 비율: 31.553%
...
<p>첫째 줄에는 스터디에 참가하고자하는 참가자 수 <em>N</em>과 스터디 시간 <em>T</em>가 주어진다. (1 &le; <em>N</em> &le; 100,000, 1 &le; <em>T</em>  &le; 100,000)</p>
...
<p>각 정보의 두번째 줄부터 <em>K</em>개의 줄에 걸쳐 가능한 시간의 시작 시각 <em>S<sub>i</sub></em>와 끝나는 시각 <em>E<sub>i</sub></em>가 주어진다. 이때 <em>E<sub>i</sub></em> &lt; <em>S<sub>i+1</sub></em> (1 &le; <em>i</em> &lt; <em>K</em>)을 만족한다. (0 &le; <em>S<sub>i</sub></em> &lt; <em>E<sub>i</sub></em> &le; 100,000)</p>
