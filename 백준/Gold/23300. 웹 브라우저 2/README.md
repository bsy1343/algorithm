...
제출: 1366, 정답: 501, 맞힌 사람: 401, 정답 비율: 35.708%
...
<p>첫째 줄에 접속할 수 있는 웹페이지의 종류의 수 <em>N</em>, 사용자가 수행하는 작업의 개수 <em>Q</em>&nbsp;가 각각 주어진다.(1 &le; <em>N, Q</em>&nbsp;&le; 2,000)</p>
