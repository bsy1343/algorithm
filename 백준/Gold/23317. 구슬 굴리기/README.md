...
제출: 441, 정답: 145, 맞힌 사람: 123, 정답 비율: 34.358%
...
<p>첫째 줄에 정수 n(1 &le; n &le; 30)이 주어진다. 둘째 줄에는 정수 m(1 &le; m &le; 50)이 주어진다. 다음 m개의 줄에는 공간의 위치를 나타내는 행 번호와, 그 행에서의 공간의 번호가 주어진다.</p>
