...
제출: 74, 정답: 25, 맞힌 사람: 23, 정답 비율: 38.983%
...
<p>첫째 줄에 두 정수 n(1 &le; n &le; 200), m(0 &le; m &le; n<sup>2</sup>)이 주어진다. m은 같은 연구실에 보관할 수 없는 약품들의 쌍의 개수이다. 다음 m개의 줄에는 두 정수 a, b(1 &le; a, b &le; n)가 주어진다. 이는 A 연구실에 보관되어 있는 a번 약품을 B 연구실의 b번 약품과 함께 보관할 수 없다는 의미이다.</p>
...
<p>첫째 줄에 옮길 수 있는 화학 약품의 최대 종류수를 출력한다.A 연구실의 6, 7, 8번 화학 약품들과 B 연구실의 6, 7, 8번 화학 약품들을 바꾸면 된다. 이 경우는 우연히 두 연구실에 있는 약품의 번호가 같은 것이고, 꼭 번호가 일치해야 할 필요는 없다. 단지 개수만 맞으면 된다.</p>