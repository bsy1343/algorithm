...
제출: 1048, 정답: 497, 맞힌 사람: 385, 정답 비율: 47.767%
...
<section id="hint">
<p>단순 연결 그래프란 다음 조건들을 모두 만족하는 그래프를 의미한다.</p>

<ul>
	<li>어떤 정점 $u$와 다른 정점 $v$를 잇는 간선 $u-v$는 최대 한 개이다.</li>
	<li>어떤 정점 $u$를 스스로 연결하는 간선 $u-u$는 존재하지 않는다.</li>
	<li>어떤 정점 $u$에서 다른 정점 $v$까지 한 개 이상의 간선을 이용하여 항상 도달할 수 있다.</li>
</ul>