...
제출: 474, 정답: 230, 맞힌 사람: 173, 정답 비율: 54.747%
...
<p>입력의 첫 번째 줄에는 도시의 수 N, 운하의 수 M, 노선의&nbsp;수 K가 주어진다.&nbsp;<span style="line-height:1.6em">(N &le; 1000, M &le; 100000, K &le; 10000)</span></p>

<p>다음 M개의 줄에는 세 정수 i,&nbsp;j, w가 주어지며, 이는 도시 i와 j 사이에 폭이 w인 운하를 건설할 것임을 의미한다. (1 &le; i, j &le; N, w &le; 200)</p>

<p>다음 K개의 줄에는 각 노선이 연결하는&nbsp;도시&nbsp;i, j가 주어진다. (1 &le; i, j &le;N)</p>
