...
제출: 2066, 정답: 412, 맞힌 사람: 275, 정답 비율: 18.419%
...
<p>주어지는 문자열 $S$의 길이는 $4 &le; \lvert S\rvert&nbsp;&le; 100,000$ 이고, 문자열에&nbsp;포함된&nbsp;수는 $1$ 이상 $1,000,000$ 이하이다.</p>
...
<p>정답 및 계산 과정 중에 나오는&nbsp;수의 절댓값은 모두 $10^{15}$보다 작다.</p>