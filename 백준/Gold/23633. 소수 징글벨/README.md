...
제출: 273, 정답: 104, 맞힌 사람: 85, 정답 비율: 45.213%
...
<p>첫 번째 줄에 테스트 케이스의 개수를 나타내는 정수&nbsp;$T(1 &le;&nbsp;T &le;&nbsp;10)$가 주어진다.</p>

<p>두 번째 줄부터 한 테스트 케이스당 한 줄씩&nbsp;정수 $A(1 &le;&nbsp;A &le;&nbsp;2,000)$, $B(A &le;&nbsp;B &le;&nbsp;2,000)$가 공백으로 구분되어 주어진다.</p>
