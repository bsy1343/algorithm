...
제출: 2209, 정답: 695, 맞힌 사람: 544, 정답 비율: 30.122%
...
<p>첫째 줄에 정점의 수 <em>N</em>&nbsp;(1 &le; <em>N</em> &le; 100,000), 간선의 수 <em>M</em>&nbsp;(1 &le; <em>M</em> &le; 200,000)이&nbsp;주어진다.</p>

<p>다음 <em>M</em>개 줄에 간선 정보 <code>u v w</code>가 주어지며&nbsp;도시 u에서 도시 v로 가중치가 w인 단방향 도로를 나타낸다. (1 &le; u, v &le;&nbsp;<em>N</em>, u &ne; v, 1 &le; w &le; 10,000, w는 정수) 모든 간선의 (u, v) 쌍의 값은 서로 다르다.</p>

<p>다음 줄에 <code>X Y Z</code>가 주어진다. (1 &le; X, Y, Z &le;&nbsp;<em>N</em>, X &ne; Y, X &ne; Z, Y &ne; Z)</p>
