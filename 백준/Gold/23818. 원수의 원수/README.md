...
제출: 322, 정답: 133, 맞힌 사람: 105, 정답 비율: 42.339%

### 분류

자료 구조, 그래프 이론, 그래프 탐색, 깊이 우선 탐색, 분리 집합, 이분 그래프
...
<p>두번째 예제의 경우,&nbsp;1과&nbsp;2는 직접적으로 원수 관계이지만, 1과 3 그리고 2와 3이 친구 관계이므로 간접적으로 친구 관계이다.&nbsp;따라서 1과 2는 원수 관계이면서도 친구 관계가 되어 Error가 된다.</p>