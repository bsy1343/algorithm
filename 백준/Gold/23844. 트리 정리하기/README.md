...
제출: 436, 정답: 200, 맞힌 사람: 154, 정답 비율: 44.767%
...
<p>첫째 줄에 정점의 개수 <em>N</em>과 레벨 당&nbsp;남길 수 있는 노드의 개수 <em>K</em>가 주어진다. (1 &le; <em>N&nbsp;</em>&le; 10,000, 1 &le; <em>K</em> &le; <em>N</em>)&nbsp;</p>

<p>다음 <em>N</em>-1개의 줄에 걸쳐, 두 정수 <em>a</em><sub><em>i</em>,</sub>&nbsp;<em>b<sub>i</sub></em> 가 주어진다. 이는 <em>a<sub>i</sub></em>번 노드와 <em>b<sub>i</sub></em>번 노드가 간선으로 연결되어 있다는 의미이다. (1 &le; <em>a<sub>i</sub></em>, <em>b<sub>i</sub></em> &le; <em>N</em>, <em>a<sub>i</sub></em> &ne; <em>b<sub>i</sub></em>)&nbsp;</p>
