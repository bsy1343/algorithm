...
제출: 786, 정답: 221, 맞힌 사람: 166, 정답 비율: 30.292%
...
<p>등비수열의 합을 나타내는 정수&nbsp;<em>N</em>이 주어진다. (1 &le; <em>N</em> &le; 10<sup>12</sup>)</p>

### 출력

<p>문제의 조건을 만족하는 등비수열이 존재하는 경우,&nbsp;첫째 줄에 항의 개수 <em>K</em>(<em>K</em> &ge; 3)를 출력한다. 둘째 줄에 등비수열을 순서대로 공백으로 구분하여&nbsp;출력한다.</p>

<p>조건을 만족하는 등비수열이 존재하지 않는 경우 -1을 출력한다.</p>

### 제한

<p>등비수열에서 모든 항은 양의 정수이고, 공비는 1보다 큰 양의 정수이다.</p>