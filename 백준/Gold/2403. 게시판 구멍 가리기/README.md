...
제출: 337, 정답: 71, 맞힌 사람: 60, 정답 비율: 27.523%
...
<p>첫째 줄에는 구멍의 개수인 n이 주어지고 (1 &le; n &le; 1000), 다음 n개의 줄에는 구멍의 위치로 x 좌표와 y 좌표가 주어진다. 입력으로 주어지는 좌표의 값은 절댓값이 30,000보다 작거나 같은 정수이다.</p>
