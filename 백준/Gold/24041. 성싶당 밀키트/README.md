...
제출: 3371, 정답: 864, 맞힌 사람: 592, 정답 비율: 22.955%
...
<ul>
	...
	<li>$1 \le G \le 10^9$</li>
	<li>$0 \le K &lt; N$</li>
	<li>$1 \le S_i \le 10^9$</li>
	<li>$1 \le L_i \le 10^9$</li>
	<li>$O_i \in \left\{0,1\right\}$</li>
	<li>모든 재료의 $S_i$의 합은 $G$를 넘지 않는다. ($\sum_{1 \le i \le n} S_i \le G$)</li>
