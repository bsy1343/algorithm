...
<p>入力は (D+1)行のファイルであり，最初の行には店舗数 N とショッ ピングをする日数 D が空白で区切って書かれている．ただし， 2 &le; N &le; 3, 000, 2 &le; D &le; 365 である．</p>

<p>続く D 行にはそれぞれ N 個の 10 以上 100, 000 以下の 10 の倍数が書かれている．これらの 数は金額を表わしていて各行に，1 日分ずつ日を追って，店舗番号の順に各店舗の割引き前の予 定価格が書かれている．つまり, 1 &le; d &le; D, 1 &le; n &le; N のとき, (d + 1) 行目の n 番目の数は第 d 日に店舗番号 n の店舗の金額で割引き無しで購入した場合の予定価格である．</p>
