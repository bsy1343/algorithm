...
제출: 937, 정답: 296, 맞힌 사람: 226, 정답 비율: 34.191%
...
<ul>
	...
	<li>$K \le 10^9$</li>
	<li>$1 \le S_i$ $(1 \le i \le N)$</li>
	<li>$S_1 + S_2 + \cdots + S_N \le K$</li>
</ul>