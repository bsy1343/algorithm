...
제출: 259, 정답: 68, 맞힌 사람: 39, 정답 비율: 23.926%
...
<ul>
	<li>1 &le; <em>O </em>&le; 2 &times; 10<sup>5</sup></li>
	<li>1 &le; <em>E </em>&le; 2 &times; 10<sup>5</sup></li>
	<li>객체 id가&nbsp;<code>object_id</code>인 객체가 생성된 상태에서 id가 <code>object_id</code>인 객체를&nbsp;생성하는 연산은&nbsp;주어지지 않습니다.</li>
	<li>연결 번호 <code>ref_id</code>인 연결 관계가 생성된 상태에서 연결 번호가 <code>ref_id</code>인 연결 관계를 생성하는 연산은&nbsp;주어지지 않습니다.</li>
	<li>연결 번호 <code>ref_id</code>인 연결 관계가 없는&nbsp;상태에서 연결 번호가 <code>ref_id</code>인 연결 관계를 삭제하는 연산은&nbsp;주어지지 않습니다.</li>
	<li><code>object_id_1</code>과 <code>object_id_2</code>를 연결하는 연결 관계를 추가할 때 객체 고유 번호가 <code>object_id_1</code>인 object와 고유 번호가 <code>object_id_2</code>인 object는 항상 존재합니다.&nbsp;</li>
	<li>1 &le; 연산&nbsp;M과 m을&nbsp;하는&nbsp;횟수의 총합&nbsp;&le; 20</li>
	<li><code>object_id</code>와 <code>ref_id</code>는 1 이상 10<sup>9</sup>&nbsp;이하 정수입니다.</li>
	<li>놀이가 시작되기 전 생성 되어 있는 <em>O</em>개의 객체&nbsp;고유 번호는 <strong>중복되지 않습니다.&nbsp;</strong></li>
</ul>

### 힌트

<p>root가 없는 경우가 있거나, 자신이 자신을 가리키는 self-loop가 있는 경우도 있음을 조심하세요.</p>