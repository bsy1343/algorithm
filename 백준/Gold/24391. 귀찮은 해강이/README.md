...
제출: 2502, 정답: 1251, 맞힌 사람: 1077, 정답 비율: 51.067%
...
<p>첫째 줄에 강의의 개수 <em>N</em>(1 &le; <em>N</em> &le; 10<sup>5</sup>)과 연결되어 있는 건물의 쌍의 개수 <em>M</em>(0 &le; <em>M</em> &le; 10<sup>5</sup>)이 공백으로 구분되어 주어진다.</p>

<p>두 번째 줄부터는 <em>M</em>줄에 걸쳐 <em>i</em>와 <em>j</em>(1 &le; <em>i</em>, <em>j</em> &le; <em>N</em>)가 주어진다. 이는 <em>i</em>번 건물과 <em>j</em>번 건물이 연결되어 있다는 의미이다. 건물이 자기 자신과 연결되거나, 이미 연결된 건물의 쌍이 다시 주어지는 경우는 없다.</p>

<p>마지막 줄에는 <em>N</em>개의 강의코드 <em>A<sub>i</sub></em>(1 &le; <em>A<sub>i</sub></em> &le; <em>N</em>)로 이루어진 강의 시간표가 공백으로 구분되어 주어진다.</p>
