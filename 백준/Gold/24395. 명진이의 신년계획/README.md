...
제출: 362, 정답: 135, 맞힌 사람: 106, 정답 비율: 39.114%
...
<p>첫째 줄에 <em>N&nbsp;</em>(1 &le; <em>N</em> &le; 100,000), <em>M&nbsp;</em>(1 &le; <em>M</em> &le; 100)이 공백을 두고 주어진다.</p>

<p>둘째 줄부터 <em>M</em>개의 줄에 걸쳐 <em>M</em>개의 질병에 처방할 빨강, 파랑 알약의 수 <em>R<sub>i&nbsp;</sub></em>, <em>B<sub>i&nbsp;</sub></em>(0 &le;&nbsp;<em>R<sub>i&nbsp;</sub></em>, <em>B<sub>i</sub></em> &le; 50,&nbsp;<em>R<sub>i&nbsp;</sub></em>+&nbsp;<em>B<sub>i</sub></em> &ge; 1)와 위험도 <em>D<sub>i&nbsp;</sub></em>(0 &le;&nbsp;<em>D<sub>i</sub></em> &le; 100)가 공백을 두고 주어진다.</p>

<p><em>M</em>+2번째 줄부터 <em>N&nbsp;</em>개의 줄에 걸쳐 <em>N&nbsp;</em>명의 학생이 처방받은 빨강, 파랑 알약의 수 <em>R&#39;<sub>i&nbsp;</sub></em>,&nbsp;<em>B&#39;<sub>i&nbsp;</sub></em>(0 &le;&nbsp;<em>R&#39;<sub>i&nbsp;</sub></em>, <em>B&#39;<sub>i</sub></em> &le; 50,&nbsp;<em>R&#39;<sub>i&nbsp;</sub></em>+&nbsp;<em>B&#39;<sub>i</sub></em>&nbsp; &ge;&nbsp;1)가 공백을 두고 주어진다.</p>
