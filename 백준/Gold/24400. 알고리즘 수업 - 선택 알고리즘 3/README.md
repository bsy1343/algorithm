...
제출: 359, 정답: 67, 맞힌 사람: 59, 정답 비율: 26.818%
...
<p>첫째 줄에 배열 A, B의 크기&nbsp;<em>N</em>(5&nbsp;&le;&nbsp;<em>N</em>&nbsp;&le; 10,000), 찾을 원소 정보&nbsp;<em>Q</em>(1 &le;&nbsp;<em>Q</em>&nbsp;&le;&nbsp;<em>N</em>)가&nbsp;주어진다.</p>
...
<p>다음&nbsp;줄에 서로 다른 배열 B의 원소 <em>B<sub>1</sub></em>, <em>B<sub>2</sub></em>, ... , <em>B<sub>N</sub></em>이 주어진다.&nbsp;(1&nbsp;&le; <em>B<sub>i</sub></em>&nbsp;&le; 10<sup>9</sup>)</p>
