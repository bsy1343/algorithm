...
제출: 26986, 정답: 7848, 맞힌 사람: 5468, 정답 비율: 28.594%
...
<p>첫째 줄에는 꽃들의 총 개수 N (1 &le; N &le; 100,000)이 주어진다. 다음 N개의 줄에는 각 꽃이 피는 날짜와 지는 날짜가 주어진다. 하나의 날짜는 월과 일을 나타내는 두 숫자로 표현된다. 예를 들어서, 3 8 7 31은 꽃이 3월 8일에 피어서 7월 31일에 진다는 것을 나타낸다.&nbsp;</p>
