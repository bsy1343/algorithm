...
제출: 72, 정답: 21, 맞힌 사람: 20, 정답 비율: 32.258%
...
<p>The first line of input has a single string p giving the puzzle word (1 &le; |p| &le; 10<sup>5</sup>). The second line has a single string s giving the letter sequence that Anna typed (1 &le; |s| &le; min(50, |p|)). Both strings contain only lowercase English letters.</p>
