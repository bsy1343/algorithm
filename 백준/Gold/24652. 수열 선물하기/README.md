...
제출: 155, 정답: 71, 맞힌 사람: 43, 정답 비율: 60.563%
...
<p>첫째 줄에 양의 정수 <em>N</em>과 <em>K</em>가 주어진다. (1 &le; <em>K</em> &le; <em>N</em> &le; 1,000,000)</p>
...
<p>이 문제에서 이진 탐색이 위와 같이 정의된 이유는 하이비가 저 방식으로 이진 탐색을 구현하기 때문이다.</p>