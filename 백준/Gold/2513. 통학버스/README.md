...
제출: 3168, 정답: 1289, 맞힌 사람: 1029, 정답 비율: 41.242%
...
<p style="text-align: center;"><img alt="" src="%EB%B0%B1%EC%A4%80/Gold/2513.%E2%80%85%ED%86%B5%ED%95%99%EB%B2%84%EC%8A%A4/b6ee68a6.png" data-original-src="%EB%B0%B1%EC%A4%80/Gold/2513.%E2%80%85%ED%86%B5%ED%95%99%EB%B2%84%EC%8A%A4/b6ee68a6.png" data-original-src="https://upload.acmicpc.net/636f2f28-7c2e-45fc-8fdb-010db25c8a4d/-/preview/" onerror="this.onerror=null;this.src=this.dataset.originalSrc" style="width: 337px; height: 126px;" /></p>
...
<p>첫째 줄에는 세 개의 양의 정수 N, K, S가 빈칸을 사이에 두고 순서대로 주어진다. 첫 번째 정수 N은 아파트 단지의 수이며 2 &le; N &le; 30,000이다. 두 번째 정수 K는 1 &le; K &le; 2,000이며, 통학버스의 정원이다. 세 번째 정수 S는 학교의 위치를 나타낸다. 둘째 줄부터 N+1번째 줄에는 각 아파트 단지의 위치를 나타내는 정수와 이 단지에 사는 학생 수를 나타내는 정수가 빈칸을 사이에 두고 주어진다. 학교와 아파트 단지의 좌표는 0 이상 100,000 이하이며, 이 좌표들은 모두 서로 다르다. 각 아파트 단지의 학생 수는 1 이상 2,000 이하이다.&nbsp;</p>
