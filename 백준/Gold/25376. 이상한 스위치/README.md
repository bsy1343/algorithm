...
제출: 531, 정답: 175, 맞힌 사람: 133, 정답 비율: 32.282%
...
<ul>
	<li>$3 \leq N \leq 20$</li>
	<li>$A_i=0$ 또는 $A_i = 1$</li>
	<li>$0 \leq C_i \lt N$</li>
	<li>$1 \leq j \leq C_i$인 모든 $j$에 대해서, $1 \leq B_{i,j} \leq N$, $B_{i,j} \neq i$를 만족하고, 배열 $B_i$ 내의 값은 모두 다르다.</li>
