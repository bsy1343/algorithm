...
제출: 376, 정답: 129, 맞힌 사람: 115, 정답 비율: 33.237%
...
<ul>
	...
	<li>모든 2 &le; <em>i</em> &le; <em>n</em>에 대해 함수 <em>f</em><sub><em>i</em></sub> : <em>W</em><sub><em>i</em></sub> &rarr; ℝ을
	...
	<li>현서는 <em>f</em><sub><em>i</em></sub>(<em>w</em>) &le; <em>T</em>인 <em>w</em> &isin; <em>W</em><sub><em>i</em></sub>가 존재하는 정점만을 고려하려고 한다.</li>
</ul>
...
<p>첫째 줄에 정점의 개수 <em>N</em>과 간선의 개수 <em>M</em>이 주어진다. (1 &le; <em>N</em>, <em>M</em> &le; 200&thinsp;000)</p>

<p>둘째 줄부터 <em>M</em>개의 줄에 걸쳐 각 간선이 잇는 두 정점의 번호 <em>u</em><sub><em>i</em></sub>와 <em>v</em><sub><em>i</em></sub>, 그리고 정수 <em>a</em><sub><em>i</em></sub>와 <em>b</em><sub><em>i</em></sub>가 공백으로 구분되어 주어진다. (1 &le; <em>u</em><sub><em>i</em></sub>, <em>v</em><sub><em>i</em></sub> &le; <em>N</em>; <em>u</em><sub><em>i</em></sub> &ne; <em>v</em><sub><em>i</em></sub>; &minus;10<sup>9</sup> &le; <em>a</em><sub><em>i</em></sub>, <em>b</em><sub><em>i</em></sub> &le; 10<sup>9</sup>) 같은 정점 쌍을 두 번 잇는 입력은 주어지지 않는다. 즉, 모든 1 &le; <em>i</em>, <em>j</em> &le; <em>M</em>에 대해 {<em>u</em><sub><em>i</em></sub>, <em>v</em><sub><em>i</em></sub>} = {<em>u</em><sub><em>j</em></sub>, <em>v</em><sub><em>j</em></sub>}이면 <em>i</em> = <em>j</em>이다.</p>

<p>(<em>M</em> + 2)째 줄에 정수 <em>T</em>가 주어진다. (&minus;2 &times; 10<sup>15</sup> &le; <em>T</em> &le; 2 &times; 10<sup>15</sup>)</p>
...
<p>첫 번째 예제에서, 2번 정점의 경우 2 &rarr; 3 &rarr; 1 순으로 이동하면 기댓값이 4분이 된다. 3번 정점의 경우 3 &rarr; 1 순으로 이동하면 기댓값이 2<em>.</em>5분이 된다.</p>

<p>세 번째 예제에서 주어지듯이, 학교에서 도달할 수 없는 자취방이 같이 주어지는 것도 가능하다.</p>