...
제출: 766, 정답: 113, 맞힌 사람: 80, 정답 비율: 17.937%
...
<ul>
	...
	<li><code>-x</code>: <em>K</em>에서 <em>x</em>를 뺍니다. 단, 이 프로그래밍 언어는 음이 아닌 정수만 처리할 수 있어서, 만일 <em>K</em> &le; <em>x</em>이면 <em>K</em>는 0이 됩니다.</li>
...
<p>첫째 줄에 <em>N</em>과 입력값 <em>K</em><sub>0</sub>가 공백을 사이에 두고 주어집니다. (1 &le; <em>N</em> &le; 300&thinsp;000, 0 &le; <em>K</em><sub>0</sub> &le; 10<sup>9</sup>)</p>
...
<p>가능한 실행 방법 중 하나는 다음과 같습니다.</p>

<ol>
	<li><em>K</em><sub>0</sub> = 15를 입력받고, <em>K</em>를 그 값으로 설정합니다. 따라서 <em>K</em> := <em>K</em><sub>0</sub> = 15가 됩니다.</li>
	<li>각 줄에서 연산을 하나씩 고르는데, 구체적으로 첫째 줄에서는 <code>+10</code>, 둘째 줄에서는 <code>-20</code>, 셋째 줄에서는 <code>*20</code>을 고릅니다.</li>
	<li>각 연산을 순서대로 시행하면, 첫째 줄 시행 이후 <em>K</em> := 15 + 10 = 25, 둘째 줄 시행 이후 <em>K</em> := 25 &minus; 20 = 5, 셋째 줄 시행 이후 <em>K</em> := 5 &times; 20 = 100이 됩니다.</li>
	<li>100을 출력합니다.</li>
</ol>

<p>이렇게 실행하는 방법이 다른 방법에 비해 가장 큰 값을 출력함을 알 수 있습니다. 가장 큰 출력값인 100을 10<sup>9</sup> + 7로 나눈 나머지인 100을 출력합니다.</p>