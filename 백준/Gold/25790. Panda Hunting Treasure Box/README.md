...
<p><img alt="" src="https://upload.acmicpc.net/6d7093ea-b895-4e95-9ca5-b51d28e08d2d/-/preview/" style="width: 166px; height: 123px; float: right;" />Panda starts with some energy. The picture to the right shows the energy needed for Panda to move into any of the eight neighboring cells (note that the boundary cells in the maze have fewer than eight neighbors).</p>
