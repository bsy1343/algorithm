...
제출: 230, 정답: 138, 맞힌 사람: 117, 정답 비율: 60.309%
...
<ul>
	<li>1 &le; 학생끼리 메시지를 전달하는 데 걸리는 시간 &le; 1,000</li>
	<li>학생 i가 학생 j에게 메시지를 전달하는 데 걸리는 시간과 학생 j가 학생 i에게 메시지를 전달하는 데 걸리는 시간은 같다. (1 &le; i, j &le; 12, i &ne; j)</li>
	<li>선생님은 모든 학생에게 메시지를 전달할 수 있다.</li>
