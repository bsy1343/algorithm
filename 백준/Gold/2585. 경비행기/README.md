...
제출: 4326, 정답: 1600, 맞힌 사람: 1098, 정답 비율: 34.615%
...
<p style="text-align: center;"><img alt="" src="%EB%B0%B1%EC%A4%80/Gold/2585.%E2%80%85%EA%B2%BD%EB%B9%84%ED%96%89%EA%B8%B0/efda17c0.png" data-original-src="%EB%B0%B1%EC%A4%80/Gold/2585.%E2%80%85%EA%B2%BD%EB%B9%84%ED%96%89%EA%B8%B0/efda17c0.png" data-original-src="https://upload.acmicpc.net/74546cce-0762-4546-b2b9-aee04a54f1f2/-/preview/" onerror="this.onerror=null;this.src=this.dataset.originalSrc" style="width: 224px; height: 220px;" /></p>
...
<ol style="list-style-type:lower-alpha">
	...
	<li>두 위치간의 거리는 평면상의 거리이다. 예를 들면, 두 점 g=(2,1)와 h=(37,43)간의 거리 d(g,h)는 \(\sqrt{(2-37)^2 + (1-43)^2}\)&nbsp;= 54.671... 이고 50＜d(g,h) &le; 60이므로 필요한 연료는 6ℓ가 된다.</li>
	<li>출발지 S의 좌표는 항상 (0,0)이고 목적지 T의 좌표는 (10000,10000)으로 모든 입력 데이터에서 고정되어 있다.</li>
	<li>출발지와 목적지를 제외한 비행장의 수 n은 3 &le; n &le; 1000이고 그 좌표 값 (x,y)의 범위는 0＜x,y＜10000의 정수이다. 그리고 최대 허용 중간급유 횟수 k는 0 &le; k &le; 1000이다.</li>
</ol>
