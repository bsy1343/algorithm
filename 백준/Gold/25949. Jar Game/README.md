...
제출: 453, 정답: 233, 맞힌 사람: 190, 정답 비율: 53.521%
...
<p>Your program is to read from standard input. The input starts with a line containing three integers, $a$, $b$ and $c$ ($1 &le; a, b, c &le; 100$) denoting the number of pebbles in three jars at the beginning.</p>
