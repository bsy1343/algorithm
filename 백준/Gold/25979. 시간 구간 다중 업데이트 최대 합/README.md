...
시간 제한: 0.4 초, 메모리 제한: 512 MB

### 통계

제출: 275, 정답: 115, 맞힌 사람: 76, 정답 비율: 35.185%
...
<ul>
	...
	<li>00 &le; <em>h</em>1, <em>h</em>2 &le; 23</li>
	<li>00 &le; <em>m</em>1, <em>s</em>1, <em>m</em>2, <em>s</em>2 &le; 59</li>
	<li>00:00:00 &le; <em>h</em>1:<em>m</em>1:<em>s</em>1 &lt; <em>h</em>2:<em>m</em>2:<em>s</em>2 &le; 23:59:59</li>
	<li><em>h</em>1, <em>m</em>1, <em>s</em>1, <em>h</em>2, <em>m</em>2, <em>s</em>2는 모두 길이가 2인 문자열이다.</li>
	<li>배열 <em>A</em>에는 유형 2의 질의가 마지막에 1개 저장되어 있다.</li>
	<li>유형 2의 질의에서 시간 구간의 길이는 양의 정수이다.</li>
</ul>