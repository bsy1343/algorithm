...
제출: 242, 정답: 61, 맞힌 사람: 53, 정답 비율: 28.804%
...
<p>윤이는 UNIST 주변의 음식점에 대한 정보를 제공하는 가이드 앱, 일명 &ldquo;UNIST 가이드&rdquo;를 만들기로 했다. 윤이는 근처 음식점 중에서 $N$개의 음식점을 추천하기로 정하고, 음식점에 $1$번부터 $N$번까지 번호를 붙였다.</p>
