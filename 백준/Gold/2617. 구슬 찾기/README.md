...
제출: 12973, 정답: 4750, 맞힌 사람: 3591, 정답 비율: 36.357%
...
<p>첫 줄은 구슬의 개수를 나타내는 정수 N(1 &le; N &le; 99)과 저울에 올려 본 쌍의 개수 M(1 &le; M &le; N(N-1)/2)이 주어진다. 그 다음 M 개의 줄은 각 줄마다 두 개의 구슬 번호가 주어지는데, 앞 번호의 구슬이 뒤 번호의 구슬보다 무겁다는 것을 뜻한다.</p>
