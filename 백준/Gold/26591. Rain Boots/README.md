...
제출: 59, 정답: 47, 맞힌 사람: 28, 정답 비율: 80.000%
...
<ul>
	<li>&lsquo;M&rsquo; &ndash; Muddy Puddle</li>
	<li>&lsquo;-&rsquo; &ndash; No Mud</li>
	<li>&lsquo;S&rsquo; &ndash; Start (No Mud)</li>
	<li>&lsquo;E&rsquo; &ndash; End (No Mud)</li>
</ul>

### 입력

<p>There will be an unknown number of inputs. Each input will contain an 8 by 8 grid that represents the area nearby. There will be a single line containing a single &lsquo;-&lsquo; separating each input.</p>
