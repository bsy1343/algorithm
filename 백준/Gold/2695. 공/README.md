...
제출: 364, 정답: 220, 맞힌 사람: 178, 정답 비율: 68.199%
...
<p>첫째 줄은 데이터 세트 수 P(1 &le; P &le; 1000)가 입력으로 들어온다. 각각의 데이터 세트는 한 줄로 구성되어 있으며 2개의 숫자가 공백으로 구분되어 있다. 유리공의 개수 B(1 &le; B &le; 50), 건물의 층 수 M(1 &le; M &le; 1000)</p>
