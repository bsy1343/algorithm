...
제출: 111, 정답: 38, 맞힌 사람: 34, 정답 비율: 33.663%
...
<p>Bessie has a map of of the forest, which is partitioned into a square grid arrayed in the usual manner, with axes parallel to the X and Y axes. The map is W x H units in size (1 &le; W &le; 1000; 1 &le; H &le; 1000).</p>
