...
제출: 536, 정답: 241, 맞힌 사람: 180, 정답 비율: 40.909%
...
<ul>
	...
	<li>$2\leq C \leq 16$</li>
	<li>$1\leq A_i \leq C$ ($1 \leq i \leq N$)</li>
	<li>$1\leq B_i \leq C$ ($1 \leq i \leq M$)</li>
	<li>$1\leq W[i][j] \leq 1000000000$ ($1 \leq i, j \leq C$)</li>
	<li>$W[i][j] = W[j][i]$ ($1 \leq i, j \leq C$)</li>
</ul>