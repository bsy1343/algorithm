...
제출: 202, 정답: 130, 맞힌 사람: 113, 정답 비율: 68.485%
...
<p>
	한국 최고의 자물쇠 회사 마선영은 도어락을 생산한다. 이 도어락은 B(1 &le; B &le; 11)개의 버튼으로 이루어졌으며 각 버튼은 &#39;1&#39;부터 &#39;B&#39;까지 이름 붙여 있다. 도어락은 버튼 조합으로 이뤄진 비밀번호를 올바른 순서로 누른 후 손잡이를 돌리면 마법처럼-_- 열린다</p>
...
<p>
	첫 줄은 도어락 개수인 정수 N(1 &le; N &le; 100)이 주어진다. 다음 줄부터 N개의 도어락 버튼의 개수 B가 주어진다.</p>
