...
제출: 198, 정답: 127, 맞힌 사람: 105, 정답 비율: 65.625%
...
<p>JOI-kun has $N$ go stones. The stones are numbered from $1$ to $N$. The color of each stone is an integer between $1$ and $10^9$, inclusive. In the beginning, the color of Stone $i$ ($1 &le; i &le; N$) is $A_i$.</p>

<p>From now, JOI-kun will perform $N$ operations. He will put the stones on the table in a line. The operation $i$ ($1 &le; i &le; N$) will be performed as follows:</p>
...
<p>Write $N$ lines to the standard output. The $i$-th line ($1 &le; i &le; N$) should contain the color of Stone $i$ after the $N$ operations are performed.</p>
