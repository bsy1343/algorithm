# [Gold IV] Greatest number (Easy) - 27666

[문제 링크](https://www.acmicpc.net/problem/27666)
...
<ul>
	<li>Any nonnegative integer is a valid expression, as long as it doesn&rsquo;t have unnecessary leading zeros.</li>
...
<p>Note that the definition allows multiple unary pluses and minuses to follow each other. For example, <code>1*(2+3*-+-4)</code> is a valid expression that is evaluated as follows: &minus; + &minus;4 is 4, 3 &times; 4 is 12, 2 + 12 is 14, and 1 &times; 14 is 14.</p>
...
<ul>
	<li><em>t</em> = 100</li>
	<li>The length of each expression is between 1 and 16, inclusive.</li>
</ul>