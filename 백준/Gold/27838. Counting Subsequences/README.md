...
제출: 36, 정답: 21, 맞힌 사람: 18, 정답 비율: 66.667%
...
<p>The first line of each test case contains the length of a sequence <b>N</b>. The second line contains <b>N</b> space-separated integers <strong>A<sub>i</sub></strong> &ndash; the elements of the sequence.</p>

### 출력

<p>For each test case output a single line containing a single integer &ndash; the count of interesting subsequences of the given sentence.</p>

### 힌트

<ul>
	<li>1 &le; <b>T</b> &le; 7</li>
</ul>