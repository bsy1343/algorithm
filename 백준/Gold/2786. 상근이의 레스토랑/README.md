...
제출: 1314, 정답: 362, 맞힌 사람: 265, 정답 비율: 33.250%
...
<p>첫째 줄에 상근이네 레스토랑의 음식의 개수 N(2 &le; N &le; 500,000)이 주어진다. 다음 N개의 줄에는 각 음식의 가격 A<sub>i</sub>와 B<sub>i</sub>가 주어진다. (0 &le; A<sub>i</sub>, B<sub>i</sub> &le; 1,000,000,000)</p>
