...
제출: 1007, 정답: 298, 맞힌 사람: 248, 정답 비율: 29.772%
...
<p>changwook987은 레드스톤 회로 블록들을 이용해 $W&times;H$ 크기의 사각형 맵에 회로를 만들었다. 회로 블록에는 레드스톤 가루, 레드스톤 블록, 레드스톤 램프가 있다.</p>
...
<p>둘째 줄에는 회로 블록의 개수 $N$이 정수로 주어진다. $(1 \le N \le W&times;H)$</p>
