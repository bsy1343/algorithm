...
제출: 408, 정답: 140, 맞힌 사람: 108, 정답 비율: 36.986%
...
<p>사주의 일주는 태어난 날에 해당하는 간지를 의미한다. 간지는 &ldquo;갑을병정무기경신임계&rdquo;의 10종류의 천간과 &ldquo;자축인묘진사오미신유술해&rdquo;의 12종류의 지지의 조합으로 구성되며 &ldquo;갑자&rdquo;, &ldquo;을축&rdquo;, &ldquo;병인&rdquo;, ... , &ldquo;계해&rdquo;의 총 60종류가 있다. 편의상 천간의 갑부터 계까지를 각각 $0$부터 $9$까지의 정수로, 지지의 자부터 해까지를 각각 &lsquo;<span style="color:#e74c3c;"><code>A</code></span>&rsquo;부터 &lsquo;<span style="color:#e74c3c;"><code>L</code></span>&rsquo;까지의 알파벳 대문자로 표현하자. 예를 들어 &ldquo;갑자&rdquo;는 &ldquo;<span style="color:#e74c3c;"><code>0A</code></span>&rdquo;, &ldquo;계해&rdquo;는 &ldquo;<span style="color:#e74c3c;"><code>9L</code></span>&rdquo;로 표현한다.</p>
