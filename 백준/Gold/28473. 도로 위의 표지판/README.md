...
제출: 348, 정답: 198, 맞힌 사람: 168, 정답 비율: 54.902%
...
<p>숫자가 적힌 표지판이 흥미로웠던 우현이는 도로를 지날 때마다 그 숫자를 핸드폰에 적어 두려고 한다. 핸드폰에 숫자를 적을 때는 커서를 원하는 곳에 두고 적을 수 있다. 즉, 현재 &ldquo;<span style="color:#e74c3c;"><code>321</code></span>&rdquo;을 써 두었고 표지판에 &lsquo;<span style="color:#e74c3c;"><code>4</code></span>&rsquo;가 써 있는 도로를 지났다면 &ldquo;<span style="color:#e74c3c;"><code>3421</code></span>&rdquo;, &ldquo;<span style="color:#e74c3c;"><code>3214</code></span>&rdquo; 등의 수를 만들 수 있다. 그러나 이미 지난 적이 있는 도로의 표지판 숫자는 다시 적지 않기로 했다.</p>
