# [Gold II] Операция <<Перестановка>> - 28956

[문제 링크](https://www.acmicpc.net/problem/28956)
...
<p>В первом примере солдаты стояли в порядке $(5, 2, 1, 3, 4)$. Уже после четвёртой пары чисел, запомненной адъютантом, можно восстановить этот порядок.</p>

<p>Во втором примере существует четыре варианта расстановки солдат, удовлетворяющих входным данным: $(1, 3, 4, 2)$, $(2, 3, 4, 1)$, $(3, 2, 4, 1)$ и $(4, 2, 3, 1)$.</p>