...
제출: 4926, 정답: 1764, 맞힌 사람: 1238, 정답 비율: 33.271%
...
<p>두 수 A와 B를 고르고, A를 나눌 수 있는 소수 X를 고른다. 그 다음, A를 지우고 A/X를 쓰고, B를 지우고 B&times;X를 쓴다.</p>
...
<p>첫째 줄에 N이 주어진다. (1 &le; N &le; 100) 둘째 줄에는 종이에 적혀있는 수 N개가 주어진다. 수는 모두 1,000,000보다 작거나 같은 양의 정수이다.</p>
