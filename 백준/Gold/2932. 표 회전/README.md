...
제출: 499, 정답: 175, 맞힌 사람: 135, 정답 비율: 39.244%
...
<p>상근이는 N&times;N 표를 만들었다. 표에는 1부터 N<sup>2</sup>까지의 수가 행 우선 순서(row-major order)에 따라 쓰여져 있다. 표가 수행할 수 있는 연산은 아래와 같이 두 가지이다.</p>
...
<p>첫째 줄에 표의 크기 N(2 &le; N &le; 10000)과 이동시키려고 하는 숫자의 수 K(1 &le; K &le; 1000)이 주어진다.</p>

<p>다음 K개 줄에는 이동시키려고 하는 숫자 X와 위치 R, C가 주어진다. (1 &le; X &le; N<sup>2</sup>, 1 &le; R,C &le; N)</p>
