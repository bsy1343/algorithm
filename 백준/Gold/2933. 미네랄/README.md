...
제출: 17279, 정답: 5079, 맞힌 사람: 3435, 정답 비율: 27.251%
...
<p>동굴은 R행 C열로 나타낼 수 있으며, R&times;C칸으로 이루어져 있다. 각 칸은 비어있거나 미네랄을 포함하고 있으며, 네 방향 중 하나로 인접한 미네랄이 포함된 두 칸은 같은 클러스터이다.</p>
...
<p>첫째 줄에 동굴의 크기 R과 C가 주어진다. (1 &le; R,C &le; 100)</p>

<p>다음 R개 줄에는 C개의 문자가 주어지며, &#39;.&#39;는 빈 칸, &#39;x&#39;는 미네랄을 나타낸다.</p>

<p>다음 줄에는 막대를 던진 횟수 N이 주어진다. (1 &le; N &le; 100)</p>
