...
제출: 268, 정답: 153, 맞힌 사람: 131, 정답 비율: 54.132%
...
<p>첫째 줄에 보드판의 한 변의 길이 N과 그 위의 블록의 개수 M이 주어진다. (1 &le; N &le; 100, 1 &le; M &le; N<sup>2</sup>)</p>

<p>다음 M개 줄에는 블록이 있는 위치(좌표) R과 C가 주어진다. (1 &le; R, C &le; N)</p>
