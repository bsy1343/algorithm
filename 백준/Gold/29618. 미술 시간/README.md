...
제출: 982, 정답: 314, 맞힌 사람: 235, 정답 비율: 33.862%
...
<p>첫째 줄에 칸의 개수 $N$ ($1&le;N&le;10^5$)과 쿼리의 개수 $Q$ ($1&le;Q&le;10^5$)가 공백으로 구분되어 주어진다. </p>

<p>둘째 줄부터 $Q$개의 줄에는 쿼리가 한 줄에 하나씩 주어진다. ($1&le;a&le;b&le;N;$ $1&le;x&le;10^9$)</p>
