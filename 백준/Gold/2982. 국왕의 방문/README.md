...
제출: 1263, 정답: 540, 맞힌 사람: 421, 정답 비율: 48.840%
...
<p>첫째 줄에 교차로의 수 N과 도로의 수 M이 주어진다. 교차로는 1번부터 N번까지 번호가 매겨져 있다. (2 &le; N &le; 1000, 2 &le; M &le; 10,000)</p>

<p>둘째 줄에는 네 정수 A, B, K, G가 주어진다. (1 &le; A, B &le; N, 0 &le; K &le; 1000, 0 &le; G &le; 1000) A는 상근이가 배달을 시작하는 교차로, B는 상근이가 배달을 마치는 교차로이다. K는 고둘라가 출발한 시간과 상근이가 출발한 시간의 차이, G는 고둘라가 방문하는 교차로의 개수이다.</p>
