...
제출: 53, 정답: 39, 맞힌 사람: 38, 정답 비율: 74.510%

### 분류

수학, 정수론, 소수 판정, 분할 정복을 이용한 거듭제곱, 소인수분해
...
<p>In the first example, $f(10, 1) = g(1, 2) \cdot g(1, 5) = 1$, $f(10, 2) = g(2, 2) \cdot g(2, 5) = 2$.</p>

<p>In the second example, actual value of formula is approximately $1.597 \cdot 10^{171}$. Make sure you print the answer modulo $(10^{9} + 7)$.</p>

<p>In the third example, be careful about overflow issue.</p>