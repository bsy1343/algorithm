...
제출: 159, 정답: 113, 맞힌 사람: 108, 정답 비율: 77.143%
...
<ul>
	...
	<li>$P_i\neq P_j$ if $i\neq j\ (1\le i,j\le N)$</li>
	<li>It is guaranteed that the sum of $N$ over all test cases does not exceed $500\, 000$.</li>
	<li>$1\le S_i\le N-1\ (1\le i\le K)$</li>
</ul>