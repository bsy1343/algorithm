...
제출: 179, 정답: 49, 맞힌 사람: 44, 정답 비율: 34.375%
...
<ul>
<li>$x&le;10^{100000}$</li>
<li>$b&lt;2^{64}$</li>
<li>There is no leading zero if $x&gt;0$.</li>
</ul>