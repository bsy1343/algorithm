...
제출: 912, 정답: 362, 맞힌 사람: 198, 정답 비율: 35.676%
...
<p>Your program is to read from standard input. The input starts with a line containing one integer, $n$ ($1 &le; n &le; 3\,000$), where $n$ is the number of stars. The stars are numbered from $1$ to $n$. In the following $n$ lines, the $i$-th line contains two integers that represent $x$ ($-10^9 &le; x &le; 10^9$) and $y$ ($-10^9 &le; y &le; 10^9$) coordinates of the star $i$, repectively. Note that no two stars are in the same position.</p>
