...
제출: 43, 정답: 41, 맞힌 사람: 33, 정답 비율: 97.059%
...
<p>In the first example test case, no pauses are needed: Kenny can just press the button once.</p>

<p>In the second example test case, Kenny can press, pause, press to set the timer for $2$ minutes.</p>

<p>In the third example test case, Kenny can just press the button twice to set the timer for $3$ minutes.</p>

<p>In the fourth example test case, Kenny can press, press, pause, press to set the timer for $1 + 2 + 1 = 4$ minutes.</p>