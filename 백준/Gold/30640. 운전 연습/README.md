...
제출: 123, 정답: 58, 맞힌 사람: 43, 정답 비율: 47.778%
...
<p>마법사가 장난을 칠 때에는 충전을 할 수 없으며, 순간이동을 통해 다시 만난 충전소에서는 충전을 할 수 있다. 예를 들어 시은이가 3번 충전소에서 마법사를 만나 1번 충전소로 순간이동 하기로 했다면, 0 &rarr; 1 &rarr; 2 &rarr; (마법사의 장난에 의해 3번에서 충전을 하지 못함) &rarr; 1 &rarr; 2 &rarr; 3 &rarr; &hellip; 번 충전소의 순서로 자동차를 충전할 수 있다.</p>
...
<p>총 N줄을 출력해야 하며, i번째 줄에는 두 정수 x<sub>i</sub>와 y<sub>i</sub>를 공백으로 구분하여 출력한다. (1 &le; i &le; N) </p>
...
<ul>
	...
	<li>A<sub>0</sub> = 0</li>
	<li>A<sub>0</sub> &lt; A<sub>1</sub> &lt; A<sub>2</sub> &lt; ... &lt; A<sub>N</sub> &le; 10<sup>12</sup></li>
	<li>1 &le; F<sub>i</sub> &le; 10<sup>6</sup> (0 &le; i &le; N)</li>
	<li>자동차에는 무한히 많은 전기를 충전할 수 있다.</li>
