...
제출: 633, 정답: 328, 맞힌 사람: 254, 정답 비율: 54.506%
...
<p>A basic fraction can be represented by three integers $(a\, b\, c)$ which denotes $a + \frac{b}{c}$ where $1 &le; a, b, c &le; 9$. An extended fraction has the form of $(a&#39;\, b&#39;\, c&#39;)$ where $a&#39;$, $b&#39;$ and $c&#39;$ may be integers between one and nine or other extended fractions. Note that a basic fraction is also an extended fraction, and the length of the fraction is finite.</p>
...
<p>Your program is to read from standard input. The input starts with a line containing one integer $n$ ($2 &le; n &le; 100$), where $n$ is the number of symbols which are parentheses and digits between $1$ and $9$. The second line contains symbols, separated by a space, which represent an extended fraction.</p>
