...
제출: 845, 정답: 432, 맞힌 사람: 328, 정답 비율: 52.396%
...
<p>첫째 줄에 사람의 수 N과 처음 친구 관계의 수 M이 주어진다. (1 &le; N &le; 50, 1 &le; M &le; N*(N-1)/2)</p>

<p>둘째 줄부터 M개의 줄에는 두 정수 A와 B가 주어진다. (1 &le; A &le; N, 1 &le; B &le; N, A &lt; B). 이것은 A와 B가 친구라는 것을 의미한다. 항상 모든 사람이 서로 친구가 될 수 있는 경우만 입력으로 주어진다.</p>
