...
제출: 375, 정답: 195, 맞힌 사람: 79, 정답 비율: 41.361%
...
<p>첫째 줄에 X와 Y가 주어진다. (1 &le; X, Y &le; 1000)</p>

<p>둘째 줄에 스프링쿨러의 수 N이 주어진다. (1 &le; N &le; 10,000)</p>

<p>셋째 줄부터 N개 줄에는 스프링 쿨러의 좌표 x와 y가 주어진다. (0 &le; x &le; X, 0 &le; y &le; Y)</p>

### 출력

<p>스프링쿨러가 물을 뿌릴 수 있는 영역의 넓이를 출력한다. 오차는 &plusmn;0.01까지 허용한다.</p>