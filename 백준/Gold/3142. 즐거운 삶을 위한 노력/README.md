...
제출: 807, 정답: 230, 맞힌 사람: 147, 정답 비율: 26.344%
...
<p>첫 번째 줄에는 이 장치를 이용하는 사람의 수 N(1 &le; N &le; 500 000)이 들어온다.</p>

<p>다음 N개의 줄에는 사람들이 입력한 정수 a<sub>i</sub>(1 &le; a<sub>i</sub> &le; 1 000 000)가 사용하는 순서대로 한 줄에 하나씩 들어온다.</p>
