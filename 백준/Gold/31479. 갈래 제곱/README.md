...
제출: 232, 정답: 60, 맞힌 사람: 48, 정답 비율: 25.131%
...
<p>다익망가는 인테그랄 양의 탄생을 무척이나 좋아하였고, 인테그랄 양의 특성을 분석하기 시작했다. 인테그랄 양은 주변에 보이는 수식을 안아준다. 그리고 이 수식은 기쁨에 겨워 <strong>두 번 적분된다!!</strong> 우리는 이 기쁨에 겨운 수식을 양갈래를 적분한다는 의미로 <strong>양(</strong>$2$<strong>)갈래 &rarr; 갈래 제곱식</strong>이라고 부르기로 하였다.</p>
...
<p>문제에서 다루는 적분법은 $\int x^n \mathrm{d}x = \frac{1}{n+1}x^{n+1} + C$이 성립한다.</p>