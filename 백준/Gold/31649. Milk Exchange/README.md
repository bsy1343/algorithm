...
제출: 428, 정답: 131, 맞힌 사람: 113, 정답 비율: 37.919%
...
<p>Every minute, the cows exchange milk according to a string $s_1s_2\dots s_N$ consisting solely of the characters $\text{&lsquo;L&rsquo;}$ and $\text{&lsquo;R&rsquo;}$. if the $i$th cow has at least $1$ liter of milk, she will pass $1$ liter of milk to the cow to her left if $s_i=\text{&lsquo;L&rsquo;}$, or to the right if $s_i=\text{&lsquo;R&rsquo;}$. All exchanges happen simultaneously (i.e., if a cow has a full bucket but gives away a liter of milk but also receives a liter, her milk is preserved). If a cow&#39;s total milk ever ends up exceeding $a_i$, then the excess milk will be lost.</p>
...
<p>The second line contains a string $s_1s_2\dots s_N$ consisting solely of the characters $\text{&lsquo;L&rsquo;}$ or $\text{&lsquo;R&rsquo;}$, denoting the direction each cow will pass their milk in.</p>
