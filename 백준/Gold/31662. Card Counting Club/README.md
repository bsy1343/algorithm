...
제출: 42, 정답: 34, 맞힌 사람: 30, 정답 비율: 88.235%
...
<ol>
	...
	<ol>
		<li>
		<p>Only one player gets to discard their card, and the ties are broken by choosing the player&rsquo;s whose name comes first lexicographically (i.e. standard dictionary order).</p>
		</li>
		<li>
