...
제출: 1170, 정답: 312, 맞힌 사람: 219, 정답 비율: 26.838%
...
<ul>
	...
	<li>$0 \le M \le \min\left(\frac{(n+1)(n+2)}{2} - 1, 100\,000 \right)$</li>
	<li>$0 \le x_i \le 2N$</li>
	<li>$0 \le y_i \le N$</li>
	<li>$x_i + y_i$는 짝수다.</li>
	<li>$(0,0)$에는 선생님이 계시지 않는다.</li>
</ul>