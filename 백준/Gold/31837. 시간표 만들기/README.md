...
제출: 209, 정답: 121, 맞힌 사람: 103, 정답 비율: 59.195%
...
<ul>
	<li>$1\le N\le 15$</li>
	<li>$1\le A_i\le 15$</li>
	<li>$\sum_{i=1}^{N}A_i\le 15$</li>
	<li>$1\le C\le 22$</li>
	<li>$1\le D\le 7$</li>
	<li><code>00</code> $\le$ <code>HH</code> $\le$ <code>23</code></li>
	<li><code>00</code> $\le$ <code>MM</code> $\le$ <code>59</code></li>
	<li>$S&lt;E$, 즉, 강의가 자정을 넘어서까지 진행되거나, 시작하자마자 종료하는 경우는 없다.</li>
