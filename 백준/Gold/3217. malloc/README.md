...
제출: 1144, 정답: 252, 맞힌 사람: 158, 정답 비율: 22.604%
...
<ol>
	...
	<ul>
		<li>이 함수은 처음 등장하는 <code>size</code>개의 연속된 공간을 찾아, 할당해주는 함수이다. 이 함수의 리턴값은 할당된 공간의 제일 처음 주소이다. 만약, 할당해줄 수 있는 공간이 없다면 <code>0</code>을 리턴한다. (100 &le; <code>size</code> &le; 100,000)</li>
	</ul>
	</li>
...
<p>첫째 줄에 명령의 개수 N이 주어진다. (1 &le; N &le; 100,000)</p>
