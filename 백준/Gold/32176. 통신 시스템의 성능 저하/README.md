...
제출: 262, 정답: 97, 맞힌 사람: 84, 정답 비율: 39.810%
...
<ul>
	<li>$2 \le N \le 6$</li>
	<li>$0 \le M \le N^2 - 1$</li>
	<li>$\max(M - 4, 0) \le K_1 \le M$</li>
	<li>$0 \le K_2 \le \min(4, M)$</li>
	<li>마을에서 주어지는 기지국의 개수는 $1$개이다.</li>
	<li>마을에서 주어지는 노드의 개수는 $M$개이다.</li>
</ul>