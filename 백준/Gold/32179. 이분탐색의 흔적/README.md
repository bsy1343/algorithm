...
제출: 175, 정답: 85, 맞힌 사람: 72, 정답 비율: 46.452%
...
<ul>
	<li>$1 \le N \le 100$</li>
	<li>$1 \le K \le \lfloor \log_2{N} \rfloor + 1$</li>
	<li>$1\le a_1 &lt; a_2 &lt; \cdots &lt; a_N \le 100$</li>
	<li>$1\le t_i \le 100$</li>
	<li>모든 $i \neq j$에 대해 $t_i \neq t_j$</li>
	<li>$1 \le i, j \le K$</li>
	<li>가능한 배열 $A$가 $1$개 이상 존재하는 흔적만이 입력으로 주어진다.</li>
</ul>