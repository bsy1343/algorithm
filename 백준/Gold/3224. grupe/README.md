...
제출: 70, 정답: 41, 맞힌 사람: 38, 정답 비율: 65.517%
...
<p>In the first line, there will be integer N, 1 &le; N &le; 500,000.</p>
...
<p>If the written word is &#39;DA&#39;, then the next N&ndash;1 lines should consist of two integers a and b so that those numbers in the line (i+1) are the smallest and the biggest number in the group made in i-th gathering.</p>