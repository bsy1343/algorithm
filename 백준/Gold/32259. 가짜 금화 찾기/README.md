...
제출: 264, 정답: 97, 맞힌 사람: 85, 정답 비율: 35.417%
...
<p>첫째 줄에 동전의 수 $N$이 입력된다. $(1 &le; N &le; 128)$</p>
...
<p>채점 프로그램은 처음에 가짜 금화를 결정한 후 처음 정한 가짜 금화에 따라 답변한다. 즉 채점 프로그램은 실행 도중에 가짜 금화의 번호를 바꾸지 않는다.</p>