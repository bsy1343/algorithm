...
제출: 21, 정답: 16, 맞힌 사람: 13, 정답 비율: 86.667%
...
<ul>
	<li>$1 \le T \le 10$</li>
	<li>$1 \le N, M \le 250\,000$</li>
	<li>$1 \le i \le N$ 인 $i$에 대하여: $W_i = $<code>A</code> 혹은 $W_i = $<code>B</code></li>
	<li>$1 \le j \le M$ 인 $j$에 대하여:
	<ul>
		<li>$1 \le s_j \le N$</li>
		<li>$1 \le g_j \le N$ 이며 $g_j$ 는 언제나 홀수이다</li>
	</ul>
	</li>
</ul>