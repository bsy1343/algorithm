...
제출: 67, 정답: 25, 맞힌 사람: 18, 정답 비율: 37.500%
...
<p>The first lline of the input file consists of two natural numbers F and B; 1 &le; F &le; 2000, 1 &le; B &le; F, F is the number of flowers in the meadow and B is the number of bees available for collecting pollen.</p>

<p>Each of the next C lines contains two natural numbers X and Y, 1 &le; X,Y &le; 10000, the coordinates of a flower.</p>
