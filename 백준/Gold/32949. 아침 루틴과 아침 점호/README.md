...
제출: 127, 정답: 38, 맞힌 사람: 37, 정답 비율: 37.374%
...
<ul>
	<li>$0$개의 행동을 고른 경우 각각의 행동을 수행하는 데에 걸리는 시간의 합과, 수행한 각각의 행동을 수행했을 때 얻는 만족감의 합은 모두 $0$이다.</li>
	<li>C/C++, Java 등의 언어에서 일부 변수를 $32$비트 정수형으로 선언한 경우 오버플로우가 발생할 수 있음에 유의하라.</li>
</ul>