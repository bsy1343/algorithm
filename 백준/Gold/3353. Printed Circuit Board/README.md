# [Gold II] Printed Circuit Board - 3353
...
제출: 79, 정답: 43, 맞힌 사람: 39, 정답 비율: 60.000%
...
<p>The first line of the text file pcb.in contains N (1 &le; N &le; 10<sup>5</sup>), the number of connectors. Each of the following N lines contains two integers, X<sub>i1</sub> and X<sub>i2</sub> (0 &le; X<sub>ij</sub> &le; 10<sup>6</sup>), separated by a space, meaning that the i-th conductor has to connect the points (X<sub>i1</sub>, 0) and (X<sub>i2</sub>, H). It may be assumed that all the 2 &middot; N endpoints given in the input are distinct.</p>
