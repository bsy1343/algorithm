...
제출: 150, 정답: 125, 맞힌 사람: 100, 정답 비율: 80.645%
...
<p>The first line contains the number of cards N (2 &le; N &le; 100 000, N is an even integer). Each of the following N lines contains two integers a<sub>i</sub> and b<sub>i</sub> (-2000 &le; a<sub>i</sub>, b<sub>i</sub> &le; 2000; i = 1&hellip;N). These are the numbers written on separate sides of the i-th card.</p>
