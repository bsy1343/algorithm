...
제출: 247, 정답: 96, 맞힌 사람: 54, 정답 비율: 34.839%
...
<ul>
	...
	<li>$0\leq M\leq\min \left( \displaystyle\frac{N \left(N-1 \right)}{2} ,1\,000 \right)$</li>
	<li>$1\leq T\leq 1\,000$</li>
	<li>$1\leq a_i,b_i\leq N \left(1 \le i \le M \right)$</li>
	<li>$1\leq c_j\leq N \left(0 \le j &lt; T \right)$</li>
</ul>
