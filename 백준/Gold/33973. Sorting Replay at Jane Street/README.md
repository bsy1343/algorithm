...
제출: 153, 정답: 92, 맞힌 사람: 80, 정답 비율: 66.116%
...
<p style="text-align: center;"><img alt="" src="%EB%B0%B1%EC%A4%80/Gold/33973.%E2%80%85Sorting%E2%80%85Replay%E2%80%85at%E2%80%85Jane%E2%80%85Street/ab076c60.png" data-original-src="https://boja.mercury.kr/assets/problem/33973-1.png" onerror="this.onerror=null;this.src=this.dataset.originalSrc"></p>
...
<p>정렬 시 기준값이 같은 배열들에 대해 정렬은 다음과 같이 이루어진다.</p>

<ul>
	<li>안정 정렬 (stable sort): 기준값이 같은 배열들 사이의 원래 순서를 보존하며 오름차순 정렬을 수행한다.</li>
	<li>불안정 정렬 (unstable sort): 기준값이 같은 배열들 사이의 원래 순서를 보존하지 않으며 오름차순 정렬을 수행한다.</li>
</ul>