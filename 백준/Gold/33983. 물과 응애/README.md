...
제출: 1364, 정답: 427, 맞힌 사람: 294, 정답 비율: 31.144%
...
<p style="text-align: center;"><img alt="" src="%EB%B0%B1%EC%A4%80/Gold/33983.%E2%80%85%EB%AC%BC%EA%B3%BC%E2%80%85%EC%9D%91%EC%95%A0/77a6be02.png" data-original-src="https://boja.mercury.kr/assets/problem/33983-1.png" onerror="this.onerror=null;this.src=this.dataset.originalSrc" style="height: 340px; width: 600px;"></p>
...
<p>문자열의 부분 수열이란 주어진 문자열의 일부 문자를 원래 순서대로 나열하여 얻을 수 있는 문자열이다.</p>