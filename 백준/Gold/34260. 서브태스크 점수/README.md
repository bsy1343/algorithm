...
제출: 105, 정답: 87, 맞힌 사람: 83, 정답 비율: 91.209%

### 분류

그래프 이론, 다이나믹 프로그래밍, 방향 비순환 그래프, 배낭 문제, 브루트포스 알고리즘, 비트마스킹, 수학, 위상 정렬
...
<ul>
	<li>$1 \le P \le 30$</li>
	<li>$1 \le N_i \le 10$ ($1 \le i \le P$)</li>
	<li>$0 \le M_i \le N_i(N_i-1)/2$ ($1 \le i \le P$)</li>
	<li>$1 \le S_{i,j} \le 100$ ($1 \le i \le P$; $1 \le j \le N_i$)</li>
	<li>$\sum_{j=1}^{N_i} S_{i,j} = 100$ ($1 \le i \le P$)</li>
	<li>$1 \le X_{i,k} &lt; Y_{i,k} \le N_i$ ($1 \le i \le P$; $1 \le k \le M_i$)</li>
	<li>중복된 위계 관계는 주어지지 않는다.</li>
	<li>전이적으로 유도될 수 있는 위계 관계가 <strong>입력으로 주어질 수 있다</strong>.</li>
