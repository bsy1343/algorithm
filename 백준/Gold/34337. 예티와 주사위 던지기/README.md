...
제출: 181, 정답: 109, 맞힌 사람: 102, 정답 비율: 68.000%

### 분류

구현, 백트래킹, 브루트포스 알고리즘, 수학, 조합론, 확률론
...
<p>최종 주사위 조합이 $2, 2, 3, 4, 5$라고 하자. <code>Twos</code>를 사용할 경우 4점, <code>Threes</code>를 사용할 경우 3점, <code>Fours</code>를 사용할 경우 4점, <code>Fives</code>를 사용할 경우 5점을 얻을 수 있다. 나머지 족보를 선택하면 0점을 얻는다. 따라서 예티는 <code>Fives</code>를 선택할 것이고, 5점을 얻게 된다.</p>