...
제출: 19754, 정답: 4250, 맞힌 사람: 2925, 정답 비율: 19.649%
...
<p>각 테스트 케이스의 첫째 줄에는 구멍의 너비 x (1 &le; x &le; 20, x는 정수)가 주어진다. x의 단위는 센티미터이다.</p>

<p>다음 줄에는 물리 실험실에 있는 레고 조각의 수 n이 주어진다. (0 &le; n &le; 1000000)</p>

<p>다음 n개의 줄에는 레고 조각의 길이 ℓ이 주어진다. ℓ은 양의 정수이며,&nbsp;단위는 나노미터이다. 블록의 길이는 10 센티미터 (100000000 나노미터)를 넘지 않는다.</p>

### 출력

<p>각 테스트 케이스마다 한 줄에 하나씩, 구멍을 완벽하게 막을 수 있는 두 조각이 없다면 &#39;danger&#39;를 출력한다. 막을 수 있는 경우에는 &#39;yes ℓ<sub>1</sub> ℓ<sub>2</sub>&#39;를 출력한다. (ℓ<sub>1</sub> &le; ℓ<sub>2</sub>)</p>
