...
제출: 349, 정답: 142, 맞힌 사람: 126, 정답 비율: 45.000%
...
<p>각 테스트 케이스의 첫째 줄에는 선물의 가격 p (1 &le; p &le; 1,000,000)와 선영이 친구의 수 n (2 &le; n &le; 100) 이 주어진다. 둘째 줄에는 각 사람이 낼 수 있는 금액 a<sub>i</sub> (1 &le; a<sub>i</sub> &le; 1,000,000) 가 주어진다.</p>
