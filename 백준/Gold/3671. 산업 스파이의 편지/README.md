...
제출: 2138, 정답: 1112, 맞힌 사람: 818, 정답 비율: 52.571%
...
<p>첫째 줄에 테스트 케이스의 개수 c가 주어진다. (1 &le; c &le; 200) 각 테스트 케이스는 한 줄로 이루어져 있고, 종이조각에 쓰여 있는 수가 공백없이 주어진다. 종이조각의 수는 적어도 1개, 많아야 7개이다.</p>
