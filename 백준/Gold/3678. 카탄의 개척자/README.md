...
제출: 1060, 정답: 460, 맞힌 사람: 323, 정답 비율: 41.894%
...
<p><img alt="" src="/upload/images/settler.png" style="height:280px; width:329px" /></p>

### 입력

<p>첫째 줄에 테스트 케이스의 개수 c (1 &le; c &le; 200)가 주어진다. 각 테스트 케이스는 한 줄로 이루어져 있으며, 정수 n이 주어진다. (1 &le; n &le; 10000)</p>
