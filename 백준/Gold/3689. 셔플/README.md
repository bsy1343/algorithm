...
제출: 68, 정답: 26, 맞힌 사람: 25, 정답 비율: 43.103%
...
<p>그 이후 각 테스트케이스마다 첫째 줄에는 s와 n(1 &le; s, n &le; 100 000)이 주어진다. s는 플레이리스트의 곡의&nbsp;수이고, n은 이제껏&nbsp;재생된&nbsp;곡&nbsp;목록의 곡의 수이다.</p>

<p>둘째 줄에는 n개의&nbsp;x1, x2, . . . , xn&nbsp;(1 &le; xi&nbsp;&le; s) 재생된 음악이 주어진다.</p>
