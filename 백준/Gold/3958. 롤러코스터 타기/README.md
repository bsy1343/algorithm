...
제출: 109, 정답: 38, 맞힌 사람: 35, 정답 비율: 45.455%
...
<p>첫째 줄에 N이 주어진다. N은 놀이 공원에 있는 롤러코스터의 개수이다. (0 &lt; N &le; 100)</p>

<p>다음 N개의 줄에는 a<sub>i</sub>, b<sub>i</sub>, t<sub>i</sub>가 있다. a<sub>i</sub>와 b<sub>i</sub>는 상근이가 정의한 함수의 계수이고, t<sub>i</sub>는 i번째 롤러코스터를 타는데 걸리는 시간이다. (0 &le; a<sub>i</sub>, b<sub>i</sub> &le; 1,000, 0 &lt; t<sub>i</sub> &le; 25,000)</p>

<p>다음 줄에는 놀이 공원을 방문하는 시간의 개수 Q가 주어진다. (0 &le; Q &le; 1,000) 다음 Q개 줄에는 상근이가 놀이 공원에 방문하는 시간 T<sub>i</sub>가 주어진다. (0 &le; T<sub>i</sub> &le; 25,000)</p>
