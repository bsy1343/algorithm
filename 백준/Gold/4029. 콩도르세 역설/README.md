...
제출: 299, 정답: 63, 맞힌 사람: 50, 정답 비율: 23.585%
...
<p>입력은 여러 개의 테스트 케이스로 이루어져 있다. 각 테스트 케이스의 첫째 줄에는 선호 리스트의 수 b와 후보자의 수 c가 주어진다. (1 &le; b &le; 500, 1 &le; c &le; 2500) 후보자는 0번부터 c-1번까지 번호가 매겨져 있다. 다음 줄부터 b개 줄에는 각 선호 리스트에 적혀있는 후보자가 순서대로 주어진다.</p>
