...
제출: 451, 정답: 156, 맞힌 사람: 116, 정답 비율: 39.057%

### 분류

수학, 구현, 브루트포스 알고리즘, 이분 탐색, 런타임 전의 전처리
...
<p>
	입력은 여러개의 테스트 케이스로 이루어져 있다. 각 테스트 케이스는 정수 X(10 &le; X &le; 1,000,000)를 포함하는 한 줄로 이루어져 있다. 입력은 0이 있는 줄에서 끝난다.</p>
