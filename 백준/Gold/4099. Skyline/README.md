...
제출: 55, 정답: 37, 맞힌 사람: 34, 정답 비율: 70.833%
...
<p>There will be several test cases in the input. Each test case will consist of a single line containing a single integer N (3 &le; N &le; 1,000), which represents the number of skyscrapers. The heights of the skyscrapers are assumed to be 1, 2, 3, &hellip;, N. The input will end with a line with a single 0.</p>
