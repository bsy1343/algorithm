...
[문제 링크](https://www.acmicpc.net/problem/4399)
...
제출: 260, 정답: 37, 맞힌 사람: 23, 정답 비율: 14.839%
...
<p>알파벳 소문자로 되어있는 두 문자열 a와 b가 주어졌을 때, ax 또는 bx가 팰린드롬이 되는 가장 짧은 문자열 x를 찾는 프로그램을 작성하시오. 이때, ax와 bx가 둘 다 팰린드롬이면 안 된다.&nbsp;</p>
