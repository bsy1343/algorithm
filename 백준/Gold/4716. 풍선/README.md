...
제출: 4779, 정답: 1285, 맞힌 사람: 940, 정답 비율: 26.926%
...
<p>입력은 여러 개의 테스트 케이스로 이루어져 있다. 각 테스트 케이스의 첫째 줄에는 팀의 수 N(1 &le; N &le; 1,000)과 방 A와 B에 보관되어있는 풍선의 수 A, B가 주어진다. (0 &le; A, B &le; 10,000)&nbsp;</p>

<p>다음 N개 줄에는 팀에게 달아줘야하는 풍선의 수 K와 방 A로부터 떨어진 거리 D<sub>A</sub>, B로부터 떨어진 거리 D<sub>B</sub> (0 &le; D<sub>A</sub>, D<sub>B</sub> &le; 1,000)가 주어진다. 풍선이 부족한 경우는 없다. 즉, &Sigma;<sub>i</sub> K<sub>i</sub> &le; A+B.</p>
