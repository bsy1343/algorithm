...
제출: 150, 정답: 105, 맞힌 사람: 98, 정답 비율: 76.562%
...
<p>There will be several test cases in the data file. Each test case will begin with an integer N (2 &le; N &le; 1, 000), which is the number of points in the city. On each of the next N lines will be two integers, X and Y (&minus;1, 000 &le; X, Y &le; 1, 000), which are the (X, Y ) locations of the N points.</p>
