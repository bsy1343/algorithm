...
제출: 51, 정답: 34, 맞힌 사람: 32, 정답 비율: 65.306%
...
<p>The Acme Extrusion Company specializes in the production of steel bars with custom-designed cross-sections. The manufacturing process involves cutting a hole in a thick metal plate, the shape of the hole being determined by the customer&rsquo;s specifications.</p>
...
<p>where &ldquo;x&rdquo; is the maximum bar length, a floating point number expressed with two digits precision.&nbsp;</p>
