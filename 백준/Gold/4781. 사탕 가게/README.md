...
제출: 15014, 정답: 3835, 맞힌 사람: 2564, 정답 비율: 25.029%
...
<p>각 테스트 케이스의 첫째 줄에는 가게에 있는 사탕 종류의 수 n과 상근이가 가지고 있는 돈의 양 m이 주어진다. (1 &le; n &le; 5,000, 0.01 &le; m &le; 100.00) m은 항상 소수점 둘째자리까지 주어진다.</p>

<p>다음 n개 줄에는 각 사탕의 칼로리 c와 가격 p가 주어진다. (1 &le; c &le; 5,000, 0.01 &le; p &le; 100.00) c는 항상 정수, p는 항상 소수점 둘째자리이다.</p>
