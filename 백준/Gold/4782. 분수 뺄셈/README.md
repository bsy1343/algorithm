...
제출: 697, 정답: 166, 맞힌 사람: 106, 정답 비율: 24.766%
...
<p>분수 b/n이 주어진다. 이때, 아래 식을 만족하는 모든 a와 m을 찾는 프로그램을 작성하시오. (a &ge; 0, m &gt; 0)</p>

<p>\[\frac{a}{m} - \frac{b}{n} = \frac{a-b}{m-n}\]</p>

### 입력

<p>입력은 여러 개의 테스트 케이스로 이루어져 있다. 각 테스트 케이스는 한 줄로 이루어져 있고, b와 n이 주어진다. (1 &le; b, n &le; 10<sup>6</sup>) 입력의 마지막 줄에는 0이 두 개 주어진다.</p>
