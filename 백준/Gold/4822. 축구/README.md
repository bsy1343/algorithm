...
제출: 136, 정답: 19, 맞힌 사람: 19, 정답 비율: 31.148%
...
<p>입력은 여러 개의 테스트 케이스로 이루어져 있다. 각 테스트 케이스의 첫째 줄에는 팀의 수 n과 리그 경기의 수 m이 주어진다. (2 &le; n &le; 20, 1 &le; m &le; 1000) 다음 n개 줄에는 팀 이름이 주어진다. 팀 이름은 알파벳으로만 이루어져 있고, 최대 30글자이다. 다음 m개 줄에는 경기 일정과 결과가 주어진다. 경기 일정은 다음과 같이 생겼다.</p>
