...
제출: 23, 정답: 16, 맞힌 사람: 14, 정답 비율: 66.667%
...
<p>Also, define root(T1), ..., root(Tm) to be the children of root(T), with root(Ti) being the i&minus;th child. The nodes root(T1), ..., root(Tm) are siblings.</p>
