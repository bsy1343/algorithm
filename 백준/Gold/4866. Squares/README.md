...
제출: 81, 정답: 39, 맞힌 사람: 27, 정답 비율: 51.923%

### 분류

브루트포스 알고리즘, 자료 구조, 기하학, 해시를 사용한 집합과 맵, 집합과 맵
...
<p>The input consists of a number of test cases. Each test case starts with the integer n (1 &le; n &le; 1000) indicating the number of points to follow. Each of the next n lines specify the x and y coordinates (two integers) of each point. You may assume that the points are distinct and the magnitudes of the coordinates are less than or equal to 20000. The input is terminated when n = 0.</p>
