...
제출: 351, 정답: 133, 맞힌 사람: 121, 정답 비율: 40.066%
...
<p><img alt="" src="/upload/images/andortree.png" style="float:right; height:172px; width:164px" />모든 불리언 식은 Disjunctive Normal Form(DNF)나 Conjunctive Normal Form(CNF)로 나타낼 수 있다. DNF는 하나 또는 그 이상의 CNF식을 OR로 연결한 식이고, CNF는 DNF식을 AND로 연결한 식이다.</p>
...
<p>오른쪽 그림은 (A&or;(B&and;C))&and;(D&or;E)를 트리로 나타낸 것이다. 레벨 1(가장 위)과 3은 AND트리이다.</p>
...
<pre>
(E<sub>1</sub> E<sub>2</sub> ... E<sub>n</sub>)</pre>
