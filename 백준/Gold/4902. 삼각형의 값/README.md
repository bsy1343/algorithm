...
<p><img alt="" src="/upload/images/tr.png" style="float:right; height:130px; width:134px" />오른쪽 삼각형은 9개의 단위 삼각형이 총 3줄(N=3)로 이루어져 있다. 단위 삼각형은 N=1인 삼각형이다.</p>
...
<p><img alt="" src="/upload/images/tr1.png" style="float:right; height:126px; width:133px" />오른쪽 그림은 가장 큰 값을 갖는 부분 삼각형이다.</p>
