...
제출: 54946, 정답: 19274, 맞힌 사람: 12267, 정답 비율: 32.844%
...
<p>첫째 줄에 테스트 케이스의 개수 t가 주어진다. (1 &le; t &le; 50) 각 테스트 케이스의 첫째 줄에는 전화번호의 수 n이 주어진다. (1 &le; n &le; 10000) 다음 n개의 줄에는 목록에 포함되어 있는 전화번호가 하나씩 주어진다. 전화번호의 길이는 길어야 10자리이며, 목록에 있는 두 전화번호가 같은 경우는 없다.</p>
