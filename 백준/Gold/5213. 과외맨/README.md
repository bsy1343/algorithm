...
제출: 5455, 정답: 1158, 맞힌 사람: 782, 정답 비율: 22.439%
...
<p style="text-align: center;"><img alt="" src="%EB%B0%B1%EC%A4%80/Gold/5213.%E2%80%85%EA%B3%BC%EC%99%B8%EB%A7%A8/b0eb5d93.png" data-original-src="%EB%B0%B1%EC%A4%80/Gold/5213.%E2%80%85%EA%B3%BC%EC%99%B8%EB%A7%A8/b0eb5d93.png" data-original-src="https://upload.acmicpc.net/04f37a7b-2308-4f1c-837a-ad5197c14870/-/preview/" onerror="this.onerror=null;this.src=this.dataset.originalSrc" style="width: 304px; height: 122px;" /></p>
...
<p>첫째 줄에 N이 주어진다. (1 &le; N &le; 500) 다음 줄부터 N*N-N/2줄(/는 정수 나눗셈이다)에는 두 양의 A<sub>i</sub>와 B<sub>i</sub>가 주어진다. (1 &le; A<sub>i</sub>, B<sub>i</sub> &le; 6, 1 &le; i &le; N * N - N / 2) 타일 i의 왼쪽에 쓰여 있는 숫자는 A<sub>i</sub>, 오른쪽에 쓰여 있는 숫자는 B<sub>i</sub>이다.</p>
