...
제출: 742, 정답: 214, 맞힌 사람: 171, 정답 비율: 32.022%
...
<p>예시로 든 방법을 사용해서 &radic;N을 작도하려고 한다. 필요한 원의 반지름과 선분의 길이를 구하자. 쓸 수 있는 길이가 여러 가지가 있다면 그들 중 최솟값을 사용한다.</p>

<p>(길이는 0이 되어도 된다.)</p>

### 입력

<p>첫 번째 줄에는 테스트 케이스의 개수가 주어진다. 다음 줄부터 각각의 테스트 케이스에 대해 정수 1 &le; N &le; 10<sup>9</sup>&nbsp;이 한 줄마다 주어진다.</p>
