...
제출: 413, 정답: 117, 맞힌 사람: 92, 정답 비율: 40.175%
...
<p><img alt="" src="/upload/images/stackbook.png" style="height:153px; width:572px" /></p>
...
<p>각 테스트 케이스의 첫째 줄에는 책의 수 n이 주어진다. (1 &le; n &le; 50) 다음 줄에는 책의 크기 s<sub>i</sub>가 스택의 맨 위에서부터 순서대로 주어진다. (1 &le; s<sub>i</sub> &le; 1000)</p>
