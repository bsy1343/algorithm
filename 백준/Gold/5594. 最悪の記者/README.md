...
제출: 137, 정답: 100, 맞힌 사람: 80, 정답 비율: 69.565%
...
<ul>
	...
	<li>情報 3 全ての 1 &le; a &lt; b &le; n に対し，a 位のチームと b 位のチームの試合において， 必ず a 位のチームが勝利した．</li>
</ul>
...
<p>n, m は 1 &le; n &le; 5000, 1 &le; m &le; 100000 をみたす．</p>

### 출력

<p>出力ファイルは n + 1 行からなる．</p>

<p>1 行目から n 行目までの n 行には，伝えられた情報に適合する順位表を出力せよ． i 行目 (1 &le; i &le; n) に i 位のチームの番号を出力せよ．</p>
