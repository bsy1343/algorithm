...
제출: 3764, 정답: 1139, 맞힌 사람: 760, 정답 비율: 27.869%
...
<p>첫째 줄에 제단의 열의 수 N이 주어진다. (1 &le; N &le; 10,000)</p>

<p>다음 줄에는 공백으로 구분된 N개의 정수 h<sub>i</sub>가 주어진다. (-1 &le; h<sub>i</sub> &le; 10,000) h<sub>i</sub>는 i번 열의 높이를 나타내며, -1인 경우에는 도둑이 그 열을 훔쳐간 상태를 나타낸다.</p>
