...
제출: 443, 정답: 204, 맞힌 사람: 162, 정답 비율: 45.378%
...
<p>첫째 줄에 수문의 개수 n이 주어진다. (1 &le; n &le; 20) 다음 n개 줄에는 각 수문 G<sub>i</sub>의 유량 (m<sup>3</sup>/hour) F<sub>i</sub>와 피해 비용 C<sub>i</sub>가 주어진다. 다음 줄에는 테스트 케이스의 수 m (1 &le; m &le; 50)이 주어진다. 다음 m개 줄에는 V와 T가 주어지며, 물 V m<sup>3</sup>을 T시간 이내에 비워내야 한다는 뜻이다. (1 &le; F<sub>i</sub>, V, C<sub>i</sub> &le; 10<sup>9</sup>, 1 &le; T &le; 1000)</p>
