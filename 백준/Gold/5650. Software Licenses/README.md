...
제출: 98, 정답: 28, 맞힌 사람: 20, 정답 비율: 47.619%
...
<p>The first line contains a positive integer n 1( &le; n &le; 100) indicating the number of licenses you need. The next n lines contain 2 numbers: P<sub>j</sub> and R<sub>j</sub> in each line.</p>
