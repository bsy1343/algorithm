# [Gold IV] Need For Speed - 6038

[문제 링크](https://www.acmicpc.net/problem/6038)
...
제출: 88, 정답: 44, 맞힌 사람: 40, 정답 비율: 53.333%
...
<p>Bessie is preparing her race car for the upcoming Grand Prix, but she wants to buy some extra parts to improve the car&#39;s performance. Her race car currently has mass M (1 &lt;= M &lt;= 1,000) and is able to push itself forward with a force of F (1 &lt;= F &lt;= 1,000,000). The Race Car Performance Store has N (1 &lt;= N &lt;= 10,000) parts conveniently numbered 1..N. Bessie can buy as many or as few parts as she wishes though the store stocks no more than one instance of each part.</p>
