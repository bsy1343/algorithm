...
제출: 547, 정답: 151, 맞힌 사람: 122, 정답 비율: 28.372%
...
<p>The cow must make at least 2 turns: For example, the cow may start by facing south, move south, turn to face west, move west, move west, then turn to face south, and finally move south into the B square.</p>