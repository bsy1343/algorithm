...
제출: 30485, 정답: 11555, 맞힌 사람: 8733, 정답 비율: 36.006%
...
<ul>
	<li>첫 번째 줄에 빌딩의&nbsp;개수 N이 입력된다.(1 &le; N &le; 80,000)</li>
	<li>두 번째 줄 부터 N+1번째 줄까지 각 빌딩의 높이가 h<sub>i</sub> 입력된다. (1 &le; h<sub>i</sub> &le; 1,000,000,000)</li>
</ul>
