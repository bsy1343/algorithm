...
제출: 24001, 정답: 9417, 맞힌 사람: 7172, 정답 비율: 36.575%
...
<p>각 테스트 케이스의 첫째 줄에는 집의 수 m과 길의 수 n이 주어진다. (<em>1 &le; m &le; 200000</em>, <em>m-1 &le; n &le; 200000</em>)</p>

<p>이어서 n개의 줄에 각 길에 대한 정보 x, y, z가 주어지는데, 이는 x번 집과 y번 집 사이에 양방향 도로가 있으며 그 거리가 z미터라는 뜻이다. (<em>0 &le; x, y &lt; m</em>, <em>x &ne; y</em>)</p>
