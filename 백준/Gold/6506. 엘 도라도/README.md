...
제출: 473, 정답: 222, 맞힌 사람: 190, 정답 비율: 48.718%
...
<p>수열 a<sub>1</sub>, ..., a<sub>n</sub>의 부분 수열은 1 &le; i<sub>1</sub> &lt; i<sub>2</sub> &lt; ... &lt; i<sub>l</sub> &le; n를 만족하는 a<sub>i1</sub>, ..., a<sub>il</sub>로 정의 한다. 부분 수열이 증가하려면 모든 1 &lt; j &le; l에 대해서, a<sub>ij-1</sub> &lt; a<sub>ij</sub>를 만족해야 한다.</p>
...
<p>입력은 여러 개의 테스트 케이스로 이루어져 있다. 각 테스트 케이스의 첫째 줄에는 n과 k가 주어진다. (1 &le; k &le; n &le; 100) 둘째 줄에는 컴퓨터가 만든 수열 a<sub>i</sub>가 주어진다. a<sub>i</sub>는 서로 중복되지 않는다. (-10000 &le; a<sub>i</sub> &le; 10000)</p>
