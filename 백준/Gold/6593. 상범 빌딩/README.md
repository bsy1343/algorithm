...
제출: 28880, 정답: 11987, 맞힌 사람: 9518, 정답 비율: 40.789%
...
<p>입력은 여러 개의 테스트 케이스로 이루어지며, 각 테스트 케이스는 세 개의 정수 L, R, C로 시작한다.&nbsp;L(1 &le; L &le; 30)은 상범 빌딩의 층 수이다.&nbsp;R(1 &le; R &le; 30)과 C(1 &le; C &le; 30)는 상범 빌딩의 한 층의 행과 열의 개수를 나타낸다.</p>
