# [Gold V] A language for constants - 6726
...
제출: 54, 정답: 36, 맞힌 사람: 26, 정답 비율: 61.905%
...
<p>An obscure computer science professor wants to become famous devel- oping a new programming language YACL (&ldquo;Yet Another Constant Lan- guage&rdquo;). This language is very simple; it only has four constructs:</p>

<ul>
	<li><strong>C+1</strong> creates the constant 1.</li>
	<li><strong>C-1</strong> creates the constant &minus;1.</li>
...
<p>The input file may contain several instances of the problem. Each instance of the problem is just one line containing the numeric constant to be generated. All numbers are non-zero integers between &minus;32768 and 32767. A line containing the integer zero terminates the input file.</p>

<p>&nbsp;</p>

### 출력

<p>For each instance of the problem, your program should print one line saying &ldquo;Constant n&rdquo;, where n is the constant for that instance, followed by the most efficient program to generate that constant, one instruction per line. Insert a blank line between each instance.</p>
