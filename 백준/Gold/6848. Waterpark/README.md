...
제출: 76, 정답: 61, 맞힌 사람: 49, 정답 비율: 79.032%
...
<p>Input begins with a single integer n (1 &le; n &le; 9999), on a line by itself, indicating the number of marked points. The next lines contain point pairs of the of the form x y, where 1 &le; x &lt; y &le; n. For example, 1234 8765 indicates a direct slide from point 1234 to point 8765. The last line of input will be indicated by point pair 0 0.</p>
