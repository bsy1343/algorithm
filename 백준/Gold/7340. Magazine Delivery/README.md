...
제출: 59, 정답: 31, 맞힌 사람: 28, 정답 비율: 53.846%
...
<p>For all i = 2 .. N, magazines should be delivered at Li only after magazines are delivered at L<sub>i &ndash;1</sub> .<br />
...
<p>The input file contains M instances of this problem (1 &le; M &le; 10). The first line of the input file is M. The descriptions of the input data follows one after the other. Each instance starts with N in a single line (N &le; 30). Each line i of the following N-1 lines contains D[i , j], for all i=1..N-1, and j=i+1..N.</p>
