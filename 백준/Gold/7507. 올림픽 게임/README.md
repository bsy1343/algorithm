...
제출: 1111, 정답: 499, 맞힌 사람: 367, 정답 비율: 41.991%
...
<p>각 테스트 케이스의 첫째 줄에는 경기의 수 &nbsp;1 &le; m &le; 50000 이 주어진다. 다음 m개 줄에는 각 경기의 정보를 나타내는 세 정수 d, s, e가 주어진다. d는 경기의 날짜, s는 시작 시간, e는 종료 시간을 나타낸다. 시간은 hhmm형식으로 주어지며, 모든 경기는 시작한 날에 끝난다.</p>
