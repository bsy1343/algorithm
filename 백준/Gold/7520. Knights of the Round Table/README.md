# [Gold IV] Knights of the Round Table - 7520
...
<p>The first line contains the number of scenarios. Each scenario starts with a line containing the number n of chairs (3 &le; l &le; 10 000). After that follow n lines, each consisting of two integers p and q (0 &le; p &lt; q &lt; 10<sup>9</sup>), denoting the angle 2&pi;p/q.</p>

### 출력

<p>The output for every scenario begins with a line containing &ldquo;Scenario #i:&rdquo;, where i is the number of the scenario starting at 1. Then print the maximal occurring distance, rounded to two digits after the decimal point. Terminate the output for the scenario with a blank line.</p>