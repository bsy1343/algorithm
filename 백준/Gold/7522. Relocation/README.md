...
제출: 26, 정답: 7, 맞힌 사람: 5, 정답 비율: 45.455%
...
<p>The first line contains the number of scenarios. Each scenario consists of one line containing three numbers n, C1 and C2. C1 and C2 are the capacities of the cars (1 &le; Ci &le; 100) and n is the number of pieces of furniture (1 &le; n &le; 10). The following line will contain n integers w1, . . . , wn, the weights of the furniture (1 &le; wi &le; 100). It is guaranteed that each piece of furniture can be loaded by at least one of the two cars.</p>

### 출력

<p>The output for every scenario begins with a line containing &ldquo;Scenario #i:&rdquo;, where i is the number of the scenario starting at 1. Then print a single line with the number of trips to the new house they have to make to move all the furniture. Terminate each scenario with a blank line.</p>