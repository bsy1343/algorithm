...
제출: 65, 정답: 24, 맞힌 사람: 17, 정답 비율: 30.357%
...
<p>This kind of conversation usually happens when we take a taxi. Many people think that the fastest way would mean the cheapest one as well. But it&rsquo;s not always true! Sometimes the fastest way could be more expensive than the slower one and vice versa, some factors are: toll fee, longer road without traffic jam, etc.</p>
...
<p>For each case, output in a single line the minimum time to reach your destination while the total cost doesn&rsquo;t exceed your money.</p>
