...
제출: 68, 정답: 22, 맞힌 사람: 18, 정답 비율: 31.579%
...
<p>In the first line of the standard input there are three integers: n, k, p (1 &le; k &le; n &le; 100,000, 1 &le; p &le; 500,000), separated by single spaces. These denote respectively: the total number of cars, the number of cars that can remain on the floor at once and the length of the sequence of cars which Johnny will want to play with. Each of the following p lines contains one integer. These integers are the numbers of cars Johnny will want to play with (the cars are numbered from 1 to n).</p>
