...
제출: 3369, 정답: 1623, 맞힌 사람: 1275, 정답 비율: 48.479%
...
<p>첫째 줄에는 과제의 개수인 정수 n (1 &le; n &le; 10<sup>6</sup>)이 주어진다.</p>

<p>이후 n개의 줄에 각각의 과제를 나타내는 두 정수 d<sub>i</sub>, t<sub>i</sub> (1 &le; d<sub>i</sub>, t<sub>i</sub> &le; 10<sup>9</sup>)가 순서대로 주어진다. 오늘은 0일이다.</p>
...
<p>1&ndash;5일에는 놀고, 6&ndash;7일에는 1번째 과제를, 8&ndash;10일에는 3번째 과제를 한다. 11&ndash;12일에는 놀고, 13&ndash;13 일에 2번째 과제를 한다.</p>