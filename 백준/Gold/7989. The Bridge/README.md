...
제출: 178, 정답: 56, 맞힌 사람: 44, 정답 비율: 28.947%
...
<p>In the first line of the standard input there is a single positive integer n - the number of tourists, 1 &le; n &le; 100,000. In the following n lines there is a non-decreasing&nbsp;sequence of integers not greater than 1,000,000,000, a single number in a line. The number in the (i+1)&rsquo;st line (1 &le; i &le; n) represents the time needed by the i&rsquo;th tourist to cross the bridge. The sum of these numbers does not exceed 1,000,000,000.</p>
