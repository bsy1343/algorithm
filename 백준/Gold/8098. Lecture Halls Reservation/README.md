...
제출: 184, 정답: 109, 맞힌 사람: 83, 정답 비율: 56.081%
...
<p>In the first line of the standard input there is written one positive integer n, (n &le; 10,000), which is the number of orders.</p>

<p>In each of the following n&nbsp;lines there are written two integers p&nbsp;and k, separated by a single space, 0 &le; p &lt; k &le; 30,000. Such a pair of integers represents an order for the hall. The lecture is to begin at time p&nbsp;and end in time k&nbsp;(a lecturer needs the hall in time represented by an open interval).</p>
