...
제출: 29, 정답: 17, 맞힌 사람: 16, 정답 비율: 64.000%
...
<p>The first and only line of the standard input contains one integer <em>n</em>&nbsp;(3 &le; <em>n</em> &le; 2 000 000 000), denoting the number of members.</p>
