...
제출: 4612, 정답: 1102, 맞힌 사람: 642, 정답 비율: 19.760%
...
<p>각 테스트케이스의 첫째 줄에는 점의 개수 N(4 &le; n &le; 3,000)이 주어지고,&nbsp;이어서 N개의 줄에는 점의 x좌표와 y좌표가 주어진다.&nbsp;모든 좌표는&nbsp;-10000 이상&nbsp;+10000이하의 정수이다. 같은 위치의 점이 여러 번 주어지는 경우는 없다.</p>
