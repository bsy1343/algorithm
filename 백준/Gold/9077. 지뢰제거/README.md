...
제출: 1307, 정답: 404, 맞힌 사람: 267, 정답 비율: 35.411%
...
<p><img alt="" src="/upload/images/mine.png" style="height:325px; width:336px" /></p>
...
<p>입력의 첫 줄에는 테스트 케이스의 개수 T(1 &le; T &le; 10)가 주어진다. 각 테스트 케이스는 한 줄에 지뢰의 개수를 나타내는 하나의 정수 N (4&nbsp;&le; N &le; 100,000)이 주어진 다음, N개의 좌표가 한 줄에 하나씩 주어진다. 각 좌표는 0이상 10,000이하의 두 정수로 주어지는데, 첫 번째 정수는 x-좌표를, 두 번째 정수는 y-좌표를 나타낸다. 모든 정수 사이에는 한 칸의 공백이 존재한다. 같은 좌표에 두 개 이상의 지뢰는 존재하지 않으며, 지뢰의 크기는 무시할 정도로 작다고 가정한다.&nbsp;</p>
