...
제출: 130, 정답: 27, 맞힌 사람: 22, 정답 비율: 41.509%
...
<p>그 다음 두 줄에는 흰색 킹의 좌표(1 &le; x<sub>k</sub>, y<sub>k</sub> &le; 8)와 검은색 폰의 좌표(1 &le; x<sub>p</sub>, y<sub>p</sub> &le; 8)가 순서대로 주어진다. 흰색 킹의 최초 좌표는 금지 칸과 고정 된 위험 칸일 수 없으며, 검은 폰의 최초 좌표는 금지 칸일수 없으며, 흰색 킹의 최초 좌표와 다르다.</p>
