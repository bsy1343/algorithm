...
제출: 69, 정답: 21, 맞힌 사람: 18, 정답 비율: 31.579%
...
<ul>
	<li>One line with two integers N and M, separated by a single space, with 2 &le; N &le; 1,000 and 1 &le; M &le; 10, 000: the number of cities and the number of roads in the road map.</li>
	<li>M lines, each with three integers A, B and L, separated by single spaces, with 1 &le; A, B &le; N, A &ne; B and 1 &le; L &le; 1,000, describing a road from city A to city B with length L.</li>
</ul>
...
<ul>
	<li>One line with two integers S and F, separated by a single space, with 1 &le; S, F &le; N and S &ne; F: the starting city and the final city of the route.</li>
</ul>
...
<p>The first test case above corresponds to the picture in the problem description.</p>