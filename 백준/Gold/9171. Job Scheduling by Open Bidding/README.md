...
제출: 86, 정답: 28, 맞힌 사람: 28, 정답 비율: 37.838%
...
<ul>
	<li>a single integer n (n &le; 500) specifying the number of candidate jobs to be scheduled</li>
	...
	<li>a single integer t (t &le; 2000) specifying the amount of time to be scheduled with these jobs</li>
</ul>
...
<p>Problem &lt;k&gt;: &lt;t&gt; seconds scheduled for \$abc.de</p>
