...
제출: 24, 정답: 22, 맞힌 사람: 20, 정답 비율: 90.909%
...
<ol>
	...
	<li>A district of the k-th stage (k &gt; 1) consists of multiple districts of the (k &minus; 1)-th stage. In contrast, a district of the (k &minus; 1)-th stage is a sub-district of one and only one district of the k-th stage. The winner of a district of the k-th stage is the candidate who wins in a majority of its sub-districts of the (k &minus; 1)-th stage.</li>
...
<ul>
	...
	<li>The number of the sub-districts of the (k &minus; 1)-th stage that constitute a district of the k-th stage (k &gt; 1) is also odd.</li>
</ul>
...
<ul>
	...
	<li>A district of the k-th stage (k &gt; 1) is denoted as [d1d2&hellip;dm], where d1, d2, &hellip;, dm denote its sub-districts of the (k &minus; 1)-th stage in this notation.</li>
</ul>
