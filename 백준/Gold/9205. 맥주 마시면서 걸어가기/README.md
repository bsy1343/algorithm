...
제출: 42813, 정답: 18476, 맞힌 사람: 13533, 정답 비율: 41.399%
...
<p>첫째 줄에 테스트 케이스의 개수 t가 주어진다. (t &le; 50)</p>

<p>각 테스트 케이스의 첫째 줄에는 맥주를 파는 편의점의 개수 n이 주어진다. (0 &le; n &le; 100).</p>

<p>다음 n+2개 줄에는 상근이네 집, 편의점, 펜타포트 락 페스티벌 좌표가 주어진다. 각 좌표는 두 정수 x와 y로 이루어져 있다. (두 값 모두 미터, -32768 &le; x, y &le; 32767)</p>
