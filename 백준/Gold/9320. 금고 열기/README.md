...
제출: 726, 정답: 153, 맞힌 사람: 118, 정답 비율: 25.000%

### 분류

수학, 브루트포스 알고리즘, 조합론, 임의 정밀도 / 큰 수 연산
...
<p>첫째 줄에 테스트 케이스의 개수가 주어진다. 테스트 케이스의 개수는 100개를 넘지 않는다. 각 테스트 케이스는 한 줄로 이루어져 있고, 가능한 암호를 나타내는 네 정수 a, b, c, d (1 &le; a, b, c, d &le; 9)가 주어진다.</p>
