...
제출: 150, 정답: 42, 맞힌 사람: 36, 정답 비율: 30.769%
...
<p>표는 m &times; n 그리드로 나타낼 수 있고, 각 칸의 너비는 두 글자, 높이는 한 글자이다. 2 &times; 3 그리드는 다음과 같이 나타낼 수 있다.</p>
...
<pre>
N RS<sub>1</sub> CS<sub>1</sub> ... RS<sub>N</sub> CS<sub>N</sub></pre>
