...
제출: 956, 정답: 319, 맞힌 사람: 220, 정답 비율: 34.003%
...
<ul>
	...
	<li>h<sub>i</sub>/w<sub>i</sub> &ne; h<sub>j</sub>/w<sub>j</sub> if i &ne; j</li>
</ul>
...
<p>첫째 줄에 테스트 케이스의 개수 T가 주어진다. 각 테스트 케이스는 한 줄로 이루어져 있고, 철사의 길이 L이 주어진다. (14 &le; L &le; 1,000,000)</p>
