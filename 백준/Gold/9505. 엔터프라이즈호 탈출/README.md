...
제출: 1185, 정답: 426, 맞힌 사람: 317, 정답 비율: 36.521%
...
<p>첫째 줄에 <strong>테스트 케이스의 개수 T</strong> (2 &le; T &le; 100)가 주어진다.</p>

<p>각 케이스는 첫 줄에 세개의 숫자 <strong>K, W, H</strong>가 주어진다.</p>

<p><strong>K</strong>&nbsp;(1 &le; K &le; 25)는 <strong>클링온 전투선의 클래스 개수</strong>를 의미한다.</p>

<p><strong>W</strong>&nbsp;(1 &le; W &le; 1000)는 <strong>평면의 폭</strong>을 의미한다.</p>

<p><strong>H</strong>&nbsp;(1 &le; H &le; 1000)는 <strong>평면의 높이</strong>를 의미한다.</p>
