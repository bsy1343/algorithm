...
제출: 64, 정답: 53, 맞힌 사람: 45, 정답 비율: 84.906%
...
<p>The input starts with an integer N (0 &le; N &le; 255). This is followed by N input cases. Each input case is a list of six unsigned integers with values not exceeding 100. The six integers xA yA xB yB xC yC correspond to the coordinates (xA, yA), (xB, yB), (xC, yC).</p>
