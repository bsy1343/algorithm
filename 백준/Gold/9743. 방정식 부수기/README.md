...
제출: 51, 정답: 13, 맞힌 사람: 8, 정답 비율: 32.000%
...
<p>집합 A = {a<sub>1</sub>, a<sub>2</sub>, a<sub>3</sub>, ..., a<sub>n</sub>}, a<sub>i</sub> &isin; {0, 1, 2, 3, ...}과 여섯 방정식이 주어진다.</p>
...
<p>첫째 줄에 n, c<sub>1</sub>, c<sub>2</sub>가 주어진다. 둘째 줄부터 n개 줄에는 a<sub>i</sub>가 주어진다. 12 &le; n &le; 7,000, a<sub>i</sub>는 32비트 정수이다.</p>
