...
제출: 1129, 정답: 731, 맞힌 사람: 550, 정답 비율: 68.069%
...
<p>양의 정수 N (1 &le; N &le; 2000)을 서로 다른 자연수의 합으로 나타내는 방법은 여러 가지가 있다.</p>
...
<p>첫째 줄에, 테스트 케이스의 개수 T (1 &le; T &le; 20)이 주어진다. 각 테스트 케이스는 한 줄로 이루어져 있고, N이 주어진다.</p>
