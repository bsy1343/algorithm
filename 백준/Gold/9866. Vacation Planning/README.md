...
제출: 292, 정답: 123, 맞힌 사람: 98, 정답 비율: 41.880%
...
<h4>Output Details</h4><p>For the first flight, the only feasible route is 1-&gt;2-&gt;3, costing 20. There are no flights leaving farm 3, so the poor cows are stranded there.</p>