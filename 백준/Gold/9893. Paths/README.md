...
제출: 229, 정답: 115, 맞힌 사람: 98, 정답 비율: 50.777%
...
<p>For example, again consider Figure 1. The shortest path from Node 0 to Node 1 is the 1-link path 0 &rarr; 1 with a path cost of 10. While there are cheaper paths: 0 &rarr; 2 &rarr; 1 and 0 &rarr; 3 &rarr; 1, they are longer (2 links). Therefore, 0 &rarr; 1 is the minimum-cost shortest path.</p>

<p>Consider another example, Figure 2. There are two shortest paths of length 2, the path 0 &rarr; 3 &rarr; 1 has a lower cost (cost = 4) than the path 0 &rarr; 2 &rarr; 1 (cost = 5). Another path 0 &rarr; 2 &rarr; 3 &rarr; 1 (cost = 3) is cheaper but longer. Therefore, the minimum-cost shortest path is 0 &rarr; 3 &rarr; 1.</p>
...
<p>There are at most 100 nodes, and nodes are numbered from 0 to 99. There are at most 1000 links and link cost varies between 0 and 2<sup>15</sup> &minus; 1.</p>
