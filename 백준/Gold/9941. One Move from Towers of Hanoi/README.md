...
제출: 134, 정답: 64, 맞힌 사람: 59, 정답 비율: 57.282%
...
move(num_disks, from_post, spare_post, to_post)
    if (num_disks == 0)
        return
    move(num_disks &ndash; 1, from_post, to_post, spare_post)
    print (&quot;Move disk &quot;, num_disks, &quot; from &quot;,
        from_post, &quot; to &quot;, to_post)
    move(num_disks &ndash; 1, spare_post, from_post, to_post)
</pre>
