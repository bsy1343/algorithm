...
시간 제한: 3 초  (하단 참고), 메모리 제한: 256 MB

### 통계

제출: 4696, 정답: 1623, 맞힌 사람: 1034, 정답 비율: 32.333%
...
<p dir="ltr">N&times;M 보드 위에서 할 수 있는 게임이 있다. 보드는 크기가 1&times;1인 정사각형 칸으로 나누어져&nbsp;있다. 보드의 각 칸은 빈 칸 또는 장애물이다. 장애물은 아래 그림에선 어두운 사각형으로 표시되어져 있다.</p>
