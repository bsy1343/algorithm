...
제출: 26734, 정답: 5144, 맞힌 사람: 3374, 정답 비율: 21.803%
...
<p>첫째 줄에는 (구역의 개수)/2 값 N과 특수 소대원의 수 W가 주어진다.&nbsp;(1 &le; N &le; 10000, 1 &le; W &le; 10000).</p>

<p>둘째 줄에는 1~N번째 구역에 배치된 적의 수가 주어지고, 셋째 줄에는 N+1 ~ 2N번째 구역에 배치된 적의 수가 공백으로 구분되어 주어진다. (1 &le; 각 구역에 배치된 최대 적의 수 &le; 10000) 단,&nbsp;한 구역에서 특수 소대원의 수보다 많은 적이 배치된 구역은 존재하지 않는다.&nbsp;(따라서, 각 구역에 배치된 최대 적의 수 &le; W)</p>
