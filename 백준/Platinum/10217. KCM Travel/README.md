...
제출: 34731, 정답: 2350, 맞힌 사람: 1312, 정답 비율: 9.749%
...
<p>각 테스트 케이스의 첫 줄에는 공항의 수 N (2 &le; N &le; 100), 총 지원비용 M (0 &le; M &le; 10,000), 티켓정보의 수 K (0 &le; K &le; 10,000)가 공백으로 구분되어 주어진다. 이어서 K개의 줄에 걸쳐 각 티켓의 출발공항 u, 도착공항 v (1 &le; u, v &le; N, u &ne; v), 비용 c (1 &le; c &le; M, 정수), 그리고 소요시간 d (1 &le; d &le; 1,000) 가 공백으로 구분되어 주어진다. 인천은 언제나 1번 도시이고, LA는 언제나 N번 도시이다</p>
