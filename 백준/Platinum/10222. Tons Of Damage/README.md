...
제출: 335, 정답: 58, 맞힌 사람: 44, 정답 비율: 20.952%

### 분류

수학, 다이나믹 프로그래밍, 조합론, 확률론, 기댓값의 선형성
...
<p>각 테스트 케이스는 5개의 정수로 구성되어 있으며, 한 줄에 순서대로 N (1 &le; N &le; 24), adt, adp, apt, app가 공백으로 구분되어 주어진다. adt, adp, apt, app의 단위는 퍼센트로 0이상 100이하이며, 그&nbsp;합이&nbsp;정확히 100이 된다.</p>
