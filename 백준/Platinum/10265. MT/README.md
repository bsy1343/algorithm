...
제출: 3179, 정답: 1035, 맞힌 사람: 655, 정답 비율: 34.492%
...
<p>첫 번째 줄에 사람 수 n과 버스에 태울 수 있는 사람 수 k가 주어진다.&nbsp;(1 &le; k &le; n &le; 1 000)</p>

<p>두 번째 줄에 n개의 정수 x<sub>i</sub> (i = 1, 2, ... , n,&nbsp;1 &le; x<sub>i</sub>&nbsp;&le; n)&nbsp;가 순서대로 주어진다.&nbsp;x<sub>i</sub>는 x<sub>i</sub>번째 사람이 버스에 타지 않는다면 i번째 사람 역시 버스에 타지 않음을 의미한다.</p>
