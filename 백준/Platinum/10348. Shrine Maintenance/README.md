...
<table style="height:204px; text-align:center; width:406px">
	<tbody>
		<tr>
			<td><img alt="optimal paths" src="/upload/images2/fig1.png" style="width:200px" /></td>
			<td><img alt="optimal paths" src="/upload/images2/fig3.png" style="width:225px" /></td>
			<td><img alt="optimal paths" src="/upload/images2/fig4.png" style="width:215px" /></td>
			<!--
