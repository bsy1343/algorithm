...
제출: 95, 정답: 64, 맞힌 사람: 42, 정답 비율: 65.625%
...
<p style="text-align: center;"><img alt="" src="/upload/images2/tunel(1).png" style="height:236px; width:305px" /></p>
...
<p>For each case, output &ldquo;Case #X: D M&rdquo; (without quotes) in a line where X is the case number, starting from 1, followed by a single space, the integer D is the minimal total cost of setting up the chinchilla running and chasing monitoring system such that there is at least one motion-sensitive camera along every possible route, and integer M is the maximum length of the lane where a motion-sensitive camera is to be installed.&nbsp;</p>