...
제출: 404, 정답: 137, 맞힌 사람: 116, 정답 비율: 33.048%
...
<p>Of course one can always &ldquo;partition&rdquo; the sequence into one single block (which is not very interesting). We want, however, to have as many blocks as possible. Consider for example the following sequences and its partitions:</p>
