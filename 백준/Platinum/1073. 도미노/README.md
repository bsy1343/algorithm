...
제출: 588, 정답: 249, 맞힌 사람: 215, 정답 비율: 54.020%
...
<p>안타깝게도, 장엄지가 조각 몇 개를 가지고 가버렸다. 따라서, 은진이는 은진이답게 남은 도미노 조각을 가지고 할 수 있는 게임을 생각했다. 바로 &ldquo;남은 도미노 조각을 가지고 사이클 콜렉션을 만들 수 있을까?&rdquo; 이다.</p>
...
<p>첫째 줄에 조각의 개수 N (1 &le; N &le; 45)이 주어진다. 둘째 줄부터 N개의 줄에는 각 조각이 주어진다. 조각은 2개의 숫자로 되어 있고, 앞에 있는 숫자는 항상 뒤에 있는 숫자보다 작다. 조각은 중복되지 않는다.</p>
