...
제출: 1968, 정답: 906, 맞힌 사람: 674, 정답 비율: 47.465%
...
<p>KOI 두부 공장에서 만들어내는 크기가 N &times; N (N &le; 11)인 두부모판이 있다. 이 모판을 1&times;1 크기의 단위두부가 2개 붙어있는 형태의 포장단위(즉, 1&times;2 혹은 2&times;1 크기)로 잘라서 판매한다. 그런데 두부제조 공정상 모판에 있는 각 단위두부의 품질은 A, B, C, F급으로 분류되고, 잘려진 포장단위의 두부 가격은 이 포장단위에 있는 두 개의 단위두부의 품질에 따라서 그림 1과 같이 정해진다</p>
