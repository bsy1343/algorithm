...
제출: 652, 정답: 322, 맞힌 사람: 279, 정답 비율: 51.476%
...
<p>각 테스트케이스의 첫 번째 줄에는 체크포인트의 수 N(2 &le; N &le; 200)과 간선의 수 M(1 &le; M &le; N(N-1)/2)가 주어진다.</p>

<p>각 테스트케이스의 두 번째 줄부터 M+1번째 줄까지 두 정수 x, y(1 &le; x, y &le; N)이 주어진다. 이는 x에서 y로 가는 길이 있다는 뜻이다.&nbsp;</p>
