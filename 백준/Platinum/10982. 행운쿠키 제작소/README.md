...
제출: 1638, 정답: 628, 맞힌 사람: 430, 정답 비율: 37.719%
...
<p>각 케이스의 첫 번째 줄에 철수가 가지고 있는 행운반죽의 개수 N(1 &le; N &le; 1,000)이 주어진다.</p>

<p>그 다음 N개의 줄에 각 행운반죽이 오븐 1에서 구워지는데 걸리는 시간 a<sub>i</sub>, 오븐 2에서 구워지는데 걸리는 시간 b<sub>i</sub>가 주어진다. (1 &le; a<sub>i</sub>, b<sub>i</sub> &le; 100)</p>
