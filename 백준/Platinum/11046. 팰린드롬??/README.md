...
제출: 2204, 정답: 717, 맞힌 사람: 537, 정답 비율: 33.774%
...
<p>각 질문은 두 정수 S와 E(1 &le; S &le; E &le; N)로 나타낼 수 있으며, S번째 수부터 E번째 까지&nbsp;수가 팰린드롬을 이루는지를 물어보며, 명우는 각 질문에 대해 팰린드롬이다 또는 아니다를 말해야 한다.</p>
...
<p>첫째 줄에 수열의 크기 N (1 &le; N &le; 1,000,000)이 주어진다.</p>
