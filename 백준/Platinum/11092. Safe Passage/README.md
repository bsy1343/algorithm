...
제출: 196, 정답: 121, 맞힌 사람: 96, 정답 비율: 59.259%
...
<p>The input is a single line beginning with an integer, 2 &le; N &le; 15. Following that are N positive integers that respectively represent the minimum time in which each person is able to cross the campus if alone; these times are measured in minutes, with each being at most 5 000. (It is a very large campus!)</p>
