...
제출: 17788, 정답: 6713, 맞힌 사람: 4015, 정답 비율: 35.346%
...
<p>첫째 줄에 두 정수 V(1&le;V&le;10,000), E(1&le;E&le;100,000)가 주어진다. 이는 그래프가 V개의 정점과 E개의 간선으로 이루어져 있다는 의미이다. 다음 E개의 줄에는 간선에 대한 정보를 나타내는 두 정수 A, B가 주어진다. 이는 A번 정점과 B번 정점이 연결되어 있다는 의미이며, 방향은 양방향이다.</p>
