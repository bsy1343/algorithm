...
제출: 6816, 정답: 3596, 맞힌 사람: 2478, 정답 비율: 51.722%
...
<p>첫째 줄에 변수의 개수 N (1 &le; N &le; 10,000)과 절의 개수 M (1 &le; M &le; 100,000)이 주어진다. 둘째 줄부터 M개의 줄에는 절이&nbsp;주어진다. 절은 두 정수 i와 j (1 &le; |i|, |j| &le; N)로 이루어져 있으며, i와 j가 양수인 경우에는 각각 \(x_i\), \(x_j\)를 나타내고, 음수인 경우에는 \(\lnot x_{-i}\), \(\lnot x_{-j}\)를 나타낸다.</p>
