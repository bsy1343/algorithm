...
제출: 318, 정답: 107, 맞힌 사람: 80, 정답 비율: 35.556%
...
<p>첫 번째 줄에 자연수 N (1 &le; N &le; 10<sup>6</sup>)이 주어진다.</p>
...
<ul>
	<li>세 번째 물체만 먹으면 5 &times; 1 = 5점</li>
	<li>두 번째, 세 번째 물체만 먹으면 ( - 1) &times; 1 + 5 &times; 2 = 9점</li>
	<li>모든 물체를 먹는다면 ( - 1) &times; 1 + ( - 1) &times; 2 + 5 &times; 3 = 12점</li>
</ul>