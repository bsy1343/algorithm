...
시간 제한: 1.5 초 (추가 시간 없음)  (하단 참고), 메모리 제한: 256 MB

### 통계

제출: 43693, 정답: 16622, 맞힌 사람: 8742, 정답 비율: 34.111%
...
<p>N(2 &le; N &le; 100,000)개의 정점으로 이루어진 트리가 주어진다. 트리의 각 정점은 1번부터 N번까지 번호가 매겨져 있으며, 루트는 1번이다.</p>

<p>두 노드의 쌍 M(1 &le; M &le; 100,000)개가 주어졌을 때, 두 노드의 가장 가까운 공통 조상이 몇 번인지 출력한다.</p>
