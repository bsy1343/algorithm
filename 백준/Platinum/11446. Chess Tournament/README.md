# [Platinum II] Chess Tournament - 11446
...
제출: 102, 정답: 31, 맞힌 사람: 20, 정답 비율: 23.810%

### 분류

이분 그래프, 해 구성하기, 다이나믹 프로그래밍, 플러드 필, 그래프 이론, 그래프 탐색, 배낭 문제
...
<ul>
	<li>One line with two space-separated integers N and M, denoting the number of players per team and the total number of matches that have been played. These satisfy 1 &le; N &le; 250 and N<sup>2</sup> &le; M &le; 10<sup>6</sup>.</li>
	<li>After that, M lines follow with two different space-separated integers A and B per line, indicating that players A and B have played a match against one another. These satisfy 1 &le; A &lt; B &le; 2N.</li>
</ul>
...
<ul>
	<li>One line with the number of solutions. As the number of solutions can be very large, you must reduce your answer modulo 10<sup>8</sup>. No answer &lt; 0 or &ge; 10<sup>8</sup> will be accepted.</li>
