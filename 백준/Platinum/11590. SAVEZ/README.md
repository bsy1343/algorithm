...
제출: 331, 정답: 122, 맞힌 사람: 62, 정답 비율: 24.219%
...
<p>Clarification of the first example: Prefix and suffix can intersect so subsequence is A &rarr; AA &rarr; AAA</p>

<p>Clarification of the third example: Strings in the subsequence are allowed to be equal so subsequence is A &rarr; A &rarr; A or B &rarr; B &rarr; B</p>