...
제출: 22239, 정답: 5490, 맞힌 사람: 3486, 정답 비율: 23.833%
...
<p>첫 줄에는 도시의 수 N(1 &le; N &le; 10,000)과 도로의 수 M(1 &le; M &le; 50,000)과 포장할 도로의 수 K(1 &le; K &le; 20)가 공백으로 구분되어 주어진다. M개의 줄에 대해 도로가 연결하는&nbsp;두 도시와 도로를 통과하는데 걸리는 시간이 주어진다. 도로들은 양방향 도로이며, 걸리는 시간은 1,000,000보다 작거나 같은 자연수이다.</p>
