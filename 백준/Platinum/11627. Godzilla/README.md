...
제출: 110, 정답: 34, 맞힌 사람: 27, 정답 비율: 29.032%
...
<p>Godzilla is rampaging through Tokyo again. Luckily, the Superior Defender Mech Force (SDMF) has sent its mech units to stop Godzilla&rsquo;s attack. Mech units are gigantic bipedal robots, usually piloted by Japanese teenagers, that carry weapons of superior destruction. The weapons are so powerful that one hit should neutralize the Godzilla threat.</p>
...
<ul>
	<li>One line containing two space-separated integers L (3 &le; L &le; 1000) and W (3 &le; W &le; 1000), the length and width of the map of Tokyo in sectors, respectively.</li>
	<li>W lines, containing L characters, describing the map of Tokyo. The characters are:
	<ul>
		<li>&lsquo;.&rsquo;: a non-residential sector;</li>
		<li>&lsquo;R&rsquo;: a residential sector;</li>
		<li>&lsquo;G&rsquo;: the starting position of Godzilla. This is always a non-residential sector;</li>
		<li>&lsquo;M&rsquo;: the starting position of a mech unit. This is always a non-residential sector.</li>
	</ul>
	</li>
</ul>
