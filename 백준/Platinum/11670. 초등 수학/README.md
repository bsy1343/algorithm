...
제출: 739, 정답: 340, 맞힌 사람: 284, 정답 비율: 44.795%
...
<p>첫째 줄에 순서쌍의 개수 n (1 &le; n &le; 2 500)이 입력된다.</p>

<p>다음 n개의 줄에 걸쳐서 순서쌍 a,b (&minus;10<sup>6</sup> &le; a, b &le; 10<sup>6</sup>)가 입력된다.</p>

### 출력

<p>입력과 같은 순서대로 (a,b) 순서쌍이 유효한 방정식과 함께 출력된다. 각각의 방정식은 5개의 요소로 나뉜다. a와 3개의 연산자(+ 혹은 - 혹은  *)중 하나, b 그리고 = 와 연산결과이다. 모든 연산결과는 달라야한다.</p>

<p>만약 출력 할 수 있는 답이 여러개라면 아무거나 출력하고, 답이 없다면 &ldquo;impossible&rdquo; 을 출력한다.</p>