...
제출: 14196, 정답: 1480, 맞힌 사람: 771, 정답 비율: 13.381%
...
<p>첫 줄에는 정점의 수 N(1 &le; N &le; 1,000)이 주어진다. 그리고 다음 N개의 줄에 대해 인접행렬의 정보가 주어진다. i+1번째 줄에는 i번 정점에 대한 인접행렬이 주어진다.&nbsp;두 정점 사이에&nbsp;간선이 여러 개 있을 수 있다. 인접행렬의 값은 두 정점 사이의 간선 개수를 의미하며, 0보다 크거나 같고, 10보다 작거나 같은 정수이다.</p>
