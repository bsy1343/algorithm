...
제출: 11581, 정답: 1523, 맞힌 사람: 832, 정답 비율: 13.033%
...
<p>이 문제에서 다루는 2048 게임은 보드의 크기가 N&times;N 이다. 보드의 크기와 보드판의 블록 상태가 주어졌을 때, 최대 10번 이동해서 만들 수 있는 가장 큰 블록의 값을 구하는 프로그램을 작성하시오.</p>
