# [Platinum IV] Fairland (Large) - 12130

[문제 링크](https://www.acmicpc.net/problem/12130)
...
제출: 56, 정답: 11, 맞힌 사람: 10, 정답 비율: 21.739%

### 분류

다이나믹 프로그래밍, 그래프 이론, 그래프 탐색, 트리, 누적 합, 너비 우선 탐색, 깊이 우선 탐색, 트리에서의 다이나믹 프로그래밍
...
<ul>
	...
	<li>1 &le;&nbsp;<strong>D</strong>&nbsp;&le; 10<sup>6</sup>.</li>
	<li>1 &le;&nbsp;<strong>R<sub>s</sub></strong>,&nbsp;<strong>R<sub>m</sub></strong>&nbsp;&le; 10<sup>6</sup>.</li>
</ul>
</div>
