...
제출: 1407, 정답: 356, 맞힌 사람: 243, 정답 비율: 31.114%
...
<p>첫 줄에는 주식의 개수 C(1 &le; C &le; 50)과 주식 매입 및 매각을 할 기간 D(2 &le; D &le; 10), 초기 자금 M(1 &le; M &le; 200,000)이 공백으로 구분되어 주어진다. 두 번째 줄부터 C+1번째 줄까지 각 줄에는 각각 주식이 날짜에 따라 변하는 값이 입력된다.&nbsp;주식 가격은 1 이상 1,000 이하이다.</p>
