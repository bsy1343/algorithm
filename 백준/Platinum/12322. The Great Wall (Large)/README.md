# [Platinum II] The Great Wall (Large) - 12322

[문제 링크](https://www.acmicpc.net/problem/12322)
...
제출: 42, 정답: 10, 맞힌 사람: 9, 정답 비율: 36.000%

### 분류

구현, 자료 구조, 세그먼트 트리, 시뮬레이션, 느리게 갱신되는 세그먼트 트리, 값 / 좌표 압축
...
<ul>
	...
	<li>1 &le; <strong>n</strong><strong><sub>i</sub></strong> &le; 1000.</li>
	<li>-10<sup>6</sup> &le; <strong>w</strong><strong><sub>i</sub></strong> &lt; <strong>e</strong><strong><sub>i</sub></strong> &le; 10<sup>6</sup>.</li>
	<li>-10<sup>5</sup> &le; <strong>delta_p</strong><strong><sub>i</sub></strong> &le; 10<sup>5</sup>.</li>
</ul>
