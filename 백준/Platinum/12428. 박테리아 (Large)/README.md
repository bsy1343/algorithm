...
제출: 94, 정답: 46, 맞힌 사람: 36, 정답 비율: 52.174%
...
<pre>
N M K
B<sub>1,1,1</sub>B<sub>1,2,1</sub> &hellip; B<sub>1,M,1</sub>
B<sub>2,1,1</sub>B<sub>2,2,1</sub> &hellip; B<sub>2,M,1</sub>
&hellip;
B<sub>N,1,1</sub>B<sub>N,2,1</sub> &hellip; B<sub>N,M,1</sub>
&hellip;
B<sub>N,1,K</sub>B<sub>N,2,K</sub> &hellip; B<sub>N,M,K</sub></pre>

<p>여기서&nbsp;<strong>N</strong>은 건물 한 층의 행 수,&nbsp;<strong>M</strong>은 건물 한 층의 열 수,&nbsp;<strong>K</strong>는 건물의 층 수를 나타낸다.&nbsp;<strong>B<sub>i,j,k</sub></strong>는 &lsquo;.&rsquo; 인 경우 해당 칸이 비어있음을, &lsquo;#&rsquo;인 경우 해당 칸이 벽임을 나타내며, 한 층에서 가로/세로로 인접한 빈 칸들은 하나의 방에 속한다. 예를 들어 다음과 같은 구조의 층에는 A, B, C 세 개의 방이 있다. 하나의 방이 두 개 이상의 층에 걸쳐있는 경우는 없다.</p>
...
<ul>
	...
	<li>1 &le;&nbsp;<strong>N</strong>,&nbsp;<strong>M</strong>&nbsp;&le; 20.</li>
	<li>1 &le;&nbsp;<strong>K</strong>&nbsp;&le; 50.</li>
</ul>
