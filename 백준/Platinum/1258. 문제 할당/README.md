...
제출: 576, 정답: 324, 맞힌 사람: 247, 정답 비율: 67.486%
...
<p>첫째 줄에는 N(1 &le; N &le; 100)이 주어지고, 둘째 줄부터 N개의 줄에 걸쳐 각 학생이 N개의 문제를 푸는 데 걸리는 시간을 나타내는 N개의 정수가 순서대로 주어진다. 주어지는 모든 정수는 1,000을 넘지 않는다.</p>
