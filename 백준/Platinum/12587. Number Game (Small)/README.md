# [Platinum V] Number Game (Small) - 12587

[문제 링크](https://www.acmicpc.net/problem/12587)
...
<ul>
	...
	<li><strong style="font-size:13px">A<sub>2</sub></strong><span style="font-size:13px">&nbsp;-&nbsp;</span><strong style="font-size:13px">A<sub>1</sub></strong><span style="font-size:13px">&nbsp;&le; 30.</span></li>
	<li><strong>B<sub>2</sub></strong>&nbsp;-&nbsp;<strong>B<sub>1</sub></strong>&nbsp;&le; 30.</li>
</ul>
