# [Platinum V] Millionaire (Small) - 12691

[문제 링크](https://www.acmicpc.net/problem/12691)
...
제출: 39, 정답: 27, 맞힌 사람: 20, 정답 비율: 68.966%
...
<ul>
	...
	<li>1 &le;&nbsp;<strong>M</strong>&nbsp;&le; 5</li>
</ul>
...
<p>In the first case, the only way to reach \$1000000 is to bet everything in the single round.<br />
<br />
In the second case, you can play so that you can still reach \$1000000 even if you lose a bet. Here&#39;s one way to do it:</p>
