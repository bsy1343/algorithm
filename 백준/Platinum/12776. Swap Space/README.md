...
제출: 1085, 정답: 382, 맞힌 사람: 287, 정답 비율: 34.126%
...
<p>The input begins with a line containing one integer n (1 &le; n &le; 10<sup>6</sup>), which is the number of drives in your cluster. Following this are n lines, each describing a drive as two integers a and b, where a is the capacity with the old file system and b is the capacity with the new file system.</p>

<p>All capacities are given in gigabytes and satisfy 1 &le; a, b &le; 10<sup>9</sup>. (One thousand petabytes should be enough for everyone, right?)</p>
