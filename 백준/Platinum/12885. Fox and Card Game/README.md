...
제출: 78, 정답: 53, 맞힌 사람: 50, 정답 비율: 79.365%
...
<p>첫 번째 줄에는 카드 묶음의 개수 n (1 &le; n &le; 100)이 입력으로 주어진다.</p>

<p>다음 n개의 줄에는 각각 자연수 s<sub>i</sub>와, s<sub>i</sub>개의 자연수 c<sub>ij</sub>가 주어진다. (1 &le; s<sub>i</sub> &le; 100; 1 &le; c<sub>ij </sub>&le; 1000) 이는 i번째 카드 묶음에 카드가 총 s<sub>i</sub>장 있으며, 그 순서가 입력으로 주어진 순서와 같다는 것이다. 처음 주어진 자연수가 카드 묶음의 맨 위에, 마지막에 주어진 자연수가 맨 아래 있는 카드이다.</p>
