...
시간 제한: 7 초, 메모리 제한: 4 MB (추가 메모리 없음)

### 통계

제출: 779, 정답: 322, 맞힌 사람: 196, 정답 비율: 41.438%
...
<p>첫째 줄에는 4개의 정수 N, x0, a, b가 주어집니다. (1 &le; N &le; 2,000,000, 0 &le; x0, a, b &le; 1,000,000,006)</p>

<p>둘째 줄에는 쿼리의 개수 Q이 주어집니다. (1 &le; Q &le; 1000)</p>

<p>셋째 줄에는 쿼리의 각 원소를 나타내는 Q개의 정수가 주어집니다. (0 &le; q &le; N-1)</p>
