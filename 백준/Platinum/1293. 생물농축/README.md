...
제출: 172, 정답: 66, 맞힌 사람: 41, 정답 비율: 35.652%
...
<p style="text-align: center;"><img alt="" src="/upload/201004/sang.bmp" /></p>
...
<p>첫째 줄에 생물 종의 수 N이 주어진다. (1 &le; N &le; 1,000) 이어서 N개의 줄에 걸쳐 세 자연수 C[i], H[i], E[i]가 주어지는 데, C[i](0 &le; C[i] &le; 10,000)는 i번 생물이 섭취해야 할 칼로리를, H[i](1 &le; H[i] &le; 10,000)는 i번 생물이 섭취할 수 있는 최대 중금속 양을, E[i](1 &le; E[i] &le; 10,000)는 다른 생물이 i번 생물을 먹었을 때 얻을 수 있는 칼로리를 가리킨다.</p>

<p>다음 줄에는 천적관계의 수 M이 주어진다. (1 &le; M &le; 10,000) 이어서 M개의 줄에 걸쳐 각 줄에 N 이하의 서로 다른 두 자연수가 &quot;a b&quot;의 형태로 주어지는데, 이는 a번 생물이 b번 생물에게 먹힌다는 것을 의미한다.</p>
