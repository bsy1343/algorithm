...
제출: 1325, 정답: 699, 맞힌 사람: 556, 정답 비율: 50.962%
...
<p>첫째 줄에 도시의 수 N과 도로의 수 M이 주어진다. (2 &le; N &le; 2000, 0 &le; M &le; 2000)</p>

<p>둘째 줄부터 M개의 줄에는 도로의 정보 a, b가 0번 도로부터 순서대로 주어진다. (0 &le; a, b &lt; N, a &ne; b) 같은 도로가 여러 번 주어지는 경우는 없다.</p>
