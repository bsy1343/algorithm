...
제출: 324, 정답: 23, 맞힌 사람: 17, 정답 비율: 9.239%
...
<p>입력의 첫 번째 줄에는 참가자 수 N이 주어진다. (1 &le; N &le; 200,000)</p>

<p>다음 N개의 줄에는 참가자의 정보가 주어진다. i번째 줄에는 참가자의 정보를 나타내는 두 자연수 s<sub>i</sub>와 r<sub>i</sub>가 주어진다. (1 &le; s<sub>i</sub>, r<sub>i </sub>&le; 10,000)</p>
