...
제출: 117, 정답: 49, 맞힌 사람: 46, 정답 비율: 48.421%
...
<p style="text-align: center;"><img alt="" src="%EB%B0%B1%EC%A4%80/Platinum/13005.%E2%80%85%ED%96%89%EB%B3%B5%ED%95%9C%E2%80%85%EB%82%98%EB%AC%B4/5c476c88.png" data-original-src="%EB%B0%B1%EC%A4%80/Platinum/13005.%E2%80%85%ED%96%89%EB%B3%B5%ED%95%9C%E2%80%85%EB%82%98%EB%AC%B4/5c476c88.png" data-original-src="https://onlinejudgeimages.s3-ap-northeast-1.amazonaws.com/problem/13005/1.png" onerror="this.onerror=null;this.src=this.dataset.originalSrc" style="height:463px; width:470px" /></p>

### 입력

<p>첫 줄에 나무의 노드의 개수 N(1 &le; N &le; 100,000)이 주어진다. 두 번째 줄에는 1번 노드부터 N번 노드에 쓰여있는 숫자 a<sub>i</sub>(1 &le; N &le; 1,000,000,000)가 N개 주어진다. 다음 N - 1개의 줄에는 각 노드들을 잇는 간선의 정보가 들어온다. i번째 간선 정보는 각각 p<sub>i</sub>(1 &le; p<sub>i</sub> &le; N)와 c<sub>i</sub>(-1,000,000,000 &le; c<sub>i</sub> &le; 1,000,000,000)를 가지는데, 이때 (i + 1)번 노드는 p<sub>i</sub>노드와 연결되어 있고 해당 간선에 쓰인 숫자는 c<sub>i</sub>가 된다.</p>
