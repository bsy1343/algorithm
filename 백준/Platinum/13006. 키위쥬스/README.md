...
제출: 269, 정답: 89, 맞힌 사람: 71, 정답 비율: 36.410%
...
<p>첫 줄에 병의 개수 N(1 &le; N &le; 15), 병의 최대용량 C(1 &le; C &le; 49)가 주어진다. 두 번째 줄에는 N개의 병에 담긴 키위쥬스의 현재 용량 B<sub>i</sub>(0 &le; B<sub>i</sub> &le; C)가 주어진다. 세 번째 줄에는 (C + 1)개의 각 용량마다의 가격 P<sub>i</sub>(0 &le; P<sub>i</sub> &le; 1000000)가 주어진다. P<sub>i</sub>가 주어지는 순서는 0리터부터 C리터까지 순차적이다.</p>
