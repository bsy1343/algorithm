...
제출: 697, 정답: 125, 맞힌 사람: 63, 정답 비율: 14.450%
...
<p>첫째 줄에 정점의 개수 N, 간선의 개수 M, 특수 능력을 사용할 수 있는 횟수 C가 주어진다. (1 &le; N &le; 50, 1 &le; M &le; 2500, 0 &le; C &le; 1,000)</p>

<p>둘째 줄부터 M개의 줄에 간선의 정보 from, to, cost가 주어진다. (1 &le; from, to &le; N, 0 &le; cost &le; 100,000) from은 간선의 시작점, to는 간선의 도착점이다.</p>
