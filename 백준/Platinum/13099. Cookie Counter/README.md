...
제출: 51, 정답: 27, 맞힌 사람: 26, 정답 비율: 60.465%
...
<p>The input consists of multiple datasets. The number of datasets is no more than 100. For each dataset, three numbers N (1 &le; N &le; 2,000), D (1 &le; D &le; 10<sup>12</sup>) and X (1 &le; X &le; 2,000) are written in a line and separated by a space. The end of input is denoted by a line that contains three zeros.</p>
