...
제출: 154, 정답: 73, 맞힌 사람: 60, 정답 비율: 51.282%

### 분류

수학, 브루트포스 알고리즘, 누적 합, 값 / 좌표 압축
...
<p>첫 번째 줄에는 투표를 한 유권자의 수 N이 주어진다. (2 &le; N &le; 1,000)</p>

<p>두 번째 줄부터 N개의 줄에는 각 유권자가 체키와 차카에게 던진 표의 개수 A<sub>i</sub>, B<sub>i</sub>가 주어진다. 이때 B<sub>i</sub>의 합이 A<sub>i</sub>의 합보다 큰 데이터만 주어진다. (0 &le; A<sub>i</sub>, B<sub>i</sub>&nbsp;이고&nbsp;1 &le; A<sub>i</sub> + B<sub>i</sub> &le; 100,000)</p>
...
<p>X = 6, 9 &le; Y &le; 100,000일 때만 체키가 당선된다.</p>