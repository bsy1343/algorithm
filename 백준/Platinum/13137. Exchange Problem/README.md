...
제출: 711, 정답: 209, 맞힌 사람: 162, 정답 비율: 39.225%
...
<ul>
	<li>거스름돈 C원을 액면이 P<sub>1</sub>, P<sub>2</sub>, &hellip;, P<sub>N</sub>인 동전으로 바꿀 때, 최소 몇 개의 동전이 필요한가?</li>
</ul>
...
<p>첫 번째 줄에는 동전 단위의 수 N이 주어진다. (1 &le; N &le; 100)</p>

<p>두 번째 줄에는 동전의 단위 액면 값 P<sub>1</sub>, P<sub>2</sub>, &hellip;, P<sub>N</sub>이 주어진다. 단, 1 = P<sub>1</sub> &lt; P<sub>2</sub> &lt; &hellip; &lt; P<sub>N</sub> &le; 100,000을 만족한다.</p>
