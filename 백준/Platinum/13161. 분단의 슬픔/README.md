...
제출: 6038, 정답: 1735, 맞힌 사람: 831, 정답 비율: 22.459%
...
<p>첫 번째 줄에는 UCPC 구성원의 수 N(1 &le; N &le; 500)이 주어진다. 두 번째 줄에는 N개의 정수가 주어지는데, i번째 수가 1이면 i번 사람은 무조건 A진영에 들어가야 함을, 2라면 무조건 B진영에 들어가야 함을, 0이면 어느 진영에 들어가든지 상관 없다는 것을 의미한다.</p>
