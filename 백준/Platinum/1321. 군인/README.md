...
제출: 2943, 정답: 1484, 맞힌 사람: 1171, 정답 비율: 53.107%
...
<p>첫째 줄에 부대의 개수 N(1 &le; N &le; 500,000)이 주어지고, 이어서 각 부대의 군사 수를 나타내는 정수가 N개 주어진다. 각 부대의 군사 수는 1000보다 작거나 같은 자연수이다.&nbsp;그 다음 줄에 명령의 개수 M(1 &le; M &le; 10,000)개가 주어지고, 이어서 M줄에 걸쳐 명령이 주어진다.</p>
