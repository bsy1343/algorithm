...
제출: 1492, 정답: 498, 맞힌 사람: 391, 정답 비율: 37.924%
...
<ol>
	<li>(0, 40) &rarr; (20, 40) &rarr; (20, 50) &rarr; (35, 50) &rarr; (35, 60) &rarr; (70, 60)</li>
	<li>(0, 40) &rarr; (20, 40) &rarr; (20, 50) &rarr; (35, 50) &rarr; (35, 40) &rarr; (70, 40)</li>
	<li>(0, 40) &rarr; (20, 40) &rarr; (20, 30) &rarr; (50, 30) &rarr; (50, 40) &rarr; (70, 40)</li>
...
<p>표준 입력으로 다음 정보가 주어진다. 첫 번째 줄에는 장애물의 개수를 나타내는 정수 N (1 &le; N &le; 100,000)이 주어진다. 다음 줄에는 출발지점의 y 좌표와 결승선의 x 좌표를 나타내는 두 정수가 차례로 주어진다. 이어지는 N 개의 줄 각각엔 장애물의 정보를 나타내는 세 정수 [x, y<sub>l</sub>, y<sub>h</sub>] (y<sub>l</sub> &lt; y<sub>h</sub>)가 차례로 주어진다. 문제에서 사용되는 모든 좌표 (x, y)에 대해, 0 &le; x &le; 1,000,000이고 0 &le; y &le; 2,000,000이다. 모든 장애물의 x 좌표는 0보다 크고 결승선의 x 좌표보다 작다.</p>
