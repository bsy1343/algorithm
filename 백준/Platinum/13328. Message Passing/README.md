...
제출: 994, 정답: 424, 맞힌 사람: 325, 정답 비율: 43.624%
...
<p>Your program is to read from standard input. The input contains two integers, d and t (2 &le; d &le; 50, 1 &le; t &le; 2,000,000,000), where d represents the number of employees to which an employee can make calls, and t represents the time that has been passed since the message passing started.</p>
