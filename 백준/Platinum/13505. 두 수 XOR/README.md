...
제출: 2794, 정답: 1581, 맞힌 사람: 1078, 정답 비율: 58.907%
...
<p>즉, A<sub>1</sub>, A<sub>2</sub>, ..., A<sub>N</sub> 중에서 i &ne; j이면서&nbsp;A<sub>i</sub> XOR A<sub>j</sub> 가 가장 큰 것을 찾아야 한다.</p>

### 입력

<p>첫째 줄에 N (2&nbsp;&le; N &le; 100,000)이 주어진다.</p>
