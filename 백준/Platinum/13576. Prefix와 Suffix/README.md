...
제출: 1818, 정답: 774, 맞힌 사람: 567, 정답 비율: 40.762%
...
<ul>
	<li>문자열 S의 부분 문자열 S[i..j] (1 &le; i &le; j &le; |S|)는 S<sub>i</sub>S<sub>i+1</sub>...S<sub>j</sub> 이다.</li>
	<li>문자열 S의 길이가 l (1 &le; l &le; |S|)인 Prefix는 S[1..l] 이다.</li>
	<li>문자열 S의 길이가 l (1 &le; l &le; |S|)인 Suffix는 S[|S|-l+1..|S|] 이다.</li>
</ul>
...
<p>첫째 줄에 문자열 S가 주어진다. (1 &le; |S| &le; 100,000)</p>
