...
제출: 1578, 정답: 525, 맞힌 사람: 415, 정답 비율: 31.416%
...
<p>The first line contains an integer T &le; 10, number of test cases. Then for each test case:</p>

<p>The first line of the test case contains three integers 1 &le; N &le; 100 000, 1 &le; Q &le; 50 000, 1 &le; R &le; N, denote number of cities, number of queries, and an initial capital city in respective order.</p>

<p>Each of next N - 1 lines gives an information of a sky way. It contains two integers 1 &le; A &le; N and 1 &le; B &le; N, A &ne; B, there is a sky way connects A and B.</p>

<p>Each of next Q lines gives an information about query. It contains two integers 0 &le; S &le; 1 and 1 &le; U &le; N.</p>
