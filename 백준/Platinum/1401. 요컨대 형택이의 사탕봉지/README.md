# [Platinum III] 요컨대 형택이의 사탕봉지 - 1401

[문제 링크](https://www.acmicpc.net/problem/1401)
...
제출: 58, 정답: 17, 맞힌 사람: 16, 정답 비율: 44.444%

### 분류

애드 혹, 브루트포스 알고리즘, 많은 조건 분기, 수학, 런타임 전의 전처리

### 문제 설명

<p>요컨대 형택이는 사탕을 좋아한다. 이제 이 사탕을 보관하기 위해, 형택이는 요컨대 N개의 사탕 봉지를 만들었다. 그런데 형택이는 서로 다른 사탕 봉지에 같은 개수의 사탕이 들어있는 것을 요컨대 끔찍이도 싫어한다.</p>
...
<p>첫째 줄에 데이터 케이스의 개수 D가 주어진다. (1&le;D&le;100) 둘째 줄부터 D개의 줄에 걸쳐 각각의 케이스의 경우 N이 주어진다. (1&le;N&le;1,000,000)</p>
