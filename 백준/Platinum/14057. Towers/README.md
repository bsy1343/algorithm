...
제출: 71, 정답: 32, 맞힌 사람: 27, 정답 비율: 42.857%
...
<p>Two space separated positive integers are given on the first row of the standard input: N and K &ndash; the number of buildings and the number of offered towers.</p>
...
<p>The third row consists of K space separated positive integers &ndash; the heights of the offered towers.</p>

### 출력

<p>The program should write on a single row of the standard output K space separated non-negative integers: for each offer in the third input row &ndash; the maximal number of buildings which would receive messages, if the tower were built, assuming optimal placement.</p>
...
<ul>
	...
	<li>1 &le; height of each building and offered tower &le; 10<sup>9</sup></li>
</ul>
