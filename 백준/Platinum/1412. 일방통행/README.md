...
제출: 790, 정답: 385, 맞힌 사람: 316, 정답 비율: 48.024%
...
<p>첫째 줄에 도시의 개수 N(2 &le; N &le; 50) 이 주어진다.&nbsp; 둘째 줄부터 N개의 줄에 도로의 정보가 주어진다. 인접행렬처럼 주어진다. i행 j열이 의미하는 정보는 Y 또는 N인데, Y일 때는 i에서 j으로 가는 도로가 있다는 소리고, N일 때는 없다는 소리다. i번 행의 i번 열에 있는 문자는 항상 N이다.</p>
