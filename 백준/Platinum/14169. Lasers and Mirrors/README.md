...
제출: 562, 정답: 241, 맞힌 사람: 161, 정답 비율: 39.851%

### 분류

그래프 이론, 그래프 탐색, 너비 우선 탐색, 최단 경로, 데이크스트라, 값 / 좌표 압축
...
<p>The next N lines each contain the x and y locations of a fence post, both integers in the range 0&hellip;1,000,000,000.</p>
