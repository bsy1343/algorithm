...
제출: 861, 정답: 462, 맞힌 사람: 331, 정답 비율: 49.774%
...
<p>q<sub>1</sub>, q<sub>2</sub>, ..., q<sub>K</sub>는 항상 양수이며, &Sigma;q<sub>i</sub> = n 이다.</p>
...
<p>모든 i번 사람과 j번 사람 사이에는 어색한 정도 u<sub>ij</sub>가 정의되어 있다. u<sub>ij</sub> = u<sub>ji</sub>이며, 모든 1 &le; i &le; N에 대해서, u<sub>ii</sub> = 0이다.</p>
...
<p>첫째 줄에 사람의 수 N과 열차의 수 K가 주어진다. (1 &le; N &le; 4000, 1 &le; K &le; min(N, 800))이 주어진다.</p>

<p>둘째 줄부터 N개의 줄에는 N개의 정수가 주어지며, 이것은 행렬 u (0 &le; u<sub>ij</sub> &le; 9, u<sub>ij</sub> = u<sub>ji</sub>, u<sub>ii</sub> = 0)을 나타낸다.</p>
