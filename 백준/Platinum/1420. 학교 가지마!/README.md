...
시간 제한: 2 초, 메모리 제한: 160 MB

### 통계

제출: 6542, 정답: 1833, 맞힌 사람: 1298, 정답 비율: 25.723%
...
<p>도현이가 사는 도시는 N&times;M 크기의 모양이며, 1&times;1칸으로 나누어져 있다. 각 칸은 빈 칸 또는 벽이다.</p>
...
<p>첫째 줄에 도시의 세로 크기 N과 가로 크기 M이 주어진다. (1 &le; N, M &le; 100) 둘째 줄부터 N개의 줄에 도시의 모양이 주어진다. 비어있으면 점(&#39;.&#39;), 벽은 &#39;#&#39;, 도현이의 위치는 K, 학교의 위치는 H이다. K와 H는 하나만 주어진다.</p>
