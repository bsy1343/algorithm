...
제출: 3075, 정답: 1902, 맞힌 사람: 1559, 정답 비율: 62.762%
...
<p>첫 번째 줄에 수열의 크기 n (0 &lt; n &le; 500,000)이 주어진다.</p>

<p>두 번째 줄에 수열의 원소가 0번부터 n - 1번까지 차례대로 주어진다. 수열의 원소는 100,000보다 크지 않은 음이 아닌 정수이다.</p>

<p>세 번째 줄에 여러분이 수행할 쿼리의 개수 m (0 &lt; m &le; 500,000)이 주어진다.</p>

<p>그 다음 m개의 줄에는 t로 시작하는 쿼리가 주어진다. t가 1이면 a, b, c를 입력받아 구간 [a, b]의 각 원소에 c를 xor한다.(0 &le; a &le; b &lt; n, 0 &le; c &le; 100,000) t가 2 이면 a를 입력받아 a번째 원소의 값을 출력한다. (0 &le; a &lt; n)</p>
