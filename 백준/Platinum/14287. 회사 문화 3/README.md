...
제출: 2483, 정답: 1283, 맞힌 사람: 998, 정답 비율: 51.390%
...
<ul>
	<li><code>1 i w</code>: i번째 직원이 직속 부하 중 한 명으로부터 w만큼 칭찬을 받는다. (1 &le; i &le; n, 1 &le; w &le; 1,000) 부하가 없다면 입력으로 들어오지 않는다.</li>
	<li><code>2 i</code>: i번째 직원이 칭찬을 받은 정도를 출력한다. (1 &le; i &le; n)</li>
</ul>
...
<p>첫째 줄에는 회사의 직원 수 n명, 쿼리의 개수 m이 주어진다. 직원은 1번부터 n번까지 번호가 매겨져 있다. (2 &le; n, m &le; 100,000)</p>
