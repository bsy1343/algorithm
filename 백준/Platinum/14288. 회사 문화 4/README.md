...
제출: 1289, 정답: 802, 맞힌 사람: 695, 정답 비율: 67.280%
...
<ul>
	<li><code>1 i w</code>: i번째 직원이 직속 상사로부터 w만큼 칭찬을 받는다. 만약, 칭찬의 방향이 상사 방향이라면, i번째 직원이 직속 부하 중 한 명으로부터 w만큼 칭찬을 받는다. (1 &le; i &le; n, 1 &le; w &le; 1,000)</li>
