# [Platinum I] Rebel Against The Empire (Large) - 14352

[문제 링크](https://www.acmicpc.net/problem/14352)

### 성능 요약

시간 제한: 30 초, 메모리 제한: 512 MB

### 통계

제출: 20, 정답: 7, 맞힌 사람: 5, 정답 비율: 38.462%

### 분류

수학, 그래프 이론, 그래프 탐색, 기하학, 이분 탐색, 너비 우선 탐색, 피타고라스 정리
...
<ul>
	...
	<li>-500 &le;&nbsp;<strong>x<sub>i</sub></strong>&nbsp;&le; 500.</li>
	<li>-500 &le;&nbsp;<strong>y<sub>i</sub></strong>&nbsp;&le; 500.</li>
	<li>-500 &le;&nbsp;<strong>z<sub>i</sub></strong>&nbsp;&le; 500.</li>
	<li>-500 &le;&nbsp;<strong>V<sub>xi</sub></strong>&nbsp;&le; 500.</li>
	<li>-500 &le;&nbsp;<strong>V<sub>yi</sub></strong>&nbsp;&le; 500.</li>
	<li>-500 &le;&nbsp;<strong>V<sub>zi</sub></strong>&nbsp;&le; 500.</li>
</ul>
