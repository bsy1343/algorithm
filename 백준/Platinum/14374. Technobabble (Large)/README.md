# [Platinum I] Technobabble (Large) - 14374

[문제 링크](https://www.acmicpc.net/problem/14374)
...
제출: 39, 정답: 29, 맞힌 사람: 27, 정답 비율: 77.143%

### 분류

자료 구조, 그래프 이론, 문자열, 집합과 맵, 해시를 사용한 집합과 맵, 최대 유량, 이분 매칭
