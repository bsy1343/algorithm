...
제출: 3321, 정답: 1332, 맞힌 사람: 1089, 정답 비율: 38.332%
...
<p>첫 줄에 학생의 수 N, 알고리즘의 수 K, 문제에 설명한 D가 주어진다. (1 &le; N &le; 10<sup>5</sup>, 1 &le; K &le; 30, 0 &le; D &le; 10<sup>9</sup>)</p>

<p>이어 N명의 학생에 대한 정보가 아래와 같이 주어진다.</p>

<ul>
	<li>M d (0 &le; M &le; K, 0 &le; d &le; 10<sup>9</sup>): 해당 학생이 알고 있는 알고리즘의 수, 해당 학생의 실력</li>
	<li>다음 줄에, M개의 정수 A<sub>i</sub>: 해당 학생이 알고 있는 알고리즘들 (1 &le; A<sub>i</sub> &le; K)</li>
</ul>
