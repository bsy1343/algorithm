# [Platinum I] 도미노 (Large) - 14587

[문제 링크](https://www.acmicpc.net/problem/14587)
...
제출: 553, 정답: 128, 맞힌 사람: 104, 정답 비율: 27.225%
...
<p>첫째 줄에 N이 주어진다. (1 &le; N &le; 500,000)</p>

<p>둘째 줄부터 N개의 줄에는 각 도미노의 위치와 높이를 나타내는 2개의 정수 X<sub>i</sub>와 H<sub>i</sub>가 주어진다.&nbsp;(1 &le; X<sub>i</sub>, H<sub>i</sub> &le; 2,000,000,000)</p>
