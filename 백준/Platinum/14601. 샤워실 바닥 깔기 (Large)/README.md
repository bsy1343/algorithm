...
제출: 2416, 정답: 1335, 맞힌 사람: 1102, 정답 비율: 55.882%
...
<p>첫 번째 줄에는 바닥의 한 변의 길이를 표현하는 자연수 K(1 &le; K &le; 7) 가 주어진다. 이때 바닥의 크기는 2<sup>K</sup> 가 됨에 유의하라. 두 번째 줄에는 배수구의 위치를 나타내는 자연수 x, y (1 &le; x, y &le; 2<sup>K</sup>)가 공백으로 분리돼서 주어진다. 이때 가장 왼쪽 아래가 (1, 1), 가장 오른쪽 위가 (2<sup>K</sup>, 2<sup>K</sup>)이다.</p>
