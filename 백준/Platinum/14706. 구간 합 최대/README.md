...
제출: 288, 정답: 110, 맞힌 사람: 83, 정답 비율: 37.900%
...
<p>첫 번째 줄에 배열을 구성하는 정수의 개수 N(1 &le; N &le; 200, 000)과 특별한 조건의 개수 M(1 &le; M &le; 200)이 주어진다.</p>

<p>두 번째 줄부터 M 개의 줄에 걸쳐 특별한 조건을 의미하는 두 정수 L<sub>i</sub> 와 S<sub>i</sub> 가 주어진다. (1 &le; i &le; M, 1 &le; L<sub>i</sub> &le; N, 1 &le; S<sub>i</sub> &le; 10<sup>9</sup>)</p>
