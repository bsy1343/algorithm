...
제출: 2354, 정답: 1002, 맞힌 사람: 885, 정답 비율: 53.378%
...
<p>히스토그램을 구성하는 직사각형의 개수 N(1 &le; N &le; 100,000)이 주어진다. 이어 N개의 줄에 걸쳐 각 직사각형의 높이인 정수 H<sub>i</sub>(1 &le; H<sub>i</sub> &le; 1,000,000)가 주어진다.</p>
