...
제출: 301, 정답: 100, 맞힌 사람: 91, 정답 비율: 39.394%
...
<p>Your program is to read from standard input. The first line contains an integer, n, representing the number of vertices of the input tree, where 2 &le; n &le; 100,000. It is followed by n - 1 lines, each contains two positive integers u and v that represent an edge between vertex u and vertex v of the input tree. It is assumed that the vertices are indexed from 1 to n. The last line contains two distinct integers s and t, where s, t &isin; {1, &hellip;, n}, that respectively represent the start and end vertices of a grasshopper route.</p>
