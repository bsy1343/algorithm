# [Platinum IV] Googlements (Large) - 14824

[문제 링크](https://www.acmicpc.net/problem/14824)
...
제출: 62, 정답: 17, 맞힌 사람: 16, 정답 비율: 41.026%

### 분류

수학, 그래프 이론, 브루트포스 알고리즘, 그래프 탐색, 조합론, 너비 우선 탐색
...
<ul>
	...
	<li>1 &le; the length of&nbsp;<strong>G</strong>&nbsp;&le; 9.</li>
</ul>
