...
제출: 63, 정답: 45, 맞힌 사람: 31, 정답 비율: 67.391%
...
<p>There are several test cases. Each case starts with a line containing one integer N which specifies the number of possible boxing machine locations in the park (1 &le; N &le; 2000). Next, there are N lines representing the location coordinates, each line describes one location by a pair of integer coordinates in meters. All locations in one test case are unique. Each coordinate is non-negative and less than or equal to 10<sup>9</sup>.</p>
