...
제출: 583, 정답: 134, 맞힌 사람: 82, 정답 비율: 22.343%
...
<p>각 테스트 케이스는 표의 행의 개수 m, 열의 개수 n (2 &le;&nbsp;m, n &le; 8)이&nbsp;첫 줄에 주어진다. 두 번째 줄과&nbsp;세 번째 줄은 i와 j, a와 b(각 1의 위치를 나타내는 좌표)로 이루어져 있다.</p>
