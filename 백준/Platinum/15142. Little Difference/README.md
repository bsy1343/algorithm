...
제출: 165, 정답: 44, 맞힌 사람: 41, 정답 비율: 28.671%
...
<p>The only line of the input contains a single integer n (1 &le; n &le; 10<sup>18</sup>).</p>

### 출력

<p>In first line output the number of decompositions of n, or &minus;1 if this number is infinite. If number of decompositions is finite, print all of them one per line. In each line first print number k<sub>i</sub> of elements in decomposition. Then print k<sub>i</sub> integers in this decomposition in any order. Don&rsquo;t forget that decompositions which are different only in order of elements are considered the same.</p>