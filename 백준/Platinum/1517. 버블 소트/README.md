...
제출: 41493, 정답: 12391, 맞힌 사람: 8588, 정답 비율: 31.979%
...
<p>N개의 수로 이루어진 수열 A[1], A[2], &hellip;, A[N]이 있다. 이 수열에 대해서 버블 소트를 수행할 때, Swap이 총 몇 번 발생하는지 알아내는 프로그램을 작성하시오.</p>
...
<p>첫째 줄에 N(1 &le; N &le; 500,000)이 주어진다. 다음 줄에는 N개의 정수로 A[1], A[2], &hellip;, A[N]이 주어진다. 각각의 A[i]는 0 &le; |A[i]| &le; 1,000,000,000의 범위에 들어있다.</p>
