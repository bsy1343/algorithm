...
제출: 488, 정답: 162, 맞힌 사람: 125, 정답 비율: 31.486%
...
<ol>
	<li>A[i]는 금민수이다. (0 &le; i &lt; L)</li>
	<li>모든 i에 대해서 A[i] = Numbers[j]인 j가 적어도 하나 존재한다. (0 &le; i &lt; L)</li>
	<li>모든 i에 대해서 A[i]의 마지막 자리는 A[i+1]의 첫 번째 자리와 같다. (0 &le; i &lt; L-1)</li>
</ol>
