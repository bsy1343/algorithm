...
제출: 576, 정답: 167, 맞힌 사람: 95, 정답 비율: 25.469%
...
<p>첫 번째 줄에 K와 N이 입력됩니다. (1 &le; K, N &le; 10<sup>6</sup>)</p>

<p>두 번째 줄에 A<sub>1</sub>, A<sub>2</sub>, ..., A<sub>N</sub>이 입력됩니다. (1 &le; A<sub>i</sub> &le; K)</p>

<p>세 번째 줄에 Q가 입력됩니다. (0 &le; Q &le; 3 &times; 10<sup>6</sup>)</p>

<p>Q개의 줄 동안 숫자 a와 b가 입력됩니다. (1&nbsp;&le; a &le; 2, 1 &le; b &le; N)</p>
