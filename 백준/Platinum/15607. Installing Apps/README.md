...
제출: 337, 정답: 84, 맞힌 사람: 70, 정답 비율: 24.138%
...
<ul>
	<li>One line with two integers n, c (1 &le; n &le; 500, 1 &le; c &le; 10 000), the number of available apps and the available disk space of the phone in megabytes.</li>
	<li>n lines, each with two integers d, s (1 &le; d, s &le; 10 000), the download size and storage size of an app, in megabytes.</li>
</ul>
