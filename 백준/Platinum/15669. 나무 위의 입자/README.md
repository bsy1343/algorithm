...
제출: 585, 정답: 212, 맞힌 사람: 176, 정답 비율: 37.131%

### 분류

다이나믹 프로그래밍, 트리, 트리에서의 다이나믹 프로그래밍, 홀짝성
...
<p>첫 줄에 입자가속기의 정점의 수 N (2 &le; N &le; 10<sup>5</sup>)과 진행한 실험의 수 M(1 &le; M &le; 10<sup>5</sup>) 이 주어진다.</p>

<p>이어 N-1줄에 걸쳐, 입자가속기에서 연결된 두 정점 U V가 주어진다. (1 &le; U, V &le; N, U &ne; V)</p>

<p>이어 M줄에 걸쳐, 실험에 대해 알고 있는 정보 U V C가 주어진다. (1 &le; U, V &le; N, C = 0 또는 1, U &ne; V)</p>
