...
제출: 1714, 정답: 523, 맞힌 사람: 386, 정답 비율: 29.715%
...
<p>첫째 줄에 정수 N(1 &le; N &le; 10<sup>5</sup>), T(1 &le; T &le; 10<sup>9</sup>), P(1 &le; P &le; 10<sup>5</sup>)가 공백으로 구분되어 주어진다.</p>

<p>둘째 줄에 바위 i(i = 1, 2, ..., N)를 채취하기 위해 필요한 곡괭이질의 수 K<sub>i</sub>(1 &le; K<sub>i</sub> &le; 10<sup>5</sup>)가 공백으로 구분되어 주어진다.</p>
