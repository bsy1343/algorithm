...
제출: 456, 정답: 113, 맞힌 사람: 87, 정답 비율: 26.048%

### 분류

다이나믹 프로그래밍, 그래프 이론, 자료 구조, 세그먼트 트리, 집합과 맵, 데이크스트라
...
<p>첫째 줄에 트램펄린의 개수 N(1 &le; N &le; 10<sup>5</sup>)과 하늘의 높이를 의미하는 정수 S(1 &le; S &le; 10<sup>9</sup>)가 주어진다.</p>

<p>다음 N개의 줄에는 각각 한 줄씩 두개의 정수 i번째 트램펄린의 위치 y<sub>i</sub>(0 &le; y<sub>i</sub> &le; 10<sup>9</sup>)와 해당 트램펄린을 밟을 경우 도약하는 높이 h<sub>i</sub>(0 &le; h<sub>i</sub>&nbsp;&le;&nbsp;10<sup>9</sup>)가 주어진다.</p>
