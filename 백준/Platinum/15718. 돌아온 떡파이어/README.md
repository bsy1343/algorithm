...
제출: 3756, 정답: 711, 맞힌 사람: 538, 정답 비율: 19.507%
...
<p>첫째 줄에 테스트 케이스의 수 T(1 &le;&nbsp;T &le; 1000)가 주어진다.</p>

<p>각 테스트 케이스는 한 줄로 이루어져 있으며, 정수 N(0 &le; N &le; 10<sup>9</sup>)과 M(1 &le; M &le; 10<sup>9</sup>)이 공백으로 구분되어 주어진다.</p>
