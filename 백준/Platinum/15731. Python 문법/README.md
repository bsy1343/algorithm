...
제출: 398, 정답: 137, 맞힌 사람: 95, 정답 비율: 34.926%
...
<p>첫째 줄에 N(1 &le; N &le; 5000)개의 문자로 이루어진 문자열이 주어진다. 각 문자는 &lsquo;f&rsquo;(본문의 For statement) 또는 &lsquo;e&rsquo;(본문의 Execute statement)로 이루어져 있으며, 만들 수 있는 모든 경우가 Python 문법에 어긋나는 입력은 주어지지 않는다.</p>
