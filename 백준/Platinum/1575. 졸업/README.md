...
제출: 385, 정답: 114, 맞힌 사람: 45, 정답 비율: 25.862%
...
<p>그런데, 갑자기 형택 대학교의 졸업 조건이 바뀌었다. 어떤 졸업 조건을 충족시킬 때 사용한 수업은, 다른 졸업 조건을 충족시킬 수 없는 것이다.</p><p>예를 들어서, &ldquo;1, 2, 3중 2개의 수업을 들어라&ldquo;, &rdquo;3, 4, 5중 2개의 수업을 들어라&ldquo;가 있을 때, 첫 번째 조건을 충족시키는 수업이 1, 3이면, 두 번째 조건을 충족시킬 때, 3은 이용되어서 안되는 것이다.</p>
