...
제출: 646, 정답: 159, 맞힌 사람: 133, 정답 비율: 28.000%
...
<p>프로그램의 입력은 표준 입력으로 받는다. 라이트의 개수 N(1 &le; N &le; 10<sup>5</sup>) 이 주어지고, 그 다음 N줄에 걸쳐 라이트의 위치를 나타내는 좌표인 두 정수 X<sub>i</sub>, Y<sub>i</sub> (-1500 &le; X<sub>i</sub>, Y<sub>i</sub> &le; 1500)가 주어진다.</p>

<p>그 다음 P(1 &le; P &le; 10<sup>5</sup>)가 주어진다. 이어서 P개의 줄에 걸쳐서 X<sub>pi</sub> , Y<sub>pi</sub> (-1500 &le; X<sub>pi</sub>, Y<sub>pi</sub> &le; 1500)가 주어지는데, 이는 윤호가 빛의 세기를 알고 싶어하는 지점들의 X좌표, Y좌표이다.</p>
