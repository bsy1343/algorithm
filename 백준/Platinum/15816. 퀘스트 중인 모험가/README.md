...
제출: 1098, 정답: 295, 맞힌 사람: 181, 정답 비율: 23.537%
...
<p>첫째 줄에 지금까지 달성한 퀘스트의 개수 N이 주어진다. (1 &le; N &le; 1,000,000)</p>

<p>둘째 줄에 지금까지 달성한 퀘스트들의 번호 Q<sub>1</sub> ... Q<sub>N</sub> 까지의 N개의 수가 주어진다. (&minus;1,000,000,000 &le; Q[i] &le; 1,000,000,000, Q[i] &lt; Q[i+1])</p>

<p>셋째 줄에 애드온 요청의 개수 M이 주어진다. (1 &le; M &le; 1,000,000)</p>

<p>넷째 줄부터 M개의 줄에 걸쳐서 애드온에 요청할 명령이 주어진다.</p>

<ol>
	<li>1 X:&nbsp; 퀘스트 번호 X를 달성했다. 애드온에 이를 반영해야 한다. (&minus;1,000,000,000 &le; X &le; 1,000,000,000)</li>
	<li>2 L R: 퀘스트 번호 L 이상 R 이하인 퀘스트 중, 모험가가 달성하지 못한 퀘스트의 개수를 출력한다. (&minus;1,000,000,000 &le; L &le; R &le; 1,000,000,000)</li>
</ol>
