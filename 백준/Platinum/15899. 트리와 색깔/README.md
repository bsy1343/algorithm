...
제출: 2703, 정답: 935, 맞힌 사람: 725, 정답 비율: 34.689%
...
<p>첫 번째 줄에 정점의 수를 나타내는 N(1 &le; N &le; 2&times;10<sup>5</sup>), 질의의 개수를 나타내는 M(1 &le; M &le; 2&times;10<sup>5</sup>), 정점의 색깔 종류를 나타내는 C(1 &le; C &le; N)가 공백 하나를 사이에 두고 차례로 주어진다.</p>
