...
제출: 1503, 정답: 323, 맞힌 사람: 205, 정답 비율: 19.505%
...
<p>게임 도중에 스마트폰 화면을 터치한 횟수 N(1 &le; N &le; 1,000)이 주어진다.</p>
...
<p>예제 1: f(3, 0) = 3이 최댓값이다.</p>

<p>예제 2: f(2, 1) = 3이 최댓값이다.</p>

<p>예제 3: f(5, 0) = 8이 최댓값이다.</p>