...
제출: 170, 정답: 60, 맞힌 사람: 42, 정답 비율: 40.777%
...
<p>첫째 줄에는 자연수&nbsp;n이 주어진다 (1 &le; n&nbsp;&le;&nbsp;1,000). 다음 n줄에는 각 줄에 정수 두 개가 주어지는데, 각 행렬의 행의 수 R[i]와 열의 수 C[i]이다. 각 행렬의 행의 수와 열의 수는 1 이상 1,000 이하이다.</p>
