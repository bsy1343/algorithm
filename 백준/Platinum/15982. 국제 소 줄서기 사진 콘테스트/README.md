...
제출: 238, 정답: 69, 맞힌 사람: 63, 정답 비율: 33.333%

### 분류

자료 구조, 누적 합, 우선순위 큐, 트리를 사용한 집합과 맵, 집합과 맵
...
<ul>
	...
	<li><em>1</em> &le;<i> </i><em>P<sub>1</sub></em>, <em>P<sub>2</sub></em>, ..., <em>P<sub>m&nbsp;</sub></em>&lt; <em>N</em></li>
</ul>