...
제출: 242, 정답: 43, 맞힌 사람: 32, 정답 비율: 22.378%
...
<p>- <em>1&nbsp;X&nbsp;Y</em>&nbsp;: <em>X</em>가 속한 팀과 <em>Y</em>가 속한 팀을 한 팀으로 합친다. (<em>1</em> &le; <em>X</em>, <em>Y</em> &le; <em>N</em>)</p>

<p>- <em>2&nbsp;X&nbsp;K</em>&nbsp;: <em>X</em>가 속한 팀을 사원 번호를 <em>P</em>로 나눈 나머지가 <em>K</em>인 팀과 그렇지 않은 팀으로 나눈다. (<em>1</em> &le; <em>X</em> &le; <em>N</em>, <em>0</em> &le; <em>K</em> &lt; <em>P</em>)</p>

<p>- <em>3&nbsp;X</em>&nbsp;: <em>X</em>가 속한 팀의 총 인원수를 출력한다.(<em>1</em> &le; <em>X</em> &le; <em>N</em>)</p>
