...
제출: 300, 정답: 21, 맞힌 사람: 14, 정답 비율: 9.722%

### 분류

구현, 브루트포스 알고리즘, 이분 탐색, 매개 변수 탐색
...
<p style="text-align: center;"><img alt="" height="144" src="/upload/201004/rndur.PNG" width="367" /></p>
...
<p>첫째 줄에는 두 정수 n(1 &le; n &le; 20), m(1 &le; m &le; 100)이 주어진다. 두 번째 줄에는 두 정수 X(1 &le; X &le; n), Y(1 &le; Y &le; m)이 주어진다. 다음 n+1개의 줄에는 m+1개의 자연수가 주어진다. 이 값들은 10,000이하이다. 각각의 수들 사이에는 공백이 하나씩 있다.</p>
