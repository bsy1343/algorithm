...
제출: 120, 정답: 34, 맞힌 사람: 28, 정답 비율: 29.474%
...
<ul>
	<li>The first line of the input contains an integer 1 &le; B &le; 10<sup>3</sup> giving the number of bolts that you need.</li>
	<li>The second line of the input contains an integer 1 &le; k &le; 10 giving the number of companies.</li>
	<li>The next k lines each describe a company. Each line consists of the integers l<sub>i</sub> , n<sub>1</sub>, n<sub>2</sub>, . . . , n<sub>l<sub>i</sub></sub> meaning that the company i produces 1 &le; l<sub>i</sub> &le; 10 types of packages of sizes 0 &lt; n<sub>1</sub> &lt; n<sub>2</sub> &lt; . . . &lt; n<sub>l<sub>i</sub></sub> &le; 10<sup>3</sup>, respectively.</li>
</ul>
