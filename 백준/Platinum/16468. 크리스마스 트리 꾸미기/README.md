...
제출: 712, 정답: 291, 맞힌 사람: 215, 정답 비율: 40.037%
...
<p>첫째 줄에 볼의 개수 N과 트리의 높이 L이 차례대로 주어진다. (1 &le; N&nbsp;&le; 300, 1 &le; L&nbsp;&le; 300)&nbsp;</p>
...
<p>이진트리란 각각의 노드가 최대 두개의 자식 노드를 가지는 트리 자료구조로, 자식 노드는 왼쪽 자식 노드와 오른쪽 자식 노드가 있다. 제일 위에 노드가 1개, 그 다음 2개&hellip; 와 같은 식으로 위에서 d번째 줄엔 2<sup>d&minus;1</sup>개의 노드가 있을 수 있다.&nbsp;</p>