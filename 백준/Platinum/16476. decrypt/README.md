...
<p><img alt="" src="https://upload.acmicpc.net/dd440796-2792-4657-9a7e-d2e672599ad3/-/preview/" style="width: 204px; height: 114px; float: right;" />All the operations use 8 bits. XOR is the bitwise exclusive or function (the ^ operator in C, xor operator in Pascal).</p>
