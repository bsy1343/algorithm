...
제출: 1727, 정답: 984, 맞힌 사람: 908, 정답 비율: 57.614%
...
<p>첫째 줄에 <em>R</em>과 <em>r</em>의 값이 사이에 공백을 한 개 두고 차례대로 주어진다. (단, <em>R</em>과 <em>r</em>의 값은 100,000 이하의 양의 정수이고, 2&times;<em>r</em>&nbsp;&le; <em>R</em>을 만족한다.)</p>
