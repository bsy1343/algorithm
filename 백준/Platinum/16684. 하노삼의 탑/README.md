...
제출: 245, 정답: 65, 맞힌 사람: 53, 정답 비율: 28.649%

### 분류

구현, 다이나믹 프로그래밍, 애드 혹, 재귀

### 문제 설명

<p>COSE214 알고리즘 강의를 수강하는 이세정 군은 최근 강의에서 &lsquo;하노이의 탑&rsquo; 문제를 해결하는 방법에 대해 배웠다. 하노이의 탑의 규칙은 아래와 같다.</p>
...
<ul>
	<li>&lt;2&gt; 원판을 인접한 기둥으로만 옮길 수 있다. (1번 &harr; 2번 &harr; 3번)</li>
</ul>

<p>반대쪽에 있던 사세정 군은 다음과 같은 규칙을 제안했다.</p>

<ul>
	<li>&lt;3&gt; 원판을 오른쪽 기둥으로만(단, 3번에서는 1번으로) 옮길 수 있다. (1번 &rarr; 2번 &rarr; 3번 &rarr; 1번)</li>
</ul>

<p>그들은 신난다며 이 문제를 &lsquo;하노삼의 탑&rsquo;으로 명명했다. 이세정 군은 솔직히 이런 추가 조건들이 끌리지 않았지만, 그래도 인싸가 되기 위해 <em>K</em>초 후에 각 원판이 어디에 배치되어 있을지 구해보기로 했다. 그를 도와주자.</p>

### 입력

<p>첫째 줄에 세 정수 <em>M, N, K</em> 가 공백으로 구분되어 주어진다.</p>

<p><em>M</em>은 하노삼의 탑에 대해 적용될 규칙의 번호를 나타낸다. 1 &le;&nbsp;<em>M</em> &le;&nbsp;3 이며, 1이라면 원래의 문제, 2라면 삼세정 군의 규칙, 3이라면 사세정 군의 규칙을 적용한다.</p>

<p><em>N</em>과&nbsp;<em>K</em>는 <em>M</em>의 값에 따라 범위가 달라진다. 상세한 범위는 다음과 같다.</p>

<ul>
	<li><em>M</em> = 1인 경우: 1&nbsp;&le; <em>N</em> &le; 60, 0&nbsp;&le; <em>K</em> &le; 2<em><sup>N</sup></em>-1</li>
	<li><em>M</em> = 2인 경우: 1&nbsp;&le; <em>N</em> &le; 40, 0&nbsp;&le; <em>K</em> &le; 3<em><sup>N</sup></em>-1</li>
	<li><em>M&nbsp;</em>= 3인 경우: 1&nbsp;&le; <em>N</em> &le; 30, 0&nbsp;&le; <em>K</em> &le; $\frac{3+2\sqrt{3}}{6}(1+\sqrt{3})^N+\frac{3-2\sqrt{3}}{6}(1-\sqrt{3})^N-1$</li>
</ul>
