...
제출: 429, 정답: 211, 맞힌 사람: 170, 정답 비율: 54.839%
...
<p>첫 번째 줄에는 미야가 가진 카드의 개수 <em>N</em> 이 주어진다. (2 &le;&nbsp;<em>N</em> &le;&nbsp;100,000)</p>

<p>두 번째 줄부터 <em>N</em>개의 줄에 걸쳐 미야의 <em>i </em>번째 카드에 적힌 수 <em>a<sub>i</sub></em>가 주어진다. (0 &le; <em>a<sub>i</sub></em> &le; 10<sup>18</sup>)</p>
