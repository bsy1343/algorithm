...
제출: 305, 정답: 64, 맞힌 사람: 54, 정답 비율: 22.689%
...
<p>The first input line contains an integer L (1 &le; L &le; 2 &middot; 10<sup>5</sup>), the number of lines to follow. Each of the next L lines contains five integers t, x<sub>1</sub>, y<sub>1</sub>, x<sub>2</sub>, y<sub>2</sub> (t &isin; {0, 1}, 1 &le; x<sub>1</sub>, x<sub>2</sub> &le; 50, 1 &le; y<sub>1</sub>, y<sub>2</sub> &le; 10<sup>5</sup>). Number t is the type of information and pairs [x<sub>1</sub>, y<sub>1</sub>] and [x<sub>2</sub>, y<sub>2</sub>] specify the respective unit squares.</p>
