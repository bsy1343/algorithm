...
제출: 313, 정답: 88, 맞힌 사람: 74, 정답 비율: 33.790%
...
<p>첫째 줄에 격자의 세로 길이 <em>N</em>과 가로 길이 <em>M</em>이 주어진다. (2&nbsp;&le; <em>N, M</em> &le; 500)</p>
...
<p>첫째 줄에는 규민이의 시행 횟수 <em>X</em>를 출력한다. 단, 0&nbsp;&le; <em>X</em> &le; 10<sup>6</sup>를 만족해야 한다.</p>
...
<p>여기서 (<em>r<sub>1</sub>, c<sub>1</sub></em>)과 (<em>r<sub>2</sub>, c<sub>2</sub></em>)는 규민이가 선택한 인접한 두 칸의 좌표이고, 1&nbsp;&le; <em>r<sub>1</sub>,&nbsp;r<sub>2</sub></em>&nbsp;&le; <em>N</em>과&nbsp;1&nbsp;&le; <em>c<sub>1</sub>,&nbsp;c<sub>2</sub></em>&nbsp;&le; <em>M</em>,&nbsp;그리고 |<em>r<sub>1</sub>-r<sub>2</sub></em>|+|<em>c<sub>1</sub>-c<sub>2</sub></em>|=1을&nbsp;만족한다.</p>

<p>또한, <em>k</em>는 규민이가 시행을 통해 두 칸에 적힌 수에 더할 정수로, -10<sup>12</sup>&nbsp;&le; <em>k</em> &le; 10<sup>12</sup>가 성립해야 한다.&nbsp;</p>
