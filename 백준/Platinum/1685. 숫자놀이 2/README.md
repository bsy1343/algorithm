...
제출: 308, 정답: 50, 맞힌 사람: 19, 정답 비율: 14.961%
...
<ul>
	...
	<li>1 &le; K &le; 50,000</li>
	<li>숫자 게임에서 사용하는 정수는 1000보다 작거나 같은 자연수이고, 중복되는 수가 주어지지 않는다.</li>
</ul>