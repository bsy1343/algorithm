...
제출: 646, 정답: 395, 맞힌 사람: 286, 정답 비율: 65.000%
...
<p>크기가 3000&times;3000인 체스판 위에 궁전 N개가 놓여져 있다. 구사과와 큐브러버는 턴을 번갈아가면서 게임을 하며, 각 턴은 다음과 같이 이루어져 있다.</p>
...
<p>첫째 줄에 궁전의 개수 N(1 &le; N &le; 300,000)이 주어진다. 둘째 줄부터 N개의 줄에 궁전의 좌표 x, y (0 &le; x, y &lt; 3000)가 한 줄에 하나씩 주어진다.</p>
