...
제출: 182, 정답: 59, 맞힌 사람: 48, 정답 비율: 30.189%
...
<p>첫째 줄에 벡터의 개수 N(2 &le; N &le; 100,000)이 주어진다. 둘째 줄부터 N개의 줄에 i번째 벡터 v<sub>i</sub>의 좌표 x<sub>i</sub>, y<sub>i</sub>(-10,000 &le; x, y &le; 10,000)가 한 줄에 하나씩 주어진다.</p>
...
<p>두 벡터 v = (x<sub>v</sub>, y<sub>v</sub>), u = (x<sub>u</sub>, y<sub>u</sub>)의 합은 s = v + u = (x<sub>v</sub> + x<sub>u</sub>, y<sub>v</sub> + y<sub>u</sub>) 이다.</p>

<p>벡터 v = (x, y)의 |v|는 &radic;(x<sup>2</sup> + y<sup>2</sup>) 이다.</p>