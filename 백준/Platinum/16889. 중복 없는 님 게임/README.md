...
제출: 286, 정답: 187, 맞힌 사람: 148, 정답 비율: 60.905%
...
<p>첫째 줄에 돌 더미의 개수 N(1 &le; N &le; 10<sup>6</sup>)이 주어진다. 둘째 줄에는 돌 더미에 있는 돌의 개수 A<sub>1</sub>, A<sub>2</sub>, .., A<sub>N</sub>(1 &le; A<sub>i</sub> &le; 60)이 주어진다.</p>
