...
제출: 197, 정답: 63, 맞힌 사람: 39, 정답 비율: 27.273%

### 분류

수학, 다이나믹 프로그래밍, 자료 구조, 정수론, 집합과 맵, 비트마스킹, 해시를 사용한 집합과 맵, 게임 이론, 소수 판정, 에라토스테네스의 체, 소인수분해, 스프라그–그런디 정리
...
<p>첫째 줄에 수열의 크기 N(1 &le; N &le; 100)이 주어진다. 둘째 줄에는 A<sub>1</sub>, A<sub>2</sub>, ..., A<sub>N</sub> (1 &le; A<sub>i</sub> &le; 10<sup>9</sup>)가 주어진다.</p>
