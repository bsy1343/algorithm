...
제출: 300, 정답: 111, 맞힌 사람: 88, 정답 비율: 49.162%
...
<p>첫째 줄에 테스트 케이스의 개수 T(1 &le; T &le; 10,000)이 주어진다. 둘째 줄부터 T개의 줄에 테스트 케이스의 정보가 한 줄에 하나씩 주어진다. 정보는 정수 N(2 &le; N &le; 10<sup>15</sup>)로 이루어져 있다.</p>
