...
제출: 1013, 정답: 390, 맞힌 사람: 305, 정답 비율: 40.237%
...
<p>첫째 줄에 방의 개수 N(2 &le; N &le; 100,000)과 스위치의 개수 M(2 &le; M &le; 100,000)이 주어진다. 둘째 줄에는 초기 방의 잠금 상태가 1번 방부터 순서대로 주어진다. 0은 닫힌 상태, 1은 열린 상태이다.</p>
