...
제출: 11091, 정답: 1800, 맞힌 사람: 1142, 정답 비율: 14.649%
...
<p>진영이는 다이어트를 위해 N&times;M 크기의 체육관을 달리려고 한다. 체육관은 1&times;1 크기의 칸으로 나누어져 있고, 칸은 빈 칸 또는 벽이다.&nbsp;x행 y열에 있는 칸은 (x, y)로 나타낸다.</p>
...
<ul>
	...
	<li>1 &le; x<sub>1</sub>, x<sub>2</sub> &le; N</li>
	<li>1 &le; y<sub>1</sub>, y<sub>2</sub> &le; M</li>
</ul>