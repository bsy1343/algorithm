...
제출: 1763, 정답: 804, 맞힌 사람: 538, 정답 비율: 43.006%
...
<p>크기가 N&times;N인 체스판이 있고, 체스판의 각 칸에는 1부터 N<sup>2</sup>까지의 정수가 한 번씩 적혀있다. 지학이는 이 체스판을 이용해서 재미있는 게임을 해보려고 한다.</p>
...
<p>첫째 줄에 체스판의 크기 N(3 &le; N &le; 10)이 주어진다.</p>
