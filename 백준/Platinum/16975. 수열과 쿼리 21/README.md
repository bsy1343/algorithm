...
제출: 9130, 정답: 4935, 맞힌 사람: 3738, 정답 비율: 52.626%
...
<p>넷째 줄부터 M개의 줄에는 쿼리가 한 줄에 하나씩 주어진다. 1번 쿼리의 경우 1 &le; i &le; j &le; N, -1,000,000&nbsp;&le; k &le; 1,000,000 이고, 2번 쿼리의 경우 1 &le; x &le; N이다. 2번 쿼리는 하나 이상 주어진다.</p>
