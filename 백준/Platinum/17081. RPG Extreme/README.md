...
제출: 3940, 정답: 1026, 맞힌 사람: 699, 정답 비율: 22.724%
...
<p style="text-align: center;"><img alt="" src="%EB%B0%B1%EC%A4%80/Platinum/17081.%E2%80%85RPG%E2%80%85Extreme/026f4c21.png" data-original-src="%EB%B0%B1%EC%A4%80/Platinum/17081.%E2%80%85RPG%E2%80%85Extreme/026f4c21.png" data-original-src="https://upload.acmicpc.net/ad60f113-37b3-4ea5-918a-8fc8165f93c4/-/preview/" onerror="this.onerror=null;this.src=this.dataset.originalSrc" style="height: 240px; width: 150px;" /></p>

<p>요즘 택희는 RPG 게임을 하고 있다. 던전을 헤쳐나가며 몬스터를 물리치고, 아이템을 모으고, 레벨 업을 하여 보스 몬스터를 물리치는 전형적인 RPG 게임이다.</p>

<p>이 게임은 <em>N</em>&times;<em>M</em> 2차원 그리드 위에서 진행되며, 그리드의 각 칸에는 아래와 같은 것들이 있을 수 있다.</p>
...
<ul>
	...
	<li>경험치 : 처음엔 레벨 1이며, 레벨 <em>N</em>에서 <em>N</em>+1이 되기 위한 필요 경험치는 5&times;<em>N</em>이다.
	<ul>
	...
	<ul>
		...
		<li>Courage(CO) : 모든 전투에서, 첫 번째 공격에서 주인공의 공격력(무기 합산)이 두 배로 적용된다. 즉, 모든 첫 공격에서 몬스터에게 <em>max</em>(1, 공격력&times;2 &ndash; 몬스터의 방어력)만큼의 데미지를 입힌다.</li>
...
<ul>
	...
	<ul>
		...
		<ul>
			<li>전투의 결과로 사망했을 경우 <em>S</em>는 몬스터의 이름, 가시 함정에 의해 사망했을 경우 <em>S</em>는 &ldquo;SPIKE TRAP&rdquo; 이 된다.</li>
		</ul>
		</li>
...
<p>첫 줄에 그리드의 크기 <em>N</em>과 <em>M</em>이 주어진다. (1 &le; <em>N</em>, <em>M</em> &le; 100, 2 &le; <em>N</em>&times;<em>M</em>)</p>

<p>다음 줄부터 <em>N</em>개의 줄에 걸쳐 <em>M</em>개의 문자로 그리드의 상태가 주어진다. 주어지는 문자는 모두 본문에 설명된 것 중 하나이다.</p>

<p>보스 몬스터에 해당하는 &lsquo;M&rsquo;과, 주인공에 해당하는 &lsquo;@&rsquo;은 정확히 한 개씩 있다.</p>

<p>그 다음 줄에는 <em>L</em>, <em>R</em>, <em>U</em>, <em>D</em>로 이루어진 문자열 S가 주어진다. (1 &le; |<em>S</em>| &le; 5,000) 주인공은 문자열 <em>S</em>의 첫 글자부터 순서대로 실행한다.</p>

<p>이 그리드에 있는 몬스터의 수(보스 몬스터 포함)를 <em>K</em>라 하자. 이제 <em>K</em>줄에 걸쳐 각 몬스터의 정보가 아래와 같이 주어진다.</p>

<ul>
	<li><em>R C S W&nbsp;A&nbsp;H E</em> (1 &le; <em>R</em> &le; <em>N</em>, 1 &le; <em>C</em> &le; <em>M</em>, 1 &le; |<em>S</em>| &le; 10, 1 &le; <i>W</i>, <i>A</i>, <em>H</em>, <em>E</em> &le; 20)
...
<ul>
	<li><em>R C T</em> &lt;<em>S</em>&gt; (1 &lt;= <em>R</em> &lt;= <em>N</em>, 1 &lt;= <em>C</em> &lt;= <em>M</em>, <em>T</em> &isin; { &#39;W&#39;, &lsquo;A&rsquo;, &lsquo;O&rsquo; })</li>
	<li>위에서부터 <em>R</em>번째 줄, 왼쪽에서부터 <em>C</em>번째 열에 있는 아이템 상자에 대한 정보이다. 이 칸에는 아이템 상자가 있음이 보장된다.</li>
	<li><em>T</em> = &#39;W&#39;, &#39;A&#39;일 경우
	<ul>
		<li>&lt;<em>S</em>&gt; = <em>N</em> (1 &le; <em>N</em> &le; 10)</li>
		<li><em>T</em> = &#39;W&#39;일 경우 공격력이 <em>N</em>인 무기를, <em>T&nbsp;</em>= &#39;A&#39;일 경우 방어력이<em> N</em>인 방어구를 의미한다.</li>
	</ul>
	</li>
	<li><em>T</em> = &#39;O&#39;일 경우
	<ul>
		<li>&lt;<em>S</em>&gt; &isin; { &quot;HR&quot;, &quot;RE&quot;, &quot;CO&quot;, &quot;EX&quot;, &quot;DX&quot;, &quot;HU&quot;, &quot;CU&quot; }</li>
