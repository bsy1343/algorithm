...
제출: 700, 정답: 170, 맞힌 사람: 96, 정답 비율: 20.870%

### 분류

자료 구조, 세그먼트 트리, 집합과 맵, 우선순위 큐, 스택
...
<p>첫 번째 줄에는 쿼리의 수를 의미하는 정수 <em>Q</em>와 나누는 정수 <em>mod</em> 가 공백으로 구분되어 주어집니다. (1 &le;&nbsp;<em>Q</em>&nbsp;&le; 10<sup>6</sup>, 1 &le;&nbsp;<em>mod</em> &le; 2&times;10<sup>9</sup>)</p>
