...
제출: 679, 정답: 81, 맞힌 사람: 63, 정답 비율: 16.623%
...
<p>첫 줄에 현정의 전장에 있는 하수인 수 <em>N</em>과 상대 전장의 하수인 수 <em>M</em>이 주어진다. (0 &le; <em>N</em>, <em>M</em> &le; 7)</p>
...
<p>가능하다면 첫 줄에 로그의 개수 <em>L</em>(0 &le; <em>L</em> &le; <em>N</em>+1)을 출력한다.</p>
