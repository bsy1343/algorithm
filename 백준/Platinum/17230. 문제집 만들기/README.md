...
제출: 169, 정답: 66, 맞힌 사람: 48, 정답 비율: 43.636%
...
<ul>
	<li>1 <em>x y</em> : <em>x</em>번부터 <em>y</em>번까지의 문제들로 구성된 문제집을 민규에게 준다. ( <em>x</em> &le; <em>y</em> )</li>
...
<ul>
	<li>1 &le; <em>a</em>, <em>b</em>, <em>x</em>, <em>y</em> &le; <em>N</em></li>
</ul>
