...
제출: 2466, 정답: 192, 맞힌 사람: 115, 정답 비율: 14.896%
...
<p>첫째 줄에 티셔츠의 개수 N (1 &le; N &le; 1,000,000)이 주어진다. 이후 N개의 행에 각 티셔츠의 정보가 두 개의 자연수로 주어진다. 이는 티셔츠의 안쪽과 바깥쪽에 적힌 등번호이다. 각 등번호는 1이상 1,000,000 이하이다.</p>
