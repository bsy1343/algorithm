...
제출: 178, 정답: 76, 맞힌 사람: 67, 정답 비율: 47.857%
...
<table align="center" class="table table-bordered" id="operations">
	<tbody>
		...
		<tr>
			...
			<td><code>Insert n&crarr; 			s</code></td>
			<td>Inserts a string&nbsp;<var>s</var>&nbsp;of length&nbsp;<var>n</var>&nbsp;(<var>n</var>&nbsp;&ge; 1) at the position of the cursor. The position of the cursor does not change.</td>
		</tr>
		<tr>
			<td>Delete(<var>n</var>)</td>
			<td><code>Delete n</code></td>
			<td>Delete the&nbsp;<var>n</var>&nbsp;(<var>n</var>&nbsp;&ge; 1) characters following the cursor. The position of the cursor does not change.</td>
		</tr>
		<tr>
			<td>Get(<var>n</var>)</td>
			<td><code>Get n</code></td>
			<td>Outputs the&nbsp;<var>n</var>&nbsp;(<var>n</var>&nbsp;&ge; 1) characters following the cursor. The position of the cursor does not change.</td>
		</tr>
		<tr>
			<td>Prev</td>
...
<ul>
	...
	<li>The number of characters inserted in each Insert() operation will not exceed 2M (1M = 1024&times;1024). The length of the correct output will not exceed 3M.</li>
