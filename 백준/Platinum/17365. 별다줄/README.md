...
제출: 1156, 정답: 343, 맞힌 사람: 257, 정답 비율: 36.299%
...
<p>고고학자 종영이는 최근 문래빗어 사전을 하나 발견했다. 이 사전에는 수많은 단어가 적혀 있는데, 그중에는 똑같은 단어들도 여럿 있을 수 있다. 이들은 실제로는 다른 단어인데, 발음을 표현할 문자가 부족해서 이렇게 된 것이다. 예를 들어 사전에 &quot;aa&quot;라는 단어가 두 개 있다면 &quot;aa aa&quot;는 2 &times; 2 = 4가지의 다른 문장으로 해석될 수 있다.</p>
...
<p>첫 줄에 종영이가 발견한 사전에 적혀 있는 단어의 수 <em>N</em>(1 &le; <em>N</em> &le; 10<sup>6</sup>)이 주어진다.</p>
