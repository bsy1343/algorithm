...
제출: 10415, 정답: 2058, 맞힌 사람: 1271, 정답 비율: 18.821%
...
<p>첫째 줄에 골목길들이 교차하는 지점의 개수 n (2 &le; n &le; 100)과 골목길의 개수 m (1 &le; m &le; 20,000) 이 차례로 주어진다. 이어지는 m개의 행에 각각의 골목길을 나타내는 세 정수 u, v, w가 차례로 주어진다. 이는 u번 교차점에서 v번 교차점으로 이동할 수 있는 골목길이 나있다는 의미이다. 즉, 주어지는 골목길들은 기본적으로 모두 일방통행로이다. w (0 &le; |w| &le; 1,000)는 이 길을 지날 때 갈취당하거나 획득하게 되는 금품의 양이다. 음수는 갈취, 양수는 획득을 뜻한다.</p>
