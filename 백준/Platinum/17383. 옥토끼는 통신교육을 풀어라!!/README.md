...
제출: 926, 정답: 385, 맞힌 사람: 302, 정답 비율: 42.238%
...
<p>첫 번째 줄에는 문제의 수 N (1 &le; <em>N</em> &le; 100,000)이 주어진다.</p>

<p>두 번째 줄에는 옥토끼가 각 문제를 푸는 데 걸리는 시간 <em>T<sub>i</sub></em> (1 &le; <em>T<sub>i</sub></em> &le; 10<sup>9</sup>, <em>T<sub>i</sub></em>는 정수)가 주어진다.</p>
