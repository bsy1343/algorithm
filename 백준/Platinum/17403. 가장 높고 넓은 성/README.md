...
제출: 1010, 정답: 440, 맞힌 사람: 369, 정답 비율: 42.512%
...
<p>첫 번째 줄에 표지판의 개수 n이 주어진다. (1 &le; n &le; 10<sup>3</sup>)&nbsp;</p>

<p>두 번째 줄부터 n개의 줄에 걸쳐 각 표지판들의 위치를 의미하는 정수 x, y가 공백으로 구분되어 주어진다. (-10<sup>4</sup> &le; x, y &le; 10<sup>4</sup>) 이는 (x, y)에 표지판이 위치함을 의미한다.</p>
