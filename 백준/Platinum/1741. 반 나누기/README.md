...
제출: 837, 정답: 216, 맞힌 사람: 159, 정답 비율: 27.273%

### 분류

자료 구조, 그래프 이론, 그래프 탐색, 집합과 맵, 분리 집합
...
<p>첫째 줄 학생들의 수 n과, 서로 메신저 아이디를 알고 있는 학생들 쌍의 수 m이 공백을 사이에 두고 주어진다. (2 &le; n &le; 100,000. 1 &le; m &le; 2,000,000) 이후 m개의 줄에는 서로 메신저 아이디를 알고 있는 학생들 번호의 쌍이 두 개의 정수로 주어진다. 두 학생의 번호는 1이상 n이하의 정수이다.</p>
