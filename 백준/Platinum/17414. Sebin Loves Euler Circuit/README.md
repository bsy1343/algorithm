...
제출: 185, 정답: 56, 맞힌 사람: 44, 정답 비율: 32.836%
...
<p>(i+1)번째 줄에는 i번째 간선의 정보를 나타내는 두 정수 <em>A</em><sub>i</sub>와 <em>B</em><sub>i</sub>가 사이에 공백을 두고 주어진다(1 &le; i &le; <em>M</em>).</p>

<p>i번째 간선은 <em>A</em><sub>i</sub>번 정점과 <em>B</em><sub>i</sub>번 정점을 서로 연결한다(1 &le; i &le; <em>M</em>, 1 &le; <em>A</em><sub>i</sub>&nbsp;&le; <em>N</em>, 1 &le; <em>B</em><sub>i</sub> &le; <em>N</em>).</p>

<p>모든 입력 데이터에 대하여 1 &le;&nbsp;<em>N</em> &le; 2&times;10<sup>5</sup>와 <em>N</em> &le;&nbsp;<em>M</em> &le; 10<sup>6</sup>을 만족한다.</p>
...
<p>(i+1)번째 줄에는 i번째로 추가할 간선이 연결하는 두 정점의 번호를 사이에 공백을 두고 출력한다(1 &le;&nbsp;i &le; <em>T</em>).</p>
