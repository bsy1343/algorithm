# [Platinum III] 레이싱결과 - 1742

[문제 링크](https://www.acmicpc.net/problem/1742)
...
제출: 251, 정답: 72, 맞힌 사람: 46, 정답 비율: 30.464%

### 분류

수학, 다이나믹 프로그래밍, 그래프 이론, 조합론, 비트마스킹, 비트필드를 이용한 다이나믹 프로그래밍, 방향 비순환 그래프, 위상 정렬

### 문제 설명

<p>상욱이는 레이싱 결과 맞추기를 좋아한다. 상욱이가 레이싱 결과를 맞추는 방법은 이전 경기에서 A란 선수가 B란 선수를 이긴 적이 있으면, A는 B를 무슨일이 있어도 이번 레이스에서 항상 이긴다고 가정하고 경기 결과를 예측 하는 방법이다.</p>
