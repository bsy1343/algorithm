...
제출: 516, 정답: 134, 맞힌 사람: 67, 정답 비율: 19.648%

### 분류

자료 구조, 세그먼트 트리, 이분 탐색, 스위핑, 매개 변수 탐색, 느리게 갱신되는 세그먼트 트리, 값 / 좌표 압축
...
<ol>
	...
	<li style="text-align: justify;">스피커들은 크기가 제각각이다.&nbsp;<em>i</em>번째 스피커의 크기가&nbsp;<em>S<sub>i</sub></em>이고 볼륨이 <em>V</em>이면, 그 스피커의 음악은 스피커와의 거리가 <em>V</em>&times;<em>S<sub>i</sub></em>&nbsp;이내인 모든 점에서 들을 수 있다.</li>
...
<p style="text-align: center;"><img alt="" src="%EB%B0%B1%EC%A4%80/Platinum/17423.%E2%80%85%EB%AF%BC%EC%9B%90%EC%9D%B4%E2%80%85%EB%84%98%EC%B3%90%ED%9D%98%EB%9F%AC/cf78baa1.png" data-original-src="%EB%B0%B1%EC%A4%80/Platinum/17423.%E2%80%85%EB%AF%BC%EC%9B%90%EC%9D%B4%E2%80%85%EB%84%98%EC%B3%90%ED%9D%98%EB%9F%AC/cf78baa1.png" data-original-src="https://upload.acmicpc.net/a4f4b6ae-caf7-411a-8fee-f35155a474d0/-/crop/1883x1090/0,0/-/preview/" onerror="this.onerror=null;this.src=this.dataset.originalSrc" style="width: 777px; height: 450px;" /></p>
...
<ul>
	...
	<li>1 &le; <em>S<sub>i</sub></em> &le; 1,000</li>
	<li>1 &le; <em>x<sub>i</sub></em>, <em>y<sub>i</sub></em>&nbsp;&le; 1,000,000</li>
</ul>