...
제출: 2210, 정답: 970, 맞힌 사람: 700, 정답 비율: 41.866%
...
<p>첫 번째 줄에는 정점의 개수 N(1 &le; N &le; 100,000)과 2번 쿼리의 개수 Q(1 &le; Q &le; 1,000,000)가 주어진다.</p>

<p>다음 N-1개 줄의 i번째 줄에는 정점 i+1의 부모 정점을 나타내는 정수 p(1 &le; p &le; N)가 주어진다.</p>

<p>다음 N개 줄의 i번째 줄에는 정점 i의 색깔을 나타내는 정수 c(1 &le; c &le; 100,000)가 주어진다.</p>

<p>다음 N+Q-1개의 줄에는 여러분이 처리해야 할 쿼리가 주어지는데, 1번 쿼리는 N-1개, 2번 쿼리는 Q개 주어진다.</p>

<p>쿼리는 한 줄에 하나씩 쿼리의 종류를 나타내는 X(1 &le; X &le; 2)와 쿼리에서 처리할 정점의 번호 a(1 &le; a &le; N)가 주어진다.</p>
