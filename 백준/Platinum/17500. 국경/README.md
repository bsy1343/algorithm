...
제출: 148, 정답: 86, 맞힌 사람: 63, 정답 비율: 55.263%
...
<p>이 나라는 <em>N&times;N</em> 모양의 사각 격자로 나타낼 수 있고 각 칸의 내부에는 최대 하나의 종이 살고 있습니다.</p>
...
<p>첫 번째 줄에 칸의 크기를 나타내는 정수 <em>N</em> (2 &le; <em>N</em> &le; 4) 이 주어집니다.</p>
