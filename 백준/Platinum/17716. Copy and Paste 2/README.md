# [Platinum IV] Copy and Paste 2 - 17716
...
제출: 70, 정답: 40, 맞힌 사람: 38, 정답 비율: 77.551%
...
<ul>
	<li>1 ≦ K ≦ 200．</li>
	<li>1 ≦ M ≦ 1 000 000 000．</li>
	<li>S の各文字は英アルファベットの小文字 (&lsquo;a&rsquo; &ndash; &lsquo;z&rsquo;) である．</li>
	<li>K ≦ (S の長さ) ≦ min{M, 200 000}．</li>
	<li>1 ≦ N ≦ 200 000．</li>
	<li>i 回目の操作の直前の文字列の長さを L<sub>i</sub> とすると，0 ≦ A<sub>i</sub> &lt; B<sub>i</sub> ≦ L<sub>i</sub> および 0 ≦ C<sub>i</sub> ≦ L<sub>i</sub> (1 ≦ i ≦ N)．</li>
</ul>