...
제출: 78, 정답: 39, 맞힌 사람: 36, 정답 비율: 66.667%
...
<ul>
	...
	<li>1 ≦ M ≦ 300 000．</li>
	<li>1 ≦ K ≦ 10 000．</li>
	<li>1 ≦ A<sub>i</sub> ≦ N, 1 ≦ B<sub>i</sub> ≦ N (1 ≦ i ≦ M)．</li>
	<li>A<sub>i</sub>, B<sub>i</sub> (1 ≦ i ≦ M)．</li>
	<li>1 ≦ C<sub>i</sub> ≦ 1 000 000 000 (1 ≦ i ≦ M)．</li>
	<li>C<sub>i</sub> &ne; C<sub>j</sub> (1 ≦ i &lt; j ≦ M)．</li>
</ul>