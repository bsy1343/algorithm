...
제출: 159, 정답: 98, 맞힌 사람: 87, 정답 비율: 70.161%
...
<ul>
	<li>The first line contains integers 3 &le; n &le; 10<sup>5</sup> and 1 &le; k &le; n &minus; 1, the number of nodes of the tree and the number of players. The nodes are labelled 0 through n &minus; 1, and 0 is the root of the tree.</li>
	<li>The second line contains k integers 0 &le; a<sub>1</sub>, . . . , a<sub>k</sub> &le; 10<sup>9</sup>, denoting the skill values of the players.</li>
	<li>Then follow n &minus; 1 lines, the ith of which (1 &le; i &le; n &minus; 1) contains the parent 0 &le; p<sub>i</sub> &lt; i of node i.</li>
</ul>
