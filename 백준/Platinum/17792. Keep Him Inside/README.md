...
제출: 235, 정답: 72, 맞힌 사람: 62, 정답 비율: 33.514%
...
<ul>
	<li>The first line contains 3 &le; n &le; 10, the number of Sorcerers in guard towers and two integers &minus;10<sup>4</sup> &le; x, y &le; 10<sup>4</sup>, the coordinates of the prisoner.</li>
	<li>Then follow n lines, each of which contains two integers &minus;10<sup>4</sup> &le; x, y &le; 10<sup>4</sup>, the coordinates of a Sorcerer.</li>
</ul>
...
<p>Your answer will be correct if the sum of fractions differs at most 10<sup>&minus;4</sup> from 1 and the weighted centre of your spell is within distance 10<sup>&minus;4</sup> of the prisoner. Note that it may not be sufficient to print your answer itself with 10<sup>&minus;4</sup> precision.</p>