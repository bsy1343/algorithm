...
제출: 173, 정답: 44, 맞힌 사람: 35, 정답 비율: 24.476%
...
<p>&ldquo;국밥 먹을바엔 뜨끈-하고 든든-한 돼지국밥 먹고 말지&rdquo;</p>
...
<p>첫째 줄에 배달시켜 먹을 사람들의 수 N이 정수로 주어진다. (1 &le; N &le; 5,000)</p>

<p>둘째 줄에 배달시켜 먹을 사람들의 주소들이 빈 칸을 기준으로 구분되어 주어진다.</p>

<p>셋째 줄에는 기름값 C와 체인점을 하나 짓는데 드는 금액 M이 자연수로 주어진다.(1 &le; C &le; 1,000, 1 &le; M &le; 1,000,000)</p>
