...
제출: 397, 정답: 235, 맞힌 사람: 183, 정답 비율: 63.103%
...
<p style="text-align: center;"><img alt="" src="%EB%B0%B1%EC%A4%80/Platinum/17969.%E2%80%85Gene%E2%80%85Tree/e1c42818.png" data-original-src="%EB%B0%B1%EC%A4%80/Platinum/17969.%E2%80%85Gene%E2%80%85Tree/e1c42818.png" data-original-src="https://upload.acmicpc.net/b0de84fb-77f8-445e-aaca-2862a4c4c213/-/preview/" onerror="this.onerror=null;this.src=this.dataset.originalSrc" style="width: 426px; height: 252px;" /></p>
...
<p>Your program is to read from standard input. The input starts with a line containing an integer <em>n</em> (4 &le; <em>n</em> &le; 100,000), where <em>n</em> is the number of nodes of the input gene tree <em>T</em>. Then <em>T</em> has <em>n</em> &minus; 1 edges. The nodes of <em>T</em> are numbered from 1 to <em>n</em>. The following <em>n</em> &minus; 1 lines represent <em>n</em>&nbsp;&minus; 1 edges of <em>T</em>, where each line contains three non-negative integers <em>a</em>, <em>b</em>, and <em>l</em>&nbsp;(1 &le; a &ne; b &le; <em>n</em>, 1 &le; <em>l</em> &le; 50) where two nodes <em>a</em> and <em>b</em> form an edge with phylogenetic length <em>l</em>.</p>
