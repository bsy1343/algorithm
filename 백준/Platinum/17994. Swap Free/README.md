...
제출: 84, 정답: 62, 맞힌 사람: 61, 정답 비율: 80.263%
...
<p>The first line of input contains a single integer <em>n</em> (1 &le; <em>n</em> &le; 500).</p>

<p>Each of the next <em>n</em> lines contains a single word <em>w</em> (1 &le; |<em>w</em>| &le; 26).</p>
