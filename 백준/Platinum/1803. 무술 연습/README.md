...
제출: 677, 정답: 112, 맞힌 사람: 80, 정답 비율: 23.529%
...
<p>첫째 줄에 두 자연수 m, n이 주어진다. (1 &le; m, n &le; 50,000) 한쪽 줄에 m명의 학생이, 반대편 줄에 n명의 학생이 서 있다는 의미이다.</p>

<p>학생들이 늘어선 두 개의 줄을 각각 A, B라고 하자. A줄에 늘어선 m 명의 학생은 1&sim;m까지 차례로 번호가 붙어 있고, B 줄에 늘어선 n 명의 학생은 n명의 학생은 1&sim;n까지 차례로 번호가 붙어 있다.</p>
