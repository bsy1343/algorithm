...
제출: 58, 정답: 47, 맞힌 사람: 44, 정답 비율: 80.000%
...
<p>The input contains two text lines. Each line contains a string of N capital letters &ldquo;A&rdquo;, &ldquo;C&rdquo;, &ldquo;G&rdquo;, or &ldquo;T&rdquo;, (1 &le; N &le; 10<sup>6</sup>). The two strings represent one pair of a particular gene versions. The first line represents the gene before the rock season, the second line represents the same gene from the same person after the rock season. The number of occurrences of each nucleobase is the same in both strings.</p>
