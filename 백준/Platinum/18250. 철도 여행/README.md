...
제출: 865, 정답: 352, 맞힌 사람: 285, 정답 비율: 42.857%
...
<p>입력의 첫 줄에 두 정수 <em>N</em>(1 &le; <em>N</em> &le; 200,000)과 <em>M</em>(1 &le; <em>M</em> &le; 300,000)이 주어진다.</p>

<p>이후 <em>M</em>개의 줄에 걸쳐 서로 다른 두 정수 <em>u</em>, <em>v</em>(1 &le; <em>u</em>, <em>v</em>&nbsp;&le; <em>N</em>)가 주어진다. 이는 <em>C<sub>u</sub></em>와 <em>C<sub>v</sub></em>를 양방향으로 잇는 철도 노선이 존재함을 의미한다.</p>
