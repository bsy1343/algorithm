...
제출: 776, 정답: 322, 맞힌 사람: 246, 정답 비율: 40.594%
...
<p>첫째 줄에 블록의 개수 N (1 &le; N &le; 100,000)이 주어진다. 둘째 줄부터 N개의 줄에 블록의 정보 W<sub>i</sub>, D<sub>i</sub>&nbsp;(1 &le; W<sub>i</sub>, D<sub>i</sub> &le; 1,000,000,000)가 한 줄에 하나씩 1번 블록부터 순서대로 주어진다.</p>
