...
제출: 20467, 정답: 8395, 맞힌 사람: 5215, 정답 비율: 37.553%
...
<p>첫째 줄에 $n$, $m$, $k$가 주어진다. ($1 &le; n &le; 1\,000$, $0 &le; m &le; 250\,000$, $1 &le; k &le; 100$, $mk &le; 3\,000\,000$) $n$과 $m$은 각각 김 조교가 여행을 고려하고 있는 도시들의 개수와, 도시 간에 존재하는 도로의 수이다.</p>

<p>이어지는 $m$개의 줄에는 각각 도로의 정보를 제공하는 세 개의 정수 $a$, $b$, $c$가 포함되어 있다. 이것은 $a$번 도시에서 $b$번 도시로 갈 때는 $c$의 시간이 걸린다는 의미이다. ($1 &le; a, b &le; n$, $1 &le; c &le; 1\,000$)</p>
