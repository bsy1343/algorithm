...
제출: 418, 정답: 55, 맞힌 사람: 28, 정답 비율: 10.182%
...
<p>첫 번째 줄에 탄약고 초소 길의 길이를 나타내는 정수&nbsp;<em>L</em>&nbsp;(1 &le;&nbsp;<em>L</em>&nbsp;&le; 18)이 주어진다.&nbsp;</p>

<p>두 번째 줄에 소총탄의 살상력을 나타내는 정수&nbsp;<em>B1<sub>power</sub></em> (1 &le;&nbsp;<em>B1<sub>power</sub></em>&nbsp;&le; 100)가 주어진다.&nbsp;</p>

<p>세 번째 줄에 산탄의 살상력을 나타내는 정수&nbsp;<em>B2<sub>power</sub></em> (<em>B1<sub>power</sub></em>&nbsp;&lt;&nbsp;<em>B2<sub>power</sub></em>&nbsp;&le; 500)와 산탄의 개수&nbsp;<em>B2<sub>ammo</sub></em> (0 &le;&nbsp;<em>B2<sub>ammo</sub></em>&nbsp;&le; 9)가 빈칸을 사이에 두고 주어진다.</p>

<p>네 번째 줄에 대구경탄의 살상력을 나타내는 정수&nbsp;<em>B3<sub>power</sub></em> (1 &le;&nbsp;<em>B3<sub>power</sub></em>&nbsp;&le; 500)와 대구경탄의 유효 관통 거리를 나타내는 정수&nbsp;<em>B3<sub>length</sub></em> (2 &le; <em>B3<sub>length</sub></em>&nbsp;&le; 18), 대구경탄의 개수&nbsp;<em>B3<sub>ammo</sub></em> (0 &le;&nbsp;<em>B3<sub>ammo</sub></em>&nbsp;&le; 9)가 빈칸을 사이에 두고 주어진다.</p>

<p>다섯 번째 줄부터&nbsp;<em>L</em>개의 줄에 걸쳐서 정수가 하나씩 주어진다. 이 때 <em>i</em>&nbsp;(1 &le;&nbsp;<em>i</em> &le; <em>L</em>)번째 정수는 탄약고 초소에서 <em>i</em> m 떨어진 곳의 좀비의 체력&nbsp;<em>Z<sub>i</sub></em> (0 &le;&nbsp;<em>Z<sub>i</sub></em>&nbsp;&le; 500)이다.&nbsp;<em>Z<sub>i</sub></em>가 0인 경우 <em>i</em> m 떨어진 곳에 좀비가 없다는 뜻이다.</p>
