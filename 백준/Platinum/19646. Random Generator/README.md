...
제출: 485, 정답: 311, 맞힌 사람: 245, 정답 비율: 65.508%
...
<ol>
	<li>1부터 <em>N</em>까지의 양의 정수&nbsp;<em>i&nbsp;</em>(1 &le;&nbsp;<em>i&nbsp;</em>&le;&nbsp;<em>N</em>)를 연속적으로 <em>w<sub>i</sub></em>개씩 배치한다.</li>
...
<p>첫 번째 줄에는 <em>N&nbsp;</em>(1 &le;&nbsp;<em>N&nbsp;</em>&le; 200,000)이 주어진다.</p>
