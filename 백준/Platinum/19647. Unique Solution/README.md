...
제출: 278, 정답: 107, 맞힌 사람: 90, 정답 비율: 47.120%
...
<p>첫 번째 줄에는 문제의 개수를 의미하는 정수 <em>N&nbsp;</em>(4 &le;&nbsp;<em>N&nbsp;</em>&le; 1,000)이 주어진다.</p>

<p>두 번째 줄부터 <em>N&nbsp;</em>+ 1번째 줄까지 정답의 후보군에 대한 정보가 들어온다. <em>i&nbsp;</em>+ 1번째 줄에는 정수 <em>A<sub>i</sub></em>&nbsp;(1 &le;&nbsp;<em>A<sub>i</sub></em>&nbsp;&le; 5)와 <em>A<sub>i</sub></em>개의 정수가 입력된다. <em>A<sub>i</sub></em>는 <em>i</em>번째 문제의 정답의 후보군의 개수며, 뒤의 정수는 정답의 후보군들이 들어온다. 후보군들은 서로 다른 정수들로 1부터 <em>N</em>까지의 정수다.</p>
