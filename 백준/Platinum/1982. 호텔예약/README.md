...
제출: 249, 정답: 71, 맞힌 사람: 46, 정답 비율: 25.556%
...
<p>첫째 줄에 남자의 수 m(1 &le; m &le; 100), 여자의 수 f(1 &le; f &le; 100), 방의 수 (1 &le; r &le; 100), 그리고 결혼을 한 쌍의 수 c(0 &le; c &le; min(m,f))가 공백을 사이에 두고 주어진다. 그리고 두 번째 줄부터 r+1번째 줄까지 방의 정보가 주어지는데 각 줄에는 두 개의 정수 1 &le; a &le; 5, 1 &le; b &le; 1000이 공백을 사이에 두고 주어진다. a는 번째 방에 들어갈 수 있는 최대인원, b는 번째 방을 얻는데 필요한 비용을 의미한다.</p>
