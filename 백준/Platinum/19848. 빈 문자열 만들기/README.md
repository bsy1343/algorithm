...
제출: 424, 정답: 103, 맞힌 사람: 92, 정답 비율: 47.423%
...
<p>예를 들어, <span style="font-style: italic;">S</span> = &ldquo;0111000011&rdquo;인 경우, <span style="font-style: italic;">S</span>의 2번째 문자부터 7번째 문자까지인 &ldquo;111000&rdquo;을 제거하는 것이 가능하다. 이 작업 후에는 제거된 부분의 앞부분과 뒷부분이 연결되어 <span style="font-style: italic;">S</span> = &ldquo;0011&rdquo;이 된다. 그러면 이제 한 번의 작업을 통해 &ldquo;0011&rdquo;을 제거할 수 있으므로 초기 <span style="font-style: italic;">S</span> = &ldquo;0111000011&rdquo;는 두 번의 작업을 통해 빈 문자열로 만들 수 있다.</p>
...
<ul>
	<li><span style="font-style: italic;">S</span>에 포함된 문자의 개수는 1 이상 500,000 이하이다.</li>
	<li><span style="font-style: italic;">S</span>에 포함된 0의 개수와 1의 개수는 동일하다.</li>
</ul>