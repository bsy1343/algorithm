# [Platinum I] Arranging Shoes - 19914
...
제출: 292, 정답: 116, 맞힌 사람: 107, 정답 비율: 46.725%
...
<ul>
	...
	<li>For each $i$ ($0 \leq i \leq 2n-1$), $1 \leq |S[i]| \leq n$.</li>
	<li>A valid arrangement of the shoes can be obtained by performing some sequence of swaps.</li>
</ul>