...
제출: 643, 정답: 279, 맞힌 사람: 237, 정답 비율: 47.117%
...
<p>&#39;(&#39;와 &#39;)&#39;로 이루어진 괄호 문자열 S = s<sub>1</sub>s<sub>2</sub>...s<sub>N</sub>과 M개의 쿼리가 주어진다. 쿼리는 두 정수 i, j (1 &le; i &le; j &le; N)로 이루어져 있고,&nbsp;쿼리가 의미하는 것은 다음과 같다.</p>
