...
제출: 976, 정답: 355, 맞힌 사람: 253, 정답 비율: 36.667%
...
<p>첫째 줄에 N(1 &le; N &le; 100), M(0 &le; M &le; 500)이 주어진다. 다음 줄에는 a, b, X, Y(0 &le; X, Y &le; 1,000)가 주어진다. 다음 M개의 줄에는 위에서부터 가로선에 대한 정보를 나타내는 정수 p가 주어진다. 이는 p번, p+1번 세로선을 연결하는 가로선을 의미한다.</p>
