...
제출: 229, 정답: 47, 맞힌 사람: 36, 정답 비율: 18.848%
...
<ol>
	<li>감옥은 <em>N</em> &times; <em>M</em> 크기의 격자판으로 이루어져 있고 감옥에는 사람 한 명이 갇혀있다.</li>
...
<p>첫 번째 줄에 <em>N, M, a, b, c&nbsp;</em>(1 &le;&nbsp;<em>N</em>,&nbsp;<em>M</em> &le;&nbsp;10, -100 &le;&nbsp;<em>a, b</em> &le;&nbsp;100, -2 &le;&nbsp;<em>c</em> &le;&nbsp;2)&nbsp;가 공백으로 구분되어 주어진다.&nbsp;</p>
