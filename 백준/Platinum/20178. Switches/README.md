...
제출: 323, 정답: 185, 맞힌 사람: 146, 정답 비율: 58.635%
...
<p>Your program is to read from standard input. An integer <em>N</em> (3 &le; <em>N</em> &le; 500) is given in the first line. Each of the following <em>N</em> line contains <em>N</em> integers of 0&rsquo;s and 1&rsquo;s separated by a single space. The numbers in the <em>i</em>-th (1 &le; <em>i</em> &le; <em>N</em>) line represent which lights are connected to the <em>i</em>-th switch. If the <em>k</em>-th (1 &le; <em>k</em> &le; <em>N</em>) value in the <em>i</em>-th line is 1, it means the <em>k</em>-th light is connected to the <em>i</em>-th switch; 0 means it is not connected.</p>
