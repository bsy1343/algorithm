...
제출: 638, 정답: 151, 맞힌 사람: 40, 정답 비율: 13.201%
...
<ul>
	<li>페널티 (<em>penalty</em>): 대회의 페널티 (0 &le; <em>penalty</em> &le; 100)</li>
...
<ol>
	<li>번호 (<em>id</em>): BOJ에서 문제를 구분하기 위해 사용하는 고유 번호 (1,000 &le; <em>id</em> &le; 30,000)</li>
	<li>순서 (<em>order</em>): 대회 문제의 순서로 문제를 정렬하는데 사용 (1 &le; <em>order</em> &le; 대회에 포함된 문제의 개수)</li>
	<li>배점 (<em>pscore</em>): 점수 대회에서만 사용하는 값으로, 문제의 배점이다. (0 &le; <em>pscore</em> &le; 2,147,483,647)</li>
</ol>
...
<ul>
	<li>제출 번호 (<em>sid</em>): 제출 순으로 BOJ에서 정하는 제출 번호. (1 &le; <em>sid</em> &le; 10<sup>9</sup>)</li>
	...
	<li>채점 결과 (<em>result</em>): 4인 경우만 &quot;성공&quot; 또는 &quot;부분 성공&quot;이다. 컴파일 에러의 경우는 11이다. (4 &le; <em>result</em> &le; 13)
	<ul>
		<li><em>result</em>가 13인 경우 제출이 없는 것으로 무시해야 한다.</li>
	</ul>
	</li>
	<li>부분 성공 여부 (<em>presult</em>): <em>result</em>가 4인 경우만 의미가 있으며, 그 외의 경우에는 무시한다. 0이면 &quot;성공&quot;, 1이면 &quot;부분 성공&quot;이다. (0 &le; <em>presult</em> &le; 1)</li>
	<li>점수 (<em>score</em>): <em>result</em>가 4일때만 의미가 있으며, 그 외의 경우에는 무시한다. (0 &le; <em>score</em> &le; 2,147,483,647)</li>
...
<ul>
	<li>페널티 1
	<ul>
		<li>(좋은 제출 전까지 유저 <em>u</em>가 문제 <em>p</em>에 제출한 횟수) &times; (대회의 페널티)</li>
		<li>좋은 제출이 없으면 0</li>
	</ul>
	</li>
	<li>페널티 2
...
<p>둘째 줄에 대회에 포함된 문제의 수 <em>N</em> (1 &le; N &le; 26)이 주어진다.</p>

<p>셋째 줄부터 <em>N</em>개의 줄에 대회 문제의 값 <em>id</em>, <em>order</em>, <em>pscore</em>가 한 줄에 하나씩 주어진다. </p>

<p>다음 줄에는 대회에 참가한 유저의 수 <em>M</em> (1 &le; <em>M</em> &le; 1,000)이 주어지고, 그 다음 줄에 대회에 참가한 유저의 아이디가 주어진다. </p>

<p>그 다음 줄에는 이 대회에 제출된 제출의 수 <em>S</em> (1 &le; <em>S</em> &le; 1,000,000)가 주어진다.</p>
...
<p>스코어보드를 HTML 표로 생성하는 BOJ의 소스 코드를 이용해서 이 문제의 데이터를 만들었다.</p>