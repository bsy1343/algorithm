...
제출: 530, 정답: 254, 맞힌 사람: 185, 정답 비율: 54.252%
...
<p>첫 번째 줄에 N이 주어진다. 두 번째 줄에 N개의 정렬할 수 A<sub>1</sub>, A<sub>2</sub>, &middot; &middot; &middot; , A<sub>N</sub>이 공백 하나를 사이로 두고 주어진다. 이 수들은 모두 정수이다.</p>
...
<ul>
	...
	<li>1 &le; A<sub>1</sub>, &middot; &middot; &middot; , A<sub>N</sub> &le; 1 000 000</li>
</ul>