...
제출: 1922, 정답: 549, 맞힌 사람: 423, 정답 비율: 28.427%
...
<p>정수가 저장된 크기 N인 배열 A가 있을 때, &lsquo;순서 섞기&rsquo; 연산은 아래와 같이 정의된다.</p>
...
<p style="text-align: center;"><img alt="" src="%EB%B0%B1%EC%A4%80/Platinum/20192.%E2%80%85%EC%88%9C%EC%84%9C%E2%80%85%EC%84%9E%EA%B8%B0/daddc7b0.png" data-original-src="%EB%B0%B1%EC%A4%80/Platinum/20192.%E2%80%85%EC%88%9C%EC%84%9C%E2%80%85%EC%84%9E%EA%B8%B0/daddc7b0.png" data-original-src="https://upload.acmicpc.net/f991c11b-4a4f-4cf5-b0a3-63b3380e6e6c/-/preview/" onerror="this.onerror=null;this.src=this.dataset.originalSrc" style="width: 359px; height: 186px;" /></p>

<p>위에서 보인 그림처럼 순서 섞기 연산을 하면 배열 A의 값은 다음과 같이 변경된다.</p>

<p style="text-align: center;">(34, 19, 5, 36, 4, 25, 12, 9) =&rArr; (9, 34, 19, 12, 25, 4, 5, 36)</p>

<p>배열 A의 i번째 원소를 A<sub>i</sub>라고 나타내자. &ldquo;1 &le; i &lt; j &le; N이면 A<sub>i</sub> &le; A<sub>j</sub>이다.&rdquo;가 성립할 때, &ldquo;배열 A는 단조증가한다&rdquo;라고 말한다.</p>

<p>정수가 저장된 크기 N인 배열 A가 주어질 때, 배열 A가 단조증가하도록 정렬하기 위해 필요한 &lsquo;순서 섞기&rsquo; 연산의 <strong>최소 횟수</strong>를 계산하는 프로그램을 작성하시오.</p>
...
<p>배열 A가 단조증가하도록 정렬하기 위해 필요한 &lsquo;순서 섞기&rsquo; 연산의 최소 횟수를 출력한다.</p>
