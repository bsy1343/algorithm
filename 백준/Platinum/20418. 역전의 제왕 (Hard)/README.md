# [Platinum I] 역전의 제왕 (Hard) - 20418

[문제 링크](https://www.acmicpc.net/problem/20418)
...
제출: 99, 정답: 27, 맞힌 사람: 23, 정답 비율: 28.049%

### 분류

구현, 자료 구조, 세그먼트 트리, 시뮬레이션, 트리를 사용한 집합과 맵
...
<p>첫번째 줄에는 참가자들의 수 <em>N</em> (1 &le; <em>N</em> &le; 50,000), 대회 중 제출된 참가자들의 제출이력의 수 <em>M</em> (<em>N</em> &le; <em>M</em> &le; 13&times;<em>N</em>)이 주어진다.</p>
...
<p>제출이력은 제출시간, 참가자 번호 <em>id</em> (1 &le; <em>id</em> &le; N), 문제번호 <em>p</em> (1 &le; <em>p</em> &le; 13), 제출횟수 <em>s</em> (1 &le; <em>s</em> &le; 100) 순으로 주어진다. 각 참가자의 제출 횟수는 총 <strong>100회</strong>를 넘지 않는다. 제출시간은 <em>hh:mm</em> 형식으로 주어지며, 스코어보드는 03:00를 지난 후 부터 프리징 된다. (00:00 &lt; <em>hh:mm</em> &le; 04:00)</p>
...
<p>역전의 제왕(normal)과 역전의 제왕(hard)의 차이는 N의 크기의 차이이다.</p>

<p>1 &le; <em>N</em> &le; 50,000</p>