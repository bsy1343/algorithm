...
제출: 3251, 정답: 589, 맞힌 사람: 345, 정답 비율: 17.941%
...
<p>편의를 위해 사람들의 이야기를 &ldquo;X년도에는 Y년도 이후 가장 많은 비가 내렸다&rdquo;는 형태로 한정하기로 하자. 이러한 이야기는 다음의 조건들이 만족될 때 참이 된다.</p>
...
<p>첫째 줄에 정수 n(1 &le; n &le; 50,000)이 주어진다. 다음 n개의 줄에는 두 정수 y(0 &le; |y| &le; 1,000,000,000), r(1 &le; r &le; 1,000,000,000)이 주어지는데, 이는 y년도의 강수량이 r이라는 의미이다. 이러한 정보는 y가 증가하는 순서대로 주어진다. 그 다음 줄에는 정수 m(1 &le; m &le; 10,000)이 주어진다. 그 다음 m개의 줄에는 사람들의 이야기에 대한 정보를 나타내는 두 정수 Y, X(-1,000,000,000 &le; Y &lt; X &le; 1,000,000,000)가 주어진다.</p>
