...
제출: 327, 정답: 46, 맞힌 사람: 31, 정답 비율: 19.497%
...
<p>N(1 &le; N &le; 30,000)개의 좌석으로 되어 있는 기차가 있다. 편의상 좌석에 1번부터 N번까지의 번호가 붙어있다고 하자. 철도 회사에서는 명절을 맞이하여 귀성하는 가족들에게 기차 티켓을 팔기로 하였다. 문제를 단순화하기 위해서, 편의상 모든 가족들은 L(1 &le; L &le; 100)명으로 이루어져 있다고 가정하자.</p>
...
<p>첫째 줄에 세 정수 N, L, M(1 &le; M &le; 100,000)이 주어진다. 다음 줄에는 M개의 정수 z(1 &le; z &le; N-L+1)가 주어진다. 이는 그 가족이 z번 좌석부터 z+L-1번 좌석까지를 구매하기를 원한다는 의미이다.</p>
