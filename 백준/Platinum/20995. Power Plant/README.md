...
제출: 56, 정답: 36, 맞힌 사람: 36, 정답 비율: 69.231%
...
<p>The JOI power plant has N bases numbered from 1 to N. The bases are connected by N &minus; 1 wires. The i-th wire (1 &le; i &le; N &minus; 1) connects the base A<sub>i</sub> and the base B<sub>i</sub>, in both directions. We can travel from any base to any other base by passing through some wires.</p>
...
<ul>
	...
	<li>S is a string of length 2N which consists of <code>B</code> and <code>W</code>. The character <code>B</code> appears N times in the string S, and the character <code>W</code> appears N times in the string S.</li>
</ul>