...
제출: 82, 정답: 43, 맞힌 사람: 30, 정답 비율: 45.455%
...
<p>For example, if N = 3, and M = 1, then there are two different paths that Ani&rsquo;s piece can use to the goal:</p>
...
<p>Input begins with a line containing two integers: N M (1 &le; N, M &le; 100 000) representing the number of super cards and normal cards, respectively.</p>
