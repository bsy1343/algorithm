# [Platinum II] 프로그래밍 언어 L - 2119

[문제 링크](https://www.acmicpc.net/problem/2119)
...
제출: 119, 정답: 8, 맞힌 사람: 6, 정답 비율: 75.000%

### 분류

구현, 다이나믹 프로그래밍, 자료 구조, 그래프 이론, 세그먼트 트리, 시뮬레이션, 느리게 갱신되는 세그먼트 트리, 방향 비순환 그래프, 재귀, 위상 정렬

### 문제 설명

<p>다음과 같은 가상의 프로그래밍 언어 L이 있다.</p>

<ol>
	<li>L 프로그램의 각 줄은 순서대로 1부터 N(1 &le; N &le; 100,000)의 번호가 붙어 있다.</li>
