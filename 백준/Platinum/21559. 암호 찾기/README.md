...
제출: 436, 정답: 135, 맞힌 사람: 102, 정답 비율: 33.117%
...
<p>오랜 기간 동안 세계 4대 문명이 최초의 문명으로 알려져 있었으나, 얼마 전 이를 뒤집는 고고학적 연구 결과가 발표되었습니다. 이번에 새로 발견된 문명인 &lsquo;폴리매스 문명&rsquo;은 기원전 9000년경부터 존재하였음이 확인되었습니다.</p>
...
<ul>
	...
	<li>$1 \le K \le N$</li>
	<li>$|A| = |B| = N$</li>
	<li>$A$, $B$의 모든 문자는 1 이상 9 이하의 숫자입니다.</li>
</ul>