...
제출: 2000, 정답: 435, 맞힌 사람: 262, 정답 비율: 20.263%
...
<ul>
	...
	<li>사원의 실력은 $-1~000~000~000$ 이상, $1~000~000~000$ 이하의 정수이다.</li>
	<li>사원 $1$을 제외한 각 사원 $i$의 직속 상사 번호는 $i - 1$ 이하이다.</li>
	<li>지문에 제시된 조건을 만족하도록 두 팀을 구성할 수 있다.</li>
</ul>