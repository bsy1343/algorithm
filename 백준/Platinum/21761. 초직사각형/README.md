...
제출: 4042, 정답: 1088, 맞힌 사람: 800, 정답 비율: 28.623%
...
<ul>
	...
	<li>$1 \le A_0, B_0, C_0, D_0 &le; 1~000~000$</li>
	<li>모든 $1 \le i \le N$에 대해, $T_i$는 <code>A</code>, <code>B</code>, <code>C</code>, <code>D</code> 중 하나이다.</li>
	<li>모든 $1 \le i \le N$에 대해, $U_i$는 $1$ 이상 $1~000~000$ 이하의 자연수이다.</li>
</ul>