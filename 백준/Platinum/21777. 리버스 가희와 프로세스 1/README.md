...
제출: 220, 정답: 66, 맞힌 사람: 49, 정답 비율: 30.435%
...
<ul>
	<li>1 &le; 문제에서 주어지는 시간 <em>T&nbsp;</em>&le; 10<sup>5</sup>​​​​, 1 &le; 문제에서 주어지는&nbsp;프로세스들의 <em>id&nbsp;</em>&le; 10<sup>6</sup></li>
	<li>1 &le; 출력해야 하는 프로세스들의&nbsp;정보 &le; 10<sup>6</sup></li>
	<li>가능한 경우만 입력으로 주어집니다.</li>
