...
제출: 113, 정답: 32, 맞힌 사람: 26, 정답 비율: 32.099%
...
<ul>
	...
	<li>1 &le; <em>Q</em> &le; 50</li>
	<li>1 &le; <em>A<sub>i</sub></em>, <em>B<sub>i</sub></em>, <em>C<sub>i</sub>&nbsp;</em>&le; 10<sup>12</sup></li>
	<li>1 &le; 문제에서 주어지는 <em>T<sub>c</sub></em>값 &le; <strong>min(10<sup>17</sup>, 프로세스가 실행을 마치는 데 필요한 시간의 총합)</strong></li>
</ul>