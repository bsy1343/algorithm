...
제출: 2511, 정답: 954, 맞힌 사람: 666, 정답 비율: 35.201%
...
<p>N(1 &le; N &le; 100)마리의 들쥐들과 M(1 &le; M &le; 100)개의 땅굴이 있다. 각각의 들쥐는 2차원 평면상의 한 위치에 있고, 각각의 땅굴들도 2차원 평면상의 한 점에 위치한다.</p>
...
<p>매는 현재를 기준으로 S(1 &le; S &le; 100)초가 지난 후에 지상에 도착한다. 각각의 들쥐들은 매 초당 V(1 &le; V &le; 100)만큼의 거리를 움직인다(즉 V가 쥐들의 초속이다). 만약 S초가 되기 전에 들쥐가 땅굴에 도착하게 되면 그 들쥐는 땅굴로 숨을 수 있다. 단, 들쥐가 도착하는 시간이 정확히 S인 경우에도 그 들쥐는 도망칠 수 있는 것으로 간주한다.</p>
