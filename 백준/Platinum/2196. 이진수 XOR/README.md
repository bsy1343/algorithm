...
제출: 666, 정답: 114, 맞힌 사람: 94, 정답 비율: 18.762%
...
<p>길이 B(1 &le; B &le; 16)인 이진수들이 E(1 &le; E &le; 100)개 있다. 이 이진수들을 두 개씩 선택하여 XOR연산을 하여, 어떤 이진수를 만들려고 한다. 이 과정에서 만들어지는 이진수들을 이용하여 XOR연산을 해도 되며, 같은 두 이진수를 XOR연산을 해도 된다.</p>
