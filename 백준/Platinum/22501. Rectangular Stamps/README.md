# [Platinum II] Rectangular Stamps - 22501

[문제 링크](https://www.acmicpc.net/problem/22501)
...
<p><i>N</i> はスタンプの個数，<i>H</i><sub><i>i</i></sub>, <i>W</i><sub><i>i</i></sub> (1 &le; <i>i</i> &le; <i>N</i>) はそれぞれ，<i>i</i> 番目のスタンプの縦の長さ，横の長さを表す整数である．<i>C</i><sub><i>i</i>, <i>j</i></sub> (1 &le; <i>i</i> &le; 4，1 &le; <i>j</i> &le; 4) は，上から <i>i</i> 行目，左から <i>j</i> 列目のマスについて指定された絵の色を表す文字である．赤は <code>R</code> ，緑は <code>G</code> ，青は <code>B</code> で表される．</p>

<p>1 &le; <i>N</i> &le; 16，1 &le; <i>H</i><sub><i>i</i></sub> &le; 4，1 &le; <i>W</i><sub><i>i</i></sub> &le; 4 を満たす．(<i>H</i><sub><i>i</i></sub>, <i>W</i><sub><i>i</i></sub>) として同一の組は複数回現れない．</p>
