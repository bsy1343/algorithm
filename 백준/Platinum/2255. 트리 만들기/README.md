# [Platinum II] 트리 만들기 - 2255

[문제 링크](https://www.acmicpc.net/problem/2255)
...
제출: 346, 정답: 51, 맞힌 사람: 40, 정답 비율: 33.333%
...
<p>첫째 줄에 세 정수 N(2 &le; N &le; 1,000), M(N-1 &le; M &le; N&times;(N-1)/2), R(1 &le; R &le; N)이 주어진다. N은 정점의 개수, M은 간선의 개수, R은 루트의 번호이다. 다음 M개의 줄에는 각 간선에 대한 정보를 나타내는 두 정수 A, B(1 &le; A, B &le; N)가 주어진다. 이는 그 간선이 연결하고 있는 서로 다른 두 정점의 번호이다. 같은 간선이 여러 번 주어지는 경우는 없다.</p>
