...
제출: 303, 정답: 116, 맞힌 사람: 58, 정답 비율: 30.366%
...
<p>Input may contain multiple test cases. The first line is a positive integer n (n &le; 100), denoting the number of test cases below. Each case is composed of two lines, the first one is the description of orbit A, and the second one the description of orbit B. Each description contains two positive integers, a and b (a, b &le; 100), denoting the ellipse equation x<sup>2</sup>/a<sup>2</sup> + y<sup>2</sup>/b<sup>2</sup> = 1. It is guaranteed that the focuses of orbit A are on x-axis, and the focuses of orbit B are on y-axis.</p>
