...
제출: 2037, 정답: 921, 맞힌 사람: 659, 정답 비율: 43.327%
...
<p>첫째 줄에 미지수의 수 <em>N&nbsp;</em>(2 &le;&nbsp;<em>N&nbsp;</em>&le; 6)이 주어진다.</p>

<p>둘째 줄부터 <em>N&nbsp;</em>개의 줄에 걸쳐 각 방정식을 나타내는 <em>N+1</em>개의 정수 <em>A<sub>1</sub>, A<sub>2</sub>, ..., A<sub>N</sub>, B</em>&nbsp;(1 &le; <em>A<sub><em>i</em>&nbsp;&nbsp;</sub>&le;&nbsp;</em>10)가 주어진다.</p>
