...
제출: 289, 정답: 124, 맞힌 사람: 94, 정답 비율: 52.514%

### 분류

수학, 해 구성하기, 분할 정복, 불변량 찾기
...
<p>첫째 줄에 방의 개수를 나타내는 정수 N (단, 2<sup>1</sup> &le;&nbsp;N &le; 2<sup>13</sup>=8192)이 주어진다. N은 2의 거듭제곱인 정수이다. 둘째 줄에는 해리 포터가&nbsp;IN을 사용해 들어간 방의 번호를 나타내는 정수 M이 주어진다. (단, 1 &le; M &le; N)</p>
