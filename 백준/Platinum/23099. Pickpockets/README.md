...
제출: 34, 정답: 18, 맞힌 사람: 18, 정답 비율: 62.069%
...
<p>The first line contains two integers H and T (1 &le; H &le; 10<sup>5</sup>, 1 &le; T &le; 16), the number of days in the holidays and the number of teams available. The second line contains H integers C<sub>k</sub> (0 &le; C<sub>k</sub> &le; 10<sup>5</sup>, 1 &le; k &le; H), the highest labels of a clean store on the k-th day of holidays. Label 0 means there is no clean store on the k-th day of holidays. Each of the next T lines contains two integers D<sub>t</sub> and I<sub>t</sub> (1 &le; D<sub>t</sub> &le; H, 0 &le; I<sub>t</sub> &le; 10<sup>6</sup>, 1 &le; t &le; T), the duration of the operation of team t in days, and the minimum income the team generates.</p>
