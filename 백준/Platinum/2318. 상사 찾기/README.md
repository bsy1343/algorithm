...
제출: 178, 정답: 48, 맞힌 사람: 36, 정답 비율: 40.449%
...
<p>첫째 줄에 두 정수 n(1 &le; n &le; 30,000), m(1 &le; m &le; 200)이 주어진다. n은 사원의 수고, m은 우리가 직속 상사와 부하의 수를 알아보려는 사원의 수이다. 다음 n개의 줄에는 각 사원의 정보를 나타내는 세 정수 a, b, c가 주어진다. a(1 &le; a &le; 2,147,483,647)는 사원의 ID, b(0 &le; b &le; 10,000,000)는 급료, c(1,000,000 &le; c &le; 2,500,000)는 근무한 시간(분 단위)을 나타낸다. 사원의 ID는 중복되지 않는다.</p>
