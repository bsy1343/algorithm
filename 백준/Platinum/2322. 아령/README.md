...
제출: 1040, 정답: 478, 맞힌 사람: 405, 정답 비율: 50.562%
...
<p>첫째 줄에 n(1 &le; n &le; 100,000)이 주어진다. 다음 줄에는 걸려 있는 순서대로 아령의 무게가 주어진다. 각 아령의 무게는 2<sup>30</sup>보다 작거나 같은 자연수이며 답이 2<sup>31</sup>-1보다 작거나 같게&nbsp;되도록 주어진다.</p>
