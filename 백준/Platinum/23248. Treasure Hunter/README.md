...
제출: 824, 정답: 312, 맞힌 사람: 252, 정답 비율: 50.704%
...
<p>Your program is to write to standard output. Print exactly one line. The line should contain the minimum number of THR&rsquo;s to collect all the treasures on the map.</p>