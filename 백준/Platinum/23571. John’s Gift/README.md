...
제출: 724, 정답: 166, 맞힌 사람: 132, 정답 비율: 24.309%
...
<p>Your program is to write to standard output. Print exactly one line. The line should contain the value of the good that John picks for Jane&rsquo;s birthday gift such that its removal produces the smallest matching score in the remaining $n - 1$ goods. If there are multiple candidate goods, print the smallest value among the candidate goods.</p>