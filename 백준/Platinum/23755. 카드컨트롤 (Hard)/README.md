# [Platinum III] 카드컨트롤 (Hard) - 23755

[문제 링크](https://www.acmicpc.net/problem/23755)
...
제출: 180, 정답: 53, 맞힌 사람: 44, 정답 비율: 30.137%
...
<ol>
	...
	<li>준석이의 카드와 수현이의 카드가 같으면 무승부, 다른 카드면 O가 적힌 카드를 가진 사람의 점수가 1점 추가된다.</li>
</ol>
...
<p>첫 번째 줄에 $N$이 주어진다. ($1 \leq N \leq 10^6$)</p>

<p>다음 줄에 위에 있는 카드부터 순서대로&nbsp;카드에 적혀있는 문양이 주어진다.</p>

### 출력

<p>카드의 최소 조작 횟수를 출력한다.</p>