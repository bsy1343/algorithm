...
제출: 185, 정답: 98, 맞힌 사람: 81, 정답 비율: 54.730%
...
<ul>
	...
	<li>$1 \le K_i \le 100$ ($1 \le i \le N$)</li>
	<li>$1 \le T_i \le 2$ ($1 \le i \le Q$)</li>
	<li>$T_i = 1$일 때, $1 \le A_i \le B_i \le N$ ($1 \le i \le Q$)</li>
	<li>$T_i = 2$일 때, $1 \le A_i \le N$ ($1 \le i \le Q$)</li>
	<li>$T_i = 2$일 때, $1 \le B_i \le 100$ ($1 \le i \le Q$)</li>
	<li>$T_i = 1$인 $i$가 적어도 하나 존재한다. ($1 \le i \le Q$)</li>
</ul>