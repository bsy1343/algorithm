...
제출: 83, 정답: 44, 맞힌 사람: 42, 정답 비율: 55.263%
...
<p>規則 i (1 &le; i &le; M)：文字 A<sub>i</sub> の直後に文字 B<sub>i</sub> は来ない．</p>
...
<ul>
	...
	<li>続く M 行には IOI 語の規則の情報が書かれている．i + 3 行目 (1 &le; i &le; M) には，規則 i を表す A から Z までの文字 A<sub>i</sub>, B<sub>i</sub> が空白を区切りとして書かれている．A<sub>i</sub> = A<sub>j</sub> かつ B<sub>i</sub> = B<sub>j</sub> なる規則 j (j &ne; i) は存 在しない．</li>
</ul>
...
<ul>
	<li>1 &le; L &le; 300 000 機密文書の長さ</li>
	<li>0 &le; M &le; 26 &times; 26 IOI 語の規則の個数</li>
</ul>