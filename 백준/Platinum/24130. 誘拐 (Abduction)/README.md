...
제출: 55, 정답: 29, 맞힌 사람: 27, 정답 비율: 52.941%
...
<p>入力の 1 行目には 2 つの整数 W, H (1 &le; W, H &le; 1000) が書 かれている．これは，南北，東西に走る道路の本数がそれぞれ W + 1 本，H + 1 本であること を表す．</p>

<p>2 行目には，1 つの整数 N(1 &le; N &le; 10 000) が書かれている．これは，Y の証言の長さを表す．</p>
