...
제출: 119, 정답: 81, 맞힌 사람: 78, 정답 비율: 70.270%
...
<p>入力の 1 行目には，2 つの整数 n, m (1 &le; n &le; 100 000， 0 &le; m &le; 100 000) が空白を区切りとして書かれている．n は新製品の購入が予想される人の人 数を表す．</p>

<p>続く m 行 (2 行目から m + 1 行目) はどの人がどの人の連絡先を知っているかを表す．j + 1 行目 (1 &le; j &le; m) には，2 つの整数 a<sub>j</sub>, b<sub>j</sub> (1 &le; a<sub>j</sub>, b<sub>j</sub> &le; n，a<sub>j</sub>&nbsp;&ne;&nbsp;b<sub>j</sub>) が空白を区切りとして書か れている．これは，人 a<sub>j</sub> が人 b<sub>j</sub> の連絡先を知っていることを表す．人は 1 から n までの整数で 表される．j &ne;&nbsp;k ならば a<sub>j</sub> = a<sub>k</sub> かつ b<sub>j</sub> = b<sub>k</sub> となることはない．</p>
