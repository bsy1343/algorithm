...
제출: 69, 정답: 42, 맞힌 사람: 38, 정답 비율: 65.517%
...
<p>入力の 1 行目には 1 つの整数 N (1 &le; N &le; 300) が書かれて いる．これはお箸の彩色される部分の長さが Nmm であることを表す．</p>

<p>2 行目には，N 文字からなる英字 (A～Z, a～z) の列が与えられる．文字列の i 文字目が端から (i &minus; 1)mm から imm までの色を表す．</p>
