...
<p><img alt="" src="https://upload.acmicpc.net/50375d0a-4a39-4f2f-bcc8-9e03a171ecd7/-/preview/" style="width: 184px; height: 171px; float: right;" />In Olympia, there is a circular village with N houses. They are numbered from 1 to N in the clockwise order. For example, if N = 8, the village would look like on the picture (the circle is the border line of the village):</p>
