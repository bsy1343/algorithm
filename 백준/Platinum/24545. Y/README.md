...
제출: 661, 정답: 241, 맞힌 사람: 182, 정답 비율: 34.082%
...
<p>$1$, $2$, &hellip; $N$까지의 번호가 하나씩 매겨진 정점&nbsp;$N$개로 이루어진&nbsp;트리가 주어진다.&nbsp;주어진 트리에서 정점을 $0$개 이상 삭제하여 만들 수 있는 가장 큰 Y-트리의 크기를 구하는 프로그램을 작성하시오.&nbsp;</p>
