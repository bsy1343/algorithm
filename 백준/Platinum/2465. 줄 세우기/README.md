...
제출: 1711, 정답: 1021, 맞힌 사람: 746, 정답 비율: 63.598%
...
<p>첫째 줄에는 전체 사람의 수 N (1 &le; N &le; 100,000)이 주어진다. 다음 N개의 줄에 사람들의 키를 나타내는 양의 정수가 하나씩 주어진다. 여기서 모든 키들은 2&times;10<sup>9</sup>이하이다. 그리고 마지막 줄에 수열 S가 한 줄로 주어진다. 단 그 수열의 수는 하나의 공백을 두고 나타난다.&nbsp;</p>
