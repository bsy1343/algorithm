...
제출: 360, 정답: 128, 맞힌 사람: 85, 정답 비율: 38.636%

### 분류

자료 구조, 문자열, 집합과 맵, 우선순위 큐, 트리를 사용한 집합과 맵
...
<p style="text-align: center;"><img alt="" src="%EB%B0%B1%EC%A4%80/Platinum/2471.%E2%80%85%EB%AA%A8%EB%B9%8C%E2%80%85%EC%9D%B4%EC%A7%84%EC%88%98/2d02a020.png" data-original-src="%EB%B0%B1%EC%A4%80/Platinum/2471.%E2%80%85%EB%AA%A8%EB%B9%8C%E2%80%85%EC%9D%B4%EC%A7%84%EC%88%98/2d02a020.png" data-original-src="https://www.acmicpc.net/upload/images/w7.png" onerror="this.onerror=null;this.src=this.dataset.originalSrc" style="width: 346px; height: 267px; " /></p>
...
<p>모빌의 하나의 상태가 주어졌을 때, 그 상태를 변화시키면 매우 다양한 모빌 이진수를 관찰할 수 있는데, 이 문제의 목표는 관찰 가능한 모든 모빌 이진수들 중에서 K번째로 작은 모빌 이진수를 찾아내는 것이다. 단, 모빌의 서로 다른 형태가 동일한 모빌 이진수를 만들어 내는 경우, 동일한 숫자들은 &ldquo;하나만&rdquo; 남기고 나머지는 모두 제거하여야 한다. 예를 들어, 다음과 같은 모빌의 경우,&nbsp;</p>
...
<ul>
	<li><code>(0((01)1)1)</code> &rarr;&nbsp;<code>00111</code>&nbsp;&rarr; 가장 작은 수</li>
	<li><code>(0((10)1)1)</code>&nbsp;&rarr; <code>01011</code>&nbsp;&rarr; 2번째로 작은 수</li>
	<li><code>(0(1(01))1)</code>&nbsp;&rarr; <code>01011</code>&nbsp;&rarr; 위의 수와 동일</li>
	<li><code>(0(1(10))1)</code>&nbsp;&rarr; <code>01101</code>&nbsp;&rarr; 3번째로 작은 수</li>
</ul>
