...
제출: 436, 정답: 101, 맞힌 사람: 66, 정답 비율: 27.848%
...
<p style="text-align: center;"><img alt="" src="%EB%B0%B1%EC%A4%80/Platinum/2474.%E2%80%85%EA%B5%90%EC%B0%A8%E2%80%85%EC%84%A0%EB%B6%84/c4f23ef3.png" data-original-src="%EB%B0%B1%EC%A4%80/Platinum/2474.%E2%80%85%EA%B5%90%EC%B0%A8%E2%80%85%EC%84%A0%EB%B6%84/c4f23ef3.png" data-original-src="https://upload.acmicpc.net/832ca4d9-b1eb-456b-adcf-bd8ed217fd9a/-/preview/" onerror="this.onerror=null;this.src=this.dataset.originalSrc" style="width: 259px; height: 104px;" /></p>

<p>선분 집합에서 일부 선분들을 뽑아 선분들의 리스트 (s<sub>1</sub>, s<sub>2</sub>, ..., s<sub>k</sub>)를 구성할 수 있는데, 리스트 상에서 모든 인접한 두 선분 s<sub>i</sub>와 s<sub>i+1</sub>&nbsp;(1 &le; i &lt; k)이 서로 교차하면, 이 리스트를 선분 체인(chain)이라 부른다. 선분 체인의 길이는 체인을 구성하는 선분들의 개수로 정의된다. 예를 들어, 위 그림에서 선분 리스트 (B, C, D, F)는 길이가 4인 선분 체인이지만, (A, C, D)는 선분 체인이 아니다.</p>
