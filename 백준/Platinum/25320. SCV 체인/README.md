...
제출: 826, 정답: 161, 맞힌 사람: 141, 정답 비율: 21.793%

### 분류

그리디 알고리즘, 집합과 맵, 해 구성하기

### 문제 설명

<p>블록체인 컨설팅 회사 SCVSoft에서는 두 대의 건설 로봇<span style="color: Gray">(SCV)</span>이 일하고 있다. 두 로봇에게는 &ldquo;A&rdquo;와 &ldquo;B&rdquo;라는 멋진 이름이 붙어 있다.</p>
