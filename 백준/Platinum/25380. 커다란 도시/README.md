...
제출: 1101, 정답: 225, 맞힌 사람: 143, 정답 비율: 26.779%

### 분류

수학, 정렬, 기하학, 이분 탐색, 누적 합
...
<p>두 번째 줄에 N개의 정수 a<sub>1</sub>, a<sub>2</sub>, &middot; &middot; &middot;, a<sub>N</sub>이 공백 하나씩을 사이에 두고 주어진다.</p>

<p>세 번째 줄에 M개의 정수 b<sub>1</sub>, b<sub>2</sub>, &middot; &middot; &middot;, b<sub>M</sub>이 공백 하나씩을 사이에 두고 주어진다.</p>

<p>그 다음 K개의 줄에는 경찰들의 위치가 주어지는데, 이 중 k (1 &le; k &le; K)번째 줄에는 두 정수 p<sub>k</sub>와 q<sub>k</sub>가 공백 하나를 사이에 두고 주어진다.</p>
...
<ul>
	...
	<li>2 &le; K &le; N + M</li>
	<li>-100 000 &le; a<sub>i</sub> &le; 100 000 (1 &le; i &le; N)</li>
	<li>-100 000 &le; b<sub>j</sub> &le; 100 000 (1 &le; j &le; M)</li>
	<li>-100 000 &le; p<sub>k</sub>, q<sub>k</sub> &le; 100 000 (1 &le; k &le; K)</li>
	<li>같은 위치에 도로나 경찰이 여럿 존재하지 않는다. 즉:
	<ul>
		<li>a<sub>1</sub>, a<sub>2</sub>, &middot; &middot; &middot;, a<sub>N</sub>는 서로 다르다.</li>
		<li>b<sub>1</sub>, b<sub>2</sub>, &middot; &middot; &middot;, b<sub>M</sub>는 서로 다르다.</li>
		<li>(p<sub>1</sub>, q<sub>1</sub>), (p<sub>2</sub>, q<sub>2</sub>), &middot; &middot; &middot;, (p<sub>K</sub>, q<sub>K</sub>)는 서로 다르다.</li>
	</ul>
	</li>
	<li>한 도로 위에는 한 명 이하의 경찰만 위치한다.</li>
</ul>