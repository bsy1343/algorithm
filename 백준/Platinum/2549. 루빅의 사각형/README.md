...
제출: 2645, 정답: 893, 맞힌 사람: 521, 정답 비율: 35.418%

### 분류

그래프 이론, 그래프 탐색, 백트래킹, 중간에서 만나기, 양방향 탐색

### 문제 설명

<p>4&times;4 격자판에 1에서 16까지 정수 번호가 매겨진 16개 타일이 임의로 놓여져 있다. 타일을 움직여 그림 1과 같이 타일을 놓이게 하려고 한다.</p>
...
<p>4&times;4 격자판에 놓여진 타일 번호가 행단 위로 4개 줄에 주어진다. 타일 번호는 1부터 16까지의 정수이다.</p>
