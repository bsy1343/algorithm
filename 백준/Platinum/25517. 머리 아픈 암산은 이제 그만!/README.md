...
제출: 431, 정답: 185, 맞힌 사람: 117, 정답 비율: 43.657%
...
<ul>
	<li>1 &le; <i>k<sub>i</sub></i> &le; <em>N</em> &le; 10<sup>9</sup></li>
	<li>0 &le; <em>M</em> &le; 10<sup>6</sup>  </li>
	<li><em>M</em> &lt; <em>N </em></li>
	<li>친구들이 부르지 않은 1 이상 <em>N</em> 이하의 정수는 적어도 한 개 존재한다.</li>
	<li><strong><i>k<span style="font-size: 10.8333px;">i </span></i>는 중복될 수 있다.</strong></li>
</ul>