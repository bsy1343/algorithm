...
제출: 543, 정답: 175, 맞힌 사람: 128, 정답 비율: 33.952%
...
<p>첫째 줄에 <em>N</em>과 <em>M</em>이 주어집니다. (1 &le; <em>N</em> &le; 200&thinsp;000, 1 &le; <em>M</em> &le; 10<sup>200&thinsp;000</sup>)</p>

<p>둘째 줄에 <em>N</em>개의 정수 <em>A</em><sub><em>i</em></sub>가 공백으로 구분되어 주어집니다. (1 &le; <em>A</em><sub><em>i</em></sub> &le; <em>N</em>) 주어지는 <em>A</em><sub><em>i</em></sub>는 모두 다릅니다.</p>
...
<p>예제에서 처음 3일 동안의 답은 다음과 같습니다.</p>

<ul>
	<li>1일째: 5 6 2 1 7 3 4</li>
	<li>2일째: 7 3 6 5 4 2 1</li>
	<li>3일째: 4 2 3 7 1 6 5</li>
</ul>