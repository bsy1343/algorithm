...
제출: 250, 정답: 106, 맞힌 사람: 84, 정답 비율: 43.979%
...
<ul>
	<li>동방은 <em>N</em> &times; <em>M</em>의 직사각형 꼴이고, 입구는 왼쪽 위의 (1, 1) 위쪽에 존재한다.</li>
...
<ul>
	...
	<li>1 &le; <em>K</em> &le; 2,000</li>
	<li>1 &le; <em>a<sub>i</sub></em>, <em>c<sub>i</sub></em> &le; <em>N</em></li>
	<li>1 &le; <em>b<sub>i</sub></em>, <em>d<sub>i</sub></em> &le; <em>M</em></li>
	<li><em>a<sub>i</sub></em> &le; <em>c<sub>i</sub></em></li>
	<li><em>b<sub>i</sub></em> &le; <em>d<sub>i</sub></em></li>
	<li>여러 개의 감시 카메라가 같은 감시 구역을 가질 수 있다.</li>
</ul>