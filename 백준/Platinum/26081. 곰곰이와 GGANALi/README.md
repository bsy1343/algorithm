# [Platinum IV] 곰곰이와 GGANALi - 26081

[문제 링크](https://www.acmicpc.net/problem/26081)
...
제출: 89, 정답: 37, 맞힌 사람: 24, 정답 비율: 32.877%
...
<p>이 구조에서 Actor구조를 추가, 제거하는 <span style="color:#2980b9;">명령어</span>를 수행하고 <span style="color:#c0392b;">속성 </span>값을 확인하는 <span style="color:#2980b9;">명령어</span>의 결과도 출력하고, 최종적으로 화면에 그려진 모습까지 출력해보자.</p>
