...
제출: 359, 정답: 94, 맞힌 사람: 70, 정답 비율: 31.390%

### 분류

자료 구조, 덱, 트리를 사용한 집합과 맵, 집합과 맵
...
<p>아, 일이 또 추가되었다. 지환이는 결국 일에 치여 과로사해버렸지만, 스케줄링을 하기 위한 기계 &lsquo;지환봇 스케줄러2&rsquo;는 여전히 정상적으로 작동한다. &#39;지환봇 스케줄러2&#39;는 기본적으로는 스택(stack) 구조, 즉 제일 나중에 들어간 업무가 제일 먼저 처리되는(LIFO, Last in First out) 특성을 가지고 있다.</p>
