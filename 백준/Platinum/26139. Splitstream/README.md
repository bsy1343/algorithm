...
제출: 105, 정답: 54, 맞힌 사람: 48, 정답 비율: 51.613%
...
<p>The first line of input contains three integers m, n, and q, where m (1 &le; m &le; 10<sup>9</sup>) is the length of the input sequence, n (1 &le; n &le; 10<sup>4</sup>) is the number of nodes, and q (1 &le; q &le; 10<sup>3</sup>) is the number of queries.</p>
...
<p>Each of the next q lines describes a query. Each query consists of two integers x and k, where x (2 &le; x &le; 10<sup>5</sup>) is a valid output identifier and k (1 &le; k &le; 10<sup>9</sup>) is the index of the desired number in that sequence. Indexing in a sequence starts with 1.</p>
