# [Platinum IV] 은?행 털!자 2 - 26268

[문제 링크](https://www.acmicpc.net/problem/26268)
...
제출: 300, 정답: 117, 맞힌 사람: 90, 정답 비율: 43.062%

### 분류

다이나믹 프로그래밍, 자료 구조, 세그먼트 트리, 집합과 맵, 값 / 좌표 압축
...
<p>시우는 직선상에서 임의의 정수 좌표에서 시작해 움직인다. 움직이는 동안 좌표는 <strong>감소하지 않아야 한다</strong> (원하는 만큼 멈춰 설 수 있음에 주의하라). 시간은 $0$으로 시작하며 좌표가 $1$만큼 증가할 때 시간도 $1$만큼 증가한다.</p>
