...
제출: 152, 정답: 45, 맞힌 사람: 21, 정답 비율: 20.588%
...
<p>친구가 없는 준호는 혼자서도 할 수 있는 1인용 보드게임 &ldquo;이 게임&rdquo;을 하고 있다. 게임의 규칙은 다음과 같다.</p>
...
<p>첫째 줄에 카드의 개수 $N$이 주어진다. $(2 &le; N &le; 100;$ $N$은 짝수$)$</p>

<p>둘째 줄부터 $\frac{N}{2}$개 줄에 걸쳐 $i$번째 카드에 적힌 서로 다른 정수 $A_i$가 한 줄에 2개씩 주어진다. $(1&le;A_i&le;100)$</p>
