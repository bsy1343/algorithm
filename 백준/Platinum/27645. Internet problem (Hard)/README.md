# [Platinum IV] Internet problem (Hard) - 27645

[문제 링크](https://www.acmicpc.net/problem/27645)
...
제출: 6, 정답: 2, 맞힌 사람: 2, 정답 비율: 40.000%
...
<ul>
	<li>2 &le; <em>n</em> &le; 500 000</li>
	<li>0 &le; <em>m</em> &le; 1 000 000</li>
</ul>
