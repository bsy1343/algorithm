# [Platinum II] Dijkstra's Nightmare (Easy) - 27676
...
<p>In this problem, the word &ldquo;graph&rdquo; always denotes a directed weighted graph with no duplicate edges and no self-loops. The letters <em>n</em> and <em>m</em> denote its numbers of vertices and edges. Vertices are numbered 0 through <em>n</em> &minus; 1. The starting vertex is 0.</p>

<p>We want you to show that there are graphs for which Dijkstra&rsquo;s algorithm terminates, but its time complexity is exponential in the number of vertices.</p>
...
<p>In a valid graph, 1 &le; <em>n</em> &le; 60 and the length of each edge fits into a signed 32-bit integer variable.</p>

<p>Each graph should be output as a sequence of <em>m</em> + 2 lines. The first of these lines should contain <em>n</em>, the second line should contain <em>m</em>, and each of the following <em>m</em> lines should contain three integers describing an edge &ndash; the vertex numbers of its two endpoints (between 0 and <em>n</em> &minus; 1) followed by its length.</p>
