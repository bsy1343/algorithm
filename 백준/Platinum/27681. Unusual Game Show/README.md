# [Platinum II] Unusual Game Show - 27681
...
제출: 29, 정답: 8, 맞힌 사람: 8, 정답 비율: 44.444%
...
<ol>
	...
	<li>
	<p>Then, Monty asked the contestant a very tricky question: &quot;Do you want to <em>keep</em> the door you have, or do you want to <em>switch</em> to the other door?&rsquo;&rsquo;</p>

	<p>Once the contestant made her final decision, Monty opened the door she chose to show whether she found the prize.</p>
	</li>
</ol>

<p>This game became very famous among mathematicians because the optimal strategy is very counterintuitive. At the end of the game, the player gets to choose between two doors. One of them contains the prize, the other does not. Thus, on the surface it seems that the choice doesn&rsquo;t matter and that the probability of winning the prize is always 1/2. <strong>This is not true.</strong> It can be shown that the optimal strategy for the contestant is to <em>never keep, always switch to the other door</em>. With this strategy, the actual probability of winning the prize is 2/3.</p>

<p>Monty Hall is still hosting the game show. However, there have been some changes:</p>

<ul>
	<li>
	<p>For financial reasons, the number of doors is now <em>d</em> (<em>d</em> &ge; 3). There is one prize and <em>d</em> &minus; 1 goats.</p>
	</li>
	<li>
	<p>Monty is very old. When performing a show, with probability <em>p</em> he is tired.</p>

	<p>If Monty isn&rsquo;t tired, he follows the above protocol. However, if he is tired, he wants to avoid unnecessary walking. Therefore, if he has a choice in step 2, he will always open <strong>the door with the smallest number</strong> among the doors he is allowed to open. (He is still not allowed to open the door with the prize nor the door currently chosen by the contestant.)</p>
	</li>
	<li>
	...
	<li>
	<p>After step 3, the game is over. The remaining <em>d</em> &minus; 1 doors are opened and it is revealed whether the contestant won the prize.</p>
	</li>
</ul>
...
<p>For each test case, output a single line with a single real number: the optimal probability of winning the prize. Output at least 10 decimal places. Answers within 10<sup>&minus;9</sup> of our answer will be accepted as correct.</p>

### 힌트

<p>In this example we have 3 doors and Monty is never tired, so we are playing the original game.</p>