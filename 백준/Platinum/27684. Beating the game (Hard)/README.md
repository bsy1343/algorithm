# [Platinum V] Beating the game (Hard) - 27684

[문제 링크](https://www.acmicpc.net/problem/27684)
...
제출: 10, 정답: 3, 맞힌 사람: 3, 정답 비율: 37.500%
...
<p>You are again given the values <em>x</em><sub>0</sub> through <em>x</em><sub>42</sub> and the initial value of a short strip. The strip is empty except for one tile that has the number 2 or 4. Output the best possible score you can achieve.</p>
...
<p>For each test case, output a single line with one number &ndash; the maximum score you can achieve for the given initial conditions.</p>