# [Platinum IV] Quick growth (Additional Challenge) - 27717

[문제 링크](https://www.acmicpc.net/problem/27717)
...
제출: 28, 정답: 19, 맞힌 사람: 15, 정답 비율: 62.500%
...
<p>Each test case consists of two lines. The first line contains the two integers N and D. The second line consists of N non-negative integers that are all less than 100,000: the contents of the original array.</p>

<p>You may assume that N &le; 100,000 and D &le; 100,000.</p>
...
<p>You can test it on the following input: N = D = 100000, array = (1,2,3,&hellip;,99999,100000). The correct output is 92629705.</p>