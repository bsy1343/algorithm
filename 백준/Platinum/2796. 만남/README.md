...
제출: 142, 정답: 74, 맞힌 사람: 66, 정답 비율: 54.098%
...
<p>첫째 줄에 친구의 수 N이 주어진다. (2 &le; N &le; 200,000)</p>

<p>다음 N개 줄에는 집의 위치 x, y와 P가 주어진다. (0 &le; x, y, P &le; 200,000)</p>
...
<p>첫 번째 예제의 경우 배달을 (4, 8)에서 시작한다면, 첫 번째 친구를 만날 수 있다. 그 다음 (6, 6)으로 가서 두 번째 친구를 만나고, (4, 5)로 가서 세 번째 친구를 만나면 된다.</p>