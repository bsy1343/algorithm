...
제출: 388, 정답: 181, 맞힌 사람: 141, 정답 비율: 45.928%
...
<p>첫째 줄에 수열 <em>A</em>의 크기 <em>N</em>이 주어진다. (1 &le; <em>N</em> &le; 300,000)</p>

<p>둘째 줄에는 수열 <em>A</em>를 이루고 있는 양의 정수 <em>A</em><sub>1</sub>, <em>A</em><sub>2</sub>, ⋯, <em>A<sub>N</sub></em>이 공백을 사이에 두고 주어진다. (1 &le; <em>i</em> &le; <em>N</em>, 1 &le; <em>A<sub>i</sub></em> &le; 10<sup>12</sup>)</p>
