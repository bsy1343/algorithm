...
제출: 185, 정답: 85, 맞힌 사람: 79, 정답 비율: 47.305%
...
<ul>
	<li>$i$번 노드에는 $1$ 이상 $M$ 이하의 정수 $a_i$가 적혀 있다. $(1 &le; i &le; N) $</li>
...
<ul>
	...
	<li>$N &le; M &le; 2\,000$</li>
	<li>올바른 이진 트리만 입력으로 주어진다.</li>
	<li>지워진 수가 하나도 없거나 답이 $0$인 경우는 주어지지 않는다.</li>
</ul>