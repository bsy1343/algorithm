...
제출: 1766, 정답: 586, 맞힌 사람: 418, 정답 비율: 34.262%
...
<p>이 때 경로의 &ldquo;길이&rdquo;는, 경로를 이루는 도로의 수, 즉 $t + 1$로 정의한다.</p>
...
<ul>
	...
	<li>$1 &le; k &le; N - 1$</li>
	<li>$1 &le; x_i &le; N$, $1 &le; y_i &le; N$, $x_i \ne y_i$ ($1 &le; i &le; N - 1$)</li>
	<li>임의의 두 마을에 대해, 두 마을을 잇는 경로가 정확히 하나 존재한다.</li>
	<li>길이 $k$인 경로는 적어도 하나 존재한다.</li>
