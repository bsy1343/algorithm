...
제출: 471, 정답: 158, 맞힌 사람: 111, 정답 비율: 35.127%
...
<ul>
	...
	<li>각 칸에 쌓인 블록의 개수는 단조증가한다: $1 &le; i &le; N - 1$에 대해 $i$번 칸에 쌓인 블록의 개수는 $i + 1$번 칸에 쌓인 블록의 개수 이하이다.</li>
</ul>
