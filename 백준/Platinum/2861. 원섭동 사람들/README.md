...
제출: 338, 정답: 89, 맞힌 사람: 67, 정답 비율: 28.033%

### 분류

그래프 이론, 그리디 알고리즘, 방향 비순환 그래프, 위상 정렬, 함수형 그래프
...
<p>첫째 줄에 시민의 수 N (2 &le; N &le; 200,000)이 주어진다. 각 사람의 번호는 1번부터 N번이다.</p>

<p>다음 N개의 줄에는 공백으로 구분되어져 있는 두 정수 A<sub>i</sub>와 B<sub>i</sub>가 주어진다. A<sub>i</sub>는 i번 사람이 돈을 빌린 사람의 번호이고, B<sub>i</sub>는 갚아야 하는 금액이다. (1 &le; A<sub>i</sub> &le; N, A<sub>i</sub> &ne; i, 1 &le; B<sub>i</sub> &le; 10,000)</p>
