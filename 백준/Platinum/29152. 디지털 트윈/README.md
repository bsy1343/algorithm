...
제출: 422, 정답: 103, 맞힌 사람: 83, 정답 비율: 27.946%
...
<p>둘째 줄부터 $N$개의 줄에 걸쳐 &lsquo;<span style="color:#e74c3c;"><code>0</code></span>&rsquo;, &lsquo;<span style="color:#e74c3c;"><code>1</code></span>&rsquo;로 이루어진 $N \times N$ 크기의 격자가 공백 없이 주어진다.</p>

<p>빈 부분의 위치는 &lsquo;<span style="color:#e74c3c;"><code>0</code></span>&rsquo;, 생산 기계의 위치는 &lsquo;<span style="color:#e74c3c;"><code>1</code></span>&rsquo;로 나타난다.</p>

### 출력

<p>공장의 시작에서 생산 기계를 모두 연결하면서 끝에 도달할 때 컨테이너 벨트의 최소 길이를 구하라.</p>

<p>만약, 모두 연결하는 것이 불가능하다면 &ldquo;<span style="color:#e74c3c;"><code>-1</code></span>&rdquo;을 출력해라.</p>