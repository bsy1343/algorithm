...
제출: 5280, 정답: 641, 맞힌 사람: 390, 정답 비율: 17.631%
...
<p>상근이의 게임은 R&times;C 보드를 세워놓은 상태에서 진행한다. 맨 처음에 각 정사각형 칸은 비어있거나 벽으로 막혀있다. 상근이는 민혁이에게 돌을 떨어놓을 열을 지시하고, 민혁이는 가장 윗 행의 그 열에 돌을 놓는다. 돌을 놓은 이후에는 중력에 의해서 돌이 떨어지게 된다.</p>
...
<p>첫째 줄에 보드의 크기 R과 C가 주어진다. (1 &le; R &le; 30,000, 1 &le; C &le; 30)</p>

<p>다음 R개 줄에는 C개의 문자가 주어지며, 보드의 초기 상태이다. &#39;.&#39;는 빈 칸, &#39;X&#39;는 벽으로 막힌 곳을 나타낸다.</p>

<p>다음 줄에는 돌을 던진&nbsp;횟수 N이 주어진다. (1 &le; N &le; 100,000)</p>
