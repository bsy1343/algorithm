...
제출: 379, 정답: 118, 맞힌 사람: 82, 정답 비율: 32.157%
...
<p>첫 번째 줄에 시험을 본 과목의 수 $N$이 주어진다.</p>

<p>두 번째 줄에는 $N$ 과목에 대한 이안이의 점수들이 공백으로 구분되어 주어지고, 세 번째 줄에는 예환이의 점수들이 공백으로 구분되어 주어진다.</p>
...
<ul>
	...
	<li>모든 점수는 $10^9$보다 작거나 같은 $0$ 이상의 정수이다.</li>
</ul>