...
제출: 907, 정답: 290, 맞힌 사람: 223, 정답 비율: 31.586%
...
<p>첫째 줄에 탱크의 수 N이 주어진다. (5 &le; N &le; 500)</p>

<p>다음 N개 줄에는 각 탱크가 있는 행의 번호 R과 열의 번호 C가 주어진다. (1 &le; R, C &le; N) 행과 열은 1부터 N까지 번호가 매겨져 있으며, 위에서 아래, 왼쪽에서 오른쪽 순서이다. 두 탱크가 같은 칸에 있는 경우는 없다.</p>
