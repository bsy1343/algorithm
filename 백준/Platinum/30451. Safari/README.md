...
제출: 327, 정답: 96, 맞힌 사람: 87, 정답 비율: 32.222%
...
<p style="text-align: center;"><img alt="" src="%EB%B0%B1%EC%A4%80/Platinum/30451.%E2%80%85Safari/ea0f025e.png" data-original-src="%EB%B0%B1%EC%A4%80/Platinum/30451.%E2%80%85Safari/ea0f025e.png" data-original-src="https://upload.acmicpc.net/d35fdf06-2ad1-4692-9e56-b9dd6bf2ebce/-/preview/" onerror="this.onerror=null;this.src=this.dataset.originalSrc" style="width: 253px; height: 211px;" /></p>
...
<p>Your program is to read from standard input. The input starts with a line containing one integer $n$ ($1 &le; n &le; 5\,000$), where $n$ is the number of animals. The animals are numbered from $1$ to $n$. In the following $n$ lines, the $i$-th line contains two integers $x_i$ and $y_i$ that represent the coordinate $(x_i , y_i)$ of the point $p_i$ in the plane where the animal $i$ appears ($0 &le; x_i , y_i &le; 10^6$). Note that the car $C$ is located at $(0, 0)$ at time $0$. The given points containing $(0, 0)$ are all distinct. In the following $n$ lines, the $i$-th line contains two integers $v_i$ and $w_i$ that represent the duration $[v_i , w_i]$ when the animal $i$ appears at $p_i$ ($0 &le; v_i &lt; w_i &le; 10^9$).</p>
