# [Platinum III] 방형구 탐색 (Hard) - 30515

[문제 링크](https://www.acmicpc.net/problem/30515)
...
제출: 577, 정답: 128, 맞힌 사람: 88, 정답 비율: 31.206%

### 분류

이분 탐색, 자료 구조, 세그먼트 트리, 트리를 사용한 집합과 맵, 집합과 맵

### 문제 설명

<p><strong>이 문제는 &rdquo;방형구 탐색 (Easy)&rdquo;문제와 $N$, $Q$의 제한을 제외하고 같은 문제다.</strong></p>
...
<p>첫째 줄에 방형구의 크기를 나타내는 양의 정수 $N$이 주어진다. $(1\leq N\leq 200\, 000)$</p>

<p>둘째 줄에 $N$개의 양의 정수 $A_1,A_2,\cdots ,A_N$이 공백으로 구분되어 주어진다. 이때 $A_i$는 $i$번 칸에 핀 꽃의 종류를 의미한다. $(1\leq A_i\leq 10^{9})$</p>

<p>셋째 줄에 쿼리의 수를 나타내는 양의 정수 $Q$가 주어진다. $(1\leq Q\leq 200\, 000)$</p>
