# [Platinum IV] Golem Coordinated Derby - 30577
...
제출: 58, 정답: 17, 맞힌 사람: 13, 정답 비율: 26.531%
...
<p>The first input line contains one integer N (2 &le; N &le; 10<sup>5</sup>), the number of robots in the team. The second line contains N space-separated integers A<sub>i</sub> (1 &le; A<sub>i</sub> &le; 20), the list of heights of all robots in the team.</p>
