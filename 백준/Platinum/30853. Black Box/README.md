...
제출: 260, 정답: 181, 맞힌 사람: 119, 정답 비율: 74.843%
...
<pre>
<strong>function</strong> BlackBox( Banana ):
    <strong>if</strong> len( Banana ) &le; 4 :
