...
제출: 63, 정답: 29, 맞힌 사람: 25, 정답 비율: 45.455%

### 분류

기하학, 이분 매칭, 4차원 이상의 기하학
...
<p>첫 번째 줄에 파댕이가 전구가 통과할 구멍을 뚫지 못한 면의 개수 $N$이 주어진다. $(0&le; N &le; 32)$</p>

<p>두 번째 줄부터 $N$개의 줄에 걸쳐 파댕이가 뚫지 못한 면을 사이에 둔 두 정사면체의 번호 $a,b$가 공백으로 구분되어 한 줄에 하나씩 주어진다. $(1&le; a &lt; b &le; 16)$</p>
