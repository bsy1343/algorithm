...
제출: 543, 정답: 257, 맞힌 사람: 165, 정답 비율: 47.826%
...
<p>첫 번째 줄에는 식물의 수 N(1 &le; N &le; 300 000)이 들어온다.</p>

<p>이후 N개의 줄에는 각각의 식물의 좌표 x<sub>i</sub>, y<sub>i</sub>(0 &le; x<sub>i</sub>, y<sub>i</sub> &le; 1 000 000 000)가 들어온다. (단, 두 식물이 같은 좌표에 있는 경우는 없다.)</p>
