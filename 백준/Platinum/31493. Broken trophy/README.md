# [Platinum IV] Broken trophy - 31493
...
제출: 76, 정답: 41, 맞힌 사람: 41, 정답 비율: 59.420%
...
<ul>
	<li>$1 \le K \le 300\, 000$</li>
	<li>$1 \le N \le 100\, 000$</li>
	<li>$1 \le A_k \le B_k \le 3$ for all $k \le K$</li>
	<li>the pieces described in the input can be reassembled in the form of a rectangle of size $3 \times N$.</li>
</ul>