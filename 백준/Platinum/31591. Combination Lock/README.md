...
제출: 62, 정답: 24, 맞힌 사람: 22, 정답 비율: 57.895%
...
<p>The first line of input contains one integer $n$ ($2 &le; n &le; 50$). Each of the next $n$ lines contains two integers. The $i$-th line contains $a_i$ and $b_i$ ($1 &le; a_i &le; b_i &le; 50$).</p>
