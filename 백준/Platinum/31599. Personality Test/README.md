...
제출: 90, 정답: 63, 맞힌 사람: 58, 정답 비율: 74.359%
...
<p>The first line of input contains three integers $n$, $m$, and $k$ ($2 &le; n &le; 5000$; $1 &le; m &le; 3000$; $1 &le; k &le; 5$). Each of the next $n$ lines contains a string of $m$ characters. The $i$-th line contains the string $S_i$.</p>
