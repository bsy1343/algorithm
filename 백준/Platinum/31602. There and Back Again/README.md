...
제출: 137, 정답: 75, 맞힌 사람: 70, 정답 비율: 54.264%
...
<p>The first line of input contains two integers $n$ and $m$ ($2 &le; n &le; 100\, 000$; $1 &le; m &le; \min(\frac{n(n-1)}{2}, 300\, 000)$). Each of the next m lines contains three integers. The $i$-th line contains $u_i$, $v_i$, and $t_i$ ($1 &le; u_i &lt; v_i &le; n$; $1 &le; t_i &le; 1000$). Different roads connect different pairs of cities.</p>
