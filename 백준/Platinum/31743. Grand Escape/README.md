...
제출: 147, 정답: 61, 맞힌 사람: 43, 정답 비율: 44.330%

### 분류

자료 구조, 정렬, 세그먼트 트리, 스위핑, 느리게 갱신되는 세그먼트 트리, 오프라인 쿼리, 값 / 좌표 압축
...
<ul>
	<li>$0 \leq N \leq 200,000$ ($N=0$일 수 있음에 주의하라)</li>
	<li>$1\leq M \leq 200,000$</li>
	<li>$Lx1_i &lt; Lx2_i$</li>
	<li>입력에서 주어지는 모든 좌표 $(x, y)$는 $1 \leq x, y \leq 10^9$를 만족한다.</li>
	<li>모든 $y$좌표는 겹치는 것이 없다.</li>
	<li>입력에서 주어지는 모든 수는 정수이다.</li>
</ul>
