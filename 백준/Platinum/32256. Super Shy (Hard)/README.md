# [Platinum II] Super Shy (Hard) - 32256
...
제출: 191, 정답: 56, 맞힌 사람: 51, 정답 비율: 48.113%
...
<p>첫째 줄에 테스트 케이스의 수 $T$가 주어진다. ($1\leq T\leq 100\, 000$)</p>

<p>둘째 줄부터 $T$개의 줄에 테스트 케이스가 한 줄에 하나씩 주어진다. 각 테스트 케이스의 첫째 줄에는 좌석의 수 $N$이 주어진다. ($1\leq N\leq 10^{18}$)</p>
