...
제출: 96, 정답: 60, 맞힌 사람: 54, 정답 비율: 63.529%

### 분류

그리디 알고리즘, 세그먼트 트리, 자료 구조, 정렬, 해 구성하기
...
<ul>
	<li>$1 ≤ n ≤ 5 \times 10^5$</li>
	<li>$1 ≤ a_i ≤ n$ for $i \in \{1, 2, \dots ,n\}$</li>
	<li>$1 ≤ b_i ≤ n$ for $i \in \{1, 2,\dots ,n\}$</li>
	<li>It is guaranteed that $a_1, a_2,\dots ,a_n$ and $b_1, b_2,\dots ,b_n$ are both permutations of integers $1, 2, \dots ,n$.</li>
</ul>