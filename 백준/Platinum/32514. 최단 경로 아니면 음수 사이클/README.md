...
제출: 502, 정답: 109, 맞힌 사람: 46, 정답 비율: 16.487%
...
<ul>
	<li>$2 \le N \le 20\,000$</li>
	<li>$1 \le M \le 20\,000$</li>
	<li>$0 \le s &lt; N$</li>
	<li>$0 \le a_i, b_i \le N$</li>
	<li>$(a_i, b_i) \neq (a_j, b_j)$ ($i \neq j$)</li>
	<li>$-10^4 \le c_i \le 10^4$</li>
	<li>모든 정점 $0 \le i \le N - 1$ 에 대해 $s$ 에서 $i$ 로 가는 경로가 존재한다.</li>
</ul>