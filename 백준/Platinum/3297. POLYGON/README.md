...
제출: 162, 정답: 24, 맞힌 사람: 24, 정답 비율: 30.769%
...
<p>The first line of input file contains a natural number N, 2 &le; N &le; 100, a number of given points.</p>

<p>Each of the following N lines contains two natural numbers X and Y, 1 &le; X &le; 100, 1 &le; Y &le; 100, separated by a space character, coordinates of one point. All points will be different.</p>
