...
제출: 563, 정답: 132, 맞힌 사람: 81, 정답 비율: 25.962%
...
<p>첫 번째 줄에 풍선의 개수&nbsp;n이 주어진다 (1 &le; n &le; 200 000). &nbsp;이어지는 n개의 줄에는 풍선에 대한 정보가 주어진다.&nbsp;</p>

<p>각 i번째 줄에는&nbsp;x<sub>i</sub>와&nbsp;&nbsp;r<sub>i</sub> 두 개의 정수가 주어진다.&nbsp;(풍선이 놓여 있는 x축 좌표&nbsp;0 &le; x<sub>i&nbsp;</sub>&le; 10<sup>9</sup>, &nbsp;풍선의 반지름의 최댓값&nbsp;1 &le; r<sub>i</sub>&nbsp;&le; 10<sup>9</sup>). 각 풍선들의 위치인 x좌표는 반드시 오른쪽으로만 나아간다.</p>
