...
제출: 112, 정답: 58, 맞힌 사람: 46, 정답 비율: 56.098%

### 분류

다이나믹 프로그래밍, 배낭 문제, 수학, 이분 탐색
...
<ul>
	...
	<li>$1 \leq c_i \leq 500 ~ (1 \leq i \leq N)$</li>
	<li>$1 \leq p_i \leq 500 ~ (1 \leq i \leq N)$</li>
	<li>$1 \leq a, b \leq 10^9$</li>
	<li>$1 \leq Q \leq 10^5$</li>
	<li>$1 \leq C, P \leq 500$</li>
</ul>