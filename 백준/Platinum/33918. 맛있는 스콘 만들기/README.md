...
제출: 1748, 정답: 373, 맞힌 사람: 260, 정답 비율: 19.034%

### 분류

다이나믹 프로그래밍, 덱, 덱을 이용한 구간 최댓값 트릭, 덱을 이용한 다이나믹 프로그래밍, 자료 구조
...
<ul>
	...
	<li>$1\leq M\leq 25\, 000$</li>
	<li>$1\leq C\leq D\leq M$</li>
	<li>$D$는 $C$의 배수이다.</li>
	<li>$1\le b_i\le M$ ($0\le i\le N-1$)</li>
