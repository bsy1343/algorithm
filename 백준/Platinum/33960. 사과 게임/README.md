...
제출: 191, 정답: 48, 맞힌 사람: 45, 정답 비율: 36.000%
...
<ul>
	<li>$N$개의 사과가 게임판에 일직선으로 배치되어 있고, 각 사과에는 $1$부터 $9$까지의 수 중 하나가 적혀있다.</li>
	<li>연속한 사과를 하나 이상 선택한다. 두 사과 사이에 다른 사과가 없을 경우 두 사과는 연속한다.</li>
	<li>선택한 사과에 적힌 수의 합이 정확히 $10$일 경우 선택한 사과를 모두 없앤 뒤 <strong>1점</strong>을 획득한다.</li>
	<li>더이상 사과를 없앨 수 없을 때까지 시행을 반복한다.</li>
</ul>

<p style="text-align: center;"><img alt="" src="%EB%B0%B1%EC%A4%80/Platinum/33960.%E2%80%85%EC%82%AC%EA%B3%BC%E2%80%85%EA%B2%8C%EC%9E%84/6aa802cc.jpg" data-original-src="https://boja.mercury.kr/assets/problem/33960-1.jpg" onerror="this.onerror=null;this.src=this.dataset.originalSrc" style="height: 455px; width: 800px;"></p>
...
<p>첫 번째 줄에 사과의 개수 $N$이 주어진다. $(1\le N\le 500)$</p>

<p>두 번째 줄에 각 사과에 적힌 정수 $A_1,\cdots ,A_N$이 공백으로 구분되어 주어진다. $(1\le A_i\le 9)$</p>
...
<p>실제로 플레이 가능한 원본 사과 게임과는 점수 계산 방식이 다름을 유의하라.</p>