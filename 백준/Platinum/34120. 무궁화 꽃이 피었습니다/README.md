...
제출: 426, 정답: 151, 맞힌 사람: 85, 정답 비율: 33.865%
...
<ul>
	...
	<li>$3 ≤ N ≤ 2\, 000$</li>
	<li>$3 ≤ M ≤ 4\, 000$</li>
	<li>$1 ≤ j ≤ M$인 각 $j$에 대해 $1 ≤ x_j , y_j ≤ N$, $x_j ≠ y_j$, $1 ≤ t_j ≤ 100\, 000$</li>
	<li>$1 ≤ j &lt; k ≤ M$인 각 $j$, $k$에 대해 $(x_j , y_j ) ≠ (x_k , y_k )$. 즉, 두 도로의 시작 건물과 도착 건물이 모두 서로 같은 경우는 없다.</li>
	<li>$2 ≤ i ≤ N − 1$인 각 $i$에 대해 $c_i ∈ \{0, 1\}$</li>
	<li>$c_1 = c_N = 0$이다. 즉, $1$번 건물과 $N$번 건물에는 창문이 없다.</li>
	<li>$1 ≤ a, b ≤ 10^9$</li>
</ul>