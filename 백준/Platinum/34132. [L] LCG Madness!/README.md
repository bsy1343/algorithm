# [Platinum V] [L] LCG Madness! - 34132

[문제 링크](https://www.acmicpc.net/problem/34132)

### 성능 요약

시간 제한: 1.712 초, 메모리 제한: 16 MB

### 통계

제출: 19, 정답: 11, 맞힌 사람: 10, 정답 비율: 76.923%

### 분류

다이나믹 프로그래밍, 비트마스킹, 비트필드를 이용한 다이나믹 프로그래밍, 슬라이딩 윈도우

### 문제 설명

<p><strong>메모리 제한에 유의하라.</strong></p>
...
<p>첫째 줄에는 LCG 기계의 개수 $N$과 플레이하는 라운드의 수 $R$이 공백으로 구분되어 주어진다. $(1\le N\le 10;$ $1\le R\le 17\, 012)$</p>

<p>둘째 줄부터 $N$개의 줄에 걸쳐, $i+1$번째 줄에는 LCG 기계에 저장되는 $4$개의 정수 $A_i$, $B_i$, $I_i$, $M_i$가 공백으로 구분되어 주어진다. $(0 \le A_i,B_i,I_i \lt M_i \le 10^9)$</p>

### 출력

<p>첫째 줄에 바이히가 얻을 수 있는 최고 점수를 출력한다.</p>