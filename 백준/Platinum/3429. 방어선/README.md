...
제출: 685, 정답: 182, 맞힌 사람: 134, 정답 비율: 31.529%
...
<p>첫째 줄에는 테스트 케이스의 개수 Z &le; 25 가 주어집니다.</p>

<p>이후 두 줄씩 입력이 주어지는데, 첫째 줄은 타워의 수를 나타내는 양의 정수 n &le; 2 &middot; 10<sup>5</sup> 이 주어집니다. 둘째 줄에는 10<sup>9</sup> 이하인 양의 정수 n개가 공백으로 구분되어 주어집니다.</p>
