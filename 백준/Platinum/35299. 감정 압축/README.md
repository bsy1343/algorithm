...
제출: 180, 정답: 67, 맞힌 사람: 61, 정답 비율: 62.887%
...
<ul>
<li>$1 \le N \le 75$</li>
<li>$S_{2i - 1} = $ <span style="color:#e74c3c;"><code>:</code></span>, $S_{2i} \in \{ $ <span style="color:#e74c3c;"><code>)</code></span>$,$ <span style="color:#e74c3c;"><code>(</code></span>$\}$ $(1 \le i \le N)$</li>
<li>$0 \le K \le N$</li>
</ul>

### 힌트

<p>$N$의 상한이 $75$인 이유는 KSA는 한 학기에 수업이 총 $15$주 진행되기 때문이다.</p>