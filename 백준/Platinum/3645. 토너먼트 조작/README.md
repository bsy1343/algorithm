...
제출: 140, 정답: 50, 맞힌 사람: 34, 정답 비율: 64.151%

### 분류

구현, 그래프 이론, 해 구성하기, 시뮬레이션
...
<p>각 테스트 케이스의 첫째 줄에는 토너먼트에 참가하는 팀의 수 n이 주어진다. (2 &le; n &le; 1024, n은 2의 제곱꼴) 팀은 1번부터 n번까지 번호가 매겨져 있으며, 선영이네 팀의 번호는 1이다.</p>
