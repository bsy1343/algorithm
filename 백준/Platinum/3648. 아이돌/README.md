...
제출: 6617, 정답: 2158, 맞힌 사람: 1641, 정답 비율: 29.712%
...
<p>각 테스트 케이스의 첫째 줄에는 참가자의 수 n (2 &le; n &lt; 1000) 과 심사위원의 수 m (1 &le; m &lt; 2000)이 주어진다.</p>

<p>다음 m개 줄에는 각 심사위원이 행사한 투표의 정보 a와 b가 주어진다. (1 &le; |a|, |b| &le; n, |a| &ne; |b|) 정보가 x &lt; 0인 경우에는 그 심사위원이 참가자 |x|에게 반대표를 행사한 것이고, x &gt; 0인 경우는 |x|에게 찬성을 던진 것이다.</p>
