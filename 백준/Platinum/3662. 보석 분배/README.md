...
제출: 124, 정답: 42, 맞힌 사람: 34, 정답 비율: 41.975%

### 분류

다이나믹 프로그래밍, 자료 구조, 그리디 알고리즘, 정렬, 우선순위 큐
...
<p>첫째 줄에 테스트 케이스의 개수 T (T &le; 100)가 주어진다. 각 테스트 케이스는 다음과 같이 이루어져 있다.</p>

<ul>
	<li>보석의 개수 n (1 &le; n &le; 1000)</li>
	<li>먼저 턴을 시작하는 사람의 이름 (민혁이인 경우에는 &quot;Petra&quot;, 민규인 경우에는 &quot;Jan&quot;)</li>
	<li>n개의 줄에 걸쳐서 민혁이가 느끼는 가치 p<sub>i</sub>, 민규가 느끼는 가치 j<sub>i</sub> (0 &le; p<sub>i</sub>, j<sub>i</sub>&nbsp;&le; 1 000)</li>
</ul>
