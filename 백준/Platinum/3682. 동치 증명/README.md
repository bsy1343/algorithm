...
제출: 1748, 정답: 536, 맞힌 사람: 351, 정답 비율: 25.620%
...
<p>첫 번째 줄에는 테스트 케이스의 개수 T(1 &le; T &le; 100)가 주어지고,</p>

<p>각 테스트 케이스에 대해서는 다음과 같은 입력이 주어진다:</p>

<ul>
	<li>명제의 수 n(1 &le; n &le; 20,000)와 이미 증명된 함축의 수 m(0 &le; m &le; 50,000)이 첫 번째 줄에 주어진다.</li>
	<li>m개의 줄에 &quot;s<sub>1</sub>이면 s<sub>2</sub>이다.&quot; 를 나타내는 s<sub>1</sub>과 s<sub>2</sub>(1 &le; s<sub>1</sub>,s<sub>2</sub>&nbsp;&le; n이고 s<sub>1&nbsp;</sub>&ne; s<sub>2</sub>)가 주어진다.</li>
</ul>
