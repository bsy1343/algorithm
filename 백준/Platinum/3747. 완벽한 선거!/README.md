...
제출: 1717, 정답: 710, 맞힌 사람: 532, 정답 비율: 43.750%
...
<p>각 테스트 케이스는 두 수 N과 M을 입력받으며 시작한다.&nbsp;(1&le;N&le;1000,&nbsp;1&le;M&le;1000000) 그리고 이어서 M개의 순서쌍&nbsp;&plusmn;i &plusmn;j 가 주어진다. (1&le;i,j&le;N) 각 순서쌍은 위의 표대로 해석하면 된다.</p>
