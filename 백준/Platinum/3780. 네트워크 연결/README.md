...
제출: 5321, 정답: 1444, 맞힌 사람: 979, 정답 비율: 24.766%
...
<ol>
	...
	<li>I와 J를 통신 라인으로 연결한다. 이때 기업 I와 J를 잇는 라인의 길이는 |I &ndash; J|(mod 1000)이다.</li>
...
<p>입력은 여러 개의 테스트케이스로 주어진다. 입력의 첫 번째 줄에는 테스트 케이스의 개수 T가 주어진다. 각 테스트 케이스에는 기업의 수를 나타내는 N(4&nbsp;&le; N &le; 20,000)이 주어진다. 다음은 몇 개의 줄에 걸쳐 아래 두 가지 종류의 명령어가 들어온다.</p>

<ul>
	<li>E I &ndash; 기업 I와 현재 I의 센터까지의 거리를 출력한다.&nbsp;</li>
	<li>I I J &ndash; 센터 I를 기업 J에 연결한다.</li>
</ul>
