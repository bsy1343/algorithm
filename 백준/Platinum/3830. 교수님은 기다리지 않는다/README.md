...
제출: 12867, 정답: 3843, 맞힌 사람: 2588, 정답 비율: 28.534%
...
<p>
	각 테스트 케이스의 첫째 줄에는 샘플의 종류의 개수 N (2 &le; N &le; 100,000)과 상근이가 실험실에서 한 일의 수 M (1 &le; M &le; 100,000)이 주어진다. 샘플은 1번부터 N번까지 번호가 매겨져 있다. 다음 M개 줄에는 상근이가 실험실에서 한 일이 주어진다.</p>

<p>
	상근이가 무게를 쟀다면, ! a b w와 같은 형식으로 주어진다. 이 뜻은 b가 a보다 w그램 무겁다는 뜻이다. (a &ne; b) w는 1,000,000을 넘지 않는 음이 아닌 정수이다. 모든 측정은 정확하고, 일관성을 유지한다.</p>
