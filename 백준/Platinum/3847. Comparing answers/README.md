...
제출: 249, 정답: 124, 맞힌 사람: 55, 정답 비율: 50.000%
...
<p>For each case, your program should output a line. The content of this line should be YES if your classmate&rsquo;s solution to the assignment is right, and NO otherwise.</p>