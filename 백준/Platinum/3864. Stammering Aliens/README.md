...
제출: 274, 정답: 80, 맞힌 사람: 55, 정답 비율: 24.887%
...
<p>The input contains several test cases. Each test case consists of a line with an integer m (m &ge; 1), the minimum number of repetitions, followed by a line containing a string s of length between m and 40 000, inclusive. All characters in s are lowercase characters from &ldquo;a&rdquo; to &ldquo;z&rdquo;. The last test case is denoted by m = 0 and must not be processed.</p>
