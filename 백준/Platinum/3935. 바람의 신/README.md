# [Platinum III] 바람의 신 - 3935

[문제 링크](https://www.acmicpc.net/problem/3935)
...
제출: 67, 정답: 19, 맞힌 사람: 11, 정답 비율: 40.741%
...
<p>용태가 맡은 나라는 창영제국이라는 매우 작은 나라이다. 이 나라는 4&times;4 크기의 정사각형으로 이루어져 있으며, 다음과 같이 번호가 매겨져 있다. 한 마을은 1&times;1 정사각형 하나를 차지한다.</p>
...
<p>구름의 크기는 2&times;2이며, 나라의 경계를 넘어갈 수 없다. 용태는 축제와 시장이 각 마을 별로 언제 열리는지를 알고 있다. 이 날은 그 마을에 비가 오면 안 된다.</p>
