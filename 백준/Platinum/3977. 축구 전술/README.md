...
제출: 5882, 정답: 2201, 맞힌 사람: 1724, 정답 비율: 36.090%
...
<p>그 다음 줄부터 여러 개의 테스트 케이스가 주어지는데, 각 테스트 케이스마다 첫 번째 줄에 구역의 수&nbsp;N, 지시한 움직임의 수&nbsp;M이 주어지며&nbsp;1 &le; N, M &le; 100,000&nbsp;이다. 그 다음 M개의 줄에 걸쳐서 움직임 (A, B)가 주어지며, A, B는&nbsp;0 &le; A, B &lt; N인 정수이다.</p>
