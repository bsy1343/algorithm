...
제출: 1360, 정답: 514, 맞힌 사람: 386, 정답 비율: 34.557%
...
<p>각 닌자 i (1 &le; i &le; N) 에 대해 보스 B<sub>i</sub>, 월급 C<sub>i</sub>, 그리고 리더십 레벨 L<sub>i</sub>가 주어지고, 그리고 월급으로 줄 수 있는 예산 M이 주어졌을 때, 매니저와 배치된 닌자가 주어진 조건을 만족하도록 선택이 되었을 때, 고객 만족도의 최댓값을 출력하는 프로그램을 작성하시오.&nbsp;</p>
...
<ul>
	...
	<li>0 &le; B<sub>i</sub> &le; i</li>
	<li>1 &le; C<sub>i</sub> &le; M</li>
	<li>1 &le; L<sub>i</sub> &le; 1,000,000,000</li>
</ul>
