...
제출: 222, 정답: 98, 맞힌 사람: 90, 정답 비율: 44.554%
...
<p>
	<img alt="" src="/upload/images/mobile.png" style="width: 378px; height: 122px;" /></p>
...
<p>
	예로서, 앞의 그림에 주어진 모빌을 고려하여 보자. Ike 는 이 모빌을 좋아하지 않을 것이다. 이 모빌은 제약조건 (i)을 만족하지만 조건 (ii)는 만족하지 못한다 &ndash; 가장 왼쪽 끝에 있는 장난감이 오른쪽에 있는 장난감들 보다 높은 레벨에 놓여있다.&nbsp;</p>
...
<p>
	<img alt="" src="/upload/images/mobile2.png" style="width: 373px; height: 118px;" /></p>

<p>
	2. 그 다음으로, 2번 막대의 양쪽 끝을 서로 바꾼다. 이렇게 하면 4번 막대가 2번 막대의 왼쪽 끝으로, 장난감은 오른쪽 끝으로 옮겨지게 된다.</p>

<p>
	<img alt="" src="/upload/images/mobile3.png" style="width: 402px; height: 119px;" /></p>
...
<p>
	입력의 첫째 줄에 모빌에 있는 막대의 수를 나타내는 정수 n 이 주어진다 (1 &le; n &le; 100,000). 막대들은 1 부터 n 까지 번호가 매겨져 있다.&nbsp;</p>
