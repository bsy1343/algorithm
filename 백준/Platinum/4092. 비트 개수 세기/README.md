...
제출: 344, 정답: 76, 맞힌 사람: 51, 정답 비율: 36.170%
...
<p>
	입력은 여러 개의 테스트 케이스로 이루어져 있고, 각 케이스는 한 줄로 이루어져 있다. 범위를 나타내는 LO와 HI 그리고 X가 주어진다. (1 &le; LO &le; HI &le; 10<sup>18</sup>, 0 &le; X &le; 10) 입력의 마지막 줄에는 0이 3개 주어진다.</p>
