...
제출: 5402, 정답: 1402, 맞힌 사람: 997, 정답 비율: 23.926%
...
<p><img alt="" src="/upload/images/chute.png" style="height:303px; width:387px" /></p>

<p>어떤 물체가 주어진다. 이 물체가 통과할 수 있는 가장 작은 슈트의 너비를 구하는 프로그램을 작성하시오.</p>

### 입력

<p>입력은 여러 개의 테스트 케이스로 이루어져 있다. 각 테스트 케이스의 첫째 줄에는 물체(다각형)의 꼭짓점의 개수 n이 주어진다. (3 &le; n &le; 100)</p>

<p>다음 n개 줄에는 꼭짓점의 좌표 x<sub>i</sub>와 y<sub>i</sub>가 주어진다. (0 &le; x<sub>i</sub>, y<sub>i</sub> &le; 10<sup>4</sup>) 꼭짓점은 다각형을 이루는 순서대로 주어진다.&nbsp;</p>
