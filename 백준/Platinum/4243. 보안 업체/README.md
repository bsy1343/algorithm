...
제출: 1945, 정답: 680, 맞힌 사람: 493, 정답 비율: 35.064%
...
<p style="text-align: center;"><img alt="" src="/upload/images/security.png" style="height:100px; width:415px" /></p>
...
<p>첫째 줄에 테스트 케이스의 개수 T가 주어진다. 각 테스트 케이스의 첫째 줄에는 상점의 수 N (1 &le; N &le; 100)이 주어진다. 둘째 줄에는 시작점의 위치 a (1 &le; a &le; N)가 주어진다. a번째 점, p<sub>a</sub> = s가 시작점이 된다. 다음 N-1개 줄의 i번째 줄에는 t[p<sub>i</sub>,p<sub>i+1</sub>]가 주어진다. (1 &le; t[p<sub>i</sub>,p<sub>i+1</sub>] &le; 15,000,000)</p>
