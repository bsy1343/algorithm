...
제출: 93, 정답: 48, 맞힌 사람: 31, 정답 비율: 47.692%
...
<p>Input consists of a number of test cases. Each case will be a line containing a single integer n, 1 &le; n &le; 300000. An input of 0 follows the last test case. Note that the portion of the EKG sequence that contains all integers &le; 300,000 will not contain an integer &gt;1,000,000.&nbsp;</p>
...
<pre>
The number n appears in location p.</pre>
