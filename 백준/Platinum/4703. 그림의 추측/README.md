...
제출: 400, 정답: 26, 맞힌 사람: 16, 정답 비율: 9.581%

### 분류

수학, 정수론, 해 구성하기, 소수 판정, 이분 매칭, 소인수분해

### 문제 설명

<p>그림의 추측이란, 연속된 합성수의 집합이 있을 때, 각각의 수를 나눌 수 있는 서로 다른 소수를 하나씩 배정할 수 있다는 내용이다.</p>

<p>즉, n+1, n+2, ..., n+k가 모두 합성수일 때, (n+i)를 나눌 수 있는 서로 다른 k개의 소수 pi가 존재한다는 내용이다. (1 &le; i &le; k)</p>
...
<p>입력은 여러 개의 테스트 케이스로 이루어져 있다. 각 테스트 케이스는 한 줄로 이루어져 있고, L과 H가 주어진다. (4 &le; L &lt; H &le; 10<sup>10</sup>)</p>
