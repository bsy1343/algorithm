...
제출: 80, 정답: 22, 맞힌 사람: 21, 정답 비율: 30.000%
...
<p>Indent the list of players by two spaces. Print the player name and the team name right&minus;justified in a field width of 15 (in addition to the indentation before the player&#39;s name and one space separation between the player&#39;s name and team name). If no one scores a hit or a run, print the single line</p>
...
<p>The summary should be indented by two spaces. Print the team name right&minus;justified in a field width of 15 (in addition to the indentation).</p>
