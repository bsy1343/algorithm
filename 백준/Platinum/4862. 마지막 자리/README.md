...
제출: 545, 정답: 169, 맞힌 사람: 96, 정답 비율: 30.868%
...
<p>
	입력은 여러 개의 테스트 케이스로 이루어져 있다. 각 테스트 케이스는 세 줄로 이루어져 있다. 첫째 줄에는 b(1 &le; b &le; 100), 둘째 줄에는 i(1 &le; i &le; 100), 셋째 줄에는 n(1 &le; n &le; 7)이 주어진다. 마지막 줄에는 0이 하나 주어진다.</p>
