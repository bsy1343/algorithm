...
제출: 333, 정답: 112, 맞힌 사람: 74, 정답 비율: 30.328%
...
<p>입력의 마지막 줄에는 0이 주어진다. 1 &le; N &le; 300, 0 &le; X, Y &le; 10.0 두 점의 거리가 0.0001보다 가까운 경우는 없다. 또, 두 점의 거리가 2.0에 가까운 경우도 없다. 즉, 두 점의 거리를 d라고 했을 때, 1.999 &le; d &le; 2.0001을 만족하는 두 점은 없다. 마지막으로, 세 점이 반지름이 1인 원에 동시에 가까운 경우도 없다. 즉, 세 점을 P<sub>1</sub>, P<sub>2</sub>, P<sub>3</sub>라 하고, 각각의 거리를 d<sub>1</sub>, d<sub>2</sub>, d<sub>3</sub>라 했을 때, 0.9999 &le; d<sub>i</sub> &le; 1.0001을 동시에 만족하는 경우도 없다.</p>
