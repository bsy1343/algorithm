...
제출: 93, 정답: 36, 맞힌 사람: 28, 정답 비율: 41.176%
...
<p>The ﬁrst line of the input contains a single integer 0 &le; n &le; 1000, the number of houses in the slum.</p>

<p>Then follow n lines in the format p<sub>i</sub> r<sub>i</sub> c<sub>i</sub>, where 0 &le; p<sub>i</sub> &le; n is the parent node of house i, 0 &le; r<sub>i</sub> &le; 100 is the energy demand of house i and 1 &le; c<sub>i</sub> &le; 100 is the capacity of the extension cord connecting house i to house p<sub>i</sub>.</p>
