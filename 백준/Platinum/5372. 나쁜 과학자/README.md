...
제출: 313, 정답: 54, 맞힌 사람: 39, 정답 비율: 26.897%
...
<ul>
	<li>첫째 줄에 논문에 있는 이론의 수 n이 주어진다. (1 &le; n &le; 50)</li>
	<li>둘째 줄에는 의심을 받지 않고 제거할 수 있는 이론의 최대 개수 k가 주어진다. (0 &le; k &le; 16)</li>
	<li>셋째 줄에는 서로 모순인 이론의 쌍의 개수 m이 주어진다. (0 &le; m &le; n&times;(n-1)/2)</li>
	<li>다음 m개 줄에는 서로 모순인 이론 x<sub>i</sub>와 y<sub>i</sub>가 주어진다. (1 &le; x<sub>i</sub> &lt; y<sub>i</sub> &le; n)</li>
</ul>
