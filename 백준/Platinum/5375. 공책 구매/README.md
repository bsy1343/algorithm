...
제출: 481, 정답: 138, 맞힌 사람: 112, 정답 비율: 34.783%
...
<p>첫째 줄에 테스트 케이스의 개수 T (T &le; 100)가 주어지며, 아래와 같은 형식으로 이루어져 있다.</p>

<ul>
	<li>첫째 줄에 사려고 하는 공책의 개수 N과 쇼핑몰의 개수 M이 주어진다. (1 &le; N &le; 10,000, 1 &le; M &le; 100, N &le; &Sigma;s<sub>i</sub>)</li>
	<li>M개의 줄에 s<sub>i</sub>, p<sub>i</sub>, o<sub>i</sub>가 주어진다. (0 &le; s<sub>i</sub>, p<sub>i</sub> &le; 10,000, 0 &le; o<sub>i</sub> &le; 1,000,000)</li>
</ul>
