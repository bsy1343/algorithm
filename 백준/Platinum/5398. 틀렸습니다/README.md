...
제출: 755, 정답: 324, 맞힌 사람: 242, 정답 비율: 42.456%
...
<ul>
	<li>첫째 줄에 각각 가로 단어, 세로 단어 개수를 의미하는 두 정수 H, V가 주어진다. (1 &le; H, V &le; 500)</li>
	<li>이어서 H개 줄에 각 가로 단어의 시작 위치 x, y, 그리고 승혁이가 답이라고 생각하는 단어 W가 주어진다. (0 &le; x, y &le; 1,000 이고 1 &le; Length(W) &le; 1,000)</li>
	<li>이어서 V개 줄에 각 세로 단어의 시작 위치 x, y, 그리고 승혁이가 답이라고 생각하는 단어 W가 주어진다. (0 &le; x, y &le; 1,000 이고 1 &le; Length(W) &le; 1,000)</li>
</ul>
