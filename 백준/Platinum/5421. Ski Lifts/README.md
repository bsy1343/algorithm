...
제출: 48, 정답: 19, 맞힌 사람: 18, 정답 비율: 42.857%
...
<ul>
	<li>A line with two positive numbers w and l with 1 &le; w, l &le; 500: the width and length of the area.</li>
	<li>w lines, each line containing l positive numbers h<sub>ij</sub>, with 0 &le; h<sub>ij</sub> &le; 10<sup>9</sup>, representing the height in each point of the area.</li>
</ul>
