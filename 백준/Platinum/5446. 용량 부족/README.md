...
제출: 2043, 정답: 782, 맞힌 사람: 544, 정답 비율: 36.194%
...
<ul>
	<li>첫째 줄에 지워야 하는 파일의 개수 N<sub>1</sub>이 주어진다. (1 &le; N<sub>1</sub> &le; 1000)</li>
	<li>이어서 N<sub>1</sub>개의 줄에 지워야 하는 파일명이 줄마다 하나씩 주어진다.</li>
	<li>이어서 지우면 안 되는 파일의 개수&nbsp;N<sub>2</sub>가 주어진다. (0 &le; N<sub>2</sub> &le; 1000)</li>
