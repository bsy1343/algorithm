...
제출: 378, 정답: 182, 맞힌 사람: 152, 정답 비율: 49.191%
...
<ul>
	<li>Line 1 contains the integer N, the number of words you need to print. (1 &le; N &le; 25,000)</li>
	<li>Each of the next N lines contains a word. Each word consists of lower case letters (&lsquo;a&rsquo; &ndash; &lsquo;z&rsquo;) only and has length between 1 and 20, inclusive. All words will be distinct.</li>
</ul>
...
<ul>
	...
	<ul>
		...
		<li>Removing the last letter is represented by the character &lsquo;‐&lsquo; (minus, ASCII code 45)</li>
		<li>Printing the current word is represented by the character &lsquo;P&rsquo; (uppercase letter P)</li>
	</ul>
	</li>
</ul>