...
제출: 241, 정답: 155, 맞힌 사람: 109, 정답 비율: 70.779%
...
<p>Your program reads from standard input. The first line contains the number of jobs N, 1 &le; N &le; 10000. The second line contains the batch setup time S which is an integer, 0 &le; S &le; 50. The following N lines contain information about the jobs 1, 2, &hellip;, N in that order as follows. First on each of these lines is an integer T<sub>i</sub> , 1 &le; T<sub>i</sub>&nbsp;&le; 100, the processing time of the job. Following that, there is an integer F<sub>i</sub>, 1 &le; F<sub>i</sub> &le; 100, the cost factor of the job.</p>
...
<p>For each test case, the total cost for any partitioning does not exceed 2<sup>31</sup>-1.</p>