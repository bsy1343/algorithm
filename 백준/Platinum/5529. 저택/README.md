...
제출: 1514, 정답: 257, 맞힌 사람: 195, 정답 비율: 19.024%
...
<p>상근이는 매우 큰 저택에 갇혔다. 이 저택은 정사각형 모양의 방이 격자 모양으로 배치되어 있고, N행 M열 형태이다. 왼쪽으로부터 x(1 &le; x &le; M)번째, 아래쪽으로부터 y(1 &le; y &le; N)번째 방을 (x,y)라고 한다.</p>
...
<p>첫째 줄에 집의 크기 M, N과 스위치가 있는 방의 수 K가 주어진다. 둘째 줄부터 K개 줄에는 스위치가 있는 방의 위치 (x<sub>i</sub>, y<sub>i</sub>)가 주어진다.&nbsp;(2 &le; M,N &le; 100,000, 1 &le; K &le; 200,000)</p>
