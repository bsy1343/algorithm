...
제출: 880, 정답: 311, 맞힌 사람: 245, 정답 비율: 36.350%
...
<p>어느 시골에, 쌀의 길 이라고 불리는 긴 직선 도로가 있다. 이 길을 따라 R 개의 논들이 있다. 각 논들은 1 이상 L 이하의 정수좌표를 갖는다. 논들은 좌표 값이 감소하지 않는 순서로 주어진다. 즉, 0 &le; i &lt; R 에 대해서, 논 i 는 좌표 X[i] 에 있다. 1 &le; X[0] &le; ... &le; X[R-1] &le; L 라고 가정할 수 있다.</p>
...
<ul>
	<li>R &ndash; 논의 수. 논들은 0 이상 R-1 이하의 번호로 나타낸다.&nbsp;</li>
	<li>L &ndash; 최대 좌표 값.</li>
	<li>X &ndash; 가장 작은 수부터 가장 큰 수까지 정렬된 정수의 1 차원 배열. 0 &le; i &lt; R 에 대하여, 논 i 는 X[i]에 위치한다.&nbsp;</li>
	<li>B &ndash; 예산.</li>
</ul>
