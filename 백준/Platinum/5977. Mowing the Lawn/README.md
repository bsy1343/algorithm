...
제출: 2467, 정답: 951, 맞힌 사람: 699, 정답 비율: 36.520%
...
<p>FJ has 5 cows whose efficiencies are 1, 2, 3, 4, and 5, in that order. He wants to choose some of the cows such that their total efficiency is maximized, but he cannot choose more than 2 consecutive cows.</p>

<p>FJ chooses all cows but the third. The total efficiency of the cows is thus 1 + 2 + 4 + 5 = 12.</p>