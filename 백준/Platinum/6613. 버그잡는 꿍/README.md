...
제출: 616, 정답: 85, 맞힌 사람: 54, 정답 비율: 20.074%
...
<p><img alt="" src="/upload/images2/sb.png" style="float:right; height:97px; width:110px" /> 모든 버그(bug)가 벌레라는 뜻은 아니다. 개발자에게 악몽인 버그도 있다. 이 버그는 바로 여러분이 아는 &quot;니가 짠 프로그램에서 버그 발견됐다 ㅋ&quot; 라고 말할 때 쓰는 버그다. 말 안해도 알겠지만 버그는 없애도 나오고 없애도 나온다. 젠장...</p>
...
<p>입력은 몇 개의 테스트케이스로 이루어진다. 각 테스트 케이스는 T (0 &le; T &le; 100 000)를 포함하는 하나의 정수, 하나의 공백, 그리고 버그를 뜻하는 문자열 B로 시작한다.</p>
