...
제출: 929, 정답: 352, 맞힌 사람: 212, 정답 비율: 33.812%
...
<p>Students have seniority, based their year of study. Third-year students&rsquo; selections should have more weight than first-year students&rsquo; selections..</p>
...
<p>Your task is to assign students to positions in a way that maximizes the sum of all students&rsquo; satisfaction according to the above matrix. Each student must get a position, but all positions may not be filled.&nbsp;</p>

### 입력

<p>There will be multiple test cases in the input. Each test case will begin with two integers, n (4&le;n&le;140) and m (1&le;m&le;70), where n is the number of postings and m is the number of students. Each of the next n lines will contain a single integer p (1&le;p&le;10), indicating the number of positions available for that job posting. The job postings are listed in order, from job 0 to job n-1.</p>
...
<p>Where y (y=1, 2 or 3) is the student&rsquo;s year of study, and c1, c2, c2 and c4 (0&le;c1,c2,c3,c4&lt;n, all four unique) indicating the student&rsquo;s choice of job postings, in order of preference.</p>
