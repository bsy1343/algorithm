...
제출: 46, 정답: 17, 맞힌 사람: 16, 정답 비율: 36.364%
...
<p>In the first line of the standard input there are two non-negative integers n and m. They denote respectively: the number of parties, 1 &le; n &le; 8,000, and the number of pairs of deputies, who do not like each other, 0 &le; m &le; 20,000. In each of the following m lines there is written one pair of integers a and b, 1 &le; a &lt; b &le; 2n, separated by a single space. It means that the deputies a and b do not like each other.</p>
