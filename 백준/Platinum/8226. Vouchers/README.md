...
제출: 136, 정답: 47, 맞힌 사람: 42, 정답 비율: 35.593%
...
<p>On the first line of the standard input there is a single integer m (1 &le; m &le; 1,000,000) that denotes the number of vouchers. The k-th of the m lines that follow holds an integer b<sub>k</sub> (1 &le; b<sub>k</sub> &le; 1,000,000) denoting the size (i.e., the number of candies inside) of a package in which Byteasar has placed the k-th voucher. These numbers are given in an increasing order.</p>

<p>Then the next line contains a single integer n (1 &le; n &le; 1,000,000) that denotes the number of carnival days. The k-th of the n lines that follow holds an integer a<sub>k</sub> (1 &le; a<sub>k</sub> &le; 1,000,000) denoting the number of guests attending the k-th party.</p>
