...
제출: 231, 정답: 51, 맞힌 사람: 47, 정답 비율: 22.816%
...
<p>The first line of the standard input holds three integers, m, d, and n (1 &le; d &le; m &le; 10^18, 1 &le; n &le; 500,000), separated by single spaces. Those denote, respectively: the distance from Bytehole to Bytepit, the distance from Bytehole to the taxi base, and the number of taxis at the base. The second line of input contains n integers, x<sub>1</sub>,x<sub>2</sub>,&hellip;,x<sub>n</sub> (1 &le; x<sub>i</sub> &le; 10<sup>18</sup>), separated by single spaces. The number x<sub>i</sub> denotes the maximum distance (in kilometres) that the &nbsp;i-th taxi can travel.</p>
...
<p>Byteasar can take the taxis no. 4, 5, 1, and 2, in this order.</p>