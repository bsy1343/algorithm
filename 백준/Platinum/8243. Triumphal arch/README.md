...
제출: 326, 정답: 92, 맞힌 사람: 76, 정답 비율: 29.572%
...
<p>The first line of the standard input contains a single integer n (1 &le; n &le; 300,000), the number of towns in Byteotia. The towns are numbered from 1 to , where the number 1 corresponds to the capital.</p>

<p>The road network is described in n-1 lines that then follow. Each of those lines contains two integers, a,b (1 &le; a,b &le; n), separated by a single space, indicating that towns a and b are directly connected with a two way road.</p>
...
<p style="text-align: center;"><img alt="" src="https://onlinejudgeimages.s3-ap-northeast-1.amazonaws.com/problem/8243/1.gif" style="height:247px; width:200px" /></p>