...
제출: 23, 정답: 16, 맞힌 사람: 14, 정답 비율: 73.684%
...
<p>The road on the map is represented by <em>n</em>&nbsp;turns, each of which is 90&deg;&nbsp;turn to the right or to the left. For simplicity we can represent the map by <em>n</em>-letter string consisting of&nbsp;<code>L</code>&nbsp;and/or&nbsp;<code>P</code>&nbsp;letters.</p>
...
<ul>
	...
	<li>determines <em>a<sub>i</sub></em>&nbsp;values, for 1 &le; i &le; n,</li>
	<li>writes the result to the standard output.</li>
</ul>

### 입력

<p>The first line of the input contains one integer <em>n</em>&nbsp;(1 &le; <em>n</em> &le; 500 000). The second line contains description of the road - <em>n</em>&nbsp;letters&nbsp;<code>L</code>&nbsp;and/or&nbsp;<code>P</code>, without any spaces.</p>
