...
제출: 1392, 정답: 370, 맞힌 사람: 296, 정답 비율: 27.433%
...
<p>첫 번째 줄에 그래프의 정점, 간선의 수와 질의의 수를 나타내는 n, m, q 가 주어진다. (1 &le; n &le; 1, 000, 1 &le; m &le; 100, 000, 1 &le; q &le; 200, 000) 정점들은 순서대로 1부터 n까지 번호가 매겨져 있고, 간선들은 순서대로 1부터 m까지 번호가 매겨져 있다.</p>
