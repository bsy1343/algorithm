...
제출: 3685, 정답: 1629, 맞힌 사람: 1175, 정답 비율: 42.403%
...
<p>첫째 줄에 배열의 크기 \(n\)과 부분 배열의 개수 \(t\)가 주어진다. (1 &le; \(n\), \(t\) &le; 10<sup>5</sup>) 둘째 줄에는 \(n\)개의 자연수 \(a_i\) (1 &le; \(a_i\) &le; 10<sup>6</sup>) 가 주어진다.</p>

<p>다음 \(t\)개 줄에는 부분 배열의 범위 \(l_i\)와 \(r_i\)가 주어진다. (1 &le; \(l_i\) &le; \(r_i\) &le; \(n\))</p>
