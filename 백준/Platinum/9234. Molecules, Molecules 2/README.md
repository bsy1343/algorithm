# [Platinum II] Molecules, Molecules 2 - 9234

[문제 링크](https://www.acmicpc.net/problem/9234)
...
제출: 28, 정답: 13, 맞힌 사람: 6, 정답 비율: 50.000%

### 분류

비트마스킹, 다이나믹 프로그래밍, 비트필드를 이용한 다이나믹 프로그래밍, 최대 유량, 그래프 이론
