...
제출: 121, 정답: 24, 맞힌 사람: 19, 정답 비율: 40.426%
...
<p>테스트 케이스의&nbsp;첫 줄에는 두 정수 n과 m이 공백으로 구분되어 주어진다. (0 &le; n &le; 10 000, 0 &le; m &le; 20 000)</p>

<p>n은 영상에 등장한 점의 개수이며, m은 선의 개수이다.</p>

<p>다음 m줄엔 두 정수 x와 y가 주어진다.&nbsp;(1 &le; x, y &le; n)</p>
