...
제출: 236, 정답: 79, 맞힌 사람: 57, 정답 비율: 29.534%
...
<ul>
	<li>공백으로 구분된 세 개의 정수 n, c, m (1 &le; n, c &le; 16 and 1 &le; m &le; 1000) : 접선할 수 있는 조직원의 수, 당신이 필요로 하는 최소한의 조직원 수, 예산</li>
	<li>n줄에 걸쳐 두 개의 정수 b, p (0 &le; b &le; 1 000 ,&nbsp;0 &le; p &le; 100) : 매수를 시도하는 데 필요한 금액, 그 조직원이 성공적으로 당신의 편이 될 확률( % 값&nbsp;)</li>
</ul>
