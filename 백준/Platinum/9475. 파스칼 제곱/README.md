...
제출: 267, 정답: 102, 맞힌 사람: 73, 정답 비율: 37.824%
...
<pre>
Pascal[row, column] = Comb(row, column) for 0 &le; column &le; row</pre>
...
<pre>
Pascal<sup>P</sup> = Pascal &times; Pascal &times; ... &times; Pascal</pre>

### 입력

<p>첫째 줄에 테스트 케이스의 개수 K (1 &le; K &le; 1000)가 주어진다.</p>

<p>각 테스트 케이스는 네 정수로 이루어져 있다. 첫 번째 정수는 테스트 케이스 번호이다. 두 번째 정수는 P이다. (1 &le; P &le; 100,000) 세 번째 정수와 네 번째 정수는 R과 C이다. (0 &le; C &le; R &le; 100,000)</p>
