...
제출: 186, 정답: 53, 맞힌 사람: 42, 정답 비율: 36.842%
...
<p>첫 줄에 테스트 케이스의 수 T가 주어진다. ( 1 &le; T &le; 1,000 )</p>

<p>각 테스트 케이스는 하나의 정수 N과 6글자로 이루어진 문자열 하나로 이루어져 있다.</p>

<p>N은 구할 답이 N자리 정수임을 의미한다. ( 1 &le; N &le; 10 <sup>18</sup>)</p>
