...
제출: 121, 정답: 31, 맞힌 사람: 30, 정답 비율: 28.302%
...
<p>Dmitry loves programming competitions very much. The Finals of the famed Champions League are taking place in Dmitry&rsquo;s home city, so he wants to visit the competition. The competition is very popular, but most tickets to the competition are reserved for VIPs and for sponsors.</p>
...
<p>The first and the only line of the input contains 3 integer numbers &mdash; the number of seats available for a draw n (1 &le; n &le; 3000), the number of requests with ICPC card as a payment method a, and the number of requests with other payment methods b (0 &le; a, b &le; 10<sup>9</sup>).</p>
