...
제출: 1114, 정답: 220, 맞힌 사람: 167, 정답 비율: 29.715%
...
<p>첫째 줄에 테스트 케이스의 개수 T가 주어진다. 각 테스트 케이스의 첫째 줄에는 N (1 &le; N &le; 500,000)과 X (-10<sup>9</sup> &le; X &le; 10<sup>9</sup>)가 주어진다. 둘째 줄에는 수열에 들어있는 정수 N개가 주어진다. 이 정수는 -10<sup>9</sup>보다 크거나 같고, 10<sup>9</sup>보다 작거나 같다.</p>
