...
제출: 4286, 정답: 1414, 맞힌 사람: 968, 정답 비율: 30.585%
...
<p>첫째 줄에 N과 L이 주어진다. (1 &le; N, L &le; 300,000)</p>

<p>다음 N개 줄에는 A<sub>i</sub>와 B<sub>i</sub>가 주어진다. (1 &le; A<sub>i</sub>, B<sub>i</sub> &le; L, A<sub>i</sub> &ne; B<sub>i</sub>)</p>
