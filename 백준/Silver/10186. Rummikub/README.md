...
제출: 41, 정답: 26, 맞힌 사람: 24, 정답 비율: 63.158%
...
<p>For each data set, print out either &ldquo;NO GROUPS OR RUNS&rdquo; or a sorted list of the group or run with the highest point score. This sorted list should have spaces and have the points as the last item on the output line.</p>