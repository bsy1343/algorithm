...
제출: 93, 정답: 57, 맞힌 사람: 40, 정답 비율: 54.054%
...
<p>The first line in the test data file contains the number of test cases (&le; 100). After that each line will contain one date from the regular calendar in &ldquo;YYYY MM DD&rdquo; format. You can assume that you will only be provided with correct dates.</p>
