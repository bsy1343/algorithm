...
제출: 200, 정답: 132, 맞힌 사람: 108, 정답 비율: 71.053%

### 분류

그래프 이론, 문자열, 그래프 탐색, 너비 우선 탐색, 최단 경로, 깊이 우선 탐색, 파싱, 플로이드–워셜
...
<p>Given such a graph and a super-villain, your goal is to count to the number of super-villains in that super-villain&rsquo;s 2-hop neighborhood in the graph, i.e., all the nodes that are within a distance of 2 from the given node. (This is also called &ldquo;friends of friends query&rdquo; in a social graph setting.) For example, for v<sub>1</sub>, this includes: v<sub>3</sub>, v<sub>2</sub>, v<sub>5</sub>, and v<sub>4</sub> (so the answer would be 4), whereas for v<sub>5</sub>, the 2-hop neighborhood includes: v<sub>1</sub>, v<sub>2</sub>, v<sub>3</sub>, v<sub>4</sub>, v<sub>6</sub>, v<sub>7</sub>, v<sub>8</sub>, v<sub>9</sub>, i.e., all the nodes in the graph (so the answer would be 8). Note that, we don&rsquo;t count v<sub>5</sub> to be in its own 2-hop neighborhood.</p>

<p style="text-align: center;"><img alt="" src="%EB%B0%B1%EC%A4%80/Silver/10204.%E2%80%85Neighborhoods%E2%80%85in%E2%80%85Graphs/97259305.png" data-original-src="%EB%B0%B1%EC%A4%80/Silver/10204.%E2%80%85Neighborhoods%E2%80%85in%E2%80%85Graphs/97259305.png" data-original-src="https://upload.acmicpc.net/637c1c2c-d979-4ce9-bb7e-291f54813010/-/preview/" onerror="this.onerror=null;this.src=this.dataset.originalSrc" style="width: 379px; height: 177px;" /></p>
