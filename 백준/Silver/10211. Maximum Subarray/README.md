...
제출: 13035, 정답: 5770, 맞힌 사람: 4584, 정답 비율: 43.921%
...
<p>여러분은 N과 배열 X가 주어졌을 때, X의 maximum subarray의 합을 구하자. 즉, max<sub>1&nbsp;&le;&nbsp;i&nbsp;&le; &nbsp;j &le;&nbsp;N&nbsp;</sub>(X[i]+...+X[j])를 구하자.</p>

### 입력

<p>입력 파일의 첫 번째 줄에 테스트 케이스의 수를 의미하는 자연수 T가 주어진다. 그 다음에는 T개의 테스트 케이스가 주어진다.</p>

<p>각 테스트케이스 별로 첫 번째&nbsp;줄에 배열의 크기 N이 주어진다. (1 &le; N &le; 1,000)</p>
