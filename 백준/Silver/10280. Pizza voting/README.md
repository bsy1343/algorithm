...
제출: 491, 정답: 218, 맞힌 사람: 150, 정답 비율: 42.735%
...
<p>The input starts with the number of pizzas n (1 &le; n &le; 100 000) and the index of your favorite pizza p (1 &le; p &le; n) (1-indexed). Then follow the description of the n pizzas, each given in one line. The description consists of one integer c (0 &le; c &le; 1 000 000) giving the calories followed by a single word w giving the name of the pizza (up to 100 characters). The pizzas are ordered from low calories to high calories and the number of calories is unique for every pizza.&nbsp;</p>

### 출력

<p>Output one line. &ldquo;YES&rdquo; if you can vote in a way, such that your pizza will be selected. &ldquo;NO&rdquo; if you are not able to influence the vote in a way that your pizza will be selected.</p>