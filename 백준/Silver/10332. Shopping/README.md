...
제출: 141, 정답: 92, 맞힌 사람: 88, 정답 비율: 72.131%
...
<p>The first line contains two integers N and m, where N (1 &le; N &le; 1000) is the number of shops, and m (0 &le; m &le; 500) is the number of restrictions. Each of the next m lines contains two integers c<sub>i</sub> and d<sub>i</sub> (1 &le; c<sub>i</sub> &lt; d<sub>i</sub> &le; N) indicating the i-th restriction on the visiting order, where she must visit the shop numbered c<sub>i</sub> after she visits the shop numbered d<sub>i</sub> (i = 1, ... , m).</p>
