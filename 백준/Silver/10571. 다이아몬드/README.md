...
제출: 995, 정답: 355, 맞힌 사람: 303, 정답 비율: 37.224%
...
<p style="text-align:center"><img alt="" src="/upload/images2/diamond.png" style="height:72px; width:210px" /></p>
...
<p>테스트 케이스의 개수 T가 주어지고 (1&le;T&le;100) 각 테스트 케이스마다 다이아몬드의 정보의 개수 N (1&le;N&le;200)이 주어집니다. 그리고 N개의 줄에 걸쳐서 다이아몬드의 무게와 선명도 w<sub>i, </sub>c<sub>i</sub>가 주어집니다 (0&le;w<sub>i,</sub>c<sub>i</sub>&le;100).</p>
