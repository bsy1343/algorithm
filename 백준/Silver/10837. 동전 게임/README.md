...
제출: 8573, 정답: 2949, 맞힌 사람: 2134, 정답 비율: 36.604%
...
<p>첫 줄에 게임의 라운드 수를 나타내는 정수 K(1 &le; K &le; 1,000)가 주어진다. 두 번째 줄에는 입력의 개수를 나타내는 정수 C(1 &le; C &le; 100,000)가 주어진다. 다음 이어지는 C개의 줄 각각에는 하나의 입력을 나타내는 두 정수 M과 N(0 &le; M, N &le; K)이 주어진다.&nbsp;</p>
