...
제출: 98, 정답: 50, 맞힌 사람: 44, 정답 비율: 48.352%
...
<p>Once again you lost days refactoring code, which never runs in the first place. Enough is enough &ndash; your time is better spent writing a tool that finds unused code!</p>
...
<p>The first line of the input contains an integer N, the number of methods in your software (1 &le; N &le; 400).</p>

<p>Each method is described by two lines, totaling in 2&middot;N lines. The first line consists of the unique identifier of the method and k<sub>i</sub>, the number of methods directly invoking this one (0 &le; k<sub>i</sub> &le; N). The second line consists of a set of ki identifiers of these calling methods or is empty if there are no such methods, i.e. k<sub>i</sub> = 0.</p>
