...
제출: 397, 정답: 277, 맞힌 사람: 228, 정답 비율: 71.473%
...
<p>첫 번째 줄에는 사람들의 수 N (1 &le; N &le; 300)이 주어진다.</p>

<p>다음 3N줄에는 각 말뚝의 위치를 나타내는 두 정수 x,y (&minus;10<sup>6</sup> &le; x,y &le; 10<sup>6</sup>) 가 공백으로 구분되어 주어진다. 말뚝은 입력 받는 순서대로 1에서 3N까지의 번호가 붙는다.</p>
