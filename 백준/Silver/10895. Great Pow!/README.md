...
시간 제한: 10 초, 메모리 제한: 64 MB

### 통계

제출: 723, 정답: 251, 맞힌 사람: 205, 정답 비율: 36.477%
...
<p>첫 번째 줄에 \(a\)와 \(k\) (1 &le; \(a\) &le; 10<sup>9</sup>, 0 &le; \(k\) &le; 10<sup>9</sup>)가 공백으로 구분되어 주어진다.</p>
...
<p>\(pow_{2}^{3}(2) = 2^{2^{2^{2}}} = 65,536\)이므로, 이를 3으로 나눈 나머지인 1을 출력한다.</p>