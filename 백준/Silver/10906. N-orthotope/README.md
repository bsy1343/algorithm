...
제출: 143, 정답: 86, 맞힌 사람: 79, 정답 비율: 59.848%
...
<p style="text-align: center;">[s<sub>1</sub>, e<sub>1</sub>] &times; [s<sub>2</sub>, e<sub>2</sub>] &times; ... &times; [s<sub>N</sub>, e<sub>N</sub>] (s<sub>i</sub> &lt; e<sub>i</sub>)<br />
(즉, N차원 점 (x<sub>1</sub>, x<sub>2</sub>, ..., x<sub>N</sub>)의 각 x<sub>i</sub> 가 s<sub>i</sub> &le; x<sub>i</sub> &le; e<sub>i</sub> 인 점들의 집합이다.)</p>
...
<p style="text-align: center;">[s<sub>1</sub>, e<sub>1</sub>] &times; [s<sub>2</sub>, e<sub>2</sub>] &times; ... &times; [s<sub>K</sub>, e<sub>K</sub>] (s<sub>i</sub> &le; ei)</p>
