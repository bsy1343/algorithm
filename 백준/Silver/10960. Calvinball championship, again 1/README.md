...
제출: 243, 정답: 155, 맞힌 사람: 125, 정답 비율: 65.445%
...
<p>이 문제는 <a href="https://onlinejudgeimages.s3-ap-northeast-1.amazonaws.com/problem/10960/data.tar.gz">압축 파일</a>에서 calvin1.in으로 채점을 한다. (예제는 채점하지 않는다)</p>