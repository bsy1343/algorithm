...
제출: 135, 정답: 72, 맞힌 사람: 64, 정답 비율: 58.182%
...
<p>The first line of the data set contains the number n of buildings, 1 &le; n &le; 100. This is followed by n lines, each containing the name of a building, consisting of only uppercase and lowercase letters and white space. Finally, the building code will follow on a line by itself, consisting only of letters. Each string will be at most 100,000 characters long.</p>
