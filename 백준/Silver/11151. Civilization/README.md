...
제출: 126, 정답: 93, 맞힌 사람: 85, 정답 비율: 74.561%
...
<ul>
	<li>0 &lt; T &le; 100</li>
	<li>0 &lt; N &le; 18</li>
	<li>0 &lt; W, C, F &le; 1000</li>
	<li>0 &lt; w<sub>i</sub>, c<sub>i</sub>, f<sub>i</sub> &le; 1000</li>
</ul>

### 출력

<p>For each test case, output the minimal number of regions that need to be administered. If it is impossible for the city to be prosperous, output &ldquo;game over&rdquo; instead (without quotes).</p>