...
제출: 24198, 정답: 14372, 맞힌 사람: 12627, 정답 비율: 60.923%
...
<p>길이가 N으로 같은 문자열 X와 Y가 있을 때, 두 문자열 X와 Y의 차이는 X[i] &ne; Y[i]인 i의 개수이다. 예를 들어, X=&rdquo;jimin&rdquo;, Y=&rdquo;minji&rdquo;이면, 둘의 차이는 4이다.</p>
