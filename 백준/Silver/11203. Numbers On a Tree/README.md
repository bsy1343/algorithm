...
제출: 701, 정답: 293, 맞힌 사람: 251, 정답 비율: 41.625%
...
<p>Lovisa is at KTH listening to Stefan Nilsson lecturing about perfect binary trees. &ldquo;A perfect binary tree has a distinguished node called the root which is usually drawn at the top. Each node has two children except the nodes in the lowest layer, which we call leaves.&rdquo; Lovisa knows all this already, so she is a bit bored. Noticing this, Stefan comes up with a new challenge for Lovisa.</p>
...
<p>Lovisa&rsquo;s task is to calculate the label of a node, given the height of the tree H and the description of the path from the root.</p>

### 입력

<p>The only line of input contains the height of the tree H, 1 &le; H &le; 30 and a string consisting of the letters &lsquo;<code>L</code>&rsquo; and &lsquo;<code>R</code>&rsquo;, denoting a path in the tree starting in the root. The letter &lsquo;<code>L</code>&rsquo; denotes choosing the left child, and the letter &lsquo;<code>R</code>&rsquo; choosing the right child. The description of the path may be empty and is at most H letters.</p>
