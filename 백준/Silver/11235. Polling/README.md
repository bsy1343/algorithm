...
제출: 360, 정답: 276, 맞힌 사람: 248, 정답 비율: 76.308%
...
<p>Each input will consist of a single test case. Note that your program may be run multiple times on different inputs. Each test case will begin with an integer n (1 &le; n &le; 1,000), indicating the number of votes. The next n lines will hold the votes. The candidates&rsquo; names will appear one per line, and consist of between 1 and 20 capital letters only.</p>
