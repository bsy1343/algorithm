...
제출: 65, 정답: 28, 맞힌 사람: 23, 정답 비율: 47.917%
...
<p>Each record has an integer, a slash character, /, and either another integer, or a &ndash; character. The record should be interpreted as follows:</p>
