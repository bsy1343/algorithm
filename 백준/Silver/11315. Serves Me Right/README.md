# [Silver III] Serves Me Right - 11315
...
제출: 214, 정답: 58, 맞힌 사람: 31, 정답 비율: 20.395%
...
<p>The first line of the input file starts with the integer T, the number of web logs to process (1 &le; T &le; 100).</p>

<p>Each case starts with two integers on the first line - E and T O (1 &le; E, T O &le; 1440) Then follow E log entries on each line. They can be in either of these two formats:</p>

<pre>
TIME SERVER RESTART</pre>
