...
제출: 93, 정답: 70, 맞힌 사람: 59, 정답 비율: 74.684%
...
<p>Albert would like you to help him achieve his addition aspirations; he doesn&rsquo;t want you to do all of his work for him (that wouldn&rsquo;t help!), but if you could rearrange some of his practice expressions into something a little easier, he would be very grateful!</p>

### 입력

<p>Each line of input will be a summation of nonnegative integers in the form</p>

<p>x<sub>1</sub> + x<sub>2</sub> + &middot; &middot; &middot; + x<sub>N</sub></p>

<p>for some N(2 &le; N &lt; 1000), where 0 &le; x<sub>i</sub> &le; 100000 for each x<sub>i</sub>.</p>
