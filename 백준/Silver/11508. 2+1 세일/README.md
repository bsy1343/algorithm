...
제출: 10256, 정답: 6150, 맞힌 사람: 5181, 정답 비율: 60.710%
...
<p>첫 번째 줄에는 유제품의 수 N (1 &le; N &le; 100,000)이 주어집니다.</p>

<p>두 번째 줄부터 N개의 줄에는 각 유제품의 가격 C<sub>i</sub> (1 &le; C<sub>i</sub> &le; 100,000)가 주어집니다.</p>
