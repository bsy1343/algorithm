...
제출: 160, 정답: 105, 맞힌 사람: 81, 정답 비율: 74.312%
...
<p>The input consists of a single line containing two strings. The first string is the password, having length P, with 3 &le; P &le; 8. The second string has length S, with 10 &le; S &le; 40. Both strings will consist solely of uppercase letters. (That is, neither string can include whitespace, lowercase letters, digits, or other special characters.)</p>
