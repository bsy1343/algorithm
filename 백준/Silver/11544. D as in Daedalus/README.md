...
제출: 205, 정답: 131, 맞힌 사람: 122, 정답 비율: 66.667%
...
<p>The first line contains two integers N and M, representing respectively the number of players and the number of rounds (1 &le; N &le; 20 and 1 &le; M &le; 50). Each of the next M lines describes a round with an integer B indicating the budget (1 &le; B &le; 10<sup>6</sup>), followed by N integers C<sub>1</sub>, C<sub>2</sub>, . . . , CN representing that the i-th player chose the card labelled with C<sub>i</sub> points during that round (C<sub>i</sub> &isin; {1, 10, 100, 1000, 10000} for i = 1, 2, . . . , N). Daedalus is the first player.</p>
