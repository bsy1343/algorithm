...
제출: 3395, 정답: 1312, 맞힌 사람: 1123, 정답 비율: 39.514%
...
<p>매 테스트 케이스의 첫 줄에는 플레이어의 숫자 N(1 &le; N &le; 10,000)이 주어진다.</p>

<p>이어서 N줄에 걸쳐 각 플레이어가 지명한 사람의 숫자 A<sub>i</sub>(1 &le; A<sub>i</sub> &le; N, 1 &le; i &le; N)이 주어진다.</p>
