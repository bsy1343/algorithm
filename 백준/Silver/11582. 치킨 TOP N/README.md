...
제출: 4481, 정답: 2307, 맞힌 사람: 1763, 정답 비율: 52.006%
...
<p>첫 번째 줄에 치킨집의 개수 N(4 &le; N &le; 2<sup>20</sup>)이 주어진다. N은 항상 2의 거듭제곱 꼴이다.</p>

<p>두 번째 줄에는 N개의 치킨집의 맛의 수치들이 빈칸을 구분으로 주어지며 이 값은 10억보다 작거나 같은 자연수 또는 0이다.</p>

<p>세 번째 줄에는 현재 정렬을 진행중인 회원들의 수 k(1 &le; k &lt; N)가 주어진다. k 또한 2의 거듭제곱 꼴이다.</p>
