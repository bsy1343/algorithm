...
제출: 338, 정답: 279, 맞힌 사람: 246, 정답 비율: 84.828%
...
<ul>
	<li>one line with a string s (1 &le; length(s) &le; 30), the quadkey of the map tile.</li>
</ul>

<p>The string s consists of only the digits &lsquo;0&rsquo;, &lsquo;1&rsquo;, &lsquo;2&rsquo; and &lsquo;3&rsquo;.</p>
