...
제출: 354, 정답: 246, 맞힌 사람: 195, 정답 비율: 70.144%
...
<ul>
	<li>one line with an integer n (1 &le; n &le; 10<sup>5</sup>), the number of bytes in the message sent by the weather sensor;</li>
	<li>one line with n integers b<sub>1</sub>, . . . , b<sub>n</sub> (0 &le; b<sub>i</sub> &le; 255 for all i), the byte values of the message.</li>
</ul>
