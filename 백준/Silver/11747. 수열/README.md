...
제출: 480, 정답: 306, 맞힌 사람: 265, 정답 비율: 65.594%
...
<p>하나코는 최근에 임의의 음이 아닌 정수를 선택하면 항상 원주율&nbsp;&pi; = 3.14159265 &middot; &middot; &middot; 의 특정 부분에서 나타난다는 것을 알았습니다. 그 이후, 그녀는 숫자들의 나열이 주어질 때, 그 숫자열에서 나타나는 음이 아닌 정수를 알아보고자 합니다.</p>
...
<p>입력의 첫 번째 줄에는 숫자열의 길이 N (1 &le; N&nbsp;&le; 1,000)이 주어집니다.</p>
