...
제출: 147, 정답: 100, 맞힌 사람: 91, 정답 비율: 72.800%
...
<p>If the given word is not a multigram, output &minus;1.</p>

<p>Otherwise, output the shortest root of the given word in one line.</p>

### 힌트

<p>Clarification of the first example: Notice that the word &ldquo;aa&rdquo; could also be the root, but &ldquo;a&rdquo; is shorter.</p>

<p>Clarification of the second example: The word is not a multigram because &ldquo;a&rdquo; and &ldquo;b&rdquo; are not mutually anagrams</p>