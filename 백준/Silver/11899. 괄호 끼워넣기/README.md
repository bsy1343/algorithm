...
제출: 4543, 정답: 3452, 맞힌 사람: 3019, 정답 비율: 77.232%
...
<p>승현이는 이 괄호열을 가지고 놀려고 했으나 올바른 괄호열이 아니기 때문에 행복하지 않았습니다. 이를 보던 지학이는 승현이에게 &ldquo;그러면 앞과 뒤에 적절하게 괄호를 붙이면 올바른 괄호열이 되지 않을까?&rdquo;라고 했고, 승현이는 조금 생각한 뒤 그렇게 하기로 했습니다. 예를 들어, 위의 올바르지 않은 괄호열의 경우 앞에 여는 괄호 3개를 붙이면 올바른 괄호열이 됩니다.</p>
...
<p>괄호열이란 여는 괄호 &lsquo;(&rsquo;와 닫는 괄호 &lsquo;)&rsquo;로만 구성된 문자열을 말합니다.</p>
