...
제출: 2370, 정답: 1391, 맞힌 사람: 1239, 정답 비율: 59.028%
...
<p>첫째 줄에 볼록 다각형 점의 수 N (3 &le; N &le; 35)이 주어진다. 둘째 줄부터 N개의 줄에는 볼록 다각형을 이루고 있는 점이 시계 방향 순서로 주어진다. 좌표는 10,000보다 작거나 같은 자연수이다.</p>
