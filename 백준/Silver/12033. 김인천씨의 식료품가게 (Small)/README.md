...
제출: 1385, 정답: 693, 맞힌 사람: 602, 정답 비율: 53.133%
...
<ul dir="ltr">
	<li>1 &le; T &le; 100.</li>
	<li>모든 i에 대해서 1 &le; P<sub>i</sub> &le; 10<sup>9</sup>.</li>
	<li>모든 i에 대해서 P<sub>i</sub> &le; P<sub>i+1</sub>. (가격은 오름차순으로 존재)</li>
...
<p dir="ltr">개별 테스트 케이스에 대해서 출력라인은 &ldquo;Case #x: y&rdquo; 형식(큰 따옴표는 제외)으로 출력하며, &nbsp;x는 1부터 시작하는 테스트 케이스의 번호 (인덱스)이며, y는 할인가격에 해당하는 오름차순으로 정렬된 N개의 정수들이다.</p>
