...
제출: 1738, 정답: 865, 맞힌 사람: 713, 정답 비율: 49.105%
...
<p>개별 테스트 케이스에 대해서 출력라인은 &ldquo;Case #x: y&rdquo; 형식(큰 따옴표는 제외)으로 출력하며, &nbsp;x는 1부터 시작하는 테스트 케이스의 번호 (인덱스)이며, y는 할인가격에 해당하는 오름차순으로 정렬된 N개의 정수들이다.</p>
