...
제출: 56, 정답: 39, 맞힌 사람: 34, 정답 비율: 72.340%
...
<ul>
	<li><span style="line-height:1.6em">1 &le; </span><strong style="line-height:1.6em">T</strong><span style="line-height:1.6em"> &le; 50.</span></li>
	<li>0 &le; |<strong>X</strong>|, |<strong>Y</strong>| &le; 100.</li>
</ul>
...
<p>The output for the first sample test case will not be considered correct if it is in the large dataset, because the number of moves is not the minimum. WNSEN would be a correct output for this test case if it were in the large dataset.</p>