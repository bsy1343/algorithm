...
제출: 112, 정답: 60, 맞힌 사람: 42, 정답 비율: 55.263%
...
<ul>
	...
	<li><span style="line-height:1.6em">1 &le; </span><strong style="line-height:1.6em">E</strong><span style="line-height:1.6em"> &le; 5.</span></li>
	<li>1 &le; <strong>R</strong> &le; 5.</li>
	<li>1 &le; <strong>N</strong> &le; 10.</li>
	<li>1 &le; <strong>v</strong><strong><sub>i</sub></strong> &le; 10.</li>
</ul>
