...
제출: 97563, 정답: 23038, 맞힌 사람: 17328, 정답 비율: 21.775%
...
<p>1부터 연속적으로 번호가 붙어있는 스위치들이 있다. 스위치는 켜져 있거나 꺼져있는 상태이다. &lt;그림 1&gt;에 스위치 8개의 상태가 표시되어 있다. &lsquo;1&rsquo;은 스위치가 켜져 있음을, &lsquo;0&rsquo;은 꺼져 있음을 나타낸다. 그리고 학생 몇 명을 뽑아서, 학생들에게 1 이상이고 스위치 개수 이하인 자연수를 하나씩 나누어주었다. 학생들은 자신의 성별과 받은 수에 따라 아래와 같은 방식으로 스위치를 조작하게 된다.</p>
