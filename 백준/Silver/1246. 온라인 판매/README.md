...
제출: 8739, 정답: 3946, 맞힌 사람: 3524, 정답 비율: 45.494%
...
<p>첫째 줄에 정수 N(1 &le; N &le; 1,000)과 M(1 &le; M &le; 1,000)이 입력된다. 둘째 줄부터 M+1번째 줄까지 i+1번째 줄에는 P<sub>i</sub>(1 &le; P<sub>i</sub>&nbsp;&le; 1,000,000)가 입력된다.</p>
