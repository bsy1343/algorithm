...
제출: 8214, 정답: 3152, 맞힌 사람: 2679, 정답 비율: 38.625%
...
<p>월세를 내기 바로 전 날 까지 인 n (1&nbsp;&le; n &le;&nbsp;100,000) 일과 일을 할 수 있는 날 m (0 &le;&nbsp;m &le;&nbsp;n) 일이 주어진다.</p>

<p>그 다음 줄 에는 1일부터 n일 까지 일급 T<sub>i</sub>가 순서대로 주어진다. (0 &lt; T<sub>i</sub> &le;&nbsp;1,000,000)</p>
