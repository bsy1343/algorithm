...
제출: 361, 정답: 155, 맞힌 사람: 140, 정답 비율: 49.123%
...
<p>철수는 K(1&le;K&le;N)개의 사탕을 받으면 총 2<sup>K</sup>만큼의 만족도를 느낀다고 합니다. 예를 들어, 철수가 1번, 3번, 4번 총 3개의 사탕을 선물 받았다면, 2<sup>3</sup>만큼의 만족도를 느끼게 되는 것입니다. 단, 철수가 사탕을 하나도 못 받는 경우에는 철수는 0의 만족도를 느낍니다.</p>

<p>이때, 철수는 본인이 얻을 수 있는 가능한 모든 경우의 수의 만족도 합이 궁금해졌습니다. 철수의 궁금증을 해결해주는 프로그램을 작성하세요.</p>

### 입력

<p>입력의 첫째 줄에는 서로 다른 사탕의 개수를 나타내는 N(2 &le; N &le; 100,000)가 주어집니다.</p>
...
<p>(1번 사탕)을 선물 받는 경우 만족도는 2, (2번 사탕)을 선물 받는 경우 만족도는 2, (1, 2번 사탕)을 선물 받는 경우 만족도는 4.</p>
