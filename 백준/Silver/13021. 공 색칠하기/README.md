...
제출: 483, 정답: 226, 맞힌 사람: 196, 정답 비율: 50.777%
...
<p>첫째 줄에 공의 개수 N과 기계를 사용한 횟수 M이 주어진다. (1 &le; N &le; 1,000, 1 &le; M &le; 50)</p>

<p>둘째 줄부터 M개의 줄에는 기계를 사용할 때 입력한 L과 R이 기계를 사용한 순서대로 주어진다. (1 &le; L &le; R &le; N)</p>
