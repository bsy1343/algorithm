...
제출: 24707, 정답: 10087, 맞힌 사람: 8086, 정답 비율: 39.834%
...
<p>첫째 줄에는 전쟁터의 가로 크기 N, 세로 크기 M(1 &le; N, M &le; 100)이 주어진다. 그 다음 두 번째 줄에서 M+1번째&nbsp;줄에는 각각 (X, Y)에 있는 병사들의 옷색이 띄어쓰기 없이 주어진다. 모든 자리에는 병사가 한 명 있다. B는 파란색, W는 흰색이다. 당신의 병사와 적국의 병사는 한 명 이상 존재한다.</p>
