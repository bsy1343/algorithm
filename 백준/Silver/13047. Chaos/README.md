...
제출: 113, 정답: 63, 맞힌 사람: 50, 정답 비율: 54.945%
...
<p>The first line contains one integer n (3 &le; n &le; 10<sup>5</sup>) &mdash; the number of integers written on the board.</p>

<p>The second line contains n integers a<sub>i</sub> (1 &le; a<sub>i</sub> &le; 10<sup>9</sup>) &mdash; the numbers on the board.</p>

### 출력

<p>Output one integer &mdash; the maximal possible value of the two numbers left on the board in the end of Doc&#39;s actions.</p>
