...
제출: 104, 정답: 36, 맞힌 사람: 30, 정답 비율: 37.500%
...
<p>A sequence enters a chain when a term of the form 1233*4444 or 5566*7777 appears (3* means one or more consecutive digits 3). In this case, the number of 3&rsquo;s and 6&rsquo;s increase steadily and the terms go to infinity. Below is an example:</p>
...
<p>For each test case, print one line as follows. If the RATS sequence enters a repeat within the first M term, the line follows by an uppercase letter &ldquo;R&rdquo; and the index of the term from which the sequence enters a repeat.</p>

<p>For the case of chain, the test case number is followed by the uppercase letter &ldquo;C&rdquo; and the index of the term from which the sequence enters a chain.</p>
