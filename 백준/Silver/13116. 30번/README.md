...
제출: 3434, 정답: 1947, 맞힌 사람: 1523, 정답 비율: 55.931%
...
<p>첫 번째 줄에 테스트 케이스의 수 T (1 &le; T &le; 50 000)가 주어진다. 이후 T개의 테스트 케이스가 주어진다. 각 테스트 케이스는 한 줄로 구성되어 있으며, 각 줄에는 두 개의 정수 A와 B (1 &le; A, B &le; 1 023, A &ne; B)가 공백을 사이로 두고 주어진다. 이는 첫 번째 빈 칸에는 A를, 두 번째 빈 칸에는 B를 넣었을 때 답을 구하라는 의미이다</p>
