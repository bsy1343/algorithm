...
제출: 684, 정답: 524, 맞힌 사람: 371, 정답 비율: 79.957%
...
<p>The first line of the input will contain the number of nodes n. (1 &le; n &le; 20)</p>
...
<p>The root node will be identified by -1. Remember that node 1 won&rsquo;t always be the root node.</p>
