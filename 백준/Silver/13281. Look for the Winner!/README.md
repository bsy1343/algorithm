...
제출: 100, 정답: 74, 맞힌 사람: 73, 정답 비율: 76.042%
...
<pre>
n
c<sub>1</sub> c<sub>2</sub> &hellip; c<sub>n</sub></pre>

<p>n in the first line represents the number of votes, and is a positive integer no greater than 100. The second line represents the n votes, separated by a space. Each c<sub>i</sub> (1 &le; i &le; n) is a single uppercase letter, i.e. one of &#39;A&#39; through &#39;Z&#39;. This represents the election candidate for which the i-th vote was cast. Counting shall be done in the given order from c<sub>1</sub> to c<sub>n</sub>.</p>
