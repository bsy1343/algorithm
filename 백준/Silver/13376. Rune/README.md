...
제출: 63, 정답: 44, 맞힌 사람: 33, 정답 비율: 70.213%
...
<ol>
	<li>Rune named &lsquo;gattaca&rsquo; has a power of 3. Since there are 3 non-adjacent vowels in its name.</li>
	<li>Rune named &#39;beautiful&#39; also has a power of 3. Even though there are 5 vowels, because &lsquo;eau&rsquo; are adjacency vowels and are counted as one.</li>
</ol>
...
<p>The first line of input gives integer L, a number of languages you interested (1 &lt; L &le; 10)</p>

<p>Next L lines will start with N (1 &lt; N &le; 10<sup>5</sup>), a number of runes in that language.</p>
