...
제출: 54, 정답: 41, 맞힌 사람: 35, 정답 비율: 74.468%
...
<ul>
	...
	<li>Material: One piece of rectangle paper with dimension L&rdquo; &times; W&rdquo;.&nbsp;</li>
...
<ul>
	<li>A square paper size 5&rdquo; &times; 2&rdquo;.</li>
	<li>The first player can cut 2 squares of 2&rdquo; &times; 2&rdquo;. The remainder is therefore a rectangle 2&rdquo; &times; 1&rdquo;.&nbsp;</li>
	<li>The second player can cut 2 squares with 1&rdquo; &times; 1&rdquo; without the remainder.</li>
...
<ul>
	...
	<ul>
		...
		<li>The next r integers are ai where 1 &le; I &le; r</li>
	</ul>
	</li>
</ul>
