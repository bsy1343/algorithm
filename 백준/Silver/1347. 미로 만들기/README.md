...
제출: 5275, 정답: 3009, 맞힌 사람: 2602, 정답 비율: 58.617%
...
<p>입력으로 홍준이가 적은 내용을 나타내는 문자열이 주어진다. 각&nbsp;문자 하나는 한 번의 움직임을 말한다. &lsquo;F&rsquo;는 앞으로 한 칸 움직인 것이고, &lsquo;L&#39;과 &rsquo;R&#39;은 방향을 왼쪽 또는 오른쪽으로 전환한 것이다. 즉, 90도를 회전하면서, 위치는 그대로인 것이다.</p>
...
<p>첫째 줄에 미로 지도를 출력한다. &lsquo;.&rsquo;은 이동할 수 있는 칸이고, &lsquo;#&rsquo;는 벽이다.</p>