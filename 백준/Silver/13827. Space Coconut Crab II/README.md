...
제출: 85, 정답: 45, 맞힌 사람: 32, 정답 비율: 56.140%
...
<p>The input consists of multiple datasets. Each dataset comes with a line that contains a single positive integer T (1 &le; T &le; 30000).</p>
