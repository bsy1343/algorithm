...
제출: 124, 정답: 33, 맞힌 사람: 23, 정답 비율: 25.843%
...
<p>Your task is to write a program that counts the score of the dealer&rsquo;s hand after his play for each given sequence of cards.</p>
...
<p>Each case consists of two lines. The first line contains two characters, which indicate the cards in the dealer&rsquo;s initial hand. The second line contains eight characters, which indicate the top eight cards in the pile after all players finish their plays.</p>
...
<p>For each case, print on a line &ldquo;blackjack&rdquo; if the dealer has a blackjack; &ldquo;bust&rdquo; if the dealer busts; the score of the dealer&rsquo;s hand otherwise.</p>