...
제출: 65, 정답: 49, 맞힌 사람: 45, 정답 비율: 91.837%
...
<pre>
<code>F(1) = 1/1, F(2) = 1/2, F(3) = 2/1, F(4) = 1/3, F(5) = 3/2, F(6) = 2/3, &hellip; </code></pre>
...
<p>The first line of input contains a single integer P, (1 &le; P &le; 1000), which is the number of data sets that follow.</p>
