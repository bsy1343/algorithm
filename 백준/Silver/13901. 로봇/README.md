...
제출: 3413, 정답: 1226, 맞힌 사람: 1029, 정답 비율: 35.495%
...
<table class="table table-bordered">
	<tbody>
		...
		<tr>
			...
			<p>로봇은 (1, 1) &rarr; (0, 1) &rarr; (0, 0)로 이동하였다.</p>
			</td>
		</tr>
	</tbody>
</table>
...
<p>첫 번째 줄에는 방의 크기 R, C(3 <strong>&le;</strong> R, C <strong>&le;</strong> 1,000)가 입력된다. 두 번째 줄에는 장애물의 개수 k(0 <strong>&le;</strong> k <strong>&le;</strong> 1,000)가 입력된다. 다음 k개의 줄에는 각 장애물 위치 br(0 <strong>&le; </strong>br <strong>&le;</strong> R &ndash; 1), bc(0 <strong>&le;</strong> bc <strong>&le;</strong> C - 1)가 주어진다. 그 다음 순서대로 로봇의 시작 위치 sr(0 <strong>&le;</strong> sr <strong>&le;</strong> R &ndash; 1), sc(0 <strong>&le;</strong> sc <strong>&le;</strong> C - 1)와 이동 방향의 순서(총 4개가 입력되는데 1은 위 방향, 2은 아래 방향, 3은 왼쪽 방향, 4는 오른쪽 방향을 나타낸다)가 한 줄씩 입력된다. 로봇의 시작위치에 장애물이 있는 경우는 없다.</p>
