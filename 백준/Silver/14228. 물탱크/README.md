...
제출: 335, 정답: 78, 맞힌 사람: 59, 정답 비율: 23.228%
...
<p>첫째 줄에 n과 C가 주어진다. (1 &le;&nbsp;n &le; 50, 1 &le; C &le; 10<sup>9</sup>)</p>

<p>둘째 줄에는 t[0], t[1], ..., t[n-1]이, 셋째 줄에는 x[0], x[1], ..., x[n-1]이 주어진다. (1 &le; t[i], x[i] &le; 1,000,000)</p>
