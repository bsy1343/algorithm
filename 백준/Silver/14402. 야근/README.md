...
제출: 792, 정답: 401, 맞힌 사람: 336, 정답 비율: 54.992%
...
<p>첫째 줄에는 출입기록의 개수 q가 주어진다.( 1&le;q&le;100,000)</p>

<p>다음 q줄에는 이름 s와 들어간지 나간지에 대한 정보 p가 주어지는데, p는 &lsquo;+&rsquo;일 때 들어간 것이고, &lsquo;-&lsquo;일 때 나간 것이다. 이름의 길이는 30자를 넘지 않는다. 이름은 소문자로만 이루어져 있다.</p>
