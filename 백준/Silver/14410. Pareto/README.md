...
제출: 145, 정답: 98, 맞힌 사람: 81, 정답 비율: 68.644%
...
<p>The first line of input contains the integer N (1 &le; N &le; 300 000), the number of clients in the bank.</p>
...
<p>50% of accounts (one account, the one with 200 euros), contains two thirds, 66.666667% of the total money.</p>