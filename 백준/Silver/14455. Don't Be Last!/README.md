...
제출: 1912, 정답: 574, 맞힌 사람: 530, 정답 비율: 32.595%
...
<p>The input file for this task starts with a line containing the integer&nbsp;N&nbsp;(1 &le; N &le; 100), giving the number of entries in Farmer John&#39;s milking log.</p>
...
<p>In this example, Bessie, Elsie, and Daisy all tie for the minimum by each producing 7 units of milk. The next-largest production, 9 units, is due to Henrietta.</p>