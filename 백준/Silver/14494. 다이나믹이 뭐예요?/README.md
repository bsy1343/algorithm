...
제출: 4362, 정답: 3065, 맞힌 사람: 2610, 정답 비율: 71.526%
...
<p>&ldquo;&rarr;, &darr;, ↘의 세 방향만 사용해서 한 번에 한 칸씩 이동할 때, 왼쪽 위 (1, 1)에서 출발하여 오른쪽 아래 (n, m)에 도착하는 경우의 수를 구하여라.&rdquo;</p>

<p>시작!</p>

### 입력

<p>n과 m이 주어진다. (1 &le; n, m &le; 1,000)</p>
