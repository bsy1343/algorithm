...
제출: 217, 정답: 176, 맞힌 사람: 137, 정답 비율: 85.093%
...
<p>Each input will consist of a single test case. Note that your program may be run multiple times on different inputs. The input will consist of a single string s (1 &le; |s| &le; 10<sup>5</sup>), with only the characters capital &lsquo;B&rsquo; and &lsquo;W&rsquo;. The stones are arranged in a circle, so the first stone and the last stone are adjacent.</p>
