...
제출: 639, 정답: 335, 맞힌 사람: 313, 정답 비율: 54.435%
...
<p>두 번째 게임에는, 총 4장의 카드가 있다. 처음 행동 때, 같은 무늬가 나왔으면, 카드를 두 장 모두 게임에서 제외하고, 나머지 카드를 뒤집어 게임에서 제외시키면 된다. 처음 행동 때, 다른 무늬가 나왔으면, 두 번째 행동때는, 첫 번째 행동때 뒤집지 않은 카드의 무늬를 확인하여, 첫 번째 행동때 뒤집어서 확인한 카드중 같은 무늬의 카드도 뒤집어, 제외시키고, 나머지 카드 두개를 제외시키면 된다. 그러므로 최소의 행동은 2번, 최대의 행동은 3번이 든다.</p>