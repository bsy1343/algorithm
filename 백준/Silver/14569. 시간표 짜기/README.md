...
제출: 1651, 정답: 1087, 맞힌 사람: 928, 정답 비율: 66.715%
...
<p>연세대학교의 총 과목의 수 N (3 &le; N &le; 1000)이 주어진다.</p>

<p>N줄에 걸쳐서 각 과목의 수업시간의 수 k (4 &le; k &le; 50)가 주어지고 그 옆에 k개의 숫자 t<sub>i</sub> (1 &le; t<sub>i</sub> &le; 50)가 공백으로 구분되어 주어진다.</p>

<p>t<sub>i</sub>는 이 과목의 수업이 진행되는 교시를 의미하며 1 ~ 50의 값을 가진다.</p>

<p>(월요일 1~10교시: 1~10, 화요일 1~10교시: 11~20, &hellip;)</p>

<p>다음 줄에 학생수 M (1 &le; M &le; 10000) 이 주어진다.</p>

<p>M줄에 걸쳐서 각 학생들의 <strong>비어 있는</strong> 교시 개수 p (0 &le; p &le; 50)가 주어지고 그 옆에 p개의 숫자 q<sub>i </sub>(1 &le; q<sub>i</sub> &le; 50)가 공백으로 구분되어 주어진다.</p>
