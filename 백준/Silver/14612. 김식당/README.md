...
제출: 1871, 정답: 730, 맞힌 사람: 623, 정답 비율: 41.149%
...
<p dir="ltr">입력의 첫째 줄에 질의의 수 N과 테이블의 수 M이 주어진다. (1&le;N, M&le;100)</p>

<p>다음 N줄에 각각의 명령어들이 주어진다. 포스트잇을 정렬할 때 주문 시간이 같다면 테이블 번호가 작은 것을 더 앞에 놓는다. (1 &le; 주문 시간 &le; 1,000 , 1 &le; 테이블 번호 &le; M)</p>
