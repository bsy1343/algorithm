...
제출: 10857, 정답: 2798, 맞힌 사람: 1897, 정답 비율: 22.969%
...
<p>첫째 줄에 승균이가 시장에서 사 온 파의 개수 S(1 &le; S &le; 1,000,000), 그리고 주문받은 파닭의 수 C(1 &le; C &le; 1,000,000)가 입력된다. 파의 개수는 항상 파닭의 수를 넘지 않는다. (S &le; C) 그 후, S 줄에 걸쳐 파의 길이 L(1 &le; L &le; 1,000,000,000)이 정수로 입력된다.</p>
