...
제출: 197, 정답: 143, 맞힌 사람: 131, 정답 비율: 73.596%
...
<p>The first line of input contains two integers m (1 &le; m &le; 500) and n (1 &le; n &le; 50), where m is the number of translations of letters and n is the number of word pairs. Each of the next m lines contains two distinct space-separated letters a and b, indicating that the letter a can be translated to the letter b. Each ordered pair of letters (a, b) appears at most once. Following this are n lines, each containing a word pair to check. Translations and words use only lowercase letters &lsquo;a&rsquo;&ndash;&lsquo;z&rsquo;, and each word contains at least 1 and at most 50 letters.</p>
