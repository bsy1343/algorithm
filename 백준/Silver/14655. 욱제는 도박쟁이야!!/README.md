...
제출: 1861, 정답: 1537, 맞힌 사람: 1344, 정답 비율: 84.105%
...
<p>욱제는 라스베이거스에서 유명한 베팅꾼이다. 어찌나 게임을 잘 하는지 &lsquo;제2의 홍진호&rsquo;라는 별명이 붙었을 정도다. 어찌나 게임을 잘 하는지 &lsquo;제2의 홍진호&rsquo;라는 별명이 붙었을 정도다.</p>
...
<p>첫째 줄에 동전의 수 N이 주어진다. (1 &le; N &le; 10,000) 둘째 줄에 욱제의 첫 번째 라운드의 N개 동전의 배열이 주어진다. 셋째 줄에 욱제의 두 번째 라운드의 N개 동전의 배열이 주어진다. 동전에 적히는 수는 절댓값 10,000 이하의 정수이다.</p>
...
<p>첫 번째 라운드에서 &ndash;2, -7, -8을 뒤집으면 동전 값의 합을 최대로 만들 수 있다.</p>
