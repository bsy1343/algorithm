...
제출: 350, 정답: 199, 맞힌 사람: 176, 정답 비율: 58.863%
...
<p>Given Joe&rsquo;s measurements in no particular order, you must reconstruct the correct order in which the measurements were taken.</p>

### 입력

<p>The first line contains the integer N (1 &le; N &le; 100). The next line contains N distinct spaceseparated positive integers, where each integer is at most 1 000 000.</p>
...
<p>Explanation of Output for Sample Input</p>

<p>The low tide measurements (in order) were 10, 7, 3, and 2. The high tide measurements (in order) were 40, 50, 90, and 110.</p>