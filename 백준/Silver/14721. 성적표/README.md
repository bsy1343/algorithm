...
제출: 1078, 정답: 442, 맞힌 사람: 401, 정답 비율: 41.814%
...
<p>첫 번째 줄에는 데이터의 수 N이 주어진다. (2 &le; N &le; 100)</p>

<p>두 번째 줄부터 N+1 번째 줄까지, 각 줄에는 i번 학생의 공부시간 x<sub>i</sub>와 시험점수 y<sub>i</sub>가 순서대로 주어진다. (1 &le; x<sub>i</sub>, y<sub>i</sub> &le; 1000, x<sub>i</sub>와 y<sub>i</sub>는 정수)</p>
