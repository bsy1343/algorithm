...
제출: 1359, 정답: 864, 맞힌 사람: 733, 정답 비율: 66.215%
...
<p>첫째 줄에 직사각형의 개수 N(2 &le; N &le; 100)이 주어진다.</p>

<p>이어 N개의 줄에 네 정수 x1, y1, x2, y2(0 &le; x1 &lt; x2 &le; 500, 0 &le; y1 &lt; y2 &le; 500)가 순서대로 주어진다. 이는 좌측 하단의 좌표 (x1, y1), 우측 상단의 좌표 (x2, y2)이다.</p>
