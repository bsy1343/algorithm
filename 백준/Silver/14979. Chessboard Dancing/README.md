...
제출: 53, 정답: 38, 맞힌 사람: 30, 정답 비율: 68.182%
...
<p>The performance takes place on a regular S &times; S square grid of markers on the floor.</p>
...
<ul>
	<li>In the King performance, if |x<sub>1</sub>&minus;x<sub>2</sub>| &lt; 2 and |y<sub>1</sub>&minus;y<sub>2</sub>| &lt; 2, then A and B must be occupied by members of different teams.</li>
	<li>In the Knight performance, if |x<sub>1</sub> &minus; x<sub>2</sub>| &middot; |y<sub>1</sub> &minus; y<sub>2</sub>| = 2, then A and B must be occupied by members of different teams.</li>
	<li>In the Bishop performance, if |x<sub>1</sub> &minus; x<sub>2</sub>| = |y<sub>1</sub> &minus; y<sub>2</sub>|, then A and B must be occupied by members of different teams.</li>
	<li>In the Rook performance, if |x<sub>1</sub> &minus; x<sub>2</sub>| &middot; |y<sub>1</sub> &minus; y<sub>2</sub>| = 0, then A and B must be occupied by members of different teams.</li>
</ul>
...
<p>There are more test cases. Each test case consists of a single line with integer S (1 &le; S &le; 1000) followed by a space and one of four capital letters &ldquo;K&rdquo;, &ldquo;N&rdquo;, &ldquo;B&rdquo;, &ldquo;R&rdquo;. S specifies the size of the marker grid and letters denote King performance, Knight performance, Bishop performance, or Rook performance, respectively.</p>
