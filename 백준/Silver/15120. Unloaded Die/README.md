...
제출: 119, 정답: 82, 맞힌 사람: 80, 정답 비율: 71.429%
...
<p>Consider a six-sided die, with sides labeled 1 through 6. We say the die is fair if each of its sides is equally likely to be face up after a roll. We say the die is loaded if it isn&rsquo;t fair. For example, if the side marked 6 is twice as likely to come up as than any other side, we are dealing with a loaded die.</p>
