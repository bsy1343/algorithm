...
제출: 100, 정답: 64, 맞힌 사람: 58, 정답 비율: 65.909%
...
<pre>
 &lang;formula&rang; ::= &lang;clause&rang; | &lang;formula&rang; &or; &lang;clause&rang;
  &lang;clause&rang; ::= &lang;literal&rang;
 &lang;literal&rang; ::= &lang;variable&rang; | &not; &lang;variable&rang;
&lang;variable&rang; ::= A . . . Z | a . . . z</pre>
...
<p>The only line of the input file contains a logical formula in 1-DNF form (not longer than 1000 symbols). Logical operations are represented by &lsquo;|&rsquo; (disjunction) and &lsquo;~&rsquo; (negation). The variables are &lsquo;A&rsquo; . . . &lsquo;Z&rsquo; and &lsquo;a&rsquo; . . . &lsquo;z&rsquo; (uppercase and lowercase letters are different variables). The formula contains neither spaces nor other characters not mentioned in the grammar.</p>

### 출력

<p>Output a single integer &mdash; the answer for #SAT problem for the given formula.</p>