...
제출: 84, 정답: 49, 맞힌 사람: 44, 정답 비율: 61.972%
...
<p>For example, the atomic mass of hydrogen (H) is 1.01 and the atomic mass of oxygen (O) is 16.00, which means that the molecular mass of water (H<sub>2</sub>O) is 2 &middot; 1.01 + 16.00 = 18.02.</p>

<p>What is the molecular mass of the given compound?</p>

### 입력

<p>The input starts with a line containing a single integer n (1 &le; n &le; 20), which is the number of elements.</p>

<p>The next n lines describe the elements. Each line contains the element&rsquo;s symbol followed by a real number m (0.01 &le; m &le; 500.00), which is the mass of this element. The symbol will be either a single uppercase letter or an uppercase letter followed by a lowercase letter. No two elements will have the same symbol. All masses will be specified to exactly two decimal places.</p>
...
<p>Display the molecular mass of the compound. Your answer should have an absolute or relative error of less than 10<sup>&minus;6</sup>.</p>