...
제출: 99, 정답: 39, 맞힌 사람: 35, 정답 비율: 38.462%
...
<p>The first line of input contains two integers N (1 &le; N &le; 1 000), which is the number of traffic lights, and D (2 &le; D &le; 10<sup>9</sup>), which is the length of the journey.</p>

<p>The next N lines describe the traffic lights. Each line contains four integers x (1 &le; x &lt; D), which is the location of the traffic light in kilometres from your home, a (1 &le; a &le; 10<sup>9</sup>), which is the number of minutes after leaving home that the traffic light first turns green, g (1 &le; g &le; 10<sup>9</sup>), which is the number of minutes that the traffic light remains green on each cycle, and r (1 &le; r &le; 10<sup>9</sup>), which is the number of minutes that the traffic light remains red on each cycle. The locations of the traffic lights are all distinct.</p>
