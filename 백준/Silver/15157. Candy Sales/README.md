...
제출: 134, 정답: 99, 맞힌 사람: 86, 정답 비율: 85.149%
...
<p>The input consists of two lines. The first line contains an integer n (1 &le; n &le; 200 000), which is the number of flavours. The second line contains n integers w<sub>1</sub>, w<sub>2</sub>, ..., w<sub>n</sub> (1 &le; w<sub>i</sub> &le; 100 000), where w<sub>i</sub> is the initial price of the i th candy flavour in dollars.</p>
