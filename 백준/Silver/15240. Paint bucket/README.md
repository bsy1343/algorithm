...
제출: 917, 정답: 366, 맞힌 사람: 284, 정답 비율: 38.957%
...
<p dir="ltr">Let&rsquo;s see another example, now using digits instead of pixels. We have the following image:</p>
...
<p dir="ltr">If we &ldquo;fill&rdquo; at position Y = 0, X = 0 with color 3, all the 0s get painted of color 3. Because all of them are recursively connected.</p>
...
<p dir="ltr">The last line will contain 3 integers Y, X and K representing the row and column where we want to apply the &ldquo;fill&rdquo; operation and the color to use.</p>
