...
제출: 74, 정답: 63, 맞힌 사람: 57, 정답 비율: 87.692%
...
<ul>
	...
	<li>the second line consists of the area a of Alice&rsquo;s plate, an integer in mm<sup>2</sup>;</li>
...
<ul>
	...
	<li>0 &le; a &le; 100 000</li>
	<li>For every 0 &le; i &le; n &minus; 1:
	<ul>
		<li>0 &le; v<sub>i</sub> &le; 100;</li>
		<li>0 &le; a<sub>i</sub> &le; 100 000 000.</li>
	</ul>
	</li>
</ul>
