...
제출: 937, 정답: 494, 맞힌 사람: 398, 정답 비율: 57.431%
...
<p>첫째 줄에 배열 A의 크기 N(1 &le; N &le; 100,000)과&nbsp;위치 K(1 &le; K &le; N), 연산의 개수 M(1 &le; M &le; 100,000)이&nbsp;주어진다. 둘째에는 배열 A에 들어있는 수가 1번째 수부터 순서대로 주어진다. 배열에 들어있는 수는 100,000보다 작거나 같은 자연수이다. 배열에는 같은 수가 여러 번 들어있을 수도 있다.</p>
