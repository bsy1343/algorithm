...
제출: 2383, 정답: 920, 맞힌 사람: 755, 정답 비율: 38.442%
...
<p style="text-align: center;">n &times; (n<sup>2</sup> + 1) / 2</p>
...
<p>첫째 줄에 N(3 &le; &nbsp;N &le; 100)가 주어지고 둘째 줄부터 N개의 줄에 걸쳐 N개의 숫자가 주어진다. N개의 수의 범위는 1이상 n<sup>2</sup>이하&nbsp;이다.</p>
