...
제출: 696, 정답: 445, 맞힌 사람: 410, 정답 비율: 64.976%
...
<p>In this setting, only three cows might end up in line (and this is the smallest possible). Suppose the cows with $w = 7$ and $w = 400$ arrive first and wait in line. Then the cow with $w = 1$ arrives and turns away, since 2 cows are already in line. The cows with $w = 2$ then arrive, one staying and one turning away.</p>