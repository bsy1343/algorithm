...
제출: 844, 정답: 281, 맞힌 사람: 215, 정답 비율: 33.965%
...
<p>예제 데이터 3은 Small에서는 나오지 않는다.</p>

<p>공기의 저항은 없음을 가정했기 때문에 수평 방향으로의 속도는 벽에 부딪히는 순간을 제외하고는 일정하다. 바닥과 벽이 동시에 부딪히는 경우는 없다!</p>