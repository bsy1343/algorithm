...
제출: 171, 정답: 128, 맞힌 사람: 80, 정답 비율: 70.796%
...
<p>Input will consist of a series of lines, each line containing the number of companies (N) with 1 &le; N &le; 1500, and a skipping value (M) with 1 &le; M &le; 50. The values will be terminated by a line consisting of double zeros (0 0) as shown in sample input output.</p>
