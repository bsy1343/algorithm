...
제출: 1212, 정답: 397, 맞힌 사람: 360, 정답 비율: 36.885%
...
<p>첫째 줄에 두 정수 a,b (-10<sup>8</sup> &le; a &le;10<sup>8</sup>, 1 &le;&nbsp;b &le; 10<sup>8</sup>, a &ne; b)가 주어진다. 이는 현욱이 가진 고장난 시계의 초침이 1초에 a/b 초만큼 움직인다는 의미이다. a가 음수인 경우 시계가 거꾸로 도는 경우이다.</p>
...
<p>첫 번째 예제에서, 멈춰있는 시계는 항상 12시 정각을 가리키고 있을 것이므로 맨 처음 시작할 때, 12시간 후, 24시간 후 세 번 일치하는 위치를 가리키게 된다. 이 중 맨 처음 시작할 때 동일한 위치로 맞춰두고 시작했던 것은 제외하므로 답은 2가 된다.</p>