...
제출: 2328, 정답: 478, 맞힌 사람: 383, 정답 비율: 22.358%
...
<p>0이 아닌 세 개의 정수 A, B, C가 주어진다. (-100 &le; A, B, C &le; 100)</p>

<p>이는 Ax<sup>2</sup> + Bx + C = 0꼴인 이차방정식의 계수를 의미한다.</p>

### 출력

<p>답이 이수근이면 &ldquo;이수근&rdquo;, 정수근이면 &ldquo;정수근&rdquo;, 그 외의 경우에는 &ldquo;둘다틀렸근&rdquo;을 출력한다.</p>