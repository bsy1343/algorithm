...
제출: 12119, 정답: 3814, 맞힌 사람: 2823, 정답 비율: 35.394%
...
<p>첫째 줄에 트리의 정점 개수 N(2 &le; N &le; 500,000)이 주어진다.</p>

<p>둘째 줄부터 N-1줄에 걸쳐 트리의 간선 정보가 주어진다. 줄마다 두개의 자연수 a, b(1 &le; a, b &le; N, a &ne; b)가 주어지는데, 이는 a와 b 사이에 간선이 존재한다는 뜻이다.</p>
