...
제출: 25006, 정답: 11338, 맞힌 사람: 9394, 정답 비율: 44.616%
...
<ol>
	<li>x번 카드와 y번 카드를 골라 그 두 장에 쓰여진 수를 더한 값을 계산한다. (x &ne; y)</li>
...
<p>첫 번째 줄에 카드의 개수를 나타내는 수 n(2 &le; n &le; 1,000)과 카드 합체를 몇 번 하는지를 나타내는 수 m(0 &le; m &le; 15&times;n)이 주어진다.</p>

<p>두 번째 줄에 맨 처음 카드의 상태를 나타내는 n개의 자연수 a<sub>1</sub>, a<sub>2</sub>, &hellip;, a<sub>n</sub>이 공백으로 구분되어 주어진다. (1 &le; a<sub>i</sub> &le; 1,000,000)</p>
