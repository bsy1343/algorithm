...
제출: 15932, 정답: 2717, 맞힌 사람: 1954, 정답 비율: 18.578%
...
<p style="text-align: center;"><img alt="" src="%EB%B0%B1%EC%A4%80/Silver/15954.%E2%80%85%EC%9D%B8%ED%98%95%EB%93%A4/fe931ffc.png" data-original-src="https://upload.acmicpc.net/291e743c-cfa6-4b5d-a4db-b8c2a1143179/-/preview/" onerror="this.onerror=null;this.src=this.dataset.originalSrc" /></p>
...
<p><em>N</em>개의 수 <em>a<sub>1</sub></em>, <em>a<sub>2</sub></em>, &hellip;, <em>a<sub>N</sub></em>이 주어져 있을 때, 통계학에서 (산술) 평균은 (<em>a<sub>1</sub></em> + <em>a<sub>2</sub></em> + &hellip; + <em>a<sub>N</sub></em>) / <em>N</em> 으로 정의한다. 이를&nbsp;<em>m</em>으로 정의하자.&nbsp;또한, 분산은 ((<em>a<sub>1</sub></em> - <em>m</em>)<sup>2</sup> + (<em>a<sub>2</sub></em> - <em>m</em>)<sup>2</sup> + &hellip; + (<em>a<sub>N</sub></em> - <em>m</em>)<sup>2</sup>) / <em>N</em>으로 정의하고, 표준 편차는 분산의 음이 아닌 제곱근으로 정의한다.</p>
