...
제출: 132, 정답: 87, 맞힌 사람: 69, 정답 비율: 65.094%
...
<ul>
	...
	<ul>
		<li>n (1 &le; n &le; 300 000) is the game duration;</li>
		<li>m (1 &le; m &le; 10) is the time needed to charge the ultimate attack in time slices.</li>
	</ul>
	</li>
	<li>one line with n integers x<sub>i</sub> (0 &le; x<sub>i</sub> &le; 32) describing the number of opponents in view during a time slice in order.</li>
</ul>
