...
제출: 292, 정답: 80, 맞힌 사람: 70, 정답 비율: 28.340%
...
<p>Paul is an extremely gifted computer scientist who just completed his master&rsquo;s degree at a prestigious German university. Now he would like to culminate his academic career in a PhD. The problem is that there are so many great universities out there that it is hard for him to pick the best. Because some application deadlines are coming up soon, Paul&rsquo;s only way to procrastinate his decision is by simply applying to all of them.</p>
...
<ul>
	<li>one line with an integer n (1 &le; n &le; 10<sup>5</sup>), the number of applications Paul has to file;</li>
	<li>n lines, each with two real numbers a and b (0 &lt; a, b &lt; 100), where a &times; b is the desired aspect ratio of one application.</li>
</ul>
