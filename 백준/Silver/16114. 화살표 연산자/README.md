...
제출: 2136, 정답: 472, 맞힌 사람: 421, 정답 비율: 23.145%
...
<p>첫 줄에 변수 <code>x</code>의 초기값을 뜻하는 정수 <em>X</em>와 화살표의 길이를 뜻하는 정수 <em>N</em>(-100 &le; <em>X</em> &le; 100, 0 &le; <em>N</em> &le; 10)이 주어진다.</p>
...
<p>세 번째 예시는 <code>x</code>의 값이 항상 3이므로 프로그램이 3을 무한히 출력한다.</p>