...
제출: 1344, 정답: 175, 맞힌 사람: 128, 정답 비율: 14.579%
...
<p>첫 줄에는 전체 학생 수 <em>N</em>&nbsp;(10 &le; <em>N</em> &le; 100), 조 군의 방 번호 <em>A</em>&nbsp;(1 &lt;<em> A</em> &le;&nbsp;<em>N</em>), 기분이 좋은 값 <em>B&nbsp;</em>(1 &le;&nbsp;<em>B</em>&nbsp;&le; 50), 기숙사 생활의 기간(주 단위)&nbsp;<em>M</em>&nbsp;(1 &le;&nbsp;<em>M</em>&nbsp;&le;&nbsp;50)이 차례로 한 칸씩 공백을 두고 주어진다.&nbsp;&nbsp;</p>
...
<p>첫 줄에 &lsquo;홍 군의 기분이 좋은 주의 수&rsquo;와 &lsquo;연속으로 기분이 좋은 기간의 최댓값&rsquo;을 공백으로 분리하여 출력한다.&nbsp;한 주도 기분이 좋지 않으면 &lsquo;연속으로 기분이 좋은 기간의 최댓값&rsquo;은 0으로 정의한다.</p>