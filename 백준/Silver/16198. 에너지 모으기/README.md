...
제출: 7169, 정답: 5426, 맞힌 사람: 4402, 정답 비율: 76.717%
...
<ol>
	...
	<li>W<sub>x-1</sub>&nbsp;&times; W<sub>x+1</sub>의 에너지를 모을 수 있다.</li>
...
<p>첫째 줄에 에너지 구슬의 개수 N(3 &le; N &le; 10)이 주어진다.</p>

<p>둘째 줄에는 에너지 구슬의 무게 W<sub>1</sub>, W<sub>2</sub>, ..., W<sub>N</sub>을 공백으로 구분해 주어진다. (1 &le; W<sub>i</sub> &le; 1,000)</p>
