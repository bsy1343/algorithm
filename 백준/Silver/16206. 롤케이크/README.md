...
제출: 4380, 정답: 1475, 맞힌 사람: 1178, 정답 비율: 32.795%
...
<p>첫째 줄에 롤케이크의 개수 N과 자를 수 있는 최대 횟수 M이 주어진다. (1 &le; N, M &le; 1,000)</p>

<p>둘째 줄에 롤케이크의 길이 A<sub>1</sub>, A<sub>2</sub>, ..., A<sub>N</sub>이 주어진다. (1 &le; A<sub>i</sub> &le; 1,000)</p>
