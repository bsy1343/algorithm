...
<p>The first line of input contains two integers: n and k &mdash; the number of rows and the number of passangers (1&thinsp;&le;&thinsp;n&thinsp;&le;&thinsp;10<sup>9</sup>, 1&thinsp;&le;&thinsp;k&thinsp;&le;&thinsp;min(2&middot;10<sup>5</sup>,&thinsp;2n)).</p>

<p>The following k lines describe passengers in order they entered the bus.</p>

<p>The i-th of these lines contains integers x<sub>i</sub> and y<sub>i</sub> &mdash; the row that the i-th passenger chose and the seat in that row (1&thinsp;&le;&thinsp;x<sub>i</sub>&thinsp;&le;&thinsp;n, 1&thinsp;&le;&thinsp;y<sub>i</sub>&thinsp;&le;&thinsp;2), xi is the row number, y<sub>i</sub>&thinsp;=&thinsp;1 means that the passenger took the left seat, y<sub>i</sub>&thinsp;=&thinsp;2 &mdash; the right seat.</p>

<p>Seats for different passengers are distinct.</p>

### 출력

<p>The first line must contain s<sub>1</sub> &mdash; the number of passengers that could be Red Ranger, followed by a space and s<sub>1</sub> space separated integers, the numbers of there passengers in order they entered the bus (the passengers are numbered from 1 to k in order they entered the bus).</p>
