...
제출: 160, 정답: 77, 맞힌 사람: 65, 정답 비율: 46.429%
...
<ul>
	<li>The first line has 1 &le; h &le; 100 and 1 &le; w &le; 100, the height and width of the grid.</li>
	<li>Then follow h lines with l characters each. Each character is either <code>.</code>, indicating empty space, or one of <code>#/\_|-</code>, indicating a filled 1 &times; 1 box .</li>
</ul>
