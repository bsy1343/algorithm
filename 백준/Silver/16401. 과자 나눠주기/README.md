...
제출: 19312, 정답: 7554, 맞힌 사람: 5542, 정답 비율: 37.998%
...
<p>첫째 줄에 조카의 수 M (1 &le; M &le; 1,000,000), 과자의 수 N (1 &le; N &le; 1,000,000)이 주어진다.</p>

<p>둘째 줄에 과자 N개의 길이 L<sub>1</sub>, L<sub>2</sub>, ..., L<sub>N</sub>이 공백으로 구분되어 주어진다. 과자의 길이는 (1 &le; L<sub>1</sub>, L<sub>2</sub>, ..., L<sub>N </sub>&le; 1,000,000,000) 를 만족한다.</p>
