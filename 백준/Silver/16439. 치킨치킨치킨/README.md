...
제출: 2766, 정답: 1959, 맞힌 사람: 1667, 정답 비율: 72.636%
...
<p>첫 번째 줄에 고리 회원의 수 <em>N</em>&nbsp;(1 &le; <em>N</em> &le; 30)&nbsp;과 치킨 종류의 수 <em>M</em>&nbsp;(3&nbsp;&le; <em>M</em> &le; 30) 이 주어집니다.</p>

<p>두 번째 줄부터 <em>N</em>개의 줄에 각 회원의 치킨 선호도가 주어집니다.</p>

<p><em>i</em>+1번째 줄에는 <em>i</em>번째 회원의 선호도 <em>a<sub>i,1</sub></em>, <em>a<sub>i,2</sub></em>, ..., <em>a</em><sub><em>i,M</em>&nbsp;</sub>(1 &le; <em>a<sub>i,j</sub></em>&nbsp;&le; 9) 가&nbsp;주어집니다.</p>
