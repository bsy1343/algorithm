...
제출: 1264, 정답: 461, 맞힌 사람: 399, 정답 비율: 39.900%
...
<p>첫 번째 줄에, 테스트케이스의 수 N (1 &le; N&nbsp;&le; 10<sup>3</sup>)이 주어진다. 그 다음 줄부터 N개의 줄에 테스트케이스가 한 줄에 하나씩 주어진다. 각 테스트케이스에는 딜러가 뽑은 공의 수 K (2 &le; K &le; 10<sup>9</sup>)가 주어진다.</p>
