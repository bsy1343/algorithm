...
제출: 3080, 정답: 2001, 맞힌 사람: 1641, 정답 비율: 65.483%
...
<p>첫째 줄에 N(1 &le; N &le; 200)과 챕터의 수 M(1 &le; M &le; 20)이 주어진다. 둘째 줄부터 각 챕터 당 읽는데 소요되는 일 수와 페이지 수가 주어진다. 소요되는 일 수는 20보다 작거나 같은 자연수이고, 페이지 수는 300보다 작거나 같은 자연수이다.</p>
