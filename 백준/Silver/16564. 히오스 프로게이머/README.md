...
제출: 7219, 정답: 2487, 맞힌 사람: 1810, 정답 비율: 34.701%
...
<p>팀 목표레벨 T =min(X<sub>i</sub>) (1 &le; i &le; N)라고 정의하면, 게임이 끝날 때까지 성권이가 달성할 수 있는 최대 팀 목표레벨 T는 무엇인가?</p>
...
<p>첫째 줄에는 캐릭터의 개수 N, 올릴 수 있는 레벨 총합 K가 주어진다. (1 &le; N &le;1,000,000, 1 &le; K &le; 1,000,000,000)</p>

<p>다음 N개의 줄에는 현재 각 캐릭터의 레벨이 X<sub>1</sub><em>, </em>X<sub>2</sub>, X<sub>3</sub>, ... , X<sub>n</sub> 으로 주어진다. (1 &le; X<sub>i</sub> &le; 1,000,000,000)</p>
