...
제출: 132, 정답: 57, 맞힌 사람: 50, 정답 비율: 43.478%
...
<p>Input begins with two integers: N M (1 &le; N, M &le; 100000) representing the number of given integers and the number of groups to be made, respectively. The next line contains N integers: A<sub>i</sub> (0 &le; A<sub>i</sub> &le; 1000000) representing the given integers.</p>
