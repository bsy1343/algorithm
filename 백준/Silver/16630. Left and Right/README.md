...
제출: 90, 정답: 64, 맞힌 사람: 48, 정답 비율: 65.753%
...
<p>The mail delivery robot has a tracking device that records its delivery route. One day the device was broken, and the exact route was lost. However, the technical team managed to recover the moving directions of the robot from the broken device, which are represented as a string consisting of n &minus; 1 letters. The i-th letter of the string is &lsquo;L&rsquo; (or &lsquo;R&rsquo;) if the (i + 1)-th house visited by the robot is on the left (or right) of the i-th house visited. For example, if n = 4 and the robot visited the houses in the order of 2, 4, 3, 1, its moving directions would be &ldquo;RLL&rdquo;.</p>
...
<p>The input has a single integer n (2 &le; n &le; 2 &middot; 10<sup>5</sup>) on the first line. The second line has a string of length n &minus; 1 consisting of letters &lsquo;L&rsquo; and &lsquo;R&rsquo; giving the moving directions of the robot.</p>
