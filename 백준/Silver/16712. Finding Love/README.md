...
제출: 375, 정답: 194, 맞힌 사람: 167, 정답 비율: 55.116%
...
<p>첫째 줄에는 참가자 수 <em>N</em>, 각 대회에 참가하는 인원의 수 <em>M</em>이 입력된다. (2&nbsp;&le; <em>M</em> &le; <em>N&nbsp;</em>&le; 500)</p>

<p>둘째 줄에는 참가자 <em>N</em>명의 정보 실력 <em>a<sub>1</sub>, a<sub>2</sub>, ... a<sub>N</sub></em>이 공백을 사이에 두고 입력된다. (1 &le; <em>a<sub>i</sub>&nbsp;</em>&le;&nbsp;10<sup>4</sup>)</p>

<p>셋째 줄에는 <em>V<sub>1</sub>, V<sub>2</sub>, ... V<sub>N-M+1</sub></em>이 공백을 사이에 두고 입력된다. (1 &le; <em>V<sub>i</sub>&nbsp;</em>&le;&nbsp;<em>M</em>)</p>
