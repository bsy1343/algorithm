...
제출: 97, 정답: 57, 맞힌 사람: 41, 정답 비율: 53.947%
...
<p>The first line is the number 0 &le; n &le; 10, 000, 000 of women in the data set. This is followed by n integers, distributed over one or more lines. The i<sup>th</sup> integer gives you the index of the mother of i, which is some number j &lt; i. If the mother is listed as number 0, this means we do not know i&rsquo;s mother; as far as your program is concerned, this means that i has no mother.</p>

### 출력

<p>For each data set, output &ldquo;Data Set x:&rdquo; on a line by itself, where x is its number. Then, output the number of pairs of sisters in the data set.</p>
