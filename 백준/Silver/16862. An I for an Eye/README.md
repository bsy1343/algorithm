# [Silver II] An I for an Eye - 16862
...
제출: 69, 정답: 35, 맞힌 사람: 29, 정답 비율: 54.717%
...
<p>Ken has been having trouble lately staying under the word limit in Twitter, so he&rsquo;s decided to write a little front-end program which will take in text and shorten it using a fixed set of abbreviations for commonly used letter sequences. Those abbreviations are shown in the table below:</p>
...
<p>Ken is about to start writing this program when he realizes that the extent of his computer knowledge is ... well ... using Twitter. He&rsquo;s looking for someone to help him &ndash; <code>r u th@ some1</code>?</p>
