...
제출: 88, 정답: 47, 맞힌 사람: 46, 정답 비율: 55.422%
...
<p>The following (last) line contains the time in milliseconds (-10 000 &le; T &le; 10 000), which needs to be added to all subtitle blocks.</p>
