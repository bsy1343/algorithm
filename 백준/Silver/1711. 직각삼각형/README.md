...
제출: 5638, 정답: 1815, 맞힌 사람: 1217, 정답 비율: 31.925%
...
<p>첫째 줄에 점의 개수 N(3 &le; N &le; 1,500)이 주어진다. 둘째 줄부터 N개의 줄에 걸쳐 각 점의 x좌표와 y좌표가 빈 칸을 사이에 두고 주어진다. 좌표값은 절댓값이 1,000,000,000을 넘지 않는 정수이며, 주어지는 모든 점의 좌표는 다르다.</p>
