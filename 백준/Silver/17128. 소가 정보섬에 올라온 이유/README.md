...
제출: 1824, 정답: 839, 맞힌 사람: 658, 정답 비율: 48.454%
...
<p style="text-align: center;">$S = \sum_{i=1}^N(A_{i}&times;A_{i+1}&times;A_{i+2}&times;A_{i+3})$ (단, $A_{N+1}=A_{1}, A_{N+2}=A_{2}, A_{N+3}=A_{3}$)</p>
