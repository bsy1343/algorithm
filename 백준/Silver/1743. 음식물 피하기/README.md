...
제출: 26934, 정답: 13271, 맞힌 사람: 10579, 정답 비율: 49.207%
...
<p>선생님을 도와 제일 큰 음식물의 크기를 구해서 &ldquo;10ra&quot;를 외치지 않게 도와주자.</p>

### 입력

<p>첫째 줄에 통로의 세로 길이 N(1 &le; N &le; 100)과 가로 길이 M(1 &le; M &le; 100) 그리고 음식물 쓰레기의 개수 K(1 &le; K &le; N&times;M)이 주어진다.&nbsp; 그리고 다음 K개의 줄에 음식물이 떨어진 좌표 (r, c)가 주어진다.</p>
