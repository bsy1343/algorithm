...
제출: 5613, 정답: 1837, 맞힌 사람: 1363, 정답 비율: 31.973%
...
<p>첫 번째 줄에 축제가 열리는 기간 <em>N</em> (1 &le; <em>N</em> &le; 200,000) 과, 채워야 하는 선호도의&nbsp;합 <em>M</em> (1 &le; <em>M</em> &lt;&nbsp;2<sup>31</sup>) 과,&nbsp;마실 수 있는 맥주 종류의&nbsp;수 K (<em>N</em> &le; <em>K</em> &le; 200,000) 가 주어집니다.</p>

<p>다음 <em>K</em>개의 줄에는 1번부터 <em>K</em>번 맥주의 선호도&nbsp;<em>v<sub>i</sub></em> (0 &le; <em>v<sub>i</sub></em> &le; 10,000) 와 도수 레벨 <em>c<sub>i</sub></em> (1 &le; <em>c<sub>i</sub></em> &lt;&nbsp;2<sup>31</sup>) (<em>v<sub>i</sub></em>, <em>c<sub>i</sub></em>는 정수) 이 공백을 사이에 두고 주어집니다.</p>
