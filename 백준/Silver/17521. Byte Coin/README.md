...
제출: 4239, 정답: 1816, 맞힌 사람: 1522, 정답 비율: 43.214%
...
<p style="text-align: center;"><img alt="" src="%EB%B0%B1%EC%A4%80/Silver/17521.%E2%80%85Byte%E2%80%85Coin/5f8310b9.png" data-original-src="%EB%B0%B1%EC%A4%80/Silver/17521.%E2%80%85Byte%E2%80%85Coin/5f8310b9.png" data-original-src="https://upload.acmicpc.net/4e5dc721-dfbb-4054-a545-713eee3137be/-/preview/" onerror="this.onerror=null;this.src=this.dataset.originalSrc" style="width: 295px; height: 273px;" /></p>
...
<p>입력은 표준입력을 사용한다. 첫 번째 줄에 요일 수를 나타내는 양의 정수 <em>n</em>과 초기 현금 <em>W</em>(1 &le; <em>n</em> &le; 15, 1 &le; <em>W</em> &le; 100,000)가 주어진다. 다음 <em>n</em> 개의 줄에서, <em>i</em>번째 줄은 <em>i</em>일의 바이트 코인 가격을 나타내는 정수 <em>s<sub>i</sub></em>가 주어진다(1 &le; <em>s<sub>i</sub></em>&nbsp;&le; 50).</p>
