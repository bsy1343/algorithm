...
제출: 157, 정답: 60, 맞힌 사람: 59, 정답 비율: 50.862%
...
<p style="text-align: center;"><img alt="" src="%EB%B0%B1%EC%A4%80/Silver/17597.%E2%80%85Zipline/e39d28ca.png" data-original-src="%EB%B0%B1%EC%A4%80/Silver/17597.%E2%80%85Zipline/e39d28ca.png" data-original-src="https://upload.acmicpc.net/feb834cc-1d79-4865-acab-b906a8b54d8d/-/preview/" onerror="this.onerror=null;this.src=this.dataset.originalSrc" style="width: 512px; height: 192px;" /></p>

<p style="text-align: center;">Figure M.1: A zipline, annotated with the four variables used to describe it.</p>

### 입력

<p>The input starts with a line containing an integer <em>n</em>, where 1 &le; <em>n</em> &le; 1 000. The next <em>n</em> lines each describe a zipline configuration with four integers: <em>w</em>, <em>g</em>, <em>h</em>, and <em>r</em>. These correspond to the variables described above. The limits on their values are: 1 &le; <em>w</em>, <em>g</em>, <em>h</em> &le; 1 000 000, and 1 &le; <em>r</em> &le; min(<em>g</em>, <em>h</em>).</p>

### 출력

<p>For each zipline, print a line of output with two lengths (in meters): the minimum and maximum length the cable can be while obeying the above constraints. Both lengths should have an absolute error of at most 10<sup>&minus;6</sup>.</p>