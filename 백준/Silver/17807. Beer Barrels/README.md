...
제출: 51, 정답: 26, 맞힌 사람: 25, 정답 비율: 59.524%
...
<p>The input consists of a single line with four integers A, B, K, C (1 &le; A, B, C &le; 9, 0 &le; K &le; 1000) which represent the numbers painted on the first four barrels.</p>
