...
제출: 2903, 정답: 991, 맞힌 사람: 804, 정답 비율: 33.682%
...
<p>첫 번째 줄에 문자열의 길이 <em>N</em>(1 &le;&nbsp;<em>N</em> &le;&nbsp;5,000,000)과, 문자열의 가치를&nbsp;나타내는 정수 <em>X</em>(1 &le;&nbsp;<em>X</em> &le;&nbsp;500,000,000)가 공백으로 구분되어 주어진다.</p>
