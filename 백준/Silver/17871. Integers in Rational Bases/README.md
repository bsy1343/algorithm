...
제출: 75, 정답: 61, 맞힌 사람: 50, 정답 비율: 78.125%
...
<p>Given relatively prime positive integers p &gt; q, any positive integer, n, can be written uniquely as a linear combination of powers of (p/q) with coefficients in the range 0 &hellip; (p-1).</p>

<p style="text-align: center;">n = a0 + a1*(p/q) + a2*(p/q)<sup>2</sup> + &hellip;</p>
