...
제출: 81, 정답: 51, 맞힌 사람: 43, 정답 비율: 66.154%
...
<p>More precisely, for integers p and d, we say that Terry is tired at second i if from second i &minus; p + 1 to second i (inclusive) he has slept for less than d seconds.</p>

### 입력

<p>The first line of input contains three integers n (1 &le; n &le; 86 400), the length of Terry&rsquo;s sleep pattern, p (1 &le; p &le; N), and D (1 &le; d &le; p) as described above.</p>
