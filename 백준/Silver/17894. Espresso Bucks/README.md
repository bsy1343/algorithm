...
제출: 84, 정답: 66, 맞힌 사람: 45, 정답 비율: 86.538%
...
<p>The first line of input consists of two integers n and m (1 &le; n, m &le; 100). The following n lines each contain a string of length m consisting only of the characters &lsquo;.&rsquo; (land) and &lsquo;#&rsquo; (water). This is the map of gridland. It is guaranteed that the map contains at least one land cell.</p>

### 출력

<p>Output a copy of the map of gridland, where some of the land cells have been replaced with the letter &lsquo;E&rsquo;, meaning that a coffee shop was placed on the corresponding land cell. This placement should satisfy the constraints above. If there are many solutions, any one will be accepted.</p>