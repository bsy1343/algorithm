...
제출: 885, 정답: 207, 맞힌 사람: 168, 정답 비율: 25.378%
...
<ol>
	...
	<li>들어야 하는 팔의 갯수가 2&nbsp;&times; N 개가 되었다면 다음 차례부터 1씩 감소시킨다.</li>
	<li>들어야 하는 팔의 갯수가 1개가 되었다면 다음 차례부터 다시 1씩 증가시킨다.<br />
	즉, 매 차례에 들어야 할 팔의 갯수는 1 이상 2 &times; N&nbsp;이하로 유지된다.</li>
</ol>
...
<p>첫 번째 줄에 게임에 참여하는 사람수 N이 정수로 주어진다. (2 &le;&nbsp;N &le;&nbsp;1,000)</p>

<p>두 번째 줄에는 휘수의 위치 P와 차례&nbsp;T가 정수로 주어진다. (1 &le;&nbsp;P &le;&nbsp;N, 1 &le;&nbsp;T &le;&nbsp;10,000,000)</p>

### 출력

<p>만약 T번째 차례에 휘수가 팔을 들어야 해서,&nbsp;휘수가 트롤을 성공할 수 있다면 &ldquo;<code>Dehet YeonJwaJe ^~^</code>&rdquo;을 출력하고, 휘수가 트롤을 할 수 없는 위치라면 &ldquo;<code>Hing&hellip;NoJam</code>&rdquo;을 출력한다.</p>