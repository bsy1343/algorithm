...
제출: 2337, 정답: 1131, 맞힌 사람: 946, 정답 비율: 47.514%
...
<p>강의실에는 가로로 N 행, 세로로 N 열, 총 N &times;&nbsp;N 개의 책상이 있으며, 위쪽에서부터 R&nbsp;번째 행, 왼쪽에서부터 C&nbsp;번째 열에 있는 책상의 위치를 (R, C)로 표현한다. 각 책상 자리는 비어있거나, 성규가 아닌 학생 혹은 성규가 앉아있거나, 교수님이 위치해 있다.</p>
...
<p>입력의 첫 번째 줄에 자연수 N(7&nbsp;&le; N&nbsp;&le; 1,000)&nbsp;이 주어진다.</p>
