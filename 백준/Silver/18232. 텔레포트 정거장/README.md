...
제출: 3113, 정답: 1282, 맞힌 사람: 996, 정답 비율: 38.725%
...
<p>첫 번째 줄에 정수 <em>N</em>, <em>M</em>이 공백으로 구분되어 주어진다. (2 &le; <em>N</em> &le; 300,000, 0 &le; <em>M</em> &le; min(<em>N</em>&times;(<em>N</em>-1)/2, 300,000))</p>

<p>두 번째 줄에 정수 <em>S</em>, <em>E</em>가 공백으로 구분되어 주어진다. (1 &le; <em>S</em>, <em>E</em> &le; <em>N</em>, <em>S</em> &ne; <em>E</em>)</p>

<p>그 다음 줄부터 <em>M</em>개의 줄에 걸쳐 텔레포트 연결&nbsp;정보를 의미하는 정수 <em>x</em>, <em>y</em>가 주어진다. (1 &le; <em>x</em>, <em>y</em>&nbsp;&le; <em>N</em>, <em>x</em>&nbsp;&ne; <em>y</em>)</p>
