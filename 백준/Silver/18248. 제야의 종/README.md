...
제출: 1309, 정답: 481, 맞힌 사람: 397, 정답 비율: 41.397%
...
<p>첫 줄에 <em>N</em>(1&nbsp;&le; <em>N</em>&nbsp;&le; 1,000)과 <em>M</em>(1&nbsp;&le; <em>M</em>&nbsp;&le; 100)이 주어진다.</p>

<p><em>i</em>+1(1 &le; <em>i</em> &le; <em>N</em>)번째 줄에는 M개의 정수 <em>a</em><sub><em>i</em>,1</sub>,&nbsp;<em>a</em><sub><span style="font-size: 10.8333px;"><em>i</em>,2</span></sub>, ..., <em>a</em><sub><em>i</em>,M</sub>&nbsp;이 주어지는데, <em>a<sub>i,j</sub></em>가 1이면 사람 <em>i</em>가 <em>j</em> 번째 타종을 들었음을 의미하고, 0이면 듣지 못했음을 의미한다.</p>
