...
제출: 1219, 정답: 467, 맞힌 사람: 418, 정답 비율: 41.468%
...
<p>당신에게 그래프가 주어진다. 이 그래프는 자연수 <em>N</em>(1&nbsp;&le; <em>N</em>&nbsp;&le; 191,229)으로 표현되며, 다음과 같은 정점과 간선을 가진다.</p>
...
<ul>
	...
	<li>1&nbsp;&le; <em>i</em>&nbsp;&le; <em>N</em>인 자연수 <em>i</em>에 대해 빨간색 <em>i</em>번 정점과 파란색 <em>i</em>번 정점을 연결하는 간선이 존재한다.</li>
	<li>2&nbsp;&le; <em>i</em>&nbsp;&le; <em>N</em>인 자연수 <em>i</em>에 대해 빨간색 <em>i</em>-1번 정점과 파란색 <em>i</em>번 정점을 연결하는 간선이 존재한다.</li>
	<li>2&nbsp;&le; <em>i</em>&nbsp;&le; <em>N</em>인 자연수 <em>i</em>에 대해 빨간색 <em>i</em>번 정점과 파란색 <em>i</em>-1번 정점을 연결하는 간선이 존재한다.</li>
</ul>
...
<p>입력의 첫 번째 줄에 테스트 케이스의 수 <em>T</em>가 주어진다.&nbsp;(1&nbsp;&le; <em>T</em>&nbsp;&le; 191,229)</p>

<p>이후 <em>T</em>개의 줄에 걸쳐 각각의 그래프를 나타내는 자연수 <em>N</em>이 주어진다.&nbsp;(1&nbsp;&le; <em>N</em>&nbsp;&le; 191,229)</p>
