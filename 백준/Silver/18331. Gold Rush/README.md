...
제출: 146, 정답: 82, 맞힌 사람: 71, 정답 비율: 62.832%
...
<p>The first line of the input contains two integers c (0 ⩽ c ⩽ 3000), Dr. Predictman&rsquo;s initial savings in Oshloobs, and n (0 ⩽ n ⩽ 30), the period of his prediction. Each of the next following n lines contains an integer p<sub>i</sub> (1000 ⩽ p<sub>i</sub> ⩽ 2000) denoting the price of a gold coin at day i (1 ⩽ i ⩽ n) in Oshloobs.</p>
