...
제출: 316, 정답: 67, 맞힌 사람: 52, 정답 비율: 22.707%
...
<p>The first line of the input contains a positive integer n (1 ⩽ n ⩽ 1000), the number of the registered email addresses. Each of the next n lines contains one email address of length at most 100 and consisting of alphabets, digits, &lsquo;<code>@</code>&rsquo;, &lsquo;<code>.</code>&rsquo;, &lsquo;<code>_</code>&rsquo;, and &lsquo;<code>-</code>&rsquo;.</p>
