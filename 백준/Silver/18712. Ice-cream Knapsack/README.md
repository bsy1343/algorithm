...
제출: 250, 정답: 69, 맞힌 사람: 59, 정답 비율: 26.577%
...
<p>Each test case begins with a line containing two integers N and K (1 &le; K &le; N &le; 10<sup>5</sup>), in which N is the number of ice-creams in the shop, and K is the number of ice-creams you want to buy.</p>

<p>Then a line follows containing N integers C<sub>1</sub>, &middot; &middot; &middot; , C<sub>N</sub> (0 &le; C<sub>i</sub> &le; 10<sup>9</sup>), in which C<sub>i</sub> is the number of calories in the i<sup>th</sup> ice-cream. Then a line follows containing N integers H<sub>1</sub>, &middot; &middot; &middot; , H<sub>N</sub> (0 &le; H<sub>i</sub> &le; 10<sup>9</sup>), in which H<sub>i</sub> is the happiness value of the i<sup>th</sup> ice-cream.</p>
