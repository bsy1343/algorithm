...
제출: 69603, 정답: 32370, 맞힌 사람: 21776, 정답 비율: 44.896%
...
<p>첫째 줄에 도화지의 세로 크기 n(1 &le; n &le; 500)과 가로 크기 m(1 &le; m &le; 500)이 차례로 주어진다. 두 번째 줄부터 n+1 줄 까지 그림의 정보가 주어진다. (단 그림의 정보는 0과 1이 공백을 두고 주어지며, 0은 색칠이 안된 부분, 1은 색칠이 된 부분을 의미한다)</p>
