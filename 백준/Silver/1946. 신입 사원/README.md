...
제출: 76177, 정답: 28051, 맞힌 사람: 20469, 정답 비율: 35.168%
...
<p>첫째 줄에는 테스트 케이스의 개수 T(1 &le; T &le; 20)가 주어진다. 각 테스트 케이스의 첫째 줄에 지원자의 숫자 N(1 &le; N &le; 100,000)이 주어진다. 둘째 줄부터 N개 줄에는 각각의 지원자의 서류심사 성적, 면접 성적의 순위가 공백을 사이에 두고 한 줄에 주어진다. 두 성적 순위는 모두 1위부터 N위까지 동석차 없이 결정된다고 가정한다.</p>
