...
제출: 2125, 정답: 528, 맞힌 사람: 439, 정답 비율: 25.733%
...
<ul>
	<li>시의 내용은 길이가 5,000을 넘지 않는 소문자, 대문자 알파벳과 빈칸으로 구성된 길이가 0보다 큰 문자열이다.</li>
	<li>시의 내용의 시작과 끝은 빈칸이 아닌 알파벳이 입력된다.</li>
	<li>스페이스바는 시의 내용을 입력할 때 외에는 사용하지 않는다.</li>
	<li>스페이스바와 영자판의 남은 사용 가능 횟수는 10,000보다 작거나 같은 음이 아닌 정수이다.</li>
</ul>