...
제출: 4867, 정답: 2715, 맞힌 사람: 2256, 정답 비율: 56.970%
...
<p>첫째 줄에 N(1 &le; N &le; 1,000)이 주어진다. 다음 N개의 줄에는 지뢰 찾기 map에 대한 정보가 주어지는데 &#39;.&#39; 또는 숫자로 이루어진 문자열이 들어온다. &#39;.&#39;는 지뢰가 없는 것이고 숫자는 지뢰가 있는 경우로 그 칸의 지뢰의 개수이다. 한 줄은 N개의 문자로 이루어져 있다.</p>
