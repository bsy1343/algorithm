# [Silver I] Pebbling odometer 3 - 20109

[문제 링크](https://www.acmicpc.net/problem/20109)
...
제출: 72, 정답: 30, 맞힌 사람: 27, 정답 비율: 39.130%
...
<p>There are exactly two pebbles somewhere in row 0: one is in cell (0, x), the other in cell (0, y); x and y are distinct, and x + y is even. Write a program that leaves the odometer in cell (0, (x + y) / 2), i.e., exactly in the midpoint between the two cells containing the pebbles. The final state of the grid is not relevant.</p>
...
<ul>
	<li>program size &le; 100</li>
	<li>execution length &le; 200 000.</li>
</ul>