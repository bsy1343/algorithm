...
제출: 1320, 정답: 1050, 맞힌 사람: 934, 정답 비율: 80.034%
...
<p>첫째 줄에 원래 문자열의 길이 <em>N</em>, 세로로 번진 글자의 개수 <em>H</em>, 가로로 번진 글자의 개수 <em>W</em>가 주어진다. (1 &le;&nbsp;<em>N</em> &le; 100, 1 &le; <em>H</em> &le; 10, 1 &le; <em>W</em> &le; 10)</p>

<p>둘째 줄부터 <em>H</em>개의 줄에 걸쳐 <em>N</em> &times; <em>W</em> 길이의 문자열이 주어진다. 문자열은 알파벳 소문자 또는 &#39;<code>?</code>&#39;로만 이루어져 있다. &#39;<code>?</code>&#39;는 해당 자리의 문자가 지워진 경우를 뜻한다.</p>
