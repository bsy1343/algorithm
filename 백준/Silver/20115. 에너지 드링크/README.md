...
제출: 5059, 정답: 3700, 맞힌 사람: 3071, 정답 비율: 72.859%
...
<p>첫째 줄에 페인이 가지고 있는 에너지 드링크의 수 <em>N</em>이 주어진다. (2 &le;&nbsp;<em>N</em> &le;&nbsp;10<sup>5</sup>)</p>

<p>둘째 줄에 각 에너지 드링크의 양이 공백으로 구분되어 주어진다. <em>i</em>번째 정수 <em>x<sub>i</sub></em> (1 &le;&nbsp;<em>x<sub>i</sub></em> &le;&nbsp;10<sup>9</sup>)는 에너지 드링크 <em>i</em>의 양이 <em>x<sub>i</sub></em>임을 의미한다.</p>
