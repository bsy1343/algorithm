...
제출: 1257, 정답: 748, 맞힌 사람: 656, 정답 비율: 62.004%
...
<p>첫 번째 줄에 호반우의 개수 <em>N</em> (1 &le; <em>N</em> &le; 100,000)이 주어집니다.</p>

<p>두 번째 줄에 공백으로 구분된 <em>N</em>개의&nbsp;정수&nbsp;<em>a<sub>1</sub>, a<sub>2,</sub> ..., a<sub>n</sub></em> (1 &le; <em>a<sub>i</sub></em> &le; 1,000)가 주어지는데 이 숫자는 각 호반우의 품질을 나타냅니다.</p>
...
<p>어떤 묶음에 있는 호반우의 품질이 [1, 2, 3, 4] 라고 하면 중간값인 3으로 모든 호반우의 품질을 계산한다. 따라서 이 묶음의 총 가격은 3 &times; 4 = 12 가 된다.</p>

<p>품질이 [6, 3, 9] 라고 하면 중간값인 6으로 모든 호반우의 품질을 계산한다. 따라서 이 묶음의 총 가격은 6 &times; 3 = 18 이 된다.</p>