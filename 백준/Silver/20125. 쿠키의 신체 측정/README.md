...
제출: 6559, 정답: 4424, 맞힌 사람: 3911, 정답 비율: 68.554%
...
<ul>
	<li>5&nbsp;&le;&nbsp;<em>N</em>&nbsp;&le; 1,000.&nbsp;<em>N</em>은 판의 한 변의 길이를 의미하는 양의 정수다.</li>
	<li><em>a<sub>i,j</sub></em>는 <span style="color:#e74c3c;"><code>*</code></span> 또는 <span style="color:#e74c3c;"><code>_</code></span>이다. <span style="color:#e74c3c;"><code>*</code></span>는 쿠키의 신체 부분이고, <span style="color:#e74c3c;"><code>_</code></span>는 쿠키의 신체가 올라가 있지 않은 칸을 의미한다. (1&nbsp;&le;&nbsp;<em>i</em>,&nbsp;<em>j</em>&nbsp;&le;&nbsp;<em>N</em>)</li>
	<li>쿠키의 신체 조건에 위배되는 입력은 주어지지 않는다.</li>
</ul>