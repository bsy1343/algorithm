...
제출: 1233, 정답: 668, 맞힌 사람: 591, 정답 비율: 59.818%
...
<p>첫째 줄에 정수 <em>N</em> (1 &le; <em>N</em> &le; 1,000) 이 주어진다.</p>

<p>둘째 줄부터 <em>N </em>+ 1번째 줄까지 간식의 평점이 주어진다. <em>i </em>+ 1 (1 &le; <em>i</em> &le; <em>N</em>) 번째 줄은 파티<em> i&nbsp;</em>번째 날에 줄 수 있는 간식의 평점을 의미하며, 주어지는 평점은 모두 100,000을 넘지 않는 양의 정수이다.</p>
