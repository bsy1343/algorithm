...
제출: 161, 정답: 47, 맞힌 사람: 39, 정답 비율: 34.821%
...
<p>첫번째 줄에는 참가자들의 수 <em>N</em> (1 &le; <em>N</em> &le; 50), 대회 중 제출된 참가자들의 제출이력의 수 <em>M</em> (<em>N</em> &le; <em>M</em> &le; 13&times;<em>N</em>)이 주어진다.</p>
...
<p>제출이력은 제출시간, 참가자 번호 <em>id</em> (1 &le; <em>id</em> &le; <em>N</em>), 문제번호 <em>p</em> (1 &le; <em>p</em> &le; 13), 제출횟수 <em>s</em> (1 &le; <em>s</em> &le; 100) 순으로 주어진다. 각 참가자의 제출 횟수는 총 <strong>100회</strong>를 넘지 않는다. 제출시간은 <em>hh:mm</em> 형식으로 주어지며, 스코어보드는 03:00를 지난 후 부터 프리징 된다. (00:00 &lt; <em>hh:mm</em> &le; 04:00)</p>
...
<p>1 &le; <em>N</em> &le; 50</p>

<p>대회도중 혹은 언프리징 과정 중 정답을 맞은 문제수와 패널티까지 같은 참가자 존재하는 상황이 발생하지 않는다. <strong>즉 APC 순위 규칙 3번을 고려하는 상황은 없다.</strong></p>