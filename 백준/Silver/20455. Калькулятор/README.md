...
제출: 42, 정답: 16, 맞힌 사람: 16, 정답 비율: 50.000%
...
<p>Пользователь ввел число n и собирается нажать на кнопки операций в некотором порядке. В частности, он планирует нажать на кнопку A суммарно a раз, на кнопку B &ndash; b раз и на кнопку C &ndash; c раз. Его заинтересовал вопрос, какое минимальное число может получиться в результате выполнения описанных операций.</p>
...
<p>Входной файл содержит четыре целых числа: n, a, b и c (1 &le; n &le; 10<sup>18</sup>, 0 &le; a, b, c &le; 60). Числа заданы на одной строке, соседние числа разделены одним пробелом.</p>

### 출력

<p>Требуется вывести одно число &mdash; минимальное число, которое может получиться у пользователя в результате работы калькулятора.</p>

### 힌트

<p>В примере пользователю необходимо оптимально действовать следующим образом: нажать на кнопку B и получить число 36, затем нажать на кнопку A и получить число 18, затем нажать на кнопку C и получить число 8, затем второй раз нажать на кнопку A и получить число 4.</p>