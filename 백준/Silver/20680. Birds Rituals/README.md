...
제출: 54, 정답: 45, 맞힌 사람: 41, 정답 비율: 85.417%
...
<p style="text-align: center;"><img alt="" src="https://upload.acmicpc.net/e782a016-6a5e-4f73-8e72-e0004ac9d291/-/crop/636x347/22,21/-/preview/" style="width: 318px; height: 174px;" /></p>
...
<p>The <code>displacement</code> parameter is an integer that can be positive, negative, or zero. The bird flies to her own&nbsp;position if the displacement is 0. Otherwise, the bird flies over k birds on his right (left) if displacement is positive (negative), where k is the absolute value of displacement. This parameter is in the range [&minus;L, +R] where L and R are respectively the numbers of birds to the left and to the right of the moving bird in the row before the relocation. Displacement &minus;L puts the bird in the beginning (leftmost position) of the row, and displacement+R puts the bird in the end (rightmost position).</p>
...
<p>A video of the first two sample inputs is provided in the attachment package. Copyright notice: the images and videos of this problem are taken from the following addresses:</p>

<ul>
	<li>Animation &ldquo;For the Birds&rdquo;, Pixar Animation Studios</li>
	<li><a href="https://www.instagram.com/p/BpBshBghJ54/">https://www.instagram.com/p/BpBshBghJ54/</a></li>
	<li><a href="https://www.instagram.com/p/B1XWKQXgGKe/">https://www.instagram.com/p/B1XWKQXgGKe/</a></li>
</ul>