...
제출: 129, 정답: 112, 맞힌 사람: 89, 정답 비율: 89.000%
...
<p>Input begins with a line containing an integer: N (1 &le; N &le; 100 000) representing the number of police stations in Flatland. The next N lines each contains two integers: x<sub>i</sub> y<sub>i</sub> (&minus;10<sup>6</sup> &le; x<sub>i</sub>, y<sub>i</sub> &le; 10<sup>6</sup>) representing the location of each police station.</p>
