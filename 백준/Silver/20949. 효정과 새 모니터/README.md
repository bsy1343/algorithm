...
제출: 1262, 정답: 689, 맞힌 사람: 605, 정답 비율: 56.122%
...
<p>이후 N개의 줄 중 i(1 &le; i &le; N)번째 줄에는 i번 모니터의 가로 픽셀 수 W<sub>i</sub>와 세로 픽셀 수 H<sub>i</sub>가 주어진다.</p>
...
<ul>
	...
	<li>1 &le; W<sub>i</sub>, H<sub>i</sub> &le; 30,000</li>
</ul>