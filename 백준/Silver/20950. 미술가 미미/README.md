...
제출: 1967, 정답: 677, 맞힌 사람: 456, 정답 비율: 33.285%
...
<p>이후 N개의 줄 중 i(1 &le; i &le; N)번째 줄에는 i번 물감의 R<sub>i</sub>, G<sub>i</sub>, B<sub>i</sub> 값이 주어진다.</p>
...
<ul>
	<li>2 &le; N &le; 30</li>
	<li>0 &le; R<sub>i</sub>, G<sub>i</sub>, B<sub>i</sub> &le; 255</li>
	<li>0 &le; R<sub>g</sub>, G<sub>g</sub>, B<sub>g</sub> &le; 255</li>
</ul>