...
제출: 321, 정답: 141, 맞힌 사람: 115, 정답 비율: 51.570%
...
<p>$$D_i=(-1)^i&times;2^{\left\lfloor\frac{i}{2}\right\rfloor}$$</p>

<p>여기서 &lfloor;x&rfloor;는 바닥 함수로, x보다 크지 않은, 즉 x 이하의 정수 중 가장 큰 정수를 의미한다. 예를 들어, 3번 택배의 목적지 D<sub>3</sub>은 다음과 같이 계산할 수 있다.</p>

<p>$$D_3=(-1)^3&times;2^{\left\lfloor\frac{3}{2}\right\rfloor}=-2$$</p>
