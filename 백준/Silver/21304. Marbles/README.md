...
제출: 127, 정답: 63, 맞힌 사람: 45, 정답 비율: 45.918%
...
<p>Input consists of a single line containing four space separated decimal integers: <strong><em>p</em></strong>, <strong><em>q</em></strong>, <strong><em>N</em></strong> and <strong><em>M</em></strong>. You are to find the number of red marbles (<strong><em>r</em></strong>) and green (<strong><em>g</em></strong>) marbles so that <strong><em>r</em></strong> &le; <strong><em>g</em></strong>, <strong><em>N</em></strong> &le; (<strong><em>r</em></strong>+<strong><em>g</em></strong>) &le; <strong><em>M</em></strong>&nbsp;&le;&nbsp;1000, 2 &le; <strong><em>N</em></strong> &le; 1000 and (<strong><em>r</em></strong>+<strong><em>g</em></strong>) is the smallest sum &ge; <strong><em>N</em></strong>. In addition, the probability of drawing one red marble and one green marble (not necessarily in that order) when drawing exactly two marbles at random from the bowl is <em>exactly</em> <strong><em>p</em></strong>/<strong><em>q</em></strong>. <strong><em>q</em></strong> &gt; 0, GCD(<strong><em>p</em></strong>, <strong><em>q</em></strong>) will always be <strong>1</strong>. If no solution exists that meet Toni&rsquo;s requirements, then print out <code>NO SOLUTION</code>.</p>
