...
제출: 119, 정답: 70, 맞힌 사람: 55, 정답 비율: 63.218%
...
Semi-Magick Square : Each row and column sums to S but at least one of the diagonals doesn&rsquo;t.<br />
...
<p>is a Semi-Magick square because each row and column adds up to 5, but the diagonals don&rsquo;t.</p>
...
<p>Input will consist of a sequence of squares. Each square starts with an integer, n, specifying the square&rsquo;s size (number of rows and columns; 2 &le; n &le; 8) on a line by itself, followed by n lines, each with n integers. The sequence of squares is terminated by a line containing a zero (0).</p>

### 출력

<p>Output for each square is a single line starting with the word &lsquo;Square&rsquo; followed by a space, a sequence number (starting at 1) and a colon (:). This is then followed by another space and then one of following massages &lsquo;Magically-Magick Square&rsquo;, &lsquo;Strongly-Magick Square&rsquo;, &lsquo;Weakly-Magick Square&rsquo;, &lsquo;Semi-Magick Square&rsquo;, or &lsquo;Not a Magick Square&rsquo; as appropriate.</p>