...
제출: 3746, 정답: 1568, 맞힌 사람: 1238, 정답 비율: 39.910%
...
<p>세로 길이가 $N$이고 가로 길이가 $M$인 화면은 총 $N$ &times;&nbsp;$M$개의 픽셀로 구성되어 있고 $(i, j)$에 있는&nbsp;픽셀은 $R_{i,j}$ (Red), $G_{i,j}$ (Green), $B_{i,j}$ (Blue) 3가지 색상의 의미를 담고 있다. 각 색상은 0이상 255이하인 값으로 표현 가능하다.</p>
...
<ul>
	...
	<li>$0 \le R_{i,j},&nbsp;G_{i,j},&nbsp;B_{i,j} \le 255$, $R_{i,j},&nbsp;G_{i,j},&nbsp;B_{i,j}$ 값은 정수</li>
	<li>$0 \le T \le 255$, $T$ 값은 정수</li>
</ul>