...
제출: 134, 정답: 57, 맞힌 사람: 36, 정답 비율: 38.710%
...
<p>Первая строка содержит целое число&nbsp;<i>k</i>&nbsp;&mdash; количество наборов входных данных, которые необходимо обработать (1&nbsp;&le;&nbsp;<i>k</i>&nbsp;&lt; 1000). Каждый из наборов входных данных задается в отдельной строке и представляет собой целое число&nbsp;<i>n</i>&nbsp;(2&nbsp;&le;&nbsp;<i>n</i>&nbsp;&le;&nbsp;1000).</p>

### 출력

<p>Для каждого набора входных данных выведите в отдельной строке одно вещественное число &mdash; среднее количество мостов, которое понадобится пройти участнику, чтобы добраться от первого до последнего острова. Оно должно быть выведено с точностью не хуже 10<sup>-6</sup>.</p>