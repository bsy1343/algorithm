...
제출: 4657, 정답: 1603, 맞힌 사람: 1214, 정답 비율: 36.478%
...
<p>로봇들의 동작은 다음과 같다. (표현 |A|는 정수 A의 절댓값을 의미한다. 즉, A &ge; 0인 경우 |A| = A, A &lt; 0 인 경우 |A| = &minus;A.)</p>
...
<ul>
	...
	<li>모든 i, j (1 &le; i &le; M, 1 &le; j &le; N)에 대해, 1 &le; D<sub>i,j</sub> &le; 9.</li>
</ul>