...
제출: 2958, 정답: 1209, 맞힌 사람: 1031, 정답 비율: 46.212%
...
<p>첫째 줄에 두 정수 U(1 &le; U &le; 10,000), N(1 &le; N &le; 100,000)이 주어진다. U는 금액의 상한이고, N은 경매에 참여한 회수이다. 다음 N개의 줄에는 사람 이름 S(공백 없는 알파벳 대소문자 10자 이하)와, 그 사람이 제시한 가격 P(1 &le; P &le; U, 정수)이 경매에 참여한(가격을 제시한) 순서대로 주어진다.</p>
