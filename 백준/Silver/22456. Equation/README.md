...
제출: 51, 정답: 20, 맞힌 사람: 14, 정답 비율: 32.558%
...
<p>各データセットについて，等式が恒等式であれば&ldquo;YES&rdquo;を， そうでなければ&ldquo;NO&rdquo;をそれぞれ1行に出力しなさい． 出力には余分な文字を含んではならない．</p>