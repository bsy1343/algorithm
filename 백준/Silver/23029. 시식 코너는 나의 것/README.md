...
제출: 1052, 정답: 444, 맞힌 사람: 356, 정답 비율: 42.130%
...
<p>첫째 줄에 시식코너의 개수 <em>N</em>이 주어진다(1 &le; <em>N</em> &le; 100,000) 둘째 줄부터 <em>N</em>+1번째 줄까지 각 시식코너에서 제공하는 음식의 개수가 순서대로 주어진다. 음식의 개수는 1,000이하의 음이 아닌 정수이다.</p>
