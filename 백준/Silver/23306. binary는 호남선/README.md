...
제출: 1467, 정답: 753, 맞힌 사람: 624, 정답 비율: 49.960%
...
<p>출력 후에는 표준 출력 버퍼를<strong> flush</strong>해 주어야 한다. 언어 별로 표준 출력 버퍼를 <strong>flush</strong>하는 방법은 다음과 같다.</p>
