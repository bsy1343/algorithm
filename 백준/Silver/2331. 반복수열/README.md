...
제출: 19091, 정답: 9637, 맞힌 사람: 7382, 정답 비율: 50.030%
...
<p>예를 들어 A=57, P=2일 때, 수열 D는 [57, 74(=5<sup>2</sup>+7<sup>2</sup>=25+49), 65, 61, 37, 58, 89, 145, 42, 20, 4, 16, 37, &hellip;]이 된다. 그 뒤에는 앞서 나온 수들(57부터가 아니라 58부터)이 반복된다.</p>
...
<p>첫째 줄에 A(1 &le; A &le; 9999), P(1 &le; P &le; 5)가 주어진다.</p>
