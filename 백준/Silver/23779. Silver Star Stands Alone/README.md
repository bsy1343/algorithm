...
제출: 60, 정답: 51, 맞힌 사람: 43, 정답 비율: 84.314%
...
<p>The input contains one line with one integer P (2 &le; P &le; 211), the distance of the Silver Star from Mars expressed in AU. P is a prime number.</p>
