...
제출: 471, 정답: 292, 맞힌 사람: 257, 정답 비율: 65.394%
...
<p>가장 공용 WiFi 속도가 빠른 방에서의 속도를 공백을 두고 출력한다. 만약 모든 방에서 공용 WiFi에 연결할 수 없다면 &ldquo;<code>IMPOSSIBLE</code>&rdquo; (따옴표 제외) 을 출력한다.</p>

### 제한

<ul>
	<li>$1 \le N \le 1\, 000$</li>
	<li>$0 \le x_i, y_i \le 1\, 000$ ($0 \le i \le N$)</li>
	<li>$0 \le E_i \le 1\, 000$ ($1&nbsp;\le i \le N$)</li>
	<li>$1\le E_0&nbsp;\le 1\, 000\, 000$</li>
	<li>입력으로 주어지는 모든 수는 정수이다.</li>
</ul>

### 힌트

<p>같은 방이라도 핫스팟 WiFi가 켜져 있으면, 공용 WiFi 전파를 방해하는 것에 유의하여라.</p>