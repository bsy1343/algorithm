...
제출: 457, 정답: 218, 맞힌 사람: 182, 정답 비율: 50.138%
...
<p>첫째 줄에 정수 <em>K</em>와 <em>N</em>이 공백을 사이에 두고 주어진다. (1 &le;&nbsp;<em>K</em> &lt; min(<em>A<sub>i</sub></em>), 2 &le; <em>N</em> &le; 8)</p>

<p>둘째 줄에 <em>N</em>개의 서로 다른 정수로 이루어진 배열 <em>A</em>의 원소들이&nbsp;공백을 사이에 두고 주어진다. (3&nbsp;&le;&nbsp;<em>A<sub>i</sub></em>&nbsp;&le; 40)</p>
