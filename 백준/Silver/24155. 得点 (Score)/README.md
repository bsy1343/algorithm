...
제출: 299, 정답: 185, 맞힌 사람: 149, 정답 비율: 60.816%
...
<p>入力の 1 行目には，生徒の人数 n (1 &le; n &le; 100000) が書かれて いる．続く n 行は生徒の得点を表す．i + 1 (1 &le; i &le; n) 行目には受験番号 i の生徒の得点 s<sub>i</sub> (0 &le; s<sub>i</sub> &le; 100) が書かれている．</p>
