...
제출: 35, 정답: 12, 맞힌 사람: 7, 정답 비율: 33.333%
...
<p>На първия ред на стандартния вход са записани две цели числа N и М &ndash; брой на спирките и брой на местата в автобуса. На всеки от следващите N реда са записани: t<sub>i</sub> - времето за придвижване до следващата спирка (за последната спирка &ndash; до училището), K<sub>i</sub> &ndash; брой на учениците, които чакат на тази спирка и K<sub>i</sub>, момента за пристигане на учениците в ненамаляващ ред (всички числа са цели).</p>

### 출력

<p>На един ред на стандартния изход програмата трябва да изведе едно цяло число &ndash; минималното време за придвижване на автобуса от началната спирка до училището, като той пристига или пълен, или превозва всички ученици, ако общият им брой е по-малък от М.</p>

### 제한

<ul>
	<li>2 &le; N*M &le; 10<sup>6</sup></li>
</ul>