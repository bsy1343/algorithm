...
제출: 2074, 정답: 793, 맞힌 사람: 660, 정답 비율: 38.261%
...
<p>첫 줄에 잇창명이 원하는 조리시간이 <code>M:S</code> 형태로 주어진다(0 &le; <em>M</em> &le; 60, 0 &le; <em>S</em> &le; 59). <em>M</em>은 분, <em>S</em>는 초이며, 항상 두 자리 숫자로 주어진다.</p>
