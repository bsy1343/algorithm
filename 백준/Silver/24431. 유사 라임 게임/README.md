...
제출: 476, 정답: 356, 맞힌 사람: 269, 정답 비율: 74.930%
...
<ul>
	<li>만약 $F &le; 2$라면, 아무렇게나 두 쌍으로 묶어도 유사 라임 쌍이 되므로 $2$개의 쌍을 찾을 수 있다. 예를 들면 (&quot;<code>WALK</code>&quot;, &quot;<code>BULK</code>&quot;), (&quot;<code>TALK</code>&quot;,&quot;<code>MILK</code>&quot;)가 있다.</li>
	<li>만약 $F = 3$라면, (&quot;<code>WALK</code>&quot;, &quot;<code>TALK</code>&quot;)를 묶어 하나의 유사 라임 쌍을 만들 수 있지만, $2$개 이상을 만들 방법은 없다.</li>
	<li>만약 $F &ge; 4$라면, 유사 라임 쌍을 만들 방법은 없다.</li>
</ul>
...
<ul>
	<li>$1 &le; T &le; 10$</li>
	<li>$1 &le; F &le; L &le; 10$</li>
	<li>$2 &le; n &le; 500$</li>
	<li>각 문자열 $W_i$는 알파벳 대문자로만 구성되어 있다.</li>
	<li>각 테스트 케이스에 주어지는 $n$개의 문자열은 중복되지 않는다.</li>
</ul>

### 힌트

<p><em>최대 공통 접미사: 두 문자열의 공통 접미사 (common suffix)중 가장 길이가 긴 공통 접미사를 의미한다.</em></p>