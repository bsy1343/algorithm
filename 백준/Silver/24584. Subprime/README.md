...
제출: 111, 정답: 51, 맞힌 사람: 48, 정답 비율: 46.154%
...
<p>For example, consider l = 1, h = 10 and p = 9. This is a search from the 1st smallest prime (2) to the 10th smallest prime (29) for any prime containing the substring &ldquo;9&rdquo;. There are 2 such primes: 1<u>9</u> and 2<u>9</u>.</p>

### 입력

<p>The first line of input has two integers l and h (1 &le; l &le; h &le; 10<sup>5</sup>). The second line has a sequence of 1 to 6 digits giving the integer p, which may be zero or have significant leading zeroes.</p>
