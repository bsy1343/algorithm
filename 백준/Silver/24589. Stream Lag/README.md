...
제출: 96, 정답: 63, 맞힌 사람: 59, 정답 비율: 69.412%
...
<p>The first line of input has a single integer n (1 &le; n &le; 1,000). This is followed by n lines. The ith line has two integers t<sub>i</sub> and i (1 &le; t<sub>i</sub> &le; 10<sup>9</sup>, 1 &le; i &le; n), which means that packet i arrives at the beginning of the t<sub>i</sub> th second. The values of t<sub>i</sub>&rsquo;s are non-decreasing. Packets may arrive at the same time.</p>
