...
제출: 90, 정답: 74, 맞힌 사람: 63, 정답 비율: 82.895%
...
<p>The sequence is then n, S(n), S(S(n)), &hellip; until the value first reaches 1.</p>
...
<p>Input consists of a single line which contains a decimal integer, m, (1 &le; m &le; 40000), which is the value for which C(m) is to be found.</p>
