...
제출: 113, 정답: 75, 맞힌 사람: 63, 정답 비율: 71.591%
...
<p style="text-align: center;">E(T) = 1*P + N*(1 &ndash; P)</p>
...
<p>Output is a single line containing a single decimal integer. If E(T) &ge; N for all N, output the value 1. Otherwise, the value is N, 2 &le; N &le; 16, which minimizes E(T) / N.</p>