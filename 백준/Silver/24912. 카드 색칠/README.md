...
제출: 1060, 정답: 435, 맞힌 사람: 384, 정답 비율: 43.636%
...
<p>유일한 줄에 <em>N</em> 개의 정수를 공백으로 구분하여 출력한다. 각 정수는 1, 2, 3 중 하나여야 하며, 주어진 조건에 맞아야 한다. 가능한 방법이 여러 가지인 경우, 그중 아무거나 출력한다. 만약 모든 조건에 맞는 색칠이 불가능하다면, 유일한 줄에 &ndash;1만 출력한다.</p>

### 제한

<ul>
	<li>1 &le;&nbsp;<em>N&nbsp;</em>&le; 1,000,000</li>
	<li>0 &le;&nbsp;<em>a<sub>i&nbsp;</sub></em>&le; 3</li>
