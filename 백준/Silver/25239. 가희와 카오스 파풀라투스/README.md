...
제출: 1047, 정답: 340, 맞힌 사람: 251, 정답 비율: 32.056%
...
<ul>
	<li>1 &le; <em>L </em>&le; 150</li>
	<li>차원의 균열 봉인 패턴 외에 다른 패턴들 (집게 패턴, 레이저 패턴 등)은 무시합니다.</li>
	<li>hh:mm 형식에서 hh는 0보다 크거나 같고 11보다 작거나 같은&nbsp;정수이고, mm은 0보다 크거나 같고 59보다 작거나 같은&nbsp;정수입니다. hh,&nbsp;mm은 10보다 작은 경우 앞에 0이 붙으며, mm은 10의 배수가 아닙니다.</li>
	<li>같은 시각에 둘 이상의 이벤트가 주어지지 않으며, 이벤트는 발생한 시간 순으로 주어집니다.</li>
	<li>차원의 균열 봉인 패턴이 끝난 이후의 이벤트는 주어지지 않습니다.</li>
	<li>파풀라투스 시계의 칸에 쓰여&nbsp;있는 수는 1, 10, 100 중 하나입니다.</li>
</ul>