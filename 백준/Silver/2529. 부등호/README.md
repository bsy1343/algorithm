...
제출: 34513, 정답: 20724, 맞힌 사람: 14102, 정답 비율: 59.200%
...
<p>두 종류의 부등호 기호 &lsquo;&lt;&rsquo;와 &lsquo;&gt;&rsquo;가 k개 나열된 순서열 A가 있다. 우리는 이 부등호 기호 앞뒤에 서로 다른 한 자릿수 숫자를 넣어서 모든 부등호 관계를 만족시키려고 한다. 예를 들어, 제시된 부등호 순서열 A가 다음과 같다고 하자.&nbsp;</p>

<p style="text-align: center;">A &rArr; &lt; &lt; &lt; &gt; &lt; &lt; &gt; &lt; &gt;</p>
...
<p>첫 줄에 부등호 문자의 개수를 나타내는 정수 k가 주어진다. 그 다음 줄에는 k개의 부등호 기호가 하나의 공백을 두고 한 줄에 모두 제시된다. k의 범위는 2 &le; k &le; 9 이다.&nbsp;</p>
