...
제출: 1229, 정답: 771, 맞힌 사람: 623, 정답 비율: 62.929%
...
<p>첫째 줄에 일차함수의 개수 $N$이 주어진다. $(1&le;N&le;100,000)$</p>

<p>둘째 줄부터 $N$줄에 걸쳐 $i$번째 일차함수를 나타내는 두 정수 $a_i, b_i$가 공백으로 구분되어 입력된다.  $(0&le;a_i, b_i&le; 10^9)$</p>
