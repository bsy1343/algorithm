...
제출: 38, 정답: 24, 맞힌 사람: 23, 정답 비율: 79.310%
...
<ul>
	...
	<li>The next player of <i>p</i>, say <i>p&prime;,</i> looks at the card(s) in the hand of <i>p</i> and draws the one having the smallest number among them.</li>
	<li>If that makes a pair of cards with the same number in the hand of <i>p&prime;</i>, the pair is discarded. If no cards remain in any players&#39; hands at this point, the game ends.</li>
</ul>
...
<p><i>n</i> is the number of players. <i>n</i> is an integer no less than two and no more than 1000. <i>c</i><sub><i>i</i>,1</sub> and <i>c</i><sub><i>i</i>,2</sub> are the numbers on the two cards in the initial hand of <i>P<sub>i</sub></i> (1 &le; <i>i</i> &le; <i>n</i>). Each integer between 1 and <i>n,</i> inclusive, appears exactly twice in <i>c</i><sub>1,1</sub>, <i>c</i><sub>1,2</sub>, ..., <i>c</i><sub><i>n</i>,1</sub>, and <i>c</i><sub><i>n</i>,2</sub>.</p>
