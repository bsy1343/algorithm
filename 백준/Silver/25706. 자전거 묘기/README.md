...
제출: 1202, 정답: 791, 맞힌 사람: 667, 정답 비율: 67.170%
...
<p>길이가 <em>N</em>미터인 직선 자전거 도로가 있다. 도로는 길이가 1미터인 <em>N</em>개의 칸으로 구분되어 있고, 가장 왼쪽에 있는 칸부터 순서대로 1번 칸, 2번 칸, &hellip;, <em>N</em>번 칸이다.</p>
