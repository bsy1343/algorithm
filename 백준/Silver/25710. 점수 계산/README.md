...
제출: 1301, 정답: 430, 맞힌 사람: 365, 정답 비율: 34.112%
...
<ol>
	<li>배열의 두 원소 <em>a<sub>i</sub></em>, <em>a<sub>j</sub></em>를 선택한다. (1 &le; <em>i</em> &lt; <em>j</em> &le; <em>N</em>)</li>
...
<ul>
	...
	<li>1&nbsp;&le;&nbsp;<em>a<sub>i</sub></em> &le;&nbsp;999</li>
