...
제출: 143, 정답: 75, 맞힌 사람: 64, 정답 비율: 51.200%
...
<p>The first input line contains two integers: s (1 &le; s &le; 100), indicating the length of one side of the fishing net and n (1 &le; n &le; 100), indicating the number of fish. Each of the next n input lines contains two integers (each between 1 and 100, inclusive) indicating the (x,y) coordinates of one fish. Assume that no two fish are at the same location.</p>
