...
제출: 93, 정답: 84, 맞힌 사람: 69, 정답 비율: 90.789%
...
<p>The regional contest does not show the &ldquo;overall performance&rdquo; of each university which is the average of the team rankings for the university. For the above scoresheet, Auburn has the overall performance of &ldquo;(1 + 6 + 7 + 9) / 4 = 5.75&rdquo;; UCF has the overall performance of &ldquo;(3 + 4 + 5) / 3 = 4.0&rdquo;; and GT has the overall performance of &ldquo;(2 + 8) / 2 = 5.0&rdquo;. So, the overall ranking of the universities will be:</p>
