...
제출: 47, 정답: 30, 맞힌 사람: 23, 정답 비율: 62.162%
...
<p>You start at the first layer and finish at the last layer. You&rsquo;d like to confirm that you have the optimal strategy, time wise.</p>
...
<p>The first input line contains two integers: n (2 &le; n &le; 20,000), indicating the number of layers, and k (1 &le; k &le; 8), indicating the maximum height you can jump. Each of the next n input lines contains an integer (between 1 and 1,000,000,000, inclusive), indicating the x coordinate of a platform. The platforms are provided in order from starting point to ending point (going up the tower), i.e., the y coordinate for platforms will be 1, 2, 3, etc. (so the y coordinates are provided in the input implicitly rather than explicitly).</p>
