...
제출: 222, 정답: 178, 맞힌 사람: 152, 정답 비율: 86.364%
...
<ul>
	<li>1 &le; 친구끼리 메시지를 전달하는 데 걸리는 시간 &le; 1,000</li>
	<li>학생 <em>i</em>가 학생 <em>j</em>에게 메시지를 전달하는 데 걸리는 시간과 학생 <em>j</em>가 학생 <em>i</em>에게 메시지를 전달하는 데 걸리는 시간은 같다. (1 &le; <em>i</em>, <em>j</em> &le; 12, <em>i</em> &ne; <em>j</em>)</li>
	<li>자기 자신에게 메시지를 전달하는 데 걸리는 시간은 0이다.</li>
</ul>