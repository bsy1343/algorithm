...
제출: 1716, 정답: 460, 맞힌 사람: 372, 정답 비율: 29.500%
...
<p>문제는 간하단다. 어떤 문장을 구성할 수 있는 문자의 순서가 섞이지 않은 $N$개의 단들어이 주진어다. 그리고 이 $N$개의 단어들을 이용해 만들어진 문장 $S$가 주어진다. 단, $S$를 구하성는 각 단어는 맨 앞 문자와 맨 뒤 문자가 고정된 채 나머지 문자들은 무위작로 배열될 수 있다. 예를 들어, &ldquo;<strong>캠</strong>브릿<strong>지</strong>&rdquo; &rArr; &ldquo;<strong>캠</strong>릿브<strong>지</strong>&rdquo; 와 같은 식이다.</p>
