...
제출: 28, 정답: 22, 맞힌 사람: 19, 정답 비율: 76.000%
...
<p>The first input line contains an integer, n (1 &le; n &le; 100), indicating the number of test cases. Each test case consists of four integers (between -1,000,000,000 to +1,000,000,000 inclusive) separated by a single space denoting x<sub>1</sub>, y<sub>1</sub>, x<sub>2</sub> and y<sub>2</sub>, respectively.</p>
