...
제출: 91, 정답: 64, 맞힌 사람: 55, 정답 비율: 67.073%
...
<p>The first input line contains a positive integer, T, indicating the number of test cases. Each case consists of a line containing five integers N (3 &le; N &le; 20), R1, C1, R2 and C2 (1 &le; R1, C1, R2, C2 &le; N).</p>
