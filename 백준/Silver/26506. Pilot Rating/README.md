...
제출: 164, 정답: 128, 맞힌 사람: 108, 정답 비율: 85.039%
...
<p>The first line of input contains a single positive integer n (1 &le; 10<sup>5</sup>, n is even), the number of pilots who volunteered for Red Squadron. Each of the following n lines contains one single integer s<sub>i</sub> (1 &le; s<sub>i</sub> &le; 10<sup>6</sup>), the rating of pilot i.</p>
