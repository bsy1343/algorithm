...
제출: 228, 정답: 106, 맞힌 사람: 86, 정답 비율: 43.216%
...
<p>After receiving an impenetrable box, you wonder what&rsquo;s inside! Write a program that finds out how many different disconnected sections the box has, and the total area of the space within the box.</p>
