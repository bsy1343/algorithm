...
제출: 77, 정답: 73, 맞힌 사람: 68, 정답 비율: 95.775%
...
<p>Fortunately, the client didn&rsquo;t specify the word that they want to be in the pennants. In fact, the client will be satisfied if and only if all the pennants have the same word.</p>
...
<ul>
	<li><code>calf</code> &rarr; 2 characters: <code>b**m</code></li>
	<li><code>palm</code> &rarr; 1 characters: <code>b***</code></li>
	<li><code>book</code> &rarr; 3 characters: <code>*alm</code></li>
	<li><code>icpc</code> &rarr; 4 characters: <code>balm</code></li>
	<li><code>ball</code> &rarr; 1 characters: <code>***m</code></li>
	<li><code>room</code> &rarr; 3 characters: <code>bal*</code></li>
</ul>
