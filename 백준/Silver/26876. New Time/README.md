...
제출: 375, 정답: 246, 맞힌 사람: 200, 정답 비율: 66.445%
...
<p>In the first example test, Nikolay can adjust the time by pressing button A three times.</p>

<p>In the second example test, Nikolay should press button A and button B $12$ times each.</p>