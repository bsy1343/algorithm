...
제출: 67, 정답: 60, 맞힌 사람: 52, 정답 비율: 88.136%
...
<p>FJ and his cows enjoy playing a mental game. They write down the numbers from 1 to N (1 &le; N &le; 10) in a certain order and then sum adjacent numbers to produce a new list with one fewer number. They repeat this until only a single number is left. For example, one instance of the game (when N=4) might go like this:</p>
