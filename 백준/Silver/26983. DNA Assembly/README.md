...
제출: 108, 정답: 40, 맞힌 사람: 35, 정답 비율: 61.404%
...
<p>Given a set of N (2 &le; N &le; 7) DNA sequences all of whose lengths are in the range 1..7, find and print length of the shortest possible sequence obtainable by repeatedly merging all N strings using the procedure described above. All strings must be merged into the resulting sequence.</p>
...
<ul>
	<li>Line 1: Length of the shortest possible string obtained by merging the subsequences. It is always possible &ndash; and required &ndash; to merge all the input strings to obtain this string.</li>
</ul>