...
제출: 178, 정답: 58, 맞힌 사람: 47, 정답 비율: 33.099%
...
<p>Romeo and Juliet want to meet and graze in as large a region as possible along the pasture fence.  However, this region should not contain too many Cowpulets, otherwise the chance of the two being caught is too great.  Romeo has determined where along the fence each of the N (1 &le; N &le; 1000) members of the Cowpulet herd grazes.  The long straight fence contains P (1 &le; P &le; 1000) equally-spaced posts numbered 1..P. Each Cowpulet grazes between some pair of adjacent posts.  Help Romeo determine the length of the largest contiguous region along the fence containing no more than C (0 &le; C &le; 1000) members of the Cowpulet herd.</p>
...
<p>There are six fence posts: 1, 2, 3, 4, 5, and 6. Of the two Cowpulets, one grazes between posts 2 &amp; 3, and the other grazes between posts 3 &amp; 4.</p>

<p>Between fence posts 3 and 6 (an interval of size 3) there is only one Cowpulet.</p>