...
제출: 329, 정답: 76, 맞힌 사람: 51, 정답 비율: 19.922%
...
<ul>
	...
	<li>$0 \le X \le 10^8$</li>
	<li>$1 \le i \le N$ 인 $i$에 대하여 $0.01 \le P_i \le 9.99$</li>
	<li>모든 테스트 케이스의 정답이 되는 부가세의 최솟값과 최댓값은 0 이상 $10^4$ 이하임이 보장된다.</li>
</ul>