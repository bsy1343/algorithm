...
제출: 417, 정답: 266, 맞힌 사람: 232, 정답 비율: 72.050%
...
<p>One possible solution that results in the least amount of money spent is to select those that cool the intervals $[2, 9]$, $[1, 2]$, and $[6, 9]$, for a cost of $3 + 2 + 5 = 10$.</p>