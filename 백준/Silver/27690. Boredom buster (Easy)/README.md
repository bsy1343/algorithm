...
제출: 117, 정답: 58, 맞힌 사람: 39, 정답 비율: 50.649%
...
<ul>
	...
	<li>otherwise, y = 1 and z = x &minus; 1.</li>
</ul>
...
<p>Each test case contains a single line with Gillian&rsquo;s initial integer n &gt; 1. You may assume that n &le; 10<sup>6</sup>.</p>
