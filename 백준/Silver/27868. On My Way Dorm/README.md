...
제출: 549, 정답: 250, 맞힌 사람: 216, 정답 비율: 53.465%
...
<ul>
	...
	<li>$1 \leq A_i \leq 200\,000$</li>
	<li>주어지는 커맨드의 길이는 $200\,000$ 이하이다.</li>
	<li>주어지는 커맨드로 궤도 엘리베이터를 작동시키면 성공적으로 $S$층과는 다른 어느 층에 도착한다.</li>
	<li>출력하는 커맨드의 길이는 $200\,000$ 이하여야 한다.</li>
	<li>퇴근이 불가능한 입력은 주어지지 않는다.</li>
</ul>