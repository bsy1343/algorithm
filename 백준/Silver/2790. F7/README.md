...
제출: 2622, 정답: 887, 맞힌 사람: 732, 정답 비율: 35.830%
...
<p>첫째 줄에 F7에 참가하는 드라이버의 수 N (3 &le; N &le; 300,000)이 주어진다.</p>

<p>다음 N개 줄에는 각 드라이버가 마지막 레이싱을 하기 전까지 얻은 점수 B<sub>i</sub>가 주어진다. (0 &le; B<sub>i</sub> &le; 2,000,000, i = 1, ..., N)</p>
