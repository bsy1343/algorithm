...
제출: 1734, 정답: 649, 맞힌 사람: 559, 정답 비율: 40.043%
...
<p><strong>그린-타오 정리(Green&ndash;Tao theorem)</strong><sup><a href="#section1">[1]</a></sup>는 소수 집합이 임의 길이의 등차수열을 포함한다는 정리로, 2004년에 Ben Green과 Terence Tao가 증명했다. 실제로는 이보다 조금 더 강력한 다음 명제를 증명한다:</p>
...
<p>그린-타오 정리는 <strong>세메레디의 정리(Szemer&eacute;di&#39;s theorem)</strong><sup><a href="#section2">[2]</a></sup>의 확장이라고 할 수 있다. 세메레디의 정리는 다음과 같다:</p>
...
<p id="section2">[2] Szemer&eacute;di, Endre. &quot;On sets of integers containing no k elements in arithmetic progression.&quot; <i>Acta Arith</i> 27.299-345 (1975): 21.</p>
...
<p>소수는 $1$보다 크면서, $1$과 자기 자신만을 약수로 가지는 양의 정수다.</p>