...
제출: 1019, 정답: 310, 맞힌 사람: 216, 정답 비율: 36.060%

### 분류

구현, 브루트포스 알고리즘, 시뮬레이션, 누적 합
...
<p>첫 번째 줄에는 예측한 날의 수&nbsp;N (1 &le; N &le; 100,000)이 주어진다.</p>

<p>두 번째 줄에는 상범이의 기분을 나타내는 N개의 정수(|기분|&nbsp;&le; 100)가 주어진다.</p>
