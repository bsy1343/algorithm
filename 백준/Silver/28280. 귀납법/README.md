...
제출: 389, 정답: 183, 맞힌 사람: 142, 정답 비율: 45.955%
...
<p>똑똑한 한별이는 수학적 귀납법을 배우자마자 산술&sdot;기하 평균 부등식을 스스로 증명해냈다. 잠시 한별이의 우아한 증명을 감상해 보자.</p>

<p>명제(산술&sdot;기하 평균 부등식): 모든 정수 $n &gt; 0$과 양의 실수 $x_1, \cdots, x_n$에 대해, 부등식 $\frac{1}{n}\sum_{i=1}^n x_i \ge \sqrt[n]{\prod_{i=1}^{n}x_i}$가 성립한다.</p>
...
<p>단계 1, 2를 종합하면 모든 자연수 $n$에 대해 산술&sdot;기하 평균 부등식이 성립한다! 증명 끝!</p>
...
<p>화살표를 클릭하면 한별이의 증명을 더 자세히 읽을 수 있다.</p>