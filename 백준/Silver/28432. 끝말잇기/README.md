...
제출: 6555, 정답: 1725, 맞힌 사람: 1524, 정답 비율: 27.948%
...
<p>첫 줄에 끝말잇기 기록의 길이 $N$ 이 주어집니다. $(1 \le N \le 100)$ 둘째 줄부터 다음 $N$개의 줄에는 끝말잇기의 기록 $S_1, \cdots, S_N$이 한 줄에 하나씩 주어집니다. 여기서, 하나의 $S_i$는 &ldquo;<span style="color:#e74c3c;"><code>?</code></span>&rdquo; 로 주어집니다. 나머지 $S_i$는 길이 $2$ 이상 $10$ 이하의 영어 소문자로 이루어진 문자열입니다.</p>
...
<p>&ldquo;<span style="color:#e74c3c;"><code>?</code></span>&rdquo;에 들어갈 수 있는 문자열을 후보 단어인 $A_1, \cdots, A_M$ 중에서 하나 찾아서 출력하세요.</p>