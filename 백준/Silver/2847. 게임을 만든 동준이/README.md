...
제출: 18407, 정답: 10971, 맞힌 사람: 9615, 정답 비율: 59.858%
...
<p>첫째 줄에 레벨의 수 N이 주어진다. (1 &le; N &le; 100) 다음 N개 줄에는 각 레벨을 클리어하면 얻는 점수가 첫 번째 레벨부터 마지막 레벨까지 순서대로 주어진다. 점수는 20,000보다 작은 양의 정수이다.</p>
