...
제출: 67, 정답: 28, 맞힌 사람: 27, 정답 비율: 44.262%
...
<p>В первом примере сначала можно нажать на первую кнопку и из вселенной номер $2$ переместиться во вселенную номер $2 \lor 3 = 3$, а затем нажать кнопку $4$ и из вселенной $3$ переместиться во вселенную $3 \lor 10 = 11$.</p>