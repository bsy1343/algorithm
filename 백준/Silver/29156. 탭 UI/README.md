...
제출: 651, 정답: 223, 맞힌 사람: 185, 정답 비율: 36.561%
...
<ul>
	...
	<li>초기 화면에서 &ldquo;그리디&rdquo; 탭의 길이인 $2$만큼 양의 방향으로 이동하면 &ldquo;그리디&rdquo; 탭이 화면 왼쪽으로 벗어나고, 왼쪽에서부터 세 번째 탭인 &ldquo;그래프&rdquo; 탭의 왼쪽 끝과 화면의 왼쪽 끝이 일치하게 된다. 이때 위치는 $4$가 된다.</li>
	<li>초기 화면에서 &ldquo;DP&rdquo; 탭의 길이인 $2$만큼 음의 방향으로 이동하면 &ldquo;DP&rdquo; 탭의 화면 왼쪽 끝과 화면의 왼쪽 끝이 일치하게 된다. 이때 위치는 $0$이 된다.</li>
</ul>
