...
제출: 716, 정답: 277, 맞힌 사람: 263, 정답 비율: 41.946%
...
<p>단, $p$나 $q$가 정수일 경우 그대로 출력하고, 정수가 아닐 경우 출력하려는 수가 $\frac{a}{b}$ 라면 $a$와 $b$를 &lsquo;<span style="color:#e74c3c;"><code>/</code></span>&rsquo;로 구분하여 출력한다. $(a,b$는 정수, $b&gt;0$, $\gcd(a,b)=1)$</p>
