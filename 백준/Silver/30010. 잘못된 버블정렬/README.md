...
제출: 784, 정답: 584, 맞힌 사람: 502, 정답 비율: 77.231%
...
<p>&rdquo;<strong>$N$개의 수를 담은 수열 $A_0$, $A_1$, $\cdots$, $A_{N-1}$이 주어질 때 이를 오름차순으로 정렬하는 프로그램을 작성하시오.</strong>&rdquo; </p>

<p>정연이는 자신의 코드가 완벽하다고 생각한 후 제출했지만, 아쉽게도 &rsquo;틀렸습니다&rsquo;를 받았다. 정연이가 작성한 버블정렬 코드는 다음과 같다.</p>
...
<ul>
	...
	<li>$0\leq A_{i}\leq 10\,000$ $(0 \le i &lt; N)$</li>
</ul>