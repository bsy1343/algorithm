...
제출: 84, 정답: 66, 맞힌 사람: 61, 정답 비율: 77.215%
...
<p>In the first test case, after given rearrangement, $|a_{1} - a_{2}| = 0 \le |a_{2} - a_{3}| = 1 \le |a_{3} - a_{4}| = 2 \le |a_{4} - a_{5}| = 2 \le |a_{5} - a_{6}| = 10$. There are other possible answers like &quot;<code>5 4 5 6 -2 8</code>&quot;.</p>

<p>In the second test case, after given rearrangement, $|a_{1} - a_{2}| = 1 \le |a_{2} - a_{3}| = 2 \le |a_{3} - a_{4}| = 4$. There are other possible answers like &quot;<code>2 4 8 1</code>&quot;.</p>