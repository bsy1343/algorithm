...
제출: 58, 정답: 27, 맞힌 사람: 22, 정답 비율: 57.895%
...
<p>Antrojoje eilutėje pateikiama N simbolių eilutė, sudaryta i&scaron; ženklų <code>+</code> (žymi &scaron;iltą dieną) ir <code>-</code> (žymi &scaron;altą dieną).</p>

### 출력

<p>I&scaron;veskite vieną sveiką skaičių &ndash; ilgiausio intervalo, turinčio po lygiai pliusų ir minusų, ilgį.</p>

### 제한

<ul>
	<li>1 &le; N &le; 5000000</li>
</ul>