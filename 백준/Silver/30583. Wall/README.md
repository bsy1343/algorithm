...
제출: 44, 정답: 25, 맞힌 사람: 21, 정답 비율: 61.765%
...
<p>The first line of the input contains two integers, R and K (0 &le; R &le; 255, 1 &le; K &le; 200), the automaton rule coded in decimal and the number of generations, respectively. The second line of the input defines the first generation of the automaton. The cell states are coded by characters, with &rsquo;.&rsquo; coding 0 and &rsquo;X&rsquo; coding 1. The row of cells in the first generation is coded as a single string without spaces. The width of the row is at least 1 cell and it does not exceed 250 cells.</p>
