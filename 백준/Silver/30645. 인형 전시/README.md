...
제출: 762, 정답: 291, 맞힌 사람: 235, 정답 비율: 40.309%
...
<p>세 번째 줄에 <em>N</em>개의 인형의 높이 h<sub>1</sub>, h<sub>2</sub>, &hellip;, h<sub>N</sub>이 주어진다.</p>
...
<ul>
	<li>1 &le; <em>R</em> &le; 1,000</li>
	<li>1 &le; <em>C</em> &le; 1,000</li>
	<li>1 &le; <em>N</em> &le; 1,000,000</li>
	<li>1 &le; h<sub>i</sub> &le; 1,000,000</li>
</ul>