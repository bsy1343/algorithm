...
제출: 349, 정답: 279, 맞힌 사람: 269, 정답 비율: 79.822%
...
<ul>
	...
	<li>그렇지 않다면 x<sub>t + 1</sub>과 y<sub>t + 1</sub>은 각각 x<sub>t</sub> &divide; 2, y<sub>t</sub> &divide; 2 이다.</li>
...
<ul>
	<li>​​1 &le; <em>R</em> &le; 10<sup>3</sup></li>
	<li>0 &le; <em>a</em> &lt; <em>R</em>  </li>
	<li>0 &le; <em>b</em> &lt; <em>R</em></li>
	<li><em>a</em> + <em>b</em> &lt; <em>R</em></li>
