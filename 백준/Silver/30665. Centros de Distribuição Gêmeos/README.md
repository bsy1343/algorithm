...
제출: 124, 정답: 38, 맞힌 사람: 23, 정답 비율: 29.870%

### 분류

구현, 그래프 이론, 비트마스킹, 비트 집합
...
<p>A entrada é composta por diferentes casos de teste. A primeira linha de cada caso de teste contém n e m, n &le; 1000 e m &le; n(n&minus;1)/2, onde n é o número de cidades da região. A seguir, m linhas, contendo dois inteiros distintos a e b cada, 1 &le; a, b &le; n, indicando que a faz parte da área de alcance de b e vice-versa.</p>
