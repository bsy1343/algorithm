...
제출: 699, 정답: 278, 맞힌 사람: 221, 정답 비율: 42.176%
...
<ul>
	...
	<li>$x_i$ 는 모두 다르다.</li>
	<li>$1 \leq h_i \leq 10^9-1$</li>
	<li>$h_i$ 는 홀수이다.</li>
	<li>$x_i$와 $h_i$는 모두 정수이다.</li>
</ul>