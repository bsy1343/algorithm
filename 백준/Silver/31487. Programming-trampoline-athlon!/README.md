# [Silver IV] Programming-trampoline-athlon! - 31487
...
제출: 151, 정답: 89, 맞힌 사람: 66, 정답 비율: 55.932%
...
<ul>
	...
	<li>$C$ consists of five uppercase English letters;</li>
	<li>$0 \le P \le 6$</li>
	<li>$0 \le E_i \le 10$ for all $1 \le i \le 6$</li>
	<li>different teams always have different team codes.</li>
</ul>