...
제출: 94, 정답: 65, 맞힌 사람: 58, 정답 비율: 74.359%
...
<p>It&rsquo;s time to play Bingo!</p>
...
<p>The game master is confused and doesn&rsquo;t know who to trust. To resolve this situation, he asked you for help. Determine which players had a <em>Bingo!</em> after drawing $m$ balls, i.e. which players had all the numbers marked in at least one row, column, or diagonal.</p>

### 입력

<p>The first line contains the integer $n$ ($1 &le; n &le; 50$), the number of players.</p>
...
<ul>
	...
	<li>Then five lines follow with five integers between $1$ and $90$, which describe the player&rsquo;s board. All the integers on the board are distinct.</li>
</ul>

<p>The next line contains the integer $m$ ($1 &le; m &le; 90$), the number of balls the game master drew before the players shouted <em>Bingo!</em>.</p>
