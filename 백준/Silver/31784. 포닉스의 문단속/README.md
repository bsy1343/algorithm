...
제출: 839, 정답: 371, 맞힌 사람: 316, 정답 비율: 41.799%
...
<p>길이가 $N$으로 같은 두 문자열 $A$, $B$에 대해 $A$가 $B$보다 사전 순으로 작음은 다음과 같은 조건을 만족하는 정수 $i$가 존재함을 의미한다.</p>

<ul>
	<li>$1 \le i \le N$</li>
	<li>$1 \le j &lt; i$에 대해 $A_j = B_j$</li>
	<li>$A_i \ne B_i$이며 $A_i$가 $B_i$보다 알파벳 순서에서 먼저 등장한다.</li>
</ul>