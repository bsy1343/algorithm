...
제출: 451, 정답: 200, 맞힌 사람: 167, 정답 비율: 44.772%
...
<p>$\left\lfloor x \right\rfloor$는 $x$를 초과하지 않는 가장 큰 정수를 말한다. 예를 들어 $\left\lfloor 2.5 \right\rfloor=2$이고, $\left\lfloor 3 \right\rfloor=3$이다.</p>