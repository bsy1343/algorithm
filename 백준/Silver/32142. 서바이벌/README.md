...
제출: 544, 정답: 419, 맞힌 사람: 322, 정답 비율: 77.778%
...
<p>점이나 선분은 단순다각형이 아니다.</p>

<p>학생들은 유클리드 평면상에 있으며, 두 점 $(x_i,y_i)$와 $(x_j,y_j)$ 사이의 거리는 $\sqrt{(x_i-x_j)^2+(y_i-y_j)^2}$로 정의된다.</p>