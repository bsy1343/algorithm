...
제출: 399, 정답: 202, 맞힌 사람: 182, 정답 비율: 53.372%
...
<p>카드는 총 $N$장이며, 백지 카드 $N &minus; 1$장과 조커 카드 $1$장으로 구성되어 있다. 맨 위쪽 카드를 $1$번, 맨 아래쪽 카드를 $N$번이라고 하자. 처음 상태의 덱에선 조커가 $1$번 위치에 있다.</p>
