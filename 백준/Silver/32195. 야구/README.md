...
제출: 498, 정답: 165, 맞힌 사람: 132, 정답 비율: 38.484%
...
<ul>
	...
	<li>$-10^9 \le x_i \le 10^9$ ($1 \le i \le N$)</li>
	<li>$-10^9 \le y_i \le 10^9$ ($1 \le i \le N$)</li>
	<li>$1 \le Q \le 300\,000$</li>
	<li>$1 \le R_i \le 10^9$ ($1 \le i \le Q$)</li>
</ul>

### 힌트

<p>충분히 빠른 입출력 방식을 사용하지 않으면 시간 초과를 받을 수 있다. 예를 들면, C++의 cin/cout을 사용할 때에는 입력받기 전에 <code>cin.tie(NULL);</code>을 사용하고, python에서는 <code>input()</code> 대신 <code>sys.stdin.readline()</code>을 사용하는 것을 권장한다.</p>