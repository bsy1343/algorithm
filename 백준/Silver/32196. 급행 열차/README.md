...
제출: 543, 정답: 223, 맞힌 사람: 183, 정답 비율: 41.031%
...
<ul>
	...
	<li>$1 \le K, X, Y \le 10^9$</li>
	<li>$0 \le A_i, B_i \le 1\,000$</li>
	<li>$\sum_{i=1}^{N}{B_i} \lt K$, 즉, 대피선을 설치하고 난 후에도 급행 열차의 운행 시간이 양수가 되는 입력만 주어진다.</li>
</ul>