...
제출: 286, 정답: 252, 맞힌 사람: 219, 정답 비율: 94.805%
...
<p style="text-align: center;"><img alt="" src="%EB%B0%B1%EC%A4%80/Silver/32289.%E2%80%85Max-Queen/57c36bf7.jpg" data-original-src="https://boja.mercury.kr/assets/problem/32289-1.jpg" onerror="this.onerror=null;this.src=this.dataset.originalSrc"></p>
...
<p>출력이 32비트 정수의 최댓값을 초과할 수 있음에 유의하세요. 값을 저장하기 위해 다음을 사용할 것을 권장합니다.</p>

<ul>
	<li>C/C++: <code>long long</code></li>
	<li>Java: <code>long</code></li>
	<li>Python: <code>int</code> (별도의 처리를 할 필요가 없습니다.)</li>
