...
제출: 58, 정답: 25, 맞힌 사람: 21, 정답 비율: 42.857%
...
<ul>
	...
	<li>the best team is ranked 1 and the worst team is ranked 2<sup>n</sup> (this is referred to as &ldquo;one-based ranking&rdquo;)</li>
...
<p>There is only one input line; it contains two integers: n (2 &le; n &le; 20), indicating the number of rounds for the tournament and r (1 &le; r &le; 2<sup>n</sup>), indicating your team&#39;s one-based ranking.</p>
