...
제출: 111, 정답: 75, 맞힌 사람: 50, 정답 비율: 69.444%
...
<p>The next line of input is an integer A where 0 &le; A &lt; R, and the last line of input is an integer B where 0 &le; B &lt; C. Row A and column B is the starting location of the farmer and the top-left corner of the patch is row 0 and column 0.</p>
