...
제출: 169, 정답: 78, 맞힌 사람: 59, 정답 비율: 45.038%
...
<p>수학에서 기울기는 직선이 기울어진 정도를 나타내는 수이다. 데카르트 좌표계에서 직선의 기울기는 대수적으로 다음과 같이 표현될 수 있다.</p>

<p>$\text{직선의 기울기} = \frac {y\text {의 변화량}}{x\text {의 변화량}}$</p>