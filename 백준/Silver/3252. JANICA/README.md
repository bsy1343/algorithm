...
제출: 35, 정답: 28, 맞힌 사람: 28, 정답 비율: 84.848%
...
<p>Watching alpine skiing on TV can be really boring sometimes. Fortunately, it can happen that your TV operator doesn&rsquo;t show all the information about the race and then you have to do some computation to determine the winner yourself.</p>
...
<p>The first line of the input file contains two integers N and M, separated by a single blank character, 3 &le; M &le; N &le; 100.</p>
