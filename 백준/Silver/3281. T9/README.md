...
제출: 138, 정답: 98, 맞힌 사람: 81, 정답 비율: 69.828%
...
<p>The first line of input file contains a natural number M, 1 &le; M &le; 100, the number of words in a dictionary. Next M lines contain dictionary words, one word in each line. The words are sorted in ascending order. The words contain only capital letters of English alphabet (A&ndash;Z). Length of each word from dictionary will be 100 or less.</p>

<p>The next, (M+2)th line contains a natural number N, 1 &le; N &le; 100, the number of presses on a mobile phone keyboard.</p>
