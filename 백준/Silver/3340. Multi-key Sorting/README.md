# [Silver III] Multi-key Sorting - 3340
...
제출: 162, 정답: 88, 맞힌 사람: 57, 정답 비율: 54.808%
...
<p>The first line of input&nbsp;contains two integers, C and N. C (1 &le; C &le; 1 000 000) is the number of columns and N (1 &le; N &le; 3 000 000) is the number of sort operations. The second line contains N integers, k<sub>i</sub> (1 &le; k<sub>i</sub> &le; C). It defines the sequence of sort operations Sort(k<sub>1</sub>); ...; Sort(k<sub>N</sub>).</p>
