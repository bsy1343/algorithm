...
제출: 132, 정답: 74, 맞힌 사람: 48, 정답 비율: 48.000%
...
<p>Roshambo &mdash; this simple game is known all around the world. In German, it is called &ldquo;Schnick, Schnack, Schnuck&rdquo;, in Japanese &ldquo;Janken&rdquo;, in Spanish &ldquo;Cachip&uacute;n&rdquo;, in Polish &ldquo;Papier, kamień, nożyce&rdquo;. The Czechs call it &ldquo;K&aacute;men, nůžky, pap&iacute;r&rdquo;.</p>
...
<p>The last round is followed by a line containing one single dash character (&ldquo;-&rdquo;) and then the next game begins. The only exception is the last game in the input, which is terminated by a dot (&ldquo;.&rdquo;) instead of the dash.</p>

### 출력

<p>For each game, print five lines of output. The first line should contain the string &ldquo;Game #G:&rdquo;, where G is the number of the game, starting with one.</p>

<p>The second line will contain the first player name followed by a colon (&ldquo;:&rdquo;), one space and the number of rounds won by that player. The number should be followed by one space and the word &ldquo;points&rdquo;. Use the singular form &ldquo;point&rdquo; if (and only if) the number of points of the player equals one.</p>

<p>The third line has the same format and shows the second player&rsquo;s name and points.</p>

<p>The fourth line displays the outcome of the game. It must contain the word &ldquo;WINNER&rdquo; followed by a colon, space and the name of the player who gained more points. If both players have the same number of points, the fourth line will contain words &ldquo;TIED GAME&rdquo; instead.</p>

<p>The fifth line is left empty to visually separate individual games.</p>

### 힌트

<p>Acknowledgements to Wikipedia, the free encyclopedia, for providing background information and symbol names in various languages. If your own language is missing, it may be because it has no article on Roshambo in Wikipedia.</p>