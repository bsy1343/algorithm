...
제출: 931, 정답: 288, 맞힌 사람: 246, 정답 비율: 35.143%
...
<p>첫째 줄에 n과 m이 주어진다. (1 &le; n &le; 1,000,000, 1 &le; m &le; 2,000) 다음 m개 줄에는 각 엘리베이터의 버튼 u<sub>i</sub>와 d<sub>i</sub>가 주어진다. (1 &le; u<sub>i</sub>, d<sub>i</sub> &le; 1000)</p>
