...
제출: 32, 정답: 21, 맞힌 사람: 15, 정답 비율: 71.429%
...
<p>Two offices are considered adjacent if they are located on the same floor and share a common wall, or if one&rsquo;s floor is the other&rsquo;s ceiling.</p>
...
<p>The input file consists of a single integer number n (1 &le; n &le; 50) &mdash; the number of countries that are hosted in the building.</p>

### 출력

<p>On the first line of the output file write three integer numbers h, w, and l &mdash; height, width and length of the building respectively.</p>
