...
제출: 118, 정답: 56, 맞힌 사람: 44, 정답 비율: 54.321%
...
<ul>
	<li>One line with two integers N and F with 1 &le; N, F &le; 10 000: the number of pies and the number of friends.</li>
	<li>One line with N integers ri with 1 &le; ri &le; 10 000: the radii of the pies.</li>
</ul>

### 출력

<p>For each test case, output one line with the largest possible volume V such that me and my friends can all get a pie piece of size V. The answer should be given as a floating point number with an absolute error of at most 10<sup>&minus;3</sup>.</p>