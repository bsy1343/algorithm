...
<p>All the reference books are in a storeroom and only the librarian is allowed to enter it. To obtain a copy of a reference book&rsquo;s page, a student should ask the librarian to make it. The librarian brings books out of the storeroom and makes page copies according to the requests. The overall situation is shown in Figure 1.</p>
...
<p style="text-align:center"><img alt="" src="%EB%B0%B1%EC%A4%80/Silver/3915.%E2%80%85Book%E2%80%85Replacement/fa0677ed.png" data-original-src="%EB%B0%B1%EC%A4%80/Silver/3915.%E2%80%85Book%E2%80%85Replacement/fa0677ed.png" data-original-src="https://www.acmicpc.net/upload/imagesa/figure1%20lib.png" onerror="this.onerror=null;this.src=this.dataset.originalSrc" style="height:234px; width:724px" /></p>
...
<p>Your task is to write a program which simulates the behaviors of the students and the librarian, and evaluates the total cost of the overall process. Costs are associated with accessing a desk or the shelf, that is, putting/taking a book on/from it in the description above. The cost of an access is i for desk D<sub>i</sub> and m+1 for the shelf. That is, an access to D<sub>1</sub>,&middot; &middot; &middot;,D<sub>m</sub>, and the shelf costs 1, &middot; &middot; &middot; , m, and m + 1, respectively. Costs of other actions are ignored.</p>
