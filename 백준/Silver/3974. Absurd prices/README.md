...
제출: 81, 정답: 31, 맞힌 사람: 24, 정답 비율: 37.500%

### 분류

수학, 구현, 해 구성하기, 많은 조건 분기
...
<ul>
	...
	<li>if d = 5 the absurdity of the number is 2 &middot; a &minus; 1</li>
	<li>otherwise, the absurdity of the number is 2 &middot; a</li>
</ul>

<p>For example, the absurdity of 350 is 3 and the absurdity of 900900 is 8. Using the measure of absurdity, we can define what we call an absurd price: A price c is absurd if and only if the closed interval [0.95 &middot; c, 1.05 &middot; c] contains an integer e such that the absurdity of e is less than the absurdity of c.</p>

<p>Given a price in cents, go ahead and tell whether it is absurd!</p>

### 입력

<p>The first line of the input consists of the number t of test cases to follow. Each test case is specified by one line containing an integer c. You may assume that 1 &le; c &le; 10<sup>9</sup>.</p>

### 출력

<p>For each test case output if c is &ldquo;absurd&rdquo; or not. Adhere to the format shown in the sample output.</p>