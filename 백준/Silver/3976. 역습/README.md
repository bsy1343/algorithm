...
제출: 403, 정답: 300, 맞힌 사람: 250, 정답 비율: 79.872%
...
<p><img alt="" src="/upload/images/counterattack.png" /></p>
...
<p>첫째 줄에 테스트 케이스의 개수 c가 주어진다. (1 &le; c &le; 100) 각각의 테스트 케이스는 다섯 줄로 이루어져 있다.</p>

<p>테스트 케이스의 첫째 줄에는 각 스트라이커가 이동하는 방법에서 미리 지정해논 점의 개수 n이 주어진다. (2 &le; n &le; 100,000) n 다음에는 l1, l2, s1, s2이 주어진다. l1과 l2은 수비수가 스트라이커에게 긴 패스를 할 때 난이도이고, s1과 s2은 스트라이커가 슛을 할 때의 난이도이다.</p>
