...
제출: 71, 정답: 35, 맞힌 사람: 25, 정답 비율: 48.077%
...
<p>It&rsquo;s preseason and the local newspaper wants to publish a preseason ranking of the teams in the local amateur basketball league. The teams are the Ants, the Buckets, the Cats, the Dribblers, and the Elephants. When Scoop McGee, sports editor of the paper, gets the rankings from the selected local experts down at the hardware store, he&rsquo;s dismayed to find that there doesn&rsquo;t appear to be total agreement and so he&rsquo;s wondering what ranking to publish that would most accurately reflect the rankings he got from the experts. He&rsquo;s found that finding the median ranking from among all possible rankings is one way to go.</p>
...
<p>Suppose there are 4 voters that have given the rankings: ABDCE, BACDE, ABCED and ACBDE. Consider two candidate median rankings ABCDE and CDEAB. The sum of distances from the ranking ABCDE to the four voted rankings is 1 + 1 + 1 + 1 = 4. We&rsquo;ll call this sum the value of the ranking ABCDE. The value of the ranking CDEAB is 7 + 7 + 7 + 5 = 26.</p>
