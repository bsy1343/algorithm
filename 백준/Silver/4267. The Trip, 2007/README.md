...
제출: 196, 정답: 33, 맞힌 사람: 28, 정답 비율: 18.543%
...
<p>Standard input contains several test cases. Each test case consists of an integer&nbsp;<i>1 &le; n &le; 10000</i>&nbsp;giving the number of bags followed by&nbsp;<i>n</i>&nbsp;integers on one or more lines, each giving the dimension of a piece. A line containing 0 follows the last test case.</p>
