...
제출: 85, 정답: 35, 맞힌 사람: 26, 정답 비율: 66.667%
...
<p>Input consists of several test cases. Each case begins with two integers: 4 &le; n &le; 50 giving the number of types of coins available, and 1 &le; t &le; 10 giving the number of tables to be designed. n lines follow; each gives the thickness of a coin in hundredths of millimetres. t lines follow; each gives the height of a table to be designed (also in hundredths of millimetres). A line containing 0 0 follows the last test case.</p>
