...
제출: 77, 정답: 46, 맞힌 사람: 28, 정답 비율: 52.830%
...
<p>The input file contains an indeterminate number of lines, each containing a single integer mod guaranteed to be in the range 2 &le; mod &le; 16777216 (2<sup>24</sup>). The final line contains a 0 as end of data and should not be processed.</p>
