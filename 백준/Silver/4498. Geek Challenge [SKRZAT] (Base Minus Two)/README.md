...
제출: 43, 정답: 23, 맞힌 사람: 23, 정답 비율: 60.526%
...
<p>The input data are in the range to fit within a 15-bit Weird Binary number, which represents the decimal number range &ndash;10922 to 21845, inclusive.</p>
