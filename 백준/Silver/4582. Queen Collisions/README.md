...
<table class="table table-bordered" style="height:277px; text-align:center; width:567px">
	<tbody>
		<tr>
			<td><img alt="no collisions" src="/upload/images2/1.png" style="height:201px; width:198px" /></td>
			<td><img alt="5x5 4 collisions" src="/upload/images2/2.png" style="height:147px; width:143px" /></td>
			<td><img alt="size 8, 5 collisions" src="/upload/images2/3.png" style="height:227px; width:223px" /></td>
		</tr>
		<tr>
			<td>Figure 1</td>
			<td>Figure 2</td>
