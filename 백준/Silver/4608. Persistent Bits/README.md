...
제출: 82, 정답: 64, 맞힌 사람: 26, 정답 비율: 89.655%
...
<p>WhatNext Software creates sequence generators that they hope will produce fairly random sequences of 16-bit unsigned integers in the range 0&ndash;65535. In general a sequence is specified by integers A, B, C, and S, where 1 &le; A &lt; 32768, 0 &le; B &lt; 65536, 2 &le; C &lt; 65536, and 0 &le; S &lt; C. S is the first element (the seed) of the sequence, and each later element is generated from the previous element. If X is an element of the sequence, then the next element is</p>
