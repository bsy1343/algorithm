...
제출: 235, 정답: 98, 맞힌 사람: 92, 정답 비율: 43.602%
...
<p>첫째 줄에 테스트 케이스의 개수 T가 주어진다. 각 테스트 케이스는 N, D, B, E가 10진수로 한 줄에 하나씩 주어진다. N과 D는 유리수의 분자와 분모이고, 0 &le; N &le; 5,000, 1 &le; D &le; 5,000을 만족한다. B와 E는 구해야 하는 수의 범위이다. 0 &le; B,E &le; 250, 0 &le; (E-B) &le; 20을 만족한다. 소수점 0번째 자리는 소수점 바로 오른쪽에 있는 수이다.</p>
...
<pre>
Problem set k: N / D, base 7 digits B through E: result</pre>
