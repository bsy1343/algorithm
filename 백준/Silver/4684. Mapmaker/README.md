...
제출: 21, 정답: 15, 맞힌 사람: 15, 정답 비율: 88.235%

### 분류

수학, 구현, 자료 구조, 집합과 맵, 해시를 사용한 집합과 맵
...
<ul>
	...
	<li>C<sub>d</sub> =&nbsp;C<sub>d+1</sub>(U<sub>d+1</sub> &minus; L<sub>d+1</sub> + 1) for 1 &le; d &lt; D</li>
	<li>C<sub>0</sub> =&nbsp;B &minus; C<sub>1</sub>L<sub>1</sub>&nbsp;&minus; C<sub>2</sub>L<sub>2</sub> &minus; &middot;&middot;&middot; &minus; C<sub>D</sub>L<sub>D</sub></li>
</ul>
