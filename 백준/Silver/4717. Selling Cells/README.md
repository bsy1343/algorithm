...
제출: 37, 정답: 27, 맞힌 사람: 16, 정답 비율: 66.667%
...
<p>Input consists of multiple data sets. Each data set begins with a line containing a single integer N, 1 &le; N &le; 25. This line is followed by N lines, each containing three floating point numbers x, y, r. These give the (x,y) coordinates of the circle&rsquo;s center and the radius of that circle, respectively.</p>
