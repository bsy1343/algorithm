...
제출: 94, 정답: 50, 맞힌 사람: 34, 정답 비율: 51.515%
...
<p>where A is the integral number of degrees that must be traversed clockwise to get from the hour hand to the minute hand and HH : MM : SS is the overheard time in 24 hour form. 0 &le; A &le; 359, 0 &le; HH &le; 23, 0 &le; MM &le; 59, and 0 &le; SS &le; 59. HH, MM, and SS will be exactly two digits with a leading zero if necessary.</p>
