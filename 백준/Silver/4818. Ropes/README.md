...
제출: 60, 정답: 52, 맞힌 사람: 49, 정답 비율: 94.231%
...
<p>When climbing a section or &ldquo;pitch&rdquo;, the lead climber ascends first, taking a rope with them that they anchor to the rock for protection to ascend. Once at the top of a pitch, the lead climber has the second climber attach to the rope, so they can ascend with the safety of the rope. Once the second climber reaches the top of the pitch, the third attaches, and so on until all the climbers have ascended.</p>
...
<pre>
N P<sub>1</sub> P<sub>2</sub> ... P<sub>N</sub></pre>

<p>Here N is the positive number of pitches, with 1 &le; N &le; 100, and Pk is the positive integer length (in meters) of each pitch, with 1 &le; P<sub>k</sub> &le; 100. The last line (indicating the end of input) is a single 0.</p>
