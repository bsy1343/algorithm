...
<p>
	<img alt="" src="/upload/images/7s.png" style="width: 103px; height: 156px; float: right;" />7 세그먼트 디스플레이는 오른쪽 그림과 같이 일곱개의 LED로 이루어져 있다. 각각의 LED는 켜있거나 꺼져있을 수 있고, 독립적으로 작동한다. 이러한 LED의 조합은 총 127가지가 있으며, 주로 숫자 0부터 9까지를 표현하는데 사용된다.&nbsp;</p>
...
<p>
	<img alt="" src="/upload/images/7seg.png" style="width: 300px; height: 154px;" /></p>
...
<p>
	<img alt="" src="/upload/images/7ref.png" style="width: 609px; height: 545px;" /></p>