...
제출: 28, 정답: 25, 맞힌 사람: 24, 정답 비율: 92.308%
...
<table class="table table-bordered">
	...
	<tbody>
		<tr>
			<td>A</td>
			<td>B = A &times; 0.03125 (and rounding off fractions)</td>
			<td>A + B - 3000</td>
		</tr>
		<tr>
			<td>1000000</td>
...
<pre>
simple-or-compound annual-interest-rate annual-operation-charge</pre>
