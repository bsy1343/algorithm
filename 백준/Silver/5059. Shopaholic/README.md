...
제출: 161, 정답: 110, 맞힌 사람: 91, 정답 비율: 70.543%
...
<p>The first line of input gives the number of test scenarios, 1 &le; t &le; 20. Each scenario consists of two lines of input. The first gives the number of items Lindsay is buying, 1 &le; n &le; 20000. The next line gives the prices of these items, 1 &le; p<sub>i</sub> &le; 20000.</p>
