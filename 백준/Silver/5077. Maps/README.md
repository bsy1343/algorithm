...
제출: 187, 정답: 124, 맞힌 사람: 103, 정답 비율: 72.028%
...
<p>You will be given a number of scenarios. Each scenario consists of an image of a secret rig and a map of a section of snowfield. Snow is represented by a dot (.) and part of a building by a X. You are to count the number of times an exact replica of the rig in the image is found on the map. &ldquo;Exact&rdquo; here means you do not have to count rotations or mirror images.</p>
