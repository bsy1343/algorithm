...
제출: 96, 정답: 66, 맞힌 사람: 56, 정답 비율: 70.000%
...
<ul>
	<li>One line with two integers P and N, satisfying 0 &le; P &le; 1000, 1 &le; N &le; 1000: the number of other pirates you have to share the loot with and the number of items, respectively.</li>
	<li>One line with N integers, v<sub>i</sub>, satisfying 1 &le; v<sub>i</sub> &le; 1000: the value of each item.</li>
</ul>
