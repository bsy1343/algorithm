...
제출: 70, 정답: 52, 맞힌 사람: 39, 정답 비율: 72.222%
...
<ul>
	<li>One line with three integers D, M and Y separated by single spaces, satisfying 1 &le; D &le; 31, 1 &le; M &le; 12 and 1000 &le; Y &le; 9999: the day, month and year of a valid date, respectively. There are no leading zeros; e.g., June is represented as 6 and not as 06.</li>
</ul>
