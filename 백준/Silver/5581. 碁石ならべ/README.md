...
제출: 123, 정답: 59, 맞힌 사람: 51, 정답 비율: 52.577%
...
<p>1 行目には正整数 n (1 &le; n &le; 100000) が書かれている．2 行目以降の第 i + 1 行目 (1 &le; i &le; n) には，i 番目に置く碁石の色を表す整数 c<sub>i</sub> が書かれており，c<sub>i</sub> が 0 な ら i 番目に置く碁石の色が白であることを，1 なら i 番目に置く碁石の色が黒であ ることを表す．</p>
