...
제출: 9041, 정답: 3932, 맞힌 사람: 3310, 정답 비율: 43.144%
...
<p>첫 번째로 입력되는 건 n (1 &le; n &le; 10<sup>6</sup>)으로 사용자가 뒤이어 입력할 원소값을 결정합니다. 입력하는 줄에는 하나의 원소값 뿐만 아니라 여러 원소값도 들어갈 수 있습니다.</p>
