...
제출: 120, 정답: 52, 맞힌 사람: 43, 정답 비율: 43.434%
...
<p>The input contains several test cases. The first line of a test case contains a single integer N indicating the number of matches in the test (1 &le; N &le; 1000). Each of the following N lines describes the result of a match, in the format</p>

<pre>
Club1 X x Y Club2</pre>

<p>where Club1 and Club2 are strings of at most 15 characters (from &lsquo;a&rsquo; to &lsquo;z&rsquo; and &lsquo;A&rsquo; to &rsquo;Z&rsquo;), X is the number of goals scored by Club1 and Y is the number of goals scored by Club2 (0 &le; X &le; 10 and 0 &le; Y &le; 10). The end of input is indicated by N = 0.</p>
