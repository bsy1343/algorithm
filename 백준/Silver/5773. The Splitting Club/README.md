...
제출: 44, 정답: 27, 맞힌 사람: 16, 정답 비율: 76.190%
...
<p>Your program should process several test cases. The first line of a test case contains an integer K and a rational R. K represents the number of different ages in the club (1 &le; K &le; 120), and R represents the splitting factor set by the club director (1.0 &le; R &le; 2.0). The next K lines describe the group members, each line containing two integers N and M, indicating that there are N members who are M-years old in the club (1 &le; N &le; 10000 and 1 &le; M &le; 120). The end of input is indicated by a line with K = 0 and R = 0.0.</p>
