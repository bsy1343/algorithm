...
제출: 85162, 정답: 23306, 맞힌 사람: 17457, 정답 비율: 27.627%
...
<p>입력 데이터는 표준 입력을 사용한다. 입력은 T개의 테스트 데이터로 구성된다. 입력의 첫 번째 줄에는 입력 데이터의 수를 나타내는 정수 T가 주어진다. 각 테스트 데이터는 한 줄로 구성된다. 각 줄에는 네 개의 정수 M, N, x와 y가 주어진다. (1 &le; M, N &le; 40,000, 1 &le; x &le; M, 1 &le; y &le; N) 여기서 &lt;M:N&gt;은 카잉 달력의 마지막 해를 나타낸다.</p>
