...
제출: 37, 정답: 31, 맞힌 사람: 31, 정답 비율: 86.111%

### 분류

그래프 이론, 자료 구조, 그래프 탐색, 집합과 맵, 최단 경로, 해시를 사용한 집합과 맵, 플로이드–워셜
...
<p>The cost of a shipment is equal to the size of the shipment times the number of shipping legs required times \$100.</p>
