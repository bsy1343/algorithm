...
제출: 75, 정답: 50, 맞힌 사람: 46, 정답 비율: 73.016%
...
<p>The first line of each test case contains two integers: the number of nodes <em>n</em> (2 &le; n &le; 25)&nbsp;and the number of edges <em>m</em>&nbsp;(1 &le; m &le; 25). The next <em>m</em> lines describe the <em>m</em> edges. Each edge is given by the numbers of the two nodes connected by it. Nodes are numbered from <em>0</em> to <em>n-1</em>. Edges are undirected. Nodes have degrees of three or less. The network is not neccessarily connected.</p>
