...
제출: 85, 정답: 55, 맞힌 사람: 32, 정답 비율: 66.667%
...
<p>The input file will contain one or more lines, each line containing one integer&nbsp;<em>n</em>&nbsp;with 3 &le;&nbsp;<em>n</em>&nbsp;&lt; 150, representing the number of cities in the country. Input is terminated by a value of zero (0) for&nbsp;<em>n</em>.</p>
