...
제출: 138, 정답: 92, 맞힌 사람: 72, 정답 비율: 65.455%
...
<p>You are gathering readings of acidity level in a very long river in order to determine the health of the river. You have placed N sensors (2 &le; N &le; 2 000 000) in the river, and each sensor gives an integer reading R (1 &le; R &le; 1 000). For the purposes of your research, you would like to know the frequency of each reading, and find the absolute difference between the two most frequent readings.</p>
...
<p>The first line of input will be the integer N (2 &le; N &le; 2 000 000), the number of sensors. The next N lines each contain the reading for that sensor, which is an integer R (1 &le; R &le; 1 000). You should assume that there are at least two different readings in the input.</p>
