...
제출: 63, 정답: 54, 맞힌 사람: 52, 정답 비율: 88.136%
...
<p>You are a mouse that lives in a cage in a large laboratory. The laboratory is composed of one rectangular grid of square cages, with a total of R rows and C columns of cages (1 &le; R, C &le; 25).</p>
