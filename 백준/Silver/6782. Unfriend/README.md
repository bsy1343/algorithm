...
제출: 41, 정답: 29, 맞힌 사람: 26, 정답 비율: 70.270%
...
<p>The first line contains a single integer N (N &le; 6), the number of people in the network. Next are N &minus; 1 lines telling us who invited each person. To be precise, line i in this set (1 &le; i &le; N &minus; 1) contains a single integer j (with j &gt; i), which indicates that person j is the person who invited person i. Person N is Mark.</p>
