...
제출: 25, 정답: 23, 맞힌 사람: 20, 정답 비율: 90.909%
...
<p>A truck driver is planning to drive along the Trans-Canada highway from Vancouver to St. John&rsquo;s, a distance of 7000 km, stopping each night at a motel. The driver has been provided with a list of locations of eligible motels, with the respective distance of each motel, measured in km, from the starting point in Vancouver. Some of the motel locations are:</p>
