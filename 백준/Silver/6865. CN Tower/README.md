...
제출: 85, 정답: 27, 맞힌 사람: 22, 정답 비율: 29.333%
...
<p>The first line of input consists of an integer n (2 &le; n &le; 1000), the number of landmarks Christy wants to photograph. Each of the following n lines specify a landmark. Each landmark specification consists of the landmark name (a string of uppercase and lowercase letters of length at most 40 characters), a space, and the compass angle d, in degrees, to the landmark from the CN Tower (0 = north, 90 = east, 180 = south, 270 = west). Note that d is a real number which satisfies 0 &le; d &lt; 360, with d specified to the hundredth of a degree (i.e., at most two decimal places).</p>
