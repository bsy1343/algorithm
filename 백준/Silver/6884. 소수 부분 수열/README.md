...
제출: 1510, 정답: 381, 맞힌 사람: 252, 정답 비율: 25.150%
...
<p>입력의 첫째 줄에는 테스트 케이스의 개수 t (1 &le; t &le; 20) 가 주어진다.</p>

<p>각 테스트 케이스는 한 줄로 이루어져 있고, 줄의 첫 번째 정수 n은 (0 &lt; n &le; 10000) 수열의 길이이다. 다음에 주어지는 정수 n개는 수열의 원소이다. 수열의 원소는 10000보다 작거나 같은 음이 아닌 정수이다.</p>
