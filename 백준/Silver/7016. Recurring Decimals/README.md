...
제출: 117, 정답: 74, 맞힌 사람: 66, 정답 비율: 64.706%
...
<ul>
	...
	<li>a<sub>1</sub> = 886320 &minus; 023688 = 862632</li>
	<li>a<sub>2</sub> = 866322 &minus; 223668 = 642654</li>
	<li>a<sub>3</sub> = 665442 &minus; 244566 = 420876</li>
	<li>a<sub>4</sub> = 876420 &minus; 024678 = 851742</li>
	<li>a<sub>5</sub> = 875421 &minus; 124578 = 750843</li>
	<li>a<sub>6</sub> = 875430 &minus; 034578 = 840852</li>
	<li>a<sub>7</sub> = 885420 &minus; 024588 = 860832</li>
	<li>a<sub>8</sub> = 886320 &minus; 023688 = 862632</li>
	<li>&hellip;</li>
</ul>
...
<p>The input consists of multiple datasets. A dataset is a line containing two integers a<sub>0</sub> and L separated by a space. a<sub>0</sub> and L represent the initial integer of the sequence and the number of digits, respectively, where 1 &le; L &le; 6 and 0 &le; a<sub>0</sub> &lt; 10L .</p>

<p>The end of the input is indicated by a line containing two zeros; it is not a dataset.</p>

### 출력

<p>For each dataset, find the smallest number i that satisfies the condition a<sub>i</sub> = a<sub>j</sub> &nbsp;(i &gt; j) and print a line containing three integers, j , ai &nbsp;and i &minus; j. Numbers should be separated by a space. Leading zeros should be suppressed. Output lines should not contain extra characters.</p>
