...
제출: 56, 정답: 50, 맞힌 사람: 42, 정답 비율: 89.362%
...
<p>The first line of the input file contains a single integer t ( 1 &le; t &le; 10), the number of test cases, followed by the input data for each test case. The first line of each test case contains a single integer n ( 1 &le; n &le; 1000) which is the number of ropes. Following the first line, there is a single line containing n integers between 1 and 10000 which are the tear-off weights of the ropes, separated by blank characters.</p>
