...
제출: 43, 정답: 22, 맞힌 사람: 16, 정답 비율: 48.485%
...
<p>The first line of the file contains a single number M, which is the number of test cases in the file (1 &le; M &le; 10), and the rest of the file consists of the data of the test cases. Each test case begins with a line containing s (1 &le; s &le;= 100), the number of line segments in the figure. It follows by s lines, each containing x and y coordinates of two end points of a segment respectively. The coordinates are integers in the range of 0 to 1000.</p>
