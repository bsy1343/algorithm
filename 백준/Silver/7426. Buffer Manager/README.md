...
제출: 35, 정답: 21, 맞힌 사람: 17, 정답 비율: 54.839%
...
<ul>
	<li><code>0</code> &ndash; when the corresponding buffer is free.</li>
	<li><code>1</code> &ndash; when the corresponding buffer is occupied and has worthiness of 1.</li>
	<li><code>2</code> &ndash; when the corresponding buffer is occupied and has worthiness of 2.</li>
	<li>...</li>
	<li><code>9</code> &ndash; when the corresponding buffer is occupied and has worthiness of 9.</li>
	<li><code>*</code> &ndash; when the corresponding buffer is locked.</li>
</ul>
