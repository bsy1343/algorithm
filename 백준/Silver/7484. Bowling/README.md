...
제출: 128, 정답: 75, 맞힌 사람: 62, 정답 비율: 59.048%
...
<p>The first line of the input contains number t &lt;= 1000 &ndash; the amount of test cases. Then the description of each of t test cases follow one per line. Each test case consists of several integers 0 &lt;= a &lt;= 10 &ndash; the amount of pins knocked down after each delivery of the ball. Each test case describes a full game for one player. All the games in the input file are correct.</p>
