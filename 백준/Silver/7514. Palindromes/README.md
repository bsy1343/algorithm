...
<p>After some time, Willi realized the following: &ldquo;If a number is not a palindrome, I can convert it to one by adding the reversed number&rdquo;. So when he sees e.g. that 134 is not a palindrome, he adds the reversed number, i.e. 431 and the resulting number 565 is indeed a palindrome.</p>
...
<ul>
	<li>The basis b of the numbers in the testcase (2 &le; b &le; 30).</li>
	<li>The number l of iterations (1 &le; l &le; 100).</li>
