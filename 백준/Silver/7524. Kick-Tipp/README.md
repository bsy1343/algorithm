...
제출: 18, 정답: 13, 맞힌 사람: 13, 정답 비율: 86.667%
...
<p>Given a list of the participants, those peoples&rsquo; bets, and the outcomes of the games, calculate each participant&rsquo;s total number of points as well as the number of dots he received and output the sorted list of scores.</p>
...
<p>The first line contains the number of scenarios. Each scenario starts with a line containing the number of participants p (1 &le; p &le; 50) and the number of rounds r (1 &le; r &le; 14). First come p lines, where the i-th such line contains the name of the i-th participant. Each name is guaranteed to be shorter than 50 characters. Then follow r descriptions of individual rounds.</p>

<p>Each round again consists of individual games, and thus starts with a line containing the number g (1 &le; g &le; 16) of games in this round. Next, there are the g descriptions of these games.</p>
...
<p>The output for every scenario begins with a line containing &ldquo;Scenario #i:&rdquo;, where i is the number of the scenario starting at 1. Then print a sorted table of p lines giving the number of points, the number of dots , and the names of the participants in the following order:</p>
