...
제출: 685, 정답: 505, 맞힌 사람: 450, 정답 비율: 75.125%
...
<p>Input consists of a number of scenarios, each beginning with a single positive integer, n, the number of music tracks that require sorting (1 &lt; n &lt;= 200). The last line of input is a single 0 &ndash; this scenario should not be processed.</p>
