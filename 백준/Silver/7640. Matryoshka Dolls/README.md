...
제출: 131, 정답: 92, 맞힌 사람: 74, 정답 비율: 71.154%

### 분류

자료 구조, 그리디 알고리즘, 정렬, 집합과 맵, 해시를 사용한 집합과 맵
...
<blockquote>
<p>Hi Adam, I hope you enjoy these dolls. But sorry, I didn&rsquo;t have enough time to sort them out. You&rsquo;ll notice that each doll has a hollow hole at the bottom which allows it to contain a smaller doll inside.<br />
...<br />
Yours,<br />
Matryona</p>
</blockquote>
...
<p>The input consists of multiple test cases. Each test case begins with a line with an integer N, 1 &le; N &le; 10<sup>5</sup>, denoting the number of Matryoshka dolls. This is followed by N lines, each with a single integer h<sub>i</sub>, 1 &le; h<sub>i</sub> &le; 10<sup>9</sup>, denoting the height of the ith doll in cm. Input is followed by a single line with N = 0, which should not be processed.</p>
