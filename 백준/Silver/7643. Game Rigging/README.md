...
제출: 78, 정답: 32, 맞힌 사람: 24, 정답 비율: 42.857%
...
<p>For each test case, output one line which contains either &ldquo;yes&rdquo; or &ldquo;no&rdquo; (without quotes) indicating whether you can guarantee that one of your friends wins the tournament.</p>