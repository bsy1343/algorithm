...
제출: 63, 정답: 21, 맞힌 사람: 20, 정답 비율: 48.780%
...
<ul>
	<li>1 &le;&nbsp;<i>C, N</i> &le; 1000</li>
	<li>1 &le; <i>c<sub>i</sub></i> &le; <i>C</i></li>
	<li>1 &le; <i>p<sub>i</sub></i> &le; 20</li>
	<li>1 &le; <i>t<sub>i</sub></i> &le; 36000.</li>
</ul>