...
제출: 35, 정답: 16, 맞힌 사람: 14, 정답 비율: 53.846%

### 분류

자료 구조, 다이나믹 프로그래밍, 해시를 사용한 집합과 맵, 구현, 시뮬레이션, 문자열, 집합과 맵
...
<p>First line of input file contains two integers N (1 &le; N &le; 1000000) and L (1 &le; L &le; 1000), separated by space. Second line contains a string of N characters 0 and 1.</p>
