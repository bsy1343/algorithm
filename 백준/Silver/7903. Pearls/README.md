...
제출: 32, 정답: 21, 맞힌 사람: 17, 정답 비율: 62.963%
...
<p>For example 5 pearls are needed in the 10 Euro category and 100 pearls are needed in the 20 Euro category. That will normally cost: (5 + 10) &times; 10 + (100 + 10) &times; 20 = 2350 Euro. Buying all 105 pearls in the 20 Euro category only costs: (5 + 100 + 10) &times; 20 = 2300 Euro.</p>
...
<p>The first line of the input contains the number of test cases. Each test case starts with a line containing the number of categories c (1 &le; c &le; 100). Then, c lines follow, each with two numbers a<sub>i</sub> and p<sub>i</sub>. The first of these numbers is the number of pearls a<sub>i</sub> needed in a class (1 &le; a<sub>i</sub> &le; 1000). The second number is the price per pearl p<sub>i</sub> in that class (1 &le; p<sub>i</sub> &le; 1000). The qualities of the classes (and so the prices) are given in ascending order. All numbers in the input are integers.</p>
