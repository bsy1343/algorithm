...
<ul>
	...
	<li>G - jest r&oacute;wne 2<sup>2<sup>i</sup></sup>, gdzie i to czwarta liczba od lewej dziewiątego w kolejności leksykograficznej ciągu odpowiadającego takiemu wypełnieniu liczbami 0, 1, ..., 8 kwadratu 3x3, by sumy liczb we wszystkich wierszach i kolumnach były sobie r&oacute;wne (ciągowi a<sub>0</sub>, ..., a<sub>8</sub> odpowiada kwadrat <img alt="" src="https://upload.acmicpc.net/a3427994-827d-4459-9d0a-6e89649b4e4a/-/crop/177x106/5,6/-/preview/" style="width: 89px; height: 53px;" />)</li>
