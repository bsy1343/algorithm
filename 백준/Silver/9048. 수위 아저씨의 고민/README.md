...
제출: 664, 정답: 191, 맞힌 사람: 162, 정답 비율: 35.762%
...
<p><img alt="" src="%EB%B0%B1%EC%A4%80/Silver/9048.%E2%80%85%EC%88%98%EC%9C%84%E2%80%85%EC%95%84%EC%A0%80%EC%94%A8%EC%9D%98%E2%80%85%EA%B3%A0%EB%AF%BC/332ce8eb.png" data-original-src="%EB%B0%B1%EC%A4%80/Silver/9048.%E2%80%85%EC%88%98%EC%9C%84%E2%80%85%EC%95%84%EC%A0%80%EC%94%A8%EC%9D%98%E2%80%85%EA%B3%A0%EB%AF%BC/332ce8eb.png" data-original-src="https://onlinejudgeimages.s3.amazonaws.com/problem/9048/%EC%8A%A4%ED%81%AC%EB%A6%B0%EC%83%B7%202017-01-03%20%EC%98%A4%ED%9B%84%206.08.40.png" onerror="this.onerror=null;this.src=this.dataset.originalSrc" style="height:257px; width:233px" /></p>

### 입력

<p>입력은 표준입력(standard input)으로 주어진다. 입력의 첫 번째 줄에는 테스트케이스의 개수 T (1 &le; T &le; 20) 가 주어진다.</p>

<p>각 테스트케이스 별 입력은 다음과 같이 구성된다.</p>

<ul>
	<li>1 번째 줄: 빌딩의 높이(옥상을 제외한 층의 수) F (1 &le; F &le; 30), 한 층에 있는 사무실의 수 R (1 &le; R &le; 30)와 등이 켜져 있는 사무실의 수 N (0 &le; N &le; F&times;R) 이 입력된다.</li>
	<li>2~N 번째 줄: 각 줄에 등이 켜져 있는 한 개의 사무실 위치가 입력된다. 사무실 위치는 층 번호 a (1 &le; a &le; F) 와 호수 b (1 &le; b &le; R) 로 두 개의 정수가 주어지며 빈 칸 하나로 구분된다. (사무실 호수는 왼쪽부터 차례로 1, 2, &hellip; , R 로 메겨진다.)</li>
</ul>
