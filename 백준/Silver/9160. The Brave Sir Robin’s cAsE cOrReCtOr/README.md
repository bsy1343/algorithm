# [Silver V] The Brave Sir Robin’s cAsE cOrReCtOr - 9160
...
제출: 633, 정답: 117, 맞힌 사람: 82, 정답 비율: 16.433%
...
<p>Undaunted, the brave (and crafty) Sir Robin scrutinized the documents and noticed that their loudest inflections were indicated by capital letters and realized that he could at least lower their voices. This, he reasoned, could be accomplished by replacing upper case letters with lower case letters (&ldquo;Case correction&rdquo;, from his perspective). These modifications could be forced upon the singers by insistence upon proper usage of the King&rsquo;s English. Not all letters can be lower case, however, as the King&rsquo;s English mandates some letters must be upper case.</p>

<p>Strangely hesitant about performing &ldquo;case correction&rdquo; personally, the brave, crafty (and managerially capable) Sir Robin humbly requests you write a program to perform a first pass of case correction for the songs. There will still be some corrections required after this program is used.</p>
