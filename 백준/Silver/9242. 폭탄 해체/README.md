...
제출: 937, 정답: 462, 맞힌 사람: 411, 정답 비율: 51.119%
...
<p>모든 숫자는 5&times;3 크기이지만, 올바르지 않은 숫자가 주어질 수도 있다. 올바르지 않은 숫자가 주어진 경우에는 전선을 자르면 안 된다.</p>

<p>0부터 9까지 숫자를 5&times;3으로 나타내는 방법은 아래에 나와있다.</p>
