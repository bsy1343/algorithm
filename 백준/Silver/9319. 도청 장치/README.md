...
제출: 360, 정답: 161, 맞힌 사람: 133, 정답 비율: 45.085%
...
<p>첫째 줄에 테스트 케이스의 수가 주어지며, 100을 넘지 않는다. 각 테스트 케이스의 첫째 줄에는 도청장치의 수 \(n\) (0 &le; \(n\) &le; 100,000)이 주어진다. 둘째 줄에는 백그라운드 노이즈의 레벨 \(B\) (0 &le; \(B\) &le; 1,000,000)가 주어진다. 셋째 줄에는 수신기를 들고있는 사람의 위치 x좌표와 y좌표 \(x\)와 \(y\)가 주어진다. 다음 \(n\)개 줄에는 \(i\)번째 도청장치의 위치 \(x_i\), \(y_i\)와 신호의 세기 \(s_i\)가 주어진다. (0 &le; \(s_i\) &le; 1,000,000)</p>
