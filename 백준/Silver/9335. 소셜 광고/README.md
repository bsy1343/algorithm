...
제출: 780, 정답: 243, 맞힌 사람: 175, 정답 비율: 34.113%
...
<p>입력은 여러개의 테스트 케이스로 이루어져 있다. 첫째 줄은 테스트 케이스를 나타낸다. 각각의 케이스마다 전체 사용자의 수&nbsp;n (1 &le; n &le; 20) 이 주어진다. 다음 n개의 줄에는 친구의 목록이 입력으로 주어지는데 각각의 줄은 친구의 수&nbsp;d (0 &le; d &lt; n) 가 먼저 입력으로 주어지고 뒤이어 d개의 친구 번호가 주어진다.&nbsp;i번째 줄은 i번째 사용자를 뜻하며 자기 자신이 친구일&nbsp;수는 없다.</p>
