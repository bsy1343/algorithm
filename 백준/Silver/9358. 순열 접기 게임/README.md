...
제출: 1157, 정답: 645, 맞힌 사람: 593, 정답 비율: 57.573%
...
<p>첫째 줄에 테스트 케이스의 개수 T (1 &le; T &le; 100)가 주어진다. 각 테스트 케이스의 첫째 줄에는 수열에 포함된 수의 개수 N (2 &le; N &le; 100)이 주어진다. 둘째 줄에는 수열이 주어진다. 수열을 이루는 숫자는 32비트 부호있는 정수범위이다.</p>
