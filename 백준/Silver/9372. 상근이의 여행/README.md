...
제출: 28236, 정답: 17644, 맞힌 사람: 14049, 정답 비율: 63.284%
...
<p>첫 번째 줄에는 테스트 케이스의 수 T(T&nbsp;&le;&nbsp;100)가 주어지고,</p>

<p>각 테스트 케이스마다 다음과 같은 정보가 주어진다.</p>

<ul>
	<li>첫 번째 줄에는 국가의 수 N(2 &le; N &le; 1 000)과 비행기의 종류 M(1 &le; M &le; 10 000) 가 주어진다.</li>
	<li>이후 M개의 줄에 a와 b 쌍들이 입력된다. a와 b를 왕복하는 비행기가 있다는 것을 의미한다.&nbsp;(1 &le; a, b &le; n; a &ne; b)&nbsp;</li>
