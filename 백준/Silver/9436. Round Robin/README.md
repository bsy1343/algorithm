...
제출: 412, 정답: 162, 맞힌 사람: 135, 정답 비율: 43.408%
...
<p>The input will contain one or more datasets. &nbsp;Each dataset will be described with a single line containing two integers, <em>N</em> and <em>T</em>, where <em>N</em> (2 &le; <em>N</em> &le; 100) is the initial number of &nbsp;players, and <em>T</em> (2 &le; <em>T</em> &le; 100) is the number of turns after which the player with the most recently completed turn leaves. &nbsp;Following the last dataset is a line containing only 0.</p>
