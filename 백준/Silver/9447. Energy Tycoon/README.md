...
제출: 95, 정답: 66, 맞힌 사람: 62, 정답 비율: 69.663%
...
<p>Little Vasya is playing a new computer game &mdash; turn-based strategy &ldquo;Energy Tycoon&rdquo;.</p>
...
<p style="text-align: center;"><img alt="" src="/upload/images2/enegrgytycoon.png" style="height:54px; width:545px" /></p>
...
<p>The first line of the input contains one integer n (1 &le; n &le; 100 000) &mdash; the number of slots on the board. The second line contains the string s. The i-th character of the string is 1 if you can build one-slot power plant at the i-th turn and the character is 2 if you can build two-slot power plant at the i-th turn. The number of turns does not exceed 100 000.</p>

### 출력

<p>The output should contain a single integer &mdash; the maximal score that can be achieved.</p>