...
제출: 121, 정답: 92, 맞힌 사람: 81, 정답 비율: 76.415%
...
<p>Suppose you are tracking some satellites. Each satellite broadcasts a &lsquo;Ping&rsquo; at a regular interval, and the intervals are unique (that is, no two satellites ping at the same interval). You need to know which satellites you can hear from your current position. The problem is that the pings cancel each other out. If an even number of satellites ping at a given time, you won&rsquo;t hear anything, and if an odd number ping at a given time, it sounds like a single ping. All of the satellites ping at time 0, and then each pings regularly at its unique interval.</p>

<p>Given a sequence of pings and non-pings, starting at time 0, which satellites can you determine that you can hear from where you are? The sequence you&rsquo;re given may, or may not, be long enough to include all of the satellites&rsquo; ping intervals. There may be satellites that ping at time 0, but the sequence isn&rsquo;t long enough for you to hear their next ping. You don&rsquo;t have enough information to report about these satellites. Just report about the ones with an interval short enough to be in the sequence of pings.</p>
