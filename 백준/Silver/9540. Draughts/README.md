...
제출: 163, 정답: 72, 맞힌 사람: 63, 정답 비율: 44.681%
...
<p style="text-align:center"><img alt="" src="/upload/images2/dr.png" style="height:161px; width:321px" /></p>

<p style="text-align:center">The board before and after a single move with two captures.</p>

<p>You are given a draughts position. It is the light player&rsquo;s turn. Compute the maximal possible number of dark pieces he can capture in his next move.</p>

### 입력

<p>The first line of input contains the number of test cases T. The descriptions of the test cases follow:</p>

<p>Each test case starts with an empty line. The following 10 lines of 10 characters each describe the board squares. The characters # and . denote empty black and white squares, W denotes a square with a light piece, B &ndash; a square with a dark piece.</p>
