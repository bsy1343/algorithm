...
제출: 271, 정답: 78, 맞힌 사람: 50, 정답 비율: 27.027%
...
<p>If person A trusts person B, we have a directed edge A &rarr; B in the friendship graph G.</p>

<p>There may be a case that we have directed edge A &rarr; B in G but not directed edge B &rarr; A.</p>
...
<p>The first line of input contains two integers in one line: V and E (1 &le; V &le; 2000; 0 &le; E &le; 100000). Then, we have a list of E lines that contains two integers: A and B that implies the existence of directed edge A &rarr; B in G.</p>

<p>Vertices are numbered from [0..V-1], i.e. 0 &le; A, B &lt; V.</p>
...
<p>The query section starts with one line containing an integer Q (1 &le; Q &le; 200000).</p>

<p>Afterward, we have a list of Q lines that also contains two integers: X and Y (0 &le; X, Y &lt; V). Note that it is possible that X = Y.</p>
