...
제출: 35, 정답: 33, 맞힌 사람: 24, 정답 비율: 96.000%
...
<p>The input contains just one number which is the number n as described above, where 5 &le; n &le; 100. A sample file is the following.</p>
