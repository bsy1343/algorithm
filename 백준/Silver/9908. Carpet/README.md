...
제출: 66, 정답: 57, 맞힌 사람: 51, 정답 비율: 85.000%
...
<p>Given a rectangular configuration representing a floor plan, where &lsquo;<code>#</code>&rsquo; indicates a pillar and &lsquo;<code>.</code>&rsquo; a clear space:</p>
...
<p>What is the area (number of dots) of the largest rectangular carpet whose edges are parallel to the boundary of the floor that can be laid on this piece of land? &nbsp;For the example above, the largest carpet is represented with &lsquo;<code>*</code>&rsquo; symbols:</p>
